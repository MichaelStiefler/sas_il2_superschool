...
public class SEAFIRE250AK extends SPITFIRE5
{
    ...
    public void onAircraftLoaded()
    {
        ...
        FM.CT.bHasWingControl = false;
        FM.WingspanFolded = 0.0F;
        FM.EI.engines[0].load(FM, "Rolls-Royce-Merlin", "Merlin50", 0);
    }
    ...
    static 
    {
        Class class1 = SEAFIRE250AK.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Seafire");
        Property.set(class1, "meshName", "3DO/Plane/SeafireMkII50AK(Multi1)/hier.him");
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_ExternalDev01", "_ExternalBomb01", "_ExternalDev04"
        });
    }
}