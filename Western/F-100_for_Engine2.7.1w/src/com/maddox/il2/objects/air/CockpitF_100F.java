...
public class CockpitF_100F extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                setNew.k14w = (5F * CockpitF_100F.k14TargetWingspanScale[((F_100)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitF_100F.k14TargetMarkScale[((F_100)aircraft()).k14WingspanType];
                ...
                float f3 = floatindex((f - 200F) * 0.04F, CockpitF_100F.k14BulletDrop) - CockpitF_100F.k14BulletDrop[0];
    ...
    public CockpitF_100F()
    {
        super("3DO/Cockpit/F-86K/F-100F.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        super.mesh.chunkSetAngles("Canopy", 0.0F, 0.0F, 25F * ((FlightModelMain) (super.fm)).CT.getCockpitDoor());
