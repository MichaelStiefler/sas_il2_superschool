...
public class BombB43nuke500ktpara_gn16 extends Bomb
{

    public BombB43nuke500ktpara_gn16()
    {
        chute = null;
        bOnChute = false;
    }
    ...
    {
        super.start();
        ttcurTM = World.Rnd().nextFloat(0.7F, 1.95F);
    ...
    public void interpolateTick()
    {
        ...
        {
            getSpeed(v3d);
            v3d.scale(0.97999999999999997D);
            if(v3d.z < -2D)
                v3d.z += 0.8F * Time.tickConstLenFs();
            setSpeed(v3d);
        } else
        if(curTm > ttcurTM)
        {
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.BombB43nuke500ktpara_gn16.class;
        Property.set(class1, "mesh", "3DO/Arms/USnukeB43_gn16/mono.sim");
        Property.set(class1, "radius", 22000F);
        Property.set(class1, "power", 500000000F);
        Property.set(class1, "powerType", 0);
        Property.set(class1, "kalibr", 0.457F);
        Property.set(class1, "massa", 980.0F);
