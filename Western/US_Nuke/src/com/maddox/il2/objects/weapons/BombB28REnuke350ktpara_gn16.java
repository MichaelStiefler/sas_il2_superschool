...
public class BombB28REnuke350ktpara_gn16 extends Bomb
{

    public BombB28REnuke350ktpara_gn16()
    {
        chute = null;
        bOnChute = false;
    }
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.BombB28REnuke350ktpara_gn16.class;
        Property.set(class1, "mesh", "3DO/Arms/USnukeB28_gn16/monoRE.sim");
        Property.set(class1, "radius", 20000F);
        Property.set(class1, "power", 350000000F);
        Property.set(class1, "powerType", 0);
        Property.set(class1, "kalibr", 0.58F);
        Property.set(class1, "massa", 970.0F);
