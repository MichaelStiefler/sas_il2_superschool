...
public class BombB57nuke5ktpara_gn16 extends Bomb
{

    public BombB57nuke5ktpara_gn16()
    {
        chute = null;
        bOnChute = false;
    }
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.BombB57nuke5ktpara_gn16.class;
        Property.set(class1, "mesh", "3DO/Arms/USnukeB57_gn16/mono.sim");
        Property.set(class1, "radius", 5000F);
        Property.set(class1, "power", 5000000F);
        Property.set(class1, "powerType", 0);
        Property.set(class1, "kalibr", 0.375F);
        Property.set(class1, "massa", 242.0F);
