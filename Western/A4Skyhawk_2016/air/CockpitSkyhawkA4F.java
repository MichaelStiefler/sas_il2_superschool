...
//            CockpitPilot, TypeGuidedMissileCarrier, Skyhawk, SkyhawkA4F, 
//            Cockpit
...
public class CockpitSkyhawkA4F extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f4 = ((Skyhawk)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitSkyhawkA4F.k14TargetWingspanScale[((Skyhawk)aircraft()).k14WingspanType]) / f4;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSkyhawkA4F.k14TargetMarkScale[((Skyhawk)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((Skyhawk)aircraft()).k14Mode;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            int i = ((Skyhawk)aircraft()).k14Mode;
            boolean flag = i < 2;
