...
public class MissileAGM84D_gn16 extends Missile implements MissileInterceptable {
	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAGM84D_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAGM84D_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AGM84ADJ_gn16/mono.sim");
		Property.set(class1, "meshDamage", "3do/arms/AGM84ADJ_gn16/mono_dD.sim");
		...
		Property.set(class1, "timeLife", 1200F);
		Property.set(class1, "timeFire", 12F);
		Property.set(class1, "force", 3200F);
		Property.set(class1, "timeSustain", 1100F);
		...
		Property.set(class1, "massaEnd", 361F);
		...
		Property.set(class1, "friendlyName", "AGM-84D");
		Property.set(class1, "iconFar_shortClassName", "AGM-84D Missile");
		Spawn.add(class1, new SPAWN());
	}

	public MissileAGM84D_gn16() {
      setMesh(Property.stringValue(getClass(), "mesh"));
      mesh.materialReplace("Ordnance1", "Ordnance1D");
      mesh.materialReplace("Ordnance1p", "Ordnance1Dp");
      mesh.materialReplace("Ordnance1q", "Ordnance1Dq");
	}

	public MissileAGM84D_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
