// Source File Name: MissileDerby_gn16.java
// Author:           western0221
...
public class MissileDerby_gn16 extends Missile {
	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileDerby_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileDerby_gn16.class;
		Property.set(class1, "mesh", "3do/arms/Derby_gn16/mono.sim");
		...
		Property.set(class1, "power", 5.5F); // RL Data: 23.0kg HE warhead, for realism reduced to 1/4th of it's RL weight
		Property.set(class1, "radius", 28.00F); // Radius of Explosion Effect
        Property.set(class1, "proximityFuzeRadius", 30F); // Exploding decition Radius of Proximity Fuze
		Property.set(class1, "kalibr", 0.150F); // Diameter of Missile Body
		Property.set(class1, "massa", 118.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 80F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "timeForNextLaunchAI", 7000L); // time between two Missile launches for AI
		...
		Property.set(class1, "maxLockGForce", 12.0F); // max. G-Force for lockon
		...
		Property.set(class1, "PkDistMax", 50000.0F); // max Distance for Pk calculation
		Property.set(class1, "leadPercent", 100.0F); // Track calculation lead value
		Property.set(class1, "maxGForce", 40.0F); // max turning rate G-Force
		Property.set(class1, "stepsForFullTurn", 9); // No. of ticks (1 tick = 30ms) for full control surface turn, higher value means slower reaction and smoother flight, lower value means higher agility
		...
		Property.set(class1, "friendlyName", "Derby"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileDerby_gn16() {
	}

	public MissileDerby_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
