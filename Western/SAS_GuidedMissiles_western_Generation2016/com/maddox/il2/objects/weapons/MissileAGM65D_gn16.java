...
public class MissileAGM65D_gn16 extends Missile  implements MissileInterceptable {

	static class SPAWN extends Missile.SPAWN {
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAGM65D_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}
	...
	static {
		...
		Property.set(class1, "groundTrackFactor", 384F);
	...
	public MissileAGM65D_gn16() {
	}

	public MissileAGM65D_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
