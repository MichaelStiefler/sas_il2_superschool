...
public class MissileSturmV_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileSturmV_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileSturmV_gn16.class;
		Property.set(class1, "mesh", "3do/arms/SturmV_gn16/monoclose.sim");
		Property.set(class1, "meshFly", "3do/arms/SturmV_gn16/monofly.sim");
		...
		Property.set(class1, "force", 7100F); // Rocket Engine Power (in Newton)
		...
		Property.set(class1, "dragCoefficient", 0.22F); // Aerodynamic Drag Coefficient
		Property.set(class1, "powerType", 0); // Type of Explosion. 0="Splash", 1="Splinters", 2="Napalm"
		Property.set(class1, "power", 10.5F); // RL Data: 5.3kg HEAT warhead, and make twice converting in HE
		Property.set(class1, "radius", 0.6F); // Radius of Explosion Effect , HEAT is very narrow rafius
		Property.set(class1, "kalibr", 0.130F); // Diameter of Missile Body
		Property.set(class1, "massa", 31.4F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 16.8F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "failureRate", 12.0F); // Failure rate in percent
		...
		Property.set(class1, "PkDistOpt", 2000.0F); // optimum Distance for Pk calculation
		Property.set(class1, "PkDistMax", 3750.0F); // max Distance for Pk calculation
		...
		Property.set(class1, "fxLockVolume", 0.01F); // Volume for Lock Tone, "1" is default
		Property.set(class1, "fxNoLock", (String) null); // prs file for No Lock Tone
		Property.set(class1, "fxNoLockVolume", 0.01F); // Volume for No Lock Tone, "1" is default
		...
		Property.set(class1, "friendlyName", "Sturm"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileSturmV_gn16() {
	}

	public MissileSturmV_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
