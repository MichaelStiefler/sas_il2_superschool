// Source File Name: MissileAIM4G_gn16.java
// Author:           western0221
...
public class MissileAIM4G_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM4G_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAIM4G_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AIM4G_gn16/mono.sim");
		...
		Property.set(class1, "timeSustain", 3.0F); // Rocket Sustained Motor Burn time in Seconds (0 for single stage rockets)
		Property.set(class1, "forceSustain", 7000F); // Rocket Sustained Power (in Newton)
		...
		Property.set(class1, "dragCoefficient", 0.36F); // Aerodynamic Drag Coefficient
		Property.set(class1, "powerType", 0); // Type of Explosion. 0="Splash", 1="Splinters", 2="Napalm"
		Property.set(class1, "power", 2.2F); // RL Data: 13.0kg HE warhead, for realism reduced to 1/6th of it's RL weight
		Property.set(class1, "radius", 8.0F); // Radius of Explosion Effect
		...
		Property.set(class1, "kalibr", 0.168F); // Diameter of Missile Body
		Property.set(class1, "massa", 66.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 47.8F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "PkDistMax", 11000.0F); // max Distance for Pk calculation
		...
		Property.set(class1, "friendlyName", "AIM-4G"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAIM4G_gn16() {
	}

	public MissileAIM4G_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
