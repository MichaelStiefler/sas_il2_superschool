...
public class MissileBGM71D_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileBGM71D_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileBGM71D_gn16.class;
		Property.set(class1, "mesh", "3do/arms/BGM71D_TOW2_gn16/mono.sim");
		Property.set(class1, "meshFly", "3do/arms/BGM71D_TOW2_gn16/monoFly.sim");
		...
		Property.set(class1, "friendlyName", "TOW2"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileBGM71D_gn16() {
	}

	public MissileBGM71D_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
