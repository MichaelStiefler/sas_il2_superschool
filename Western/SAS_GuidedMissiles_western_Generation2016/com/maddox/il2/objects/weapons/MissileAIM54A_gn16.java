...
public class MissileAIM54A_gn16 extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileAIM54A_gn16(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileAIM54A_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
        MissileInit(actor, netchannel, i, point3d, orient, f);
    }

    public MissileAIM54A_gn16()
    {
    }
    ...
    static 
    {
        ...
        Property.set(class1, "timeFire", 3.2F);
        Property.set(class1, "force", 200000F);
        Property.set(class1, "timeSustain", 80.0F);
        Property.set(class1, "forceSustain", 48000F);
        ...
        Property.set(class1, "proximityFuzeRadius", 60F);
        ...
        Property.set(class1, "PkDistMin", 3700F);
        Property.set(class1, "PkDistOpt", 40000F);
        Property.set(class1, "PkDistMax", 160000F);
        ...
        Property.set(class1, "friendlyName", "AIM-54A");
