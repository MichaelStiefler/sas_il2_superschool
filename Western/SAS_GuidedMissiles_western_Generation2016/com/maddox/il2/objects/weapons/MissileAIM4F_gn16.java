// Source File Name: MissileAIM4F_gn16.java
// Author:           western0221
...
public class MissileAIM4F_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM4F_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAIM4F_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AIM4F_gn16/mono.sim");
		...
		Property.set(class1, "massa", 68.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 49.8F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "friendlyName", "AIM-4F"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAIM4F_gn16() {
	}

	public MissileAIM4F_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
