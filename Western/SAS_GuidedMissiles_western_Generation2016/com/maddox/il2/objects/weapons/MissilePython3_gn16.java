// Source File Name: MissilePython3_gn16.java
// Author:           western0221
// Last Modified by: western0221 2018-09-16
...
public class MissilePython3_gn16 extends Missile {
	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissilePython3_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissilePython3_gn16.class;
		Property.set(class1, "mesh", "3do/arms/Python3_gn16/mono.sim");
		...
		Property.set(class1, "timeFire", 6.5F); // Rocket Booster Burn time in Seconds
		...
		Property.set(class1, "power", 2.6F); // RL Data: 11.0kg HE warhead, for realism reduced to 1/4th of it's RL weight
		Property.set(class1, "radius", 18.33F); // Radius of Explosion Effect
        Property.set(class1, "proximityFuzeRadius", 20F); // Exploding decition Radius of Proximity Fuze
		Property.set(class1, "kalibr", 0.150F); // Diameter of Missile Body
		Property.set(class1, "massa", 120.0F); // Missile Weight at Launch time
	...
	public MissilePython3_gn16() {
	}

	public MissilePython3_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
