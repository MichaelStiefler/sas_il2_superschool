// Source File Name: MissileAIM26A_gn16.java
// Author:           western0221
...
public class MissileAIM26A_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM26A_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAIM26A_gn16.class;
		...
		Property.set(class1, "power", 25000F); // RL Data: 250 ton Nuculear warhead, for realism reduced to 1/10th of it's RL weight
		Property.set(class1, "radius", 200.0F); // Radius of Explosion Effect
        Property.set(class1, "proximityFuzeRadius", 100F); // Exploding decition Radius of Proximity Fuze
	...
	public MissileAIM26A_gn16() {
	}

	public MissileAIM26A_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
