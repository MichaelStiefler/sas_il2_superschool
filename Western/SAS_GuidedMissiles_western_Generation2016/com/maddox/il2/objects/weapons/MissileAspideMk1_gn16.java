...
public class MissileAspideMk1_gn16 extends Missile {
	static class SPAWN extends Missile.SPAWN {
		...
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAspideMk1_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAspideMk1_gn16.class;
		...
		Property.set(class1, "massaEnd", 160.0F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "PkDistMax", 23000.0F); // max Distance for Pk calculation
		...
		Property.set(class1, "friendlyName", "Aspide"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAspideMk1_gn16() {
	}

	public MissileAspideMk1_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
