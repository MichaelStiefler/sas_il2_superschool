...
public class MissileAIM120A_gn16 extends Missile {
	...
	static {
		...
		Property.set(class1, "timeLife", 150F); // Rocket life time in Seconds
		Property.set(class1, "timeFire", 0.7F); // Rocket Booster Burn time in Seconds
		Property.set(class1, "force", 50000F); // Rocket Booster Power (in Newton)
		Property.set(class1, "timeSustain", 10.3F); // Rocket Sustained Motor Burn time in Seconds (0 for single stage rockets)
		Property.set(class1, "forceSustain", 19230.77F); // Rocket Sustained Power (in Newton)
		...
		Property.set(class1, "power", 15.70F); // RL Data: 157kg HE warhead, for realism reduced to 1/10th of it's RL weight
		Property.set(class1, "radius", 35F); // Radius of Explosion Effect
        Property.set(class1, "proximityFuzeRadius", 55F); // Exploding decition Radius of Proximity Fuze
		...
		Property.set(class1, "flareLockTime", 1300L); // time (in milliseconds) for missile locking on to different target, i.e. flare (sun, ground clutter etc.)
		...
		Property.set(class1, "maxGForce", 30.0F); // max turning rate G-Force
		...
		Property.set(class1, "fxNoLockVolume", 2.0F); // Volume for No Lock Tone, "1" is default
		...
		Property.set(class1, "friendlyName", "AIM-120A"); // Display Name of this missile
