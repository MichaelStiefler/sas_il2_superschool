// Source File Name: MissilePython5_gn16.java
// Author:           western0221
...
public class MissilePython5_gn16 extends Missile {
	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissilePython5_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissilePython5_gn16.class;
		Property.set(class1, "mesh", "3do/arms/Python5_gn16/mono.sim");
		...
		Property.set(class1, "power", 3.3F); // RL Data: 11.0kg HE warhead, for realism reduced to 1/4th of it's RL weight
		Property.set(class1, "radius", 19.50F); // Radius of Explosion Effect
        Property.set(class1, "proximityFuzeRadius", 21F); // Exploding decition Radius of Proximity Fuze
		Property.set(class1, "kalibr", 0.160F); // Diameter of Missile Body
		Property.set(class1, "massa", 105.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 70F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "PkDistOpt", 8000.0F); // optimum Distance for Pk calculation
		Property.set(class1, "PkDistMax", 20000.0F); // max Distance for Pk calculation
		...
		Property.set(class1, "friendlyName", "Python5"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissilePython5_gn16() {
	}

	public MissilePython5_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
