...
public class MissileAGM84A_gn16 extends Missile implements MissileInterceptable {
	static class SPAWN extends Missile.SPAWN {
		...
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAGM84A_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAGM84A_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AGM84ADJ_gn16/mono.sim");
		Property.set(class1, "meshDamage", "3do/arms/AGM84ADJ_gn16/mono_d.sim");
		...
		Property.set(class1, "timeFire", 120F);
		Property.set(class1, "force", 3100F);
		...
		Property.set(class1, "failureRate", 12F);
	...
	public MissileAGM84A_gn16() {
	}

	public MissileAGM84A_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
