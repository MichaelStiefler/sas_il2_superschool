...
public class MissileAGM45B_gn16 extends Missile {
	static class SPAWN extends Missile.SPAWN {
		...
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAGM45B_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAGM45B_gn16.class;
		...
		Property.set(class1, "timeLife", 90F);
		Property.set(class1, "timeFire", 20F);
		Property.set(class1, "force", 6000F);
		Property.set(class1, "timeSustain", 55F);
		Property.set(class1, "forceSustain", 3000F);
		...
		Property.set(class1, "power", 23.4F);
		Property.set(class1, "radius", 6.0F);
		...
		Property.set(class1, "friendlyName", "AGM-45B");
		Spawn.add(class1, new SPAWN());
	}

	public MissileAGM45B_gn16() {
	}

    public MissileAGM45B_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
