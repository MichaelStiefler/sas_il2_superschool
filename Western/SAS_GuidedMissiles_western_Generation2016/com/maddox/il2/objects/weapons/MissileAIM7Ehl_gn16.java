// AIM-7E 'Hot Launch' version for LAU-115 rail launcher.
// Source File Name: MissileAIM7Ehl_gn16.java
// Author:           western0221
...
public class MissileAIM7Ehl_gn16 extends Missile {
	static class SPAWN extends Missile.SPAWN {
		...
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM7Ehl_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}
	...
	static {
		...
		Property.set(class1, "failureRate", 65.0F); // Failure rate in percent
		...
		Property.set(class1, "maxGForce", 20.0F); // max turning rate G-Force
		...
		Property.set(class1, "friendlyName", "AIM-7E"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAIM7Ehl_gn16() {
	}

	public MissileAIM7Ehl_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
