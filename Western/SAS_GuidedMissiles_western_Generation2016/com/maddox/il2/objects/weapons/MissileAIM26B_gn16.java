// Source File Name: MissileAIM26B_gn16.java
// Author:           western0221
...
public class MissileAIM26B_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM26B_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAIM26B_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AIM26_gn16/mono.sim");
		Property.set(class1, "meshFly", "3do/arms/AIM26_gn16/monoFly.sim");
		Property.set(class1, "sprite", "3do/effects/RocketSidewinder/RocketSidewinderSpriteBlack.eff");
        Property.set(class1, "flame", "3do/Effects/RocketSidewinder/RocketAIM26Flame.sim");
		...
		Property.set(class1, "timeLife", 40F); // Rocket life time in Seconds
		Property.set(class1, "timeFire", 3.3F); // Rocket Engine Burn time in Seconds
		Property.set(class1, "force", 25000F); // Rocket Engine Power (in Newton)
		Property.set(class1, "timeSustain", 6.0F); // Rocket Sustained Motor Burn time in Seconds (0 for single stage rockets)
		Property.set(class1, "forceSustain", 6000F); // Rocket Sustained Power (in Newton)
		...
		Property.set(class1, "power", 2.5F); // RL Data: 18.1kg HE warhead, for realism reduced to 1/8th of it's RL weight
		Property.set(class1, "radius", 30.0F); // Radius of Explosion Effect
        Property.set(class1, "proximityFuzeRadius", 45F); // Exploding decition Radius of Proximity Fuze
		Property.set(class1, "kalibr", 0.290F); // Diameter of Missile Body
		Property.set(class1, "massa", 92.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 61.2F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "PkDistMax", 12000.0F); // max Distance for Pk calculation
		...
		Property.set(class1, "friendlyName", "AIM-26"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAIM26B_gn16() {
        setMesh(Property.stringValue(getClass(), "mesh"));
        mesh.materialReplace("Ordnance1", "Ordnance1B");
        mesh.materialReplace("Ordnance1p", "Ordnance1Bp");
        mesh.materialReplace("Ordnance1q", "Ordnance1Bq");
	}
	...
	public MissileAIM26B_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
