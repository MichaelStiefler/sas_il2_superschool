// Source File Name: MissileAIM9C_gn16.java
// Author:           Storebror
...
public class MissileAIM9C_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM9C_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAIM9C_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AIM9C_gn16/mono.sim");
		...
		Property.set(class1, "timeFire", 5.5F); // Rocket Engine Burn time in Seconds
		Property.set(class1, "force", 14500F); // Rocket Engine Power (in Newton)
		...
		Property.set(class1, "massa", 89.1F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 59.1F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "maxLockGForce", 5.0F); // max. G-Force for lockon
		...
		Property.set(class1, "friendlyName", "AIM-9C"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAIM9C_gn16() {
	}

	public MissileAIM9C_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
