...
public class MissileAGM114L_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAGM114L_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAGM114L_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AGM114_gn16/monoL.sim");
		...
		Property.set(class1, "power", 18.0F); // RL Data: 9kg HEAT warhead and make twice converting in HE
		...
		Property.set(class1, "massa", 49.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 39.0F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "PkDistOpt", 3000.0F); // optimum Distance for Pk calculation
		Property.set(class1, "PkDistMax", 9000.0F); // max Distance for Pk calculation
		...
		Property.set(class1, "friendlyName", "AGM-114L"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAGM114L_gn16() {
	}

	public MissileAGM114L_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
