...
public class MissileAGM114C_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAGM114C_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAGM114C_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AGM114_gn16/mono.sim");
		...
		Property.set(class1, "dragCoefficient", 0.28F); // Aerodynamic Drag Coefficient
		Property.set(class1, "powerType", 0); // Type of Explosion. 0="Splash", 1="Splinters", 2="Napalm"
		Property.set(class1, "power", 16.0F); // RL Data: 8kg HEAT warhead and make twice converting in HE
		...
		Property.set(class1, "massa", 45.5F); // Missile Weight at Launch time
		...
		Property.set(class1, "detectorType", Missile.DETECTOR_TYPE_LASER); // detector type
		...
		Property.set(class1, "groundTrackFactor", 512F); // lower value means higher probability of ground target tracking
		...
		Property.set(class1, "maxFOVfrom", 40.0F); // max Angle offset from launch A/C POV
		...
		Property.set(class1, "PkDistOpt", 2900.0F); // optimum Distance for Pk calculation
	...
	public MissileAGM114C_gn16() {
	}

	public MissileAGM114C_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
