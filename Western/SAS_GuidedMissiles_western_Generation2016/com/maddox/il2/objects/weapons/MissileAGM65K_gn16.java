...
public class MissileAGM65K_gn16 extends Missile  implements MissileInterceptable {
	static class SPAWN extends Missile.SPAWN {
		...
		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAGM65K_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAGM65K_gn16.class;
		...
		Property.set(class1, "sunBrightThreshold", 0.02F);
		...
		Property.set(class1, "groundTrackFactor", 1024F);
		Property.set(class1, "flareLockTime", 1000L);
		Property.set(class1, "trackDelay", 1000L);
		Property.set(class1, "failureRate", 6F);
		...
		Property.set(class1, "friendlyName", "AGM-65K");
		Spawn.add(class1, new SPAWN());
	}

	public MissileAGM65K_gn16() {
        setMesh(Property.stringValue(getClass(), "mesh"));
        mesh.materialReplace("Maverick", "MaverickK");
        mesh.materialReplace("Maverickp", "MaverickKp");
        mesh.materialReplace("Maverickq", "MaverickKq");
	}

    public MissileAGM65K_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
