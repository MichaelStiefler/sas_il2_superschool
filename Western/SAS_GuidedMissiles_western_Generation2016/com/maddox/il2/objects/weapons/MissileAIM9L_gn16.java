...
public class MissileAIM9L_gn16 extends Missile {
	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM9L_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAIM9L_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AIM9L_gn16/mono.sim");
		...
		Property.set(class1, "timeFire", 5.5F); // Rocket Booster Burn time in Seconds
		Property.set(class1, "force", 14000F); // Rocket Booster Power (in Newton)
		...
		Property.set(class1, "power", 1.02F); // RL Data: 4.5kg HE warhead, for realism reduced to 1/10th of it's RL weight
		...
		Property.set(class1, "kalibr", 0.1288F); // Diameter of Missile Body
		Property.set(class1, "massa", 86.0F); // Missile Weight at Launch time
		Property.set(class1, "massaEnd", 56F); // Missile Weight when Booster burned out
		...
		Property.set(class1, "friendlyName", "AIM-9L"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAIM9L_gn16() {
	}

	public MissileAIM9L_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
