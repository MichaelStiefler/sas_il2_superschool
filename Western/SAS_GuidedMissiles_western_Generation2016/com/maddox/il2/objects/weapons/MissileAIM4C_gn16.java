// Source File Name: MissileAIM4C_gn16.java
// Author:           western0221
...
public class MissileAIM4C_gn16 extends Missile {

	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissileAIM4C_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissileAIM4C_gn16.class;
		Property.set(class1, "mesh", "3do/arms/AIM4C_gn16/mono.sim");
		...
		Property.set(class1, "failureRate", 40.0F); // Failure rate in percent
		...
		Property.set(class1, "maxFOVto", 40.0F); // max Angle offset from target aft POV
		Property.set(class1, "PkMaxFOVfrom", 25.0F); // max Angle offset from launch A/C POV for Pk calculation
		Property.set(class1, "PkMaxFOVto", 50.0F); // max Angle offset from target aft POV for Pk calculation
		Property.set(class1, "PkDistMin", 500.0F); // min Distance for Pk calculation
		...
		Property.set(class1, "friendlyName", "AIM-4C"); // Display Name of this missile
		Spawn.add(class1, new SPAWN());
	}

	public MissileAIM4C_gn16() {
	}

	public MissileAIM4C_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
