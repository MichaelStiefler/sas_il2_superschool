...
public class MissilePython4_gn16 extends Missile {
	static class SPAWN extends Missile.SPAWN {

		public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
			new MissilePython4_gn16(actor, netchannel, i, point3d, orient, f);
		}
	}

	static {
		Class class1 = MissilePython4_gn16.class;
		Property.set(class1, "mesh", "3do/arms/Python4_gn16/mono.sim");
		...
		Property.set(class1, "timeFire", 6.6F); // Rocket Booster Burn time in Seconds
		Property.set(class1, "force", 14500F); // Rocket Booster Power (in Newton)
		...
		Property.set(class1, "power", 2.8F); // RL Data: 11.0kg HE warhead, for realism reduced to 1/4th of it's RL weight
		Property.set(class1, "radius", 18.77F); // Radius of Explosion Effect
	...
	public MissilePython4_gn16() {
	}

	public MissilePython4_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
