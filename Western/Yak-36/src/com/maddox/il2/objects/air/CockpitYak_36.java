// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 2013/11/19 15:36:58
...
public class CockpitYak_36 extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                setNew.starter1 = 0.94F * setOld.starter1 + 0.06F * (((FlightModelMain) (fm)).EI.engines[0].getStage() > 0 && ((FlightModelMain) (fm)).EI.engines[0].getStage() < 6 ? 1.0F : 0.0F);
                setNew.starter2 = 0.94F * setOld.starter2 + 0.06F * (((FlightModelMain) (fm)).EI.engines[1].getStage() > 0 && ((FlightModelMain) (fm)).EI.engines[1].getStage() < 6 ? 1.0F : 0.0F);
    ...
    {
        super.mesh.chunkSetAngles("Canopy", 0.0F, cvt(((FlightModelMain) (super.fm)).CT.getCockpitDoor(), 0.01F, 0.8F, 0.0F, 94F), 0.0F);
        ...
        pictMet1 = 0.96F * pictMet1 + 0.04F * (0.6F * ((FlightModelMain) (super.fm)).EI.engines[0].getThrustOutput() * ((FlightModelMain) (super.fm)).EI.engines[0].getControlThrottle() * (((FlightModelMain) (super.fm)).EI.engines[0].getStage() == 6 ? 1.0F : 0.02F));
        super.mesh.chunkSetAngles("NeedExhstPress1", 0.0F, cvt(pictMet1, 0.0F, 1.0F, 0.0F, 270F), 0.0F);
        super.mesh.chunkSetAngles("NeedFuelPress1", cvt(((FlightModelMain) (super.fm)).M.fuel > 1.0F ? 0.55F : 0.0F, 0.0F, 1.0F, 0.0F, 284F), 0.0F, 0.0F);
        ...
        super.mesh.chunkSetAngles("NeedRPM2", 0.0F, floatindex(cvt(((FlightModelMain) (super.fm)).EI.engines[1].getRPM(), 0.0F, 4500F, 0.0F, 14F), rpmScale), 0.0F);
        pictMet2 = 0.96F * pictMet2 + 0.04F * (0.6F * ((FlightModelMain) (super.fm)).EI.engines[1].getThrustOutput() * ((FlightModelMain) (super.fm)).EI.engines[1].getControlThrottle() * (((FlightModelMain) (super.fm)).EI.engines[1].getStage() == 6 ? 1.0F : 0.02F));
        super.mesh.chunkSetAngles("NeedExhstPress2", 0.0F, cvt(pictMet2, 0.0F, 1.0F, 0.0F, 270F), 0.0F);
        super.mesh.chunkSetAngles("NeedFuelPress2", cvt(((FlightModelMain) (super.fm)).M.fuel > 1.0F ? 0.55F : 0.0F, 0.0F, 1.0F, 0.0F, 284F), 0.0F, 0.0F);
