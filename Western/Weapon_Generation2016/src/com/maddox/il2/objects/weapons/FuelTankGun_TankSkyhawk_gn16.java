// 300 gal. Fueltank gun for A-4 Skyhawk and A-6 Intruder with horizontal 2x tailfins
...
public class FuelTankGun_TankSkyhawk_gn16 extends FuelTankGun
{
    ...
    public FuelTankGun_TankSkyhawk_gn16()
    {
    }

    public void matHighvis()
    {
        ((FuelTank_TankSkyhawk_gn16) bomb).matHighvis();
    }

    public void matSEAcamo()
    {
        ((FuelTank_TankSkyhawk_gn16) bomb).matSEAcamo();
    }

    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.FuelTankGun_TankSkyhawk_gn16.class;
        Property.set(class1, "bulletClass", (Object) com.maddox.il2.objects.weapons.FuelTank_TankSkyhawk_gn16.class);
