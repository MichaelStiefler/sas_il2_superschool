// 150 gal. Fueltank for F-5E TigerII with 2x tailfin in horizontal.
...
public class FuelTank_TankF5E150galH2_gn16 extends FuelTank
    implements SkinnableOrdnance
{

    public FuelTank_TankF5E150galH2_gn16()
    {
    }
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.FuelTank_TankF5E150galH2_gn16.class;
        Property.set(class1, "mesh", "3DO/Arms/TankF5E150gal_gn16/monoh2.sim");
        Property.set(class1, "kalibr", 0.60F);
        Property.set(class1, "massa", 550.4F);
		Property.set(class1, "dragCoefficient", 0.42F); // Aerodynamic Drag Coefficient, Stock WWII droptanks=1.0F
    }
}