// USSR night illumination flare bomb SAB-100-90 with a parachute, 24 cm diameter --- 100 kg weight.
...
public class BombSAB100_90_gn16 extends Bomb
{

    public BombSAB100_90_gn16()
    {
        chute = null;
        bOnChute = false;
        bCollideLand = false;
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.BombSAB100_90_gn16.class;
        Property.set(class1, "mesh", "3DO/Arms/SAB100_90_gn16/mono.sim");
        Property.set(class1, "emitColor", new Color3f(1.0F, 1.0F, 0.95F));
        Property.set(class1, "emitLen", 250F);
        Property.set(class1, "emitMax", 10F);
        Property.set(class1, "timeLife", 260F);
        ...
        Property.set(class1, "massa", 95.6F);
