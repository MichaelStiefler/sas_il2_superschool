// Kh-25MR : Russian Radio remote controle Air-to-Ground missile 300kg
...
public class RocketKh25MR_gn16 extends RemoteControlRocket
{
    public RocketKh25MR_gn16()
    {
        super();
    }

    public RocketKh25MR_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
   	...
   	Class class1
	    = (class$com$maddox$il2$objects$weapons$RocketKh25MR_gn16 == null
		  ...
		  = _mthclass$("com.maddox.il2.objects.weapons.RocketKh25MR_gn16"))
	       : class$com$maddox$il2$objects$weapons$RocketKh25MR_gn16);
        Property.set(class1, "mesh", "3do/arms/Kh25_gn16/Kh25MR.sim");
