...
public class RocketAGM12C_gn16 extends RemoteControlRocket
{
    public RocketAGM12C_gn16()
    {
        super();
    }

    public RocketAGM12C_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
