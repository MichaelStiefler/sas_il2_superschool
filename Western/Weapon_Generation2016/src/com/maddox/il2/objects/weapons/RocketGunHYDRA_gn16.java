...
public class RocketGunHYDRA_gn16 extends RocketGun
{

    public RocketGunHYDRA_gn16()
    {
    }
    ...
    static Class class$com$maddox$il2$objects$weapons$RocketGunHYDRA_gn16;
    static Class class$com$maddox$il2$objects$weapons$RocketHYDRA_gn16;

    static 
    {
        Class class1
	    = (class$com$maddox$il2$objects$weapons$RocketGunHYDRA_gn16 == null
	       ? (class$com$maddox$il2$objects$weapons$RocketGunHYDRA_gn16
		  = _mthclass$("com.maddox.il2.objects.weapons.RocketGunHYDRA_gn16"))
	       : class$com$maddox$il2$objects$weapons$RocketGunHYDRA_gn16);
        Class classbu
