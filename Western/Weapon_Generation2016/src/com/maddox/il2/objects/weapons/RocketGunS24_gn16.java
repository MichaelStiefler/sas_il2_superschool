...
public class RocketGunS24_gn16 extends RocketGun
{

    public RocketGunS24_gn16()
    {
    }
    ...
    static Class class$com$maddox$il2$objects$weapons$RocketGunS24_gn16;
    static Class class$com$maddox$il2$objects$weapons$RocketS24_gn16;

    static 
    {
        Class class1
        = (class$com$maddox$il2$objects$weapons$RocketGunS24_gn16 == null
           ? (class$com$maddox$il2$objects$weapons$RocketGunS24_gn16
          = _mthclass$("com.maddox.il2.objects.weapons.RocketGunS24_gn16"))
           : class$com$maddox$il2$objects$weapons$RocketGunS24_gn16);
        Class classbu
