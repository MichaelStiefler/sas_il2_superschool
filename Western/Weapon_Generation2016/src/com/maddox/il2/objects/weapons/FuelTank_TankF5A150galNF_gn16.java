// 150 gal. Fueltank for F-5A Freedom Fighter with NO tailfin
...
public class FuelTank_TankF5A150galNF_gn16 extends FuelTank
    implements SkinnableOrdnance
{

    public FuelTank_TankF5A150galNF_gn16()
    {
    }
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.FuelTank_TankF5A150galNF_gn16.class;
        Property.set(class1, "mesh", "3DO/Arms/TankF5A150gal_gn16/mononf.sim");
