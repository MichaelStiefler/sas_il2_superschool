...
public class MissileKh15S extends Missile implements MissileInterceptable {
  ...
  static {
		Class class1 = (class$com$maddox$il2$objects$weapons$MissileKh15S == null
	...
	public MissileKh15S(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
