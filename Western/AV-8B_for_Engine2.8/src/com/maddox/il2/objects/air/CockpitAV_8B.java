...
public class CockpitAV_8B extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            setNew.throttler = (10F * setOld.throttler + fm.EI.engines[0].getControlThrottle()) / 11F;
            float f = 200F;
            if(((AV_8B) aircraft()).radargunsight == 0 && ((AV_8B) aircraft()).k14Mode == 1)
                f = 200F;
            if(((AV_8B) aircraft()).radargunsight == 1 && ((AV_8B) aircraft()).k14Mode == 1)
                f = ((AV_8B) aircraft()).k14Distance;
            Point3d pointAC = ((Actor) (World.getPlayerAircraft())).pos.getAbsPoint();
            float z = (float)((Tuple3d) (pointAC)).z;
            if((((AV_8B) aircraft()).radargunsight == 2 || ((AV_8B) aircraft()).radargunsight == 3) && ((AV_8B) aircraft()).k14Mode == 1){
                f = z / (float)Math.cos(Math.toRadians(fm.Or.getPitch()-270F)) + 200F;
            }
            setNew.k14w = (5F * CockpitAV_8B.k14TargetWingspanScale[((AV_8B) aircraft()).k14WingspanType]) / f;
            setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
            setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitAV_8B.k14TargetMarkScale[((AV_8B) aircraft()).k14WingspanType];
            setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((AV_8B) aircraft()).k14Mode;
            ...
            float f3 = floatindex((f - 200F) * 0.04F, CockpitAV_8B.k14BulletDrop) - CockpitAV_8B.k14BulletDrop[0];
            if(((AV_8B) aircraft()).radargunsight == 2)
                f3 = floatindex((f - 200F) * 0.04F, CockpitAV_8B.k14RocketDrop) - CockpitAV_8B.k14RocketDrop[0];
            ...
            if(cockpitDimControl)
            {
                ...
                setNew.dimPosition = setOld.dimPosition + 0.05F;
            if(fm.EI.engines[0].getRPM() > 200F || fm.EI.engines[0].getRPM() > 200F)
    ...
    public CockpitAV_8B()
    {
        super("3DO/Cockpit/F-18/AV8B.him", "bf109");
        gun = new Gun[4];
        ...
        ((AV_8B) aircraft()).bWantBeaconKeys = true;  //TODO:Radar parameter
        t2 = 0L;
        t3 = 0L;
        FOV = 1.0D;
    ...
    {
        if((((AV_8B) aircraft()).ILS != true) || (!setNew.isBatteryOn && !setNew.isGeneratorAllive))
        {
    ...
    private void HUDgunsight()  //TODO Gunsight
    {
        if ((fm.AS.astateCockpitState & 2) == 0)
        {
            ...
            else if (i == 1)
            {
                ...
                if(((AV_8B) aircraft()).radargunsight == 1)
                {
                ...
                else if(((AV_8B) aircraft()).radargunsight == 0)
                {
                    super.mesh.chunkVisible("Z_Z_RETICLE", false);
                ...
                if(((AV_8B) aircraft()).radargunsight == 3)
                {
    ...
    public void radarclutter(float r)  //TODO: Radar
    {
        ...
        if(!setNew.isGeneratorAllive || !((AV_8B) aircraft()).radartoggle)
        {
            ...
            ((AV_8B) aircraft()).radarmode = 0;
            ((AV_8B) aircraft()).lockmode = 0;
        }
        else
        {
            radar = true;
            if(((AV_8B) aircraft()).k14Mode != 1)
            {
                super.mesh.chunkVisible("Z_Z_radarlock", false);
                super.mesh.chunkVisible("Z_Z_missilelock", false);
            }
        ...
        if(((AV_8B) aircraft()).radarvrt == 0 && ((AV_8B) aircraft()).radarhol == 0)
            super.mesh.chunkVisible("Z_Z_lockgate", false);
        else
            super.mesh.chunkVisible("Z_Z_lockgate", true);
        resetYPRmodifier();
        Cockpit.xyz[1] = -((AV_8B) aircraft()).radarvrt * 1.3333F;
        Cockpit.xyz[2] = ((AV_8B) aircraft()).radarhol * ((AV_8B) aircraft()).radarrange * 1.3333F;
        super.mesh.chunkSetLocate("Z_Z_lockgate", Cockpit.xyz, Cockpit.ypr);
        boolean flag = false;
        if(((AV_8B) aircraft()).radarmode == 0 && ((AV_8B) aircraft()).lockmode == 0)
        {
            if(oldrightscreen != 1)
            ...
            super.mesh.chunkVisible("Z_Z_RADAR_MBRG", false);
            super.mesh.chunkVisible("Z_Z_RADAR_TBRG", false);
            if((((AV_8B) aircraft()).radarvrt != 0F || ((AV_8B) aircraft()).radarhol != 0F) && t3  + 60000L < ts)
            {
                ((AV_8B) aircraft()).radarvrt = 0F;
                ((AV_8B) aircraft()).radarhol = 0F;
                t3 = ts;
            }
        }
        if(((AV_8B) aircraft()).radarmode == 0 && ((AV_8B) aircraft()).lockmode == 1)
        {
            if(oldrightscreen != 1)
                super.mesh.materialReplace("HDDR", "radarframe");
            oldrightscreen = 1;
        ...
        else if(((AV_8B) aircraft()).radarmode == 1)
        {
            if(oldrightscreen != 1)
                super.mesh.materialReplace("HDDR", "radarframe");
            oldrightscreen = 1;
        ...
        if(((AV_8B) aircraft()).radarmode < 2)
        {
            ...
            resetYPRmodifier();
            if(((AV_8B) aircraft()).lockmode == 0 || ((AV_8B) aircraft()).radarmode == 1)
                Cockpit.xyz[0] = x * 1.3333F;
            if(((AV_8B) aircraft()).lockmode == 1 && ((AV_8B) aircraft()).radarmode == 0)
                Cockpit.xyz[0] = (x - ((AV_8B) aircraft()).radarvrt / 4F) * 1.3333F;
            super.mesh.chunkSetLocate("Z_Z_Scan_1", Cockpit.xyz, Cockpit.ypr);
        }
        else if(((AV_8B) aircraft()).radarmode == 2)
        {
            if(((AV_8B) aircraft()).lockmode == 0)
            {
                radarground();
                super.mesh.chunkVisible("Z_Z_Scan_1", true);
            }
        ...
        try
        {
            ...
            if(Actor.isValid(ownaircraft) && Actor.isAlive(ownaircraft))
            {
                ...
                if(i1 > 0)
                {
                    ...
                    for(int j = 0; j < i1; j++)
                    {
                        Tuple3d tuppl = (Tuple3d) ((Radardata) (radarPlane.get(j))).p3d;
                        double x = tuppl.x;
                        if(x > (double)RClose && nt <= nTgts)
                        {
                            ...
                            double NewX = -tuppl.y * FOV; // spanning
                            double NewY = tuppl.x; //distance
    ...
    public void radaracquire(float r)  //TODO scan acquire
    {
        try
        {
            ...
            radarLock.clear();
            victim.clear();
            double v = -((((AV_8B) aircraft()).radarvrt + ((float)Math.sin(Math.toRadians(fm.Or.getRoll())) * 0.011F)) / ScX);
            double h = ((((AV_8B) aircraft()).radarhol * ((AV_8B) aircraft()).radarrange) / (ScY));
            float mach = 0F;
            float alt = 0F;
            float dif = 0F;
            float HDG = 0F;
            ...
            if(Actor.isValid(ownaircraft) && Actor.isAlive(ownaircraft))
            {
                ...
                for(int j = 0; j < i; j++)
                {
                    ...
                    if((actor instanceof Aircraft) && actor != World.getPlayerAircraft() && actor.getArmy() != World.getPlayerArmy()) //basically tell that target is not your own aircraft and not friendly aircraft
                    {
                        ...
                        if(((Tuple3d) (pointOrtho)).x > h - 500D && ((Tuple3d) (pointOrtho)).x < h + 500D && ((Tuple3d) (pointOrtho)).x < 48000D && ((Tuple3d) (pointOrtho)).y < v / (30D / ((Tuple3d) (pointOrtho)).x) + 500D && ((Tuple3d) (pointOrtho)).y > v / (30D / ((Tuple3d) (pointOrtho)).x) - 500D && (((Tuple3d) (pointOrtho)).z < ((Tuple3d) (pointOrtho)).x * 0.56397023426 && ((Tuple3d) (pointOrtho)).z > -((Tuple3d) (pointOrtho)).x * 0.56397023426))
                        {
                            ...
                            victim.add(actor);
                            ((AV_8B) aircraft()).setSemiActiveRadarLockedActor(actor);
                        }
                    }
                }
                i = victim.size();
                ...
                if(i1 > 0)
                {
                    ...
                    if(x1 > (double)RClose && nt <= nTgts)
                    {
                        ...
                        float f1 = FOrigY + (float)(NewY * ScY);
                        ((AV_8B) aircraft()).radarvrt = f;
                        ((AV_8B) aircraft()).radarhol = f1 / (((AV_8B) aircraft()).radarrange);
                        if(((AV_8B) aircraft()).radarvrt > 0.03625F || ((AV_8B) aircraft()).radarvrt < -0.03625F)
                            super.mesh.chunkVisible("Z_Z_Scan_1", false);
                        if(f1 < 0)
                            f1 = 0;
                ...
                {    // hide everything when there's no enemy
                    ...
                    super.mesh.chunkVisible("Z_Z_Radarbrg", false);
                    ((AV_8B) aircraft()).lockmode = 0;
                    ((AV_8B) aircraft()).setSemiActiveRadarLockedActor(null);
                }
            }
        ...
        try
        {
            ...
            if(Actor.isValid(ownaircraft) && Actor.isAlive(ownaircraft))
            {
                ...
                if(i1 > 0)
                {
                    ...
                    for(int j = 0; j < i1; j++)
                    {
                        Tuple3d tupgr = (Tuple3d) ((Radardata) (radarGround.get(j))).p3d;
                        double x = tupgr.x;
                        if(x > (double)RClose && nt <= nTgts)
                        {
                            FOV = 30D / x; // distance relationship, to adjust the deviation of radar mark when getting closer to target planes
                            double NewX = -tupgr.y * FOV; // spanning
                            double NewY = tupgr.x; //distance
                            float f = FOrigX + (float)(NewX * ScX) - ((float)Math.sin(Math.toRadians(fm.Or.getRoll())) * 0.011F); //FOrigX currently do nothing
                            float f1 = FOrigY + (float)(NewY * ScY);
                            if(f1 < 0)
                                f1 = 0;
    ...
    public void radaracquireground(float r)  //TODO scan acquire
    {
        try
        {
            ...
            if(Actor.isValid(ownaircraft) && Actor.isAlive(ownaircraft))
            {
                ...
                {
                    Actor actor = (Actor)list.get(j);
                    if(((actor instanceof CarGeneric) || (actor instanceof TankGeneric) || (actor instanceof ShipGeneric) || (actor instanceof BigshipGeneric) || (actor instanceof BridgeSegment)) && !(actor instanceof StationaryGeneric) && actor != World.getPlayerAircraft() && actor.getArmy() != World.getPlayerArmy())
                    {
                        Vector3d vector3d = new Vector3d();
                        vector3d.set(pointAC);
                        Point3d pointOrtho = new Point3d();
                        ...
                        {
                            radarLock.add(pointOrtho);
                            ((AV_8B) aircraft()).setGroundRadarLockedActor(actor);
                        }
                    }
                }
                int i1 = radarLock.size();
                ...
                {    // hide everything when there's no enemy
                    ...
                    if(super.mesh.isChunkVisible("Z_Z_lockgate"))
                        super.mesh.chunkVisible("Z_Z_lockgate", false);
                    ((AV_8B) aircraft()).lockmode = 0;
                    ((AV_8B) aircraft()).setGroundRadarLockedActor(null);
                }
            }
    ...
    protected void backupGauges(float f)  //TODO Gauges
    {
        ...
        float bingo = ((AV_8B) aircraft()).Bingofuel / 1000F;
        ...
        float fuelinteltempR = fm.EI.engines[0].tWaterOut;
        ...
        float N1R = cvt(fm.EI.engines[0].getRPM(), 0.0F, 4080F, 0F, 100F) / 10F;
        if(N1L < N1R)  N1L = N1R;
        ...
        float FFR = fm.EI.engines[0].tmpF;
        if(FFL < FFR)  FFL = FFR;
        ...
        float extempR = cvt(fm.EI.engines[0].tOilOut, 0F, 120F, 0F, 80F);
        ...
        float oilpressR = 1.0F + 0.05F * fm.EI.engines[0].tOilOut * fm.EI.engines[0].getReadyness();
...
//        if(((AV_8B) aircraft()).bHasCenterTank && !fm.M.bFuelTanksDropped)
//            tankExC = (((AV_8B) aircraft()).checkfuel(0) / 1000F) * 2.20462262F;
        ...
        if(!fm.M.bFuelTanksDropped)
            tankExL = (((AV_8B) aircraft()).checkfuel(0) / 1000F) * 2.20462262F;
    ...
    protected void movescreenfuelflow()  //TODO fuel flow
    {
        ...
        float bingo = ((AV_8B) aircraft()).Bingofuel / 2.20462262F;
    ...
    protected void movescreenengines()  //TODO Engine
    {
        ...
        float N1R = cvt(fm.EI.engines[0].getRPM(), 0.0F, 4080F, 0F, 100F);
        f2 = N1R / 10F;
        if(f2 > 9.9F)
            f2 = 9.9F;
        f3 = (float)(int)f2 * 36F;
        ...
        if(f4 == 0F && f3 == 0F)
            ...
            super.mesh.chunkVisible("Z_Z_HDD_NUM25_3", true);
        super.mesh.chunkSetAngles("Z_Z_HDD_NUM25_3", 0.0F, 0.0F, f4);
        float N2R = cvt(fm.EI.engines[0].getRPM() * 0.85294117647058823529411764705882F, 0.0F, 3480F, 0F, 100F);
        f2 = N2R / 10F;
        if(f2 > 9.9F)
            f2 = 9.9F;
        f3 = (float)(int)f2 * 36F;
        ...
        float extempR = cvt(fm.EI.engines[0].tOilOut, 0F, 120F, 10F, 838F);
        f2 = extempR / 100F;
        f3 = (float)(int)f2 * 36F;
        if(f3 == 0F)
            super.mesh.chunkVisible("Z_Z_HDD_NUM32_2", false);
        ...
        super.mesh.chunkVisible("Z_Z_HDD_NUM35_4", true);
        super.mesh.chunkSetAngles("Z_Z_HDD_NUM35_4", 0.0F, 0.0F, f7);
        float thrustR = (fm.EI.engines[0].getPowerOutput() < 1.00F ? cvt(fm.EI.engines[0].getPowerOutput(),0F,1.0F,0F,4800F) : cvt(fm.EI.engines[0].getPowerOutput(),1.00F,1.10F,4800F,7950F));
        f2 = thrustR / 10000F;
        f3 = (float)(int)f2 * 36F;
        if(f3 == 0F)
            super.mesh.chunkVisible("Z_Z_HDD_NUM212_2", false);
        ...
        super.mesh.chunkSetAngles("Z_Z_HDD_NUM37_3", 0.0F, 0.0F, f4);
        super.mesh.chunkVisible("Z_Z_HDD_NUM37_4", false);
        shake = (fm.EI.engines[0].w / fm.EI.engines[0].wMax) * fm.EI.engines[0].thrustMax * (float)Math.sqrt(fm.getSpeed() / 94F);
        float enginevibR = cvt(shake, 0.0F, fm.EI.engines[0].thrustMax, 0.05F, 0.21F);
        f2 = enginevibR * 10F;
        f3 = (float)(int)f2 * 36F;
        if(f3 == 0F)
            super.mesh.chunkVisible("Z_Z_HDD_NUM38_2", false);
        ...
        float CPRR = fm.EI.engines[0].getManifoldPressure();
        float TDPL = fm.EI.engines[0].getControlCompressor();
        float TDPR = fm.EI.engines[0].getControlCompressor();
    }
