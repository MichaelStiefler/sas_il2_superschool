...
public class IJNoxTorpedo extends Bomb
{
    ...
    private void surface()
    {
        ...
        LineEff = Eff3DActor.New(this, null, null, 1.0F, "3DO/Effects/Tracers/533mmTorpedo/Line.eff", -1F);
    }
    ...
    public void interpolateTick()
    {
        ...
        } else
        {
            ...
            if(Time.current() > started + travelTime || !World.land().isWater(P.x, P.y))
                sendexplosion();
            if(Time.current() > started + 9000L && LineEff!=null){
                Eff3DActor.finish( LineEff );  LineEff=null;
            }
        }
        updateSound();
    }
    ...
    private Eff3DActor LineEff=null;
