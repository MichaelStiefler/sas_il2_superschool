...
public class BombGunRNMkVIII53Torpex extends TorpedoApparatus
{
  ...
  static Class class$com$maddox$il2$objects$weapons$BombGunRNMkVIII53Torpex;
  static Class class$com$maddox$il2$objects$weapons$BombRNMkVIII53Torpex;

  static{
		Class class1
	    = (class$com$maddox$il2$objects$weapons$BombGunRNMkVIII53Torpex == null
	       ? (class$com$maddox$il2$objects$weapons$BombGunRNMkVIII53Torpex
		  = class$("com.maddox.il2.objects.weapons.BombGunRNMkVIII53Torpex"))
	       : class$com$maddox$il2$objects$weapons$BombGunRNMkVIII53Torpex);
