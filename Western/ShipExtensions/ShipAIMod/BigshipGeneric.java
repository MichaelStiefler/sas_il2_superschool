...
label0:
    ...
    public int targetMissile(ShipAim aim, Actor actor, float f, boolean flag)
    {
        ...
        point3d.scale(Rnd(0.995D, 1.0049999999999999D));
        ...
        if(!parts[firingdevice.part_idx].pro.TRACKING_ONLY)
        {
            ...
            else
            {
               if( bLogDetail )
                ...
                Class[] constructorParameterClasses2 = new Class[6];
                ...
                Object[] constructorParameter2 = new Object[6];
...
//                effreserve2[i]._setIntesity(0.0F);
    ...
    private Eff3DActor effdatum[] = new Eff3DActor[14];
