...
public class MI8T extends MI8xyz
{
    ...
    static
    {
        ...
        try
        {
            ...
            a_lweaponslot[12] = new Aircraft._WeaponSlot(2, "RocketGunS5M_gn16", 32);
            a_lweaponslot[13] = new Aircraft._WeaponSlot(2, "RocketGunS5M_gn16", 32);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "4xUB-32-57";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            ...
            a_lweaponslot[12] = new Aircraft._WeaponSlot(2, "RocketGunS5M_gn16", 32);
            a_lweaponslot[13] = new Aircraft._WeaponSlot(2, "RocketGunS5M_gn16", 32);
            a_lweaponslot[14] = new Aircraft._WeaponSlot(2, "RocketGunS5M_gn16", 32);
            a_lweaponslot[15] = new Aircraft._WeaponSlot(2, "RocketGunS5M_gn16", 32);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            ...
            a_lweaponslot[12] = new Aircraft._WeaponSlot(2, "RocketGunS8_gn16", 20);
            a_lweaponslot[13] = new Aircraft._WeaponSlot(2, "RocketGunS8_gn16", 20);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            ...
            a_lweaponslot[2] = new Aircraft._WeaponSlot(7, "RocketGunFlare_gn16", 35);
            a_lweaponslot[3] = new Aircraft._WeaponSlot(7, "RocketGunFlare_gn16", 35);
            a_lweaponslot[8] = new Aircraft._WeaponSlot(3, "BombGunFAB250M46_gn16", 1);
            a_lweaponslot[9] = new Aircraft._WeaponSlot(3, "BombGunFAB250M46_gn16", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            ...
            a_lweaponslot[2] = new Aircraft._WeaponSlot(7, "RocketGunFlare_gn16", 35);
            a_lweaponslot[3] = new Aircraft._WeaponSlot(7, "RocketGunFlare_gn16", 35);
            a_lweaponslot[8] = new Aircraft._WeaponSlot(3, "BombGunFAB100M46_gn16", 1);
            a_lweaponslot[9] = new Aircraft._WeaponSlot(3, "BombGunFAB100M46_gn16", 1);
