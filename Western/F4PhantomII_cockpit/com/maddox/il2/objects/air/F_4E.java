    ...
    implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump
{
    ...
    public void update(float f)
    {
        ...
        if(Eto0 > 1.001F && bEs0)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto0 * 26500D;
        if(Eto1 > 1.001F && bEs1)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto1 * 26500D;
        if(super.FM.getAltitude() > 0.0F && (double)calculateMach() >= 1.2D && bEs0)
            ((FlightModelMain) (super.FM)).producedAF.x -= Eto0 * 10000D;
        if(super.FM.getAltitude() > 0.0F && (double)calculateMach() >= 1.2D && bEs1)
            ((FlightModelMain) (super.FM)).producedAF.x -= Eto1 * 10000D;
        if(super.FM.getAltitude() > 500F && (double)calculateMach() >= 1.2D && bEs0)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto0 * 7000D;
        if(super.FM.getAltitude() > 500F && (double)calculateMach() >= 1.2D && bEs1)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto1 * 7000D;
        if(super.FM.getAltitude() > 1000F && (double)calculateMach() >= 1.2D && bEs0)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto0 * 1500D;
        if(super.FM.getAltitude() > 1000F && (double)calculateMach() >= 1.2D && bEs1)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto1 * 1500D;
        if(super.FM.getAltitude() > 1500F && (double)calculateMach() >= 1.2D && bEs0)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto0 * 1500D;
        if(super.FM.getAltitude() > 1500F && (double)calculateMach() >= 1.2D && bEs1)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto1 * 1500D;
        ...
        if(super.FM.getAltitude() > 10000F && (double)calculateMach() >= 2.23D && bEs0)
            ((FlightModelMain) (super.FM)).producedAF.x -= Eto0 * 8000D;
        if(super.FM.getAltitude() > 10000F && (double)calculateMach() >= 2.23D && bEs1)
            ((FlightModelMain) (super.FM)).producedAF.x -= Eto1 * 8000D;
        if(super.FM.getAltitude() > 11000F && Eto0 > 1.001F && bEs0)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto0 * 3700D;
        if(super.FM.getAltitude() > 11000F && Eto1 > 1.001F && bEs1)
            ((FlightModelMain) (super.FM)).producedAF.x += Eto1 * 3700D;
    ...
    static 
    {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_ExternalDev46",  "_ExternalDev47",  "_ExternalRock54", "_ExternalRock55", "_ExternalRock56", "_Flare01",        "_Flare02"
        });
        try
        {
            ...
            a_lweaponslot[145] = new Aircraft._WeaponSlot(7, "RocketGunFlareNEW", 32);
            a_lweaponslot[146] = new Aircraft._WeaponSlot(7, "RocketGunFlareNEW", 32);
            arraylist.add(s);
            ...
            a_lweaponslot[29] = new Aircraft._WeaponSlot(6, "RocketGunNull", 1);
            a_lweaponslot[69] = new Aircraft._WeaponSlot(9, "RocketGunAIM7Eps", 1);
            a_lweaponslot[70] = new Aircraft._WeaponSlot(1, "MGunM61", 1200);
            a_lweaponslot[71] = new Aircraft._WeaponSlot(1, "MGunM61", 1200);
            a_lweaponslot[72] = new Aircraft._WeaponSlot(1, "MGunM61", 1200);
            a_lweaponslot[145] = new Aircraft._WeaponSlot(7, "RocketGunFlareNEW", 32);
            a_lweaponslot[146] = new Aircraft._WeaponSlot(7, "RocketGunFlareNEW", 32);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "S3B:3xSUU+6xMk83+4xAIM7E";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "S2B:2xSUU+6xMk82SnakeEye+4xAIM7E+4xAIM9D_P3";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "S2B:2xSUU+4xMk20RockEye+4xAIM7E_P3";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "B2S:1xSUU+12xMk82SnakeEye+4xAIM7E";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "B1:6xMk20RockEye+4xAIM7E+4xAIM9D_P1";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "B1:6xMk20RockEye+3xAIM7E+4xAIM9D+2xDT+1xQRC160_P3";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "B2:10xMk82SneakEye+4xAIM7E+1xDT";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "B2:6xAGM65B+4xMk83+1xDT+1xQRC160";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            a_lweaponslot[40] = null;
            a_lweaponslot[41] = null;
            a_lweaponslot[42] = new Aircraft._WeaponSlot(4, "RocketGunAGM65B", 1);
            a_lweaponslot[43] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[44] = new Aircraft._WeaponSlot(4, "RocketGunAGM65B", 1);
            a_lweaponslot[45] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[46] = new Aircraft._WeaponSlot(4, "RocketGunAGM65B", 1);
            a_lweaponslot[47] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[48] = new Aircraft._WeaponSlot(4, "RocketGunAGM65B", 1);
            a_lweaponslot[49] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[50] = new Aircraft._WeaponSlot(4, "RocketGunAGM65B", 1);
            a_lweaponslot[51] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[52] = new Aircraft._WeaponSlot(4, "RocketGunAGM65B", 1);
            a_lweaponslot[53] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[54] = null;
            a_lweaponslot[55] = null;
            a_lweaponslot[56] = new Aircraft._WeaponSlot(3, "BombGunMk83", 1);
            a_lweaponslot[57] = new Aircraft._WeaponSlot(3, "BombGunMk83", 1);
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "B1:6xAGM65B+2xDT+1xQRC160_P3";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "B2:6xAGM65B+4xZUNI+1xDT+1xQRC160";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            a_lweaponslot[58] = null;
            a_lweaponslot[59] = null;
            a_lweaponslot[60] = null;
            a_lweaponslot[61] = null;
            ...
            a_lweaponslot[60] = null;
            a_lweaponslot[61] = null;
            a_lweaponslot[62] = new Aircraft._WeaponSlot(4, "RocketGunAGM84A", 1);
            a_lweaponslot[63] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[64] = new Aircraft._WeaponSlot(4, "RocketGunAGM84A", 1);
            a_lweaponslot[65] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[66] = null;
            a_lweaponslot[67] = new Aircraft._WeaponSlot(9, "PylonQRC160", 1);
            a_lweaponslot[68] = new Aircraft._WeaponSlot(9, "PylonQRC160", 1);
            a_lweaponslot[145] = new Aircraft._WeaponSlot(7, "RocketGunFlareNEW", 32);
            ...
            a_lweaponslot[60] = null;
            a_lweaponslot[61] = null;
            a_lweaponslot[62] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[63] = new Aircraft._WeaponSlot(4, "RocketGunAGM84A", 1);
            a_lweaponslot[64] = new Aircraft._WeaponSlot(4, "RocketGunNull", 1);
            a_lweaponslot[65] = new Aircraft._WeaponSlot(4, "RocketGunAGM84A", 1);
            a_lweaponslot[66] = new Aircraft._WeaponSlot(9, "PylonQRC160", 1);
            a_lweaponslot[145] = new Aircraft._WeaponSlot(7, "RocketGunFlareNEW", 32);
            a_lweaponslot[146] = new Aircraft._WeaponSlot(7, "RocketGunFlareNEW", 32);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "1xMk7+4xAIM7E+4xAIM9D+2xDT+2xQRC160_P3";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            a_lweaponslot[9] = null;
            a_lweaponslot[10] = null;
            a_lweaponslot[78] = new Aircraft._WeaponSlot(3, "BombGunMk7", 1);
            a_lweaponslot[12] = new Aircraft._WeaponSlot(9, "FuelTankGun_TankF4L", 1);
            a_lweaponslot[13] = new Aircraft._WeaponSlot(9, "FuelTankGun_TankF4R", 1);
            a_lweaponslot[14] = new Aircraft._WeaponSlot(5, "RocketGunAIM7E", 1);
            a_lweaponslot[15] = new Aircraft._WeaponSlot(5, "RocketGunNull", 1);
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "2xMk12+4xAIM7E+4xAIM9D+2xDT+2xQRC160";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            a_lweaponslot[10] = null;
            a_lweaponslot[77] = new Aircraft._WeaponSlot(9, "FuelTankGun_TankF4EF", 1);
            a_lweaponslot[79] = new Aircraft._WeaponSlot(3, "BombGunMk12", 1);
            a_lweaponslot[80] = new Aircraft._WeaponSlot(3, "BombGunMk12", 1);
            a_lweaponslot[14] = new Aircraft._WeaponSlot(5, "RocketGunAIM7E", 1);
            a_lweaponslot[15] = new Aircraft._WeaponSlot(5, "RocketGunNull", 1);
            a_lweaponslot[16] = new Aircraft._WeaponSlot(5, "RocketGunAIM7E", 1);
            a_lweaponslot[17] = new Aircraft._WeaponSlot(5, "RocketGunNull", 1);
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "S1B:1xSUU+4xZUNI+4xAIM7E+2xDT";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "B2:6xMk82SnakeEye+6xLAU3+4xAIM7E+1xDT";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[1] = null;
            a_lweaponslot[2] = null;
            ...
            a_lweaponslot[55] = null;
            a_lweaponslot[77] = new Aircraft._WeaponSlot(9, "FuelTankGun_TankF4EF", 1);
            a_lweaponslot[127] = new Aircraft._WeaponSlot(9, "Pylon_LAU130green", 1);
            ...
            a_lweaponslot[71] = new Aircraft._WeaponSlot(1, "MGunM61", 1200);
            a_lweaponslot[72] = new Aircraft._WeaponSlot(1, "MGunM61", 1200);
            a_lweaponslot[133] = new Aircraft._WeaponSlot(9, "Pylon_LAU130green", 1);
            a_lweaponslot[134] = new Aircraft._WeaponSlot(9, "Pylon_LAU130green", 1);
            a_lweaponslot[135] = new Aircraft._WeaponSlot(9, "Pylon_LAU130green", 1);
            ...
            a_lweaponslot[40] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[41] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[81] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[82] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[83] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[84] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[85] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[86] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[87] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[88] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[89] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[90] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[91] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[92] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[93] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[94] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[95] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            a_lweaponslot[96] = new Aircraft._WeaponSlot(3, "BombGunMk82SnakeEye", 1);
            ...
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "M3:18xMk82SnakeEye+4xAIM7E+1xDT";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
            a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61", 650);
            a_lweaponslot[14] = new Aircraft._WeaponSlot(5, "RocketGunAIM7E", 1);
            a_lweaponslot[15] = new Aircraft._WeaponSlot(5, "RocketGunNull", 1);
