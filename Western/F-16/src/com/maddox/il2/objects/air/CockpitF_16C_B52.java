...
public class CockpitF_16C_B52 extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            setNew.k14w = (5F * CockpitF_16C_B52.k14TargetWingspanScale[((F_16)aircraft()).k14WingspanType]) / f;
            setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
            setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitF_16C_B52.k14TargetMarkScale[((F_16)aircraft()).k14WingspanType];
            ...
            float f3 = floatindex((f - 200F) * 0.04F, CockpitF_16C_B52.k14BulletDrop) - CockpitF_16C_B52.k14BulletDrop[0];
            if(((F_16) aircraft()).radargunsight == 2)
                f3 = floatindex((f - 200F) * 0.04F, CockpitF_16C_B52.k14RocketDrop) - CockpitF_16C_B52.k14RocketDrop[0];
    ...
    protected void movescreenengines()//TODO Engine
    {
        ...
        float thrust = (((FlightModelMain) (super.fm)).EI.engines[0].getw() * 10F) / 4272F * 7711F;
