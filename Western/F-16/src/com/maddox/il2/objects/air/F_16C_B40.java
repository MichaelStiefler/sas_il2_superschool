// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 22/07/2015 00:33:45
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   F_16C_B40.java
...
public class F_16C_B40 extends F_16
    implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeDockable
{
    ...
    public void onAircraftLoaded()
    {
        ...
        if(super.thisWeaponsName.startsWith("CFT"))
        {
            ...
            float f = 2724.8F;
            float f1 = ((FlightModelMain) (FM)).M.fuel / ((FlightModelMain) (FM)).M.maxFuel;
            ((FlightModelMain) (FM)).M.maxFuel += f;
            ((FlightModelMain) (FM)).M.fuel += f * f1;
            ((FlightModelMain) (FM)).M.referenceWeight += f * f1;
    ...
    public void computePW_AB()
    {
        if(((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
            ((FlightModelMain) (super.FM)).producedAF.x += 45870D;
        ...
        if(FM.EI.engines[0].getThrustOutput() > 1.001F && FM.EI.engines[0].getStage() == 6)
            ...
            } else
            {
                ...
                float f4 = f3 * f;
                float f5 = f4 * f;
                f1 = ((-0.00245227F * f4 + 0.0888388F * f3) - 0.791411F * f2) + 2.40117F * f;
            }
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.air.F_16C_B40.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/F-16C_B30.fmd:f16_fm");
        Property.set(class1, "cockpitClass", new Class[] {
            com.maddox.il2.objects.air.CockpitF_16C_B40.class, com.maddox.il2.objects.air.CockpitF16FLIR.class
        });
