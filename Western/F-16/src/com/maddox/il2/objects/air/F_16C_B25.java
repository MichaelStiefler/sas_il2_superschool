...
// Source File Name:   F_16C_B25.java
...
public class F_16C_B25 extends F_16
    implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeDockable
{
    ...
    public void computePW_AB()
       { 
        if(((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
           ((FlightModelMain) (super.FM)).producedAF.x += 34590D; 
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.air.F_16C_B25.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/F-16C_B25.fmd:f16_fm");
        ...
        try
        {
            ...
            a_lweaponslot[27] = new Aircraft._WeaponSlot(4, "RocketGunAGM65B", 1);
            a_lweaponslot[87] = new Aircraft._WeaponSlot(7, "RocketGunFlare", 35);
            a_lweaponslot[88] = new Aircraft._WeaponSlot(7, "RocketGunFlare", 35);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
