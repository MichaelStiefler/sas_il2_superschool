...
public class Motor extends FMMath
{
    ...
    public void DataToFile(PrintWriter printwriter)
    {
        if(printwriter == null)
            return;
        ...
        if(type == 0 || type == 1 || type == 7)
        {
            printwriter.println("Horse powers: " + horsePowers);
            printwriter.println("Engine mass: " + engineMass);
        } else
        {
            printwriter.println("Thrust: " + thrustMax);
        }
        printwriter.println("Boost factor: " + engineBoostFactor);
        printwriter.println("WEP boost factor: " + engineAfterburnerBoostFactor);
        printwriter.println("Throttle control: " + (bHasThrottleControl ? "+" : "-"));
        printwriter.println("Afterburner control: " + (bHasAfterburnerControl ? "+" : "-"));
        printwriter.println("Propeller control: " + (bHasPropControl ? "+" : "-"));
        printwriter.println("Mixture control: " + (bHasMixControl ? "+" : "-"));
        printwriter.println("Magneto control: " + (bHasMagnetoControl ? "+" : "-"));
        printwriter.println("Compressor control: " + (bHasCompressorControl ? "+" : "-"));
        printwriter.println("Feather control: " + (bHasFeatherControl ? "+" : "-"));
        printwriter.println("Radiator control: " + (bHasRadiatorControl ? "+" : "-"));
        printwriter.println("Extinguishers control: " + (bHasExtinguisherControl ? "+" : "-"));
        printwriter.println("Compressor steps: " + (compressorMaxStep + 1));
        for(int i = 0; i <= compressorMaxStep; i++)
            printwriter.println("Compressor altitude: " + compressorAltitudes[i]);

        printwriter.println("Autopropeller : " + (isAllowsAutoProp() ? "+" : "-"));
        printwriter.println("Autoradiator : " + (isAllowsAutoRadiator() ? "+" : "-"));
    }
...
label0:
        ...
        case 2: // '\002'
            if(bTFirst)
            {
                given = (long)(4000F * World.Rnd().nextFloat(1.0F, 2.0F));
                if(bRan)
                {
...
label0:
            ...
            do
            {
                ...
                if(flag && (!bWepRpmInLowGear || controlCompressor != compressorMaxStep))
                    computePropForces(wWEP * f3 * propReductor, f, 0.0F, f14, f1);
                else
                    computePropForces(wMax * f3 * propReductor, f, 0.0F, f14, f1);
...
//    private static final boolean ___debug___ = false;
    ...
    public float wMax;
    public float wWEP;
    public float wMaxAllowed;
    public int wNetPrev;
    public float engineMoment;
    public float engineMomentMax;
    public float engineBoostFactor;
    public float engineAfterburnerBoostFactor;
    public float engineDistAM;
    public float engineDistBM;
    public float engineDistCM;
    public float producedDistabilisation;
    public boolean bRan;
    public Point3f enginePos;
    public Vector3f engineVector;
    public Vector3f engineForce;
    public Vector3f engineTorque;
    public float engineDamageAccum;
    public float _1_wMaxAllowed;
    public float _1_wMax;
    public float RPMMin;
    public float RPMNom;
    public float RPMMax;
    public float Vopt;
    public float pressureExtBar;
    public double momForFuel;
    public double addVflow;
    public double addVside;
    public Point3f propPos;
    public float propReductor;
    public int propAngleDeviceType;
    public float propAngleDeviceMinParam;
    public float propAngleDeviceMaxParam;
    public float propAngleDeviceAfterburnerParam;
    public int propDirection;
    public float propDiameter;
    public float propMass;
    public float propI;
    public Vector3d propIW;
    public float propSEquivalent;
    public float propr;
    public float propPhiMin;
    public float propPhiMax;
    public float propPhi;
    public float propPhiW;
    public float propAoA;
    public float propAoA0;
    public float propAoACrit;
    public float propAngleChangeSpeed;
    public float propForce;
    public float propMoment;
    public float propTarget;
    public int mixerType;
    public float mixerLowPressureBar;
    public float horsePowers;
    public float thrustMax;
    public int cylindersOperable;
    public float engineI;
    public float engineAcceleration;
    public boolean bMagnetos[] = {
        true, true
    };
    public boolean bIsAutonomous;
    public boolean bIsMaster;
    public boolean bIsStuck;
    public boolean bIsInoperable;
    public boolean bIsAngleDeviceOperational;
    public boolean isPropAngleDeviceHydroOperable;
    public int engineCarburetorType;
    public float FuelConsumptionP0;
    public float FuelConsumptionP05;
    public float FuelConsumptionP1;
    public float FuelConsumptionPMAX;
    public float fuelConsumption0M;
    public float fuelConsumption1M;
    public int compressorType;
    public int compressorMaxStep;
    public float compressorPMax;
    public float compressorManifoldPressure;
    public float compressorAltitudes[];
    public float compressorPressure[];
    public float compressorAltMultipliers[];
    public float compressorBaseMultipliers[];
    public float compressorRPMtoP0;
    public float compressorRPMtoCurvature;
    public float compressorRPMtoPMax;
    public float compressorRPMtoWMaxATA;
    public float compressorSpeedManifold;
    public float compressorRPM[];
    public float compressorATA[];
    public int nOfCompPoints;
    public boolean compressorStepFound;
    public float compressorManifoldThreshold;
    public float afterburnerCompressorFactor;
    public float _1_P0;
    public float compressor1stThrottle;
    public float compressor2ndThrottle;
    public float compressorPAt0;
    public int afterburnerType;
    public boolean afterburnerChangeW;
    public int stage;
    public int oldStage;
    public long timer;
    public long given;
    ...
    public float oldReadyness;
    public float radiatorReadyness;
    ...
    public boolean bHasThrottleControl;
    public boolean bHasAfterburnerControl;
    public boolean bHasPropControl;
    public boolean bHasRadiatorControl;
    public boolean bHasMixControl;
    public boolean bHasMagnetoControl;
    public boolean bHasExtinguisherControl;
    public boolean bHasCompressorControl;
    public boolean bHasFeatherControl;
    public int extinguishers;
    public float controlThrottle;
    public float controlRadiator;
    public boolean controlAfterburner;
    public float controlProp;
    public boolean bControlPropAuto;
    public float controlMix;
    public int controlMagneto;
    public int controlCompressor;
    public int controlFeather;
    public double zatizeni;
    public float coolMult;
    public int controlPropDirection;
    public float neg_G_Counter;
    public boolean bFullT;
    public boolean bFloodCarb;
    public boolean bWepRpmInLowGear;
    public boolean fastATA;
    public Vector3f old_engineForce;
    public Vector3f old_engineTorque;
    public float updateStep;
    public float updateLast;
    public float relP;
    public float maxMoment;
    public float maxW;
    public float fricCoeffT;
    ...
    public int engineNoFuelHUDLogId;
