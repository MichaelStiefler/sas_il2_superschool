        ...
        case 25: // '\031'
            ...
            if(AP.way.isLanding())
            {
                ...
                if(flag4)
                {
                    ...
                    CT.ElevatorControl = 0.05F + 0.3F * f52;
            ...
            } else
            {
                ...
                if(getSpeed() < VmaxFLAPS * 0.21F)
                    CT.FlapsControl = 0.0F;
                if(Vrel.length() < (double)(VmaxFLAPS * 0.25F) && wayCurPos == null && !AP.way.isLandingOnShip() && isEnableToTaxi())
                {
                    TaxiMode = true;
                    AP.way.setCur(0);
                    return;
            ...
            if(Group != null && actor != null)
            {
                ...
                if(mn_time >= (float)j1)
                {
                    ...
                    if(wayCurPos != null)
                    {
                        ...
                        if(Leader != null && f32 > 9F && Leader.isCapableOfTaxiing())
                        {
                            f32 = 9F;
                            Ve.sub(Leader.Loc, Loc);
...
//                        boolean flag5 = false;
    ...
    void OutCT(int i)
    {
        ...
        for(int i1 = 0; i1 < super.EI.getNum(); i1++)
        {
        	...
        	TextScr.output(650, 485, "---ENGINES (" + EI.getNum() + ")---");
            ...
            TextScr.output(650 + i1 * 300, 285, "THTL " + (int)(100F * EI.engines[i1].getControlThrottle()) + "%" + (EI.engines[i1].getControlAfterburner() ? " (NITROS)" : ""));
            TextScr.output(650 + i1 * 300, 260, "PROP " + (int)(100F * EI.engines[i1].getControlProp()) + "%" + (CT.getStepControlAuto() ? " (AUTO)" : ""));
            TextScr.output(650 + i1 * 300, 235, "MIX " + (int)(100F * EI.engines[i1].getControlMix()) + "%");
            TextScr.output(650 + i1 * 300, 210, "RAD " + (int)(100F * EI.engines[i1].getControlRadiator()) + "%" + (CT.getRadiatorControlAuto() ? " (AUTO)" : ""));
            TextScr.output(650 + i1 * 300, 185, "SUPC " + EI.engines[i1].getControlCompressor() + "x");
            TextScr.output(650 + i1 * 300, 160, "PropAoA :" + (int)Math.toDegrees(EI.engines[i1].getPropAoA()));
            TextScr.output(650 + i1 * 300, 135, "PropPhi :" + (int)Math.toDegrees(super.EI.engines[i1].getPropPhi()));
            TextScr.output(650 + i1 * 300, 110, "Cyls/Cams " + EI.engines[i1].getCylindersOperable() + "/" + EI.engines[i1].getCylinders());
            TextScr.output(650 + i1 * 300, 85, "Readyness " + (int)(100F * EI.engines[i1].getReadyness()) + "%");
            TextScr.output(650 + i1 * 300, 60, "RPM " + (int)((float)(int)(EI.engines[i1].getRPM() * 0.02F) * 50F) + " rpm");
            TextScr.output(650 + i1 * 300, 35, "Thrust " + (int)EI.engines[i1].getEngineForce().x + " N");
            TextScr.output(650 + i1 * 300, 10, "MPrs " + (int)(1000F * EI.engines[i1].getManifoldPressure()) + " mBar");
        }
...
//        int j = 0;
        ...
        TextScr.output(5, 410, "Vtas " + (int)getSpeedKMH() + " km/h");
        TextScr.output(5, 310, "AOA " + (float)(int)(getAOA() * 1000F) / 1000F);
        TextScr.output(5, 335, "AOS " + (float)(int)(getAOS() * 1000F) / 1000F);
        TextScr.output(5, 360, "Kr  " + (int)Or.getKren());
        TextScr.output(5, 385, "Ta  " + (int)Or.getTangage());
