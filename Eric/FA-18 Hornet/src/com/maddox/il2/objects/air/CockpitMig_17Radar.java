// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 7/1/2013 9:44:21 AM
            ...
            if(!Mission.isNet() && Actor.isValid(ownaircraft) && Actor.isAlive(ownaircraft))
            {
                ...
                if(ti != to)
                {
                    ...
                    for(int j = 0; j < i; j++)
                    {
                        ...
                        if((actor instanceof Aircraft) && actor != World.getPlayerAircraft() && actor == War.GetNearestEnemyAircraft(((Interpolate) (super.fm)).actor, 2700F, 9))
                        {
