    ...
    implements TypeSupersonic, TypeFighter, TypeBNZFighter, TypeFighterAceMaker, TypeGSuit, TypeFastJet, TypeX4Carrier, TypeGuidedBombCarrier, TypeBomber, TypeAcePlane, TypeLaserSpotter
{
    ...
    public void rareAction(float f, boolean flag)
    {
    	...
    	if(((FlightModelMain) (super.FM)).AS.isMaster() && Config.isUSE_RENDER())
        {
            ...
            float f1 = mn;
            World.cur().getClass();
            F_18.mn = f1 / Atmosphere.sonicSpeed((float)((Tuple3d) (((FlightModelMain) (super.FM)).Loc)).z);
...
;
    ...
    public static void moveGear(HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearL5_D0", 0.0F, Aircraft.cvt(f, 0.01F, 0.11F, 0.0F, -95F), 0.0F);
        hiermesh.chunkSetAngles("GearR5_D0", 0.0F, Aircraft.cvt(f, 0.01F, 0.11F, 0.0F, 95F), 0.0F);
    ...
    protected void moveFlap(float f)
    {
            ...
            hierMesh().chunkSetAngles("AroneL_D0", 0.0F, Aircraft.cvt(f, 0.2F, 0.29F, 0.0F,17F), 0.0F);
            hierMesh().chunkSetAngles("AroneR_D0", 0.0F, Aircraft.cvt(f, 0.2F, 0.29F, 0.0F, 17F), 0.0F);
    ...
    public void update(float f)
    {
        ...
        if(FM.CT.getGear() < 0.8F || super.FM.getSpeedKMH() > 590)
        {
        	if(((FlightModelMain) (super.FM)).CT.FlapsControl > 0.18F)
        	{
            	...
            	{
            	((FlightModelMain) (super.FM)).CT.FlapsControl = (float) (super.FM.getAOA() * 0.05);
            	}
            	if(super.FM.getAOA()<5 || super.FM.getSpeedKMH() < 500)
            	{
    ...
    private final void umn()
    {
        ...
        float f = mn;
        World.cur().getClass();
        F_18.mn = f / Atmosphere.sonicSpeed((float)((Tuple3d) (((FlightModelMain) (super.FM)).Loc)).z);
        if(mn >= lteb)
            ts = true;
        else
            ts = false;
