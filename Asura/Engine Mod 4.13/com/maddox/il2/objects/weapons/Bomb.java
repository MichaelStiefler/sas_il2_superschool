    ...
    implements MsgCollisionRequestListener, MsgCollisionListener
{
    ...
    public void start()
    {
        ...
        if(getOwner() == World.getPlayerAircraft())
            setName("MyBomb_" + World.getPlayerAircraft().FM.CT.getWeaponCount(3));
        pos.getAbs(or);
    ...
    public Bomb()
    {
        ...
        speed = new Vector3d();
        rotAxis = new Vector3d(0.0D, 1.0D, 0.0D);
        rotatingFins = false;
        rotatingSpeed = 0.0F;
        loc = new Loc();
        sound = null;
        String s = getBombMeshString();
    ...
    public void onBombLoaded()
    {
    }

    public String getBombMeshString()
    {
        return Property.stringValue(getClass(), "mesh", null);
    }
