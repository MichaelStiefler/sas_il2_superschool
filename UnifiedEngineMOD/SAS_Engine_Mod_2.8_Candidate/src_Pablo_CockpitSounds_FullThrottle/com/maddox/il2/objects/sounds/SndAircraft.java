// PAL-CockpitSoundsMod and Sani-Full Throttle Flame effect for 4.12.2m -- updated for SAS Engine MOD 2.8 on 11th/Jan./2016
...
//PAS--
	...
	public void destroy() {
		...
		if (fxScreams != null) fxScreams.cancel();
		if (fxStress != null) fxStress.cancel();
		if (fxMask != null) fxMask.cancel();
		for (int i = 0; i < 6; i++)
		{
			if (fxTts[i] != null) fxTts[i].cancel();
			if (fxShs[i] != null) fxShs[i].cancel();
		}
