...
public abstract class B5Nxyz extends Scheme1 {
    ...
    public void doMurderPilot(int i) {
        switch (i) {
            ...
            case 2:
                ...
                this.hierMesh().chunkVisible("Pilot3Col_D0", false);
                this.hierMesh().chunkVisible("HMask3_D0", false);
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                if (s.endsWith("1")) this.getEnergyPastArmor(World.Rnd().nextFloat(1.5F, 2.0F), shot);
                else if (s.endsWith("2")) this.getEnergyPastArmor(World.Rnd().nextFloat(2.0F, 3F), shot);
                return;
            }
            ...
            if (s.startsWith("xxpanel1")) this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x40);
            if (s.startsWith("xxpanel2")) this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x10);
            return;
        }
        if (s.startsWith("xcf")) {
            if (s.equals("xcf1")) this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 2);
            else if (s.equals("xcf2")) this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 1);
            else if (s.equals("xcf3")) this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 4);
            else this.hitChunk("CF", shot);
        } else if (s.startsWith("xblister1")) this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x20);
        else if (s.startsWith("xblister2")) this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 8);
    ...
    protected void moveWingFold(HierMesh hiermesh, float f) {
        ...
        hiermesh.chunkSetAngles("WingRMid_D0", 0.0F, -158F * f, 0.0F);
    }
