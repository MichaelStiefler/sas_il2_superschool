...
public class CockpitKI_15 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_15.this.fm != null) {
                ...
                if (CockpitKI_15.this.cockpitDimControl) if (CockpitKI_15.this.setNew.dimPosition > 0.0F) CockpitKI_15.this.setOld.dimPosition -= 0.05F;
                else if (CockpitKI_15.this.setNew.dimPosition < 1.0F) CockpitKI_15.this.setOld.dimPosition += 0.05F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x10) == 0) this.mesh.chunkSetAngles("NeedDF", this.cvt(this.setNew.waypointAzimuth.getDeg(f), -90F, 90F, -33F, 33F), 0.0F, 0.0F);
