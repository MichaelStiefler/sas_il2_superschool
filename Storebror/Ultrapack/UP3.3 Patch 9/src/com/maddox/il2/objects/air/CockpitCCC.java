...
public class CockpitCCC extends CockpitPilot
{
    ...
    private void moveGunner()
    {
        ...
        if((double)r_5xyz.getGunnerAnimation() > 0.25D)
        {
            ...
            Cockpit.xyz[0] = 0.0F;
            Cockpit.xyz[1] = 0.0F;
            Cockpit.xyz[2] = cvt(r_5xyz.getGunnerAnimation(), 0.25F, 0.75F, -0.2F, -0.03F);
            Cockpit.ypr[0] = cvt(r_5xyz.getGunnerAnimation(), 0.25F, 0.75F, -180F, 0.0F);
            Cockpit.ypr[1] = 0.0F;
            Cockpit.ypr[2] = 0.0F;
            mesh.chunkSetLocate("Pilot2_D0", Cockpit.xyz, Cockpit.ypr);
            mesh.chunkSetAngles("zTurret1A", 0.0F, 0.0F, 0.0F);
        ...
        } else
        {
            Cockpit.xyz[0] = 0.0F;
            Cockpit.xyz[1] = 0.0F;
            Cockpit.xyz[2] = cvt(r_5xyz.getGunnerAnimation(), 0.0F, 0.25F, 0.0F, 0.11F);
            Cockpit.ypr[0] = 0.0F;
            Cockpit.ypr[1] = 0.0F;
            Cockpit.ypr[2] = 0.0F;
    ...
    public CockpitCCC()
    {
        ...
        PatronsMat = null;
        j = -1;
        j = mesh.materialFind("patron");
        if(j != -1)
        {
            PatronsMat = mesh.material(j);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("zPed1", f1, 0.0F, 0.0F);
        mesh.chunkSetAngles("zPed2", f1, 0.0F, 0.0F);
        mesh.chunkSetAngles("zPedalL", -f1, 0.0F, 0.0F);
        mesh.chunkSetAngles("zPedalR", -f1, 0.0F, 0.0F);
        mesh.chunkSetAngles("zPedTrosL", -f1, 0.0F, 0.0F);
        mesh.chunkSetAngles("zPedTrosR", -f1, 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("zFireL", 0.0F, 0.0F, fm.CT.saveWeaponControl[0] ? -15F : 0.0F);
        mesh.chunkSetAngles("zFireR", 0.0F, 0.0F, fm.CT.saveWeaponControl[1] ? -15F : 0.0F);
        mesh.chunkSetAngles("zFireC", 0.0F, 0.0F, !fm.CT.saveWeaponControl[0] || !fm.CT.saveWeaponControl[1] ? 0.0F : -15F);
        ...
        if(Gun5 != null)
        {
            if(Gun5.isShots() && Gun5.haveBullets() && PatronsMat != null)
            {
                Patrons -= 0.35F * f;
                PatronsMat.setLayer(0);
    ...
    static 
    {
        Property.set(CockpitCCC.class, "normZNs", new float[] {
            1.9F, 0.7F, 0.7F, 0.7F
        });
    }
}
