...
public class CockpitU_2_Bombardier extends CockpitPilot // CockpitBombardier
{
...
//        mesh.chunkVisible("Pilot1_D1", hiermesh.isChunkVisible("Pilot1_D1"));
    ...
    static 
    {
        Property.set(CockpitU_2_Bombardier.class, "aiTuretNum", -1);
        Property.set(CockpitU_2_Bombardier.class, "astatePilotIndx", 1);
        Property.set(CockpitU_2_Bombardier.class, "weaponControlNum", 3);
        Property.set(CockpitU_2_Bombardier.class, "normZNs", new float[] {
            0.65F, 0.55F, 0.65F, 0.55F
        });
        Property.set(CockpitU_2_Bombardier.class, "gsZN", 0.6F);
    }
}
