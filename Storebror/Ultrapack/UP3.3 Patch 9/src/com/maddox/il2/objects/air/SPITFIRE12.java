...
public class SPITFIRE12 extends SPITFIRE {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Spitfire-F-XII-G3-CW.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitSpit12.class });
        Property.set(class1, "LOSElevation", 0.5926F);
        weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 1, 1, 9, 9, 3 });
        weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02", "_ExternalDev08", "_ExternalDev01", "_ExternalBomb01" });
    }
}
