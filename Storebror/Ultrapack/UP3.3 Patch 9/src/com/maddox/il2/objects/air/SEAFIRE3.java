...
public class SEAFIRE3 extends SPITFIRE5 {
    ...
    public void moveCockpitDoor(float f) {
        ...
        float f1 = (float) Math.sin(cvt(f, 0.01F, 0.99F, 0.0F, (float) Math.PI));
...
//        }
    ...
    static {
        Class class1 = SEAFIRE3.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Seafire");
        Property.set(class1, "meshName", "3DO/Plane/SeafireMkIII(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "yearService", 1944F);
        Property.set(class1, "yearExpired", 1946.5F);
        Property.set(class1, "FlightModel", "FlightModels/Seafire-LF-MkIII.fmd");
        ...
        weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02", "_ExternalDev01", "_ExternalBomb01", "_ExternalDev02", "_ExternalDev03", "_ExternalBomb02", "_ExternalBomb03", "_ExternalDev04",
