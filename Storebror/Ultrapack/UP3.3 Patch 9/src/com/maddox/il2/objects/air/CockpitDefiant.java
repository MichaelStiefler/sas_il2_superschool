    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitDefiant.this.fm != null) {
                ...
                if (Math.abs(CockpitDefiant.this.fm.Or.getKren()) < 30F) CockpitDefiant.this.setNew.azimuth = (35F * CockpitDefiant.this.setOld.azimuth + -CockpitDefiant.this.fm.Or.getYaw()) / 36F;
                if (CockpitDefiant.this.setOld.azimuth > 270F && CockpitDefiant.this.setNew.azimuth < 90F) CockpitDefiant.this.setOld.azimuth -= 360F;
                if (CockpitDefiant.this.setOld.azimuth < 90F && CockpitDefiant.this.setNew.azimuth > 270F) CockpitDefiant.this.setOld.azimuth += 360F;
                CockpitDefiant.this.setNew.waypointAzimuth = (10F * CockpitDefiant.this.setOld.waypointAzimuth + (CockpitDefiant.this.waypointAzimuth() - CockpitDefiant.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
