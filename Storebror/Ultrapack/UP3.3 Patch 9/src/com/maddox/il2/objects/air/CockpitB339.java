        ...
        public boolean tick() {
            if (CockpitB339.this.fm != null) {
                ...
                if (Math.abs(CockpitB339.this.fm.Or.getKren()) < 30F) {
                    CockpitB339.this.setNew.azimuth = ((35F * CockpitB339.this.setOld.azimuth) + -CockpitB339.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitB339.this.setOld.azimuth > 270F) && (CockpitB339.this.setNew.azimuth < 90F)) {
                    CockpitB339.this.setOld.azimuth -= 360F;
                }
                if ((CockpitB339.this.setOld.azimuth < 90F) && (CockpitB339.this.setNew.azimuth > 270F)) {
                    CockpitB339.this.setOld.azimuth += 360F;
                }
                CockpitB339.this.setNew.waypointAzimuth = ((10F * CockpitB339.this.setOld.waypointAzimuth) + (CockpitB339.this.waypointAzimuth() - CockpitB339.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
