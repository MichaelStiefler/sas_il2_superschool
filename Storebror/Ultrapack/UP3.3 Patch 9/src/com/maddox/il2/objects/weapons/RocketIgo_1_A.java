...
public class RocketIgo_1_A extends RocketBomb {
    static class SPAWN implements NetSpawn {
        ...
        public void netSpawn(int i, NetMsgInput netmsginput) {
            ...
            try {
                ...
                new RocketIgo_1_A(actor, netmsginput.channel(), i, point3d, orient, f);
    ...
    class Mirror extends ActorNet {
        ...
        public boolean netInput(NetMsgInput netmsginput) throws IOException {
            ...
            RocketIgo_1_A.v.x = netmsginput.readFloat();
            RocketIgo_1_A.v.y = netmsginput.readFloat();
            RocketIgo_1_A.v.z = netmsginput.readFloat();
            RocketIgo_1_A.this.setSpeed(RocketIgo_1_A.v);
            return true;
        }
    ...
    class Master extends ActorNet implements NetUpdate {
        ...
        public void netUpdate() {
            try {
                ...
                RocketIgo_1_A.this.getSpeed(RocketIgo_1_A.v);
                this.out.writeFloat((float) RocketIgo_1_A.v.x);
                this.out.writeFloat((float) RocketIgo_1_A.v.y);
                this.out.writeFloat((float) RocketIgo_1_A.v.z);
    ...
    public boolean interpolateStep() {
        if (this.tEStart > 0L && Time.current() > this.tEStart) {
            ...
            if (Config.isUSE_RENDER()) {
                if (this.smoke != null) Eff3DActor.setIntesity(this.smoke, 1.0F);
                if (this.sprite != null) Eff3DActor.setIntesity(this.sprite, 1.0F);
                if (this.flame != null) this.flame.drawing(true);
                this.light.light.setEmit(2.0F, 100F);
            }
        }
        if (World.Rnd().nextFloat() > 0.8F && this.fl1 != null) Eff3DActor.setIntesity(this.fl1, World.Rnd().nextFloat(0.1F, 2.5F));
        if (World.Rnd().nextFloat() > 0.8F && this.fl2 != null) Eff3DActor.setIntesity(this.fl2, World.Rnd().nextFloat(0.1F, 2.5F));
        ...
        if (Actor.isValid(this.getOwner())) {
            if ((this.getOwner() != World.getPlayerAircraft() || !((RealFlightModel) this.fm).isRealMode()) && this.fm instanceof Maneuver && this.target != null) {
                pT.set(this.target.pos.getAbsPoint());
                ...
                if (point3d.x > -10D && flag) {
                    ...
                    if (point3d.y > d) ((TypeX4Carrier) this.fm.actor).typeX4CAdjSideMinus();
                    if (point3d.y < -d) ((TypeX4Carrier) this.fm.actor).typeX4CAdjSidePlus();
                    if (point3d.z < -d) ((TypeX4Carrier) this.fm.actor).typeX4CAdjAttitudeMinus();
                    if (point3d.z > d) ((TypeX4Carrier) this.fm.actor).typeX4CAdjAttitudePlus();
                }
            }
            this.getSpeed(RocketBomb.spd);
            float f1 = (float) RocketBomb.spd.length();
            Vector3d vector3d = new Vector3d(0.0D, 0.0D, 0.0D);
            vector3d.y = -azimuthControlScaleFact * f1 * ((TypeX4Carrier) this.fm.actor).typeX4CgetdeltaAzimuth();
            vector3d.z = tangageControlScaleFact * f1 * ((TypeX4Carrier) this.fm.actor).typeX4CgetdeltaTangage();
            if (vector3d.y != 0.0D || vector3d.z != 0.0D) f1 *= 0.9992F;
            this.pos.getAbs(RocketBomb.Or);
            RocketBomb.Or.transform(vector3d);
            vector3d.z += f1 * 0.0018D * f * Atmosphere.g() * this.Minit / this.M;
            if (this.isThrust) vector3d.z += 0.032D * f * Atmosphere.g() * this.Minit / this.M;
    ...
    public RocketIgo_1_A() {
        this.first = true;
        this.fm = null;
    }

    public RocketIgo_1_A(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
        this.first = true;
        this.fm = null;
    ...
    private void doStart(float f) {
        ...
        if (Config.isUSE_RENDER()) {
            ...
            if (this.flame != null) this.flame.drawing(false);
            if (this.fl1 != null) Eff3DActor.setIntesity(this.fl1, 10F);
            ...
            if (this.smoke01 != null) this.smoke01.pos.changeHookToRel();
        }
        this.noGDelay = -1L;
        this.tEStart = Time.current() + 1000L;
        if (Config.isUSE_RENDER()) {
            if (this.smoke != null) Eff3DActor.setIntesity(this.smoke, 0.0F);
            if (this.sprite != null) Eff3DActor.setIntesity(this.sprite, 0.0F);
            if (this.flame != null) this.flame.drawing(false);
    ...
    public void destroy() {
        ...
        if (Config.isUSE_RENDER()) {
            ...
            if (this.smoke01 != null) Eff3DActor.finish(this.smoke01);
        }
        super.destroy();
    }
    ...
    public void msgCollision(Actor actor, String s1, String s2) {
        System.out.println("RocketIgo_1_A msgCollision(" + actor.name() + ", " + s1 + ", " + s2 + ")");
    ...
    static {
        Class class1 = RocketIgo_1_A.class;
        Property.set(class1, "mesh", "3do/Arms/Igo-1-A/mono.sim");
        ...
        Property.set(class1, "massa", 1400F);
        Property.set(class1, "massaEnd", 1200F);
