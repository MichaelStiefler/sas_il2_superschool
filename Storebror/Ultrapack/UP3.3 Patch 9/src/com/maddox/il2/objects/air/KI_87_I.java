...
public class KI_87_I extends KI_87 {
    static {
        Class class1 = KI_87_I.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "originCountry", PaintScheme.countryJapan);
        Property.set(class1, "iconFar_shortClassName", "Ki-87-I");
        Property.set(class1, "meshName", "3DO/Plane/Ki-87-I/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "PaintScheme_ja", new PaintSchemeFCSPar05());
        Property.set(class1, "yearService", 1945F);
        Property.set(class1, "yearExpired", 1955F);
        Property.set(class1, "FlightModel", "FlightModels/Ki87-I.fmd");
