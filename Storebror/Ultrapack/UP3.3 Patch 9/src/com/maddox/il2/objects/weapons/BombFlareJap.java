...
public class BombFlareJap extends Bomb {
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            this.getSpeed(BombFlareJap.v3d);
            BombFlareJap.v3d.scale(0.97D);
            if (BombFlareJap.v3d.z < -2D) {
                BombFlareJap.v3d.z += 1.1F * Time.tickConstLenFs();
            }
            this.setSpeed(BombFlareJap.v3d);
    ...
    static {
        Class class1 = BombFlareJap.class;
        Property.set(class1, "mesh", "3DO/Arms/Flare_Jap/mono.sim");
