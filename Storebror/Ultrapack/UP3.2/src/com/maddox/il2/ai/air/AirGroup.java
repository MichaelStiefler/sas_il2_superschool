...
import com.maddox.il2.objects.sounds.*;
    ...
    public void addAircraft(Aircraft aircraft) {
        ...
        if (aircraft.getSquadron() == this.sq) {
            for (i = 0; i < this.nOfAirc; ++i) {
                if (this.airc[i].getSquadron() != this.sq) {
                    break;
                }
                if (this.airc[i].getWing().indexInSquadron() * 4 + this.airc[i].aircIndex() > aircraft.getWing().indexInSquadron() * 4 + aircraft.aircIndex()) {
                    break;
                }
            }
        } else {
    ...
    Aircraft firstOkAirc(int n) {
        for (int i = 0; i < this.nOfAirc; ++i) {
            if (n >= 0 && n < this.nOfAirc) {
                ...
                if (i == n + 1 && this.airc[i].aircIndex() == this.airc[n].aircIndex() + 1) {
                    continue;
                }
            }
            Maneuver maneuver = (Maneuver) this.airc[i].FM;
                    ...
                    if (this.grTask == 3) {
                        ...
                        if (this.w.curr().getTarget() != null) {
                            ...
                            if (n17 == 0 && this.airc[0] instanceof TypeFighter) {
                                ...
                                if (n17 != 0 && maneuver.CT.getWeaponMass() > 220.0f) {
                                    n17 = 0;
                                }
                            }
                            if (n17 != 0) {
