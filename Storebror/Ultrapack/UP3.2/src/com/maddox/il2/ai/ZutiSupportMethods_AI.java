...
public class ZutiSupportMethods_AI {
    ...
    private static boolean checkPosition(com.maddox.il2.objects.air.Aircraft aircraft, int i) {
        ...
        if (java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft) (aircraft)).FM)).Loc)).x - (double) variables.getXcenter(i)) > (double) variables.getLenghtZone(i))
            return false;

        return java.lang.Math.abs(((com.maddox.JGP.Tuple3d) (((com.maddox.il2.fm.FlightModelMain) (((com.maddox.il2.objects.sounds.SndAircraft) (aircraft)).FM)).Loc)).y - (double) variables.getYcenter(i)) <= (double) variables.getWidthZone(i);
    }
