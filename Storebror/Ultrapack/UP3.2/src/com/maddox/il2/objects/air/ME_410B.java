...
public class ME_410B extends ME_210 implements TypeFighter, TypeBNZFighter, TypeStormovik, TypeStormovikArmored, TypeX4Carrier {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitME_410B.class, Cockpit410B_Bombardier.class });
