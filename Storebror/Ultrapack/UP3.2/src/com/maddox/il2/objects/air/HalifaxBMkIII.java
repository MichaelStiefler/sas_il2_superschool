...
public class HalifaxBMkIII extends Halifax implements TypeBomber {
	...
	static {
		...
		Property.set(class1, "FlightModel", "FlightModels/HalifaxBMkIII.fmd");
		...
		Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 11, 11, 11, 12, 12, 12, 12, 3, 3, 3, 3, 3, 3, 3, 3 });
		Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN08", "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN09", "_MGUN10", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06",
