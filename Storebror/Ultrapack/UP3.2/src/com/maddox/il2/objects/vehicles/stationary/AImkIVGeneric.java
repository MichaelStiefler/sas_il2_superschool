...
public abstract class AImkIVGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(AImkIVGeneric.this.engineSFX != null)
                if(AImkIVGeneric.this.engineSTimer >= 0)
                {
                    if(--AImkIVGeneric.this.engineSTimer <= 0)
                    {
                        ...
                        if(!AImkIVGeneric.this.danger())
                            AImkIVGeneric.this.engineSTimer = -AImkIVGeneric.this.engineSTimer;
                    }
                } else
                if(++AImkIVGeneric.this.engineSTimer >= 0)
                {
