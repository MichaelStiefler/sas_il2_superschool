...
public class LANCASTER extends Scheme4 implements TypeTransport, TypeBomber {
	...
	public void msgShot(Shot shot) {
		...
		if (shot.chunkName.startsWith("CF")) {
			...
			if (((Tuple3d) Aircraft.Pd).x > 2.4749999046325684D && ((Tuple3d) Aircraft.Pd).x < 4.4899997711181641D && Aircraft.Pd.z > 0.61D && shot.power * Math.sqrt(Aircraft.v1.y * Aircraft.v1.y + Aircraft.v1.z * Aircraft.v1.z) > 11900D
