		...
		if (string.startsWith("xx")) {
			if (string.startsWith("xxarmor")) {
				...
				if (string.endsWith("p1")) {
					...
					this.getEnergyPastArmor(9D / (Math.abs(Aircraft.v1.z) + 9.9999997473787516E-006D), shot);
				} else if (string.endsWith("p5")) {
					this.getEnergyPastArmor(9D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-006D), shot);
				...
				if (string.startsWith("xxwj") && this.getEnergyPastArmor(12.5F, shot) > 0.0F) {
