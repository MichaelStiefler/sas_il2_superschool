	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.startsWith("xxarmorp")) { this.getEnergyPastArmor(15.149999618530273D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-006D), shot); }
				return;
			}
			...
			if (s.startsWith("xxSpar")) {
				...
				if (s.startsWith("xxSparLI") && this.chunkDamageVisible("WingLIn") > 2 && World.Rnd().nextFloat() > Math.abs(Aircraft.v1.x) + 0.11999999731779099D
						&& this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingLIn Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
				}
				if (s.startsWith("xxSparrI") && this.chunkDamageVisible("WingRIn") > 2 && World.Rnd().nextFloat() > Math.abs(Aircraft.v1.x) + 0.11999999731779099D
						&& this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingRIn Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
				}
				if (s.startsWith("xxSparlm") && this.chunkDamageVisible("WingLMid") > 2 && World.Rnd().nextFloat() > Math.abs(Aircraft.v1.x) + 0.11999999731779099D
						&& this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingLMid Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
				}
				if (s.startsWith("xxSparrm") && this.chunkDamageVisible("WingRMid") > 2 && World.Rnd().nextFloat() > Math.abs(Aircraft.v1.x) + 0.11999999731779099D
						&& this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingRMid Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
				}
				if (s.startsWith("xxSparlo") && this.chunkDamageVisible("WingLOut") > 2 && World.Rnd().nextFloat() > Math.abs(Aircraft.v1.x) + 0.11999999731779099D
						&& this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingLOut Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
				}
				if (s.startsWith("xxSparro") && this.chunkDamageVisible("WingROut") > 2 && World.Rnd().nextFloat() > Math.abs(Aircraft.v1.x) + 0.11999999731779099D
						&& this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
