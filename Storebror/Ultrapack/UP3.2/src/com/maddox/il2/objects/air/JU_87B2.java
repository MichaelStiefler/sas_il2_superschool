...
public class JU_87B2 extends JU_87 {
		...
		if (aobj != null) {
			...
			do {
				...
				if (aobj[i] instanceof BombSC1000 || aobj[i] instanceof BombAB1000) {
					...
					this.FM.AS.setPilotState(this.FM.actor, 1, 99);
	...
	static {
		...
		Aircraft.weaponHooksRegister(class1,
				new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05" });
	}
}
