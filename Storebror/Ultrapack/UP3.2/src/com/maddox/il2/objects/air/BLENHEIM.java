...
public abstract class BLENHEIM extends Scheme2 implements TypeBomber, TypeTransport {
	...
	public void onAircraftLoaded() {
		...
		if (Config.isUSE_RENDER() && World.cur().camouflage == 1) {
			...
			this.hierMesh().chunkVisible("GearLS1_D0", true);
			this.hierMesh().chunkVisible("GearLS5_D0", true);
			this.hierMesh().chunkVisible("GearLS7_D0", true);
			this.hierMesh().chunkVisible("GearLS8_D0", true);
			this.hierMesh().chunkVisible("GearLS9_D0", true);
			this.hierMesh().chunkVisible("GearLS10_D0", true);
			...
			this.hierMesh().chunkVisible("GearRS1_D0", true);
			this.hierMesh().chunkVisible("GearRS5_D0", true);
			this.hierMesh().chunkVisible("GearRS7_D0", true);
			this.hierMesh().chunkVisible("GearRS8_D0", true);
			this.hierMesh().chunkVisible("GearRS9_D0", true);
			this.hierMesh().chunkVisible("GearRS10_D0", true);
			this.hierMesh().chunkVisible("GearC1_D0", false);
			this.hierMesh().chunkVisible("GearCS1_D0", true);
	...
	public void moveWheelSink() {
		...
		this.hierMesh().chunkSetAngles("GearLS7_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.25F, 0.0F, 15F), 0.0F);
		this.hierMesh().chunkSetAngles("GearLS8_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.25F, 80F, 57F), 0.0F);
		this.hierMesh().chunkSetAngles("GearLS9_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.25F, 0.0F, -8F), 0.0F);
		xyz[2] = cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.25F, 0.0F, 0.2F);
		this.hierMesh().chunkSetLocate("GearLS10_D0", xyz, ypr);
		xyz[2] = cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, 0.23F);
		this.hierMesh().chunkSetLocate("GearR99_D0", xyz, ypr);
		this.hierMesh().chunkSetAngles("GearRS7_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, 15F), 0.0F);
		this.hierMesh().chunkSetAngles("GearRS8_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 80F, 57F), 0.0F);
		this.hierMesh().chunkSetAngles("GearRS9_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, -8F), 0.0F);
		xyz[2] = cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, 0.2F);
		this.hierMesh().chunkSetLocate("GearRS10_D0", xyz, ypr);
	}
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			...
			if (s.startsWith("xxspar")) {
				if ((s.endsWith("li1") || s.endsWith("li2")) && World.Rnd().nextFloat() < cvt((float) Math.abs(v1.x), 0.0F, 1.0F, 1.0F, 0.08F) && this.chunkDamageVisible("WingLIn") > 2
						&& this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debugprintln(this, "*** WingLIn Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
				}
				if ((s.endsWith("ri1") || s.endsWith("ri2")) && World.Rnd().nextFloat() < cvt((float) Math.abs(v1.x), 0.0F, 1.0F, 1.0F, 0.08F) && this.chunkDamageVisible("WingRIn") > 2
						&& this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debugprintln(this, "*** WingRIn Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
				}
				if ((s.endsWith("lm1") || s.endsWith("lm2")) && World.Rnd().nextFloat() < cvt((float) Math.abs(v1.x), 0.0F, 1.0F, 1.0F, 0.08F) && this.chunkDamageVisible("WingLMid") > 2
						&& this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debugprintln(this, "*** WingLMid Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
				}
				if ((s.endsWith("rm1") || s.endsWith("rm2")) && World.Rnd().nextFloat() < cvt((float) Math.abs(v1.x), 0.0F, 1.0F, 1.0F, 0.08F) && this.chunkDamageVisible("WingRMid") > 2
						&& this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debugprintln(this, "*** WingRMid Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
				}
				if ((s.endsWith("lo1") || s.endsWith("lo2")) && World.Rnd().nextFloat() < cvt((float) Math.abs(v1.x), 0.0F, 1.0F, 1.0F, 0.33F) && this.chunkDamageVisible("WingLOut") > 2
						&& this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debugprintln(this, "*** WingLOut Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
				}
				if ((s.endsWith("ro1") || s.endsWith("ro2")) && World.Rnd().nextFloat() < cvt((float) Math.abs(v1.x), 0.0F, 1.0F, 1.0F, 0.33F) && this.chunkDamageVisible("WingROut") > 2
						&& this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					debugprintln(this, "*** WingROut Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
				}
				if ((s.endsWith("k1") || s.endsWith("k2")) && World.Rnd().nextFloat() < cvt((float) Math.abs(v1.x), 0.0F, 1.0F, 1.0F, 0.26F) && this.chunkDamageVisible("Keel1") > 1
			...
			if (s.startsWith("xxengine")) {
				...
				if (this.getEnergyPastArmor(World.Rnd().nextFloat(0.1F, 4.3F), shot) > 0.0F && World.Rnd().nextFloat() < this.FM.EI.engines[k].getCylindersRatio() * 1.12F) {
					...
					debugprintln(this, "*** Engine" + (k + 1) + " Cylindres Damaged, " + this.FM.EI.engines[k].getCylindersOperable() + "/" + this.FM.EI.engines[k].getCylinders() + " left..");
				}
			...
			if (s.startsWith("xxtank")) {
				...
				if (i1 < 4 && this.getEnergyPastArmor(0.1F, shot) > 0.0F) {
					if (shot.power < 14100F) {
						...
						this.FM.AS.hitTank(shot.initiator, i1, World.Rnd().nextInt(0, (int) (shot.power / 20000F)));
					}
				}
				if (i1 == 4 && this.getEnergyPastArmor(1.1F, shot) > 0.0F && World.Rnd().nextFloat() < 0.06F) {
