...
public class B_24J100 extends B_24 implements TypeBomber, TypeX4Carrier, TypeGuidedBombCarrier {
	...
	public void typeBomberUpdate(float f) {
		...
		if (this.fSightCurReadyness < 1.0F) {
			...
			if (this.fSightCurDistance < this.calibDistance + toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(toMeters(this.fSightCurAltitude) * 0.2038736F)) { this.bSightBombDump = true; }
