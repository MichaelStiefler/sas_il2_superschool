...
public abstract class FlensburgGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(FlensburgGeneric.this.engineSFX != null)
                if(FlensburgGeneric.this.engineSTimer >= 0)
                {
                    if(--FlensburgGeneric.this.engineSTimer <= 0)
                    {
                        ...
                        if(!FlensburgGeneric.this.danger())
                            FlensburgGeneric.this.engineSTimer = -FlensburgGeneric.this.engineSTimer;
                    }
                } else
                if(++FlensburgGeneric.this.engineSTimer >= 0)
                {
