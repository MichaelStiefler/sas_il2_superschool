	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		...
		if (s.startsWith("xcf") || s.startsWith("xcockpit")) {
			...
			if (s.startsWith("xcf1")) {
				...
				if (point3d.x > -1.195D && point3d.x < -0.90400000000000003D && point3d.z > 0.20300000000000001D) { this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x40); }
				if (point3d.x > -1.402D && point3d.x < -1.125D && point3d.z > -0.032000000000000001D && point3d.z < 0.501D) { this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 4); }
			}
