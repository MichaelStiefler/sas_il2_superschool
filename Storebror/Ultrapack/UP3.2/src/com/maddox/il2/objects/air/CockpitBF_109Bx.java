...
public class CockpitBF_109Bx extends CockpitPilot {
	...
	public CockpitBF_109Bx() {
		...
		super.cockpitNightMats = new String[] { "ZClocks1", "ZClocks1DMG", "ZClocks2", "ZClocks3", "FW190A4Compass", "oxigen" };
	...
	public void removeCanopy() {
		if (super.mesh.chunkFindCheck("Top") >= 0) { super.mesh.chunkVisible("TopOpen", false); }
		super.mesh.chunkVisible("TopE1", false);
		super.mesh.chunkVisible("Z_Holes1_D1", false);
		super.mesh.chunkVisible("Z_Holes2_D1", false);
		if (super.mesh.chunkFindCheck("Top2") >= 0) { super.mesh.chunkVisible("Top2", false); }
	}
	...
	public void reflectWorldToInstruments(float f) {
		...
		super.mesh.chunkSetAngles("Z_Altimeter1", this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 10000F, 0.0F, 3600F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_Altimeter2", this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 10000F, 0.0F, 180F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_ReviTinter", this.cvt(this.interp(this.setNew.dimPosition, this.setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, -30F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_ReviTint", this.cvt(this.interp(this.setNew.dimPosition, this.setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, 40F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_ATA1", 15.5F + this.cvt(this.pictManifold = 0.75F * this.pictManifold + 0.25F * ((FlightModelMain) super.fm).EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 336F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) ((FlightModelMain) super.fm).Loc).z, super.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), speedometerScale), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(((FlightModelMain) super.fm).EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), rpmScale), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(((FlightModelMain) super.fm).M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), fuelScale), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_Iengtemprad1", this.cvt(((FlightModelMain) super.fm).EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, 58.5F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_EngTemp1", this.cvt(((FlightModelMain) super.fm).EI.engines[0].tWaterOut, 0.0F, 120F, 0.0F, 58.5F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_FuelPress1", this.cvt(((FlightModelMain) super.fm).M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3F, 0.0F, 135F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_OilPress1", this.cvt(1.0F + 0.05F * ((FlightModelMain) super.fm).EI.engines[0].tOilOut, 0.0F, 15F, 0.0F, 135F), 0.0F, 0.0F);
		float f1;
		...
		super.mesh.chunkSetAngles("Z_Azimuth1", -this.interp(this.setNew.waypointAzimuth, this.setOld.waypointAzimuth, f), 0.0F, 0.0F);
		...
		super.mesh.chunkSetAngles("Z_Minute1", this.cvt(World.getTimeofDay() % 1.0F, 0.0F, 1.0F, 0.0F, 360F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_Second1", this.cvt(World.getTimeofDay() % 1.0F * 60F % 1.0F, 0.0F, 1.0F, 0.0F, 360F), 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_Column", (this.pictAiler = 0.85F * this.pictAiler + 0.15F * ((FlightModelMain) super.fm).CT.AileronControl) * 15F, 0.0F,
				(this.pictElev = 0.85F * this.pictElev + 0.15F * ((FlightModelMain) super.fm).CT.ElevatorControl) * 10F);
		...
		super.mesh.chunkSetAngles("Z_Throttle", this.interp(this.setNew.throttle, this.setOld.throttle, f) * 57.72727F, 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_Throttle_D1", this.interp(this.setNew.throttle, this.setOld.throttle, f) * 27F, 0.0F, 0.0F);
		super.mesh.chunkSetAngles("Z_Throttle_tube", -this.interp(this.setNew.throttle, this.setOld.throttle, f) * 57.72727F, 0.0F, 0.0F);
		...
		super.mesh.chunkSetAngles("Z_MagnetoSwitch", -45F + 28.333F * ((FlightModelMain) super.fm).EI.engines[0].getControlMagnetos(), 0.0F, 0.0F);
	...
	public void reflectCockpitState() {
		...
		if ((((FlightModelMain) super.fm).AS.astateCockpitState & 4) != 0) { super.mesh.chunkVisible("Z_HullDamage4", true); }
		...
		if ((((FlightModelMain) super.fm).AS.astateCockpitState & 0x10) != 0) { super.mesh.chunkVisible("Z_HullDamage3", true); }
	...
	protected void reflectPlaneMats() {
		if (Actor.isValid(((Interpolate) super.fm).actor)) {
			if (((Interpolate) super.fm).actor instanceof BF_109B1) {
				...
				this.type = 3;
			} else if (((Interpolate) super.fm).actor instanceof BF_109D1L) { this.type = 4; }
			switch (this.type) {
				case 0: // '\0'
