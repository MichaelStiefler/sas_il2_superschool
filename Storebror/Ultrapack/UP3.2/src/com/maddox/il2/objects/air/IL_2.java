...
public abstract class IL_2 extends Scheme1 implements TypeStormovikArmored {
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		...
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.startsWith("xxarmorp")) {
					...
					switch (i) {
						...
						case 1:
							this.getEnergyPastArmor(7.070000171661377D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
							shot.powerType = 0;
							break;

						case 2:
						case 3:
							this.getEnergyPastArmor(5.0500001907348633D / (Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
							shot.powerType = 0;
							if (shot.power <= 0.0F && Math.abs(v1.x) > 0.86599999666213989D) { this.doRicochet(shot); }
							break;

						case 4:
							if (point3d.x > -1.35D) {
								this.getEnergyPastArmor(5.0500001907348633D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
								shot.powerType = 0;
								if (shot.power <= 0.0F && Math.abs(v1.x) > 0.86599999666213989D) { this.doRicochet(shot); }
							} else {
								this.getEnergyPastArmor(5.0500001907348633D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
							}
							break;
				...
				if (s.startsWith("xxarmorc1")) { this.getEnergyPastArmor(7.070000171661377D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot); }
				if (s.startsWith("xxarmort1")) { this.getEnergyPastArmor(6.059999942779541D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot); }
				return;
			}
			...
			if (s.startsWith("xxspar")) {
				...
				if (s.startsWith("xxsparlm")) {
					...
					} else if (this.chunkDamageVisible("WingLMid") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
				...
				if (s.startsWith("xxsparrm")) {
					...
					} else if (this.chunkDamageVisible("WingRMid") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
				...
				if (s.startsWith("xxsparlo")) {
					...
					} else if (this.chunkDamageVisible("WingLOut") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
				...
				if (s.startsWith("xxsparro")) {
					...
					} else if (this.chunkDamageVisible("WingROut") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
		...
		if (s.startsWith("xcf")) {
			...
			if (point3d.z > 0.159D) {
				this.getEnergyPastArmor(1.25F * World.Rnd().nextFloat(0.95F, 1.12F) / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
			} else if (point3d.x > 1.335D && point3d.x < 2.386D && point3d.z > -0.06D && point3d.z < 0.064000000000000001D) {
				this.getEnergyPastArmor(0.5D / (Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
			} else if (point3d.x > 2.53D && point3d.x < 2.992D && point3d.z > -0.235D && point3d.z < 0.011D) {
				this.getEnergyPastArmor(4.0399999618530273D / (Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
			} else if (point3d.x > 2.559D && point3d.z < -0.595D) {
				this.getEnergyPastArmor(4.0399999618530273D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
			...
			if (Math.abs(v1.x) > 0.86599999666213989D && (shot.power <= 0.0F || World.Rnd().nextFloat() < 0.1F)) { this.doRicochet(shot); }
