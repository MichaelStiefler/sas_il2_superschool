...
public class CockpitHudsonMkI_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			float f = ((Hudson_MkI) CockpitHudsonMkI_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((Hudson_MkI) CockpitHudsonMkI_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitHudsonMkI_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
			if (CockpitHudsonMkI_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitHudsonMkI_Bombardier.this.aAim + 10F * f1, CockpitHudsonMkI_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	...
	public CockpitHudsonMkI_Bombardier() {
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((Hudson_MkI) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((Hudson_MkI) this.aircraft()).fSightCurReadyness > 0.93F;
	...
	static {
		Property.set(CockpitHudsonMkI_Bombardier.class, "astatePilotIndx", 0);
	}
}