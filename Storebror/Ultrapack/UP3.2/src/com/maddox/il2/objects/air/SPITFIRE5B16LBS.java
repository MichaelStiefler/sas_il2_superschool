...
public class SPITFIRE5B16LBS extends SPITFIRE5 {

	public SPITFIRE5B16LBS() {
	}

	static {
		Class class1 = SPITFIRE5B16LBS.class;
		...
		Property.set(class1, "FlightModel", "FlightModels/Spitfire-F-Vb-M45-16.fmd");
