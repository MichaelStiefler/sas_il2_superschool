...
public class P_24E extends P_24 {

	static {
		Class class1 = P_24E.class;
		new NetAircraft.SPAWN(class1);
		Property.set(class1, "iconFar_shortClassName", "P.24");
		Property.set(class1, "meshName", "3DO/Plane/P-24E/hier.him");
		Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
		Property.set(class1, "meshName_ro", "3DO/Plane/P-24E(Romanian)/hier.him");
		...
		Property.set(class1, "FlightModel", "FlightModels/P-24E (Ultrapack).fmd");
