...
public class ME_410A extends ME_210 implements TypeFighter, TypeBNZFighter, TypeStormovik, TypeStormovikArmored, TypeX4Carrier {
	...
	static {
		...
		Property.set(class1, "FlightModel", "FlightModels/Me-410A.fmd");
		Property.set(class1, "cockpitClass", new Class[] { CockpitME_410A.class, Cockpit410A_Bombardier.class });
		Property.set(class1, "LOSElevation", 0.66895F);
		Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 1, 1, 10, 10, 3, 3, 3, 0, 0, 9, 0, 9, 9, 1, 9, 1, 9, 1, 9, 1, 9, 1, 9, 1, 9, 1, 1, 9, 1, 1, 9, 9, 9, 9, 2, 2, 2, 2, 9, 2, 9, 2, 9, 2, 2, 9, 2, 2, 9, 3, 9, 3, 9, 3, 9, 3, 9, 3 });
		Aircraft.weaponHooksRegister(class1,
				new String[] { "_MGUN01", "_MGUN02", "_CANNON01", "_CANNON02", "_MGUN03", "_MGUN04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_CANNON03", "_CANNON04", "_ExternalDev03", "_CANNON05", "_ExternalDev04", "_ExternalDev05", "_MGUN05",
						...
						"_ExternalDev24", "_ExternalBomb04", "_ExternalDev25", "_ExternalBomb05" });
	}
}
