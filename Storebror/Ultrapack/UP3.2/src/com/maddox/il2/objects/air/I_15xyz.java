	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			...
			if (s.startsWith("xcf1")) {
				...
				if (point3d.x > -1.195D && point3d.x < -0.90400000000000003D && point3d.z > 0.20300000000000001D) { this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 4); }
			}
