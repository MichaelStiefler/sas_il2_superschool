		...
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.endsWith("p1")) {
					...
					this.getEnergyPastArmor(12.52D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
				} else if (s.endsWith("p3")) {
					this.getEnergyPastArmor(12.56D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
				} else if (s.endsWith("p4")) {
					this.getEnergyPastArmor(12.56D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
				} else if (s.endsWith("f1")) {
					this.getEnergyPastArmor(2.0999999046325684D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
