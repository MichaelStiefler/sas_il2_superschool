...
public abstract class ASVmkIIIGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(ASVmkIIIGeneric.this.engineSFX != null)
                if(ASVmkIIIGeneric.this.engineSTimer >= 0)
                {
                    if(--ASVmkIIIGeneric.this.engineSTimer <= 0)
                    {
                        ...
                        if(!ASVmkIIIGeneric.this.danger())
                            ASVmkIIIGeneric.this.engineSTimer = -ASVmkIIIGeneric.this.engineSTimer;
                    }
                } else
                if(++ASVmkIIIGeneric.this.engineSTimer >= 0)
                {
