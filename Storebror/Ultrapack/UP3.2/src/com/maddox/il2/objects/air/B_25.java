...
public abstract class B_25 extends Scheme2a {
	...
	public static void moveGear(HierMesh hiermesh, float f) {
		...
		hiermesh.chunkSetAngles("GearC6_D0", 0.0F, floatindex(cvt(f, 0.0F, 1.0F, 0.0F, 10F), anglesc6), 0.0F);
		hiermesh.chunkSetAngles("GearC7_D0", 0.0F, floatindex(cvt(f, 0.0F, 1.0F, 0.0F, 10F), anglesc7), 0.0F);
		hiermesh.chunkSetAngles("GearC4_D0", 0.0F, cvt(f, 0.0F, 0.1F, 0.0F, -95F), 0.0F);
		hiermesh.chunkSetAngles("GearL2_D0", 0.0F, 0.0F, -89.5F * f);
		if (f < 0.5F) {
			hiermesh.chunkSetAngles("GearL4_D0", 0.0F, cvt(f, 0.01F, 0.1F, 0.0F, -45F), 0.0F);
			hiermesh.chunkSetAngles("GearL5_D0", 0.0F, cvt(f, 0.01F, 0.1F, 0.0F, 45F), 0.0F);
		} else {
			hiermesh.chunkSetAngles("GearL4_D0", 0.0F, cvt(f, 0.9F, 0.99F, -45F, 0.0F), 0.0F);
			hiermesh.chunkSetAngles("GearL5_D0", 0.0F, cvt(f, 0.9F, 0.99F, 45F, 0.0F), 0.0F);
		}
		hiermesh.chunkSetAngles("GearL6_D0", 0.0F, cvt(f, 0.0F, 0.1F, 0.0F, 60F), 0.0F);
		hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 0.0F, -89.5F * f);
		if (f < 0.5F) {
			hiermesh.chunkSetAngles("GearR4_D0", 0.0F, cvt(f, 0.01F, 0.1F, 0.0F, -45F), 0.0F);
			hiermesh.chunkSetAngles("GearR5_D0", 0.0F, cvt(f, 0.01F, 0.1F, 0.0F, 45F), 0.0F);
		} else {
			hiermesh.chunkSetAngles("GearR4_D0", 0.0F, cvt(f, 0.9F, 0.99F, -45F, 0.0F), 0.0F);
			hiermesh.chunkSetAngles("GearR5_D0", 0.0F, cvt(f, 0.9F, 0.99F, 45F, 0.0F), 0.0F);
		}
		hiermesh.chunkSetAngles("GearR6_D0", 0.0F, cvt(f, 0.0F, 0.1F, 0.0F, -60F), 0.0F);
	}
	...
	public void moveWheelSink() {
		...
		xyz[2] = cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.33F, 0.0F, 0.33F);
		this.hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
		this.resetYPRmodifier();
		xyz[1] = cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.33F, 0.0F, 0.33F);
		this.hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
		this.resetYPRmodifier();
		xyz[2] = cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.154F, 0.0F, 0.154F);
		...
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				if (s.endsWith("p1") || s.endsWith("p2")) {
					if (Math.abs(v1.x) > 0.5D) {
						this.getEnergyPastArmor(7.94D / Math.abs(v1.x), shot);
					} else {
						this.getEnergyPastArmor(9.5299997329711914D / (1.0D - Math.abs(v1.x)), shot);
					}
				}
				if (s.endsWith("p3")) { this.getEnergyPastArmor(7.94D / (Math.abs(v1.z) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p4")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p5") || s.endsWith("p6")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(v1.y) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p7")) { this.getEnergyPastArmor(0.5D / (Math.abs(v1.z) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p8")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a1")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(v1.y) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a2")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(v1.y) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a3")) { this.getEnergyPastArmor(6.3499999046325684D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a4") || s.endsWith("a5")) { this.getEnergyPastArmor(12.699999809265137D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a6") || s.endsWith("a7")) { this.getEnergyPastArmor(6.3499999046325684D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("r1")) { this.getEnergyPastArmor(3.17D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("r2") || s.endsWith("r3")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("c1") || s.endsWith("c2")) { this.getEnergyPastArmor(8.7299995422363281D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				return;
			}
			...
			if (s.startsWith("xxspar")) {
				if (s.startsWith("xxspart") && World.Rnd().nextFloat() < 0.1F && this.chunkDamageVisible("Tail1") > 2 && this.getEnergyPastArmor(19.9F / (float) Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F) {
