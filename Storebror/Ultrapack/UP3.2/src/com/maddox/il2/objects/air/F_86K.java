...
public class F_86K extends F_86D implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit {
	...
	public void destroy() {
		if (Actor.isValid(this.turbo)) { this.turbo.destroy(); }
		if (Actor.isValid(this.turbosmoke)) { this.turbosmoke.destroy(); }
		if (Actor.isValid(this.afterburner)) { this.afterburner.destroy(); }
		super.destroy();
	}
