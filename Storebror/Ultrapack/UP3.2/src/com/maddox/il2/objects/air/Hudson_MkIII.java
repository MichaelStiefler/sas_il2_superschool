...
public class Hudson_MkIII extends Hudson123 implements TypeStormovik, TypeBomber {
	...
	public void typeBomberUpdate(float f) {
		...
		if (this.fSightCurReadyness < 1.0F) {
			...
			if (this.fSightCurDistance < Hudson_MkIII.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(Hudson_MkIII.toMeters(this.fSightCurAltitude) * 0.2038736F)) { this.bSightBombDump = true; }
	...
	static {
		...
		Property.set(class1, "FlightModel", "FlightModels/Hudson_MkIII.fmd");
		...
		Aircraft.weaponHooksRegister(class1,
				new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10" });
	}
}
