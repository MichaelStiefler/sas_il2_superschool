...
public class A6M_21Late extends A6M {
	...
	public void update(float f) {
		...
		if (this.FM.CT.getArrestor() > 0.2F) {
			if (this.FM.Gears.arrestorVAngle != 0.0F) {
				...
				if (f2 < 0.0F && this.FM.getSpeedKMH() > 60F) { Eff3DActor.New(this, this.FM.Gears.arrestorHook, (Loc) null, 1.0F, "3DO/Effects/Fireworks/04_Sparks.eff", 0.1F); }
	...
	static {
		Class class1 = A6M_21Late.class;
		new NetAircraft.SPAWN(class1);
		Property.set(class1, "iconFar_shortClassName", "A6M");
		Property.set(class1, "meshName", "3DO/Plane/A6M-21Late(Multi1)/hier.him");
		Property.set(class1, "PaintScheme", new PaintSchemeFMPar01());
		Property.set(class1, "meshName_ja", "3DO/Plane/A6M-21Late(ja)/hier.him");
		Property.set(class1, "PaintScheme_ja", new PaintSchemeFCSPar01());
		Property.set(class1, "yearService", 1943.5F);
		Property.set(class1, "yearExpired", 1945.5F);
		Property.set(class1, "FlightModel", "FlightModels/A6M2-21_Late.fmd");
