		...
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.endsWith("p1")) {
					...
					if (point3d.z < -0.27D) {
						this.getEnergyPastArmor(4.0999999046325684D / (Math.abs(v1.z) + 9.9999997473787516E-006D), shot);
					} else {
						this.getEnergyPastArmor(8.1D / (Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
					}
				} else if (s.endsWith("p4")) {
					this.getEnergyPastArmor(10.1D / (Math.abs(v1.z) + 9.9999997473787516E-006D), shot);
				} else if (s.endsWith("p5")) {
					this.getEnergyPastArmor(10.1D / (Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
				} else if (s.endsWith("p6")) {
					this.getEnergyPastArmor(12.1D / (Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
