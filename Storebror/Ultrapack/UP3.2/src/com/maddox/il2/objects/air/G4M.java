...
public abstract class G4M extends Scheme2 {
	...
	public static void moveGear(HierMesh hiermesh, float f) {
		...
		hiermesh.chunkSetAngles("GearL4_D0", 0.0F, cvt(f, 0.01F, 0.1F, 0.0F, -90F), 0.0F);
		hiermesh.chunkSetAngles("GearL5_D0", 0.0F, cvt(f, 0.01F, 0.1F, 0.0F, -90F), 0.0F);
		hiermesh.chunkSetAngles("GearR2_D0", 0.0F, -90F * f, 0.0F);
		hiermesh.chunkSetAngles("GearR4_D0", 0.0F, cvt(f, 0.01F, 0.1F, 0.0F, -90F), 0.0F);
		hiermesh.chunkSetAngles("GearR5_D0", 0.0F, cvt(f, 0.01F, 0.1F, 0.0F, -90F), 0.0F);
	}
	...
	public boolean turretAngles(int i, float af[]) {
		...
		switch (i) {
			...
			case 2:
				...
				if (f1 > cvt(Math.abs(f), 0.0F, 50F, 40F, 25F)) { f1 = cvt(Math.abs(f), 0.0F, 50F, 40F, 25F); }
				if (f1 < cvt(Math.abs(f), 0.0F, 50F, -10F, -3.5F)) { f1 = cvt(Math.abs(f), 0.0F, 50F, -10F, -3.5F); }
				break;
		...
		if (s.startsWith("xx")) {
			...
			if (s.startsWith("xxeng")) {
				...
				if (s.endsWith("gear")) {
					if (this.getEnergyPastArmor(0.1F, shot) > 0.0F) {
						if (Pd.y > 0.0D && Pd.z < 0.18899999558925629D && World.Rnd().nextFloat(0.0F, 16000F) < shot.power) { this.FM.EI.engines[j].setMagnetoKnockOut(shot.initiator, 0); }
						if (Pd.y < 0.0D && Pd.z < 0.18899999558925629D && World.Rnd().nextFloat(0.0F, 16000F) < shot.power) { this.FM.EI.engines[j].setMagnetoKnockOut(shot.initiator, 1); }
			...
			if (s.startsWith("xxfuel")) {
				...
				if (this.getEnergyPastArmor(0.8F, shot) > 0.0F && World.Rnd().nextFloat() < 0.2F) {
					...
					if (World.Rnd().nextFloat() < 0.15F) { this.FM.AS.hitTank(shot.initiator, k, 1); }
			...
			if (s.startsWith("xxpar")) {
				if (s.startsWith("xxpark") && this.chunkDamageVisible("Keel1") > 1 && this.getEnergyPastArmor(10.699999809265137D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
				...
				if (s.startsWith("xxparlm") && this.chunkDamageVisible("WingLMid") > 2 && this.getEnergyPastArmor(10.8D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					this.debuggunnery("*** WingLMid Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
				}
				if (s.startsWith("xxparrm") && this.chunkDamageVisible("WingRMid") > 2 && this.getEnergyPastArmor(10.8D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					this.debuggunnery("*** WingRMid Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
				}
				if (s.startsWith("xxparlo") && this.chunkDamageVisible("WingLOut") > 2 && this.getEnergyPastArmor(8.8D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					this.debuggunnery("*** WingLOut Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
				}
				if (s.startsWith("xxparro") && this.chunkDamageVisible("WingROut") > 2 && this.getEnergyPastArmor(8.8D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					this.debuggunnery("*** WingROut Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
				}
				if (s.startsWith("xxparrs") && this.chunkDamageVisible("StabL") > 1 && this.getEnergyPastArmor(8.8D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
					this.debuggunnery("*** StabL Spars Damaged..");
					this.nextDMGLevels(1, 2, "StabL_D2", shot.initiator);
				}
				if (s.startsWith("xxparls") && this.chunkDamageVisible("StabR") > 1 && this.getEnergyPastArmor(8.8D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F) {
