...
public class Hudson_MkI extends Hudson123 implements TypeStormovik, TypeBomber {
	...
	public void typeBomberUpdate(float f) {
		...
		if (this.fSightCurReadyness < 1.0F) {
			...
			if (this.fSightCurDistance < Hudson_MkI.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(Hudson_MkI.toMeters(this.fSightCurAltitude) * 0.2038736F)) { this.bSightBombDump = true; }
	...
	static {
		...
		Property.set(class1, "FlightModel", "FlightModels/Hudson_MkI.fmd");
