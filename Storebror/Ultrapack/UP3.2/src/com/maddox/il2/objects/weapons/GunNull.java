...
public abstract class GunNull extends Gun {
	...
	public int countBullets() {
		if (this.getOwner() != null && this.getOwner() instanceof TypeGuidedMissileCarrier) {
			return ((TypeGuidedMissileCarrier) this.getOwner()).getGuidedMissileUtils().hasMissiles() ? 0x7fffffff : 0;
		} else {
