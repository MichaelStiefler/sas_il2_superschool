...
public class BELL_47 extends Scheme1 implements TypeScout, TypeTransport {
	...
	public void onAircraftLoaded() {
		...
		if (this.getGunByHookName("_MGUN01") instanceof GunEmpty) { this.hierMesh().chunkVisible("30Cal_MGR", false); }
		if (this.getGunByHookName("_MGUN03") instanceof GunEmpty) { this.hierMesh().chunkVisible("30Cal_MGL", false); }
	}
	...
	public void update(float f) {
		...
		((FlightModelMain) super.FM).Or.increment(f2 * (((FlightModelMain) super.FM).CT.getRudder() + this.FM.CT.getTrimRudderControl()), f2 * (this.FM.CT.getElevator() + this.FM.CT.getTrimElevatorControl()),
