		...
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.equals("xxarmorc1")) {
					this.getEnergyPastArmor(World.Rnd().nextFloat(10F, 15F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
					...
					if (s.endsWith("3")) { this.getEnergyPastArmor(12.699999809265137D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot); }
