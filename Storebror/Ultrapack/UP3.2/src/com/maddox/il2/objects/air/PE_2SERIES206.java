...
public class PE_2SERIES206 extends PE_2 implements TypeBomber, TypeDiveBomber, TypeTransport {
		...
		if (Time.current() > this.tme) {
			...
			if (this.FM.turret.length != 0) {
				...
				if (actor == null) {
					...
					if (Aircraft.tmpLoc3.getPoint().x < -Math.abs(Aircraft.tmpLoc3.getPoint().y)) {
						this.setRadist(1);
					} else if (Aircraft.tmpLoc3.getPoint().y < 0.0D) {
						this.setRadist(2);
					} else {
						this.setRadist(3);
					}
	...
	static {
		Class class1 = PE_2SERIES206.class;
		...
		Property.set(class1, "yearService", 1943.7F);
		Property.set(class1, "yearExpired", 1945.5F);
		Property.set(class1, "FlightModel", "FlightModels/Pe-2series206.fmd");
		Property.set(class1, "cockpitClass", new Class[] { CockpitPE2_206.class, CockpitPE2_Bombardier.class, CockpitPE2_110_TGunner.class });
		Property.set(class1, "LOSElevation", 0.76315F);
		Aircraft.weaponTriggersRegister(class1, new int[] { 0, 1, 10, 11, 12, 13, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
		Aircraft.weaponHooksRegister(class1, new String[] { "_CANNON02", "_CANNON01", "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb03", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb04", "_ExternalBomb01", "_ExternalBomb01",
				"_ExternalBomb02", "_ExternalBomb02", "_BombSpawn05", "_BombSpawn05", "_BombSpawn06", "_BombSpawn06", "_BombSpawn01", "_BombSpawn01", "_BombSpawn02", "_BombSpawn02", "_BombSpawn03", "_BombSpawn03", "_BombSpawn04", "_BombSpawn04" });
	}
}
