...
public abstract class NaxosGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(NaxosGeneric.this.engineSFX != null)
                if(NaxosGeneric.this.engineSTimer >= 0)
                {
                    if(--NaxosGeneric.this.engineSTimer <= 0)
                    {
                        NaxosGeneric.this.engineSTimer = (int)NaxosGeneric.SecsToTicks(NaxosGeneric.Rnd(15F, 15F));
                        if(!NaxosGeneric.this.danger())
                            NaxosGeneric.this.engineSTimer = -NaxosGeneric.this.engineSTimer;
                    }
                } else
                if(++NaxosGeneric.this.engineSTimer >= 0)
                {
