...
public abstract class AImkXVGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(AImkXVGeneric.this.engineSFX != null)
                if(AImkXVGeneric.this.engineSTimer >= 0)
                {
                    if(--AImkXVGeneric.this.engineSTimer <= 0)
                    {
                        ...
                        if(!AImkXVGeneric.this.danger())
                            AImkXVGeneric.this.engineSTimer = -AImkXVGeneric.this.engineSTimer;
                    }
                } else
                if(++AImkXVGeneric.this.engineSTimer >= 0)
                {
