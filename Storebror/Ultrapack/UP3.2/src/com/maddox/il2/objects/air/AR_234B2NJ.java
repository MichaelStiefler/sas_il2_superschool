...
//			if (FM.getAltitude() > 300F && boosterFireOutTime == -1L && FM.Loc.z != 0.0D && World.Rnd().nextFloat() < 0.05F) {
	...
	public void typeBomberUpdate(float f) {
		...
		if (this.fSightCurReadyness < 1.0F) {
			...
			if (this.fSightCurDistance < this.fSightCurSpeed / 3.6F * Math.sqrt(this.fSightCurAltitude * 0.2038736F)) { this.bSightBombDump = true; }
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitAR_234B2NJ.class, CockpitAR_234B2NJ_Bombardier.class });
