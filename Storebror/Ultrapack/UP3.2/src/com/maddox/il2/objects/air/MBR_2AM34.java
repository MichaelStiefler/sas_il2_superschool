...
public class MBR_2AM34 extends Scheme1 implements TypeTransport, TypeBomber, TypeSailPlane {
		...
		switch (i) {
			...
			case 0:
				...
				if (f2 < 114F) {
					...
					if (f1 < -24F) { f1 = -24F; }
					if (f1 < -61.962F + 0.333F * f) { flag = false; }
					if (f1 < -19.111F + 0.185185F * f && f1 > 40F - 0.333F * f) { flag = false; }
				} else if (f2 < 168F) {
					if (f1 < -97.666F + 0.481482F * f) { f1 = -97.666F + 0.481482F * f; }
					if (f1 < -19.111F + 0.185185F * f) { flag = false; }
				} else {
					if (f1 < -97.666F + 0.481482F * f) { f1 = -97.666F + 0.481482F * f; }
					flag = false;
				}
			...
			case 1:
				float f3 = Math.abs(f);
				if (f3 < 2.0F) { flag = false; }
				if (f3 < 6.5F) {
					if (f1 < -4F) { f1 = -4F; }
					if (f1 < 17.666F - 3.333F * f) { flag = false; }
				} else if (f3 < 45F) {
	...
	public void msgShot(Shot shot) {
		...
		if (shot.chunkName.startsWith("Pilot3")) { this.killPilot(shot.initiator, 2); }
		super.msgShot(shot);
	}
