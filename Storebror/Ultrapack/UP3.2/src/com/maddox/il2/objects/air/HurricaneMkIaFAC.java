...
public class HurricaneMkIaFAC extends Hurricane implements TypeFighter {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitHURRII.class, CockpitIL2_GunnerOpen.class });
		Property.set(class1, "LOSElevation", 0.965F);
		Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 0, 0, 0, 0, 10 });
		Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09" });
	}
}
