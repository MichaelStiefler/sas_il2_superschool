	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.endsWith("p1")) {
					this.getEnergyPastArmor(World.Rnd().nextFloat(0.0F, 45.2F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
					...
					this.getEnergyPastArmor(10.1D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
				} else if (s.endsWith("p6")) {
					this.getEnergyPastArmor(12D + World.Rnd().nextFloat(10F, 30F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
				} else if (s.endsWith("p7")) {
					this.getEnergyPastArmor(8.0799999237060547D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
				} else if (s.endsWith("p8")) {
					this.getEnergyPastArmor(1.0099999904632568D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
				...
				} else if (s.endsWith("p10")) {
					this.getEnergyPastArmor(9.0900001525878906D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
				} else if (s.endsWith("p11")) {
					this.getEnergyPastArmor(64.639999389648438D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
					if (shot.power <= 0.0F) { this.doRicochetBack(shot); }
				} else if (s.startsWith("xxarmore")) {
					this.getEnergyPastArmor(5.0500001907348633D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
				} else if (s.startsWith("xxarmorw")) { this.getEnergyPastArmor(5.0500001907348633D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot); }
				return;
			}
