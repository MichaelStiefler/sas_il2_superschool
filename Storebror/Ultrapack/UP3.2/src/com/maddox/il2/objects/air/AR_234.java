...
public abstract class AR_234 extends Scheme2 implements TypeBomber, TypeDiveBomber {
	...
	public static void moveGear(HierMesh hiermesh, float f) {
		hiermesh.chunkSetAngles("GearC2_D0", 0.0F, cvt(f, 0.2F, 0.65F, 0.0F, -92F), 0.0F);
		hiermesh.chunkSetAngles("GearC3_D0", 0.0F, 0.0F, 0.0F);
		hiermesh.chunkSetAngles("GearC4_D0", 0.0F, cvt(f, 0.2F, 0.65F, 0.0F, -62.5F), 0.0F);
		if (f < 0.525F) {
			hiermesh.chunkSetAngles("GearC6_D0", 0.0F, cvt(f, 0.2F, 0.525F, 0.0F, -46F), 0.0F);
			hiermesh.chunkSetAngles("GearC7_D0", 0.0F, cvt(f, 0.2F, 0.525F, 0.0F, -0.25F), 0.0F);
		} else {
			hiermesh.chunkSetAngles("GearC6_D0", 0.0F, cvt(f, 0.525F, 0.65F, -46F, -73.5F), 0.0F);
			hiermesh.chunkSetAngles("GearC7_D0", 0.0F, cvt(f, 0.525F, 0.65F, -0.25F, -7.5F), 0.0F);
		}
		ypr[0] = ypr[1] = ypr[2] = xyz[0] = xyz[1] = xyz[2] = 0.0F;
		xyz[1] = cvt(f, 0.2F, 0.65F, 0.0F, -0.2935F);
		hiermesh.chunkSetLocate("GearC8_D0", xyz, ypr);
		hiermesh.chunkSetAngles("GearC9_D0", 0.0F, cvt(f, 0.07F, 0.32F, 0.0F, -98F), 0.0F);
		hiermesh.chunkSetAngles("GearC10_D0", 0.0F, cvt(f, 0.07F, 0.32F, 0.0F, -98F), 0.0F);
		hiermesh.chunkSetAngles("GearL2_D0", 0.0F, cvt(f, 0.3F, 0.8F, 0.0F, -90F), 0.0F);
		hiermesh.chunkSetAngles("GearL6_D0", 0.0F, floatindex(cvt(f, 0.3F, 0.8F, 0.0F, 3F), gear6), 0.0F);
		ypr[0] = ypr[1] = ypr[2] = xyz[0] = xyz[1] = xyz[2] = 0.0F;
		xyz[1] = floatindex(cvt(f, 0.3F, 0.8F, 0.0F, 3F), gear7);
		hiermesh.chunkSetLocate("GearL7_D0", xyz, ypr);
		if (f < 0.6F) {
			hiermesh.chunkSetAngles("GearL8_D0", 0.0F, cvt(f, 0.3F, 0.6F, 0.0F, -76.5F), 0.0F);
			hiermesh.chunkSetAngles("GearL9_D0", 0.0F, cvt(f, 0.1F, 0.3F, 0.0F, -44F), 0.0F);
		} else {
			hiermesh.chunkSetAngles("GearL8_D0", 0.0F, cvt(f, 0.6F, 0.8F, -76.5F, -62F), 0.0F);
			hiermesh.chunkSetAngles("GearL9_D0", 0.0F, cvt(f, 0.6F, 0.8F, -44F, 0.0F), 0.0F);
		}
		hiermesh.chunkSetAngles("GearR2_D0", 0.0F, cvt(f, 0.3F, 0.8F, 0.0F, -90F), 0.0F);
		hiermesh.chunkSetAngles("GearR6_D0", 0.0F, floatindex(cvt(f, 0.3F, 0.8F, 0.0F, 3F), gear6), 0.0F);
		ypr[0] = ypr[1] = ypr[2] = xyz[0] = xyz[1] = xyz[2] = 0.0F;
		xyz[1] = floatindex(cvt(f, 0.3F, 0.8F, 0.0F, 3F), gear7);
		hiermesh.chunkSetLocate("GearR7_D0", xyz, ypr);
		if (f < 0.6F) {
			hiermesh.chunkSetAngles("GearR8_D0", 0.0F, cvt(f, 0.3F, 0.6F, 0.0F, -76.5F), 0.0F);
			hiermesh.chunkSetAngles("GearR9_D0", 0.0F, cvt(f, 0.1F, 0.3F, 0.0F, -44F), 0.0F);
		} else {
			hiermesh.chunkSetAngles("GearR8_D0", 0.0F, cvt(f, 0.6F, 0.8F, -76.5F, -62F), 0.0F);
			hiermesh.chunkSetAngles("GearR9_D0", 0.0F, cvt(f, 0.6F, 0.8F, -44F, 0.0F), 0.0F);
		}
	}
	...
	public void moveWheelSink() {
		...
		this.hierMesh().chunkSetAngles("GearL4_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -46F), 0.0F);
		this.hierMesh().chunkSetAngles("GearL5_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -46F), 0.0F);
		xyz[1] = cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -0.3274F);
		this.hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
		this.hierMesh().chunkSetAngles("GearR4_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -46F), 0.0F);
		this.hierMesh().chunkSetAngles("GearR5_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -46F), 0.0F);
	}
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				...
				if (s.startsWith("xxarmorp")) { this.getEnergyPastArmor(15.149999618530273D / (Math.abs(v1.x) + 9.9999997473787516E-006D), shot); }
				return;
			}
			...
			if (s.startsWith("xxSpar")) {
				...
				if (s.startsWith("xxSparLI") && this.chunkDamageVisible("WingLIn") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingLIn Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
				}
				if (s.startsWith("xxSparrI") && this.chunkDamageVisible("WingRIn") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingRIn Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
				}
				if (s.startsWith("xxSparlm") && this.chunkDamageVisible("WingLMid") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingLMid Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
				}
				if (s.startsWith("xxSparrm") && this.chunkDamageVisible("WingRMid") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingRMid Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
				}
				if (s.startsWith("xxSparlo") && this.chunkDamageVisible("WingLOut") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
					this.debuggunnery("Spar Construction: WingLOut Spar Hit, Breaking in Half..");
					this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
				}
				if (s.startsWith("xxSparro") && this.chunkDamageVisible("WingROut") > 2 && World.Rnd().nextFloat() > Math.abs(v1.x) + 0.11999999731779099D && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) > 0.0F) {
