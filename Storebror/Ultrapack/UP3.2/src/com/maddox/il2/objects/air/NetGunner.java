...
public class NetGunner extends com.maddox.il2.engine.Actor {
		...
		public boolean netInput(NetMsgInput netmsginput) throws java.io.IOException {
			...
			if (NetGunner.this.checkAircraft() && NetGunner.this.netCockpitTuretNum >= 0) {
				...
				if (com.maddox.il2.net.NetMissionTrack.isPlaying() && NetGunner.this.aircraft == com.maddox.il2.ai.World.getPlayerAircraft()) {
					...
					((com.maddox.il2.objects.air.CockpitGunner) com.maddox.il2.game.Main3D.cur3D().cockpits[NetGunner.this.getCockpitNum()]).moveGun(com.maddox.il2.engine.Actor._tmpOrient);
				} else {
	...
	private boolean checkAircraft() {
		...
		this.aircraft = (com.maddox.il2.objects.air.Aircraft) com.maddox.il2.engine.Actor.getByName(this.aircraftName);
...
//        user.setArmy(aircraft.getArmy()); // Test Modified
		...
		if (this.isNetMaster() || this.user.isTrackWriter()) {
			...
			try {
				com.maddox.il2.objects.air.CockpitGunner cockpitgunner = (com.maddox.il2.objects.air.CockpitGunner) com.maddox.il2.game.Main3D.cur3D().cockpits[this.getCockpitNum()];
	...
	public void doNetFirstUpdate(java.lang.Object obj) {
		...
		if (!this.checkAircraft() || !netchannel.isMirrored(this.aircraft.net)) {
			if (com.maddox.il2.engine.Actor.isValid(this.aircraft) && this.aircraft.net.masterChannel() == netchannel) {
				return;
			} else {
	...
	public NetGunner(java.lang.String s, com.maddox.il2.net.NetUser netuser, int i, int j) {
		...
		if (netuser.isMaster()) {
			...
			this.net = new Mirror(this, netuser.masterChannel(), i);
		}
