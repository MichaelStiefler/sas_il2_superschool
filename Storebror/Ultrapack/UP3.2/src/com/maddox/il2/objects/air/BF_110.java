			...
			if (s.startsWith("xxarmor")) {
				...
				if (s.endsWith("p1")) {
					if (Math.abs(point3d.y) > 0.231D) {
						this.getEnergyPastArmor(8.585D / (Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
					} else {
					...
					if (point3d.z < 0.080000000000000002D) {
						this.getEnergyPastArmor(8.585D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
					} else {
						if (point3d.z < 0.09D) {
						...
						if (point3d.z > 0.288D && Math.abs(point3d.y) < 0.077D) {
							this.getEnergyPastArmor(World.Rnd().nextFloat(8.5F, 12.46F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
						} else {
							this.getEnergyPastArmor(10.51D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
						}
					}
					...
					this.getEnergyPastArmor(5.51D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
					...
					if (point3d.z > 0.448D) {
						...
						if (point3d.z > 0.021000000000000001D) {
							this.getEnergyPastArmor(8.51D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
						} else {
							this.debuggunnery("Armor: Bullet Went Through a Pilofacturing Hole..");
							return;
						}
						...
						this.getEnergyPastArmor(8.0600004196166992D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
					}
				} else if (s.endsWith("p7")) {
					this.getEnergyPastArmor(6.059999942779541D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
