...
public abstract class B_25_Strafer extends B_25 {
	...
	private boolean isNotPilot3(String s) {
		boolean flag = true;
		if (s.startsWith("xpilot3") || s.startsWith("xhead3")) { flag = false; }
		return flag;
	}
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
			...
			if (s.startsWith("xxarmor")) {
				if (s.endsWith("p1") || s.endsWith("p2")) {
					if (Math.abs(Aircraft.v1.x) > 0.5D) {
						...
						this.getEnergyPastArmor(9.5299997329711914D / (1.0D - Math.abs(Aircraft.v1.x)), shot);
					}
				}
				if (s.endsWith("p3")) { this.getEnergyPastArmor(7.94D / (Math.abs(Aircraft.v1.z) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p4")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p5") || s.endsWith("p6")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(Aircraft.v1.y) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p7")) { this.getEnergyPastArmor(0.5D / (Math.abs(Aircraft.v1.z) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p8")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a1")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(Aircraft.v1.y) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a2")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(Aircraft.v1.y) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a3")) { this.getEnergyPastArmor(6.3499999046325684D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("a4") || s.endsWith("a5")) { this.getEnergyPastArmor(12.699999809265137D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot); }
				...
				if (s.endsWith("r2") || s.endsWith("r3")) { this.getEnergyPastArmor(9.5299997329711914D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("c1") || s.endsWith("c2")) { this.getEnergyPastArmor(8.7299995422363281D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot); }
				return;
			}
		...
		} else if (s.startsWith("xpilot") || s.startsWith("xhead") && this.isNotPilot3(s)) {
			byte byte0 = 0;
			int i1;
			if (s.endsWith("a")) {
				byte0 = 1;
