...
public abstract class N1K extends Scheme1 implements TypeFighter {
		...
		if (this.FM.CT.FlapsControl <= 0.32F && this.FM.CT.FlapsControl >= 0.05F) {
			...
			if (this.mBar < 315F && this.FM.getOverload() > 0.0F && f1 < 128F) {
				...
				if (this.curFlaps < this.desiredPosition) {
					this.curFlaps = this.flapsMovement(f, this.desiredPosition, this.curFlaps, 999F, cvt(this.FM.getSpeedKMH(), 150F, 280F, 0.15F, 0.08F));
				} else {
	...
	public static void moveGear(HierMesh hiermesh, float f) {
		...
		if (f > 0.75F) {
			hiermesh.chunkSetAngles("GearR5_D0", 0.0F, cvt(f, 0.75F, 0.95F, -45F, -65F), 0.0F);
		} else {
			hiermesh.chunkSetAngles("GearR5_D0", 0.0F, cvt(f, 0.4F, 0.75F, 0.0F, -45F), 0.0F);
		}
		hiermesh.chunkSetAngles("GearR6_D0", 0.0F, cvt(f, 0.05F, 0.95F, 0.0F, -130F), 0.0F);
		if (f > 0.75F) {
			hiermesh.chunkSetAngles("GearR7_D0", 0.0F, cvt(f, 0.725F, 0.95F, -86F, -133F), 0.0F);
		} else {
			hiermesh.chunkSetAngles("GearR7_D0", 0.0F, cvt(f, 0.05F, 0.725F, 0.0F, -86F), 0.0F);
		}
		xyz[1] = cvt(f, 0.05F, 0.95F, 0.0F, -0.1F);
		...
		if (s.startsWith("xx")) {
			if (s.startsWith("xxarmor")) {
				if (s.endsWith("p1")) {
					...
					this.getEnergyPastArmor(13.13D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
