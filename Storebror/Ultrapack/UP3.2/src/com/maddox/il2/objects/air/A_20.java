	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			...
			if (s.startsWith("xxarmor")) {
				if (s.endsWith("p1")) { this.getEnergyPastArmor(12.1D / Math.abs(v1.x), shot); }
				if (s.endsWith("p2")) {
					this.getEnergyPastArmor(World.Rnd().nextFloat(20F, 60F) / Math.abs(v1.x), shot);
					if (shot.power <= 0.0F) {
				...
				if (s.endsWith("p4")) { this.getEnergyPastArmor(12.699999809265137D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p5")) { this.getEnergyPastArmor(12.699999809265137D / (Math.abs(v1.z) + 9.9999999747524271E-007D), shot); }
				if (s.endsWith("p6")) { this.getEnergyPastArmor(4.0999999046325684D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot); }
