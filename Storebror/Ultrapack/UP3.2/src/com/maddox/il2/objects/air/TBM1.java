...
public class TBM1 extends TBF {
	...
	static {
		...
		Property.set(class1, "iconFar_shortClassName", "TBM-1");
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitTBX1.class, CockpitTBM1_Bombardier.class, CockpitTBX1_TGunner.class, CockpitTBX1_BGunner.class });
