...
public class BF_110C1 extends BF_110 {
	...
	static {
		Class class1 = BF_110C1.class;
		new NetAircraft.SPAWN(class1);
		Property.set(class1, "iconFar_shortClassName", "Bf-110");
		Property.set(class1, "meshName", "3DO/Plane/Bf-110C-1/hier.him");
		Property.set(class1, "PaintScheme", new PaintSchemeBMPar01());
		Property.set(class1, "yearService", 1940F);
		Property.set(class1, "yearExpired", 1945.5F);
		Property.set(class1, "FlightModel", "FlightModels/Bf-110Cvroeg.fmd");
		Property.set(class1, "cockpitClass", new Class[] { CockpitBF_110C1.class, CockpitBF_110E1_Gunner.class });
