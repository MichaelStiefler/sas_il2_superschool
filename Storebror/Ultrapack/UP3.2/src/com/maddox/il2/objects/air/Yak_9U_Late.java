...
public class Yak_9U_Late extends YAK implements TypeBNZFighter {
	...
	static {
		Class class1 = Yak_9U_Late.class;
		...
		Property.set(class1, "FlightModel", "FlightModels/Yak-9U-Late.fmd");
