...
public class Cockpit_KikkaF extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            Cockpit_KikkaF.this.setNew.azimuth = Cockpit_KikkaF.this.fm.Or.getYaw();
            if ((Cockpit_KikkaF.this.setOld.azimuth > 270F) && (Cockpit_KikkaF.this.setNew.azimuth < 90F)) {
                Cockpit_KikkaF.this.setOld.azimuth -= 360F;
            }
            if ((Cockpit_KikkaF.this.setOld.azimuth < 90F) && (Cockpit_KikkaF.this.setNew.azimuth > 270F)) {
                Cockpit_KikkaF.this.setOld.azimuth += 360F;
            }
            Cockpit_KikkaF.this.setNew.waypointAzimuth = ((10F * Cockpit_KikkaF.this.setOld.waypointAzimuth) + (Cockpit_KikkaF.this.waypointAzimuth() - Cockpit_KikkaF.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
