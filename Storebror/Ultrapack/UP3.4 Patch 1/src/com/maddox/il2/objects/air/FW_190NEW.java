...
public abstract class FW_190NEW extends Scheme1 implements TypeFighter, TypeBNZFighter {
...
//    }
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        ...
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 77F * f, 0.0F);
        double theta0 = -0.14D;
        FW_190NEW.AxisPos[FW_190NEW.axisD][FW_190NEW.idX] = Math.cos(theta0) * FW_190NEW.LengthA_D;
        FW_190NEW.AxisPos[FW_190NEW.axisD][FW_190NEW.idY] = Math.sin(theta0) * FW_190NEW.LengthA_D;
        double theta1 = ((f * 77D) / 180D) * Math.PI;
        FW_190NEW.AxisPos[FW_190NEW.axisB][FW_190NEW.idX] = Math.cos(theta1) * FW_190NEW.LengthA_B;
        FW_190NEW.AxisPos[FW_190NEW.axisB][FW_190NEW.idY] = Math.sin(theta1) * FW_190NEW.LengthA_B;
        double LengthB_D = FW_190NEW.getDst(FW_190NEW.AxisPos[FW_190NEW.axisB][FW_190NEW.idX], FW_190NEW.AxisPos[FW_190NEW.axisB][FW_190NEW.idY], FW_190NEW.AxisPos[FW_190NEW.axisD][FW_190NEW.idX], FW_190NEW.AxisPos[FW_190NEW.axisD][FW_190NEW.idY]);
        double theta4_1 = Math.acos((FW_190NEW.LengthA_D - FW_190NEW.AxisPos[FW_190NEW.axisB][FW_190NEW.idX]) / LengthB_D);
        ...
        double theta3 = 0.0D;
        Cos2_2 = (((LengthB_D * LengthB_D) + FW_190NEW.LengthB_C * FW_190NEW.LengthB_C) - FW_190NEW.LengthC_D * FW_190NEW.LengthC_D) / (2D * LengthB_D * FW_190NEW.LengthB_C);
        Cos2_2 = Cos2_2 <= 1.0D ? Cos2_2 : 1.0D;
        Cos2_2 = Cos2_2 >= -1D ? Cos2_2 : -1D;
        theta2_2 = Math.acos(Cos2_2);
        Cos4_2 = (((LengthB_D * LengthB_D) + FW_190NEW.LengthC_D * FW_190NEW.LengthC_D) - FW_190NEW.LengthB_C * FW_190NEW.LengthB_C) / (2D * LengthB_D * FW_190NEW.LengthC_D);
        Cos4_2 = Cos4_2 <= 1.0D ? Cos4_2 : 1.0D;
        Cos4_2 = Cos4_2 >= -1D ? Cos4_2 : -1D;
        theta4_2 = Math.acos(Cos4_2);
        Cos3 = ((FW_190NEW.LengthC_D * FW_190NEW.LengthC_D) + (FW_190NEW.LengthB_C * FW_190NEW.LengthB_C) - (LengthB_D * LengthB_D)) / (2.0F * FW_190NEW.LengthC_D * FW_190NEW.LengthB_C);
    ...
    public void EjectCanopy() {
        ...
        if (this.FM.actor instanceof FW_190A7STURM) {
            Main3D.cur3D().cockpitCur.mesh.chunkVisible("ArmorL1_D0", false);
            Main3D.cur3D().cockpitCur.mesh.chunkVisible("ArmorR1_D0", false);
        }
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.endsWith("p1")) {
                    ...
                    if (World.Rnd().nextFloat() < ((this.FM.actor instanceof FW_190A7STURM)?0.05F:0.15F)) {
                        this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 2);
                    }
                    Aircraft.debugprintln(this, "*** Armor Glass: Hit..");
                    if (shot.power <= ((this.FM.actor instanceof FW_190A7STURM)?0.05F:0.0F)) {
                        Aircraft.debugprintln(this, "*** Armor Glass: Bullet Stopped..");
                        if (World.Rnd().nextFloat() < ((this.FM.actor instanceof FW_190A7STURM)?0.91F:0.5F)) {
            ...
            if (s.startsWith("xxspar")) {
                ...
                if (s.startsWith("xxsparli") && (this.chunkDamageVisible("WingLIn") > 2) && (this.getEnergyPastArmor(23F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparri") && (this.chunkDamageVisible("WingRIn") > 2) && (this.getEnergyPastArmor(23F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlm") && (this.chunkDamageVisible("WingLMid") > 2) && (this.getEnergyPastArmor(23.7F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparrm") && (this.chunkDamageVisible("WingRMid") > 2) && (this.getEnergyPastArmor(23.7F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlo") && (this.chunkDamageVisible("WingLOut") > 2) && (this.getEnergyPastArmor(23.7F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if (s.startsWith("xxsparro") && (this.chunkDamageVisible("WingROut") > 2) && (this.getEnergyPastArmor(23.7F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
            ...
            if (s.startsWith("xxeng")) {
                ...
                if (s.endsWith("pipe")) {
                    ...
                    if ((this.getEnergyPastArmor(0.1F, shot) > 0.0F) && (World.Rnd().nextFloat() < 0.9F)) {
                    ...
                    if ((this.getEnergyPastArmor(2.4F, shot) > 0.0F) && (World.Rnd().nextFloat() < (this.FM.EI.engines[0].getCylindersRatio() * (this.FM.EI.engines[0].getType() == 0 ? ((this.FM.actor instanceof FW_190A7STURM)?0.5F:1.75F) : 0.5F)))) {
                        if (this.FM.EI.engines[0].getType() == 0) {
                        ...
                        if ((World.Rnd().nextFloat() < (shot.power / ((this.FM.actor instanceof FW_190A7STURM)?35000F:48000F))) && (this.FM.EI.engines[0].getType() == 0)) {
                            this.FM.AS.hitEngine(shot.initiator, 0, 3);
                            Aircraft.debugprintln(this, "*** Engine Module: Cylinders Hit, Engine Fires..");
                        }
                        if ((World.Rnd().nextFloat() < (shot.power / ((this.FM.actor instanceof FW_190A7STURM)?35000F:48000F))) && (this.FM.EI.engines[0].getType() == 1)) {
        ...
        if (s.startsWith("xcf") || s.startsWith("xcockpit")) {
            ...
            if (s.startsWith("xcockpit")) {
                if (point3d.z > 0.4D) {
                    if (World.Rnd().nextFloat() < ((this.FM.actor instanceof FW_190A7STURM)?0.05F:0.2F)) {
                ...
                } else if (World.Rnd().nextFloat() < ((this.FM.actor instanceof FW_190A7STURM)?0.05F:0.2F)) {
                    this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x10);
                }
                if ((point3d.x > 0.2D) && (World.Rnd().nextFloat() < ((this.FM.actor instanceof FW_190A7STURM)?0.05F:0.2F))) {
        ...
        } else if (s.startsWith("xpilot") || (s.startsWith("xhead") && (!(this.FM.actor instanceof FW_190A7STURM) || (World.Rnd().nextFloat() < 0.11F)))) {
            byte byte0 = 0;
            int l;
            if (s.endsWith("a")) {
                byte0 = 1;
        ...
        if (s.startsWith("xxammo")) {
            ...
            if (World.Rnd().nextFloat() < 0.08F) {
                ...
                this.FM.AS.hitTank(shot.initiator, 1, 99);
                this.nextDMGLevels(3, 2, "WingRMid_D" + this.chunkDamageVisible("WingRMid"), shot.initiator);
            }
        }
        if (s.endsWith("06")) {
            this.getEnergyPastArmor(World.Rnd().nextFloat(50F, 50F), shot);
        ...
        if (World.Rnd().nextFloat() < 0.08F) {
            this.nextDMGLevels(3, 2, "WingRMid_D", shot.initiator);
        }
    }
