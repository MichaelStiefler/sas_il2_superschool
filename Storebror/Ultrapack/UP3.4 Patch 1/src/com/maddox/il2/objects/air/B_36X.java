...
//            }
    ...
    private void updateTurretStatus() {
        if (!this.isEquippedWithTurrets || this.isNetMirror()) {
            return;
        }
...
//            this.hierMesh().chunkSetAngles(B_36X.B36Props[j][0], 0.0F, this.propPos[j], 0.0F);
    ...
    public void typeBomberReplicateToNet(NetMsgGuaranted netmsgguaranted) throws IOException {
        ...
        if (this.isEquippedWithTurrets) {
            netmsgguaranted.writeByte((int)(this.turretAnimatedPosition[0] * 255F));
            netmsgguaranted.writeByte((int)(this.turretAnimatedPosition[1] * 255F));
            netmsgguaranted.writeByte((int)(this.turretAnimatedPosition[2] * 255F));
            netmsgguaranted.writeByte((int)(this.turretAnimatedPosition[3] * 255F));
            netmsgguaranted.writeByte((int)(this.turretAnimatedPosition[4] * 255F));
            netmsgguaranted.writeByte((int)(this.turretAnimatedPosition[5] * 255F));
        }
    }
    ...
    public void typeBomberReplicateFromNet(NetMsgInput netmsginput) throws IOException {
        ...
        if (this.isEquippedWithTurrets) {
            this.animateTurret3((float)netmsginput.readByte() / 255F);
            this.animateTurret4((float)netmsginput.readByte() / 255F);
            this.animateTurret5((float)netmsginput.readByte() / 255F);
            this.animateTurret6((float)netmsginput.readByte() / 255F);
            this.animateTurret7((float)netmsginput.readByte() / 255F);
            this.animateTurret8((float)netmsginput.readByte() / 255F);
        }
    }
