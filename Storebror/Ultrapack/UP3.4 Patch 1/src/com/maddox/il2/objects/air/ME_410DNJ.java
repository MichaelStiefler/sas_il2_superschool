...
public class ME_410DNJ extends ME_210 implements TypeFighter, TypeBNZFighter, TypeStormovik, TypeStormovikArmored, TypeX4Carrier, TypeRadarLiSN2Carrier {
    ...
    static {
        Class class1 = ME_410DNJ.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Me-410");
        Property.set(class1, "meshName", "3DO/Plane/ME-410-DNJ/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1943F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/Me-410D.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitME_410DNJ.class, CockpitMe_410_Radar.class });
