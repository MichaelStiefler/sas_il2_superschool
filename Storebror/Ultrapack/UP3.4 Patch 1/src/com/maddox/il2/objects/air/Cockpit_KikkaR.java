...
public class Cockpit_KikkaR extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            Cockpit_KikkaR.this.setNew.azimuth = Cockpit_KikkaR.this.fm.Or.getYaw();
            if ((Cockpit_KikkaR.this.setOld.azimuth > 270F) && (Cockpit_KikkaR.this.setNew.azimuth < 90F)) {
                Cockpit_KikkaR.this.setOld.azimuth -= 360F;
            }
            if ((Cockpit_KikkaR.this.setOld.azimuth < 90F) && (Cockpit_KikkaR.this.setNew.azimuth > 270F)) {
                Cockpit_KikkaR.this.setOld.azimuth += 360F;
            }
            Cockpit_KikkaR.this.setNew.waypointAzimuth = ((10F * Cockpit_KikkaR.this.setOld.waypointAzimuth) + (Cockpit_KikkaR.this.waypointAzimuth() - Cockpit_KikkaR.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
