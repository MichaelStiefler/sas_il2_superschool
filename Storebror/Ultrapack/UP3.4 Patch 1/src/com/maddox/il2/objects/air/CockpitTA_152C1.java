...
public class CockpitTA_152C1 extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f1 = ((TA_152C1)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitTA_152C1.k14TargetWingspanScale[((TA_152C1)aircraft()).k14WingspanType]) / f1;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitTA_152C1.k14TargetMarkScale[((TA_152C1)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((TA_152C1)aircraft()).k14Mode;
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(Time.tickCounter() < tClap)
            i1 = 1;
        this.mesh.chunkSetAngles("SecTrigger2", -(240F + f2) * (pictClap = 0.85F * pictClap + 0.15F * (float)i1), 0.0F, 0.0F);
        this.mesh.chunkSetLocate("SecTrigger", Cockpit.xyz, Cockpit.ypr);
