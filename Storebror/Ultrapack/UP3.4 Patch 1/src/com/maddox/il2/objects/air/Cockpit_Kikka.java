...
public class Cockpit_Kikka extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            Cockpit_Kikka.this.setNew.azimuth = Cockpit_Kikka.this.fm.Or.getYaw();
            if ((Cockpit_Kikka.this.setOld.azimuth > 270F) && (Cockpit_Kikka.this.setNew.azimuth < 90F)) {
                Cockpit_Kikka.this.setOld.azimuth -= 360F;
            }
            if ((Cockpit_Kikka.this.setOld.azimuth < 90F) && (Cockpit_Kikka.this.setNew.azimuth > 270F)) {
                Cockpit_Kikka.this.setOld.azimuth += 360F;
            }
            Cockpit_Kikka.this.setNew.waypointAzimuth = ((10F * Cockpit_Kikka.this.setOld.waypointAzimuth) + (Cockpit_Kikka.this.waypointAzimuth() - Cockpit_Kikka.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
