...
public class MGunBK5_HE extends MGunAircraftGeneric
{
    ...
    public GunProperties createProperties()
    {
        ...
        gunproperties.bullet[0].massa = 1.96F;
        ...
        gunproperties.bullet[1].massa = 1.76F;
        gunproperties.bullet[1].kalibr = 0.0005F;
