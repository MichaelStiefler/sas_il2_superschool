...
public class CockpitLi_P13 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkVisible("Z_GearLRed1", fm.CT.getGearL() < 0.01F && fm.Gears.lgear);
        mesh.chunkVisible("Z_GearCGreen1", fm.CT.getGearC() > 0.99F);
        mesh.chunkVisible("Z_GearCRed1", fm.CT.getGearC() < 0.01F);
        ...
        if(!((Li_P13)aircraft()).bCartAttached)
        ...
        resetYPRmodifier();
        Cockpit.xyz[2] = -0.01825F * fm.CT.trimElevator;
        mesh.chunkSetLocate("Z_Trimposit", Cockpit.xyz, Cockpit.ypr);
        ...
        mesh.chunkSetAngles("Z_AroneL", (pictAiler < 0.0F ? 25F : 35F) * pictAiler, 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_AroneR", (pictAiler < 0.0F ? -35F : -25F) * pictAiler, 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Speed1", floatindex(cvt(Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), speedometerIndScale), 0.0F, 0.0F);
        ...
        f1 = ((setOld.fuel - setNew.fuel) / Time.tickLenFs()) * 60F;
        mesh.chunkSetAngles("Z_Fuelconsum1", cvt(pictCons = 0.75F * pictCons + 0.25F * f1, 0.0F, 20F, 0.0F, 282F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Temp1", cvt(fm.EI.engines[1].tWaterOut, 20F, 135F, 0.0F, 96F), 0.0F, 0.0F);
    }
