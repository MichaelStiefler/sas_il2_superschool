...
public abstract class RE_2002xyz extends Scheme1 implements TypeFighter, TypeStormovik {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.endsWith("Torpedo")) this.bRaiseTailWheel = true;
        prepareWeapons(this.getClass(), this.hierMesh(), this.thisWeaponsName);
    }
    
    public static void prepareWeapons(Class aircraftClass, HierMesh hierMesh, String thisWeaponsName) {
        hierMesh.chunkVisible("RackL_D0", thisWeaponsName.startsWith("2x100kg") || thisWeaponsName.endsWith("2x100kg"));
        hierMesh.chunkVisible("RackR_D0", thisWeaponsName.startsWith("2x100kg") || thisWeaponsName.endsWith("2x100kg"));
        hierMesh.chunkVisible("LeverBase_d0", thisWeaponsName.equals("1x630kg") || thisWeaponsName.equals("1x500kg") || thisWeaponsName.startsWith("1x250kg"));
        hierMesh.chunkVisible("BombLever_d0", thisWeaponsName.equals("1x630kg") || thisWeaponsName.equals("1x500kg") || thisWeaponsName.startsWith("1x250kg"));
        hierMesh.chunkVisible("BombHook_d0", thisWeaponsName.equals("1x630kg") || thisWeaponsName.equals("1x500kg") || thisWeaponsName.startsWith("1x250kg"));
    }
    ...
    public void update(float f) {
        if (this.bRaiseTailWheel) {
            ...
            if (this.counter >= 50) this.bRaiseTailWheel = false;
        }
        for (int i = 1; i < 6; i++) {
