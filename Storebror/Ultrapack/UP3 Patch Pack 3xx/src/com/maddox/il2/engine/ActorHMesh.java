...
// return this.mesh().collisionR();
        if (this.mesh() == null) {
            System.out.println("Mission Change Nullpointer Exception Hotfix: " + this.name() + " would have caused issues on removal.");
        }
    ...
    public void destroy() {
        ...
        // TODO: +++ Mission Change Nullpointer Exception Hotfix by SAS~Storebror +++
        if (this.mesh() != null)
            this.lastCollisionR = this.mesh().collisionR();
        // TODO: --- Mission Change Nullpointer Exception Hotfix by SAS~Storebror ---
        super.destroy();
        if (this.hmesh != null) {
            this.hmesh.destroy();
