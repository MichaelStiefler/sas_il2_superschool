...
public class ZutiSupportMethods {
     ...
     *            Radius
     * @param color
     *            Army color of which markers we are trying to locate
     * @return
     */
     ...
     *            Radius
     * @param color
     *            Army color of which markers we do not want
     * @return
     */
    ...
    public static boolean allowRRR(Aircraft aircraft) {
        ...
        if (ZutiSupportMethods_FM.isFMOnZAP(aircraft.FM) || ZutiAirfieldPoint.isLocatedTestRunway(aircraft.FM.Loc) || ZutiAirfieldPoint.isLocatedOnCarrier(aircraft.FM.Loc))
