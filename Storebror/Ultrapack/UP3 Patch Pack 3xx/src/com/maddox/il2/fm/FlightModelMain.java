...
public class FlightModelMain extends FMMath {
    ...
    public boolean tick() {
        ...
        if (super.actor.pos.base() == null) {
            super.actor.pos.setAbs(this.Loc, this.Or);
        } else {
            if (super.actor.pos.base() instanceof Aircraft) {
                this.Vwld.set(((FlightModelMain) (((SndAircraft) ((Aircraft) super.actor.pos.base())).FM)).Vwld);
            } else {
    ...
    private void checkDamaged() {
        if (!this.bDamaged && Actor.isValid(this.damagedInitiator) && (!this.isCapableOfBMP() || this.isTakenMortalDamage())) {
            this.bDamaged = true;
            if (super.actor != this.damagedInitiator)
                EventLog.onDamaged(super.actor, this.damagedInitiator);
            this.damagedInitiator = null;
        }
    ...
    public static SectFile sectFileOld(String s) {
        SectFile sectfile = null;
        String s1 = s.toLowerCase();
        try {
            Object obj = Property.value(s, "stream", null);
