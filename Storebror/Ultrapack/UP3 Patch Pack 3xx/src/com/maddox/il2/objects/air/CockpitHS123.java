...
public class CockpitHS123 extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitHS123.this.fm != null) {
				...
				CockpitHS123.this.setNew.throttle = ((10F * CockpitHS123.this.setOld.throttle)
						+ CockpitHS123.this.fm.CT.PowerControl) / 11F;
				CockpitHS123.this.setNew.mix = ((8F * CockpitHS123.this.setOld.mix)
						+ CockpitHS123.this.fm.EI.engines[0].getControlMix()) / 9F;
				float f = CockpitHS123.this.waypointAzimuth();
				CockpitHS123.this.setNew.waypointAzimuth.setDeg(CockpitHS123.this.setOld.waypointAzimuth.getDeg(0.1F),
						f - CockpitHS123.this.setOld.azimuth.getDeg(1.0F));
				CockpitHS123.this.setNew.azimuth.setDeg(CockpitHS123.this.setOld.azimuth.getDeg(1.0F),
						CockpitHS123.this.fm.Or.azimut());
	...
	protected void setCameraOffset() {
		super.cameraCenter.add(0.0D, 0.02D, 0.0D);
	}
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("Z_PropPitch1", 270F
				- ((float) Math.toDegrees(this.fm.EI.engines[0].getPropPhi() - this.fm.EI.engines[0].getPropPhiMin())
						* 60F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_PropPitch2", 105F
				- ((float) Math.toDegrees(this.fm.EI.engines[0].getPropPhi() - this.fm.EI.engines[0].getPropPhiMin())
						* 5F),
				0.0F, 0.0F);
