...
public class CAC_Sabre_Mk32 extends F_86F
	...
	public void update(float f) {
		...
		if (this.FM.CT.WeaponControl[1] && this.FM.EI.engines[0].getStage() == 6
			...
			origThrl = this.FM.EI.engines[0].getControlThrottle();
			this.FM.EI.engines[0].setControlThrottle(origThrl - 0.05F);
			surgeControl = 1;
		} else if (!this.FM.CT.WeaponControl[1] && this.FM.EI.engines[0].getStage() == 6 && surgeControl == 1) {
			this.FM.EI.engines[0].setControlThrottle(origThrl);
			surgeControl = 0;
		}
		super.update(f);
	}
