		...
		public boolean tick() {
			...
			if (CockpitJU_87D5.this.fm != null) {
				...
				if (CockpitJU_87D5.this.cockpitDimControl) {
					...
					CockpitJU_87D5.this.setNew.dimPosition = CockpitJU_87D5.this.setOld.dimPosition + 0.05F;
				CockpitJU_87D5.this.setNew.throttle = (10F * CockpitJU_87D5.this.setOld.throttle
						+ CockpitJU_87D5.this.fm.CT.PowerControl) / 11F;
				...
				if (CockpitJU_87D5.this.useRealisticNavigationInstruments()) {
					...
					CockpitJU_87D5.this.setNew.waypointAzimuth.setDeg(
							CockpitJU_87D5.this.setOld.waypointAzimuth.getDeg(0.1F),
							f - CockpitJU_87D5.this.setOld.azimuth.getDeg(1.0F));
				}
				CockpitJU_87D5.this.setNew.azimuth.setDeg(CockpitJU_87D5.this.setOld.azimuth.getDeg(1.0F),
						CockpitJU_87D5.this.fm.Or.azimut());
				CockpitJU_87D5.this.w.set(CockpitJU_87D5.this.fm.getW());
				CockpitJU_87D5.this.fm.Or.transform(CockpitJU_87D5.this.w);
				CockpitJU_87D5.this.setNew.turn = (12F * CockpitJU_87D5.this.setOld.turn + CockpitJU_87D5.this.w.z)
						/ 13F;
				CockpitJU_87D5.this.setNew.vspeed = (499F * CockpitJU_87D5.this.setOld.vspeed
						+ CockpitJU_87D5.this.fm.getVertSpeed()) / 500F;
				if (CockpitJU_87D5.this.buzzerFX != null)
					if (CockpitJU_87D5.this.fm.Loc.z < ((JU_87D5) CockpitJU_87D5.this.aircraft()).fDiveRecoveryAlt
							&& ((JU_87) CockpitJU_87D5.this.fm.actor).diveMechStage == 1)
				...
				float f2 = -(((JU_87D5) CockpitJU_87D5.this.aircraft()).fDiveVelocity * 0.27777F
						* (float) Math.sin(Math.toRadians(((JU_87D5) CockpitJU_87D5.this.aircraft()).fDiveAngle)))
						* 0.1019F;
				f2 += (float) Math.sqrt(f2 * f2 + 2.0F * f1 * 0.1019F);
				float f3 = ((JU_87D5) CockpitJU_87D5.this.aircraft()).fDiveVelocity * 0.27777F
						* (float) Math.cos(Math.toRadians(((JU_87D5) CockpitJU_87D5.this.aircraft()).fDiveAngle));
				float f4 = (f3 * f2 + 10F) - 10F;
				CockpitJU_87D5.this.setNew.alpha = 90F - ((JU_87D5) CockpitJU_87D5.this.aircraft()).fDiveAngle
						- (float) Math.toDegrees(Math.atan(f4 / f1));
				CockpitJU_87D5.this.setNew.beaconDirection = (10F * CockpitJU_87D5.this.setOld.beaconDirection
						+ CockpitJU_87D5.this.getBeaconDirection()) / 11F;
				CockpitJU_87D5.this.setNew.beaconRange = (10F * CockpitJU_87D5.this.setOld.beaconRange
						+ CockpitJU_87D5.this.getBeaconRange()) / 11F;
			}
			return true;
		}
...
//        this.bG2 = false;
		...
		this.cockpitNightMats = (new String[] { "87DClocks1", "87DClocks2", "87DClocks3", "87DClocks4", "87DClocks5",
				"87DPlanks2", "Signs" });
...
//            }
		...
		this.mesh.chunkSetAngles("zAlt1",
				this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 10000F, 0.0F, 3600F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("zAlt2",
				this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 10000F, 0.0F, -360F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("zAltCtr1", (((JU_87) this.aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
		this.mesh.chunkSetAngles("zAltCtr2",
				this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 6000F, 0.0F, 360F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_ReviTinter",
				this.cvt(this.interp(this.setNew.dimPosition, this.setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, 130F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_ReviTint",
				this.cvt(this.interp(this.setNew.dimPosition, this.setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, 40F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("zBoost1",
				this.cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 332F), 0.0F, 0.0F);
		this.mesh.chunkSetAngles("zSpeed",
				this.floatindex(
						this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F),
						speedometerScale),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("zRPM1",
				this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), rpmScale), 0.0F, 0.0F);
		this.mesh.chunkSetAngles("zFuel1",
				this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 250F, 0.0F, 5F), fuelScale), 0.0F, 0.0F);
		this.mesh.chunkSetAngles("zOilTemp1", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 120F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("zFuelPrs1", this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 3F, 0.0F, 135F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("zOilPrs1",
				this.cvt(1.0F + 0.05F * this.fm.EI.engines[0].tOilOut, 0.0F, 15F, 0.0F, 135F), 0.0F, 0.0F);
		...
		if (this.useRealisticNavigationInstruments()) {
			this.mesh.chunkSetAngles("zRepeater", this.setNew.azimuth.getDeg(f) - this.setNew.waypointAzimuth.getDeg(f),
					0.0F, 0.0F);
		...
		this.mesh.chunkSetAngles("zwatertemp", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 100F), 0.0F,
				0.0F);
//        if (this.bG2) {
//            if (this.gun[0] != null)
...
//        } else {
		if (this.gun[0] != null)
			this.mesh.chunkSetAngles("Z_AmmoCounter1", this.cvt(this.gun[0].countBullets(), 0.0F, 500F, 15F, 0.0F),
					0.0F, 0.0F);
		if (this.gun[1] != null)
			this.mesh.chunkSetAngles("Z_AmmoCounter2", this.cvt(this.gun[1].countBullets(), 0.0F, 500F, 15F, 0.0F),
					0.0F, 0.0F);
//        }
		...
		this.mesh.chunkSetAngles("zColumn1",
				(this.pictAiler = 0.85F * this.pictAiler + 0.15F * this.fm.CT.AileronControl) * 15F, 0.0F,
				(this.pictElev = 0.85F * this.pictElev + 0.15F * this.fm.CT.ElevatorControl) * 10F);
		...
		this.mesh.chunkSetAngles("zThrottle1", this.interp(this.setNew.throttle, this.setOld.throttle, f) * 80F, 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("zPitch1",
				(this.fm.CT.getStepControl() < 0.0F ? this.interp(this.setNew.throttle, this.setOld.throttle, f)
						: this.fm.CT.getStepControl()) * 45F,
				0.0F, 0.0F);
		...
		this.mesh.chunkSetAngles("zproppitch1", this.cvt(this.setNew.beaconDirection, -45F, 45F, 20F, -20F), 0.0F,
				0.0F);
