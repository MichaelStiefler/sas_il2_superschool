...
public abstract class FUG218Generic extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(FUG218Generic.this.engineSFX != null)
                if(FUG218Generic.this.engineSTimer >= 0)
                {
                    if(--FUG218Generic.this.engineSTimer <= 0)
                    {
                        ...
                        if(!FUG218Generic.this.danger())
                            FUG218Generic.this.engineSTimer = -FUG218Generic.this.engineSTimer;
                    }
                } else
                if(++FUG218Generic.this.engineSTimer >= 0)
                {
