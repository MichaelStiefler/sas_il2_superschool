...
public class BombsightNorden
{
    ...
    public static void Update(float f)
    {
        if(null == currentCraft)
            return;
        if((double)Math.abs(currentCraft.FM.Or.getKren()) > 4.5D)
        {
        ...
        if(bSightAutomation)
        {
            ...
            fSightCurForwardAngle = (float)Math.toDegrees(Math.atan((double)fSightCurDistance / d1));
    ...
    private static BombDescriptor BombDescs[] = {
        new BombDescriptor("FAB-100", new double[] {
            ...
            0.0002389D, 0.0002708D, 0.0003072D, 0.0003318D, 0.0003862D, 0.0004268D, 0.0004672D
        }), new BombDescriptor("FAB-5000", new double[] {
            7.229E-006D, 2.155E-005D, 8.365E-006D, 3.615E-006D, 4.952E-005D, 5.634E-005D, 8.214E-005D, 0.0001108D, 0.0001135D, 0.0001345D,
