...
//			if (FM.getAltitude() > 300F && boosterFireOutTime == -1L && FM.Loc.z != 0.0D && World.Rnd().nextFloat() < 0.05F) {
	...
	static {
		...
		Property.set(class1, "cockpitClass",
				new Class[] { CockpitAR_234B2NJ.class, CockpitAR_234B2NJ_Bombardier.class });
		Property.set(class1, "LOSElevation", 1.14075F);
		Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 3, 3, 3, 9, 9 });
		Aircraft.weaponHooksRegister(class1, new String[] { "_CANNON01", "_CANNON02", "_ExternalBomb01",
				"_ExternalBomb02", "_ExternalBomb03", "_ExternalDev01", "_ExternalDev02" });
	}
}
