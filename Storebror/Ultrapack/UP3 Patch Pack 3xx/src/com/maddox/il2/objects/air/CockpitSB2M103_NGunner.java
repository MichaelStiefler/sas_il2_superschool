...
public class CockpitSB2M103_NGunner extends CockpitGunner {
	...
	public void reflectWorldToInstruments(float f) {
		...
		if ((this.emitter != null) && World.cur().diffCur.Limited_Ammo) {
	...
	static {
		Property.set(CockpitSB2M103_NGunner.class, "aiTuretNum", 0);
		Property.set(CockpitSB2M103_NGunner.class, "weaponControlNum", 10);
		Property.set(CockpitSB2M103_NGunner.class, "astatePilotIndx", 1);
		Property.set(CockpitSB2M103_NGunner.class, "normZN", 1.1F);
		Property.set(CockpitSB2M103_NGunner.class, "gsZN", 1.1F);
	}
}
