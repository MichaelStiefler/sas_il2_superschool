...
public abstract class ArtilleryGeneric extends ActorHMesh implements MsgCollisionRequestListener, MsgExplosionListener, MsgShotListener, Predator, Obstacle, ActorAlign, HunterInterface {
            ...
            if (ArtilleryGeneric.this.dying == 1) {
                ...
                if (access$110(ArtilleryGeneric.this) <= 0L) {
                    ...
                    if (!ArtilleryGeneric.this.isNetMirror() && ArtilleryGeneric.this.RADIUS_HIDE > 0.0F)
                        ArtilleryGeneric.this.hideTmr = -1L;
                    ArtilleryGeneric.this.setDiedFlag(false);
                    ArtilleryGeneric.this.aime.forgetAiming();
                    ArtilleryGeneric.this.setMesh(ArtilleryGeneric.this.prop.meshName);
                    ArtilleryGeneric.this.setDefaultLivePose();
    ...
    public void msgShot(Shot shot) {
        ...
        if (this.dying == 0 && !(shot.power <= 0.0F) && (!this.isNetMirror() || !shot.isMirage())) {
            if (shot.powerType == 1) {
                ...
                float f = Shot.panzerThickness(this.pos.getAbsOrient(), shot.v, shot.chunkName.equalsIgnoreCase("Head"), this.prop.PANZER_BODY_FRONT, this.prop.PANZER_BODY_SIDE, this.prop.PANZER_BODY_BACK, this.prop.PANZER_BODY_TOP,
                        this.prop.PANZER_HEAD, this.prop.PANZER_HEAD_TOP);
                f *= Rnd(0.93F, 1.07F);
                float f_25_ = this.prop.fnShotPanzer.Value(shot.power, f);
                if (f_25_ < 1000.0F && (f_25_ <= 1.0F || this.RndB(1.0F / f_25_)))
                    this.Die(shot.initiator, (short) 0, true);
            }
        }
    }
        ...
        if (this.dying == 0 && (!this.isNetMirror() || !explosion.isMirage()) && !(explosion.power <= 0.0F)) {
            ...
            if (i == 1) {
                ...
                if (i_26_ == 2 && explosion.chunkName != null)
                    ...
                    if (f_27_ < 1000.0F && (f_27_ <= 1.0F || this.RndB(1.0F / f_27_)))
                        this.Die(explosion.initiator, (short) 0, true);
                }
            }
        }
    ...
    private ArtilleryGeneric(ArtilleryProperties artilleryproperties, ActorSpawnArg actorspawnarg) {
        ...
        this.headYaw = 0.0F;
        this.gunPitch = 0.0F;
        if (!this.isNetMirror() && this.RADIUS_HIDE > 0.0F)
            this.hideTmr = -1L;
    ...
    public float probabKeepSameEnemy(Actor actor) {
        if (this.nearAirfield || this.isNetMirror() || actor == null || !(actor instanceof Aircraft) || Math.abs(this.time_lastCheckShoot - Time.current()) < 12000L || (float) actor.getSpeed(null) < 10.0F)
            return 0.75F;
        if (this.friendPlanesAreNear((Aircraft) actor))
            return 0.0F;
        return 0.75F;
    }
    ...
    public Actor findEnemy(Aim aim) {
        ...
        if (this.prop.ATTACK_FAST_TARGETS)
            ...
            NearestEnemies.set(this.WeaponsMask(), -9999.9F, KmHourToMSec(100.0F));
        ...
        if (!this.nearAirfield && !this.isNetMirror() && actor instanceof Aircraft && !((float) actor.getSpeed(null) < 10.0F)) {
            if (Math.abs(this.time_lastCheckShoot - Time.current()) < 12000L) {
                if (this.dontShoot)
                    return null;
            } else if (this.friendPlanesAreNear((Aircraft) actor))
                return null;
        }
    ...
    public boolean enterToFireMode(int i, Actor actor, float f, Aim aim) {
        if (i == 1 && this.hideTmr < 0L) {
            ...
            if (f_32_ > this.RADIUS_HIDE * this.RADIUS_HIDE)
                return false;
            this.hideTmr = 0L;
        }
        if (!this.isNetMirror())
            this.send_FireCommand(actor, aim.shotpoint_idx, i == 0 ? -1.0F : f);
        return true;
    }

    private void Track_Mirror(Actor actor, int i) {
        if (this.dying != 1 && actor != null && this.aime != null)
            this.aime.passive_StartFiring(0, actor, i, 0.0F);
    }
    ...
    public int targetGun(Aim aim, Actor actor, float f, boolean bool) {
        ...
        if (!Aimer.Aim((BulletAimer) this.gun, actor, this, f_34_, p1, null))
            return 0;
        ...
        if (f_34_ > 0.0010F) {
            ...
            if (d_39_ > 0.0010) {
                ...
                if (i >= 3 && d_37_ > Mission.curCloudsHeight())
                    f_41_ *= 1.25F;
                f_36_ += f_41_;
            }
        }
        ...
        } else if (aim.getAimingError().length() > 0.011D)
        ...
        if (!((BulletAimer) this.gun).FireDirection(point3d_35_, point3d, vector3d))
            return 0;
        float f_49_;
        float f_50_;
        if (bool) {
    ...
    private void zutiRefreshFrontMarker(boolean died) {
        ...
        if (!this.zutiHasFrontMarkerAssigned())
            return;
    ...
    public boolean zutiHasFrontMarkerAssigned() {
        if (this.zutiFrontMarkers == null || this.zutiFrontMarkers.size() == 0)
            return false;
    ...
    public void zutiAddFrontMarker(Marker marker) {
        if (this.zutiFrontMarkers == null)
            this.zutiFrontMarkers = new ArrayList(1);
