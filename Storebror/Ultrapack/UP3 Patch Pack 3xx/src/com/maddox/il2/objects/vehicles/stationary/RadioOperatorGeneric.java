...
public abstract class RadioOperatorGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(RadioOperatorGeneric.this.engineSFX != null)
                if(RadioOperatorGeneric.this.engineSTimer >= 0)
                {
                    if(--RadioOperatorGeneric.this.engineSTimer <= 0)
                    {
                        ...
                        if(!RadioOperatorGeneric.this.danger())
                            RadioOperatorGeneric.this.engineSTimer = -RadioOperatorGeneric.this.engineSTimer;
                    }
                } else
                if(++RadioOperatorGeneric.this.engineSTimer >= 0)
                {
