		...
		if (explosion.chunkName != null) {
			if (explosion.chunkName.startsWith("CF")) {
				if (World.Rnd().nextFloat() < 0.005F) {
					this.FM.AS.setControlsDamage(explosion.initiator, 0);
				}
				if (World.Rnd().nextFloat() < 0.005F) {
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			...
			if (s.startsWith("xxspar")) {
				if ((s.endsWith("t1") || s.endsWith("t2")) && (World.Rnd().nextFloat() < 0.1F)
						&& (this.chunkDamageVisible("Tail1") > 2)
						&& (this.getEnergyPastArmor(19.9F
				...
				if ((s.endsWith("li1") || s.endsWith("li2")) && (this.chunkDamageVisible("WingLIn") > 2)
						&& (this.getEnergyPastArmor(19.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)) {
					this.debuggunnery("*** WingLIn Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
				}
				if ((s.endsWith("ri1") || s.endsWith("ri2")) && (this.chunkDamageVisible("WingRIn") > 2)
						&& (this.getEnergyPastArmor(19.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)) {
					this.debuggunnery("*** WingRIn Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
				}
				if ((s.endsWith("lm1") || s.endsWith("lm2")) && (this.chunkDamageVisible("WingLMid") > 2)
						&& (this.getEnergyPastArmor(19.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)) {
					this.debuggunnery("*** WingLMid Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
				}
				if ((s.endsWith("rm1") || s.endsWith("rm2")) && (this.chunkDamageVisible("WingRMid") > 2)
						&& (this.getEnergyPastArmor(19.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)) {
					this.debuggunnery("*** WingRMid Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
				}
				if ((s.endsWith("lo1") || s.endsWith("lo2")) && (this.chunkDamageVisible("WingLOut") > 2)
						&& (this.getEnergyPastArmor(19.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)) {
					this.debuggunnery("*** WingLOut Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
				}
				if ((s.endsWith("ro1") || s.endsWith("ro2")) && (this.chunkDamageVisible("WingROut") > 2)
						&& (this.getEnergyPastArmor(19.5F * World.Rnd().nextFloat(1.0F, 2.0F), shot) > 0.0F)) {
			...
			if (s.startsWith("xxeng")) {
				...
				if (s.endsWith("pipe")) {
					if ((World.Rnd().nextFloat() < 0.1F) && (this.FM.EI.engines[0].getType() == 0)
					...
					if ((this.getEnergyPastArmor(8.9F, shot) > 0.0F) && (World.Rnd().nextFloat() < 0.25F)
							&& (this.FM.EI.engines[0].getPowerOutput() > 0.7F)
							&& (this.FM.EI.engines[0].getType() == 0)) {
					...
					if ((this.getEnergyPastArmor(2.4F, shot) > 0.0F)
							&& (World.Rnd().nextFloat() < (this.FM.EI.engines[0].getCylindersRatio()
									* (this.FM.EI.engines[0].getType() == 0 ? 1.75F : 0.5F)))) {
						if (this.FM.EI.engines[0].getType() == 0) {
							this.FM.EI.engines[0].setCyliderKnockOut(shot.initiator,
									World.Rnd().nextInt(1, (int) (shot.power / 4800F)));
						} else {
							this.FM.EI.engines[0].setCyliderKnockOut(shot.initiator,
									World.Rnd().nextInt(1, (int) (shot.power / 19200F)));
						}
						Aircraft.debugprintln(this,
								"*** Engine Module: Cylinders Hit, " + this.FM.EI.engines[0].getCylindersOperable()
										+ "/" + this.FM.EI.engines[0].getCylinders() + " Left..");
						if ((World.Rnd().nextFloat() < (shot.power / 96000F))
								&& (this.FM.EI.engines[0].getType() == 0)) {
							this.FM.AS.hitEngine(shot.initiator, 0, 3);
							Aircraft.debugprintln(this, "*** Engine Module: Cylinders Hit, Engine Fires..");
						}
						if ((World.Rnd().nextFloat() < (shot.power / 96000F))
								&& (this.FM.EI.engines[0].getType() == 1)) {
