...
public class SB_2M103 extends SB implements TypeBomber {
	...
	static {
		...
		Property.set(class1, "cockpitClass", new Class[] { CockpitSB_2M103.class, CockpitSB2M103_Bombardier.class,
				CockpitSB2M103_NGunner.class, CockpitSB2M103_TGunner.class, CockpitSB2M103_BGunner.class });
		Aircraft.weaponTriggersRegister(class1, new int[] { 10, 10, 11, 12, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
		Aircraft.weaponHooksRegister(class1,
				new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_BombSpawn01", "_BombSpawn02",
						"_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07",
