	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitP_40E.this.fm != null) {
				...
				CockpitP_40E.this.setNew.throttle = ((10F * CockpitP_40E.this.setOld.throttle)
						+ CockpitP_40E.this.fm.CT.PowerControl) / 11F;
				CockpitP_40E.this.setNew.prop = ((8F * CockpitP_40E.this.setOld.prop)
						+ CockpitP_40E.this.fm.CT.getStepControl()) / 9F;
				CockpitP_40E.this.setNew.altimeter = CockpitP_40E.this.fm.getAltitude();
				if (Math.abs(CockpitP_40E.this.fm.Or.getKren()) < 45F) {
					CockpitP_40E.this.setNew.azimuth = ((35F * CockpitP_40E.this.setOld.azimuth)
							+ -CockpitP_40E.this.fm.Or.getYaw()) / 36F;
				}
				if ((CockpitP_40E.this.setOld.azimuth > 270F) && (CockpitP_40E.this.setNew.azimuth < 90F)) {
					CockpitP_40E.this.setOld.azimuth -= 360F;
				}
				if ((CockpitP_40E.this.setOld.azimuth < 90F) && (CockpitP_40E.this.setNew.azimuth > 270F)) {
					CockpitP_40E.this.setOld.azimuth += 360F;
				}
				CockpitP_40E.this.setNew.waypointAzimuth = ((10F * CockpitP_40E.this.setOld.waypointAzimuth)
						+ (CockpitP_40E.this.waypointAzimuth() - CockpitP_40E.this.setOld.azimuth)
						+ World.Rnd().nextFloat(-30F, 30F)) / 11F;
				CockpitP_40E.this.setNew.vspeed = ((199F * CockpitP_40E.this.setOld.vspeed)
						+ CockpitP_40E.this.fm.getVertSpeed()) / 200F;

				// TODO: +++ New Oil and Fuel Pressure Calculation and Animation by
				// SAS~Storebror +++
				float newOilPressure = CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].getRPM(), 0F, 300F, 0F,
						1F) * CockpitP_40E.this.fm.EI.engines[0].getReadyness()
						* CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].tOilOut, 70F, 80F, 70F, 60F)
						* CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].tOilOut, 60F, 70F, 85F / 70F, 1F)
				...
				if (newOilPressure > CockpitP_40E.this.setOld.oilPressure) {
					CockpitP_40E.this.setNew.oilPressure = (((OIL_PRESSURE_SMOOTHING_UP - 1F)
							* CockpitP_40E.this.setOld.oilPressure) + newOilPressure) / OIL_PRESSURE_SMOOTHING_UP;
				} else {
					CockpitP_40E.this.setNew.oilPressure = (((OIL_PRESSURE_SMOOTHING_DOWN - 1F)
							* CockpitP_40E.this.setOld.oilPressure) + newOilPressure) / OIL_PRESSURE_SMOOTHING_DOWN;
				}

				float newFuelPressure = CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].getRPM(), 0F, 50F, 0F,
						18F)
						* CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].getReadyness(), 0.5F, 1F, 0.9F, 1F)
				...
				if (newFuelPressure > CockpitP_40E.this.setOld.fuelPressure) {
					CockpitP_40E.this.setNew.fuelPressure = (((FUEL_PRESSURE_SMOOTHING_UP - 1F)
							* CockpitP_40E.this.setOld.fuelPressure) + newFuelPressure) / FUEL_PRESSURE_SMOOTHING_UP;
				} else {
					CockpitP_40E.this.setNew.fuelPressure = (((FUEL_PRESSURE_SMOOTHING_DOWN - 1F)
							* CockpitP_40E.this.setOld.fuelPressure) + newFuelPressure) / FUEL_PRESSURE_SMOOTHING_DOWN;
					// TODO: --- New Oil and Fuel Pressure Calculation and Animation by
					// SAS~Storebror ---
				}
			}
