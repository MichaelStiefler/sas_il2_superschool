...
class BombsightOPB
{
    ...
    {
        double d = ((double)fSightCurSpeed / 3.6D) * Math.sqrt((double)fSightCurAltitude * 0.203873599D);
        double d1 = BombDescs[nCurrentBombIndex].GetCorrectionCoeff(fSightCurAltitude);
        d += (d1 * (double)fSightCurAltitude * (double)fSightCurSpeed) / 3.6D;
    ...
    public static void ReplicateToNet(NetMsgGuaranted netmsgguaranted)
        throws IOException
    {
    ...
    public static void ReplicateFromNet(NetMsgInput netmsginput)
        throws IOException
    {
    ...
    private static BombDescriptor BombDescs[] = {
        new BombDescriptor("FAB-100", new double[] {
            0.0002072D, 0.0001216D, 0.0001417D, 0.0001036D, 0.0001295D, 8.967E-005D, 0.0001107D, 0.0001108D, 9.13E-005D, 9.449E-005D,
            9.347E-005D, 0.0001042D, 9.184E-005D, 0.0001318D, 0.0001329D, 0.0001268D, 0.0001261D
        }), new BombDescriptor("FAB-250", new double[] {
            0.0002072D, 0.0002216D, 0.0002084D, 0.0002036D, 0.0002095D, 0.0001897D, 0.0001964D, 0.0001858D, 0.0001802D, 0.0001945D,
            0.0002026D, 0.0002042D, 0.0002149D, 0.0002033D, 0.0002262D, 0.0002518D, 0.0002672D
        }), new BombDescriptor("FAB-500", new double[] {
            0.0002072D, 0.0003216D, 0.0004084D, 0.0004536D, 0.0004895D, 0.000523D, 0.0005107D, 0.0005108D, 0.0005135D, 0.0004945D,
            0.0005117D, 0.0005375D, 0.0005534D, 0.0005747D, 0.0005996D, 0.0006393D, 0.0006555D
        }), new BombDescriptor("FAB-1000", new double[] {
            0.0002072D, 0.0001216D, 0.0001417D, 0.0001536D, 0.0001695D, 0.0001897D, 0.0001964D, 0.0001858D, 0.0002024D, 0.0002145D,
            0.0002389D, 0.0002542D, 0.0002765D, 0.000289D, 0.0003062D, 0.0003143D, 0.0003261D
        }), new BombDescriptor("FAB-2000", new double[] {
            7.229E-006D, 2.155E-005D, 7.503E-005D, 0.0001036D, 8.952E-005D, 0.000123D, 0.0001678D, 0.0001858D, 0.0002024D, 0.0002145D,
            0.0002389D, 0.0002708D, 0.0003072D, 0.000332D, 0.0003862D, 0.0004268D, 0.0004672D
        }), new BombDescriptor("FAB-5000", new double[] {
            7.229E-006D, 2.155E-005D, 8.365E-006D, 3.615E-006D, 4.952E-005D, 5.634E-005D, 8.22E-005D, 0.0001108D, 0.0001135D, 0.0001345D,
            0.0001662D, 0.0001875D, 0.0002149D, 0.0002318D, 0.0003062D, 0.0003893D, 0.0004672D
        })
    };
