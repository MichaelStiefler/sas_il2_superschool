...
//    float f2 = Property.floatValue(localClass, "radius", 150.0F);
    for (int j = 0; j < times; j++) {
      MsgExplosion.send(null, null, p, getOwner(), mass, power, i, radius);
    }
//    System.out.println("SKYLLA WFRGR21: Distance from parent AC: " + getOwner().distance(this));
  ...
  static
  {
    ...
    Property.set(class1, "power", 40.799999F);
    Property.set(class1, "powerType", 1);
    Property.set(class1, "kalibr", 0.21F);
    Property.set(class1, "massa", 110.0F);
    Property.set(class1, "massaEnd", 91.599998F);
  }
}
