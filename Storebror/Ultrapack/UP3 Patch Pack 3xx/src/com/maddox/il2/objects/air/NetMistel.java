...
// System.out.println("NetMistelAircraft equals(" + obj.hashCode() + ")");
	...
	public static void netSendMsg(Aircraft aircraft, boolean bool, NetMsgGuaranted netmsgguaranted) throws IOException {
		if (Debug_Methods(aircraft))
			System.out.println("NetMistel netSendMsg(" + aircraft.hashCode() + ", " + bool + ", "
					+ netmsgguaranted.hashCode() + ")");
		if (bool) {
	...
	public static boolean netGetGMsg(Aircraft aircraft, NetMsgInput netmsginput, boolean bool) throws IOException {
		if (Debug_Methods(aircraft))
			System.out.println(
					"NetMistel netGetGMsg(" + aircraft.hashCode() + ", " + netmsginput.hashCode() + ", " + bool + ")");
	...
	public static boolean netSendExplosionToDroneMaster(Aircraft aircraft) {
		...
		if (DEBUG >= 1)
			System.out.println("NetMistel netSendExplosionToDroneMaster(" + aircraft.getClass().getName() + " - "
					+ aircraft.name() + ")");
		if (!aircraft.isNet())
			return false;
		if (DEBUG >= 2)
	...
	public static boolean netSendPowerControlToMirrors(Aircraft aircraft) {
		...
		if (DEBUG >= 1)
			System.out.println("NetMistel netSendPowerControlToMirrors(" + aircraft.getClass().getName() + " - "
					+ aircraft.name() + ") getPowerControl()=" + aircraft.FM.CT.getPowerControl());
		if (!aircraft.isNet())
			return false;
		if (DEBUG >= 2)
			System.out.println("NetMistel netSendPowerControlToMirrors(" + aircraft.getClass().getName() + " - "
	...
	public static boolean netSendTailwheelLockToMirrors(Aircraft aircraft) {
		...
		if (DEBUG >= 1)
			System.out.println("NetMistel netSendTailwheelLockToMirrors(" + aircraft.getClass().getName() + " - "
					+ aircraft.name() + ") bTailwheelLocked=" + aircraft.FM.Gears.bTailwheelLocked);
		if (!aircraft.isNet())
			return false;
		if (DEBUG >= 2)
			System.out.println("NetMistel netSendTailwheelLockToMirrors(" + aircraft.getClass().getName() + " - "
	...
	public static boolean netSendBrakesToMirrors(Aircraft aircraft) {
		...
		if (DEBUG >= 1)
			System.out.println("NetMistel netSendBrakesToMirrors(" + aircraft.getClass().getName() + " - "
					+ aircraft.name() + ") getBrake()=" + aircraft.FM.CT.getBrake() + ", getBrakeLeft()="
					+ aircraft.FM.CT.getBrakeLeft() + ", getBrakeRight()=" + aircraft.FM.CT.getBrakeRight());
		if (!aircraft.isNet())
			return false;
		if (DEBUG >= 2)
			System.out.println("NetMistel netSendBrakesToMirrors(" + aircraft.getClass().getName() + " - "
	...
	public static boolean netSendBrakeShoeToMirrors(Aircraft aircraft) {
		...
		if (DEBUG >= 1)
			System.out.println("NetMistel netSendBrakeShoeToMirrors(" + aircraft.getClass().getName() + " - "
					+ aircraft.name() + ") brakeShoe=" + aircraft.FM.brakeShoe);
		if (!aircraft.isNet())
			return false;
		if (DEBUG >= 2)
			System.out.println("NetMistel netSendBrakeShoeToMirrors(" + aircraft.getClass().getName() + " - "
	...
	private static boolean receiveNetExploded(Aircraft aircraft, NetMsgInput netmsginput) throws IOException {
		if (Debug_Methods(aircraft))
			System.out.println(
					"NetMistel receiveNetExploded(" + aircraft.hashCode() + ", " + netmsginput.hashCode() + ")");
		if (DEBUG >= 1)
			System.out.println(
					"NetMistel receiveNetExploded(" + aircraft.getClass().getName() + " - " + aircraft.name() + ")");
		if (!(aircraft instanceof Mistel))
			return false;
		...
		if (DEBUG >= 2)
			System.out.println(
					"NetMistel receiveNetExploded(" + aircraft.getClass().getName() + " - " + aircraft.name() + ") 2");
		if (((Mistel) aircraft).getQueen() == null)
			return false;
		if (DEBUG >= 2)
			System.out.println(
					"NetMistel receiveNetExploded(" + aircraft.getClass().getName() + " - " + aircraft.name() + ") 3");
		if (((Mistel) aircraft).getQueen().net != netmsginput.readNetObj())
			return false;
		if (DEBUG >= 2)
			System.out.println(
					"NetMistel receiveNetExploded(" + aircraft.getClass().getName() + " - " + aircraft.name() + ") 4");
	...
	private static boolean receivePowerControl(Aircraft aircraft, NetMsgInput netmsginput) throws IOException {
		if (Debug_Methods(aircraft))
			System.out.println(
					"NetMistel receivePowerControl(" + aircraft.hashCode() + ", " + netmsginput.hashCode() + ")");
		if (DEBUG >= 1)
			System.out.println(
					"NetMistel receivePowerControl(" + aircraft.getClass().getName() + " - " + aircraft.name() + ")");
		if (aircraft.net != netmsginput.readNetObj())
			return false;
		if (DEBUG >= 2)
			System.out.println(
					"NetMistel receivePowerControl(" + aircraft.getClass().getName() + " - " + aircraft.name() + ") 2");
		float fThrottle = netmsginput.readFloat();
		if (DEBUG >= 2)
			System.out.println(
					"NetMistel receivePowerControl(" + aircraft.getClass().getName() + " - " + aircraft.name() + ") 3");
		aircraft.FM.CT.setPowerControl(fThrottle);
		if (DEBUG >= 1)
			System.out.println("NetMistel receivePowerControl(" + aircraft.getClass().getName() + " - "
					+ aircraft.name() + ") end, PowerControl=" + fThrottle);
		return true;
	}
	...
	private static boolean receiveTailWheelLocked(Aircraft aircraft, NetMsgInput netmsginput) throws IOException {
		if (Debug_Methods(aircraft))
			System.out.println(
					"NetMistel receiveTailWheelLocked(" + aircraft.hashCode() + ", " + netmsginput.hashCode() + ")");
		if (DEBUG >= 1)
			System.out.println("NetMistel receiveTailWheelLocked(" + aircraft.getClass().getName() + " - "
					+ aircraft.name() + ")");
		if (aircraft.net != netmsginput.readNetObj())
			return false;
		if (DEBUG >= 2)
		...
		if (DEBUG >= 1)
			System.out.println("NetMistel receiveTailWheelLocked(" + aircraft.getClass().getName() + " - "
					+ aircraft.name() + ") end, bTailwheelLocked=" + bTailwheelLocked);
		return true;
	}
	...
	private static boolean receiveBrakes(Aircraft aircraft, NetMsgInput netmsginput) throws IOException {
		...
		if (DEBUG >= 1)
			System.out.println(
					"NetMistel receiveBrakes(" + aircraft.getClass().getName() + " - " + aircraft.name() + ")");
		if (aircraft.net != netmsginput.readNetObj())
			return false;
		if (DEBUG >= 2)
			System.out.println(
					"NetMistel receiveBrakes(" + aircraft.getClass().getName() + " - " + aircraft.name() + ") 2");
		...
		if (DEBUG >= 1)
			System.out.println("NetMistel receiveBrakes(" + aircraft.getClass().getName() + " - " + aircraft.name()
					+ ") end, BrakeControl=" + aircraft.FM.CT.BrakeControl + ", BrakeLeftControl="
					+ aircraft.FM.CT.BrakeLeftControl + ", BrakeRightControl=" + aircraft.FM.CT.BrakeRightControl);
		return true;
	}
	...
	private static boolean receiveBrakeShoe(Aircraft aircraft, NetMsgInput netmsginput) throws IOException {
		if (Debug_Methods(aircraft))
			System.out
					.println("NetMistel receiveBrakeShoe(" + aircraft.hashCode() + ", " + netmsginput.hashCode() + ")");
		if (DEBUG >= 1)
			System.out.println(
					"NetMistel receiveBrakeShoe(" + aircraft.getClass().getName() + " - " + aircraft.name() + ")");
		if (aircraft.net != netmsginput.readNetObj())
			return false;
		if (DEBUG >= 2)
			System.out.println(
					"NetMistel receiveBrakeShoe(" + aircraft.getClass().getName() + " - " + aircraft.name() + ") 2");
		boolean brakeShoe = netmsginput.readBoolean();
		if (DEBUG >= 2)
			System.out.println(
					"NetMistel receiveBrakeShoe(" + aircraft.getClass().getName() + " - " + aircraft.name() + ") 3");
		aircraft.FM.brakeShoe = brakeShoe;
		if (DEBUG >= 1)
			System.out.println("NetMistel receiveBrakeShoe(" + aircraft.getClass().getName() + " - " + aircraft.name()
					+ ") end, brakeShoe=" + brakeShoe);
		return true;
	}
	...
	public static void mistelToMirrors(Aircraft aircraft) {
		...
		if (!netMistelAircraftList.contains(netMistelAircraftOther)) {
			...
			if (DEBUG >= 2)
				System.out.println("Added NetMistelAircraft " + netMistelAircraft.aircraft.getClass().getName() + " - "
						+ netMistelAircraft.aircraft.name() + " to List!");
		} else {
			netMistelAircraft = (NetMistelAircraft) netMistelAircraftList
					.get(netMistelAircraftList.indexOf(netMistelAircraftOther));
		}
		...
		if (netMistelAircraft.aircraft.isNetMaster()) {
			if (netMistelAircraft.getLastPowerControl() != netMistelAircraft.aircraft.FM.CT.getPowerControl()) {
				...
				if (DEBUG >= 2)
					System.out.println("NetMistel PowerControl(" + netMistelAircraft.aircraft.getClass().getName()
							+ " - " + netMistelAircraft.aircraft.name() + ") = "
							+ netMistelAircraft.aircraft.FM.CT.getPowerControl());
			...
			if (netMistelAircraft.isLastTailWheelLocked() != netMistelAircraft.aircraft.FM.Gears.bTailwheelLocked) {
				...
				if (DEBUG >= 2)
					System.out.println("NetMistel bTailwheelLocked(" + netMistelAircraft.aircraft.getClass().getName()
							+ " - " + netMistelAircraft.aircraft.name() + ") = "
							+ netMistelAircraft.aircraft.FM.Gears.bTailwheelLocked);
				netSendTailwheelLockToMirrors(netMistelAircraft.aircraft);
			}
			if (netMistelAircraft.getLastBrake() != netMistelAircraft.aircraft.FM.CT.BrakeControl
					|| netMistelAircraft.getLastBrakeLeft() != netMistelAircraft.aircraft.FM.CT.BrakeLeftControl
				...
				if (DEBUG >= 2)
					System.out.println("NetMistel BrakeControl(" + netMistelAircraft.aircraft.getClass().getName()
							+ " - " + netMistelAircraft.aircraft.name() + ") ="
							+ netMistelAircraft.aircraft.FM.CT.BrakeControl + ", BrakeLeftControl="
							+ netMistelAircraft.aircraft.FM.CT.BrakeLeftControl + ", BrakeRightControl="
							+ netMistelAircraft.aircraft.FM.CT.BrakeRightControl);
			...
			if (netMistelAircraft.isLastBrakeShoe() != netMistelAircraft.aircraft.FM.brakeShoe) {
				...
				if (DEBUG >= 2)
					System.out.println("NetMistel brakeShoe(" + netMistelAircraft.aircraft.getClass().getName() + " - "
							+ netMistelAircraft.aircraft.name() + ") = " + netMistelAircraft.aircraft.FM.brakeShoe);
