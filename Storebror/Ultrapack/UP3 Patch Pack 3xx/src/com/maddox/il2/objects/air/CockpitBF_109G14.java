	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (CockpitBF_109G14.this.cockpitDimControl) {
				...
				CockpitBF_109G14.this.setNew.dimPosition = CockpitBF_109G14.this.setOld.dimPosition + 0.05F;
			CockpitBF_109G14.this.setNew.throttle = (10F * CockpitBF_109G14.this.setOld.throttle
					+ CockpitBF_109G14.this.fm.CT.PowerControl) / 11F;
			CockpitBF_109G14.this.setNew.mix = (8F * CockpitBF_109G14.this.setOld.mix
					+ CockpitBF_109G14.this.fm.EI.engines[0].getControlMix()) / 9F;
			...
			if (CockpitBF_109G14.this.useRealisticNavigationInstruments()) {
				...
				CockpitBF_109G14.this.setNew.waypointAzimuth.setDeg(
						CockpitBF_109G14.this.setOld.waypointAzimuth.getDeg(0.1F),
						f - CockpitBF_109G14.this.setOld.azimuth.getDeg(1.0F));
			}
			CockpitBF_109G14.this.setNew.azimuth.setDeg(CockpitBF_109G14.this.setOld.azimuth.getDeg(1.0F),
					CockpitBF_109G14.this.fm.Or.azimut());
			CockpitBF_109G14.this.w.set(CockpitBF_109G14.this.fm.getW());
			CockpitBF_109G14.this.fm.Or.transform(CockpitBF_109G14.this.w);
			CockpitBF_109G14.this.setNew.turn = (12F * CockpitBF_109G14.this.setOld.turn
					+ ((Tuple3f) (CockpitBF_109G14.this.w)).z) / 13F;
			CockpitBF_109G14.this.buzzerFX(
					CockpitBF_109G14.this.fm.CT.getGear() < 0.999999F && CockpitBF_109G14.this.fm.CT.getFlap() > 0.0F);
			CockpitBF_109G14.this.setNew.beaconDirection = (10F * CockpitBF_109G14.this.setOld.beaconDirection
					+ CockpitBF_109G14.this.getBeaconDirection()) / 11F;
			CockpitBF_109G14.this.setNew.beaconRange = (10F * CockpitBF_109G14.this.setOld.beaconRange
					+ CockpitBF_109G14.this.getBeaconRange()) / 11F;
			return true;
		}
