	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (CockpitBF_109G5AS.this.cockpitDimControl) {
				...
				CockpitBF_109G5AS.this.setNew.dimPosition = CockpitBF_109G5AS.this.setOld.dimPosition + 0.05F;
			CockpitBF_109G5AS.this.setNew.throttle = (10F * CockpitBF_109G5AS.this.setOld.throttle
					+ CockpitBF_109G5AS.this.fm.CT.PowerControl) / 11F;
			CockpitBF_109G5AS.this.setNew.mix = (8F * CockpitBF_109G5AS.this.setOld.mix
					+ CockpitBF_109G5AS.this.fm.EI.engines[0].getControlMix()) / 9F;
			...
			if (CockpitBF_109G5AS.this.useRealisticNavigationInstruments()) {
				...
				CockpitBF_109G5AS.this.setNew.waypointAzimuth.setDeg(
						CockpitBF_109G5AS.this.setOld.waypointAzimuth.getDeg(0.1F),
						f - CockpitBF_109G5AS.this.setOld.azimuth.getDeg(1.0F));
			}
			CockpitBF_109G5AS.this.setNew.azimuth.setDeg(CockpitBF_109G5AS.this.setOld.azimuth.getDeg(1.0F),
					CockpitBF_109G5AS.this.fm.Or.azimut());
			...
			CockpitBF_109G5AS.this.setNew.turn = (12F * CockpitBF_109G5AS.this.setOld.turn
					+ ((Tuple3f) (CockpitBF_109G5AS.this.w)).z) / 13F;
			CockpitBF_109G5AS.this.buzzerFX(CockpitBF_109G5AS.this.fm.CT.getGear() < 0.999999F
					&& CockpitBF_109G5AS.this.fm.CT.getFlap() > 0.0F);
			CockpitBF_109G5AS.this.setNew.beaconDirection = (10F * CockpitBF_109G5AS.this.setOld.beaconDirection
					+ CockpitBF_109G5AS.this.getBeaconDirection()) / 11F;
			CockpitBF_109G5AS.this.setNew.beaconRange = (10F * CockpitBF_109G5AS.this.setOld.beaconRange
					+ CockpitBF_109G5AS.this.getBeaconRange()) / 11F;
			return true;
		}
