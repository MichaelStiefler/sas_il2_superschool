	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (CockpitBF_109G6LATE.this.cockpitDimControl) {
				...
				CockpitBF_109G6LATE.this.setNew.dimPosition = CockpitBF_109G6LATE.this.setOld.dimPosition + 0.05F;
			CockpitBF_109G6LATE.this.setNew.throttle = (10F * CockpitBF_109G6LATE.this.setOld.throttle
					+ CockpitBF_109G6LATE.this.fm.CT.PowerControl) / 11F;
			CockpitBF_109G6LATE.this.setNew.mix = (8F * CockpitBF_109G6LATE.this.setOld.mix
					+ CockpitBF_109G6LATE.this.fm.EI.engines[0].getControlMix()) / 9F;
			...
			if (CockpitBF_109G6LATE.this.useRealisticNavigationInstruments()) {
				...
				CockpitBF_109G6LATE.this.setNew.waypointAzimuth.setDeg(
						CockpitBF_109G6LATE.this.setOld.waypointAzimuth.getDeg(0.1F),
						f - CockpitBF_109G6LATE.this.setOld.azimuth.getDeg(1.0F));
			}
			CockpitBF_109G6LATE.this.setNew.azimuth.setDeg(CockpitBF_109G6LATE.this.setOld.azimuth.getDeg(1.0F),
					CockpitBF_109G6LATE.this.fm.Or.azimut());
			...
			CockpitBF_109G6LATE.this.setNew.turn = (12F * CockpitBF_109G6LATE.this.setOld.turn
					+ ((Tuple3f) (CockpitBF_109G6LATE.this.w)).z) / 13F;
			CockpitBF_109G6LATE.this.buzzerFX(CockpitBF_109G6LATE.this.fm.CT.getGear() < 0.999999F
					&& CockpitBF_109G6LATE.this.fm.CT.getFlap() > 0.0F);
			CockpitBF_109G6LATE.this.setNew.beaconDirection = (10F * CockpitBF_109G6LATE.this.setOld.beaconDirection
					+ CockpitBF_109G6LATE.this.getBeaconDirection()) / 11F;
			CockpitBF_109G6LATE.this.setNew.beaconRange = (10F * CockpitBF_109G6LATE.this.setOld.beaconRange
					+ CockpitBF_109G6LATE.this.getBeaconRange()) / 11F;
			return true;
		}
