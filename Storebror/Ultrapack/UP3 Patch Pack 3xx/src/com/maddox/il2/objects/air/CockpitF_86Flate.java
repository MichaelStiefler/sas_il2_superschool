...
public class CockpitF_86Flate extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				setNew.stage = 0.85F * setOld.stage + fm.EI.engines[0].getControlCompressor() * 0.15F;
				...
				setNew.k14w = (5F * CockpitF_86Flate.k14TargetWingspanScale[((F_86F) aircraft()).k14WingspanType]) / f;
				setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
				setNew.k14wingspan = 0.9F * setOld.k14wingspan
						+ 0.1F * CockpitF_86Flate.k14TargetMarkScale[((F_86F) aircraft()).k14WingspanType];
				setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * ((F_86F) aircraft()).k14Mode;
				Vector3d vector3d = aircraft().FM.getW();
				double d = 0.00125D * f;
				float f1 = (float) Math.toDegrees(d * vector3d.z);
				float f2 = -(float) Math.toDegrees(d * vector3d.y);
				float f3 = floatindex((f - 200F) * 0.04F, CockpitF_86Flate.k14BulletDrop)
	...
	public void reflectWorldToInstruments(float f) {
		...
		resetYPRmodifier();
		Cockpit.xyz[1] = cvt(this.fm.CT.getCockpitDoor(), 0.01F, 0.99F, -0.625F, 0.0F);
