...
public class CockpitS_199 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (CockpitS_199.this.cockpitDimControl) {
				...
				CockpitS_199.this.setNew.dimPosition = CockpitS_199.this.setOld.dimPosition + 0.05F;
			CockpitS_199.this.setNew.throttle = (10F * CockpitS_199.this.setOld.throttle
					+ CockpitS_199.this.fm.CT.PowerControl) / 11F;
			CockpitS_199.this.setNew.mix = (8F * CockpitS_199.this.setOld.mix
					+ CockpitS_199.this.fm.EI.engines[0].getControlMix()) / 9F;
			...
			if (CockpitS_199.this.useRealisticNavigationInstruments()) {
				...
				CockpitS_199.this.setNew.waypointAzimuth.setDeg(CockpitS_199.this.setOld.waypointAzimuth.getDeg(0.1F),
						f - CockpitS_199.this.setOld.azimuth.getDeg(1.0F));
			}
			CockpitS_199.this.setNew.azimuth.setDeg(CockpitS_199.this.setOld.azimuth.getDeg(1.0F),
					CockpitS_199.this.fm.Or.azimut());
			CockpitS_199.this.w.set(CockpitS_199.this.fm.getW());
			CockpitS_199.this.fm.Or.transform(CockpitS_199.this.w);
			CockpitS_199.this.setNew.turn = (12F * CockpitS_199.this.setOld.turn + ((Tuple3f) (CockpitS_199.this.w)).z)
					/ 13F;
			CockpitS_199.this.buzzerFX(
					CockpitS_199.this.fm.CT.getGear() < 0.999999F && CockpitS_199.this.fm.CT.getFlap() > 0.0F);
			CockpitS_199.this.setNew.beaconDirection = (10F * CockpitS_199.this.setOld.beaconDirection
					+ CockpitS_199.this.getBeaconDirection()) / 11F;
			CockpitS_199.this.setNew.beaconRange = (10F * CockpitS_199.this.setOld.beaconRange
					+ CockpitS_199.this.getBeaconRange()) / 11F;
			return true;
		}
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("Z_EngTemp1", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, 58.5F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_FuelPress1", this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 3F, 0.0F, 135F),
				0.0F, 0.0F);
