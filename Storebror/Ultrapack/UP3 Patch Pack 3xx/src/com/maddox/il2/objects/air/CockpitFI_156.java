	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (CockpitFI_156.this.cockpitDimControl) {
				...
				CockpitFI_156.this.setNew.dimPosition = CockpitFI_156.this.setOld.dimPosition + 0.05F;
			CockpitFI_156.this.setNew.throttle = (10F * CockpitFI_156.this.setOld.throttle
					+ CockpitFI_156.this.fm.CT.PowerControl) / 11F;
			CockpitFI_156.this.setNew.mix = (8F * CockpitFI_156.this.setOld.mix
					+ CockpitFI_156.this.fm.EI.engines[0].getControlMix()) / 9F;
			CockpitFI_156.this.setNew.azimuth = CockpitFI_156.this.fm.Or.getYaw();
			if (CockpitFI_156.this.setOld.azimuth > 270F && CockpitFI_156.this.setNew.azimuth < 90F)
				CockpitFI_156.this.setOld.azimuth -= 360F;
			if (CockpitFI_156.this.setOld.azimuth < 90F && CockpitFI_156.this.setNew.azimuth > 270F)
				CockpitFI_156.this.setOld.azimuth += 360F;
			CockpitFI_156.this.setNew.waypointAzimuth = (10F * CockpitFI_156.this.setOld.waypointAzimuth
					+ (CockpitFI_156.this.waypointAzimuth() - CockpitFI_156.this.setOld.azimuth)
					+ World.Rnd().nextFloat(-30F, 30F)) / 11F;
			CockpitFI_156.this.buzzerFX(
					CockpitFI_156.this.fm.CT.getGear() < 0.999999F && CockpitFI_156.this.fm.CT.getFlap() > 0.0F);
			CockpitFI_156.this.setNew.vspeed = (199F * CockpitFI_156.this.setOld.vspeed
					+ CockpitFI_156.this.fm.getVertSpeed()) / 200F;
			return true;
		}
