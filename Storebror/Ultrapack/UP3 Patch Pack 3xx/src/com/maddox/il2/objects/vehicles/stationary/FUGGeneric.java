...
public abstract class FUGGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(FUGGeneric.this.engineSFX != null)
                if(FUGGeneric.this.engineSTimer >= 0)
                {
                    if(--FUGGeneric.this.engineSTimer <= 0)
                    {
                        FUGGeneric.this.engineSTimer = (int)FUGGeneric.SecsToTicks(FUGGeneric.Rnd(5F, 5F));
                        if(!FUGGeneric.this.danger())
                            FUGGeneric.this.engineSTimer = -FUGGeneric.this.engineSTimer;
                    }
                } else
                if(++FUGGeneric.this.engineSTimer >= 0)
                {
