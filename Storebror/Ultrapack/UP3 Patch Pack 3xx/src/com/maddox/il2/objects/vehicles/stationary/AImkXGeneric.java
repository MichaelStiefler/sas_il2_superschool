...
public abstract class AImkXGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(AImkXGeneric.this.engineSFX != null)
                if(AImkXGeneric.this.engineSTimer >= 0)
                {
                    if(--AImkXGeneric.this.engineSTimer <= 0)
                    {
                        AImkXGeneric.this.engineSTimer = (int)AImkXGeneric.SecsToTicks(AImkXGeneric.Rnd(5F, 5F));
                        if(!AImkXGeneric.this.danger())
                            AImkXGeneric.this.engineSTimer = -AImkXGeneric.this.engineSTimer;
                    }
                } else
                if(++AImkXGeneric.this.engineSTimer >= 0)
                {
