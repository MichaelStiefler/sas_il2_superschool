...
public abstract class SN2bGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(SN2bGeneric.this.engineSFX != null)
                if(SN2bGeneric.this.engineSTimer >= 0)
                {
                    if(--SN2bGeneric.this.engineSTimer <= 0)
                    {
                        SN2bGeneric.this.engineSTimer = (int)SN2bGeneric.SecsToTicks(SN2bGeneric.Rnd(5F, 5F));
                        if(!SN2bGeneric.this.danger())
                            SN2bGeneric.this.engineSTimer = -SN2bGeneric.this.engineSTimer;
                    }
                } else
                if(++SN2bGeneric.this.engineSTimer >= 0)
                {
