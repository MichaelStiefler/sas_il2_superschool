...
public class CockpitH8K1 extends CockpitPilot {
		...
		public boolean tick() {
			if (CockpitH8K1.this.fm != null) {
				...
				CockpitH8K1.this.setNew.throttle1 = 0.9F * CockpitH8K1.this.setOld.throttle1
						+ 0.1F * CockpitH8K1.this.fm.EI.engines[0].getControlThrottle();
				CockpitH8K1.this.setNew.prop1 = 0.9F * CockpitH8K1.this.setOld.prop1
						+ 0.1F * CockpitH8K1.this.fm.EI.engines[0].getControlProp();
				CockpitH8K1.this.setNew.mix1 = 0.8F * CockpitH8K1.this.setOld.mix1
						+ 0.2F * CockpitH8K1.this.fm.EI.engines[0].getControlMix();
				CockpitH8K1.this.setNew.throttle2 = 0.9F * CockpitH8K1.this.setOld.throttle2
						+ 0.1F * CockpitH8K1.this.fm.EI.engines[1].getControlThrottle();
				CockpitH8K1.this.setNew.prop2 = 0.9F * CockpitH8K1.this.setOld.prop2
						+ 0.1F * CockpitH8K1.this.fm.EI.engines[1].getControlProp();
				CockpitH8K1.this.setNew.mix2 = 0.8F * CockpitH8K1.this.setOld.mix2
						+ 0.2F * CockpitH8K1.this.fm.EI.engines[1].getControlMix();
				CockpitH8K1.this.setNew.man1 = 0.92F * CockpitH8K1.this.setOld.man1
						+ 0.08F * CockpitH8K1.this.fm.EI.engines[0].getManifoldPressure();
				CockpitH8K1.this.setNew.man2 = 0.92F * CockpitH8K1.this.setOld.man2
						+ 0.08F * CockpitH8K1.this.fm.EI.engines[1].getManifoldPressure();
				CockpitH8K1.this.setNew.altimeter = CockpitH8K1.this.fm.getAltitude();
				CockpitH8K1.this.setNew.azimuth.setDeg(CockpitH8K1.this.setOld.azimuth.getDeg(1.0F),
						CockpitH8K1.this.fm.Or.azimut());
				CockpitH8K1.this.setNew.vspeed = (199F * CockpitH8K1.this.setOld.vspeed
						+ CockpitH8K1.this.fm.getVertSpeed()) / 200F;
				if (CockpitH8K1.this.useRealisticNavigationInstruments())
					CockpitH8K1.this.setNew.waypointAzimuth.setDeg(CockpitH8K1.this.setOld.waypointAzimuth.getDeg(1.0F),
							CockpitH8K1.this.waypointAzimuth());
				else
					CockpitH8K1.this.setNew.waypointAzimuth.setDeg(CockpitH8K1.this.setOld.waypointAzimuth.getDeg(1.0F),
							CockpitH8K1.this.fm.Or.azimut() + 90F);
				CockpitH8K1.this.setNew.beaconDirection = (10F * CockpitH8K1.this.setOld.beaconDirection
						+ CockpitH8K1.this.getBeaconDirection()) / 11F;
				CockpitH8K1.this.setNew.beaconRange = (10F * CockpitH8K1.this.setOld.beaconRange
						+ CockpitH8K1.this.getBeaconRange()) / 11F;
			}
			return true;
		}
	...
	public CockpitH8K1() {
		...
		this.pictElev = 0.0F;
		this.bNeedSetUp = true;
		this.cockpitNightMats = (new String[] { "gauges5", "GP1_d1", "GP1", "GP2_d1", "GP2", "GP3", "GP4_d1", "GP4",
				"GP5_d1", "GP5", "GP6_d1", "GP6", "GP7", "GP9", "throttle", "Volt_Tacho" });
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("Z_Columnbase", 0.0F, 0.0F,
				10F * (this.pictElev = 0.85F * this.pictElev + 0.15F * this.fm.CT.ElevatorControl));
		this.mesh.chunkSetAngles("Z_ColumnL", 0.0F, 0.0F,
				-60.6F * (this.pictAiler = 0.85F * this.pictAiler + 0.15F * this.fm.CT.AileronControl));
		this.mesh.chunkSetAngles("Z_ColumnR", 0.0F, 0.0F, -60.6F * this.pictAiler);
		this.mesh.chunkSetAngles("Z_Throtle1", 40F * this.interp(this.setNew.throttle1, this.setOld.throttle1, f), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_Throtle2", 40F * this.interp(this.setNew.throttle2, this.setOld.throttle2, f), 0.0F,
				0.0F);
		...
		float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()),
				0.0F, 300F, 0.0F, 15F), speedometerScale);
		...
		this.mesh.chunkSetAngles("Z_Altimeter1",
				this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 20000F, 0.0F, 1440F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_Altimeter2",
				this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 20000F, 0.0F, 1440F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_Temp1", this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 350F, 0.0F, 90F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_Temp2", this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 350F, 0.0F, 90F), 0.0F,
				0.0F);
		...
		float f3 = (Atmosphere.temperature((float) this.fm.Loc.z) - 273.09F)
		...
		this.mesh.chunkSetAngles("Z_Temp7",
				this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), oilTempScale), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_Temp8",
				this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), oilTempScale), 0.0F,
				0.0F);
		...
		this.mesh.chunkSetAngles("Z_Fuel1", this.cvt((float) Math.sqrt(this.fm.M.fuel), 0.0F, 34.641F, 0.0F, 225F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_Fuel2", this.cvt((float) Math.sqrt(this.fm.M.fuel), 0.0F, 34.641F, 0.0F, 225F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_Fuel3", this.cvt((float) Math.sqrt(this.fm.M.fuel), 0.0F, 38.729F, 0.0F, 225F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_Fuel4", this.cvt((float) Math.sqrt(this.fm.M.fuel), 26.925F, 38.729F, 0.0F, 225F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_Fuel5", this.cvt((float) Math.sqrt(this.fm.M.fuel), 26.925F, 38.729F, 0.0F, 225F),
				0.0F, 0.0F);
		this.resetYPRmodifier();
		...
		this.mesh.chunkSetAngles("Z_Manifold1", this.cvt(this.setNew.man1, 0.33339F, 1.66661F, -162F, 162F), 0.0F,
				0.0F);
		this.mesh.chunkSetAngles("Z_Manifold2", this.cvt(this.setNew.man2, 0.33339F, 1.66661F, -162F, 162F), 0.0F,
				0.0F);
		...
		this.mesh.chunkSetAngles("Z_Oil2",
				this.cvt(1.0F + 0.05F * this.fm.EI.engines[1].tOilOut * this.fm.EI.engines[1].getReadyness(), 0.0F,
						7.45F, 0.0F, 180F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_fuelpress1", this.cvt(this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 0.5F, 0.0F, 180F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_fuelpress2", this.cvt(this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 0.5F, 0.0F, 180F),
				0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_RPM1",
				this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), rpmScale), 0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_RPM2",
				this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), rpmScale), 0.0F, 0.0F);
	...
	private static final float speedometerScale[] = { 0.0F, 6.5F, 30F, 66F, 105F, 158.5F, 212F, 272.5F, 333F, 384F,
			432.5F, 479.5F, 526.5F, 573.5F, 624.5F, 674F };
	private static final float oilTempScale[] = { 0.0F, 4F, 17.5F, 38F, 63F, 90.5F, 115F, 141.3F, 180F, 221.7F, 269.5F,
			311F, 357F };
