...
public class BF_109G14 extends BF_109 implements TypeBNZFighter {
	...
	public void update(float f) {
		...
		if (this.kangle > 1.0F)
			this.kangle = 1.0F;
		super.update(f);
		if (this.FM.CT.getCockpitDoor() > 0.2F && this.bHasBlister
	...
	static {
		...
		Aircraft.weaponTriggersRegister(class1,
				new int[] { 0, 0, 0, 1, 1, 1, 1, 1, 9, 9, 9, 9, 2, 2, 9, 9, 3, 3, 3, 3, 3, 3 });
		Aircraft.weaponHooksRegister(class1,
				new String[] { "_MGUN01", "_MGUN02", "_CANNON01", "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04",
						"_CANNON05", "_ExternalDev01", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03",
						"_ExternalRock01", "_ExternalRock02", "_ExternalDev04", "_ExternalDev05", "_ExternalBomb01",
