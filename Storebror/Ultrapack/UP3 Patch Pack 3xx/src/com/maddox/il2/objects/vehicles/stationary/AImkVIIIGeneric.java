...
public abstract class AImkVIIIGeneric extends ActorHMesh
    implements com.maddox.il2.objects.ActorAlign
{
    class Move extends Interpolate
    {
        ...
        public boolean tick()
        {
            if(AImkVIIIGeneric.this.engineSFX != null)
                if(AImkVIIIGeneric.this.engineSTimer >= 0)
                {
                    if(--AImkVIIIGeneric.this.engineSTimer <= 0)
                    {
                        ...
                        if(!AImkVIIIGeneric.this.danger())
                            AImkVIIIGeneric.this.engineSTimer = -AImkVIIIGeneric.this.engineSTimer;
                    }
                } else
                if(++AImkVIIIGeneric.this.engineSTimer >= 0)
                {
