...
public class Wellington3 extends Wellington implements TypeBomber {
    ...
    public static void prepareWeapons(Class aircraftClass, HierMesh hierMesh, String thisWeaponsName) {
        hierMesh.chunkVisible("Bay_D0", !thisWeaponsName.startsWith("1x4000"));
        hierMesh.chunkVisible("BayStruct_D0", !thisWeaponsName.startsWith("1x4000"));
        hierMesh.chunkVisible("Bay_Mod423_D0", thisWeaponsName.startsWith("1x4000"));
    }
    ...
    public void typeBomberAdjSideslipPlus() {
        ...
        if (this.fSightCurSideslip > 10F) this.fSightCurSideslip = 10F;
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1,
                new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08",
                        "_BombSpawn09", "_BombSpawn10", "_BombSpawn11", "_BombSpawn12", "_BombSpawn13", "_BombSpawn14", "_BombSpawn15", "_BombSpawn16", "_BombSpawn17", "_BombSpawn18", "_BombSpawn19", "_BombSpawn20", "_BombSpawn21" });
    }
}
