    ...
    private void checkAsDrone() {
        if (this.target_ == null) {
            ...
            if (Actor.isValid(this.target_) && (this.target_ instanceof Wing)) {
                ...
                if ((this.target_ instanceof AR_234C2) || (this.target_ instanceof HE_111H2) || (this.target_ instanceof G4M2E)) {
        ...
        if (Actor.isValid(this.target_) && ((this.target_ instanceof HE_111H2) || (this.target_ instanceof G4M2E) || (this.target_ instanceof HE_111Z) || (this.target_ instanceof FW_200C3U4) || (this.target_ instanceof AR_234C2))) {
