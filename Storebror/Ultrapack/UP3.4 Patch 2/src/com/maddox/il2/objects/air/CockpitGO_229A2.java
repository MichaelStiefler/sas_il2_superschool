...
public class CockpitGO_229A2 extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(setNew.dimPosition < 1.0F)
                setNew.dimPosition = setOld.dimPosition + 0.05F;
            float f = setNew.k14Distance = ((GO_229A2)aircraft()).k14Distance;
            setNew.k14w = (5F * CockpitGO_229A2.k14TargetWingspanScale[((GO_229A2)aircraft()).k14WingspanType]) / f;
            setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
            setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitGO_229A2.k14TargetMarkScale[((GO_229A2)aircraft()).k14WingspanType];
            setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((GO_229A2)aircraft()).k14Mode;
            ...
            float f3 = floatindex((f - 200F) * 0.04F, CockpitGO_229A2.k14BulletDrop) - CockpitGO_229A2.k14BulletDrop[0];
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        int i = ((GO_229A2)aircraft()).k14Mode;
        boolean flag = i < 2;
