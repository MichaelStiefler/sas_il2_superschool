...
public class Breguet_19L extends Br19xyz {
    ...
    public static void prepareWeapons(Class aircraftClass, HierMesh hierMesh, String thisWeaponsName) {
        boolean rackD = thisWeaponsName.equals("4x100KgHE") || thisWeaponsName.equals("2x200KgHE") || thisWeaponsName.equals("24x10KgHE");
        boolean rackF = rackD || thisWeaponsName.equals("8x50KgGAMM") || thisWeaponsName.equals("32x10KgHE");
        hierMesh.chunkVisible("RackD_DoorF_D0", rackD);
        hierMesh.chunkVisible("RackD_DoorB_D0", rackD);
        hierMesh.chunkVisible("RackF_Door_D0", rackF);
    }
