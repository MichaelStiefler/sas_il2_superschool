...
public class ME_209_IIB extends ME_155xyz
    implements TypeFighter, TypeBNZFighter, TypeStormovik
{
    ...
    static 
    {
        Class class1 = ME_209_IIB.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "ME-209-IIB");
        Property.set(class1, "meshName", "3do/plane/Me-209-II/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar06());
        Property.set(class1, "yearService", 1944F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/ME-209-IIB.fmd");
