...
public class CockpitBF_109V extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitBF_109V.this.setOld.azimuth = CockpitBF_109V.this.fm.Or.getYaw();
            if (CockpitBF_109V.this.setTmp.azimuth > 270F && CockpitBF_109V.this.setOld.azimuth < 90F)
                CockpitBF_109V.this.setTmp.azimuth -= 360F;
            if (CockpitBF_109V.this.setTmp.azimuth < 90F && CockpitBF_109V.this.setOld.azimuth > 270F)
                CockpitBF_109V.this.setTmp.azimuth += 360F;
            CockpitBF_109V.this.setOld.waypointAzimuth = (10F * CockpitBF_109V.this.setTmp.waypointAzimuth + (CockpitBF_109V.this.waypointAzimuth() - CockpitBF_109V.this.setTmp.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
