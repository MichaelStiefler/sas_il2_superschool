...
public class CockpitSeaHawk extends CockpitPilot
{
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                if(setNew.stbyPosition3 < 1.0F)
                    setNew.stbyPosition3 = setOld.stbyPosition3 + 0.005F;
                float f = ((SeaHawk_X) ((SeaHawk)aircraft())).k14Distance;
                setNew.k14w = (5F * CockpitSeaHawk.k14TargetWingspanScale[((SeaHawk_X) ((SeaHawk)aircraft())).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSeaHawk.k14TargetMarkScale[((SeaHawk_X) ((SeaHawk)aircraft())).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((SeaHawk_X) ((SeaHawk)aircraft())).k14Mode;
                ...
                float f3 = floatindex((f - 200F) * 0.04F, CockpitSeaHawk.k14BulletDrop) - CockpitSeaHawk.k14BulletDrop[0];
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            int i = ((SeaHawk_X) ((SeaHawk)aircraft())).k14Mode;
            boolean flag = i < 2;
        ...
        if(((SeaHawk_X) ((SeaHawk)aircraft())).k14Mode == 2)
