...
public class CockpitKI_108KAI extends CockpitPilot
{
    ...
    protected boolean doFocusEnter()
    {
        if(super.doFocusEnter())
        {
            ...
            aircraft().hierMesh().chunkVisible("RGlassBlister1_D0", false);
            aircraft().hierMesh().chunkVisible("LGlassBlister1_D0", false);
    ...
    protected void doFocusLeave()
    {
        ...
        aircraft().hierMesh().chunkVisible("RGlassBlister1_D0", true);
        aircraft().hierMesh().chunkVisible("LGlassBlister1_D0", true);
    ...
    static 
    {
        Property.set(CockpitKI_108KAI.class, "normZNs", new float[] {
            0.7F, 0.7F, 0.8F, 0.7F
        });
    }
