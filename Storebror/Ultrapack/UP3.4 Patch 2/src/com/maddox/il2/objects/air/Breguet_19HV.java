...
public class Breguet_19HV extends Br19xyz {
    ...
    public static void prepareWeapons(Class aircraftClass, HierMesh hierMesh, String thisWeaponsName) {
        boolean rack = !thisWeaponsName.equals("default") && !thisWeaponsName.equals("none");
        hierMesh.chunkVisible("RackL_D0", rack);
        hierMesh.chunkVisible("RackR_D0", rack);
    }
    
    static {
        Class class1 = Breguet_19HV.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "He45");
        Property.set(class1, "meshName", "3DO/Plane/Breguet_19/hierHV.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_it", "3DO/Plane/Breguet_19/hierHV.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/Breguet19H.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitBreguet_19HV.class });
