...
public class CockpitMe_209II extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(setNew.gearIndicatorPosition < 1.0F)
                setNew.gearIndicatorPosition = setOld.gearIndicatorPosition + 0.005F;
            boolean flag2 = false;
            if(((NetAircraft) ((Aircraft)fm.actor)).thisWeaponsName.toLowerCase().startsWith("u5") && fm.CT.Weapons[9][0].haveBullets())
                flag2 = true;
            if(flag2)
            {
            ...
            boolean flag4 = false;
            if(((NetAircraft) ((Aircraft)fm.actor)).thisWeaponsName.toLowerCase().startsWith("r1") && fm.CT.Weapons[3][0].haveBullets())
                flag4 = true;
            if(flag4)
            {
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        this.mesh.chunkSetAngles("Revi16Tinter", 0.0F, cvt(interp(setNew.dimPosition, setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, 45F), 0.0F);
        this.mesh.chunkSetAngles("Starter", 0.0F, cvt(interp(setNew.starterPosition, setOld.starterPosition, f), 0.0F, 1.0F, 0.0F, 45F), 0.0F);
        this.mesh.chunkSetAngles("Revi16Contact", 0.0F, cvt(interp(setNew.reviPosition, setOld.reviPosition, f), 0.0F, 1.0F, 0.0F, -46F), 0.0F);
        this.mesh.chunkSetAngles("Z_MasterArm", 0.0F, cvt(interp(setNew.masterArmPosition, setOld.masterArmPosition, f), 0.0F, 1.0F, 0.0F, -35F), 0.0F);
        for(int i = 0; i < NUM_COUNTERS; i++)
            this.mesh.chunkSetAngles("Z_Shot" + (i + 1), 0.0F, cvt(interp(setNew.shotPosition[i], setOld.shotPosition[i], f), 0.0F, 1.0F, 0.0F, -60F), 0.0F);

        this.mesh.chunkSetAngles("Z_GearLever", 0.0F, cvt(interp(setNew.gearLeverPosition, setOld.gearLeverPosition, f), 0.0F, 1.0F, 0.0F, -65F), 0.0F);
        this.mesh.chunkSetAngles("Z_KG13Trigger", 0.0F, cvt(interp(setNew.kg13TriggerPosition, setOld.kg13TriggerPosition, f), 0.0F, 1.0F, 0.0F, -270F), 0.0F);
        this.mesh.chunkSetAngles("Z_RadiatorSelector", 0.0F, cvt(interp(setNew.radiatorPosition, setOld.radiatorPosition, f), 0.0F, 1.0F, 0.0F, -90F), 0.0F);
        this.mesh.chunkSetAngles("Z_RadiatorSelector2", cvt(this.fm.CT.getRadiatorControl(), 0.0F, 1.0F, -180F, 0.0F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_QuickBrake", 0.0F, cvt(interp(setNew.quickBrakePosition1, setOld.quickBrakePosition1, f), 0.0F, 1.0F, 0.0F, 38F), 0.0F);
        this.mesh.chunkSetAngles("Z_QuickBrake2", 0.0F, cvt(interp(setNew.quickBrakePosition2, setOld.quickBrakePosition2, f), 0.0F, 1.0F, 0.0F, -15F), 0.0F);
        this.mesh.chunkSetAngles("Z_FuelSelector", 0.0F, cvt(interp(setNew.fuelSelectorPosition, setOld.fuelSelectorPosition, f), 0.0F, 1.0F, 0.0F, -58F), 0.0F);
        this.mesh.chunkSetAngles("Z_OilContact", 0.0F, cvt(interp(setNew.oilContactPosition, setOld.oilContactPosition, f), 0.0F, 1.0F, 0.0F, -45F), 0.0F);
        this.mesh.chunkSetAngles("Z_EjectSystem", 0.0F, cvt(interp(setNew.ejectSystemPosition, setOld.ejectSystemPosition, f), 0.0F, 1.0F, 0.0F, -42F), 0.0F);
        this.mesh.chunkSetAngles("Z_LockTWheel2", 0.0F, cvt(interp(setNew.lockTailWheelPosition1, setOld.lockTailWheelPosition1, f), 0.0F, 1.0F, 0.0F, 135F), 0.0F);
        this.mesh.chunkSetAngles("Z_LockTWheel4", 0.0F, cvt(interp(setNew.lockTailWheelPosition2, setOld.lockTailWheelPosition2, f), 0.0F, 1.0F, 0.0F, -25F), 0.0F);
        this.mesh.chunkSetAngles("Z_TopCable", 0.0F, cvt(interp(setNew.topCablePosition1, setOld.topCablePosition1, f), 0.0F, 1.0F, 0.0F, 75F), 0.0F);
        this.mesh.chunkSetAngles("Z_TopCable2", 0.0F, cvt(interp(setNew.topCablePosition2, setOld.topCablePosition2, f), 0.0F, 1.0F, 0.0F, -80F), 0.0F);
        this.mesh.chunkSetAngles("Z_OxyButton", 0.0F, cvt(interp(setNew.oxyButtonPosition, setOld.oxyButtonPosition, f), 0.0F, 1.0F, 0.0F, 180F), 0.0F);
        this.mesh.chunkSetAngles("Z_OxyPressure", 0.0F, cvt(interp(setNew.oxyPressurePosition, setOld.oxyPressurePosition, f), 0.0F, 1.0F, -258F, 0.0F), 0.0F);
        this.mesh.chunkSetAngles("Z_GlassCleaner", 0.0F, cvt(interp(setNew.glassCleanerPosition, setOld.glassCleanerPosition, f), 0.0F, 1.0F, 0.0F, -88F), 0.0F);
        this.mesh.chunkSetAngles("Z_CanopyHandle", 0.0F, cvt(interp(setNew.canopyHandlePosition, setOld.canopyHandlePosition, f), 0.0F, 1.0F, 0.0F, 120F), 0.0F);
        this.mesh.chunkSetAngles("Smoke1", 0.0F, cvt(interp(setNew.smoke1Position, setOld.smoke1Position, f), 0.0F, 1.0F, 0.0F, 18000F), 0.0F);
        this.mesh.chunkSetAngles("Smoke2", 0.0F, cvt(interp(setNew.smoke2Position, setOld.smoke2Position, f), 0.0F, 1.0F, 0.0F, 18000F), 0.0F);
        this.mesh.chunkSetAngles("Smoke3", 0.0F, cvt(interp(setNew.smoke3Position, setOld.smoke3Position, f), 0.0F, 1.0F, 0.0F, 18000F), 0.0F);
        this.mesh.chunkSetAngles("Smoke4", 0.0F, cvt(interp(setNew.smoke4Position, setOld.smoke4Position, f), 0.0F, 1.0F, 0.0F, 18000F), 0.0F);
        this.mesh.chunkSetAngles("Revi16Support1", 0.0F, cvt(interp(setNew.revi16SupportPosition, setOld.revi16SupportPosition, f), 0.0F, 1.0F, 0.0F, 91F), 0.0F);
        this.mesh.chunkSetAngles("Z_MW50", 0.0F, cvt(interp(setNew.mw50Position, setOld.mw50Position, f), 0.0F, 1.0F, 0.0F, -40F), 0.0F);
        this.mesh.chunkSetAngles("Z_MW50Count", 0.0F, cvt(interp(setNew.mw50CountPosition, setOld.mw50CountPosition, f), 0.0F, 1.0F, 0.0F, 300F), 0.0F);
        ...
        if(this.fm.getAltitude() > 5000F && !CleanIceState1)
        {
            timeCounterIce1 += f;
            timeCounterIce2 += f;
            timeCounterIce3 += f;
        ...
        if(this.fm.getAltitude() <= 300F || CleanIceState1)
        {
            timeCounterIce1 = 0.0F;
            timeIce1 = 60F;
            timeCounterIce2 = 0.0F;
        ...
        this.mesh.chunkVisible("Z_Blood", aircraft().hierMesh().isChunkVisible("Gore2_D0"));
        if(IceState1)
        {
        ...
        if(gun[0] != null)
            this.mesh.chunkSetAngles("Z_AmmoCounter1", cvt(gun[0].countBullets(), 0.0F, ammoCounterMax[0], 15F, 0.0F), 0.0F, 0.0F);
        if(gun[1] != null)
            this.mesh.chunkSetAngles("Z_AmmoCounter2", cvt(gun[1].countBullets(), 0.0F, ammoCounterMax[1], 15F, 0.0F), 0.0F, 0.0F);
        if(gun[2] != null)
            this.mesh.chunkSetAngles("Z_AmmoCounter3", cvt(gun[2].countBullets(), 0.0F, ammoCounterMax[2], 15F, 0.0F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_KG13a", (pictAiler = 0.85F * pictAiler + 0.15F * this.fm.CT.AileronControl) * 15F, 0.0F, (pictElev = 0.85F * pictElev + 0.15F * this.fm.CT.ElevatorControl) * 9F);
        ...
        if(flag)
        {
            for(int j = 3; j < MAX_GUNS; j++)
            {
                ...
                if(this.fm.CT.WeaponControl[triggerForBreechControl[j]])
                {
        ...
        if(curctl == -1F)
        {
            curctl = oldctl = this.fm.EI.engines[0].getControlThrottle();
        } else
        {
            curctl = this.fm.EI.engines[0].getControlThrottle();
            if(curctl > 0.5F && (curctl - oldctl) / f > 0.0F && this.fm.EI.engines[0].getRPM() > 300F && this.fm.getSpeedKMH() > 0.0F && this.fm.getSpeedKMH() <= 90F && this.fm.EI.engines[0].getStage() == 6)
        ...
        Cockpit.xyz[1] = cvt(this.fm.CT.getRudder(), -1F, 1.0F, -0.045F, 0.045F);
    ...
    protected void reflectPlaneMats()
    {
        ...
        case 5:
            ...
            gun[0] = ((Aircraft)this.fm.actor).getGunByHookName("_CANNON02");
        ...
        String s1 = ((NetAircraft) (aircraft())).thisWeaponsName.toUpperCase();
        if(s1.startsWith("U2") || s1.startsWith("U4") || s1.startsWith("U7") || s1.startsWith("U9"))
        {
            ...
            gun[4] = ((Aircraft)this.fm.actor).getGunByHookName("_CANNON05");
        } else
        if(s1.startsWith("U1_R3") || s1.startsWith("U1_R4"))
        {
            gun[3] = ((Aircraft)this.fm.actor).getGunByHookName("_CANNON06");
            gun[4] = ((Aircraft)this.fm.actor).getGunByHookName("_CANNON07");
        } else
    ...
    static 
    {
        Property.set(CockpitMe_209II.class, "normZNs", new float[] {
