...
public class Hunter_F4 extends Hunter implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    static {
        ...
        Property.set(airClass, "FlightModel", "FlightModels/HunterF4.fmd");
