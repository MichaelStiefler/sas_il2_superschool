...
public class CockpitBF_109CRP extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitBF_109CRP.this.setOld.azimuth = CockpitBF_109CRP.this.fm.Or.getYaw();
            if (CockpitBF_109CRP.this.setTmp.azimuth > 270F && CockpitBF_109CRP.this.setOld.azimuth < 90F)
                CockpitBF_109CRP.this.setTmp.azimuth -= 360F;
            if (CockpitBF_109CRP.this.setTmp.azimuth < 90F && CockpitBF_109CRP.this.setOld.azimuth > 270F)
                CockpitBF_109CRP.this.setTmp.azimuth += 360F;
            CockpitBF_109CRP.this.setOld.waypointAzimuth = (10F * CockpitBF_109CRP.this.setTmp.waypointAzimuth + (CockpitBF_109CRP.this.waypointAzimuth() - CockpitBF_109CRP.this.setTmp.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
