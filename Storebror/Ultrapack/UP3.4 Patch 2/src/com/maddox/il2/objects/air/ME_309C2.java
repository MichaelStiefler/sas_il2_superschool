...
public class ME_309C2 extends ME_309zyx
    implements TypeFighter, TypeBNZFighter
{
        ...
        if(this.FM.CT.getCockpitDoor() > 0.2F && bHasBlister && this.FM.getSpeedKMH() > MAX_SPEED_KMH_FOR_KEEPING_CANOPY * maxSpeedForOpeningCanopyRandomFactor && hierMesh().chunkFindCheck("Blister1_D0") != -1)
        {
            try
            {
                if(this == World.getPlayerAircraft())
                    ((CockpitME_309C2)Main3D.cur3D().cockpitCur).removeCanopy();
            }
    ...
    public static void prepareWeapons(Class aircraftClass, HierMesh hierMesh, String thisWeaponsName) {
        hierMesh.chunkVisible("mgL", thisWeaponsName.equals("4xMGs_3xMG15120") || thisWeaponsName.equals("4xMGs_3xMG15120_2xdpt"));
        hierMesh.chunkVisible("mgR", thisWeaponsName.equals("4xMGs_3xMG15120") || thisWeaponsName.equals("4xMGs_3xMG15120_2xdpt"));
        hierMesh.chunkVisible("mg151L", thisWeaponsName.equals("3xMG15120") || thisWeaponsName.equals("4xMGs_3xMG15120") || thisWeaponsName.equals("xMG15120_2xdpt") || thisWeaponsName.equals("4xMGs_3xMG15120_2xdpt"));
        hierMesh.chunkVisible("mg151R", thisWeaponsName.equals("3xMG15120") || thisWeaponsName.equals("4xMGs_3xMG15120") || thisWeaponsName.equals("xMG15120_2xdpt") || thisWeaponsName.equals("4xMGs_3xMG15120_2xdpt"));
    }

    public void onAircraftLoaded() {
        super.onAircraftLoaded();
        ME_309C2.prepareWeapons(this.getClass(), this.hierMesh(), this.thisWeaponsName);
    }
    ...
    static 
    {
        Class class1 = ME_309C2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Me-309C-2");
        Property.set(class1, "meshName", "3DO/Plane/Me-309C2(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1944.5F);
        Property.set(class1, "yearExpired", 1948.5F);
        Property.set(class1, "FlightModel", "FlightModels/Me-309C-2.fmd");
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitME_309C2.class
        });
