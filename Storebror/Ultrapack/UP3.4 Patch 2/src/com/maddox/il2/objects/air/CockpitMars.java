...
public class CockpitMars extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        mesh.chunkSetAngles("Z_Speedometer1", floatindex(cvt(Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), speedometerScale), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Speedometer2", floatindex(cvt(Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), speedometerScale), 0.0F, 0.0F);
        ...
        mesh.chunkSetAngles("Z_Altimeter1", cvt(interp(setNew.altimeter, setOld.altimeter, f), 0.0F, 9144F, 180F, 1260F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Altimeter1a", cvt(interp(setNew.altimeter, setOld.altimeter, f), 0.0F, 9144F, 180F, 12600F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Altimeter2", cvt(interp(setNew.altimeter, setOld.altimeter, f), 0.0F, 9144F, 180F, 1260F), 0.0F, 0.0F);
        mesh.chunkSetAngles("Z_Altimeter2a", cvt(interp(setNew.altimeter, setOld.altimeter, f), 0.0F, 9144F, 180F, 12600F), 0.0F, 0.0F);
    ...
    private static final float speedometerScale[] = {
        180F, 182.5F, 239F, 306F, 335.5F, 403.5F, 420F, 434.5F, 451F, 465F, 
        476.5F, 488.5F, 504F, 518.5F
    };
