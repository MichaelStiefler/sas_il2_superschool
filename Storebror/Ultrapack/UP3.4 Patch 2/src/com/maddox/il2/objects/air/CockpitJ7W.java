...
public class CockpitJ7W extends CockpitPilot
{
    ...
    public CockpitJ7W()
    {
        ...
        limits6DoF = (new float[] {
            0.7F, 0.055F, -0.07F, 0.11F, 0.13F, -0.1F, 0.025F, -0.035F
        });
    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(fm.CT.getCockpitDoor(), 0.1F, 0.99F, 0.0F, 0.5F);
        Cockpit.xyz[2] = cvt(fm.CT.getCockpitDoor(), 0.1F, 0.5F, 0.0F, 0.02F);
        Cockpit.ypr[2] = cvt(fm.CT.getCockpitDoor(), 0.1F, 0.99F, 0.0F, 0.0F);
        ...
        mesh.chunkVisible("FlareGearDn_L", fm.CT.getGearL() > 0.98F && fm.Gears.lgear);
        mesh.chunkVisible("FlareGearDn_R", fm.CT.getGearR() > 0.98F && fm.Gears.rgear);
        mesh.chunkVisible("FlareGearDn_C", fm.CT.getGear() > 0.98F);
        mesh.chunkVisible("FlareGearUp_L", fm.CT.getGearL() < 0.02F || !fm.Gears.lgear);
        mesh.chunkVisible("FlareGearUp_R", fm.CT.getGearR() < 0.02F || !fm.Gears.rgear);
    ...
    static 
    {
        Property.set(CockpitJ7W.class, "normZNs", new float[] {
            0.77F, 0.77F, 0.79F, 0.77F
        });
    }
