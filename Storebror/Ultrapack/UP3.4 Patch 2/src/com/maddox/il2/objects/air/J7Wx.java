...
public class J7Wx extends Scheme1
    implements TypeFighter, TypeBNZFighter
{
    ...
    {
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, Aircraft.cvt(f2, 0.02F, 0.89F, 0.0F, 90F), 0.0F);
        hiermesh.chunkSetAngles("GearC6_D0", 0.0F, Aircraft.cvt(f2, 0.02F, 0.89F, 0.0F, 60F), 0.0F);
        hiermesh.chunkSetAngles("GearC4", 0.0F, Aircraft.cvt(f2, 0.01F, 0.05F, 0.0F, -70F), 0.0F);
        hiermesh.chunkSetAngles("GearC5", 0.0F, Aircraft.cvt(f2, 0.01F, 0.05F, 0.0F, 70F), 0.0F);
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, Aircraft.cvt(f, 0.02F, 0.89F, 0.0F, 88.5F), 0.0F);
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, Aircraft.cvt(f, 0.02F, 0.89F, 0.0F, -100F), 0.0F);
        ...
        hiermesh.chunkSetAngles("GearL4", 0.0F, Aircraft.cvt(f, 0.01F, 0.07F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearL5", 0.0F, Aircraft.cvt(f, 0.02F, 0.61F, 0.0F, 120F), 0.0F);
        Aircraft.xyz[0] = Aircraft.xyz[1] = Aircraft.xyz[2] = Aircraft.ypr[0] = Aircraft.ypr[1] = Aircraft.ypr[2] = 0.0F;
        Aircraft.xyz[0] = Aircraft.cvt(f1, 0.02F, 0.89F, 0.0F, 0.12F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, Aircraft.cvt(f1, 0.41F, 0.99F, 0.0F, -88.5F), 0.0F);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, Aircraft.cvt(f1, 0.41F, 0.99F, 0.0F, 100F), 0.0F);
        Aircraft.xyz[0] = Aircraft.xyz[1] = Aircraft.xyz[2] = Aircraft.ypr[0] = Aircraft.ypr[1] = Aircraft.ypr[2] = 0.0F;
        Aircraft.xyz[0] = Aircraft.cvt(f1, 0.41F, 0.99F, 0.0F, 0.12F);
        hiermesh.chunkSetLocate("GearR9_D0", Aircraft.xyz, Aircraft.ypr);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, 0.0F * f1, 0.0F);
        hiermesh.chunkSetAngles("GearR4", 0.0F, Aircraft.cvt(f1, 0.4F, 0.47F, 0.0F, 90F), 0.0F);
        hiermesh.chunkSetAngles("GearR5", 0.0F, Aircraft.cvt(f1, 0.41F, 0.99F, 0.0F, -120F), 0.0F);
        Aircraft.xyz[0] = Aircraft.xyz[1] = Aircraft.xyz[2] = Aircraft.ypr[0] = Aircraft.ypr[1] = Aircraft.ypr[2] = 0.0F;
        Aircraft.xyz[2] = Aircraft.cvt(f, 0.02F, 0.61F, 0.0F, 0.09F);
        hiermesh.chunkSetLocate("gearpL_D0", Aircraft.xyz, Aircraft.ypr);
        Aircraft.xyz[0] = Aircraft.xyz[1] = Aircraft.xyz[2] = Aircraft.ypr[0] = Aircraft.ypr[1] = Aircraft.ypr[2] = 0.0F;
        Aircraft.xyz[2] = Aircraft.cvt(f1, 0.41F, 0.99F, 0.0F, 0.09F);
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                if(s.startsWith("xxsparn") && chunkDamageVisible("Nose") > 2 && getEnergyPastArmor(3.86F / (float)Math.sqrt(Aircraft.v1.y * Aircraft.v1.y + Aircraft.v1.z * Aircraft.v1.z), shot) > 0.0F && World.Rnd().nextFloat() < 0.25F)
                {
                    debuggunnery("Spar Construction: Nose Ribs Hit, Breaking in Half..");
                    nextDMGLevels(1, 2, "Nose_D3", shot.initiator);
                }
                return;
            }
        ...
        {
            if(s.startsWith("Keel1") && getEnergyPastArmor(1.0F, shot) > 0.0F && World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                hitChunk("Keel1", shot);
            if(s.startsWith("Keel2") && getEnergyPastArmor(1.0F, shot) > 0.0F && World.Rnd().nextFloat(0.0F, 3000F) < shot.power)
                hitChunk("Keel2", shot);
        } else
    ...
    public void update(float f)
    {
        ...
        if(FM.getSpeed() > 5F && FM.CT.FlapsControl > 0.19F)
        {
            resetYPRmodifier();
            Aircraft.xyz[1] = Aircraft.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, -0.05F);
            hierMesh().chunkSetLocate("SlatL_D0", Aircraft.xyz, Aircraft.ypr);
            hierMesh().chunkSetLocate("SlatR_D0", Aircraft.xyz, Aircraft.ypr);
        } else
        if(FM.CT.FlapsControl < 0.02F)
        {
            resetYPRmodifier();
            Aircraft.xyz[1] = Aircraft.cvt(FM.getAOA(), 6.8F, 11F, 0.0F, 0.0F);
            hierMesh().chunkSetLocate("SlatL_D0", Aircraft.xyz, Aircraft.ypr);
            hierMesh().chunkSetLocate("SlatR_D0", Aircraft.xyz, Aircraft.ypr);
        }
    }
