...
public class CockpitKi96 extends CockpitPilot
{
    ...
    protected boolean doFocusEnter()
    {
        ...
        {
            aircraft().hierMesh().chunkVisible("CN_D0", false);
            aircraft().hierMesh().chunkVisible("CN_D1", false);
            aircraft().hierMesh().chunkVisible("CN_D2", false);
            aircraft().hierMesh().chunkVisible("CN_D3", false);
    ...
    {
        aircraft().hierMesh().chunkVisible("CN_D0", true);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        this.mesh.chunkSetAngles("Z_RCanopy", 0.0F, cvt(fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 90F), 0.0F);
    ...
    static 
    {
        Property.set(CockpitKi96.class, "normZNs", new float[] {
            0.7F, 0.7F, 0.8F, 0.7F
        });
    }
