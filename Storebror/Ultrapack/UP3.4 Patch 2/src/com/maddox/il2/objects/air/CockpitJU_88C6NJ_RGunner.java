...
public class CockpitJU_88C6NJ_RGunner extends CockpitGunner {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitJU_88C6NJ_RGunner.this.fm != null) {
                CockpitJU_88C6NJ_RGunner.this.setTmp = CockpitJU_88C6NJ_RGunner.this.setOld;
                CockpitJU_88C6NJ_RGunner.this.setOld = CockpitJU_88C6NJ_RGunner.this.setNew;
                CockpitJU_88C6NJ_RGunner.this.setNew = CockpitJU_88C6NJ_RGunner.this.setTmp;
                CockpitJU_88C6NJ_RGunner.this.setNew.throttle1 = (0.85F * CockpitJU_88C6NJ_RGunner.this.setOld.throttle1) + (CockpitJU_88C6NJ_RGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_88C6NJ_RGunner.this.setNew.prop1 = (0.85F * CockpitJU_88C6NJ_RGunner.this.setOld.prop1) + (CockpitJU_88C6NJ_RGunner.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_88C6NJ_RGunner.this.setNew.throttle2 = (0.85F * CockpitJU_88C6NJ_RGunner.this.setOld.throttle2) + (CockpitJU_88C6NJ_RGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_88C6NJ_RGunner.this.setNew.prop2 = (0.85F * CockpitJU_88C6NJ_RGunner.this.setOld.prop2) + (CockpitJU_88C6NJ_RGunner.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_88C6NJ_RGunner.this.setNew.altimeter = CockpitJU_88C6NJ_RGunner.this.fm.getAltitude();
                float f = CockpitJU_88C6NJ_RGunner.this.waypointAzimuth();
                CockpitJU_88C6NJ_RGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88C6NJ_RGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88C6NJ_RGunner.this.setOld.azimuth.getDeg(1.0F));
                CockpitJU_88C6NJ_RGunner.this.setNew.azimuth.setDeg(CockpitJU_88C6NJ_RGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88C6NJ_RGunner.this.fm.Or.azimut());
                CockpitJU_88C6NJ_RGunner.this.setNew.vspeed = ((199F * CockpitJU_88C6NJ_RGunner.this.setOld.vspeed) + CockpitJU_88C6NJ_RGunner.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88C6NJ_RGunner.this.cockpitDimControl) {
                    if (CockpitJU_88C6NJ_RGunner.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88C6NJ_RGunner.this.setNew.dimPosition = CockpitJU_88C6NJ_RGunner.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88C6NJ_RGunner.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88C6NJ_RGunner.this.setNew.dimPosition = CockpitJU_88C6NJ_RGunner.this.setOld.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88C6NJ_RGunner.this.prevFuel - CockpitJU_88C6NJ_RGunner.this.fm.M.fuel;
                CockpitJU_88C6NJ_RGunner.this.prevFuel = CockpitJU_88C6NJ_RGunner.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88C6NJ_RGunner.this.setNew.cons = (0.91F * CockpitJU_88C6NJ_RGunner.this.setOld.cons) + (0.09F * f1);
            }
            return true;
        }
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ((TypeRadarLiSN2Carrier) this.aircraft()).setCurPilot(3);
    ...
    public void clipAnglesGun(Orient orient) {
        if (this.isRealMode()) {
            if (!this.aiTurret().bIsOperable) {
                ...
                if (f < -2F) {
                    if (f1 < this.cvt(f, -6.8F, -2F, -10F, -2.99F)) {
                        f1 = this.cvt(f, -6.8F, -2F, -10F, -2.99F);
                    }
                } else if (f < 0.5F) {
                    if (f1 < this.cvt(f, -2F, 0.5F, -2.99F, -2.3F)) {
                        f1 = this.cvt(f, -2F, 0.5F, -2.99F, -2.3F);
                    }
                } else if (f < 5.3F) {
                    if (f1 < this.cvt(f, 0.5F, 5.3F, -2.3F, -2.3F)) {
                        f1 = this.cvt(f, 0.5F, 5.3F, -2.3F, -2.3F);
                    }
                } else if (f1 < this.cvt(f, 5.3F, 25F, -2.3F, -7.2F)) {
                    f1 = this.cvt(f, 5.3F, 25F, -2.3F, -7.2F);
                }
    ...
    public CockpitJU_88C6NJ_RGunner() {
...
// protected SoundFX buzzerFX;
    ...
    static {
        Property.set(CockpitJU_88C6NJ_RGunner.class, "aiTuretNum", 0);
        Property.set(CockpitJU_88C6NJ_RGunner.class, "weaponControlNum", 10);
        Property.set(CockpitJU_88C6NJ_RGunner.class, "astatePilotIndx", 1);
    }
}
