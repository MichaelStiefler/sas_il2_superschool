...
public class Wyvern extends Wyvern123 implements TypeFighter, TypeStormovik {
    ...
    static {
        Class class1 = Wyvern.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Wyvern");
        Property.set(class1, "meshName", "3DO/Plane/Wyvern/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1945F);
        Property.set(class1, "yearExpired", 1955.5F);
        Property.set(class1, "FlightModel", "FlightModels/WyvernTF4.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitWyvern.class });
        Property.set(class1, "LOSElevation", 0.7394F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 1, 1, 1, 1, 9, 9, 9, 9, 9, 9, 3, 3, 3, 3, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 9, 9, 2, 2, 2, 2, 3, 3 });
