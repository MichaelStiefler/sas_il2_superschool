...
public class SeaHawk_X extends Scheme1
    implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker
{
    ...
    public static void moveGear(HierMesh hiermesh, float f)
    {
        ...
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, 0.0F, 40F * f);
    ...
    {
        hierMesh().chunkSetAngles("VatorL_D0", 0.0F, 0.0F, -30F * paramFloat);
        hierMesh().chunkSetAngles("VatorR_D0", 0.0F, 0.0F, -30F * paramFloat);
    }

    protected void moveAileron(float paramFloat)
    {
        hierMesh().chunkSetAngles("AroneL_D0", 0.0F, 0.0F, 30F * paramFloat);
        hierMesh().chunkSetAngles("AroneR_D0", 0.0F, 0.0F, -30F * paramFloat);
    }
