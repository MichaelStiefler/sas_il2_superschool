...
public class CockpitKI_109 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        float f2 = floatindex(cvt(0.539957F * Pitot.Indicator((float)fm.Loc.z, fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), speedometerScale);
        ...
        float f3 = (Atmosphere.temperature((float)fm.Loc.z) - 273.09F) + 44.4F * fm.EI.engines[0].getPowerOutput();
        if(f3 < 0.0F)
        ...
        f3 = (Atmosphere.temperature((float)fm.Loc.z) - 273.09F) + 44.4F * fm.EI.engines[1].getPowerOutput();
        if(f3 < 0.0F)
    ...
    static 
    {
        Property.set(CockpitKI_109.class, "normZNs", new float[] {
            1.47F, 1.1F, 0.86F, 0.8F
        });
    }
