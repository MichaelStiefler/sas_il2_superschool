...
public class BattleMkII extends FaireyBattle implements TypeBomber {
    ...
    public void onAircraftLoaded() {
        ...
        if (!this.thisWeaponsName.startsWith("4x") && !this.thisWeaponsName.startsWith("6x")) this.FM.CT.bHasBayDoorControl = false;
    }
    ...
    public void typeBomberUpdate(float f) {
        ...
        d -= this.fSightCurAltitude * this.fSightCurAltitude * 0.00001419D;
    ...
    static {
        ...
        Property.set(class1, "meshName_gb", "3DO/Plane/FaireyBattle(gb)/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitBattleMkII.class, Cockpit_BombsightOPB.class, CockpitBattleMkII_TGunner.class });
        Property.set(class1, "LOSElevation", 0.7394F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 10, 9, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_ExternalDev01", "_ExternalBomb01", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06" });
    }
}
