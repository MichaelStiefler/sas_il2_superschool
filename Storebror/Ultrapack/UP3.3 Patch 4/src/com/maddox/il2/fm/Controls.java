...
//                            	if (this.WeaponControl[wctIndex]) {
                            if ((this.WeaponControl[wctIndex] || this.bombDropMode > 1 && this.bombDropMode > this.bombsDropped && this.isGroupRelease || this.bombDropMode == fullSalvo && this.isGroupRelease) && this.hasBulletsLeftOnTrigger(wctIndex)) {
                                ...
                                if (this.isGroupRelease && (!this.hasBulletsLeftOnTrigger(wctIndex) || this.bombDropMode >= singleFire && this.bombsDropped >= this.bombDropMode)) {
                                    this.resetGroupDrop();
            ...
            if (this.Weapons[i_25_] != null) {
                ...
                for (int i_27_ = 0; i_27_ < i_26_; i_27_++) {
                    ...
                    if (bulletemitter != null && !(bulletemitter instanceof FuelTankGun)) {
                        ...
                        if (i_28_ < 0) {
                            i_28_ = 1;
                            if (bulletemitter instanceof BombGun && ((BombGun) bulletemitter).isCassette()) i_28_ = 10;
                        }
