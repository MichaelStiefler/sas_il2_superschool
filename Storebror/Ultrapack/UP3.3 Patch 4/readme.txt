...
Next, Download Ultrapack 3.3 Bigfoot Patch 4, run the installer (Ultrapack 3.3 Bigfoot Patch 4.exe) and let it do it's job.
At the end, JSGME will open up and attempt to enable "#UP#_Enable_UP3.3_Patch_04".
