...
public abstract class FW_190Sea extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeStormovik, TypeBomber, TypeRocketBoost {
    ...
    public void doAttachBoosters() {
        for (int i = 0; i < 2; i++) {
            try {
                if (i == 0) {
                    this.booster[i] = new BombStarthilfeSolfuelL();
                } else {
                    this.booster[i] = new BombStarthilfeSolfuelR();
                }
    ...
    private void boostUpdate() {
        if (!(this.FM instanceof Pilot) || ((this.boostState & AircraftState._AS_BOOST_EXISTS) == 0)) {
            return;
        }
    ...
    public void setOnGround(Point3d point3d, Orient orient, Vector3d vector3d) {
        ...
        if (this.thisWeaponsName.endsWith("_boost")) {
    ...
    public void msgCollision(Actor actor, String string, String string_0_) {
        if ((!this.isNet() || !this.isNetMirror()) && !string.startsWith("Hook")) {
    ...
    public void onAircraftLoaded() {
        ...
        this.hierMesh().chunkVisible("BoosterL_D0", false);
        this.hierMesh().chunkVisible("BoosterR_D0", false);
    }
    ...
    protected void moveGear(float f) {
        FW_190Sea.moveGear(this.hierMesh(), f);
    }
    ...
    protected void moveFlap(float f) {
        this.hierMesh().chunkSetAngles("FlaperonL_D0", 0.0F, -30F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Flap01_D0", 0.0F, -55F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Flap02_D0", 0.0F, -55F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Flap03_D0", 0.0F, -55F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Flap04_D0", 0.0F, -55F * f, 0.0F);
        this.hierMesh().chunkSetAngles("FlaperonR_D0", 0.0F, 30F * f, 0.0F);
    }
    ...
    protected void hitBone(String string, Shot shot, Point3d point3d) {
        if (string.startsWith("xx")) {
            if (string.startsWith("xxarmor")) {
                ...
                if (string.startsWith("xxspart") && (this.chunkDamageVisible("Tail1") > 2) && (this.getEnergyPastArmor(2.4F / (float) Math.sqrt((Aircraft.v1.y * Aircraft.v1.y) + (Aircraft.v1.z * Aircraft.v1.z)), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** Tail1 Spars Broken in Half..");
                    this.nextDMGLevels(1, 2, "Tail1_D3", shot.initiator);
                }
                if (string.startsWith("xxsparli") && (this.chunkDamageVisible("WingLIn") > 2) && (this.getEnergyPastArmor(18F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if (string.startsWith("xxsparri") && (this.chunkDamageVisible("WingRIn") > 2) && (this.getEnergyPastArmor(18F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if (string.startsWith("xxsparlm") && (this.chunkDamageVisible("WingLMid") > 2) && (this.getEnergyPastArmor(12.7F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if (string.startsWith("xxsparrm") && (this.chunkDamageVisible("WingRMid") > 2) && (this.getEnergyPastArmor(12.7F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if (string.startsWith("xxsparlo") && (this.chunkDamageVisible("WingLOut") > 2) && (this.getEnergyPastArmor(12.7F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if (string.startsWith("xxsparro") && (this.chunkDamageVisible("WingROut") > 2) && (this.getEnergyPastArmor(12.7F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                ...
                } else if (string.endsWith("oil1") && (this.getEnergyPastArmor(2.4F, shot) > 0.0F)) {
