...
//    private static final String _VERSION                      = "4.10.1_(UP_EDITION)";
    ...
    private static final String   MAX_PATCH_LEVEL       = "1";
    private static final String   PATCH_LEVEL           = "1";
    private static final String[] PATCHLEVEL_G          = { "1" };
    private static final String[] PATCHLEVEL_Y          = { "0" };
...
//    public static final String  NET_VERSION                   = "FB_PF_v_4.10.1m_(UP_EDITION)";
    private static final String  VERSION                       = PRODUCT;
    private static final String  NET_VERSION                   = PRODUCT;
