...
public class Wind extends FMMath {
    ...
    public void getVector(Point3d point3d, Vector3d vector3d) {
        ...
        if (Engine.land().isWater(point3d.x, point3d.y)) vector3d.z += 2.119999885559082D * (point3d.z <= 250D ? point3d.z / 250D : 1.0D) * (float) Math.cos(World.getTimeofDay() * 2.0F * 3.141593F * 0.04166666F);
