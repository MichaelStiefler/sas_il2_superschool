...
public class P_51D30NA extends P_51Mustang implements TypeFighterAceMaker {
    public int     k14Mode;
    ...
    public void update(final float n) {
        ...
        if (this.FM.CT.getCockpitDoor() > 0.2 && this.bHasBlister && this.FM.getSpeedKMH() > this.fMaxKMHSpeedForOpenCanopy && this.hierMesh().chunkFindCheck("Blister1_D0") != -1) {
            try {
                if (this == World.getPlayerAircraft()) ((CockpitP_51D30K14) Main3D.cur3D().cockpitCur).removeCanopy();
            } catch (Exception ex) {}
    ...
    static {
        final Class class1 = P_51D30NA.class;
        new SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "P-51");
        Property.set(class1, "meshName", "3DO/Plane/P-51D-30NA(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_gb", "3DO/Plane/P-51D-30NA(GB)/hier.him");
        Property.set(class1, "PaintScheme_gb", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_us", "3DO/Plane/P-51D-30NA(USA)/hier.him");
        Property.set(class1, "PaintScheme_us", new PaintSchemeFMPar06());
        Property.set(class1, "noseart", 1);
        Property.set(class1, "yearService", 1944.0f);
        Property.set(class1, "yearExpired", 1947.5f);
        Property.set(class1, "FlightModel", "FlightModels/P-51D-30.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitP_51D30K14.class });
