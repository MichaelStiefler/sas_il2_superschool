...
public class CockpitLysander_3_Gunner extends CockpitGunner {
    ...
    public CockpitLysander_3_Gunner() {
        super("3DO/Cockpit/Lysander_3_Gunner/hier.him", "bf109");
    ...
    static {
        Property.set(CockpitLysander_3_Gunner.class, "aiTuretNum", 0);
        Property.set(CockpitLysander_3_Gunner.class, "weaponControlNum", 10);
        Property.set(CockpitLysander_3_Gunner.class, "astatePilotIndx", 1);
    }
}
