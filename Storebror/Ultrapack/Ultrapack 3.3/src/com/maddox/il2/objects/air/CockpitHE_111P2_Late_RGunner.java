...
public class CockpitHE_111P2_Late_RGunner extends CockpitGunner {
    ...
    public CockpitHE_111P2_Late_RGunner() {
        super("3DO/Cockpit/He-111P-4-RGun/hier-H2.him", "he111_gunner");
        this.hook1 = null;
        this.iCocking = 0;
    }
    ...
    static {
        Property.set(CockpitHE_111P2_Late_RGunner.class, "aiTuretNum", 4);
        Property.set(CockpitHE_111P2_Late_RGunner.class, "weaponControlNum", 14);
        Property.set(CockpitHE_111P2_Late_RGunner.class, "astatePilotIndx", 4);
    }
}
