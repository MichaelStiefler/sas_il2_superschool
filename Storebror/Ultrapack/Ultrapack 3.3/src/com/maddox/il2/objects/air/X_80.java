...
public abstract class X_80 extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker {
...
// this.curctl = -1.0f;
    ...
    public void update(final float f) {
        if (Config.isUSE_RENDER() && this.FM.AS.isMaster()) if (this.FM.EI.engines[0].getPowerOutput() > 0.5f && this.FM.EI.engines[0].getStage() == 6) {
