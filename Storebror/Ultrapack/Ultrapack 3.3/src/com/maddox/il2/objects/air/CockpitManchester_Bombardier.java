...
public class CockpitManchester_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitManchester_Bombardier.this.bEntered) {
                float f = ((ManchesterBombers) (Manchester_I) CockpitManchester_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((ManchesterBombers) (Manchester_I) CockpitManchester_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitManchester_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitManchester_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((ManchesterBombers) (Manchester_I) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((ManchesterBombers) (Manchester_I) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
