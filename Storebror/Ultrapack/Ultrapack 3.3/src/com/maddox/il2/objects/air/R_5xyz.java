...
public abstract class R_5xyz extends Scheme1 implements TypeScout, TypeBomber, TypeTransport, TypeStormovik {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("Gunpods")) this.strafeWithGuns = true;
    }
    ...
    protected void moveRudder(float f) {
        ...
        this.hierMesh().chunkSetAngles("Rudder1a_D0", 0.0F, -25F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Rudder1b_D0", 0.0F, -25F * f, 0.0F);
    }
    ...
    protected void moveElevator(float f) {
        ...
        this.hierMesh().chunkSetAngles("VatorLa_D0", 0.0F, f1, f3);
        this.hierMesh().chunkSetAngles("VatorLb_D0", 0.0F, f2, f4);
        this.hierMesh().chunkSetAngles("VatorR_D0", 0.0F, -30F * f, 0.0F);
        this.hierMesh().chunkSetAngles("VatorRa_D0", 0.0F, f1, f3);
        this.hierMesh().chunkSetAngles("VatorRb_D0", 0.0F, f2, f4);
    }
    ...
    public void moveWheelSink() {
        ...
        float f = 40F;
        this.hierMesh().chunkSetAngles("GearL2_D0", 0.0F, this.suspL * -12F * f, 0.0F);
        this.hierMesh().chunkSetAngles("GearL0_D0", 0.0F, this.suspL * -4F * f, 0.0F);
        this.hierMesh().chunkSetAngles("GearL3_D0", 0.0F, this.suspL * -10F * f, 0.0F);
        this.hierMesh().chunkSetAngles("GearR2_D0", 0.0F, this.suspR * -12F * f, 0.0F);
        this.hierMesh().chunkSetAngles("GearR0_D0", 0.0F, this.suspR * -4F * f, 0.0F);
        this.hierMesh().chunkSetAngles("GearR3_D0", 0.0F, this.suspR * -10F * f, 0.0F);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xpilot") || s.startsWith("xhead")) {
            ...
            if (s.startsWith("xaronel") && this.chunkDamageVisible("AroneL") < 1) this.hitChunk("AroneL1", shot);
            if (s.startsWith("xaroner") && this.chunkDamageVisible("AroneR") < 1) this.hitChunk("AroneR1", shot);
        }
    }
