    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitBarracuda.this.fm != null) {
                ...
                if (Math.abs(CockpitBarracuda.this.fm.Or.getKren()) < 30F) CockpitBarracuda.this.setNew.azimuth = (35F * CockpitBarracuda.this.setOld.azimuth + -CockpitBarracuda.this.fm.Or.getYaw()) / 36F;
                if (CockpitBarracuda.this.setOld.azimuth > 270F && CockpitBarracuda.this.setNew.azimuth < 90F) CockpitBarracuda.this.setOld.azimuth -= 360F;
                if (CockpitBarracuda.this.setOld.azimuth < 90F && CockpitBarracuda.this.setNew.azimuth > 270F) CockpitBarracuda.this.setOld.azimuth += 360F;
                CockpitBarracuda.this.setNew.waypointAzimuth = (10F * CockpitBarracuda.this.setOld.waypointAzimuth + (CockpitBarracuda.this.waypointAzimuth() - CockpitBarracuda.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
...
// mesh.chunkSetLocate("FONAR_GLASS2", Cockpit.xyz, Cockpit.ypr);
    ...
    public void reflectCockpitState() {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) != 0) {
            ...
            if (this.bFAF) this.mesh.chunkVisible("HullDamage2_FAF", true);
            else this.mesh.chunkVisible("HullDamage2_RAF", true);
    ...
    static {
        Property.set(CockpitBarracuda.class, "normZN", 0.77F);
    }
