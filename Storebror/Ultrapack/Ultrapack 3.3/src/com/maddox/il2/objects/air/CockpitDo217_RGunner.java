...
public class CockpitDo217_RGunner extends CockpitGunner {
    ...
    static {
        Property.set(CockpitDo217_RGunner.class, "aiTuretNum", 4);
        Property.set(CockpitDo217_RGunner.class, "weaponControlNum", 14);
        Property.set(CockpitDo217_RGunner.class, "astatePilotIndx", 1); // Patch Pack 107, change pilot index from "5"
