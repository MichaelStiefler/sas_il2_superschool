        ...
        public boolean tick() {
            ...
            if (CockpitJU_88A5.this.fm != null) {
                ...
                if (CockpitJU_88A5.this.cockpitDimControl) {
                    if (CockpitJU_88A5.this.setNew.dimPosition > 0.0F) CockpitJU_88A5.this.setNew.dimPosition = CockpitJU_88A5.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_88A5.this.setNew.dimPosition < 1.0F) CockpitJU_88A5.this.setNew.dimPosition = CockpitJU_88A5.this.setOld.dimPosition + 0.05F;
                ...
                if (CockpitJU_88A5.this.buzzerFX != null) if (CockpitJU_88A5.this.fm.Loc.z < ((JU_88A5) CockpitJU_88A5.this.aircraft()).fDiveRecoveryAlt && ((JU_88A5) CockpitJU_88A5.this.fm.actor).diveMechStage == 1) CockpitJU_88A5.this.buzzerFX.play();
                else if (CockpitJU_88A5.this.buzzerFX.isPlaying()) CockpitJU_88A5.this.buzzerFX.stop();
