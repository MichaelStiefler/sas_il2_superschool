...
public class CockpitHE_111P4 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            } else CockpitHE_111P4.this.setNew.waypointAzimuth.setDeg(CockpitHE_111P4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111P4.this.setOld.azimuth.getDeg(1.0F));
