...
public class CockpitHE_111H6_Early_LGunner extends CockpitGunner {
    ...
    public CockpitHE_111H6_Early_LGunner() {
        super("3DO/Cockpit/He-111P-4-LGun/hier-H6-Early.him", "he111_gunner");
        this.hook1 = null;
        this.iCocking = 0;
    }
    ...
    static {
        Property.set(CockpitHE_111H6_Early_LGunner.class, "aiTuretNum", 3);
        Property.set(CockpitHE_111H6_Early_LGunner.class, "weaponControlNum", 13);
        Property.set(CockpitHE_111H6_Early_LGunner.class, "astatePilotIndx", 4);
    }
}
