...
public abstract class B26 extends Scheme2a {
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        ...
        hiermesh.chunkSetAngles("GearC6_D0", 0.0F, Aircraft.floatindex(Aircraft.cvt(f, 0.0F, 1.0F, 0.0F, 10F), anglesc6), 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, Aircraft.cvt(f, 0.0F, 0.1F, 0.0F, -95F), 0.0F);
        hiermesh.chunkSetAngles("GearC7_D0", 0.0F, Aircraft.floatindex(Aircraft.cvt(f, 0.0F, 1.0F, 0.0F, 10F), anglesc7), 0.0F);
    ...
    protected void hitBone(String string, Shot shot, Point3d point3d) {
        if (string.startsWith("xx")) {
            if (string.startsWith("xxarmor")) {
                if (string.endsWith("p1") || string.endsWith("p2")) if (Math.abs(Aircraft.v1.x) > 0.5D) this.getEnergyPastArmor(7.94D / Math.abs(Aircraft.v1.x), shot);
                else this.getEnergyPastArmor(9.53D / (1.0D - Math.abs(Aircraft.v1.x)), shot);
                if (string.endsWith("p3")) this.getEnergyPastArmor(7.94D / (Math.abs(Aircraft.v1.z) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("p4")) this.getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("p5") || string.endsWith("p6")) this.getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.y) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("p7")) this.getEnergyPastArmor(0.5D / (Math.abs(Aircraft.v1.z) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("p8")) this.getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("a1")) this.getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.y) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("a2")) this.getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.y) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("a3")) this.getEnergyPastArmor(6.35D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("a4") || string.endsWith("a5")) this.getEnergyPastArmor(12.7D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("a6") || string.endsWith("a7")) this.getEnergyPastArmor(6.35D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("r1")) this.getEnergyPastArmor(3.17D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("r2") || string.endsWith("r3")) this.getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                if (string.endsWith("c1") || string.endsWith("c2")) this.getEnergyPastArmor(8.73D / (Math.abs(Aircraft.v1.x) + 9.9999999747524271E-007D), shot);
                ...
                int i = 0;
                if (string.startsWith("xxeng2")) i = 1;
                ...
                if (string.endsWith("prop") && this.getEnergyPastArmor(0.42F, shot) > 0.0F) this.FM.EI.engines[i].setKillPropAngleDevice(shot.initiator);
                ...
                if (World.Rnd().nextFloat() < 0.125F) this.FM.AS.setJamBullets(i_0_, i_1_);
            ...
            if (string.startsWith("xturret1")) this.FM.AS.setJamBullets(10, 0);
            if (string.endsWith("2b1")) this.FM.AS.setJamBullets(11, 0);
            if (string.endsWith("2b2")) this.FM.AS.setJamBullets(11, 1);
            if (string.endsWith("3b1")) this.FM.AS.setJamBullets(12, 0);
            if (string.endsWith("3b2")) this.FM.AS.setJamBullets(12, 1);
            if (string.endsWith("4a")) this.FM.AS.setJamBullets(13, 1);
            if (string.endsWith("5a")) this.FM.AS.setJamBullets(14, 1);
    ...
    protected void moveBayDoor(float f) {
        ...
        this.hierMesh().chunkSetAngles("Bay3_D0", 0.0F, 110F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Bay2_D0", 0.0F, 110F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Bay4_D0", 0.0F, -110F * f, 0.0F);
    }
