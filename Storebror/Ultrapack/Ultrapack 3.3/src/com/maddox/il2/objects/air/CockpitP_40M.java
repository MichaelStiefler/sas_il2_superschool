    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_40M.this.fm != null) {
                ...
                if (newOilPressure > CockpitP_40M.this.setOld.oilPressure) CockpitP_40M.this.setNew.oilPressure = ((OIL_PRESSURE_SMOOTHING_UP - 1F) * CockpitP_40M.this.setOld.oilPressure + newOilPressure) / OIL_PRESSURE_SMOOTHING_UP;
                else CockpitP_40M.this.setNew.oilPressure = ((OIL_PRESSURE_SMOOTHING_DOWN - 1F) * CockpitP_40M.this.setOld.oilPressure + newOilPressure) / OIL_PRESSURE_SMOOTHING_DOWN;
                ...
                if (newFuelPressure > CockpitP_40M.this.setOld.fuelPressure) CockpitP_40M.this.setNew.fuelPressure = ((FUEL_PRESSURE_SMOOTHING_UP - 1F) * CockpitP_40M.this.setOld.fuelPressure + newFuelPressure) / FUEL_PRESSURE_SMOOTHING_UP;
                else CockpitP_40M.this.setNew.fuelPressure = ((FUEL_PRESSURE_SMOOTHING_DOWN - 1F) * CockpitP_40M.this.setOld.fuelPressure + newFuelPressure) / FUEL_PRESSURE_SMOOTHING_DOWN;
                // TODO: --- New Oil and Fuel Pressure Calculation and Animation by
                // SAS~Storebror ---
            }
            return true;
