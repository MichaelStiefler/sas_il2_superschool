...
public class CockpitManchester_AGunner extends CockpitGunner {
    ...
    public CockpitManchester_AGunner() {
        super("3DO/Cockpit/Stirling-AGun/hier_manchester.him", "bf109");
        this.hook1 = null;
        this.hook2 = null;
        this.hook3 = null;
        this.hook4 = null;
    ...
    static {
        Property.set(CockpitManchester_AGunner.class, "aiTuretNum", 1);
        Property.set(CockpitManchester_AGunner.class, "weaponControlNum", 11);
        Property.set(CockpitManchester_AGunner.class, "astatePilotIndx", 3);
    }
}
