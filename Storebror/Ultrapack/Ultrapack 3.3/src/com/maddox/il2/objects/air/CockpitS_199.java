    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitS_199.this.cockpitDimControl) {
                if (CockpitS_199.this.setNew.dimPosition > 0.0F) CockpitS_199.this.setNew.dimPosition = CockpitS_199.this.setOld.dimPosition - 0.05F;
            } else if (CockpitS_199.this.setNew.dimPosition < 1.0F) CockpitS_199.this.setNew.dimPosition = CockpitS_199.this.setOld.dimPosition + 0.05F;
            ...
            } else CockpitS_199.this.setNew.waypointAzimuth.setDeg(CockpitS_199.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitS_199.this.setOld.azimuth.getDeg(1.0F));
