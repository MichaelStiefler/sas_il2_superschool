...
public abstract class BV_222xyz extends Scheme7 implements TypeSeaPlane, TypeTransport {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xengine5")) {
            if (this.chunkDamageVisible("Engine5") < 2) this.hitChunk("Engine5", shot);
            return;
        }
        if (s.startsWith("xengine6")) {
            if (this.chunkDamageVisible("Engine6") < 2) this.hitChunk("Engine6", shot);
            return;
        }
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, 0.0F, 90F * f1);
        hiermesh.chunkSetAngles("GearL3_D0", 0.0F, 0.0F, -90F * f1);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 0.0F, -90F * f2);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, 0.0F, 90F * f2);
    }
