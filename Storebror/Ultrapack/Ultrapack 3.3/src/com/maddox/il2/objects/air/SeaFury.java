...
public abstract class SeaFury extends Scheme1 implements TypeFighter, TypeDiveBomber {
    ...
    protected void moveWingFold(HierMesh hiermesh, float f) {
        ...
        if (bGearExtending) {
            ...
            if (f < 6.8F) hiermesh.chunkSetAngles("REF_WingRMid_D0", 0.0F, Aircraft.cvt(f, 0.01F, 6.8F, 0.0F, 45F), 0.0F);
            else hiermesh.chunkSetAngles("REF_WingRMid_D0", 0.0F, Aircraft.cvt(f, 6.8F, 9F, 45F, 50F), 0.0F);
            if (f < 7.5F) hiermesh.chunkSetAngles("REF_WingLMid_D0", 0.0F, Aircraft.cvt(f, 0.75F, 7.5F, 0.0F, 45F), 0.0F);
            else hiermesh.chunkSetAngles("REF_WingLMid_D0", 0.0F, Aircraft.cvt(f, 7.5F, 9F, 45F, 50F), 0.0F);
        } else if (f < 11F) {
