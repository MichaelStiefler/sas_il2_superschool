...
public abstract class PE_2NEW extends Scheme2a {
    ...
    protected void moveBayDoor(float f) {
        if (this.thisWeaponsName.startsWith("6fab50") || this.thisWeaponsName.startsWith("6fab100")) {
    ...
    public int   BombLoadType;

    static {
        Class class1 = PE_2NEW.class;
