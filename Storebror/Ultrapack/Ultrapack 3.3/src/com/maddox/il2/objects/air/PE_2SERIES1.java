...
public class PE_2SERIES1 extends PE_2 implements TypeBomber, TypeDiveBomber, TypeTransport {
    ...
    static {
        Class class1 = PE_2SERIES1.class;
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPE2_1.class, CockpitPE2_Bombardier.class, CockpitPE2_1_TGunner.class });
        ...
        weaponHooksRegister(class1,
                new String[] { "_CANNON01", "_CANNON02", "_MGUN01", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06" });
    }
}
