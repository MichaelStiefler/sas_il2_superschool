...
public class CockpitJU_87D3 extends CockpitPilot {
        ...
        public boolean tick() {
            ...
            if (CockpitJU_87D3.this.fm != null) {
                ...
                if (CockpitJU_87D3.this.cockpitDimControl) {
                    if (CockpitJU_87D3.this.setNew.dimPosition > 0.0F) CockpitJU_87D3.this.setNew.dimPosition = CockpitJU_87D3.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_87D3.this.setNew.dimPosition < 1.0F) CockpitJU_87D3.this.setNew.dimPosition = CockpitJU_87D3.this.setOld.dimPosition + 0.05F;
                ...
                } else CockpitJU_87D3.this.setNew.waypointAzimuth.setDeg(CockpitJU_87D3.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_87D3.this.setOld.azimuth.getDeg(1.0F));
                ...
                if (CockpitJU_87D3.this.buzzerFX != null) if (CockpitJU_87D3.this.fm.Loc.z < 750D && ((JU_87) CockpitJU_87D3.this.fm.actor).diveMechStage == 1) CockpitJU_87D3.this.buzzerFX.play();
                else if (CockpitJU_87D3.this.buzzerFX.isPlaying()) CockpitJU_87D3.this.buzzerFX.stop();
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.gun[0] == null && !this.bNeedSetUp) if (this.bG1) {
        ...
        if (this.bG1) {
            if (this.gun[0] != null) this.mesh.chunkSetAngles("Z_AmmoCounter1", this.cvt(this.gun[0].countBullets(), 0.0F, 50F, 15F, 0.0F), 0.0F, 0.0F);
            if (this.gun[1] != null) this.mesh.chunkSetAngles("Z_AmmoCounter2", this.cvt(this.gun[1].countBullets(), 0.0F, 50F, 15F, 0.0F), 0.0F, 0.0F);
        } else {
    ...
    public void reflectCockpitState() {
        ...
        if ((this.fm.AS.astateCockpitState & 1) != 0 || (this.fm.AS.astateCockpitState & 2) != 0) {
            ...
            if (this.bG1) this.mesh.chunkVisible("Z_Holes3G_D1", true);
            else this.mesh.chunkVisible("Z_Holes3D_D1", true);
        }
