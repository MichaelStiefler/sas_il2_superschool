...
public class CockpitManchesterIa_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitManchesterIa_Bombardier.this.bEntered) {
                float f = ((ManchesterBombers) (Manchester_Ia) CockpitManchesterIa_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((ManchesterBombers) (Manchester_Ia) CockpitManchesterIa_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitManchesterIa_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitManchesterIa_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitManchesterIa_Bombardier() {
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((ManchesterBombers) (Manchester_Ia) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((ManchesterBombers) (Manchester_Ia) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitManchesterIa_Bombardier.class, "astatePilotIndx", 0);
    }
