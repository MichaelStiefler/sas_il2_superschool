    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitBF_109G6.this.cockpitDimControl) {
                if (CockpitBF_109G6.this.setNew.dimPosition > 0.0F) CockpitBF_109G6.this.setNew.dimPosition = CockpitBF_109G6.this.setOld.dimPosition - 0.05F;
            } else if (CockpitBF_109G6.this.setNew.dimPosition < 1.0F) CockpitBF_109G6.this.setNew.dimPosition = CockpitBF_109G6.this.setOld.dimPosition + 0.05F;
            ...
            } else CockpitBF_109G6.this.setNew.waypointAzimuth.setDeg(CockpitBF_109G6.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBF_109G6.this.setOld.azimuth.getDeg(1.0F));
