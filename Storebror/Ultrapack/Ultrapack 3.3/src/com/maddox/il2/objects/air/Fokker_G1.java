...
public class Fokker_G1 extends Scheme3 implements TypeScout, TypeFighter, TypeStormovik {
    ...
    public void registerPit(CockpitFokker_G1 cockpitfokkerg1) {
        this.pit = cockpitfokkerg1;
    }

    public void onAircraftLoaded() {
        super.onAircraftLoaded();
        if (this.pit != null && this.thisWeaponsName.equals("4xSC50")) this.pit.setRevi();
    }
    ...
    public void msgShot(Shot shot) {
        ...
        if (shot.chunkName.startsWith("WingLIn")) {
            ...
            if (Aircraft.v1.x < 0.25D && World.Rnd().nextFloat() < 0.25F && World.Rnd().nextFloat(0.01F, 0.121F) < shot.mass) this.FM.AS.hitTank(shot.initiator, 0, (int) (1.0F + shot.mass * 26.08F));
        }
        if (shot.chunkName.startsWith("WingRIn")) {
            if (World.Rnd().nextFloat() < 0.048F) this.FM.AS.setJamBullets(0, 1);
            if (Aircraft.v1.x < 0.25D && World.Rnd().nextFloat() < 0.25F && World.Rnd().nextFloat(0.01F, 0.121F) < shot.mass) this.FM.AS.hitTank(shot.initiator, 1, (int) (1.0F + shot.mass * 26.08F));
        }
        if (shot.chunkName.startsWith("Engine1")) {
            if (World.Rnd().nextFloat(0.0F, 1.0F) < 0.5F) this.FM.AS.hitEngine(shot.initiator, 0, (int) (1.0F + shot.mass * 20.7F));
            if (World.Rnd().nextFloat() < 0.01F) this.FM.AS.hitEngine(shot.initiator, 0, 5);
        }
        if (shot.chunkName.startsWith("Engine2")) {
            if (World.Rnd().nextFloat(0.0F, 1.0F) < 0.5F) this.FM.AS.hitEngine(shot.initiator, 1, (int) (1.0F + shot.mass * 20.7F));
            if (World.Rnd().nextFloat() < 0.01F) this.FM.AS.hitEngine(shot.initiator, 1, 5);
        }
        if (shot.chunkName.startsWith("Pilot1")) {
            if (Aircraft.v1.x > -0.5D || shot.power * -Aircraft.v1.x > 12800D) {
        ...
        if (shot.chunkName.startsWith("Tail1") && World.Rnd().nextFloat() < 0.05F) this.FM.AS.hitTank(shot.initiator, 0, (int) (1.0F + shot.mass * 26.08F));
        if (shot.chunkName.startsWith("Tail2") && World.Rnd().nextFloat() < 0.05F) this.FM.AS.hitTank(shot.initiator, 1, (int) (1.0F + shot.mass * 26.08F));
        if ((this.FM.AS.astateEngineStates[0] == 4 || this.FM.AS.astateEngineStates[1] == 4) && World.Rnd().nextInt(0, 99) < 33) this.FM.setCapableOfBMP(false, shot.initiator);
        super.msgShot(shot);
    }
    ...
    private CockpitFokker_G1 pit;

    static {
        Class class1 = Fokker_G1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Fokker G1");
        Property.set(class1, "meshName", "3do/plane/Fokker-G1/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar03());
        Property.set(class1, "originCountry", PaintScheme.countryNetherlands);
        Property.set(class1, "yearService", 1941.6F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Fokker_G1.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitFokker_G1.class, CockpitFokker_G1_RGunner.class });
