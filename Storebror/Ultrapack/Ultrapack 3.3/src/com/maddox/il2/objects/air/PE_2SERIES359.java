...
public class PE_2SERIES359 extends PE_2 implements TypeBomber, TypeDiveBomber, TypeTransport {
        ...
        if (Time.current() > this.tme) {
            ...
            if (this.FM.turret.length != 0) {
                ...
                if (actor == null) this.setRadist(0);
                    ...
                    if (tmpLoc3.getPoint().x < -Math.abs(tmpLoc3.getPoint().y)) this.setRadist(1);
                    else if (tmpLoc3.getPoint().y < 0.0D) this.setRadist(2);
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPE2_359.class, CockpitPE2_Bombardier.class, CockpitPE2_359_TGunner.class });
        Property.set(class1, "LOSElevation", 0.76315F);
        weaponTriggersRegister(class1, new int[] { 0, 1, 10, 11, 12, 13, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        weaponHooksRegister(class1, new String[] { "_CANNON02", "_CANNON01", "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03",
