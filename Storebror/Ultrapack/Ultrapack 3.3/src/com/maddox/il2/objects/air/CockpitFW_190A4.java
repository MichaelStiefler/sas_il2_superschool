...
public class CockpitFW_190A4 extends CockpitPilot {
    ...
    /*
     * private static boolean mgffshown = false; private static boolean mg151shown = false; private static boolean mg17shown = false;
     */
    ...
    public void reflectWorldToInstruments(final float f_54_) {
        ...
        this.mesh.chunkSetAngles("NeedleCD",
                this.setNew.vspeed < 0.0f ? this.floatindex(this.cvt(-this.setNew.vspeed, 0.0f, 30.0f, 0.0f, 6.0f), CockpitFW_190A4.vsiNeedleScale) : -this.floatindex(this.cvt(this.setNew.vspeed, 0.0f, 30.0f, 0.0f, 6.0f), CockpitFW_190A4.vsiNeedleScale),
                0.0f, 0.0f);
        ...
        // ------------------------------------------------------------------------
        /*
         * TODO: skylla: Schusszaehler Fix: Reference: http://www.clubhyper.com/reference/fw190cockpit/ammo.html gun[0] = _MGUN01 gun[1] = _MGUN02 gun[2] = _CANNON03 gun[3] = _CANNON04 gun[4] = _CANNON01 gun[5] = _CANNON02
         */
        if (this.gun[0] != null) {
            ...
            // first try
            /*
             * That would be too easy ;) if(this.gun[0].countBullets() % 50 == 0) { if(!mg17shown) { HUD.log("MG17 bullets: " + this.gun[0].countBullets()); mg17shown = true; } } else { mg17shown = false; }
             */
        ...
        if (this.gun[4] != null) {
            ...
            /*
             * That would be too easy ;) if(this.gun[4].countBullets() % 10 == 0) { if(!mg151shown) { HUD.log("MG151 bullets: " + this.gun[4].countBullets()); mg151shown = true; } } else { mg151shown = false; }
             */
        ...
        if (this.gun[2] != null) { // 0.026 -> voll; -0.018 -> leer!!
            ...
            this.mesh.chunkSetLocate("RC_MG151_L", Cockpit.xyz, Cockpit.ypr); // MG FF\outer MG151 occupied the outer
                                                                              // ammocounters
            /*
             * That would be too easy ;) if(this.gun[2].countBullets() % 5 == 0) { if(!mgffshown) { HUD.log("MGFF bullets: " + this.gun[2].countBullets()); mgffshown = true; } } else { mgffshown = false; }
             */
        }
        if (this.gun[3] != null) {
         ...
         * Original code:
         *
         * if (this.gun[0] != null) { Cockpit.xyz[0] = this.cvt(this.gun[0].countBullets(), 0.0f, 500.0f, -0.044f, 0.0f); this.mesh.chunkSetLocate("RC_MG17_L", Cockpit.xyz, Cockpit.ypr); this.mesh.chunkVisible("XLampMG17_1", !this.gun[0].haveBullets()); }
         * if (this.gun[1] != null) { Cockpit.xyz[0] = this.cvt(this.gun[1].countBullets(), 0.0f, 500.0f, -0.044f, 0.0f); this.mesh.chunkSetLocate("RC_MG17_R", Cockpit.xyz, Cockpit.ypr); this.mesh.chunkVisible("XLampMG17_2", !this.gun[1].haveBullets()); }
         * if (this.gun[4] != null) { Cockpit.xyz[0] = this.cvt(this.gun[4].countBullets(), 0.0f, 200.0f, -0.017f, 0.0f); this.mesh.chunkSetLocate("RC_MG151_L", Cockpit.xyz, Cockpit.ypr); } if (this.gun[5] != null) { Cockpit.xyz[0] =
         * this.cvt(this.gun[5].countBullets(), 0.0f, 200.0f, -0.017f, 0.0f); this.mesh.chunkSetLocate("RC_MG151_R", Cockpit.xyz, Cockpit.ypr); } if (this.gun[2] != null) { Cockpit.xyz[0] = this.cvt(this.gun[2].countBullets(), 0.0f, 55.0f, -0.018f, 0.0f);
         * this.mesh.chunkSetLocate("RC_MGFF_WingL", Cockpit.xyz, Cockpit.ypr); } if (this.gun[3] != null) { Cockpit.xyz[0] = this.cvt(this.gun[3].countBullets(), 0.0f, 55.0f, -0.018f, 0.0f); this.mesh.chunkSetLocate("RC_MGFF_WingR", Cockpit.xyz,
         * Cockpit.ypr); }
         */
        // ------------------------------------------------------------------------
    ...
    class Interpolater extends InterpolateRef {
        public boolean tick() {
            if (CockpitFW_190A4.this.fm != null) {
                ...
                } else CockpitFW_190A4.this.setNew.waypointAzimuth.setDeg(CockpitFW_190A4.this.setOld.waypointAzimuth.getDeg(0.1f), waypointAzimuth - CockpitFW_190A4.this.setOld.azimuth.getDeg(1.0f));
