...
public class B25A_Late extends B_25 implements TypeBomber {
    ...
    protected void nextDMGLevel(String string, int i, Actor actor) {
        ...
        if (this.FM.isPlayers()) B25A_Late.bChangedPit = true;
    }
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) this.fSightCurReadyness += 0.0333333F * f;
            ...
            if (this.fSightCurDistance < B25A_Late.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(B25A_Late.toMeters(this.fSightCurAltitude) * (2F / 9.81F))) this.bSightBombDump = true;
    ...
    static {
        Class class1 = B25A_Late.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "B-25");
        Property.set(class1, "meshName", "3DO/Plane/B-25ALate(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "meshName_us", "3DO/Plane/B-25ALate(USA)/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitB25A_Late.class, CockpitB25A_Late_Bombardier.class, CockpitB25A_Late_FGunner.class });
        Property.set(class1, "LOSElevation", 0.73425F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN02", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03" });
    }
}
