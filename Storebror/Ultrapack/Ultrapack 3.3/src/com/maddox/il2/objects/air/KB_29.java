...
public abstract class KB_29 extends Scheme4 implements TypeTransport {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        } else if (!s.startsWith("xturret") && (s.startsWith("xpilot") || s.startsWith("xhead"))) {
            byte byte0 = 0;
            int i1;
            if (s.endsWith("a")) {
                byte0 = 1;
    ...
    public void moveWheelSink() {
        this.resetYPRmodifier();
        Aircraft.xyz[1] = Aircraft.cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.325F, 0.0F, 0.325F);
        this.hierMesh().chunkSetLocate("GearC3_D0", Aircraft.xyz, Aircraft.ypr);
        this.resetYPRmodifier();
        Aircraft.xyz[0] = Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.325F, 0.0F, -0.325F);
        this.hierMesh().chunkSetLocate("GearL3_D0", Aircraft.xyz, Aircraft.ypr);
        this.resetYPRmodifier();
        Aircraft.xyz[0] = Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.325F, 0.0F, -0.325F);
