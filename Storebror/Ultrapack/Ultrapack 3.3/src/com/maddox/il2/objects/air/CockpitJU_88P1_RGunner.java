...
public class CockpitJU_88P1_RGunner extends CockpitGunner {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (JU_88P1.bChangedPit) {
                CockpitJU_88P1_RGunner.this.reflectPlaneToModel();
                JU_88P1.bChangedPit = false;
            }
            if (CockpitJU_88P1_RGunner.this.fm != null) {
                CockpitJU_88P1_RGunner.this.setTmp = CockpitJU_88P1_RGunner.this.setOld;
                CockpitJU_88P1_RGunner.this.setOld = CockpitJU_88P1_RGunner.this.setNew;
                CockpitJU_88P1_RGunner.this.setNew = CockpitJU_88P1_RGunner.this.setTmp;
                CockpitJU_88P1_RGunner.this.setNew.throttle1 = 0.85F * CockpitJU_88P1_RGunner.this.setOld.throttle1 + CockpitJU_88P1_RGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
                CockpitJU_88P1_RGunner.this.setNew.prop1 = 0.85F * CockpitJU_88P1_RGunner.this.setOld.prop1 + CockpitJU_88P1_RGunner.this.fm.EI.engines[0].getControlProp() * 0.15F;
                CockpitJU_88P1_RGunner.this.setNew.throttle2 = 0.85F * CockpitJU_88P1_RGunner.this.setOld.throttle2 + CockpitJU_88P1_RGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
                CockpitJU_88P1_RGunner.this.setNew.prop2 = 0.85F * CockpitJU_88P1_RGunner.this.setOld.prop2 + CockpitJU_88P1_RGunner.this.fm.EI.engines[1].getControlProp() * 0.15F;
                CockpitJU_88P1_RGunner.this.setNew.altimeter = CockpitJU_88P1_RGunner.this.fm.getAltitude();
                float f = CockpitJU_88P1_RGunner.this.waypointAzimuth();
                CockpitJU_88P1_RGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88P1_RGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88P1_RGunner.this.setOld.azimuth.getDeg(1.0F));
                CockpitJU_88P1_RGunner.this.setNew.azimuth.setDeg(CockpitJU_88P1_RGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88P1_RGunner.this.fm.Or.azimut());
                CockpitJU_88P1_RGunner.this.setNew.vspeed = (199F * CockpitJU_88P1_RGunner.this.setOld.vspeed + CockpitJU_88P1_RGunner.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88P1_RGunner.this.cockpitDimControl) {
                    if (CockpitJU_88P1_RGunner.this.setNew.dimPosition > 0.0F) CockpitJU_88P1_RGunner.this.setNew.dimPosition = CockpitJU_88P1_RGunner.this.setNew.dimPosition - 0.05F;
                } else if (CockpitJU_88P1_RGunner.this.setNew.dimPosition < 1.0F) CockpitJU_88P1_RGunner.this.setNew.dimPosition = CockpitJU_88P1_RGunner.this.setNew.dimPosition + 0.05F;
                float f1 = CockpitJU_88P1_RGunner.this.prevFuel - CockpitJU_88P1_RGunner.this.fm.M.fuel;
                CockpitJU_88P1_RGunner.this.prevFuel = CockpitJU_88P1_RGunner.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88P1_RGunner.this.setNew.cons = 0.91F * CockpitJU_88P1_RGunner.this.setOld.cons + 0.09F * f1;
            }
            return true;
        }
    ...
    public CockpitJU_88P1_RGunner() {
        super("3DO/Cockpit/Ju-88A-4Late-TGun/hier-RGun-P1.him", "he111");
        this.hook1 = null;
        ...
        this.pictManf2 = 1.0F;
        this.prevFuel = 0.0F;
        this.cockpitNightMats = new String[] { "88a4_I_Set1", "88a4_I_Set2", "88a4_I_Set3", "88a4_I_Set4", "88a4_I_Set5", "88a4_I_Set6", "88a4_SlidingGlass", "88gardinen", "Peil1", "Peil2", "Pedal", "skala" };
    ...
    static {
        Property.set(CockpitJU_88P1_RGunner.class, "aiTuretNum", 1);
        Property.set(CockpitJU_88P1_RGunner.class, "weaponControlNum", 11);
        Property.set(CockpitJU_88P1_RGunner.class, "astatePilotIndx", 1);
        Property.set(CockpitJU_88P1_RGunner.class, "normZN", 0.75F);
        Property.set(CockpitJU_88P1_RGunner.class, "gsZN", 0.75F);
    }
}
