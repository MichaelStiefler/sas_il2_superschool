...
public class BombletFireNapalm2 extends Bomb {

    public void start() {
        super.start();
        if (Config.isUSE_RENDER()) {
            Eff3DActor.New(this, null, new Loc(), 1.0F, "3DO/Effects/Fireworks/NapalmFire2.eff", 10F);
            Eff3DActor.New(this, null, new Loc(), 1.0F, "3DO/Effects/Explodes/NapalmSmoke.eff", 10F);
        }
    }
    ...
    public void msgCollision(Actor actor, String s, String s1) {
        ...
        if (actor != null) {
            ...
            if (Config.isUSE_RENDER()) {
                Eff3DActor.New(loc, World.Rnd().nextFloat(0.5F, 4.0F), "3DO/Effects/Fireworks/NapalmFire2.eff", 10F);
                Eff3DActor.New(loc, World.Rnd().nextFloat(0.5F, 4.0F), "3DO/Effects/Explodes/NapalmSmoke.eff", 10F);
            }
    ...
    static {
        Class class1 = BombletFireNapalm2.class;
