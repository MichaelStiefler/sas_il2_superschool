...
public class F_86D extends Scheme1 implements TypeSupersonic, TypeBNZFighter, TypeFighterAceMaker, TypeFighter, TypeGSuit {
    private class _cls0 {
        ...
        public void rs(int ii) {
            if (ii == 0 || ii == 1) access$234(F_86D.this, 0.68);
            if (ii == 31 || ii == 32) access$334(F_86D.this, 0.68);
            if (ii == 15 || ii == 16) access$434(F_86D.this, 0.68);
        }

        private void $1() {
            if (F_86D.this.ts) {
                float f1 = Aircraft.cvt(F_86D.this.FM.getAltitude(), this.lal, this.tal, this.bef, this.tef);
                float f2 = Aircraft.cvt(F_86D.this.mn, F_86D.this.mn < F_86D.mteb ? F_86D.lteb : F_86D.uteb, F_86D.this.mn < F_86D.mteb ? F_86D.uteb : F_86D.lteb, F_86D.this.mn < F_86D.mteb ? this.bhef : this.thef,
                        F_86D.this.mn < F_86D.mteb ? this.thef : this.phef);
                ...
                if (f2 > 0.6F) F_86D.this.ictl = true;
                else F_86D.this.ictl = false;
                if (this.ftl > 0.0F) {
                    if (World.Rnd().nextFloat() > 0.6F) if (F_86D.this.FM.CT.RudderControl > 0.0F) F_86D.this.FM.CT.RudderControl -= this.ftl * f2;
                    else if (F_86D.this.FM.CT.RudderControl < 0.0F) F_86D.this.FM.CT.RudderControl += this.ftl * f2;
                    else {
                    ...
                    if (F_86D.this.FM.CT.RudderControl > 1.0F) F_86D.this.FM.CT.RudderControl = 1.0F;
                    if (F_86D.this.FM.CT.RudderControl < -1.0F) F_86D.this.FM.CT.RudderControl = -1.0F;
                }
            } else {
