    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                else if (s.endsWith("p9")) this.getEnergyPastArmor(16.87D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                return;
            }
                ...
                switch (j) {
                    ...
                    case 10:
                        ...
                        if (this.getEnergyPastArmor(2.2F, shot) > 0.0F) {
                            if (World.Rnd().nextFloat() < 0.25F) this.FM.AS.setEngineSpecificDamage(shot.initiator, i, 1);
                            if (World.Rnd().nextFloat() < 0.25F) this.FM.AS.setEngineSpecificDamage(shot.initiator, i, 6);
                            if (World.Rnd().nextFloat() < 0.25F) this.FM.AS.setEngineSpecificDamage(shot.initiator, i, 7);
                        }
            ...
            if (s.startsWith("xxactu0")) {
                ...
                if (this.getEnergyPastArmor(6.3F, shot) > 0.0F && this.FM.AS.isMaster()) this.FM.turret[i1].bIsOperable = false;
                return;
            }
        }
        if (s.startsWith("xcf")) {
