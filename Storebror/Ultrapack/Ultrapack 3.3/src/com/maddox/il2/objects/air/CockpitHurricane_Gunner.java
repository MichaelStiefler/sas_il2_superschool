...
public class CockpitHurricane_Gunner extends CockpitGunner {
    ...
    static {
        Property.set(CockpitHurricane_Gunner.class, "aiTuretNum", 0);
        Property.set(CockpitHurricane_Gunner.class, "weaponControlNum", 10);
        Property.set(CockpitHurricane_Gunner.class, "astatePilotIndx", 1);
    }
}
