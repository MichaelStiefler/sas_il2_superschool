    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.endsWith("p1")) this.getEnergyPastArmor(World.Rnd().nextFloat(0.0F, 45.2F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                ...
                } else if (s.endsWith("p5")) this.getEnergyPastArmor(10.1D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("p6")) this.getEnergyPastArmor(12D + World.Rnd().nextFloat(10F, 30F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("p7")) this.getEnergyPastArmor(8.08D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("p8")) {
                    this.getEnergyPastArmor(1.01D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    if (shot.powerType == 3) shot.powerType = 0;
                } else if (s.endsWith("p9")) this.getEnergyPastArmor(5.05D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("p10")) this.getEnergyPastArmor(9.09D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("p11")) {
                    this.getEnergyPastArmor(64.64D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    if (shot.power <= 0.0F) this.doRicochetBack(shot);
                } else if (s.startsWith("xxarmore")) this.getEnergyPastArmor(5.05D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.startsWith("xxarmorw")) this.getEnergyPastArmor(5.05D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
                return;
            }
