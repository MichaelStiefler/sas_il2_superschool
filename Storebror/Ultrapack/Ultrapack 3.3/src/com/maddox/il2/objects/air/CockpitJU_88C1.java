        ...
        public boolean tick() {
            ...
            if (CockpitJU_88C1.this.fm != null) {
                ...
                if (CockpitJU_88C1.this.cockpitDimControl) {
                    if (CockpitJU_88C1.this.setNew.dimPosition > 0.0F) CockpitJU_88C1.this.setNew.dimPosition = CockpitJU_88C1.this.setNew.dimPosition - 0.05F;
                } else if (CockpitJU_88C1.this.setNew.dimPosition < 1.0F) CockpitJU_88C1.this.setNew.dimPosition = CockpitJU_88C1.this.setNew.dimPosition + 0.05F;
