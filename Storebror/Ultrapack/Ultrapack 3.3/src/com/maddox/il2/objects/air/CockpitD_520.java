...
public class CockpitD_520 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitD_520.this.fm.CT.GearControl == 1.0F) {
                if (CockpitD_520.this.setNew.stbyPosition1 > 0.0F) CockpitD_520.this.setNew.stbyPosition1 = CockpitD_520.this.setOld.stbyPosition1 - 0.5F;
            } else if (CockpitD_520.this.setNew.stbyPosition1 < 1.0F) CockpitD_520.this.setNew.stbyPosition1 = CockpitD_520.this.setOld.stbyPosition1 + 0.5F;
            if (!CockpitD_520.this.cockpitLightControl) {
                if (CockpitD_520.this.setNew.stbyPosition2 > 0.0F) CockpitD_520.this.setNew.stbyPosition2 = CockpitD_520.this.setOld.stbyPosition2 - 0.05F;
            } else if (CockpitD_520.this.setNew.stbyPosition2 < 1.0F) CockpitD_520.this.setNew.stbyPosition2 = CockpitD_520.this.setOld.stbyPosition2 + 0.05F;
            if (!CockpitD_520.this.fm.AS.bNavLightsOn) {
                if (CockpitD_520.this.setNew.stbyPosition3 > 0.0F) CockpitD_520.this.setNew.stbyPosition3 = CockpitD_520.this.setOld.stbyPosition3 - 0.5F;
            } else if (CockpitD_520.this.setNew.stbyPosition3 < 1.0F) CockpitD_520.this.setNew.stbyPosition3 = CockpitD_520.this.setOld.stbyPosition3 + 0.5F;
            if (!CockpitD_520.this.fm.AS.bLandingLightOn) {
                if (CockpitD_520.this.setNew.stbyPosition4 > 0.0F) CockpitD_520.this.setNew.stbyPosition4 = CockpitD_520.this.setOld.stbyPosition4 - 0.5F;
            } else if (CockpitD_520.this.setNew.stbyPosition4 < 1.0F) CockpitD_520.this.setNew.stbyPosition4 = CockpitD_520.this.setOld.stbyPosition4 + 0.5F;
            if (!CockpitD_520.this.fm.CT.getStepControlAuto()) {
                if (CockpitD_520.this.setNew.stbyPosition5 > 0.0F) CockpitD_520.this.setNew.stbyPosition5 = CockpitD_520.this.setOld.stbyPosition5 - 0.2F;
            } else if (CockpitD_520.this.setNew.stbyPosition5 < 1.0F) CockpitD_520.this.setNew.stbyPosition5 = CockpitD_520.this.setOld.stbyPosition5 + 0.2F;
            if (CockpitD_520.this.fm.CT.BayDoorControl == 0.0F) {
                if (CockpitD_520.this.setNew.stbyPosition8 > 0.0F) CockpitD_520.this.setNew.stbyPosition8 = CockpitD_520.this.setOld.stbyPosition8 - 0.5F;
            } else if (CockpitD_520.this.setNew.stbyPosition8 < 1.0F) CockpitD_520.this.setNew.stbyPosition8 = CockpitD_520.this.setOld.stbyPosition8 + 0.5F;
            if (!CockpitD_520.this.fm.CT.WeaponControl[0] && !CockpitD_520.this.fm.CT.WeaponControl[1]) {
                if (CockpitD_520.this.setNew.stbyPosition12 > 0.0F) CockpitD_520.this.setNew.stbyPosition12 = CockpitD_520.this.setOld.stbyPosition12 - 0.5F;
            } else if (CockpitD_520.this.setNew.stbyPosition12 < 1.0F) CockpitD_520.this.setNew.stbyPosition12 = CockpitD_520.this.setOld.stbyPosition12 + 0.5F;
            if (CockpitD_520.this.fm.CT.GearControl == 0.0F) {
                if (CockpitD_520.this.setNew.stbyPosition13 > 0.0F) CockpitD_520.this.setNew.stbyPosition13 = CockpitD_520.this.setOld.stbyPosition13 - 0.05F;
            } else if (CockpitD_520.this.setNew.stbyPosition13 < 1.0F) CockpitD_520.this.setNew.stbyPosition13 = CockpitD_520.this.setOld.stbyPosition13 + 0.05F;
            if (CockpitD_520.this.fm.CT.FlapsControl <= 0.1F || CockpitD_520.this.fm.CT.FlapsControl == 1.0F) {
                if (CockpitD_520.this.setNew.stbyPosition14 > 0.0F) CockpitD_520.this.setNew.stbyPosition14 = CockpitD_520.this.setOld.stbyPosition14 - 0.05F;
            } else if (CockpitD_520.this.setNew.stbyPosition14 < 1.0F) CockpitD_520.this.setNew.stbyPosition14 = CockpitD_520.this.setOld.stbyPosition14 + 0.05F;
            if (CockpitD_520.this.fm.CT.getGear() > 0.1F && CockpitD_520.this.fm.CT.getGear() < 0.9F) {
                if (CockpitD_520.this.setNew.stbyPosition15 > 0.0F) CockpitD_520.this.setNew.stbyPosition15 = CockpitD_520.this.setOld.stbyPosition15 - 0.05F;
            } else if (CockpitD_520.this.setNew.stbyPosition15 < 1.0F) CockpitD_520.this.setNew.stbyPosition15 = CockpitD_520.this.setOld.stbyPosition15 + 0.05F;
            if (!CockpitD_520.this.CompresseOk) {
                if (CockpitD_520.this.setNew.stbyPosition35 > 0.0F) CockpitD_520.this.setNew.stbyPosition35 = CockpitD_520.this.setOld.stbyPosition35 - 0.005F;
            } else if (CockpitD_520.this.setNew.stbyPosition35 < 1.0F) CockpitD_520.this.setNew.stbyPosition35 = CockpitD_520.this.setOld.stbyPosition35 + 0.005F;
            if (!CockpitD_520.this.CompresseOk) {
                if (CockpitD_520.this.setNew.stbyPosition36 > 0.0F) CockpitD_520.this.setNew.stbyPosition36 = CockpitD_520.this.setOld.stbyPosition36 - 0.005F;
            } else if (CockpitD_520.this.setNew.stbyPosition36 < 1.0F) CockpitD_520.this.setNew.stbyPosition36 = CockpitD_520.this.setOld.stbyPosition36 + 0.005F;
            if (!CockpitD_520.this.StarterState2) {
                if (CockpitD_520.this.setNew.stbyPosition50 > 0.0F) CockpitD_520.this.setNew.stbyPosition50 = CockpitD_520.this.setOld.stbyPosition50 - 0.1F;
            } else if (CockpitD_520.this.setNew.stbyPosition50 < 1.0F) CockpitD_520.this.setNew.stbyPosition50 = CockpitD_520.this.setOld.stbyPosition50 + 0.1F;
            if (!CockpitD_520.this.StarterState1) {
                if (CockpitD_520.this.setNew.stbyPosition51 > 0.0F) CockpitD_520.this.setNew.stbyPosition51 = CockpitD_520.this.setOld.stbyPosition51 - 0.1F;
            } else if (CockpitD_520.this.setNew.stbyPosition51 < 1.0F) CockpitD_520.this.setNew.stbyPosition51 = CockpitD_520.this.setOld.stbyPosition51 + 0.1F;
            if (CockpitD_520.this.fm.EI.isSelectionHasControlExtinguisher()) {
                if (CockpitD_520.this.setNew.stbyPosition59 > 0.0F) CockpitD_520.this.setNew.stbyPosition59 = CockpitD_520.this.setOld.stbyPosition59 - 0.1F;
            } else if (CockpitD_520.this.setNew.stbyPosition59 < 1.0F) CockpitD_520.this.setNew.stbyPosition59 = CockpitD_520.this.setOld.stbyPosition59 + 0.1F;
            if (!CockpitD_520.this.cockpitDimControl) {
                if (CockpitD_520.this.setNew.dimPosition > 0.0F) CockpitD_520.this.setNew.dimPosition = CockpitD_520.this.setOld.dimPosition - 0.05F;
            } else if (CockpitD_520.this.setNew.dimPosition < 1.0F) CockpitD_520.this.setNew.dimPosition = CockpitD_520.this.setOld.dimPosition + 0.05F;
            ...
            CockpitD_520.this.setNew.azimuth = CockpitD_520.this.fm.Or.getYaw();
            if (CockpitD_520.this.setOld.azimuth > 270F && CockpitD_520.this.setNew.azimuth < 90F) CockpitD_520.this.setOld.azimuth -= 360F;
            if (CockpitD_520.this.setOld.azimuth < 90F && CockpitD_520.this.setNew.azimuth > 270F) CockpitD_520.this.setOld.azimuth += 360F;
            CockpitD_520.this.setNew.waypointAzimuth = (10F * CockpitD_520.this.setOld.waypointAzimuth + (CockpitD_520.this.waypointAzimuth() - CockpitD_520.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
    ...
    protected void doFocusLeave() {
        ...
        if (!((D_520) this.aircraft()).CockpitDamaged2 && !((D_520) this.aircraft()).CanopyEjectState) this.aircraft().hierMesh().chunkVisible("Blister1_D0", true);
        else this.aircraft().hierMesh().chunkVisible("Blister1_D0", false);
        if (((D_520) this.aircraft()).CockpitDamaged2 && !((D_520) this.aircraft()).CanopyEjectState) this.aircraft().hierMesh().chunkVisible("Blister1_D1", true);
    ...
    public CockpitD_520() {
        super("3DO/Cockpit/D-520/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (!((D_520) this.aircraft()).CockpitDamaged5) this.mesh.chunkSetAngles("Z_GTeintee", 0.0F, this.cvt(this.interp(this.setNew.dimPosition, this.setOld.dimPosition, f), 0.0F, 1.0F, 0.0F, 87F), 0.0F);
        ...
        if (this.fm.CT.getCockpitDoor() == 0.0F && !((D_520) this.aircraft()).CanopyEjectState) this.mesh.chunkVisible("Top4", true);
...
//        }
    ...
    public void reflectCockpitState() {
        if (((D_520) this.aircraft()).CockpitDamaged2 || (this.fm.AS.astateCockpitState & 0x20) != 0) this.mesh.chunkVisible("Z_Holes3", true);
        if ((this.fm.AS.astateCockpitState & 2) != 0) {
            this.mesh.chunkVisible("Z_Holes1", true);
            this.mesh.chunkVisible("Z_Z_RETICLE", false);
            this.mesh.chunkVisible("Z_Z_MASK", false);
        }
        if (((D_520) this.aircraft()).CockpitDamaged1 || (this.fm.AS.astateCockpitState & 1) != 0) this.mesh.chunkVisible("Z_Holes1", true);
        if (((D_520) this.aircraft()).CockpitDamaged3) this.mesh.chunkVisible("Z_Holes2", true);
        ...
        if (((D_520) this.aircraft()).OilHit) this.mesh.chunkVisible("Z_OilSplats", true);
    }
