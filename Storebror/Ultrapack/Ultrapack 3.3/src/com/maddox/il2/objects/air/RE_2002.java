...
public class RE_2002 extends RE_2002xyz implements TypeDiveBomber {
    ...
    public void moveCockpitDoor(float f) {
        if (f > this.canopyF) {
            ...
            this.hierMesh().chunkSetAngles("Blister1_D0", 0.0F, 100F * f, 0.0F);
            if (this.FM.getSpeed() > 50F && f < 0.6F && !this.blisterRemoved) this.doRemoveBlister1();
    ...
    static {
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 3, 3, 3, 3, 3, 9 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalTorp01", "_ExternalDev01" });
    }
}
