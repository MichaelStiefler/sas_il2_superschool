...
public class BEAUMKI extends BEAU implements TypeFighter, TypeStormovik {

    public BEAUMKI() {
    }

    static {
        Class class1 = BEAUMKI.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Beaufighter");
        Property.set(class1, "meshName", "3DO/Plane/BeaufighterMk1(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "meshName_gb", "3DO/Plane/BeaufighterMk1(GB)/hier.him");
