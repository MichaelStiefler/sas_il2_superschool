...
public abstract class KI_84 extends Scheme1 implements TypeFighter {
    ...
    public void moveWheelSink() {
        this.resetYPRmodifier();
        float f = Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.51F, 0.0F, 0.24F);
        Aircraft.xyz[1] = f;
        this.hierMesh().chunkSetLocate("GearL3_D0", Aircraft.xyz, Aircraft.ypr);
        f = Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.51F, 0.0F, 0.24F);
        Aircraft.xyz[1] = f;
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                if (s.endsWith("p1") || s.endsWith("p2")) this.getEnergyPastArmor(13.13D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
            ...
            if (s.startsWith("xxlock")) {
                ...
                if (s.startsWith("xxlockf")) this.getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 3F), shot);
                return;
            }
