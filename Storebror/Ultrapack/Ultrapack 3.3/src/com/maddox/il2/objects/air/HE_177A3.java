...
public class HE_177A3 extends HE_177_TD implements TypeX4Carrier, TypeGuidedBombCarrier, TypeHasToKG {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("A5_1") || this.thisWeaponsName.startsWith("A5_3") || this.thisWeaponsName.startsWith("A5_4")) if (this.thisWeaponsName.indexOf("293") != -1) this.hierMesh().chunkVisible("PylonHs293C", true);
        ...
        if (this.thisWeaponsName.startsWith("A5_2") || this.thisWeaponsName.startsWith("A5_3")) if (this.thisWeaponsName.indexOf("293") != -1) {
