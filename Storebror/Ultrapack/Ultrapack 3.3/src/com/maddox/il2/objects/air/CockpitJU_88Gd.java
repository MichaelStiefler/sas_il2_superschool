        ...
        public boolean tick() {
            ...
            if (CockpitJU_88Gd.this.fm != null) {
                ...
                if (CockpitJU_88Gd.this.cockpitDimControl) {
                    if (CockpitJU_88Gd.this.setNew.dimPosition > 0.0F) CockpitJU_88Gd.this.setNew.dimPosition = CockpitJU_88Gd.this.setNew.dimPosition - 0.05F;
                } else if (CockpitJU_88Gd.this.setNew.dimPosition < 1.0F) CockpitJU_88Gd.this.setNew.dimPosition = CockpitJU_88Gd.this.setNew.dimPosition + 0.05F;
