...
public class CockpitG3M2_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitG3M2_Bombardier.this.bEntered) {
                float f = ((G3M) CockpitG3M2_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((G3M) CockpitG3M2_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitG3M2_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(-f1, CockpitG3M2_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitG3M2_Bombardier() {
        super("3DO/Cockpit/D3A1-Bombardier/hierG3M2.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((G3M) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((G3M) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitG3M2_Bombardier.class, "astatePilotIndx", 0);
        Property.set(CockpitG3M2_Bombardier.class, "normZN", 0.5F);
        Property.set(CockpitG3M2_Bombardier.class, "gsZN", 0.5F);
    }
}
