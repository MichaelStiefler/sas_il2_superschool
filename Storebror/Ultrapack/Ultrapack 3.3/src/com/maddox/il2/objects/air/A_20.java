    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            ...
            if (s.startsWith("xxarmor")) {
                ...
                if (s.endsWith("p4")) this.getEnergyPastArmor(12.7D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("p5")) this.getEnergyPastArmor(12.7D / (Math.abs(v1.z) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("p6")) this.getEnergyPastArmor(4.1D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
