...
public class CockpitJU_188_Bombardier extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            float f = ((JU_188beta) CockpitJU_188_Bombardier.this.aircraft()).fSightCurForwardAngle;
            float f1 = ((JU_188beta) CockpitJU_188_Bombardier.this.aircraft()).fSightCurSideslip;
            if (JU_188beta.bChangedPit) {
                CockpitJU_188_Bombardier.this.reflectPlaneToModel();
                JU_188beta.bChangedPit = false;
            }
            CockpitJU_188_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
            if (CockpitJU_188_Bombardier.this.bEntered) {
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(CockpitJU_188_Bombardier.this.aAim + 10F * f1, CockpitJU_188_Bombardier.this.tAim + f, 0.0F);
            }
            if (CockpitJU_188_Bombardier.this.fm != null) {
                CockpitJU_188_Bombardier.this.setTmp = CockpitJU_188_Bombardier.this.setOld;
                CockpitJU_188_Bombardier.this.setOld = CockpitJU_188_Bombardier.this.setNew;
                CockpitJU_188_Bombardier.this.setNew = CockpitJU_188_Bombardier.this.setTmp;
                CockpitJU_188_Bombardier.this.setNew.throttle1 = 0.85F * CockpitJU_188_Bombardier.this.setOld.throttle1 + CockpitJU_188_Bombardier.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
                CockpitJU_188_Bombardier.this.setNew.prop1 = 0.85F * CockpitJU_188_Bombardier.this.setOld.prop1 + CockpitJU_188_Bombardier.this.fm.EI.engines[0].getControlProp() * 0.15F;
                CockpitJU_188_Bombardier.this.setNew.throttle2 = 0.85F * CockpitJU_188_Bombardier.this.setOld.throttle2 + CockpitJU_188_Bombardier.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
                CockpitJU_188_Bombardier.this.setNew.prop2 = 0.85F * CockpitJU_188_Bombardier.this.setOld.prop2 + CockpitJU_188_Bombardier.this.fm.EI.engines[1].getControlProp() * 0.15F;
                CockpitJU_188_Bombardier.this.setNew.altimeter = CockpitJU_188_Bombardier.this.fm.getAltitude();
                float f2 = CockpitJU_188_Bombardier.this.waypointAzimuth();
                if (CockpitJU_188_Bombardier.this.useRealisticNavigationInstruments()) {
                    CockpitJU_188_Bombardier.this.setNew.waypointAzimuth.setDeg(f2 - 90F);
                    CockpitJU_188_Bombardier.this.setOld.waypointAzimuth.setDeg(f2 - 90F);
                    CockpitJU_188_Bombardier.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_188_Bombardier.this.setOld.radioCompassAzimuth.getDeg(0.02F),
                            CockpitJU_188_Bombardier.this.radioCompassAzimuthInvertMinus() - CockpitJU_188_Bombardier.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else CockpitJU_188_Bombardier.this.setNew.waypointAzimuth.setDeg(CockpitJU_188_Bombardier.this.setOld.waypointAzimuth.getDeg(0.1F), f2 - CockpitJU_188_Bombardier.this.setOld.azimuth.getDeg(1.0F));
                CockpitJU_188_Bombardier.this.setNew.azimuth.setDeg(CockpitJU_188_Bombardier.this.setOld.azimuth.getDeg(1.0F), CockpitJU_188_Bombardier.this.fm.Or.azimut());
                CockpitJU_188_Bombardier.this.setNew.vspeed = (199F * CockpitJU_188_Bombardier.this.setOld.vspeed + CockpitJU_188_Bombardier.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_188_Bombardier.this.cockpitDimControl) {
                    if (CockpitJU_188_Bombardier.this.setNew.dimPosition > 0.0F) CockpitJU_188_Bombardier.this.setNew.dimPosition = CockpitJU_188_Bombardier.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_188_Bombardier.this.setNew.dimPosition < 1.0F) CockpitJU_188_Bombardier.this.setNew.dimPosition = CockpitJU_188_Bombardier.this.setOld.dimPosition + 0.05F;
                float f3 = CockpitJU_188_Bombardier.this.prevFuel - CockpitJU_188_Bombardier.this.fm.M.fuel;
                CockpitJU_188_Bombardier.this.prevFuel = CockpitJU_188_Bombardier.this.fm.M.fuel;
                f3 /= 0.72F;
                f3 /= Time.tickLenFs();
                f3 *= 3600F;
                CockpitJU_188_Bombardier.this.setNew.cons = 0.91F * CockpitJU_188_Bombardier.this.setOld.cons + 0.09F * f3;
                if (CockpitJU_188_Bombardier.this.buzzerFX != null)
                    if (CockpitJU_188_Bombardier.this.fm.Loc.z < ((JU_188beta) CockpitJU_188_Bombardier.this.aircraft()).fDiveRecoveryAlt && ((JU_188beta) CockpitJU_188_Bombardier.this.fm.actor).diveMechStage == 1)
                        CockpitJU_188_Bombardier.this.buzzerFX.play();
                    else if (CockpitJU_188_Bombardier.this.buzzerFX.isPlaying()) CockpitJU_188_Bombardier.this.buzzerFX.stop();
                CockpitJU_188_Bombardier.this.setNew.beaconDirection = (10F * CockpitJU_188_Bombardier.this.setOld.beaconDirection + CockpitJU_188_Bombardier.this.getBeaconDirection()) / 11F;
                CockpitJU_188_Bombardier.this.setNew.beaconRange = (10F * CockpitJU_188_Bombardier.this.setOld.beaconRange + CockpitJU_188_Bombardier.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitJU_188_Bombardier() {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bEntered) {
            this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((JU_188beta) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((JU_188beta) this.aircraft()).fSightCurReadyness > 0.93F;
    ...
    static {
        Property.set(CockpitJU_188_Bombardier.class, "astatePilotIndx", 0);
    }
}
