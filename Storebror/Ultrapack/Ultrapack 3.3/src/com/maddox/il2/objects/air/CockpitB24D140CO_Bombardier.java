...
public class CockpitB24D140CO_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            float f = ((B_24D140CO) CockpitB24D140CO_Bombardier.this.aircraft()).fSightCurForwardAngle;
            float f1 = ((B_24D140CO) CockpitB24D140CO_Bombardier.this.aircraft()).fSightCurSideslip;
            CockpitB24D140CO_Bombardier.calibrAngle = 360F - CockpitB24D140CO_Bombardier.this.fm.Or.getPitch();
            CockpitB24D140CO_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, CockpitB24D140CO_Bombardier.calibrAngle + f);
            if (CockpitB24D140CO_Bombardier.this.bEntered) {
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(CockpitB24D140CO_Bombardier.this.aAim + 10F * f1, CockpitB24D140CO_Bombardier.this.tAim + CockpitB24D140CO_Bombardier.calibrAngle + f, 0.0F);
            }
            CockpitB24D140CO_Bombardier.this.mesh.chunkSetAngles("TurretA", 0.0F, CockpitB24D140CO_Bombardier.this.aircraft().FM.turret[0].tu[0], 0.0F);
            CockpitB24D140CO_Bombardier.this.mesh.chunkSetAngles("TurretB", 0.0F, CockpitB24D140CO_Bombardier.this.aircraft().FM.turret[0].tu[1], 0.0F);
            return true;
        }
    ...
    public CockpitB24D140CO_Bombardier() {
        super("3DO/Cockpit/B-25J-Bombardier/BombardierB24D.him", "he111");
        this.w = new Vector3f();
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bEntered) {
            this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((B_24D140CO) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((B_24D140CO) this.aircraft()).fSightCurReadyness > 0.93F;
    ...
    static {
        Property.set(CockpitB24D140CO_Bombardier.class, "astatePilotIndx", 0);
    }
