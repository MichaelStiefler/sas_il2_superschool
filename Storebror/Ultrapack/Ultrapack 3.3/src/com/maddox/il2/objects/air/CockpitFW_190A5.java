...
public class CockpitFW_190A5 extends CockpitPilot {
    ...
    public void reflectWorldToInstruments(final float f_54_) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x20) == 0x0 && (this.fm.AS.astateCockpitState & 0x80) == 0x0) this.mesh.chunkSetAngles("NeedleCD",
                this.setNew.vspeed < 0.0f ? this.floatindex(this.cvt(-this.setNew.vspeed, 0.0f, 30.0f, 0.0f, 6.0f), CockpitFW_190A5.vsiNeedleScale) : -this.floatindex(this.cvt(this.setNew.vspeed, 0.0f, 30.0f, 0.0f, 6.0f), CockpitFW_190A5.vsiNeedleScale),
                0.0f, 0.0f);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0x0 && (this.fm.AS.astateCockpitState & 0x8) == 0x0 && (this.fm.AS.astateCockpitState & 0x10) == 0x0) if (this.useRealisticNavigationInstruments()) {
    ...
    class Interpolater extends InterpolateRef {
        public boolean tick() {
            if (CockpitFW_190A5.this.fm != null) {
                ...
                } else CockpitFW_190A5.this.setNew.waypointAzimuth.setDeg(CockpitFW_190A5.this.setOld.waypointAzimuth.getDeg(0.1f), waypointAzimuth - CockpitFW_190A5.this.setOld.azimuth.getDeg(1.0f));
