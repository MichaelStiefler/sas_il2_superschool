...
public abstract class ANAPS4Generic extends ActorHMesh implements com.maddox.il2.objects.ActorAlign {
    class Move extends Interpolate {

        public boolean tick() {
            if (ANAPS4Generic.this.engineSFX != null) if (ANAPS4Generic.this.engineSTimer >= 0) {
                if (--ANAPS4Generic.this.engineSTimer <= 0) {
                    ANAPS4Generic.this.engineSTimer = (int) ANAPS4Generic.SecsToTicks(ANAPS4Generic.Rnd(5F, 5F));
                    if (!ANAPS4Generic.this.danger()) ANAPS4Generic.this.engineSTimer = -ANAPS4Generic.this.engineSTimer;
                }
            } else if (++ANAPS4Generic.this.engineSTimer >= 0) {
                ANAPS4Generic.this.engineSTimer = -(int) ANAPS4Generic.SecsToTicks(ANAPS4Generic.Rnd(5F, 5F));
                if (ANAPS4Generic.this.danger()) ANAPS4Generic.this.engineSTimer = -ANAPS4Generic.this.engineSTimer;
            }
            return true;
    ...
    public static class SPAWN implements ActorSpawn {
        ...
        public Actor actorSpawn(ActorSpawnArg actorspawnarg) {
            ANAPS4Generic anaps4generic = null;
            try {
                ANAPS4Generic.constr_arg2 = actorspawnarg;
                anaps4generic = (ANAPS4Generic) this.cls.newInstance();
                ANAPS4Generic.constr_arg2 = null;
            } catch (Exception exception) {
                ANAPS4Generic.constr_arg2 = null;
                System.out.println(exception.getMessage());
                exception.printStackTrace();
                System.out.println("SPAWN: Can't create ANAPS4Generic object [class:" + this.cls.getName() + "]");
                return null;
            }
            return anaps4generic;
        }
        ...
        public SPAWN(Class class1) {
            ...
            Property.set(class1, "meshName", ANAPS4Generic.mesh_name);
            this.cls = class1;
    ...
    protected ANAPS4Generic() {
        this(constr_arg2);
    }

    private ANAPS4Generic(ActorSpawnArg actorspawnarg) {
        super(mesh_name);
        this.engineSFX = null;
    ...
    public void startMove() {
        if (!this.interpEnd("move")) {
            ...
            this.engineSTimer = -(int) ANAPS4Generic.SecsToTicks(ANAPS4Generic.Rnd(5F, 5F));
        }
    }
    ...
    private boolean danger() {
        ...
        for (java.util.Map.Entry entry = Engine.name2Actor().nextEntry(null); entry != null; entry = Engine.name2Actor().nextEntry(entry)) {
            ...
            if ((actor instanceof Aircraft && actor.getSpeed(vector3d) > 20D || actor instanceof BigshipGeneric || actor instanceof ShipGeneric) && actor.getArmy() != this.myArmy && actor != World.getPlayerAircraft()) {
                this.pos.getAbs(point3d);
                ...
                byte byte0 = 9;
                if (actor instanceof Aircraft) s1 = "Aircraft";
                if (!(actor instanceof Aircraft)) s = " ";
                if (actor instanceof ShipGeneric) byte0 = 40;
                if (actor instanceof BigshipGeneric) byte0 = 55;
                if (actor instanceof Ship.SubTypeVIIC_Sub || actor instanceof Ship.USSGatoSS212_Sub || actor instanceof Ship.USSGreenlingSS213_Sub) byte0 = 5;
                if (actor instanceof Ship.SubTypeVIIC_Srf || actor instanceof Ship.USSGatoSS212_Srf || actor instanceof Ship.USSGreenlingSS213_Srf) byte0 = 30;
                if (k1 <= byte0 && i2 >= 255 && i2 <= 285 && Math.sqrt(j1 * j1) <= 35D) HUD.logCenter("                                              " + s1 + " bearing " + i1 + "\260" + ", range " + j2 + " miles" + s);
            }
        }
