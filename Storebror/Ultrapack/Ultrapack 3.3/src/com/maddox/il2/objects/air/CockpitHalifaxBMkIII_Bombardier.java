...
public class CockpitHalifaxBMkIII_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            float f = ((Halifax) CockpitHalifaxBMkIII_Bombardier.this.aircraft()).fSightCurForwardAngle;
            float f1 = ((Halifax) CockpitHalifaxBMkIII_Bombardier.this.aircraft()).fSightCurSideslip;
            CockpitHalifaxBMkIII_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f1, f);
            if (CockpitHalifaxBMkIII_Bombardier.this.bEntered) HookPilot.current.setSimpleAimOrient(CockpitHalifaxBMkIII_Bombardier.this.aAim + f1, CockpitHalifaxBMkIII_Bombardier.this.tAim + f, 0.0F);
            return true;
        }
    ...
    static {
        Property.set(CockpitHalifaxBMkIII_Bombardier.class, "astatePilotIndx", 0);
    }
}
