...
public abstract class H6K5abc extends Scheme4 implements TypeSailPlane, TypeTransport {
    ...
    public void update(float f) {
        ...
        for (int k = 0; k < 4; k++) {
            ...
            if (Math.abs(this.flapps[k] - f1) > 0.01F) this.flapps[k] = f1;
        }
