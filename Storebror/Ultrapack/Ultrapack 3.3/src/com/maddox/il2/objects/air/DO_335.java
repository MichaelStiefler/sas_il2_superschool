...
public abstract class DO_335 extends Scheme2 implements TypeFighter {
    ...
    public void moveWheelSink() {
        ...
        this.hierMesh().chunkSetAngles("GearC5_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.4719F, 0.0F, -65F), 0.0F);
        this.hierMesh().chunkSetAngles("GearC6_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.4719F, 0.0F, -130F), 0.0F);
        xyz[1] = cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.27625F, 0.0F, 0.27625F);
        this.hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        this.hierMesh().chunkSetAngles("GearL4_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.27625F, 0.0F, -33F), 0.0F);
        this.hierMesh().chunkSetAngles("GearL5_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.27625F, 0.0F, -66F), 0.0F);
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                if (s.endsWith("p1")) {
                    this.getEnergyPastArmor(35.89D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    if (shot.power <= 0.0F) this.doRicochetBack(shot);
                } else if (s.endsWith("p2")) this.getEnergyPastArmor(12.71F, shot);
                else if (s.endsWith("p3")) this.getEnergyPastArmor(12.71D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                return;
            }
                ...
                if (s.endsWith("prop") || s.endsWith("prop3")) {
                    ...
                    if (this.getEnergyPastArmor(2.1F, shot) > 0.0F) {
                        ...
                        if (World.Rnd().nextFloat() < shot.power / 50000F) {
                            ...
                            debugprintln(this, "*** Engine Module: Crank Case Hit, Readyness Reduced to " + this.FM.EI.engines[j].getReadyness() + "..");
                        }
                    ...
                    if (this.getEnergyPastArmor(0.1F, shot) > 0.0F && World.Rnd().nextFloat() < this.FM.EI.engines[j].getCylindersRatio() * 1.75F) {
                        ...
                        debugprintln(this, "*** Engine Module: Cylinders Hit, " + this.FM.EI.engines[j].getCylindersOperable() + "/" + this.FM.EI.engines[j].getCylinders() + " Left..");
    ...
    protected void moveBayDoor(float f) {
        this.hierMesh().chunkSetAngles("Bay01_D0", 0.0F, -95F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Bay02_D0", 0.0F, -95F * f, 0.0F);
    }
