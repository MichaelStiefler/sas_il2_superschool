...
public class PE_2SERIES84 extends PE_2 implements TypeBomber, TypeDiveBomber, TypeTransport {
    ...
    public void update(float f) {
        if (Time.current() > this.tme) {
            ...
            if (this.FM.turret.length != 0) if (this.FM.turret[1].target == null) this.setRadist(0);
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPE2_84.class, CockpitPE2_Bombardier.class, CockpitPE2_84_TGunner.class });
        Property.set(class1, "LOSElevation", 0.76315F);
        weaponTriggersRegister(class1, new int[] { 0, 1, 10, 11, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        weaponHooksRegister(class1,
                new String[] { "_CANNON02", "_CANNON01", "_MGUN01", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06" });
    }
}
