...
public class CockpitG3M2_RGunner extends CockpitGunner {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitG3M2_RGunner.this.mesh.chunkSetAngles("Turret5A", 0.0F, -CockpitG3M2_RGunner.this.aircraft().FM.turret[3].tu[0], 0.0F);
            CockpitG3M2_RGunner.this.mesh.chunkSetAngles("Turret5B", 0.0F, CockpitG3M2_RGunner.this.aircraft().FM.turret[3].tu[1], 0.0F);
            return true;
        }
    ...
    public CockpitG3M2_RGunner() {
        super("3DO/Cockpit/G3M2-RGun/hier.him", "he111_gunner");
        this.curMat = null;
        this.iCocking = 0;
    }
    ...
    static {
        Property.set(CockpitG3M2_RGunner.class, "aiTuretNum", 3);
        Property.set(CockpitG3M2_RGunner.class, "weaponControlNum", 13);
        Property.set(CockpitG3M2_RGunner.class, "astatePilotIndx", 5);
    }
}
