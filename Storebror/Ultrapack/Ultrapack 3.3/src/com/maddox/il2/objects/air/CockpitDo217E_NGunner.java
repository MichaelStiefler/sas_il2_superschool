...
public class CockpitDo217E_NGunner extends CockpitGunner {
...
//            doHitMasterAircraft(aircraft(), hook1, "_MGUN10");
    ...
    public CockpitDo217E_NGunner() {
        super("3DO/Cockpit/Do217E2/hierNGun.him", "he111_gunner");
        this.w = new Vector3f();
...
//    private Hook hook2;
    ...
    static {
        Property.set(CockpitDo217E_NGunner.class, "aiTuretNum", 0);
        Property.set(CockpitDo217E_NGunner.class, "weaponControlNum", 10);
        Property.set(CockpitDo217E_NGunner.class, "astatePilotIndx", 1);
    }
}
