...
public class CockpitBV_222_TGunner extends CockpitGunner {
    ...
    protected void doFocusLeave() {
        this.aircraft().hierMesh().chunkVisible("Turret7B_D0", this.aircraft().hierMesh().isChunkVisible("Turret7XA_D0"));
        super.doFocusLeave();
    }
    ...
    static {
        Property.set(CockpitBV_222_TGunner.class, "aiTuretNum", 6);
        Property.set(CockpitBV_222_TGunner.class, "weaponControlNum", 16);
        Property.set(CockpitBV_222_TGunner.class, "astatePilotIndx", 2);
    }
}
