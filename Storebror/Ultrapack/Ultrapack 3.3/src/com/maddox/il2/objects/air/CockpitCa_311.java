    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitCa_311.this.fm != null) {
                ...
                if ((CockpitCa_311.this.fm.AS.astateCockpitState & 0x40) == 0) CockpitCa_311.this.setNew.vspeed = (199F * CockpitCa_311.this.setOld.vspeed + CockpitCa_311.this.fm.getVertSpeed()) / 200F;
                else CockpitCa_311.this.setNew.vspeed = (1990F * CockpitCa_311.this.setOld.vspeed + CockpitCa_311.this.fm.getVertSpeed()) / 2000F;
                CockpitCa_311.this.setNew.radioalt = 0.9F * CockpitCa_311.this.setOld.radioalt
                        + 0.1F * (CockpitCa_311.this.fm.getAltitude() - Landscape.HQ((float) CockpitCa_311.this.fm.Loc.x, (float) CockpitCa_311.this.fm.Loc.y) + World.Rnd().nextFloat(-10F, 10F));
            }
            return true;
        }
