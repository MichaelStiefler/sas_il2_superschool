...
public class Lysander_1 extends LysanderX implements TypeBomber, TypeScout, TypeTransport {

    static {
        Class class1 = Lysander_1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Lizzie");
        Property.set(class1, "meshName", "3do/plane/Lysander_1/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1956F);
        Property.set(class1, "FlightModel", "FlightModels/Lysander1.fmd");
