...
public class SPITFIRE5C4 extends SPITFIRE5 {
    ...
    static {
        Class class1 = SPITFIRE5C4.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Spit");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireMkVc4xH(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "meshName_gb", "3DO/Plane/SpitfireMkVc4xH(GB)/hier.him");
        ...
        weaponTriggersRegister(class1, new int[] { 1, 1, 1, 1 });
        weaponHooksRegister(class1, new String[] { "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04" });
    }
}
