...
public class F_86F extends Scheme1 implements TypeSupersonic, TypeFighter, TypeBNZFighter, TypeFighterAceMaker, TypeStormovik, TypeGSuit {
    private class _cls0 {

        public void rs(int ii) {
            if (ii == 0 || ii == 1) F_86F.this.actl *= 0.68D;
            if (ii == 31 || ii == 32) F_86F.this.ectl *= 0.68D;
            if (ii == 15 || ii == 16) F_86F.this.rctl *= 0.68D;
        }

        private void $1() {
            if (F_86F.this.ts) {
                float f1 = Aircraft.cvt(F_86F.this.FM.getAltitude(), this.lal, this.tal, this.bef, this.tef);
                float f2 = Aircraft.cvt(F_86F.this.mn, F_86F.this.mn >= F_86F.mteb ? F_86F.uteb : F_86F.lteb, F_86F.this.mn >= F_86F.mteb ? F_86F.lteb : F_86F.uteb, F_86F.this.mn >= F_86F.mteb ? this.thef : this.bhef,
                        F_86F.this.mn >= F_86F.mteb ? this.phef : this.thef);
                float f3 = Aircraft.cvt(F_86F.this.mn, F_86F.this.mn >= F_86F.mteb ? F_86F.uteb : F_86F.lteb, F_86F.this.mn >= F_86F.mteb ? F_86F.lteb : F_86F.uteb, F_86F.this.mn >= F_86F.mteb ? this.wef / f1 : this.mef,
                        F_86F.this.mn >= F_86F.mteb ? this.lef / f1 : this.wef / f1);
                ((RealFlightModel) F_86F.this.FM).producedShakeLevel += 0.1125F * f2;
                F_86F.this.FM.SensPitch = F_86F.this.ectl * f3 * f3;
                F_86F.this.FM.SensRoll = F_86F.this.actl * f3;
                F_86F.this.FM.SensYaw = F_86F.this.rctl * f3;
                if (f2 > 0.6F) F_86F.this.ictl = true;
                else F_86F.this.ictl = false;
                if (this.ftl > 0.0F) {
                    if (World.Rnd().nextFloat() > 0.6F) if (F_86F.this.FM.CT.RudderControl > 0.0F) F_86F.this.FM.CT.RudderControl -= this.ftl * f2;
                    else if (F_86F.this.FM.CT.RudderControl < 0.0F) F_86F.this.FM.CT.RudderControl += this.ftl * f2;
                    else {
                        Controls controls = F_86F.this.FM.CT;
                        controls.RudderControl = controls.RudderControl + (World.Rnd().nextFloat() <= 0.5F ? -this.ftl * f2 : this.ftl * f2);
                    }
                    if (F_86F.this.FM.CT.RudderControl > 1.0F) F_86F.this.FM.CT.RudderControl = 1.0F;
                    if (F_86F.this.FM.CT.RudderControl < -1F) F_86F.this.FM.CT.RudderControl = -1F;
                }
            } else {
                F_86F.this.FM.SensPitch = F_86F.this.ectl;
                F_86F.this.FM.SensRoll = F_86F.this.actl;
                F_86F.this.FM.SensYaw = F_86F.this.rctl;
            }
        }
...
//    private static final float POS_G_RECOVERY_FACTOR = 2.0F;
    ...
    public void rareAction(float paramFloat, boolean paramBoolean) {
        ...
        if (this.FM.AS.isMaster() && Config.isUSE_RENDER()) {
            ...
            f_86f.mn = f / Atmosphere.sonicSpeed((float) this.FM.Loc.z);
            if (this.mn >= 0.9F && this.mn < 1.1D) this.ts = true;
            else this.ts = false;
        }
