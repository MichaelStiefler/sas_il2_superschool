...
public class Mig_15F extends Scheme1 implements TypeSupersonic, TypeFighter, TypeBNZFighter, TypeFighterAceMaker {
    private class _cls0 {
        ...
        public void rs(int ii) {
            if (ii == 0 || ii == 1) Mig_15F.this.actl *= 0.68D;
            if (ii == 31 || ii == 32) Mig_15F.this.ectl *= 0.68D;
            if (ii == 15 || ii == 16) Mig_15F.this.rctl *= 0.68D;
        }

        private void $1() {
            if (Mig_15F.this.ts) {
                float f1 = Aircraft.cvt(Mig_15F.this.FM.getAltitude(), this.lal, this.tal, this.bef, this.tef);
                float f2 = Aircraft.cvt(Mig_15F.this.mn, Mig_15F.this.mn >= Mig_15F.mteb ? Mig_15F.uteb : Mig_15F.lteb, Mig_15F.this.mn >= Mig_15F.mteb ? Mig_15F.lteb : Mig_15F.uteb, Mig_15F.this.mn >= Mig_15F.mteb ? this.thef : this.bhef,
                        Mig_15F.this.mn >= Mig_15F.mteb ? this.phef : this.thef);
                float f3 = Aircraft.cvt(Mig_15F.this.mn, Mig_15F.this.mn >= Mig_15F.mteb ? Mig_15F.uteb : Mig_15F.lteb, Mig_15F.this.mn >= Mig_15F.mteb ? Mig_15F.lteb : Mig_15F.uteb, Mig_15F.this.mn >= Mig_15F.mteb ? this.wef / f1 : this.mef,
                        Mig_15F.this.mn >= Mig_15F.mteb ? this.lef / f1 : this.wef / f1);
                ((RealFlightModel) Mig_15F.this.FM).producedShakeLevel += 0.1125F * f2;
                Mig_15F.this.FM.SensPitch = Mig_15F.this.ectl * f3 * f3;
                Mig_15F.this.FM.SensRoll = Mig_15F.this.actl * f3;
                Mig_15F.this.FM.SensYaw = Mig_15F.this.rctl * f3;
                if (f2 > 0.6F) Mig_15F.this.ictl = true;
                else Mig_15F.this.ictl = false;
                if (this.ftl > 0.0F) {
                    if (World.Rnd().nextFloat() > 0.6F) if (Mig_15F.this.FM.CT.RudderControl > 0.0F) Mig_15F.this.FM.CT.RudderControl -= this.ftl * f2;
                    else if (Mig_15F.this.FM.CT.RudderControl < 0.0F) Mig_15F.this.FM.CT.RudderControl += this.ftl * f2;
                    else {
                        Controls controls = Mig_15F.this.FM.CT;
                        controls.RudderControl = controls.RudderControl + (World.Rnd().nextFloat() <= 0.5F ? -this.ftl * f2 : this.ftl * f2);
                    }
                    if (Mig_15F.this.FM.CT.RudderControl > 1.0F) Mig_15F.this.FM.CT.RudderControl = 1.0F;
                    if (Mig_15F.this.FM.CT.RudderControl < -1F) Mig_15F.this.FM.CT.RudderControl = -1F;
                }
            } else {
                Mig_15F.this.FM.SensPitch = Mig_15F.this.ectl;
                Mig_15F.this.FM.SensRoll = Mig_15F.this.actl;
                Mig_15F.this.FM.SensYaw = Mig_15F.this.rctl;
            }
        }
    ...
    public void soundbarier() {
        ...
        if (this.FM.VmaxAllowed > 1300F) this.FM.VmaxAllowed = 1300F;
    ...
    private final void umnr() {
        ...
        Mig_15F.mn = f / Atmosphere.sonicSpeed((float) this.FM.Loc.z);
