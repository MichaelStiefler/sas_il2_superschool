...
public class CockpitB25B_FGunner extends CockpitGunner {
    ...
    static {
        Property.set(CockpitB25B_FGunner.class, "aiTuretNum", 0);
        Property.set(CockpitB25B_FGunner.class, "weaponControlNum", 10);
        Property.set(CockpitB25B_FGunner.class, "astatePilotIndx", 2);
    }
}
