        ...
        public boolean tick() {
            ...
            if (CockpitJU_388.this.fm != null) {
                ...
                if (CockpitJU_388.this.cockpitDimControl) {
                    if (CockpitJU_388.this.setNew.dimPosition > 0.0F) CockpitJU_388.this.setNew.dimPosition = CockpitJU_388.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_388.this.setNew.dimPosition < 1.0F) CockpitJU_388.this.setNew.dimPosition = CockpitJU_388.this.setOld.dimPosition + 0.05F;
            }
            return true;
        }
