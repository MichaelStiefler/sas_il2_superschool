...
public class CockpitFW_190F8MSTL extends CockpitPilot {
    ...
    public void reflectWorldToInstruments(final float f_54_) {
        ...
        if (this.bomb[0] == null) for (int i = 0; i < this.bomb.length; ++i)
    ...
    class Interpolater extends InterpolateRef {
        public boolean tick() {
            if (CockpitFW_190F8MSTL.this.fm != null) {
                ...
                } else CockpitFW_190F8MSTL.this.setNew.waypointAzimuth.setDeg(CockpitFW_190F8MSTL.this.setOld.waypointAzimuth.getDeg(0.1f), waypointAzimuth - CockpitFW_190F8MSTL.this.setOld.azimuth.getDeg(1.0f));
