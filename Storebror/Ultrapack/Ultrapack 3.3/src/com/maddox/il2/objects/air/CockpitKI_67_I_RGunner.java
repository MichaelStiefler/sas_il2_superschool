...
public class CockpitKI_67_I_RGunner extends CockpitGunner {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitKI_67_I_RGunner.this.mesh.chunkSetAngles("Turret5A", 0.0F, -CockpitKI_67_I_RGunner.this.aircraft().FM.turret[3].tu[0], 0.0F);
            CockpitKI_67_I_RGunner.this.mesh.chunkSetAngles("Turret5B", 0.0F, CockpitKI_67_I_RGunner.this.aircraft().FM.turret[3].tu[1], 0.0F);
            return true;
        }
    ...
    public CockpitKI_67_I_RGunner() {
        super("3DO/Cockpit/Ki67-I-RGun/hier.him", "he111_gunner");
        this.curMat = null;
        this.iCocking = 0;
    }
    ...
    static {
        Property.set(CockpitKI_67_I_RGunner.class, "aiTuretNum", 3);
        Property.set(CockpitKI_67_I_RGunner.class, "weaponControlNum", 13);
        Property.set(CockpitKI_67_I_RGunner.class, "astatePilotIndx", 5);
    }
}
