        ...
        public boolean tick() {
            ...
            if (CockpitJU_188.this.fm != null) {
                ...
                if (CockpitJU_188.this.cockpitDimControl) {
                    if (CockpitJU_188.this.setNew.dimPosition > 0.0F) CockpitJU_188.this.setNew.dimPosition = CockpitJU_188.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_188.this.setNew.dimPosition < 1.0F) CockpitJU_188.this.setNew.dimPosition = CockpitJU_188.this.setOld.dimPosition + 0.05F;
                ...
                if (CockpitJU_188.this.buzzerFX != null) if (CockpitJU_188.this.fm.Loc.z < ((JU_188beta) CockpitJU_188.this.aircraft()).fDiveRecoveryAlt && ((JU_188beta) CockpitJU_188.this.fm.actor).diveMechStage == 1) CockpitJU_188.this.buzzerFX.play();
                else if (CockpitJU_188.this.buzzerFX.isPlaying()) CockpitJU_188.this.buzzerFX.stop();
