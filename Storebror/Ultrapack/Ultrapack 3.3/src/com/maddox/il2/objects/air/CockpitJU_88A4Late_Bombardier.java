...
public class CockpitJU_88A4Late_Bombardier extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            float f = ((JU_88A4Late) CockpitJU_88A4Late_Bombardier.this.aircraft()).fSightCurForwardAngle;
            float f1 = ((JU_88A4Late) CockpitJU_88A4Late_Bombardier.this.aircraft()).fSightCurSideslip;
            if (JU_88A4Late.bChangedPit) {
                CockpitJU_88A4Late_Bombardier.this.reflectPlaneToModel();
                JU_88A4Late.bChangedPit = false;
            }
            CockpitJU_88A4Late_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
            if (CockpitJU_88A4Late_Bombardier.this.bEntered) {
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(CockpitJU_88A4Late_Bombardier.this.aAim + 10F * f1, CockpitJU_88A4Late_Bombardier.this.tAim + f, 0.0F);
            }
            if (CockpitJU_88A4Late_Bombardier.this.fm != null) {
                CockpitJU_88A4Late_Bombardier.this.setTmp = CockpitJU_88A4Late_Bombardier.this.setOld;
                CockpitJU_88A4Late_Bombardier.this.setOld = CockpitJU_88A4Late_Bombardier.this.setNew;
                CockpitJU_88A4Late_Bombardier.this.setNew = CockpitJU_88A4Late_Bombardier.this.setTmp;
                CockpitJU_88A4Late_Bombardier.this.setNew.throttle1 = 0.85F * CockpitJU_88A4Late_Bombardier.this.setOld.throttle1 + CockpitJU_88A4Late_Bombardier.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
                CockpitJU_88A4Late_Bombardier.this.setNew.prop1 = 0.85F * CockpitJU_88A4Late_Bombardier.this.setOld.prop1 + CockpitJU_88A4Late_Bombardier.this.fm.EI.engines[0].getControlProp() * 0.15F;
                CockpitJU_88A4Late_Bombardier.this.setNew.throttle2 = 0.85F * CockpitJU_88A4Late_Bombardier.this.setOld.throttle2 + CockpitJU_88A4Late_Bombardier.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
                CockpitJU_88A4Late_Bombardier.this.setNew.prop2 = 0.85F * CockpitJU_88A4Late_Bombardier.this.setOld.prop2 + CockpitJU_88A4Late_Bombardier.this.fm.EI.engines[1].getControlProp() * 0.15F;
                CockpitJU_88A4Late_Bombardier.this.setNew.altimeter = CockpitJU_88A4Late_Bombardier.this.fm.getAltitude();
                float f2 = CockpitJU_88A4Late_Bombardier.this.waypointAzimuth();
                CockpitJU_88A4Late_Bombardier.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4Late_Bombardier.this.setOld.waypointAzimuth.getDeg(0.1F), f2 - CockpitJU_88A4Late_Bombardier.this.setOld.azimuth.getDeg(1.0F));
                CockpitJU_88A4Late_Bombardier.this.setNew.azimuth.setDeg(CockpitJU_88A4Late_Bombardier.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4Late_Bombardier.this.fm.Or.azimut());
                CockpitJU_88A4Late_Bombardier.this.setNew.vspeed = (199F * CockpitJU_88A4Late_Bombardier.this.setOld.vspeed + CockpitJU_88A4Late_Bombardier.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88A4Late_Bombardier.this.cockpitDimControl) {
                    if (CockpitJU_88A4Late_Bombardier.this.setNew.dimPosition > 0.0F) CockpitJU_88A4Late_Bombardier.this.setNew.dimPosition = CockpitJU_88A4Late_Bombardier.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_88A4Late_Bombardier.this.setNew.dimPosition < 1.0F) CockpitJU_88A4Late_Bombardier.this.setNew.dimPosition = CockpitJU_88A4Late_Bombardier.this.setOld.dimPosition + 0.05F;
                float f3 = CockpitJU_88A4Late_Bombardier.this.prevFuel - CockpitJU_88A4Late_Bombardier.this.fm.M.fuel;
                CockpitJU_88A4Late_Bombardier.this.prevFuel = CockpitJU_88A4Late_Bombardier.this.fm.M.fuel;
                f3 /= 0.72F;
                f3 /= Time.tickLenFs();
                f3 *= 3600F;
                CockpitJU_88A4Late_Bombardier.this.setNew.cons = 0.91F * CockpitJU_88A4Late_Bombardier.this.setOld.cons + 0.09F * f3;
                if (CockpitJU_88A4Late_Bombardier.this.buzzerFX != null)
                    if (CockpitJU_88A4Late_Bombardier.this.fm.Loc.z < ((JU_88A4Late) CockpitJU_88A4Late_Bombardier.this.aircraft()).fDiveRecoveryAlt && ((JU_88A4Late) ((Interpolate) CockpitJU_88A4Late_Bombardier.this.fm).actor).diveMechStage == 1)
                        CockpitJU_88A4Late_Bombardier.this.buzzerFX.play();
                    else if (CockpitJU_88A4Late_Bombardier.this.buzzerFX.isPlaying()) CockpitJU_88A4Late_Bombardier.this.buzzerFX.stop();
            }
            return true;
        }
    ...
    public CockpitJU_88A4Late_Bombardier() {
        super("3DO/Cockpit/Ju-88A-4Late-Bombardier/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bEntered) {
            this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((JU_88A4Late) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((JU_88A4Late) this.aircraft()).fSightCurReadyness > 0.93F;
    ...
    static {
        Property.set(CockpitJU_88A4Late_Bombardier.class, "astatePilotIndx", 0);
    }
}
