...
public class BombFlareLC50F extends Bomb {

    public BombFlareLC50F() {
        this.chute = null;
        this.bOnChute = false;
        this.descentRate = 4F;
    }
    ...
    static {
        Class class1 = BombFlareLC50F.class;
        Property.set(class1, "mesh", "3DO/Arms/LC50F/mono.sim");
        Property.set(class1, "radius", 0.0F);
        Property.set(class1, "power", 0.0F);
        Property.set(class1, "powerType", 0);
        Property.set(class1, "kalibr", 0.28F);
        Property.set(class1, "massa", 33F);
