...
public class ZutiSupportMethods_Engine {
    ...
    public static void addAirfieldPoint_MisIni(String line) {
        ...
        try {
            ...
            if (ZutiSupportMethods_Engine.AIRFIELDS != null) ZutiSupportMethods_Engine.AIRFIELDS.add(new com.maddox.il2.game.ZutiAirfieldPoint(x1, y1, x2, y2, friction));
    ...
    public static void loadMapDefinedAirfields(IniFile inifile) {
        ...
        if (ZutiSupportMethods_Engine.AIRFIELDS == null) ZutiSupportMethods_Engine.AIRFIELDS = new ArrayList();
        ...
        for (int id = 0; id < 999; id++) {
            ...
            if (airport.trim().length() > 0) ZutiSupportMethods_Engine.addAirfieldPoint_MapIni(airport);
        }
        // --------------------------------------------------------------------------
    }
    ...
    public static void alterWaterState(IniFile inifile, String camouflage) {
        ...
        if (ZutiSupportMethods_Engine.WATER_STATE == null || ZutiSupportMethods_Engine.WATER_STATE.trim().length() == 0) if ("WINTER".equals(camouflage)) ZutiSupportMethods_Engine.WATER_STATE = "ICE";
        else ZutiSupportMethods_Engine.WATER_STATE = "LIQUID";
    }
