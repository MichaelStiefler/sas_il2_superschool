...
//    private static final String _VERSION                      = "4.10.1_(UP_EDITION)";
    ...
    public static final String[] PATCHLEVEL_G          = { "0" };
    public static final String[] PATCHLEVEL_Y          = { "0" };

    public static final String   VERSION_STRING        = "Ultrapack";
    public static final String   PRODUCT               = VERSION_STRING + "_" + VERSION_NUMBER;
