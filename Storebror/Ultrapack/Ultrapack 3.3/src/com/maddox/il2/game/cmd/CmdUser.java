...
//                this.INFO_HARD("Hit Air Bullets: \t" + netuserstat.bulletsHitAir);
                INFO_HARD("Hit Bullets: \t\t" + (netuserstat.bulletsHit * AircraftState.getCheaterHitRate(s) / 100));
                INFO_HARD("Hit Air Bullets: \t" + (netuserstat.bulletsHitAir * AircraftState.getCheaterHitRate(s) / 100));
                // ---
