...
public class ZutiSupportMethods_GUI {
    ...
    public static void drawTargets(GUIRenders guirenders, TTFont ttfont, Mat mat, CameraOrtho2D cameraortho2d) {
        try {
            ...
            if (zutiPlayerArmy == com.maddox.il2.ai.World.getMissionArmy()) drawTargets(guirenders, ttfont, mat, cameraortho2d, ZutiTargetsSupportMethods.ZUTI_TARGETPOINTS, zutiPlayerArmy, true);
                ...
                if (aircraftArmy == army) {
                    ...
                    if (cockpitObject != null) {
                        ...
                        for (int cockpitId = 1; cockpitId < cockpits; cockpitId++)
                            ...
                            if (!CockpitPilot.class.isAssignableFrom(var_classes[cockpitId])) // TODO: Storebror Cockpit assignment fix !!!
                            {
                                item = new Item();
