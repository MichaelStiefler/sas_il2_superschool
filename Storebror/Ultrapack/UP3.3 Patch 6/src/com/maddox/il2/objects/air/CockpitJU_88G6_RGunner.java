...
public class CockpitJU_88G6_RGunner extends CockpitGunner {
        ...
        public boolean tick() {
            if (CockpitJU_88G6_RGunner.this.fm != null) {
                ...
                if (CockpitJU_88G6_RGunner.this.cockpitDimControl) {
                    if (CockpitJU_88G6_RGunner.this.setNew.dimPosition > 0.0F) CockpitJU_88G6_RGunner.this.setNew.dimPosition = CockpitJU_88G6_RGunner.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_88G6_RGunner.this.setNew.dimPosition < 1.0F) CockpitJU_88G6_RGunner.this.setNew.dimPosition = CockpitJU_88G6_RGunner.this.setOld.dimPosition + 0.05F;
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ((TypeRadarFuG200Carrier) this.aircraft()).setCurPilot(3);
