...
public class CockpitCCC_Bombardier extends CockpitPilot//CockpitBombardier
{
...
//                    mesh.chunkSetAngles("zArr_Stopwatch", -6F * r_5bomber1.getOPBTimer(), 0.0F, 0.0F);
                ...
                mesh.chunkSetAngles("CCC_zESBR01", 0.0F, -floatindex(cvt(byte0 + IntervalometrNum, 0.0F, 26F, 0.0F, 26F), CockpitCCC_Bombardier.ESBR_Scale), 0.0F);
...
//    }
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if((double)r_5xyz2.getGunnerAnimation() > 0.75D)
        {
            float f5 = cvt(r_5xyz2.getGunnerAnimation(), 0.75F, 1.0F, -70F, 0.0F);
            mesh.chunkSetAngles("zTurret1B", 0.0F, 0.0F, f5);
        } else
        {
        ...
        if(Gun5 != null && World.cur().diffCur.Limited_Ammo && Gun5.countBullets() < 50)
...
//        aircraft().FM.turret[0].bMultiFunction = false;
    ...
    public CockpitCCC_Bombardier()
    {
        super("3DO/Cockpit/R-5-Bombardier/hier-CCC.him", "u2");
        saveBSFov = 50F;
        bNeedSetUp = true;
        enteringAim = false;
        bEntered = false;
...
//    private float kAim;
    ...
    static 
    {
        Property.set(CockpitCCC_Bombardier.class, "weaponControlNum", 3);
        Property.set(CockpitCCC_Bombardier.class, "astatePilotIndx", 1);
        Property.set(CockpitCCC_Bombardier.class, "normZNs", new float[] {
            0.3F, 0.7F, 1.1F, 0.7F
        });
        Property.set(CockpitCCC_Bombardier.class, "gsZN", 0.6F);
    }
}
