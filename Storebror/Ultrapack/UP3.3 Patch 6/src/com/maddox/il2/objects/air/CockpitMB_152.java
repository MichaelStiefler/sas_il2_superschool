    ...
    private class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMB_152.this.fm != null) {
                ...
                CockpitMB_152.this.setNew.azimuth = 0.97F * CockpitMB_152.this.setOld.azimuth + 0.03F * -CockpitMB_152.this.fm.Or.getYaw();
                if (CockpitMB_152.this.setOld.azimuth > 270F && CockpitMB_152.this.setNew.azimuth < 90F) CockpitMB_152.this.setOld.azimuth -= 360F;
                if (CockpitMB_152.this.setOld.azimuth < 90F && CockpitMB_152.this.setNew.azimuth > 270F) CockpitMB_152.this.setOld.azimuth += 360F;
                CockpitMB_152.this.setNew.waypointAzimuth = 0.91F * CockpitMB_152.this.setOld.waypointAzimuth + 0.09F * (CockpitMB_152.this.waypointAzimuth() - CockpitMB_152.this.setOld.azimuth) + World.Rnd().nextFloat(-10F, 10F);
                ...
                if (CockpitMB_152.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitMB_152.this.setNew.gearPhi > 0.0F) CockpitMB_152.this.setNew.gearPhi = CockpitMB_152.this.setOld.gearPhi - 0.021F;
                } else if (CockpitMB_152.this.setNew.gearPhi < 1.0F) CockpitMB_152.this.setNew.gearPhi = CockpitMB_152.this.setOld.gearPhi + 0.021F;
            }
            return true;
        }
