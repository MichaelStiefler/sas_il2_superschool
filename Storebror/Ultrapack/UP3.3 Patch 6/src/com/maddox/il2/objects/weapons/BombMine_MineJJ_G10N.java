...
public class BombMine_MineJJ_G10N extends AerialMine2 implements BombParaAerialMine2
{

    public BombMine_MineJJ_G10N()
    {
        chute = null;
        bOnChute = false;
    }
    ...
    public void interpolateTick()
    {
        ...
        if(bOnChute)
        {
            setMesh("3DO/Arms/MineJJ_G10N/Open/mono.sim");
            getSpeed(v3d);
            v3d.scale(0.99D);
            if(v3d.z < -10D)
        ...
        if(super.curTm > ttcurTM && Bomb.P.z <= (double)openHeight && Bomb.P.z >= (double)minHeight)
        {
            bOnChute = true;
            setMesh("3DO/Arms/MineJJ_G10N/Open/mono.sim");
        ...
        if(super.curTm > ttcurTM && Bomb.P.z <= (double)minHeight && Bomb.P.z > 0.05D + World.land().HQ(Bomb.P.x, Bomb.P.y))
        {
            bOnChute = false;
            setMesh("3DO/Arms/MineJJ/mono.sim");
        }
        super.pos.getRel(Bomb.P, Bomb.Or);
        if(chute == null && Bomb.P.z <= 0.05D + World.land().HQ(Bomb.P.x, Bomb.P.y))
        {
            drawing(false);
//          Explosions.torpedoEnter_Water(AerialMine.P, 4F, 1.0F);
        ...
        if(chute != null && Bomb.P.z <= 0.05D + World.land().HQ(Bomb.P.x, Bomb.P.y))
        {
            setMesh("3DO/Arms/MineJJ_G10N/Sea/mono.sim");
            drawing(true);
        }
    }
    ...
    static 
    {
        Class class1 = BombMine_MineJJ_G10N.class;
        Property.set(class1, "mesh", "3DO/Arms/MineJJ_G10N/mono.sim");
        Property.set(class1, "radius", 15.5F);
        Property.set(class1, "power", 109F);
        Property.set(class1, "powerType", 0);
        Property.set(class1, "kalibr", 0.6F);
        Property.set(class1, "massa", 272F);
        ...
        Property.set(class1, "dropMaxAltitude", 500F);
        Property.set(class1, "dropMinAltitude", 250F);
        Property.set(class1, "dropSpeed", 150F);
    }
}
