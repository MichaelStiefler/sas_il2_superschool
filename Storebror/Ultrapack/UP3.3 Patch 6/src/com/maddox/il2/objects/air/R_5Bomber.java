...
public abstract class R_5Bomber extends R_5xyz
...
//        double d = getBombDist(fSightCurAltitude, (double)fSightCurSpeed / 3.6D);
//        fSightSetForwardAngle = (float)Math.toDegrees(Math.atan(d / (double)fSightCurAltitude));
//        if(World.cur().diffCur.RealisticBombSights)
//        {
//            tmp_rnd.setSeed(System.currentTimeMillis());
//            tSAim = tmp_rnd.nextFloat(-4F, 4F);
//        }
//    }
    ...
    public float tSAim;
    public float kSAim;
//    private long OPB_Timer;
//    private long OPB_Timer1;
//    private int OPB_Speed;
//    private boolean bSightOpbTimer;
