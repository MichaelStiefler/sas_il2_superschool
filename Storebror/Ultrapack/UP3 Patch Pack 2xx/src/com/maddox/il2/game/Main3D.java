...
public class Main3D extends Main {
    ...
    class CmdScreenSequence extends Cmd {
        ...
        public Object exec(CmdEnv cmdenv, Map map) {
            if (Main3D.this.screenSequence == null) {
                Main3D.this.screenSequence = new ScreenSequence();
            }
    ...
    class ScreenSequence extends Actor {
        class Interpolater extends Interpolate {
            ...
            public boolean tick() {
                if (ScreenSequence.this.bSave) {
                    ScreenSequence.this.shot.grab();
                }
                return true;
            }
    ...
    class FarActorFilter implements ActorFilter {
        ...
        public boolean isUse(Actor actor, double d) {
            if (actor == Main3D.this.iconFarViewActor) {
                return false;
            }
            if (d <= 5D) {
                return false;
            ...
            if (d > Main3D.this.iconDrawMax) {
                return false;
            }
            actor.pos.getRender(this.p3d);
            if (!Main3D.this.project2d_cam(this.p3d, this.p2d)) {
                return false;
            }
            if ((this.p2d.z > 1.0D) || (this.p2d.x < Main3D.this.iconClipX0) || (this.p2d.x > Main3D.this.iconClipX1) || (this.p2d.y < Main3D.this.iconClipY0) || (this.p2d.y > Main3D.this.iconClipY1)) {
                if (Main3D.this.bRenderMirror) {
                    return false;
                }
                if (!(actor instanceof Aircraft)) {
                    return false;
                }
                if (Main3D.this.isViewInsideShow()) {
                    return false;
                }
                ...
                if (Main3D.this.iRenderIndx == 0) {
                    this.drawPointer(i, d, Main3D.this.render2D.getViewPortWidth() / 2, Main3D.this.render2D.getViewPortHeight() / 2);
                }
                return false;
            }
            ...
            if (s3 != null) {
                Main3D.this.insertFarActorItem(dotrange.colorIcon(d, i, i1), j, k, (float) (-this.p2d.z), s3);
            }
            return false;
        }
    ...
    public class RenderCockpitMirror extends Render {
        ...
        protected void contextResize(int i, int j) {
            ...
            if (this.camera != null) {
                ((Camera3D) this.camera).set(((Camera3D) this.camera).FOV(), (float) Main3D.this.mirrorWidth() / (float) Main3D.this.mirrorHeight());
            }
        }
...
// Orient orient = loc.getOrient();
    ...
    public void setViewInsideShow(boolean flag) {
        if (this.isViewOutside() || (this.isViewInsideShow() == flag)) {
            return;
        }
        if (!Actor.isValid(this.cockpitCur)) {
            return;
    ...
    public void setEnableRenderingCockpit(boolean flag) {
        if (this.isViewOutside() || (this.isEnableRenderingCockpit() == flag)) {
            return;
        }
        if (!Actor.isValid(this.cockpitCur)) {
            return;
    ...
    private void endView() {
        if (!this.isViewOutside()) {
            return;
        }
        if (this.bViewFly || this.bViewEnemy) {
            return;
        } else {
    ...
    private void setViewSomebody(Actor actor) {
        ...
        if (actor instanceof ActorViewPoint) {
            ((ActorViewPoint) actor).setViewActor(this.hookViewEnemy.enemy());
        }
    }
    ...
    public void setViewPadlock(boolean flag, boolean flag1) {
        ...
        if (!this.cockpitCur.existPadlock()) {
            return;
        }
        Aircraft aircraft = World.getPlayerAircraft();
        Actor actor;
        if (World.cur().diffCur.No_Icons) {
            actor = Selector.look(true, flag1, this.camera3D, -1, -1, aircraft, false);
        } else if (flag) {
            actor = Selector.look(true, flag1, this.camera3D, -1, aircraft.getArmy(), aircraft, false);
        } else {
            actor = Selector.look(true, flag1, this.camera3D, aircraft.getArmy(), -1, aircraft, false);
        }
        if ((actor == null) || (actor == aircraft)) {
            return;
        }
        if (!this.cockpitCur.startPadlock(actor)) {
            return;
        } else {
            return;
        }
    ...
    public void setViewPadlockForward(boolean flag) {
        if (this.isViewPadlock()) {
            this.cockpitCur.setPadlockForward(flag);
        }
    }

    public void setViewInside() {
        if (!this.isViewOutside() && !this.isViewPadlock()) {
            return;
        }
        if (!Actor.isValid(this.cockpitCur)) {
            return;
        }
        if (!this.cockpitCur.isEnableFocusing()) {
            return;
        } else {
            this.endView();
            this.endViewFly();
    ...
    protected int viewSet_Get() {
        ...
        if (!this.aircraftHotKeys.isAutoAutopilot()) {
            i |= 0x10;
        }
        i |= (HUD.drawSpeed() & 3) << 5;
        return i;
    ...
    public void clearGameTrack(GameTrack gametrack) {
        if (gametrack == this.gameTrackRecord) {
            this.gameTrackRecord = null;
        }
        if (gametrack == this.gameTrackPlay) {
            this.gameTrackPlay = null;
        }
    }
    ...
    public String playRecordedMission(String s, boolean flag) {
        ...
        if (this.playRecordedMissionCallback == null) {
            this.playRecordedMissionCallback = new KeyRecordCallback() {
                ...
                public void playRecordedEnded() {
                    if (this != Main3D.this.playRecordedMissionCallback) {
                        return;
                    }
        ...
        if (InOutStreams.isExistAndValid(new File(s))) {
            return this.playNetRecordedMission(s, flag);
        }
        String s1 = s;
        ...
        if (i >= 0) {
            ...
            if (InOutStreams.isExistAndValid(new File(s1))) {
                return this.playNetRecordedMission(s1, flag);
            }
    ...
    public void flyRecordedMission() {
        if (this.keyRecord.isPlaying()) {
            ...
            if (Actor.isValid(this.cockpitCur)) {
                HotKeyCmd.exec("misc", "cockpitEnter" + this.cockpitCurIndx());
            }
    ...
    public boolean saveRecordedMission(String s) {
        ...
        if (this.mission.isDestroyed()) {
            return false;
        }
        if (!this.keyRecord.isContainRecorded()) {
            return false;
        }
        try {
    ...
    public boolean saveRecordedStates2(InOutStreams inoutstreams) {
        try {
            ...
            printwriter.println(FOVX);
            int i = 0;
            if (this.hud.bDrawDashBoard) {
                i |= 1;
            }
            if (this.isViewInsideShow()) {
                i |= 2;
            }
            ...
            if (this.isEnableRenderingCockpit()) {
                i |= 0x10;
            }
    ...
    public void loadRecordedStates1(boolean flag) {
        if (flag == this.bLoadRecordedStates1Before) {
            try {
    ...
    public void loadRecordedStates2() {
        try {
            ...
            if (Actor.isValid(this.cockpitCur)) {
                this.cockpitCur.doToggleAim((i & 4) != 0);
            }
            FlightModel flightmodel = World.getPlayerFM();
            if (flightmodel != null) {
            ...
            if (Actor.isValid(this.cockpitCur)) {
                ...
                if (((i & 0x40) != 0) && !this.cockpitCur.isToggleDim()) {
                    this.cockpitCur.doToggleDim();
                }
                if (((i & 0x80) != 0) && !this.cockpitCur.isToggleLight()) {
    ...
    public boolean project2d_cam(double d, double d1, double d2, Point3d point3d) {
        if (!this.project2d(d, d1, d2, point3d)) {
            return false;
        }
        if (this.bRenderMirror) {
    ...
    private void shadowPairsRender() {
        ...
        if (this.shadowPairsList2.size() == 0) {
            return;
        } else {
    ...
    private void plateToRenderArray(ArrayList arraylist, ArrayList arraylist1) {
        ...
        for (int j = 0; j < i; j++) {
            ...
            if ((actor instanceof ActorMesh) && (((ActorMesh) actor).mesh() instanceof MeshShared)) {
                ...
                if (!((MeshShared) ((ActorMesh) actor).mesh()).putToRenderArray(this.__l)) {
...
// iconFarPlayerActor = World.getPlayerAircraft();
        ...
        for (int l = 0; l < k; l++) {
            ...
            if (d3 < 25000D) {
                this.farActorFilter.isUse(actor, d3);
            }
        }
...
// iconFarPlayerActor = null;
        ...
        if (this.iconFarListLen[this.iRenderIndx] != 0) {
            ...
            for (int i = 0; i < this.iconFarListLen[this.iRenderIndx]; i++) {
                ...
                if (this.bRenderMirror) {
                    ...
                    this.iconFarFont.output(faractoritem.color, faractoritem.x, faractoritem.y, faractoritem.z, faractoritem.str);
                }
            }
    ...
    public void initHotKeys() {
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "ScreenShot") {
            ...
            public void begin() {
                if (Main3D.this.scrShot == null) {
                    Main3D.this.scrShot = new ScrShot("grab");
                }
                if (Mission.isNet()) {
                    long l = Time.real();
                    if ((Main3D.this.lastTimeScreenShot + 10000L) < l) {
                        Main3D.this.lastTimeScreenShot = l;
                    } else {
                        return;
                    }
                }
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "showTime") {
            ...
            public void begin() {
                if (RTSConf.cur.console.getEnv().levelAccess() == 0) {
                    Main3D.this.bShowTime = !Main3D.this.bShowTime;
                }
            }
