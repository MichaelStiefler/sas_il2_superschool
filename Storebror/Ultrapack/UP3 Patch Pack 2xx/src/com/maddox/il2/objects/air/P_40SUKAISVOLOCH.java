...
public abstract class P_40SUKAISVOLOCH extends Scheme1 implements TypeFighter {
  ...
  // ************************************************************************************************
    ...
    public void moveWheelSink() {
        ...
        this.hierMesh().chunkSetAngles("GearL6_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.26F, 0.0F, -25F), 0.0F);
        this.hierMesh().chunkSetAngles("GearL7_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.26F, 0.0F, -68.5F), 0.0F);
        this.resetYPRmodifier();
        xyz[1] = cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.26F, 0.0F, 0.26F);
        ypr[1] = cvt(this.FM.CT.getGear(), 0.01F, 0.79F, 0.0F, -94F);
        this.hierMesh().chunkSetLocate("GearR21_D0", xyz, ypr);
        this.hierMesh().chunkSetAngles("GearR6_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.26F, 0.0F, -25F), 0.0F);
        this.hierMesh().chunkSetAngles("GearR7_D0", 0.0F, cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.26F, 0.0F, -68.5F), 0.0F);
    }
