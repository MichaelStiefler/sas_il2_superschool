...
/**
 * @author SAS~Skylla
 *         This class was created by SAS~Skylla in the course of the AC-47 rework.
...
public abstract class MGunAdjustableMiniGun extends MGunAircraftGeneric {
    ...
    public float incRPM() {
        if ((this.rpm + this.stepRPM) <= this.maxRPM) {
            this.rpm += this.stepRPM;
        } else {
    ...
    public float decRPM() {
        if ((this.rpm - this.stepRPM) >= this.minRPM) {
            this.rpm -= this.stepRPM;
        } else {
