    ...
    class Move extends Interpolate {
        public boolean tick() {
            ...
            if (ShipGeneric.this.dying == 0) {
                ...
                else if (ShipGeneric.this.wakeupTmr > 0L) access$1710(ShipGeneric.this);
                else if (access$1704(ShipGeneric.this) == 0L) if (ShipGeneric.this.isAnyEnemyNear()) ShipGeneric.this.wakeupTmr = SecsToTicks(Rnd(ShipGeneric.this.DELAY_WAKEUP, ShipGeneric.this.DELAY_WAKEUP * 1.2F));
            ...
            if (ShipGeneric.this.dying == 2) {
                ...
                if (access$2310(ShipGeneric.this) > 0L) return true;
