...
public class ZutiSupportMethods_ResourcesManagement {
    ...
    public static int[] getBombsForPlayer(int[] requestedBombs, double x, double y) {
        ...
        if (bp != null) {
            if (bp.zutiEnableResourcesManagement) {
                if (requestedBombs[0] <= bp.zutiBombsSupply[0]) bp.zutiBombsSupply[0] -= requestedBombs[0];
                else {
                    requestedBombs[0] = bp.zutiBombsSupply[0];
                    bp.zutiBombsSupply[0] = 0;
                }

                if (requestedBombs[1] <= bp.zutiBombsSupply[1]) bp.zutiBombsSupply[1] -= requestedBombs[1];
                else {
                    requestedBombs[1] = bp.zutiBombsSupply[1];
                    bp.zutiBombsSupply[1] = 0;
                }

                if (requestedBombs[2] <= bp.zutiBombsSupply[2]) bp.zutiBombsSupply[2] -= requestedBombs[2];
                else {
                    requestedBombs[2] = bp.zutiBombsSupply[2];
                    bp.zutiBombsSupply[2] = 0;
                }

                if (requestedBombs[3] <= bp.zutiBombsSupply[3]) bp.zutiBombsSupply[3] -= requestedBombs[3];
                else {
                    requestedBombs[3] = bp.zutiBombsSupply[3];
                    bp.zutiBombsSupply[3] = 0;
                }

                if (requestedBombs[4] <= bp.zutiBombsSupply[4]) bp.zutiBombsSupply[4] -= requestedBombs[4];
                else {
                    requestedBombs[4] = bp.zutiBombsSupply[4];
                    bp.zutiBombsSupply[4] = 0;
                }

                if (requestedBombs[5] <= bp.zutiBombsSupply[5]) bp.zutiBombsSupply[5] -= requestedBombs[5];
                else {
            ...
            // Manage side resources
            if (requestedBombs[0] <= Mission.MDS_VARIABLES().zutiBombsSupply_Red[0]) Mission.MDS_VARIABLES().zutiBombsSupply_Red[0] -= requestedBombs[0];
            else {
                requestedBombs[0] = Mission.MDS_VARIABLES().zutiBombsSupply_Red[0];
                Mission.MDS_VARIABLES().zutiBombsSupply_Red[0] = 0;
            }

            if (requestedBombs[1] <= Mission.MDS_VARIABLES().zutiBombsSupply_Red[1]) Mission.MDS_VARIABLES().zutiBombsSupply_Red[1] -= requestedBombs[1];
            else {
                requestedBombs[1] = Mission.MDS_VARIABLES().zutiBombsSupply_Red[1];
                Mission.MDS_VARIABLES().zutiBombsSupply_Red[1] = 0;
            }

            if (requestedBombs[2] <= Mission.MDS_VARIABLES().zutiBombsSupply_Red[2]) Mission.MDS_VARIABLES().zutiBombsSupply_Red[2] -= requestedBombs[2];
            else {
                requestedBombs[2] = Mission.MDS_VARIABLES().zutiBombsSupply_Red[2];
                Mission.MDS_VARIABLES().zutiBombsSupply_Red[2] = 0;
            }

            if (requestedBombs[3] <= Mission.MDS_VARIABLES().zutiBombsSupply_Red[3]) Mission.MDS_VARIABLES().zutiBombsSupply_Red[3] -= requestedBombs[3];
            else {
                requestedBombs[3] = Mission.MDS_VARIABLES().zutiBombsSupply_Red[3];
                Mission.MDS_VARIABLES().zutiBombsSupply_Red[3] = 0;
            }

            if (requestedBombs[4] <= Mission.MDS_VARIABLES().zutiBombsSupply_Red[4]) Mission.MDS_VARIABLES().zutiBombsSupply_Red[4] -= requestedBombs[4];
            else {
                requestedBombs[4] = Mission.MDS_VARIABLES().zutiBombsSupply_Red[4];
                Mission.MDS_VARIABLES().zutiBombsSupply_Red[4] = 0;
            }

            if (requestedBombs[5] <= Mission.MDS_VARIABLES().zutiBombsSupply_Red[5]) Mission.MDS_VARIABLES().zutiBombsSupply_Red[5] -= requestedBombs[5];
            else {
            ...
            // Manage side resources
            if (requestedBombs[0] <= Mission.MDS_VARIABLES().zutiBombsSupply_Blue[0]) Mission.MDS_VARIABLES().zutiBombsSupply_Blue[0] -= requestedBombs[0];
            else {
                requestedBombs[0] = Mission.MDS_VARIABLES().zutiBombsSupply_Blue[0];
                Mission.MDS_VARIABLES().zutiBombsSupply_Blue[0] = 0;
            }

            if (requestedBombs[1] <= Mission.MDS_VARIABLES().zutiBombsSupply_Blue[1]) Mission.MDS_VARIABLES().zutiBombsSupply_Blue[1] -= requestedBombs[1];
            else {
                requestedBombs[1] = Mission.MDS_VARIABLES().zutiBombsSupply_Blue[1];
                Mission.MDS_VARIABLES().zutiBombsSupply_Blue[1] = 0;
            }

            if (requestedBombs[2] <= Mission.MDS_VARIABLES().zutiBombsSupply_Blue[2]) Mission.MDS_VARIABLES().zutiBombsSupply_Blue[2] -= requestedBombs[2];
            else {
                requestedBombs[2] = Mission.MDS_VARIABLES().zutiBombsSupply_Blue[2];
                Mission.MDS_VARIABLES().zutiBombsSupply_Blue[2] = 0;
            }

            if (requestedBombs[3] <= Mission.MDS_VARIABLES().zutiBombsSupply_Blue[3]) Mission.MDS_VARIABLES().zutiBombsSupply_Blue[3] -= requestedBombs[3];
            else {
                requestedBombs[3] = Mission.MDS_VARIABLES().zutiBombsSupply_Blue[3];
                Mission.MDS_VARIABLES().zutiBombsSupply_Blue[3] = 0;
            }

            if (requestedBombs[4] <= Mission.MDS_VARIABLES().zutiBombsSupply_Blue[4]) Mission.MDS_VARIABLES().zutiBombsSupply_Blue[4] -= requestedBombs[4];
            else {
                requestedBombs[4] = Mission.MDS_VARIABLES().zutiBombsSupply_Blue[4];
                Mission.MDS_VARIABLES().zutiBombsSupply_Blue[4] = 0;
            }

            if (requestedBombs[5] <= Mission.MDS_VARIABLES().zutiBombsSupply_Blue[5]) Mission.MDS_VARIABLES().zutiBombsSupply_Blue[5] -= requestedBombs[5];
            else {
