...
public class MGunHo301s extends MGunAircraftGeneric {
    public GunProperties createProperties() {
        ...
        gunproperties.bullet[0].massa = 0.652F;
        gunproperties.bullet[0].kalibr = 0.0009035401F;
        gunproperties.bullet[0].speed = 220F;
        gunproperties.bullet[0].power = 0.095F;
        gunproperties.bullet[0].powerType = 0;
        gunproperties.bullet[0].powerRadius = 8F;
