...
public class JU_88A4 extends JU_88NEW implements TypeBomber, TypeDiveBomber, TypeScout {
    ...
    public void onAircraftLoaded() {
        ...
        } else if (this.thisWeaponsName.startsWith("28xSC50") || this.thisWeaponsName.startsWith("18xSC50") || this.thisWeaponsName.startsWith("6xSC250")) this.needsToOpenBombays = true;
    }
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitJU_88A4.class, CockpitJU_88A4_Bombardier.class, CockpitJU_88A4_NGunner.class, CockpitJU_88A4_RGunner.class, CockpitJU_88A4_BGunner.class });
        Property.set(class1, "LOSElevation", 1.0976F);
        weaponTriggersRegister(class1, new int[] { 10, 11, 12, 13, 13, 3, 3, 3, 3, 3, 3 });
        weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_BombSpawn01", "_BombSpawn02" });
    }
}
