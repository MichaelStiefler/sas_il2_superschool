...
public abstract class Bloch2xx extends Scheme2 {
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        ...
        hiermesh.chunkSetAngles("GearL3B_D0", 0.0F, 130F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, -30F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL4B_D0", 0.0F, 130F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, -130F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR3B_D0", 0.0F, 130F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, -30F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR4B_D0", 0.0F, 130F * f, 0.0F);
    }

    protected void moveGear(float f) {
        Bloch2xx.moveGear(this.hierMesh(), f);
    }
    ...
    public void moveCockpitDoor(float f) {
        Aircraft.xyz[1] = Aircraft.cvt(f, 0.01F, 1.0F, 0.0F, -0.2F);
        this.hierMesh().chunkSetLocate("Turret3AExt_D0", Aircraft.xyz, Aircraft.ypr);
        this.resetYPRmodifier();
        Aircraft.xyz[1] = Aircraft.cvt(f, 0.01F, 1.0F, 0.0F, 0.1F);
        this.hierMesh().chunkSetLocate("Turret3ABase_D0", Aircraft.xyz, Aircraft.ypr);
        this.resetYPRmodifier();
        Aircraft.xyz[1] = Aircraft.cvt(f, 0.01F, 1.0F, 0.0F, -0.1F);
        this.hierMesh().chunkSetLocate("Turret2ABase_D0", Aircraft.xyz, Aircraft.ypr);
