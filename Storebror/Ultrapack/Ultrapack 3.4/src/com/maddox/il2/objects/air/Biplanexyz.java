...
public abstract class Biplanexyz extends Scheme1 implements TypeScout, TypeBomber, TypeStormovik {
    ...
    private void moveGunner() {
        if (this.gunnerDead || this.gunnerEjected || this.FM.turret.length < 1) {
            return;
        }
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (!flag1 || this.gunnerDead) {
            if (this.FM.turret.length > 0) this.FM.turret[0].bIsOperable = false;
        }
