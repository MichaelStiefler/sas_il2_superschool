    ...
    private class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitLN_411.this.fm != null) {
                ...
                CockpitLN_411.this.setNew.azimuth = (0.97F * CockpitLN_411.this.setOld.azimuth) + (0.03F * -CockpitLN_411.this.fm.Or.getYaw());
                if ((CockpitLN_411.this.setOld.azimuth > 270F) && (CockpitLN_411.this.setNew.azimuth < 90F)) {
                    CockpitLN_411.this.setOld.azimuth -= 360F;
                }
                if ((CockpitLN_411.this.setOld.azimuth < 90F) && (CockpitLN_411.this.setNew.azimuth > 270F)) {
                    CockpitLN_411.this.setOld.azimuth += 360F;
                }
                CockpitLN_411.this.setNew.waypointAzimuth = (0.91F * CockpitLN_411.this.setOld.waypointAzimuth) + (0.09F * (CockpitLN_411.this.waypointAzimuth() - CockpitLN_411.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
