        ...
        public boolean tick() {
            if (CockpitSpitF21.this.fm != null) {
                ...
                if (Math.abs(CockpitSpitF21.this.fm.Or.getKren()) < 30F) {
                    CockpitSpitF21.this.setNew.azimuth = (0.97F * CockpitSpitF21.this.setOld.azimuth) + (0.03F * -CockpitSpitF21.this.fm.Or.getYaw());
                }
                if ((CockpitSpitF21.this.setOld.azimuth > 270F) && (CockpitSpitF21.this.setNew.azimuth < 90F)) {
                    CockpitSpitF21.this.setOld.azimuth -= 360F;
                }
                if ((CockpitSpitF21.this.setOld.azimuth < 90F) && (CockpitSpitF21.this.setNew.azimuth > 270F)) {
                    CockpitSpitF21.this.setOld.azimuth += 360F;
                }
                CockpitSpitF21.this.setNew.waypointAzimuth = (0.91F * CockpitSpitF21.this.setOld.waypointAzimuth) + (0.09F * (CockpitSpitF21.this.waypointAzimuth() - CockpitSpitF21.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
