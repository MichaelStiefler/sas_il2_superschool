...
public class MGun105mm extends MGunAircraftGeneric {
    public GunProperties createProperties() {
        ...
        gunproperties.shotFreq = 0.1433333F;
        ...
        gunproperties.bullet[0].power = 25F;
        gunproperties.bullet[0].powerType = 0;
        gunproperties.bullet[0].powerRadius = 30F;
