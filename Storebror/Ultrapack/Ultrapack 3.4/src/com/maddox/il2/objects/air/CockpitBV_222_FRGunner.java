...
public class CockpitBV_222_FRGunner extends CockpitGunner {
    ...
    public CockpitBV_222_FRGunner() {
        super("3DO/Cockpit/He-111H-2-RGun/FRGunnerBV222.him", "he111_gunner");
        this.hook1 = null;
        this.iCocking = 0;
        this.iOldVisDrums = 2;
        this.iNewVisDrums = 2;
    ...
    static {
        Property.set(CockpitBV_222_FRGunner.class, "aiTuretNum", 1);
        Property.set(CockpitBV_222_FRGunner.class, "weaponControlNum", 11);
        Property.set(CockpitBV_222_FRGunner.class, "astatePilotIndx", 4);
    }
}
