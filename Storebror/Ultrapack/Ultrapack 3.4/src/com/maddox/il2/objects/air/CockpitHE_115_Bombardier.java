...
public class CockpitHE_115_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            float f = ((HE_115) CockpitHE_115_Bombardier.this.aircraft()).fSightCurForwardAngle;
            float f1 = ((HE_115) CockpitHE_115_Bombardier.this.aircraft()).fSightCurSideslip;
            CockpitHE_115_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
            if (CockpitHE_115_Bombardier.this.bEntered) {
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(CockpitHE_115_Bombardier.this.aAim + 10F * f1, CockpitHE_115_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitHE_115_Bombardier() {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bEntered) {
            this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((HE_115) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((HE_115) this.aircraft()).fSightCurReadyness > 0.93F;
    ...
    static {
        Property.set(CockpitHE_115_Bombardier.class, "astatePilotIndx", 0);
    }
}
