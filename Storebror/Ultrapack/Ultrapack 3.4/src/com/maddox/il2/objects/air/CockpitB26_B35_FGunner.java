...
public class CockpitB26_B35_FGunner extends CockpitGunner {
    ...
    public CockpitB26_B35_FGunner() {
        super("3DO/Cockpit/B-26B35-FGun/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB26_B35_FGunner.speedometerScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1", 0.0F, this.floatindex(this.cvt(this.fm.getSpeedKMH(), 0.0F, 836.859F, 0.0F, 13F), CockpitB26_B35_FGunner.speedometerScale), 0.0F);
        ...
        if (waypoint != null) {
            waypoint.getP(CockpitB26_B35_FGunner.P1);
            CockpitB26_B35_FGunner.V.sub(CockpitB26_B35_FGunner.P1, this.fm.Loc);
            float f2 = (float) (Math.toDegrees(Math.atan2(CockpitB26_B35_FGunner.V.x, CockpitB26_B35_FGunner.V.y)));
    ...
    static {
        Property.set(CockpitB26_B35_FGunner.class, "aiTuretNum", 0);
        Property.set(CockpitB26_B35_FGunner.class, "weaponControlNum", 10);
        Property.set(CockpitB26_B35_FGunner.class, "astatePilotIndx", 2);
    }
}
