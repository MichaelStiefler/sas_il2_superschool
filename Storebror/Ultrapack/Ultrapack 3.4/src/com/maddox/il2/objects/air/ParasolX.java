...
public abstract class ParasolX extends Scheme1 implements TypeFighter, TypeTNBFighter {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.endsWith("p1")) {
                    this.getEnergyPastArmor(8.1D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
                }
                return;
            }
        ...
        if (s.startsWith("xcf") || s.startsWith("xcockpit")) {
            ...
            if (s.startsWith("xcockpit")) {
                ...
                } else if (((Tuple3d) (point3d)).x > -1.2D) {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.FM.isPlayers()) {
            if (!Main3D.cur3D().isViewOutside()) {
                ...
                this.hierMesh().chunkVisible("Cowling_D0", false);
...
//                hierMesh().chunkVisible("WingLMid_D2", false);
                ...
                this.hierMesh().chunkVisible("Cowling_D0", true);
            }
        }
    }
