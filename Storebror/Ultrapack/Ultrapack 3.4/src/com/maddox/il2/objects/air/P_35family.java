...
public abstract class P_35family extends Scheme1 implements TypeFighter, TypeStormovik {
    ...
    protected void moveGear(float f) {
        P_35family.moveGear(this.hierMesh(), f);
    }
    ...
    public void update(float f) {
        for (int i = 1; i < 7; i++) {
            this.hierMesh().chunkSetAngles("RadiatorL" + i + "_D0", 0.0F, 15F * this.FM.EI.engines[0].getControlRadiator(), 0.0F);
            this.hierMesh().chunkSetAngles("RadiatorR" + i + "_D0", 0.0F, 15F * this.FM.EI.engines[0].getControlRadiator(), 0.0F);
        }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        System.out.println("HitBone called! " + s1);
        System.out.println("IN: " + shot.power);
        if (s1.startsWith("xx")) {
        ...
        System.out.println("OUT: " + shot.power);
    }
...
//        System.out.println(s);
    ...
    static {
        Property.set(P_35family.class, "originCountry", PaintScheme.countryUSA);
    }
}
