...
public class Hudson_MkIII extends Hudson123 implements TypeStormovik, TypeBomber {
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) this.fSightCurReadyness += 0.0333333F * f;
            ...
            if (this.fSightCurDistance < Hudson_MkIII.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(Hudson_MkIII.toMeters(this.fSightCurAltitude) * (2F / 9.81F))) this.bSightBombDump = true;
