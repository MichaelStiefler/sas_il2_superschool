...
public class CockpitWalrus_NGunner extends CockpitGunner {
    ...
    public CockpitWalrus_NGunner() {
        super("3DO/Cockpit/Walrus-NGun/NGunnerWalrus.him", "i16");
        this.hook1 = null;
        this.hook2 = null;
    ...
    static {
        Property.set(CockpitWalrus_NGunner.class, "aiTuretNum", 0);
        Property.set(CockpitWalrus_NGunner.class, "weaponControlNum", 10);
        Property.set(CockpitWalrus_NGunner.class, "astatePilotIndx", 1);
    }
}
