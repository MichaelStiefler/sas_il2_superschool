        ...
        public boolean tick() {
            ...
            if (CockpitOspreyL.this.fm != null) {
                ...
                if (Math.abs(CockpitOspreyL.this.fm.Or.getKren()) < 30F) {
                    CockpitOspreyL.this.setNew.azimuth = ((35F * CockpitOspreyL.this.setOld.azimuth) + -CockpitOspreyL.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitOspreyL.this.setOld.azimuth > 270F) && (CockpitOspreyL.this.setNew.azimuth < 90F)) {
                    CockpitOspreyL.this.setOld.azimuth -= 360F;
                }
                if ((CockpitOspreyL.this.setOld.azimuth < 90F) && (CockpitOspreyL.this.setNew.azimuth > 270F)) {
                    CockpitOspreyL.this.setOld.azimuth += 360F;
                }
                CockpitOspreyL.this.setNew.waypointAzimuth = ((10F * CockpitOspreyL.this.setOld.waypointAzimuth) + (CockpitOspreyL.this.waypointAzimuth() - CockpitOspreyL.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
