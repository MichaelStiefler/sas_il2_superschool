...
public class CockpitB5N1_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if ((CockpitB5N1_Bombardier.this.ac != null) && CockpitB5N1_Bombardier.this.ac.bChangedPit) {
                CockpitB5N1_Bombardier.this.reflectPlaneToModel();
                CockpitB5N1_Bombardier.this.ac.bChangedPit = false;
            }
            if (CockpitB5N1_Bombardier.this.fm != null) {
                CockpitB5N1_Bombardier.this.setTmp = CockpitB5N1_Bombardier.this.setOld;
                CockpitB5N1_Bombardier.this.setOld = CockpitB5N1_Bombardier.this.setNew;
                CockpitB5N1_Bombardier.this.setNew = CockpitB5N1_Bombardier.this.setTmp;
                if (CockpitB5N1_Bombardier.this.bEntered) {
                    float f = ((B5N1) CockpitB5N1_Bombardier.this.aircraft()).fSightCurForwardAngle + 3.2F;
                    float f1 = -((B5N1) CockpitB5N1_Bombardier.this.aircraft()).fSightCurSideslip;
                    CockpitB5N1_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                    HookPilot hookpilot = HookPilot.current;
                    hookpilot.setSimpleAimOrient(-f1, CockpitB5N1_Bombardier.this.tAim + f, 0.0F);
                }
                CockpitB5N1_Bombardier.this.setNew.azimuth.setDeg(CockpitB5N1_Bombardier.this.setOld.azimuth.getDeg(1.0F), CockpitB5N1_Bombardier.this.fm.Or.azimut());
                CockpitB5N1_Bombardier.this.setNew.altimeter = CockpitB5N1_Bombardier.this.fm.getAltitude();
                CockpitB5N1_Bombardier.this.setNew.flaps = (0.9F * CockpitB5N1_Bombardier.this.setOld.flaps) + (0.1F * CockpitB5N1_Bombardier.this.fm.CT.FlapsControl);
                CockpitB5N1_Bombardier.this.setNew.gear = (0.7F * CockpitB5N1_Bombardier.this.setOld.gear) + (0.3F * CockpitB5N1_Bombardier.this.fm.CT.GearControl);
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bEntered) {
            this.mesh.chunkSetAngles("zMark1", ((B5N1) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
            float f1 = this.cvt(((B5N1) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
        ...
        this.mesh.chunkSetAngles("Z_Need_Navairspeed", 0.0F, this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 30F), CockpitB5N1_Bombardier.speedometerScale), 0.0F);
        ...
        if (f2 > 0.0F) {
            this.mesh.chunkSetAngles("Z_Need_FreeairTemp", 0.0F, this.cvt(f2, 0.0F, 40F, 0.0F, 32F), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_Need_FreeairTemp", 0.0F, this.cvt(f2, -60F, 0.0F, -48F, 0.0F), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Torpedosight", this.cvt(((B5N1) this.aircraft()).fSightCurSideslip, -40F, 40F, -48F, 48F), 0.0F, 0.0F);
        if ((this.aircraft().FM.CT.Weapons[10] != null) && (this.aircraft().FM.CT.Weapons[10][0] != null)) {
            ...
            for (int k = 1; k < 6; k++) {
                if (k < i) {
                    this.mesh.chunkVisible("T92Spare" + k, true);
                } else {
                    this.mesh.chunkVisible("T92Spare" + k, false);
                }
            }
    ...
    static {
        Property.set(CockpitB5N1_Bombardier.class, "astatePilotIndx", 0);
        Property.set(CockpitB5N1_Bombardier.class, "normZNs", new float[] { 0.7F, 0.45F, 0.7F, 0.45F });
        Property.set(CockpitB5N1_Bombardier.class, "gsZN", 0.5F);
    }
