...
public abstract class AT_32xyz extends Scheme2 implements TypeTransport {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        } else if (s.startsWith("xwingcin")) {
            if (this.chunkDamageVisible("WingCIn") < 2) {
                this.hitChunk("WingCIn", shot);
            }
    ...
    static {
        Property.set(AT_32xyz.class, "originCountry", PaintScheme.countryUSA);
    }
}
