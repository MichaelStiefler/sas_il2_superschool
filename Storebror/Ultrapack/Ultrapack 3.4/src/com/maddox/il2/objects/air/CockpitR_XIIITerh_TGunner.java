...
public class CockpitR_XIIITerh_TGunner extends CockpitGunner {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitR_XIIITerh_TGunner.this.bNeedSetUp) {
                CockpitR_XIIITerh_TGunner.this.reflectPlaneMats();
                CockpitR_XIIITerh_TGunner.this.bNeedSetUp = false;
            }
            if (R_XIIIxyz.bChangedPit) {
                CockpitR_XIIITerh_TGunner.this.reflectPlaneToModel();
                R_XIIIxyz.bChangedPit = false;
            }
            CockpitR_XIIITerh_TGunner.this.setTmp = CockpitR_XIIITerh_TGunner.this.setOld;
            CockpitR_XIIITerh_TGunner.this.setOld = CockpitR_XIIITerh_TGunner.this.setNew;
            CockpitR_XIIITerh_TGunner.this.setNew = CockpitR_XIIITerh_TGunner.this.setTmp;
            CockpitR_XIIITerh_TGunner.this.setNew.altimeter = CockpitR_XIIITerh_TGunner.this.fm.getAltitude();
            if (Math.abs(CockpitR_XIIITerh_TGunner.this.fm.Or.getKren()) < 30F) {
                CockpitR_XIIITerh_TGunner.this.setNew.azimuth = ((35F * CockpitR_XIIITerh_TGunner.this.setOld.azimuth) + CockpitR_XIIITerh_TGunner.this.fm.Or.azimut()) / 36F;
            }
            if ((CockpitR_XIIITerh_TGunner.this.setOld.azimuth > 270F) && (CockpitR_XIIITerh_TGunner.this.setNew.azimuth < 90F)) {
                CockpitR_XIIITerh_TGunner.this.setOld.azimuth -= 360F;
            }
            if ((CockpitR_XIIITerh_TGunner.this.setOld.azimuth < 90F) && (CockpitR_XIIITerh_TGunner.this.setNew.azimuth > 270F)) {
                CockpitR_XIIITerh_TGunner.this.setOld.azimuth += 360F;
            }
            CockpitR_XIIITerh_TGunner.this.setNew.mix = ((10F * CockpitR_XIIITerh_TGunner.this.setOld.mix) + CockpitR_XIIITerh_TGunner.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitR_XIIITerh_TGunner.this.setNew.throttle = ((10F * CockpitR_XIIITerh_TGunner.this.setOld.throttle) + CockpitR_XIIITerh_TGunner.this.fm.CT.PowerControl) / 11F;
            CockpitR_XIIITerh_TGunner.this.w.set(CockpitR_XIIITerh_TGunner.this.fm.getW());
            CockpitR_XIIITerh_TGunner.this.fm.Or.transform(CockpitR_XIIITerh_TGunner.this.w);
            CockpitR_XIIITerh_TGunner.this.setNew.turn = ((33F * CockpitR_XIIITerh_TGunner.this.setOld.turn) + CockpitR_XIIITerh_TGunner.this.w.z) / 34F;
            return true;
        }
    ...
    public CockpitR_XIIITerh_TGunner() {
        super("3DO/Cockpit/R-XIIITer/hiergun.him", "i16");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 260F, 0.0F, 13F), CockpitR_XIIITerh_TGunner.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2600F, 0.0F, 13F), CockpitR_XIIITerh_TGunner.rpmScale), 0.0F);
    ...
    static {
        Property.set(CockpitR_XIIITerh_TGunner.class, "aiTuretNum", 0);
        Property.set(CockpitR_XIIITerh_TGunner.class, "weaponControlNum", 10);
        Property.set(CockpitR_XIIITerh_TGunner.class, "astatePilotIndx", 1);
    }
