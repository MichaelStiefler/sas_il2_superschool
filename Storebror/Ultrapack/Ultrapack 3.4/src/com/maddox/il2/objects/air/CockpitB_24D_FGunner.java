...
public class CockpitB_24D_FGunner extends CockpitGunner {
    ...
    static {
        Property.set(CockpitB_24D_FGunner.class, "aiTuretNum", 0);
        Property.set(CockpitB_24D_FGunner.class, "weaponControlNum", 10);
        Property.set(CockpitB_24D_FGunner.class, "astatePilotIndx", 2);
    }
}
