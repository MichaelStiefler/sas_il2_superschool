...
public class Bomb40lbsFmkIPara extends Bomb {

    public Bomb40lbsFmkIPara() {
        this.chute = null;
        this.bOnChute = false;
    }
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            this.getSpeed(Bomb40lbsFmkIPara.v3d);
            Bomb40lbsFmkIPara.v3d.scale(0.97D);
            if (Bomb40lbsFmkIPara.v3d.z < -2D) {
                Bomb40lbsFmkIPara.v3d.z += 1.1F * Time.tickConstLenFs();
            }
            this.setSpeed(Bomb40lbsFmkIPara.v3d);
    ...
    static {
        Class class1 = Bomb40lbsFmkIPara.class;
        Property.set(class1, "mesh", "3DO/Arms/40lbs_F_MkI_Para/mono.sim");
