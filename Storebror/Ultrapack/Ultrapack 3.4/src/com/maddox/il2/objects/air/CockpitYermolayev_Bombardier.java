...
public class CockpitYermolayev_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitYermolayev_Bombardier.this.bEntered) {
                float f = ((Yermolayev) CockpitYermolayev_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((Yermolayev) CockpitYermolayev_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitYermolayev_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(-f1, CockpitYermolayev_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitYermolayev_Bombardier() {
        super("3DO/Cockpit/Yer-2-Bombardier/hier.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((Yermolayev) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((Yermolayev) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitYermolayev_Bombardier.class, "astatePilotIndx", 0);
    }
}
