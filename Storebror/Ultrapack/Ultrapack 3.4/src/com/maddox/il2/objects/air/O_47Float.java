...
public class O_47Float extends O_47F {
    static {
        Class class1 = O_47Float.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "O-47");
        Property.set(class1, "meshName", "3DO/Plane/O-47/hierFloat.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar02());
        Property.set(class1, "yearService", 1938F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/O47float.fmd");
