...
public class A_20B extends A_20 implements TypeBomber, TypeStormovik {
    ...
    static {
        Class class1 = A_20B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "A-20");
        Property.set(class1, "meshName", "3DO/Plane/A-20B(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "meshName_fr", "3DO/Plane/A-20B(fr)/hier.him");
        Property.set(class1, "PaintScheme_fr", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1940F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/A-20B.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitA_20C.class, CockpitA_20B_Bombardier.class, CockpitA_20B_TGunner.class, CockpitA_20C_BGunner.class });
        Property.set(class1, "LOSElevation", 0.92575F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 10, 11, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN08", "_MGUN09", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05" });
    }
}
