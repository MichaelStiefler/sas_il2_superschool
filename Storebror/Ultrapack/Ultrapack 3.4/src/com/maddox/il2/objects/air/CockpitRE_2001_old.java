...
public class CockpitRE_2001_old extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitRE_2001_old.this.bNeedSetUp) {
                CockpitRE_2001_old.this.reflectPlaneMats();
                CockpitRE_2001_old.this.bNeedSetUp = false;
            }
            CockpitRE_2001_old.this.setTmp = CockpitRE_2001_old.this.setOld;
            CockpitRE_2001_old.this.setOld = CockpitRE_2001_old.this.setNew;
            CockpitRE_2001_old.this.setNew = CockpitRE_2001_old.this.setTmp;
            if (((CockpitRE_2001_old.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitRE_2001_old.this.setNew.stbyPosition < 1.0F)) {
                CockpitRE_2001_old.this.delay--;
                if (CockpitRE_2001_old.this.delay <= 0) {
                    CockpitRE_2001_old.this.setNew.stbyPosition = CockpitRE_2001_old.this.setOld.stbyPosition + 0.03F;
                    CockpitRE_2001_old.this.setOld.stbyPosition = CockpitRE_2001_old.this.setNew.stbyPosition;
                    CockpitRE_2001_old.this.sightDamaged = true;
                }
            }
            if (CockpitRE_2001_old.this.fm.CT.getRadiator() < CockpitRE_2001_old.this.currentRadiator) {
                CockpitRE_2001_old.this.radiatorDelta = -1;
            } else if (CockpitRE_2001_old.this.fm.CT.getRadiator() > CockpitRE_2001_old.this.currentRadiator) {
                CockpitRE_2001_old.this.radiatorDelta = 1;
            }
            if ((CockpitRE_2001_old.this.radiator > 1.0F) || (CockpitRE_2001_old.this.radiator < -1F)) {
                CockpitRE_2001_old.this.radiatorDelta = 0;
            }
            if (CockpitRE_2001_old.this.radiatorDelta != 0) {
                CockpitRE_2001_old.this.radiator += CockpitRE_2001_old.this.radiatorDelta * 0.2F;
            } else if (CockpitRE_2001_old.this.currentRadiator == CockpitRE_2001_old.this.fm.CT.getRadiator()) {
                CockpitRE_2001_old.this.radiator *= 0.5F;
            }
            CockpitRE_2001_old.this.currentRadiator = CockpitRE_2001_old.this.fm.CT.getRadiator();
            CockpitRE_2001_old.this.setNew.altimeter = CockpitRE_2001_old.this.fm.getAltitude();
            CockpitRE_2001_old.this.setNew.throttle = ((10F * CockpitRE_2001_old.this.setOld.throttle) + CockpitRE_2001_old.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitRE_2001_old.this.setNew.mix = ((10F * CockpitRE_2001_old.this.setOld.mix) + CockpitRE_2001_old.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitRE_2001_old.this.setNew.prop = ((10F * CockpitRE_2001_old.this.setOld.prop) + CockpitRE_2001_old.this.fm.EI.engines[0].getControlProp()) / 11F;
            CockpitRE_2001_old.this.pictGear = (0.85F * CockpitRE_2001_old.this.pictGear) + (0.15F * CockpitRE_2001_old.this.fm.CT.GearControl);
            CockpitRE_2001_old.this.w.set(CockpitRE_2001_old.this.fm.getW());
            CockpitRE_2001_old.this.fm.Or.transform(CockpitRE_2001_old.this.w);
            CockpitRE_2001_old.this.setNew.turn = ((12F * CockpitRE_2001_old.this.setOld.turn) + CockpitRE_2001_old.this.w.z) / 13F;
            CockpitRE_2001_old.this.setNew.vspeed = ((299F * CockpitRE_2001_old.this.setOld.vspeed) + CockpitRE_2001_old.this.fm.getVertSpeed()) / 300F;
            if (CockpitRE_2001_old.this.flaps == CockpitRE_2001_old.this.fm.CT.getFlap()) {
                CockpitRE_2001_old.this.flapsDirection = 0;
                CockpitRE_2001_old.this.sfxStop(16);
            } else if (CockpitRE_2001_old.this.flaps < CockpitRE_2001_old.this.fm.CT.getFlap()) {
                if (CockpitRE_2001_old.this.flapsDirection == 0) {
                    CockpitRE_2001_old.this.sfxStart(16);
                }
                CockpitRE_2001_old.this.flaps = CockpitRE_2001_old.this.fm.CT.getFlap();
                CockpitRE_2001_old.this.flapsDirection = 1;
                CockpitRE_2001_old.this.flapsLeverAngle += CockpitRE_2001_old.this.flapsIncrement;
            } else if (CockpitRE_2001_old.this.flaps > CockpitRE_2001_old.this.fm.CT.getFlap()) {
                if (CockpitRE_2001_old.this.flapsDirection == 0) {
                    CockpitRE_2001_old.this.sfxStart(16);
                }
            ...
            if (!CockpitRE_2001_old.this.fm.Gears.bTailwheelLocked && (CockpitRE_2001_old.this.tailWheelLock < 1.0F)) {
                CockpitRE_2001_old.this.tailWheelLock += 0.1F;
            } else if (CockpitRE_2001_old.this.fm.Gears.bTailwheelLocked && (CockpitRE_2001_old.this.tailWheelLock > 0.0F)) {
                CockpitRE_2001_old.this.tailWheelLock -= 0.1F;
            }
            CockpitRE_2001_old.this.updateCompass();
            return true;
        }
    ...
    private class Variables {
        ...
        private Variables() {
            ...
            this.compassPoint[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ)), CockpitRE_2001_old.compassZ);
            this.compassPoint[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ)), 0.0D, CockpitRE_2001_old.compassZ);
            this.compassPoint[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ)), CockpitRE_2001_old.compassZ);
            this.compassPoint[3] = new Vector3d(Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ)), 0.0D, CockpitRE_2001_old.compassZ);
            this.cP[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ)), CockpitRE_2001_old.compassZ);
            this.cP[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ)), 0.0D, CockpitRE_2001_old.compassZ);
            this.cP[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ)), CockpitRE_2001_old.compassZ);
            this.cP[3] = new Vector3d(Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ)), 0.0D, CockpitRE_2001_old.compassZ);
        }
    }

    public CockpitRE_2001_old() {
        super("3DO/Cockpit/Re2000/hier2001.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_need_oiltemp_01", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 150F, 0.0F, 12F), CockpitRE_2001_old.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_need_oiltemp_02", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 30F, 150F, 0.0F, 12F), CockpitRE_2001_old.oilTempScale), 0.0F, 0.0F);
    ...
    private void initCompass() {
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (CockpitRE_2001_old.compassZ * CockpitRE_2001_old.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.01745328888888889D * CockpitRE_2001_old.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-CockpitRE_2001_old.compassZ * 0.7D)) {
            this.accel.scale((-CockpitRE_2001_old.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d2.normalize();
        vector3d2.scale(-CockpitRE_2001_old.compassZ);
