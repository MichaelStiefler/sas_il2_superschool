...
public class BombMichelinVM extends Bomb {

    public BombMichelinVM() {
        this.chute = null;
        this.bOnChute = false;
    }
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            ...
            this.chute.pos.setRel(new Point3d(0.5D, 0.0D, 0.0D), new Orient(0.0F, 0.0F, 0.0F));
        }
    ...
    static {
        Class class1 = BombMichelinVM.class;
        Property.set(class1, "mesh", "3DO/Arms/Michelin_VM/mono.sim");
