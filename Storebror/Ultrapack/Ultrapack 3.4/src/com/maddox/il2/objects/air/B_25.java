    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                if (s.endsWith("p1") || s.endsWith("p2")) if (Math.abs(v1.x) > 0.5D) this.getEnergyPastArmor(7.94D / Math.abs(v1.x), shot);
                else this.getEnergyPastArmor(9.53D / (1.0D - Math.abs(v1.x)), shot);
                if (s.endsWith("p3")) this.getEnergyPastArmor(7.94D / (Math.abs(v1.z) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("p4")) this.getEnergyPastArmor(9.53D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("p5") || s.endsWith("p6")) this.getEnergyPastArmor(9.53D / (Math.abs(v1.y) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("p7")) this.getEnergyPastArmor(0.5D / (Math.abs(v1.z) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("p8")) this.getEnergyPastArmor(9.53D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("a1")) this.getEnergyPastArmor(9.53D / (Math.abs(v1.y) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("a2")) this.getEnergyPastArmor(9.53D / (Math.abs(v1.y) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("a3")) this.getEnergyPastArmor(6.35D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("a4") || s.endsWith("a5")) this.getEnergyPastArmor(12.7D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("a6") || s.endsWith("a7")) this.getEnergyPastArmor(6.35D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("r1")) this.getEnergyPastArmor(3.17D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("r2") || s.endsWith("r3")) this.getEnergyPastArmor(9.53D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                if (s.endsWith("c1") || s.endsWith("c2")) this.getEnergyPastArmor(8.73D / (Math.abs(v1.x) + 9.9999999747524271E-007D), shot);
                return;
            }
