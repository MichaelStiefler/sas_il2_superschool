        ...
        public boolean tick() {
            ...
            if (CockpitSpitF24.this.fm != null) {
                ...
                if (Math.abs(CockpitSpitF24.this.fm.Or.getKren()) < 30F) {
                    CockpitSpitF24.this.setNew.azimuth = (0.97F * CockpitSpitF24.this.setOld.azimuth) + (0.03F * -CockpitSpitF24.this.fm.Or.getYaw());
                }
                if ((CockpitSpitF24.this.setOld.azimuth > 270F) && (CockpitSpitF24.this.setNew.azimuth < 90F)) {
                    CockpitSpitF24.this.setOld.azimuth -= 360F;
                }
                if ((CockpitSpitF24.this.setOld.azimuth < 90F) && (CockpitSpitF24.this.setNew.azimuth > 270F)) {
                    CockpitSpitF24.this.setOld.azimuth += 360F;
                }
                CockpitSpitF24.this.setNew.waypointAzimuth = (0.91F * CockpitSpitF24.this.setOld.waypointAzimuth) + (0.09F * (CockpitSpitF24.this.waypointAzimuth() - CockpitSpitF24.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
