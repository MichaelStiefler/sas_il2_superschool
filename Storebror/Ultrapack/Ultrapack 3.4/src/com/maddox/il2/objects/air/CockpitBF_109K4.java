...
public class CockpitBF_109K4 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitBF_109K4.this.cockpitDimControl) {
                if (CockpitBF_109K4.this.setNew.dimPosition > 0.0F) CockpitBF_109K4.this.setNew.dimPosition = CockpitBF_109K4.this.setOld.dimPosition - 0.05F;
            } else if (CockpitBF_109K4.this.setNew.dimPosition < 1.0F) CockpitBF_109K4.this.setNew.dimPosition = CockpitBF_109K4.this.setOld.dimPosition + 0.05F;
            ...
            } else CockpitBF_109K4.this.setNew.waypointAzimuth.setDeg(CockpitBF_109K4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBF_109K4.this.setOld.azimuth.getDeg(1.0F));
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Variometr", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), variometerScale));
        ...
        if (this.gun[2] != null) this.mesh.chunkSetAngles("Z_AmmoCounter2", this.cvt(this.gun[2].countBullets(), 0.0F, 500F, 15F, 0.0F), 0.0F, 0.0F);
