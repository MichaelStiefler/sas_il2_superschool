...
public class PE_2SERIES354 extends PE_2 implements TypeBomber, TypeDiveBomber, TypeTransport {

    public PE_2SERIES354() {
    ...
    public void update(float f) {
        if (!this.FM.turret[1].bIsAIControlled) {
            if (!this.hierMesh().isChunkVisible("Pilot3a_D0")) this.setRadist(1);
            ...
            if (this.FM.turret.length != 0) {
                ...
                if (actor == null) this.setRadist(0);
                    ...
                    else if (Aircraft.tmpLoc3.getPoint().y < 0.0D) this.setRadist(2);
                    else this.setRadist(3);
                }
            }
        }
        super.update(f);
    ...
    static {
        Class class1 = PE_2SERIES354.class;
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPE2_359.class, CockpitPE2_Bombardier.class, CockpitPE2_359_TGunner.class, CockpitPE2_BGunner.class });
