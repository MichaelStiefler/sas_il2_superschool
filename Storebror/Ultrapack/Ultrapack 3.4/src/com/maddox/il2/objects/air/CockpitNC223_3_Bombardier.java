...
public class CockpitNC223_3_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitNC223_3_Bombardier.this.bEntered) {
                float f = ((NC223_3xyz) ((NC223_3) CockpitNC223_3_Bombardier.this.aircraft())).fSightCurForwardAngle;
                float f1 = -((NC223_3xyz) ((NC223_3) CockpitNC223_3_Bombardier.this.aircraft())).fSightCurSideslip;
                CockpitNC223_3_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitNC223_3_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitNC223_3_Bombardier() {
        super("3DO/Cockpit/NC220-Bombardier/hier.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((NC223_3xyz) ((NC223_3) this.aircraft())).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((NC223_3xyz) ((NC223_3) this.aircraft())).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitNC223_3_Bombardier.class, "astatePilotIndx", 0);
    }
