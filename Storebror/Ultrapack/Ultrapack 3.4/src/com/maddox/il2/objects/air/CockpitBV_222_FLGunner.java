...
public class CockpitBV_222_FLGunner extends CockpitGunner {
    ...
    static {
        Property.set(CockpitBV_222_FLGunner.class, "aiTuretNum", 0);
        Property.set(CockpitBV_222_FLGunner.class, "weaponControlNum", 10);
        Property.set(CockpitBV_222_FLGunner.class, "astatePilotIndx", 3);
    }
}
