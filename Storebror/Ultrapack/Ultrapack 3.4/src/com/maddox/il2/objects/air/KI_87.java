...
public abstract class KI_87 extends Scheme1 implements TypeFighter {
    ...
    public static void moveGear(HierMesh hiermesh, float leftGearPos, float rightGearPos, float tailWheelPos) {
        hiermesh.chunkSetAngles("GearC3_D0", 0.0F, CommonTools.smoothCvt(tailWheelPos, 0.01F, 0.4F, 0F, -80F), 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, CommonTools.smoothCvt(tailWheelPos, 0.01F, 0.4F, 0F, -80F), 0.0F);
        Aircraft.xyz[0] = Aircraft.xyz[1] = Aircraft.xyz[2] = Aircraft.ypr[0] = Aircraft.ypr[1] = Aircraft.ypr[2] = 0F;
        Aircraft.ypr[1] = CommonTools.smoothCvt(tailWheelPos, 0.15F, 0.99F, 0F, 90F);
        Aircraft.xyz[0] = CommonTools.smoothCvt(tailWheelPos, 0.3F, 0.99F, 0.05F, -0.4F);
        Aircraft.xyz[2] = CommonTools.smoothCvt(tailWheelPos, 0.3F, 0.99F, 0.1F, -0.2F);
        hiermesh.chunkSetLocate("GearC2_D0", Aircraft.xyz, Aircraft.ypr);
        hiermesh.chunkSetAngles("GearC99_D0", 0.0F, 0.0F, 0.0F);

        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, CommonTools.smoothCvt(leftGearPos, 0.15F, 0.99F, 0F, 92F), 0.0F);
        hiermesh.chunkSetAngles("GearL3_D0", 0.0F, CommonTools.smoothCvt(leftGearPos, 0.15F, 0.99F, 0F, -45F), 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, CommonTools.smoothCvt(leftGearPos, 0.01F, 0.2F, 0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearL4b_D0", 0.0F, CommonTools.smoothCvt(leftGearPos, 0.01F, 0.2F, 0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearL5_D0", 0.0F, CommonTools.smoothCvt(leftGearPos, 0.25F, 0.99F, 0F, -90F), 0.0F);

        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, CommonTools.smoothCvt(rightGearPos, 0.15F, 0.99F, 0F, 92F), 0.0F);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, CommonTools.smoothCvt(rightGearPos, 0.15F, 0.99F, 0F, -45F), 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, CommonTools.smoothCvt(rightGearPos, 0.01F, 0.2F, 0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearR4b_D0", 0.0F, CommonTools.smoothCvt(rightGearPos, 0.01F, 0.2F, 0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearR5_D0", 0.0F, CommonTools.smoothCvt(rightGearPos, 0.25F, 0.99F, 0F, -90F), 0.0F);
    }

    protected void moveGear(float leftGearPos, float rightGearPos, float tailWheelPos) {
        KI_87.moveGear(this.hierMesh(), leftGearPos, rightGearPos, tailWheelPos);
    }
    ...
    public static void moveGear(HierMesh hiermesh, float gearPos) {
        KI_87.moveGear(hiermesh, gearPos, gearPos, gearPos); // re-route old style function calls to new code
    }

    protected void moveGear(float gearPos) {
        KI_87.moveGear(this.hierMesh(), gearPos);
    }

    // ************************************************************************************************

    public void moveSteering(float f) {
        if (this.FM.CT.GearControl > 0.99F) {
    ...
    public void moveWheelSink() {
        this.resetYPRmodifier();
        float gearL, gearR;
        if (KI_87.gearsSeparated) {
            gearL = this.FM.CT.getGearL();
            gearR = this.FM.CT.getGearR();
        } else {
            gearL = gearR = this.FM.CT.getGear();
        }
        Aircraft.xyz[1] = Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.17F, 0.0F, 0.1689F);
        Aircraft.ypr[1] = (-92.0F * gearL);
        this.hierMesh().chunkSetLocate("GearL5_D0", Aircraft.xyz, Aircraft.ypr);
        this.resetYPRmodifier();
        Aircraft.xyz[1] = Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.17F, 0.0F, -0.1689F);
        Aircraft.ypr[1] = (-92.0F * gearR);
    ...
    protected void moveFlap(float f) {
        float f1 = -60.0F * f;
        for (int i = 1; i < 5; i++) {
            this.hierMesh().chunkSetAngles("Flap" + i + "_D0", 0.0F, f1, 0.0F);
        }
    }
    ...
    public void update(float f) {
        float flappsPos = Aircraft.cvt(this.FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 0.0F, -25.0F);
        if (Math.abs(this.flapps - flappsPos) > 0.01F) {
            this.flapps = flappsPos;
            for (int i = 1; i < ((this instanceof KI_87_II)?11:8); i++) {
                this.hierMesh().chunkSetAngles("Water" + i + "_D0", 0.0F, flappsPos, 0.0F);
            }
        }
        super.update(f);
    ...
    static {
        if (BaseGameVersion.is412orLater()) {
            KI_87.gearsSeparated = true;
        } else {
            try {
                Controls.class.getMethod("getGearC", null);
                KI_87.gearsSeparated = true;
            } catch (Exception e) {
                KI_87.gearsSeparated = false;
            }
        }
        Property.set(KI_87.class, "originCountry", PaintScheme.countryJapan);
    }
}
