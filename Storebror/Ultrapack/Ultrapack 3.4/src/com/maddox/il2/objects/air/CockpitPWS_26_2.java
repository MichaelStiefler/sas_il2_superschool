    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (Math.abs(CockpitPWS_26_2.this.fm.Or.getKren()) < 30F) {
                CockpitPWS_26_2.this.setNew.azimuth = ((35F * CockpitPWS_26_2.this.setOld.azimuth) + CockpitPWS_26_2.this.fm.Or.azimut()) / 36F;
            }
            if ((CockpitPWS_26_2.this.setOld.azimuth > 270F) && (CockpitPWS_26_2.this.setNew.azimuth < 90F)) {
                CockpitPWS_26_2.this.setOld.azimuth -= 360F;
            }
            if ((CockpitPWS_26_2.this.setOld.azimuth < 90F) && (CockpitPWS_26_2.this.setNew.azimuth > 270F)) {
                CockpitPWS_26_2.this.setOld.azimuth += 360F;
            }
