...
public class CockpitHalifaxBMkII_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            float f = ((Halifax) CockpitHalifaxBMkII_Bombardier.this.aircraft()).fSightCurForwardAngle;
            float f1 = ((Halifax) CockpitHalifaxBMkII_Bombardier.this.aircraft()).fSightCurSideslip;
            CockpitHalifaxBMkII_Bombardier.this.mesh.chunkSetAngles("BlackBox", 0.0F, -f1, f);
            if (CockpitHalifaxBMkII_Bombardier.this.bEntered) HookPilot.current.setSimpleAimOrient(CockpitHalifaxBMkII_Bombardier.this.aAim + f1, CockpitHalifaxBMkII_Bombardier.this.tAim + f, 0.0F);
            return true;
        }
    ...
    public CockpitHalifaxBMkII_Bombardier() {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bEntered) {
            this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((Halifax) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((Halifax) this.aircraft()).fSightCurReadyness > 0.93F;
    ...
    static {
        Property.set(CockpitHalifaxBMkII_Bombardier.class, "astatePilotIndx", 0);
    }
}
