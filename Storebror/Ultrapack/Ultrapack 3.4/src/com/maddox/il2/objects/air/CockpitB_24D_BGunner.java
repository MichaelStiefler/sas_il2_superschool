...
public class CockpitB_24D_BGunner extends CockpitGunner {
    ...
    static {
        Property.set(CockpitB_24D_BGunner.class, "aiTuretNum", 2);
        Property.set(CockpitB_24D_BGunner.class, "weaponControlNum", 12);
        Property.set(CockpitB_24D_BGunner.class, "astatePilotIndx", 1);
    }
}
