...
public class CockpitMARTIN_167_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitMARTIN_167_Bombardier.this.bEntered) {
                float f = ((MARTIN_Maryland) CockpitMARTIN_167_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((MARTIN_Maryland) CockpitMARTIN_167_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitMARTIN_167_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitMARTIN_167_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitMARTIN_167_Bombardier() {
        super("3DO/Cockpit/M167-Bombardier/hier.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((MARTIN_Maryland) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((MARTIN_Maryland) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitMARTIN_167_Bombardier.class, "astatePilotIndx", 0);
    }
