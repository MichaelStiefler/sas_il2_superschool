...
public class CockpitB36_T5Gunner extends CockpitB36_Gunner {
    ...
    boolean clipAnglesTurret(Orient orient) {
        ...
        if (turretYaw > 0F) {
            if (this.fm.Gears.rgear && turretYaw > 25F && turretYaw < 50F) {
    ...
    public CockpitB36_T5Gunner() {
        super("3DO/Cockpit/B36-RemoteTurrets/T5Gunner.him", "he111_gunner", 13);
    }

    static {
        Class class1 = CockpitB36_T5Gunner.class;
        Property.set(class1, "aiTuretNum", 6);
        Property.set(class1, "weaponControlNum", 16);
