...
public abstract class Northropxyz extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeStormovikArmored {
    ...
    public void moveCockpitDoor(float f) {
        this.hierMesh().chunkSetAngles("Blister5_D0", 0.0F, Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, -25F), 0.0F);
        this.hierMesh().chunkSetAngles("TurretBomber_D0", 0.0F, Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, 20F), 0.0F);
        this.hierMesh().chunkSetAngles("TurretBase_D0", 0.0F, Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, 15F), 0.0F);
        Aircraft.xyz[1] = Aircraft.cvt(f, 0.01F, 1.0F, 0.0F, 0.5F);
        this.hierMesh().chunkSetLocate("Blister4_D0", Aircraft.xyz, Aircraft.ypr);
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xcf") || s.startsWith("xcockpit")) {
            ...
            if (s.startsWith("xcockpit")) {
                ...
                } else if (((Tuple3d) (point3d)).z < 0.593D) {
                    if (((Tuple3d) (point3d)).y > 0.0D) {
                        this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 4);
                    } else {
                        this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x10);
                    }
                } else if (((Tuple3d) (point3d)).x > -1.201D) {
    ...
    static {
        Property.set(Northropxyz.class, "originCountry", PaintScheme.countryUSA);
    }
}
