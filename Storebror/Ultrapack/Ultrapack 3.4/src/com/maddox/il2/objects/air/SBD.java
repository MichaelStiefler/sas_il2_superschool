    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                } else if (s.endsWith("t2")) this.getEnergyPastArmor(World.Rnd().nextFloat(12.2F, 12.9F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("t3")) this.getEnergyPastArmor(8.9F, shot);
                else if (s.endsWith("t4")) this.getEnergyPastArmor(World.Rnd().nextFloat(12.2F, 12.9F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("t5")) this.getEnergyPastArmor(World.Rnd().nextFloat(12.2F, 12.9F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
