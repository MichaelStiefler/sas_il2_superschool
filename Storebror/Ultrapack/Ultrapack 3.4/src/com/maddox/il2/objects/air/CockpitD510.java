    ...
    private class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitD510.this.fm != null) {
                ...
                CockpitD510.this.setNew.azimuth = (0.97F * CockpitD510.this.setOld.azimuth) + (0.03F * -CockpitD510.this.fm.Or.getYaw());
                if ((CockpitD510.this.setOld.azimuth > 270F) && (CockpitD510.this.setNew.azimuth < 90F)) {
                    CockpitD510.this.setOld.azimuth -= 360F;
                }
                if ((CockpitD510.this.setOld.azimuth < 90F) && (CockpitD510.this.setNew.azimuth > 270F)) {
                    CockpitD510.this.setOld.azimuth += 360F;
                }
                CockpitD510.this.setNew.waypointAzimuth = (0.91F * CockpitD510.this.setOld.waypointAzimuth) + (0.09F * (CockpitD510.this.waypointAzimuth() - CockpitD510.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
