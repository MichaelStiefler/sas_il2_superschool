...
public abstract class Hawk_3xyz extends Scheme1 implements TypeFighter, TypeTNBFighter, TypeStormovik {

    protected void nextDMGLevel(String s, int i, Actor actor) {
        super.nextDMGLevel(s, i, actor);
        if (this.FM.isPlayers()) {
            Hawk_3xyz.bChangedPit = true;
        }
    }
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        Hawk_3xyz.moveGear(hiermesh, Aircraft.cvt(f, 0.01F, 0.91F, 0.0F, 1.0F), 0, true);
        Hawk_3xyz.moveGear(hiermesh, Aircraft.cvt(f, 0.09F, 0.98F, 0.0F, 1.0F), 1, true);
    }
    ...
    protected void moveGear(float f) {
        Hawk_3xyz.moveGear(this.hierMesh(), f);
    }
    ...
    public void moveWheelSink() {
        if (this.FM.CT.getGear() > 0.99F) {
            Hawk_3xyz.moveGear(this.hierMesh(), Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.5F, 1.0F, 0.57F), 0, false);
            Hawk_3xyz.moveGear(this.hierMesh(), Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.5F, 1.0F, 0.57F), 1, false);
        }
    }
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.startsWith("xxeng")) {
                    ...
                    if (s.endsWith("prop")) {
                        if ((this.getEnergyPastArmor(0.45D / (Math.abs(Aircraft.v1.x) + 0.0001D), shot) > 0.0F) && (World.Rnd().nextFloat() < 0.05F)) {
            ...
            if (s.startsWith("xcf1")) {
                ...
                if ((point3d.x > -1.195D) && (point3d.x < -0.904D) && (point3d.z > 0.203D)) {
                    this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x40);
                }
                if ((point3d.x > -1.402D) && (point3d.x < -1.125D) && (point3d.z > -0.032D) && (point3d.z < 0.501D)) {
    ...
    static {
        Property.set(Hawk_3xyz.class, "originCountry", PaintScheme.countryUSA);
    }
}
