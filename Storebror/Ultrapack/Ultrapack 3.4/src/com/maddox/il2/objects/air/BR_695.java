...
public class BR_695 extends BR_690 {
    static {
        Class class1 = BR_695.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Br-695");
        Property.set(class1, "meshName", "3DO/Plane/Breguet-693/hier695.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1942F);
        Property.set(class1, "FlightModel", "FlightModels/BR695.fmd");
