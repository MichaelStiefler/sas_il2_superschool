...
public class CockpitCa311_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitCa311_Bombardier.this.bEntered) {
                float f = ((Ca_311) CockpitCa311_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((Ca_311) CockpitCa311_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitCa311_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitCa311_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitCa311_Bombardier() {
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((Ca_311) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((Ca_311) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitCa311_Bombardier.class, "astatePilotIndx", 0);
    }
}
