...
public class CockpitWellington8_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            float f = ((Wellington_MKVIII) CockpitWellington8_Bombardier.this.aircraft()).fSightCurForwardAngle;
            float f1 = ((Wellington_MKVIII) CockpitWellington8_Bombardier.this.aircraft()).fSightCurSideslip;
            CockpitWellington8_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
            if (CockpitWellington8_Bombardier.this.bEntered) {
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(CockpitWellington8_Bombardier.this.aAim + 10F * f1, CockpitWellington8_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitWellington8_Bombardier() {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bEntered) {
            this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((Wellington_MKVIII) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((Wellington_MKVIII) this.aircraft()).fSightCurReadyness > 0.93F;
    ...
    static {
        Property.set(CockpitWellington8_Bombardier.class, "astatePilotIndx", 0);
    }
}
