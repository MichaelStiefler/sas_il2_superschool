...
public abstract class SB2C extends Scheme1 {
    ...
    protected void moveRudder(float f) {
        ...
        this.hierMesh().chunkSetAngles("FRudderR_D0", 30F * f, 0.0F, 0.0F);
        this.hierMesh().chunkSetAngles("FRudderL_D0", 30F * f, 0.0F, 0.0F);
    }
...
//        }
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.endsWith("1xTorpedo")) {
            this.hierMesh().chunkVisible("Bay1_D0", false);
            this.hierMesh().chunkVisible("Bay2_D0", false);
            this.hierMesh().chunkVisible("Torpmount_D0", true);
            return;
        } else return;
    }
