...
public class Ro43 extends Ro_43xyz implements TypeSailPlane, TypeStormovikArmored {
    ...
    static {
        Class class1 = Ro43.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ro43");
        Property.set(class1, "meshName", "3DO/Plane/Ro43/hierS.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1931F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/Ro43.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitRo43.class });
        Property.set(class1, "LOSElevation", 0.742F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 10, 9, 9, 9, 9, 3, 3, 3, 3, 9, 9, 3, 3, 3, 3, 3, 3, 3, 3, 9, 9, 9, 9, 3, 3, 3, 3, 9, 3 });
