...
public class CockpitSB103_Bombardier extends CockpitPilot // CockpitBombardier
{
...
//        };
    ...
    public CockpitSB103_Bombardier()
    {
        super("3DO/Cockpit/SB_103-Bombardier/hier.him", "i16");
    ...
    public CockpitSB103_Bombardier(String s)
    {
        super(s, "i16");
        setOld = new Variables();
        setNew = new Variables();
    ...
    static 
    {
        Property.set(CockpitSB103_Bombardier.class, "normZN", 2.0F);
        Property.set(CockpitSB103_Bombardier.class, "astatePilotIndx", 1);
        Property.set(CockpitSB103_Bombardier.class, "aiTuretNum", -2);
        Property.set(CockpitSB103_Bombardier.class, "weaponControlNum", 3);
    }
}
