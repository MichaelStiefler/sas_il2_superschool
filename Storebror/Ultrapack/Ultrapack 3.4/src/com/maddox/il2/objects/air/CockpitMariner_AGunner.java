...
public class CockpitMariner_AGunner extends CockpitGunner {
    ...
    public CockpitMariner_AGunner() {
        super("3DO/Cockpit/Mariner-AGun/hier.him", "bf109");
    ...
    static {
        Property.set(CockpitMariner_AGunner.class, "aiTuretNum", 2);
        Property.set(CockpitMariner_AGunner.class, "weaponControlNum", 12);
        Property.set(CockpitMariner_AGunner.class, "astatePilotIndx", 5);
    }
}
