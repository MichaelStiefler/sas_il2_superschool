...
public class JU_88A17 extends JU_88NEW implements TypeStormovik, TypeBomber, TypeScout, TypeHasToKG {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Ju-88A-17.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitJU_88A17.class, CockpitJU_88A17_Bombardier.class, CockpitJU_88A17_NGunner.class, CockpitJU_88A17_RGunner.class });
        Property.set(class1, "LOSElevation", 1.0976F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 3, 3, 3, 3, 1 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_CANNON01" });
    }
}
