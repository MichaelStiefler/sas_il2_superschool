...
public class CockpitKI_49_II_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            float f = ((KI_49) CockpitKI_49_II_Bombardier.this.aircraft()).fSightCurForwardAngle;
            float f1 = ((KI_49) CockpitKI_49_II_Bombardier.this.aircraft()).fSightCurSideslip;
            CockpitKI_49_II_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
            if (CockpitKI_49_II_Bombardier.this.bEntered) {
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(CockpitKI_49_II_Bombardier.this.aAim + 10F * f1, CockpitKI_49_II_Bombardier.this.tAim + f, 0.0F);
            }
            CockpitKI_49_II_Bombardier.this.mesh.chunkSetAngles("Turret1A", 0.0F, -CockpitKI_49_II_Bombardier.this.aircraft().FM.turret[0].tu[0], 0.0F);
            CockpitKI_49_II_Bombardier.this.mesh.chunkSetAngles("Turret1B", 0.0F, CockpitKI_49_II_Bombardier.this.aircraft().FM.turret[0].tu[1], 0.0F);
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bEntered) {
            this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((KI_49) (KI_49_II) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((KI_49) (KI_49_II) this.aircraft()).fSightCurReadyness > 0.93F;
