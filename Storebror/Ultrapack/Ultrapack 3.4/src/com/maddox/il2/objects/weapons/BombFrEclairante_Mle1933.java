...
public class BombFrEclairante_Mle1933 extends Bomb {

    public BombFrEclairante_Mle1933() {
        this.chute = null;
        this.bOnChute = false;
        this.descentRate = 4F;
    }
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            this.getSpeed(BombFrEclairante_Mle1933.v3d);
            BombFrEclairante_Mle1933.v3d.scale(0.975D);
            if (Math.abs(BombFrEclairante_Mle1933.v3d.x) < 0.00001D) {
                BombFrEclairante_Mle1933.v3d.x = 0.00001D;
            }
            if (Math.abs(BombFrEclairante_Mle1933.v3d.y) < 0.00001D) {
                BombFrEclairante_Mle1933.v3d.y = 0.00001D;
            }
            if (BombFrEclairante_Mle1933.v3d.z < (-this.descentRate)) {
                float f = (float) Math.toRadians(-Bomb.Or.getTangage());
                BombFrEclairante_Mle1933.v3d.z += 10F * Time.tickConstLenFs() * Math.sin(f);
            }
            this.setSpeed(BombFrEclairante_Mle1933.v3d);
            ...
            if ((this.t2 - 2000L) > Time.current()) {
                lightpointactor.light.setEmit(1.0F, 500F);
            } else {
                lightpointactor.light.setEmit(0.9F, 450F);
            }
    ...
    static {
        Class class1 = BombFrEclairante_Mle1933.class;
        Property.set(class1, "mesh", "3DO/Arms/BombFrEclairante_Mle1933/mono.sim");
