...
public abstract class B26B_35xyz extends Scheme26B35 {
    ...
    protected void moveGear(float f) {
        B26B_35xyz.moveGear(this.hierMesh(), f);
    }

    public static void moveGear(HierMesh hiermesh, float f) {
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, 109F * f, 0.0F);
        hiermesh.chunkSetAngles("GearC6_D0", 0.0F, Aircraft.floatindex(Aircraft.cvt(f, 0.0F, 1.0F, 0.0F, 10F), B26B_35xyz.anglesc6), 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, Aircraft.cvt(f, 0.0F, 0.1F, 0.0F, -95F), 0.0F);
        hiermesh.chunkSetAngles("GearC7_D0", 0.0F, Aircraft.floatindex(Aircraft.cvt(f, 0.0F, 1.0F, 0.0F, 10F), B26B_35xyz.anglesc7), 0.0F);
    ...
    public void moveWheelSink() {
        ...
        this.resetYPRmodifier();
        Aircraft.xyz[2] = Aircraft.cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.105F, 0.0F, 0.105F);
    ...
    public void update(float f) {
        ...
        for (int i = 1; i < 14; i++) {
            this.hierMesh().chunkSetAngles("Water" + i + "_D0", 0F, -38F * this.kangle0, 0F);
            this.hierMesh().chunkSetAngles("waterr" + i + "_D0", 0F, -38F * this.kangle0, 0F);
        }
