...
public class CockpitRE_2001 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitRE_2001.this.bNeedSetUp) {
                CockpitRE_2001.this.reflectPlaneMats();
                CockpitRE_2001.this.bNeedSetUp = false;
            }
            CockpitRE_2001.this.setTmp = CockpitRE_2001.this.setOld;
            CockpitRE_2001.this.setOld = CockpitRE_2001.this.setNew;
            CockpitRE_2001.this.setNew = CockpitRE_2001.this.setTmp;
            if (((CockpitRE_2001.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitRE_2001.this.setNew.stbyPosition < 1.0F)) {
                CockpitRE_2001.this.delay--;
                if (CockpitRE_2001.this.delay <= 0) {
                    CockpitRE_2001.this.setNew.stbyPosition = CockpitRE_2001.this.setOld.stbyPosition + 0.03F;
                    CockpitRE_2001.this.setOld.stbyPosition = CockpitRE_2001.this.setNew.stbyPosition;
                    CockpitRE_2001.this.sightDamaged = true;
                }
            }
            if (CockpitRE_2001.this.fm.CT.getRadiator() < CockpitRE_2001.this.currentRadiator) {
                CockpitRE_2001.this.radiatorDelta = -1;
            } else if (CockpitRE_2001.this.fm.CT.getRadiator() > CockpitRE_2001.this.currentRadiator) {
                CockpitRE_2001.this.radiatorDelta = 1;
            }
            if ((CockpitRE_2001.this.radiator > 1.0F) || (CockpitRE_2001.this.radiator < -1F)) {
                CockpitRE_2001.this.radiatorDelta = 0;
            }
            if (CockpitRE_2001.this.radiatorDelta != 0) {
                CockpitRE_2001.this.radiator += CockpitRE_2001.this.radiatorDelta * 0.2F;
            } else if (CockpitRE_2001.this.currentRadiator == CockpitRE_2001.this.fm.CT.getRadiator()) {
                CockpitRE_2001.this.radiator = CockpitRE_2001.this.radiator * 0.5F;
            }
            CockpitRE_2001.this.currentRadiator = CockpitRE_2001.this.fm.CT.getRadiator();
            CockpitRE_2001.this.setNew.altimeter = CockpitRE_2001.this.fm.getAltitude();
            CockpitRE_2001.this.setNew.throttle = ((10F * CockpitRE_2001.this.setOld.throttle) + CockpitRE_2001.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitRE_2001.this.setNew.mix = ((10F * CockpitRE_2001.this.setOld.mix) + CockpitRE_2001.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitRE_2001.this.setNew.prop = ((10F * CockpitRE_2001.this.setOld.prop) + CockpitRE_2001.this.fm.EI.engines[0].getControlProp()) / 11F;
            CockpitRE_2001.this.pictGear = (0.85F * CockpitRE_2001.this.pictGear) + (0.15F * CockpitRE_2001.this.fm.CT.GearControl);
            CockpitRE_2001.this.w.set(CockpitRE_2001.this.fm.getW());
            CockpitRE_2001.this.fm.Or.transform(CockpitRE_2001.this.w);
            CockpitRE_2001.this.setNew.turn = ((12F * CockpitRE_2001.this.setOld.turn) + CockpitRE_2001.this.w.z) / 13F;
            CockpitRE_2001.this.setNew.vspeed = ((299F * CockpitRE_2001.this.setOld.vspeed) + CockpitRE_2001.this.fm.getVertSpeed()) / 300F;
            if (CockpitRE_2001.this.flaps == CockpitRE_2001.this.fm.CT.getFlap()) {
                CockpitRE_2001.this.flapsDirection = 0;
                CockpitRE_2001.this.sfxStop(16);
            } else if (CockpitRE_2001.this.flaps < CockpitRE_2001.this.fm.CT.getFlap()) {
                if (CockpitRE_2001.this.flapsDirection == 0) {
                    CockpitRE_2001.this.sfxStart(16);
                }
                CockpitRE_2001.this.flaps = CockpitRE_2001.this.fm.CT.getFlap();
                CockpitRE_2001.this.flapsDirection = 1;
                CockpitRE_2001.this.flapsLeverAngle += CockpitRE_2001.this.flapsIncrement;
            } else if (CockpitRE_2001.this.flaps > CockpitRE_2001.this.fm.CT.getFlap()) {
                if (CockpitRE_2001.this.flapsDirection == 0) {
                    CockpitRE_2001.this.sfxStart(16);
                }
            ...
            if (!CockpitRE_2001.this.fm.Gears.bTailwheelLocked && (CockpitRE_2001.this.tailWheelLock < 1.0F)) {
                CockpitRE_2001.this.tailWheelLock += 0.1F;
            } else if (CockpitRE_2001.this.fm.Gears.bTailwheelLocked && (CockpitRE_2001.this.tailWheelLock > 0.0F)) {
                CockpitRE_2001.this.tailWheelLock -= 0.1F;
            }
            CockpitRE_2001.this.updateCompass();
            return true;
        }
    ...
    private class Variables {
        ...
        private Variables() {
            ...
            this.compassPoint[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ)), CockpitRE_2001.compassZ);
            this.compassPoint[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ)), 0.0D, CockpitRE_2001.compassZ);
            this.compassPoint[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ)), CockpitRE_2001.compassZ);
            this.compassPoint[3] = new Vector3d(Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ)), 0.0D, CockpitRE_2001.compassZ);
            this.cP[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ)), CockpitRE_2001.compassZ);
            this.cP[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ)), 0.0D, CockpitRE_2001.compassZ);
            this.cP[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ)), CockpitRE_2001.compassZ);
            this.cP[3] = new Vector3d(Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ)), 0.0D, CockpitRE_2001.compassZ);
        }

    }

    public CockpitRE_2001() {
        super("3DO/Cockpit/Re2001/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_need_oiltemp_01", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 150F, 0.0F, 12F), CockpitRE_2001.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_need_oiltemp_02", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 30F, 150F, 0.0F, 12F), CockpitRE_2001.oilTempScale), 0.0F, 0.0F);
        ...
        this.resetYPRmodifier();
        this.mesh.chunkSetAngles("Z_sliding_cnp", 0.0F, 100F * this.fm.CT.getCockpitDoor(), 0.0F);
    }
    ...
    private void initCompass() {
        ...
        this.compassSouth = new Vector3d(0.0D, -Math.cos(0.0174527D * f1), Math.sin(0.01745277D * f1));
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (CockpitRE_2001.compassZ * CockpitRE_2001.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.01745328D * CockpitRE_2001.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-CockpitRE_2001.compassZ * 0.7D)) {
            this.accel.scale((-CockpitRE_2001.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d2.normalize();
        vector3d2.scale(-CockpitRE_2001.compassZ);
