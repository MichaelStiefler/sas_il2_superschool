...
public class CockpitHE_111H8 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            } else CockpitHE_111H8.this.setNew.waypointAzimuth.setDeg(CockpitHE_111H8.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111H8.this.setOld.azimuth.getDeg(1.0F));
            ...
            if (f2 < 100F || CockpitHE_111H8.this.fm.EI.engines[0].getRPM() < 600F) f2 = 1.0F;
            if (f3 < 100F || CockpitHE_111H8.this.fm.EI.engines[1].getRPM() < 600F) f3 = 1.0F;
