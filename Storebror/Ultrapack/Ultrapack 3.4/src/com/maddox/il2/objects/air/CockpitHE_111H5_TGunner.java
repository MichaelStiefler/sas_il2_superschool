...
public class CockpitHE_111H5_TGunner extends CockpitGunner {
    ...
    public void clipAnglesGun(Orient orient) {
        ...
        if (f < 1.0F && f > -1F) {
            if (f1 < 1.0F && f1 > -5F) this.bTailTurret = true;
            else this.bTailTurret = false;
        } else this.bTailTurret = false;
    ...
    public CockpitHE_111H5_TGunner() {
        super("3DO/Cockpit/He-111P-4-TGun/hier-H5.him", "he111_gunner");
        this.bNeedSetUp = true;
        this.hook1 = null;
        this.iCocking = 0;
        this.iOldVisDrums = 1000;
        this.iNewVisDrums = 1000;
        this.bTailTurret = false;
    }
    ...
    static {
        Property.set(CockpitHE_111H5_TGunner.class, "aiTuretNum", 1);
        Property.set(CockpitHE_111H5_TGunner.class, "weaponControlNum", 11);
        Property.set(CockpitHE_111H5_TGunner.class, "astatePilotIndx", 2);
    }
}
