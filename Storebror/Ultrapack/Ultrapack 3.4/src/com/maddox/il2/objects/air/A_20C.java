...
public class A_20C extends A_20 implements TypeBomber, TypeStormovik {
    ...
    public void moveWheelSink() {
        ...
        this.resetYPRmodifier();
        xyz[2] = cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.122F, 0.0F, 0.122F);
    ...
    static {
        ...
        weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 10, 10, 11, 3, 3, 3, 3, 3, 3, 3 });
        weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN07", "_MGUN08", "_MGUN09", "_ExternalBomb01", "_ExternalBomb02", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05" });
    }
}
