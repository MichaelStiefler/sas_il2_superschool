...
public class B5N1 extends B5Nxyz implements TypeBomber {
    ...
    static {
        Class class1 = B5N1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "B5N");
        Property.set(class1, "meshName", "3DO/Plane/B5N1(ja)/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitB5N1.class, CockpitB5N1_Bombardier.class, CockpitB5N1_Gunner.class });
