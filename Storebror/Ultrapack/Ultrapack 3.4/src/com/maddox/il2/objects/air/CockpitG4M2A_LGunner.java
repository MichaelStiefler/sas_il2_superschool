...
public class CockpitG4M2A_LGunner extends CockpitGunner {
    ...
    public CockpitG4M2A_LGunner() {
        super("3DO/Cockpit/G4M2A-LGun/hier.him", "he111_gunner");
        this.curMat = null;
        this.iCocking = 0;
    }
    ...
    static {
        Property.set(CockpitG4M2A_LGunner.class, "aiTuretNum", 4);
        Property.set(CockpitG4M2A_LGunner.class, "weaponControlNum", 14);
        Property.set(CockpitG4M2A_LGunner.class, "astatePilotIndx", 4);
    }
}
