    ...
    private class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitVG_33.this.fm != null) {
                ...
                CockpitVG_33.this.setNew.azimuth = (0.97F * CockpitVG_33.this.setOld.azimuth) + (0.03F * -CockpitVG_33.this.fm.Or.getYaw());
                if ((CockpitVG_33.this.setOld.azimuth > 270F) && (CockpitVG_33.this.setNew.azimuth < 90F)) {
                    CockpitVG_33.this.setOld.azimuth -= 360F;
                }
                if ((CockpitVG_33.this.setOld.azimuth < 90F) && (CockpitVG_33.this.setNew.azimuth > 270F)) {
                    CockpitVG_33.this.setOld.azimuth += 360F;
                }
                CockpitVG_33.this.setNew.waypointAzimuth = (0.91F * CockpitVG_33.this.setOld.waypointAzimuth) + (0.09F * (CockpitVG_33.this.waypointAzimuth() - CockpitVG_33.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
