...
public abstract class VulteeAxyz extends Scheme2 implements TypeStormovikArmored {
    ...
    protected void moveGear(float f) {
        VulteeAxyz.moveGear(this.hierMesh(), f);
    }
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (this.FM.getAltitude() < 3000F) {
            ...
            if (!(this instanceof Vulteexyz)) {
                this.hierMesh().chunkVisible("HMask4_D0", this.hierMesh().isChunkVisible("Head4_D0"));
            }
    ...
    boolean        bDynamoOperational;
    float          dynamoOrient;
    boolean        bDynamoRotary;
    int            pk;
    boolean        gunnerAiming;
    float          gunnerAnimation;
    boolean        gunnerDead;
    boolean        gunnerEjected;
    public boolean strafeWithGuns;

    static {
        Class class1 = VulteeAxyz.class;
