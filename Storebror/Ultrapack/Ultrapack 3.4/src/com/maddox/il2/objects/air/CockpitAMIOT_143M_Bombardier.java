...
public class CockpitAMIOT_143M_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitAMIOT_143M_Bombardier.this.bEntered) {
                float f = ((AMIOT_143) ((AMIOT_143M) CockpitAMIOT_143M_Bombardier.this.aircraft())).fSightCurForwardAngle;
                float f1 = -((AMIOT_143) ((AMIOT_143M) CockpitAMIOT_143M_Bombardier.this.aircraft())).fSightCurSideslip;
                CockpitAMIOT_143M_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitAMIOT_143M_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitAMIOT_143M_Bombardier() {
        super("3DO/Cockpit/Amiot-143_Bombardier/hier.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((AMIOT_143) ((AMIOT_143M) this.aircraft())).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((AMIOT_143) ((AMIOT_143M) this.aircraft())).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitAMIOT_143M_Bombardier.class, "astatePilotIndx", 0);
    }
