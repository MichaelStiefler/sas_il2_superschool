    ...
    class Interpolater extends com.maddox.il2.engine.InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitH8K1.this.fm != null) {
                ...
                if (CockpitH8K1.this.useRealisticNavigationInstruments()) CockpitH8K1.this.setNew.waypointAzimuth.setDeg(CockpitH8K1.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitH8K1.this.waypointAzimuth());
                else CockpitH8K1.this.setNew.waypointAzimuth.setDeg(CockpitH8K1.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitH8K1.this.fm.Or.azimut() + 90F);
