    ...
    private class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitLoire46.this.fm != null) {
                ...
                CockpitLoire46.this.setNew.azimuth = (0.97F * CockpitLoire46.this.setOld.azimuth) + (0.03F * -CockpitLoire46.this.fm.Or.getYaw());
                if ((CockpitLoire46.this.setOld.azimuth > 270F) && (CockpitLoire46.this.setNew.azimuth < 90F)) {
                    CockpitLoire46.this.setOld.azimuth -= 360F;
                }
                if ((CockpitLoire46.this.setOld.azimuth < 90F) && (CockpitLoire46.this.setNew.azimuth > 270F)) {
                    CockpitLoire46.this.setOld.azimuth += 360F;
                }
                CockpitLoire46.this.setNew.waypointAzimuth = (0.91F * CockpitLoire46.this.setOld.waypointAzimuth) + (0.09F * (CockpitLoire46.this.waypointAzimuth() - CockpitLoire46.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
