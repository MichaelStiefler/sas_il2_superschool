    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_39N1.this.fm != null) {
                ...
                if (Math.abs(CockpitP_39N1.this.fm.Or.getKren()) < 45F) CockpitP_39N1.this.setNew.azimuthMag = (349F * CockpitP_39N1.this.setOld.azimuthMag + CockpitP_39N1.this.fm.Or.azimut()) / 350F;
                if (CockpitP_39N1.this.setOld.azimuthMag > 270F && CockpitP_39N1.this.setNew.azimuthMag < 90F) CockpitP_39N1.this.setOld.azimuthMag -= 360F;
                if (CockpitP_39N1.this.setOld.azimuthMag < 90F && CockpitP_39N1.this.setNew.azimuthMag > 270F) CockpitP_39N1.this.setOld.azimuthMag += 360F;
                CockpitP_39N1.this.setNew.azimuth = CockpitP_39N1.this.fm.Or.azimut();
                if (CockpitP_39N1.this.setOld.azimuth > 270F && CockpitP_39N1.this.setNew.azimuth < 90F) CockpitP_39N1.this.setOld.azimuth -= 360F;
                if (CockpitP_39N1.this.setOld.azimuth < 90F && CockpitP_39N1.this.setNew.azimuth > 270F) CockpitP_39N1.this.setOld.azimuth += 360F;
                CockpitP_39N1.this.setNew.vspeed = (499F * CockpitP_39N1.this.setOld.vspeed + CockpitP_39N1.this.fm.getVertSpeed()) / 500F;
                CockpitP_39N1.this.setNew.waypointAzimuth = (10F * CockpitP_39N1.this.setOld.waypointAzimuth + CockpitP_39N1.this.waypointAzimuth(30F)) / 11F;
            }
            return true;
        }
