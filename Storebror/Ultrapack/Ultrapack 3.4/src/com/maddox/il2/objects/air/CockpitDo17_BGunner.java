...
public class CockpitDo17_BGunner extends CockpitGunner {
    ...
    static {
        Property.set(CockpitDo17_BGunner.class, "aiTuretNum", 2);
        Property.set(CockpitDo17_BGunner.class, "weaponControlNum", 12);
        Property.set(CockpitDo17_BGunner.class, "astatePilotIndx", 3);
    }
}
