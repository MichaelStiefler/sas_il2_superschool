...
public class CockpitMariner_TGunner extends CockpitGunner {
    ...
    public CockpitMariner_TGunner() {
        super("3DO/Cockpit/Mariner-TGun/hier.him", "he111_gunner");
    ...
    static {
        Property.set(CockpitMariner_TGunner.class, "aiTuretNum", 1);
        Property.set(CockpitMariner_TGunner.class, "weaponControlNum", 11);
        Property.set(CockpitMariner_TGunner.class, "astatePilotIndx", 4);
    }
}
