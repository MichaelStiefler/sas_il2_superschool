...
public class BombFrN75kg_TypeG2_Vichy extends Bomb {
    static {
        Class class1 = BombFrN75kg_TypeG2_Vichy.class;
        Property.set(class1, "mesh", "3DO/Arms/BombFrN75kg_TypeG2_Vichy/mono.sim");
