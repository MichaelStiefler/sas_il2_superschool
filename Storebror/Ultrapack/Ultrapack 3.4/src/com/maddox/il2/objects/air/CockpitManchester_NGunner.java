...
public class CockpitManchester_NGunner extends CockpitGunner {
    ...
    public CockpitManchester_NGunner() {
        super("3DO/Cockpit/Stirling-NGun/hier_manchester.him", "bf109");
        this.hook1 = null;
        this.hook2 = null;
    }
    ...
    static {
        Property.set(CockpitManchester_NGunner.class, "aiTuretNum", 0);
        Property.set(CockpitManchester_NGunner.class, "weaponControlNum", 10);
        Property.set(CockpitManchester_NGunner.class, "astatePilotIndx", 2);
    }
}
