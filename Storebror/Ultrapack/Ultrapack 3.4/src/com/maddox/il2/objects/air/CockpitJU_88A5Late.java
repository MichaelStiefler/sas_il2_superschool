...
public class CockpitJU_88A5Late extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitJU_88A5Late.this.fm != null) {
                ...
                CockpitJU_88A5Late.this.setNew.druckL = 0.85F * CockpitJU_88A5Late.this.setOld.druckL
                        + 0.15F * (CockpitJU_88A5Late.this.fm.EI.engines[0].getReadyness() * (CockpitJU_88A5Late.this.fm.EI.engines[0].getRPM() <= 100F ? 0.0F : 1.0F) * (CockpitJU_88A5Late.this.fm.M.fuel <= 1.0F ? 0.0F : 1.0F));
                CockpitJU_88A5Late.this.setNew.druckR = 0.85F * CockpitJU_88A5Late.this.setOld.druckR
                        + 0.15F * (CockpitJU_88A5Late.this.fm.EI.engines[1].getReadyness() * (CockpitJU_88A5Late.this.fm.EI.engines[1].getRPM() <= 100F ? 0.0F : 1.0F) * (CockpitJU_88A5Late.this.fm.M.fuel <= 1.0F ? 0.0F : 1.0F));
                ...
                if (CockpitJU_88A5Late.this.cockpitDimControl) {
                    if (CockpitJU_88A5Late.this.setNew.dimPosition > 0.0F) CockpitJU_88A5Late.this.setNew.dimPosition = CockpitJU_88A5Late.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_88A5Late.this.setNew.dimPosition < 1.0F) CockpitJU_88A5Late.this.setNew.dimPosition = CockpitJU_88A5Late.this.setOld.dimPosition + 0.05F;
                ...
                if (CockpitJU_88A5Late.this.buzzerFX != null)
                    if (CockpitJU_88A5Late.this.fm.Loc.z < ((JU_88A5Late) CockpitJU_88A5Late.this.aircraft()).fDiveRecoveryAlt && ((JU_88A5Late) ((Interpolate) CockpitJU_88A5Late.this.fm).actor).diveMechStage == 1) CockpitJU_88A5Late.this.buzzerFX.play();
                    else if (CockpitJU_88A5Late.this.buzzerFX.isPlaying()) CockpitJU_88A5Late.this.buzzerFX.stop();
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            if (!((JU_88A5Late) this.aircraft()).blisterRemoved) this.aircraft().hierMesh().chunkVisible("Turret4C_D0", false);
            return true;
        } else return false;
    }
    ...
    protected void doFocusLeave() {
        ...
        if (!((JU_88A5Late) this.aircraft()).blisterRemoved) this.aircraft().hierMesh().chunkVisible("Turret4C_D0", true);
        super.doFocusLeave();
    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_ELN2", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 120F, 0.0F, 8F), oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_ERN2", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 40F, 120F, 0.0F, 8F), oilTScale), 0.0F, 0.0F);
