    ...
    private class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitD372.this.fm != null) {
                ...
                CockpitD372.this.setNew.azimuth = (0.97F * CockpitD372.this.setOld.azimuth) + (0.03F * -CockpitD372.this.fm.Or.getYaw());
                if ((CockpitD372.this.setOld.azimuth > 270F) && (CockpitD372.this.setNew.azimuth < 90F)) {
                    CockpitD372.this.setOld.azimuth -= 360F;
                }
                if ((CockpitD372.this.setOld.azimuth < 90F) && (CockpitD372.this.setNew.azimuth > 270F)) {
                    CockpitD372.this.setOld.azimuth += 360F;
                }
                CockpitD372.this.setNew.waypointAzimuth = (0.91F * CockpitD372.this.setOld.waypointAzimuth) + (0.09F * (CockpitD372.this.waypointAzimuth() - CockpitD372.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
