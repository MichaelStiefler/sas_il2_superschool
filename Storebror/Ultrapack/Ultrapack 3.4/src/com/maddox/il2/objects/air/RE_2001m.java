...
public class RE_2001m extends RE_2002xyz implements TypeDiveBomber {
    ...
    static {
        Class class1 = RE_2001m.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "RE.2001");
        Property.set(class1, "meshName_it", "3DO/Plane/RE-2001m(it)/hier.him");
        Property.set(class1, "PaintScheme_it", new PaintSchemeBMPar09());
        Property.set(class1, "meshName", "3DO/Plane/RE-2001m(multi)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1948.5F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitRE_2001_old.class });
        Property.set(class1, "FlightModel", "FlightModels/RE-2001.fmd");
        Property.set(class1, "LOSElevation", 0.8219F);
