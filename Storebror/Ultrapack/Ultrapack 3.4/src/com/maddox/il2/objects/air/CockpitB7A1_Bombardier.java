...
public class CockpitB7A1_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitB7A1_Bombardier.this.bEntered) {
                float f = ((B7A) CockpitB7A1_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((B7A) CockpitB7A1_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitB7A1_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(-f1, CockpitB7A1_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitB7A1_Bombardier() {
        super("3DO/Cockpit/B7A1-Bombardier/hier.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((B7A) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((B7A) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitB7A1_Bombardier.class, "astatePilotIndx", 0);
        Property.set(CockpitB7A1_Bombardier.class, "normZN", 0.5F);
        Property.set(CockpitB7A1_Bombardier.class, "gsZN", 0.5F);
    }
