        ...
        public boolean tick() {
            ...
            if (CockpitD1A1.this.fm != null) {
                ...
                if (Math.abs(CockpitD1A1.this.fm.Or.getKren()) < 30F) {
                    CockpitD1A1.this.setNew.azimuth = ((35F * CockpitD1A1.this.setOld.azimuth) + -CockpitD1A1.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitD1A1.this.setOld.azimuth > 270F) && (CockpitD1A1.this.setNew.azimuth < 90F)) {
                    CockpitD1A1.this.setOld.azimuth -= 360F;
                }
                if ((CockpitD1A1.this.setOld.azimuth < 90F) && (CockpitD1A1.this.setNew.azimuth > 270F)) {
                    CockpitD1A1.this.setOld.azimuth += 360F;
                }
                CockpitD1A1.this.setNew.waypointAzimuth = ((10F * CockpitD1A1.this.setOld.waypointAzimuth) + (CockpitD1A1.this.waypointAzimuth() - CockpitD1A1.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
