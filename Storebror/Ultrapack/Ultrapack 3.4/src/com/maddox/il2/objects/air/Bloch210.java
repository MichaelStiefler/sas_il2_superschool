...
public class Bloch210 extends Bloch2xx implements TypeBomber, TypeTransport {
    ...
    public void onAircraftLoaded() {
        ...
        boolean rackD = this.thisWeaponsName.equals("32x50kgA") || this.thisWeaponsName.equals("128x10kgP");
        boolean rackS200 = this.thisWeaponsName.indexOf("x200kg") != -1;
        boolean rackS100 = this.thisWeaponsName.indexOf("x100kg") != -1;
        boolean rackT = this.thisWeaponsName.indexOf("x500kg") != -1;

        this.hierMesh().chunkVisible("RackTypeD_1_D0", rackD);
        this.hierMesh().chunkVisible("RackTypeD_2_D0", rackD);
        this.hierMesh().chunkVisible("RackTypeD_3_D0", rackD);
        this.hierMesh().chunkVisible("RackTypeD_4_D0", rackD);
        this.hierMesh().chunkVisible("RackTypeS200_L_D0", rackS200);
        this.hierMesh().chunkVisible("RackTypeS200_R_D0", rackS200);
        this.hierMesh().chunkVisible("RackTypeS100_L_D0", rackS100);
        this.hierMesh().chunkVisible("RackTypeS100_R_D0", rackS100);
        this.hierMesh().chunkVisible("RackTypeTGPU_L_D0", rackT);
        this.hierMesh().chunkVisible("RackTypeTGPU_R_D0", rackT);
        return;
    }
