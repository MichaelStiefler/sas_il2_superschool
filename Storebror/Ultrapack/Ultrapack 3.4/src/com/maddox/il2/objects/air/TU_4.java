...
public class TU_4 extends B_29X implements TypeBomber, TypeGuidedMissileCarrier {
    ...
    public void typeBomberAdjSpeedPlus() {
        ...
        if (this.fSightCurSpeed > 800F) this.fSightCurSpeed = 800F;
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitTU4.class, CockpitTU4_Bombardier.class, CockpitTU4_TGunner.class, CockpitTU4_T2Gunner.class, CockpitTU4_FGunner.class, CockpitTU4_AGunner.class, CockpitTU4_RGunner.class });
...
//        });
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 10, 11, 11, 12, 12, 13, 13, 14, 14, 3, 3, 3, 3, 2, 2, 2, 2, 9, 9 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_MGUN10", "_MGUN11", "_MGUN12", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_ExternalRock01",
                "_ExternalRock01", "_ExternalRock02", "_ExternalRock02", "_ExternalDev01", "_ExternalDev02" });
    }
}
