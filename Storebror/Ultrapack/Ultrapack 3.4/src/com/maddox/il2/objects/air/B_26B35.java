...
public class B_26B35 extends B26B_35xyz implements TypeBomber, TypeStormovik {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = B_26B35.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= B_26B35.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / B_26B35.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (B_26B35.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(B_26B35.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
    ...
    static {
        Class class1 = B_26B35.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "B-26B");
        Property.set(class1, "meshName", "3DO/Plane/B-26B_35(multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar03());
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1956.6F);
        Property.set(class1, "FlightModel", "FlightModels/B-26B-35.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitB26_B35.class, CockpitB26_B35_Bombardier.class, CockpitB26_B35_FGunner.class, CockpitB26_B35_TGunner.class, CockpitB26_B35_AGunner.class, CockpitB26_B35_LGunner.class, CockpitB26_B35_RGunner.class });
