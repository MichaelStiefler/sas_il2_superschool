...
public class CockpitR_XIIITer_TGunner extends CockpitGunner {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitR_XIIITer_TGunner.this.bNeedSetUp) {
                CockpitR_XIIITer_TGunner.this.reflectPlaneMats();
                CockpitR_XIIITer_TGunner.this.bNeedSetUp = false;
            }
            if (R_XIIIxyz.bChangedPit) {
                CockpitR_XIIITer_TGunner.this.reflectPlaneToModel();
                R_XIIIxyz.bChangedPit = false;
            }
            CockpitR_XIIITer_TGunner.this.setTmp = CockpitR_XIIITer_TGunner.this.setOld;
            CockpitR_XIIITer_TGunner.this.setOld = CockpitR_XIIITer_TGunner.this.setNew;
            CockpitR_XIIITer_TGunner.this.setNew = CockpitR_XIIITer_TGunner.this.setTmp;
            CockpitR_XIIITer_TGunner.this.setNew.altimeter = CockpitR_XIIITer_TGunner.this.fm.getAltitude();
            if (Math.abs(CockpitR_XIIITer_TGunner.this.fm.Or.getKren()) < 30F) {
                CockpitR_XIIITer_TGunner.this.setNew.azimuth = ((35F * CockpitR_XIIITer_TGunner.this.setOld.azimuth) + CockpitR_XIIITer_TGunner.this.fm.Or.azimut()) / 36F;
            }
            if ((CockpitR_XIIITer_TGunner.this.setOld.azimuth > 270F) && (CockpitR_XIIITer_TGunner.this.setNew.azimuth < 90F)) {
                CockpitR_XIIITer_TGunner.this.setOld.azimuth -= 360F;
            }
            if ((CockpitR_XIIITer_TGunner.this.setOld.azimuth < 90F) && (CockpitR_XIIITer_TGunner.this.setNew.azimuth > 270F)) {
                CockpitR_XIIITer_TGunner.this.setOld.azimuth += 360F;
            }
            CockpitR_XIIITer_TGunner.this.setNew.mix = ((10F * CockpitR_XIIITer_TGunner.this.setOld.mix) + CockpitR_XIIITer_TGunner.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitR_XIIITer_TGunner.this.setNew.throttle = ((10F * CockpitR_XIIITer_TGunner.this.setOld.throttle) + CockpitR_XIIITer_TGunner.this.fm.CT.PowerControl) / 11F;
            CockpitR_XIIITer_TGunner.this.w.set(CockpitR_XIIITer_TGunner.this.fm.getW());
            CockpitR_XIIITer_TGunner.this.fm.Or.transform(CockpitR_XIIITer_TGunner.this.w);
            CockpitR_XIIITer_TGunner.this.setNew.turn = ((33F * CockpitR_XIIITer_TGunner.this.setOld.turn) + CockpitR_XIIITer_TGunner.this.w.z) / 34F;
            return true;
        }
    ...
    public CockpitR_XIIITer_TGunner() {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 260F, 0.0F, 13F), CockpitR_XIIITer_TGunner.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2600F, 0.0F, 13F), CockpitR_XIIITer_TGunner.rpmScale), 0.0F);
    ...
    static {
        Property.set(CockpitR_XIIITer_TGunner.class, "aiTuretNum", 0);
        Property.set(CockpitR_XIIITer_TGunner.class, "weaponControlNum", 10);
        Property.set(CockpitR_XIIITer_TGunner.class, "astatePilotIndx", 1);
    }
