...
public class CockpitLiberator_GR_V_AGunner extends CockpitGunner {
    ...
    public CockpitLiberator_GR_V_AGunner() {
    ...
    static {
        Property.set(CockpitLiberator_GR_V_AGunner.class, "aiTuretNum", 5);
        Property.set(CockpitLiberator_GR_V_AGunner.class, "weaponControlNum", 15);
        Property.set(CockpitLiberator_GR_V_AGunner.class, "astatePilotIndx", 4);
    }
}
