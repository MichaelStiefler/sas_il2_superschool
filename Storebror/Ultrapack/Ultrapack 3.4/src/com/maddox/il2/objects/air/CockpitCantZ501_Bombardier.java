...
public class CockpitCantZ501_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitCantZ501_Bombardier.this.bEntered) {
                float f = ((CantZ501) CockpitCantZ501_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((CantZ501) CockpitCantZ501_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitCantZ501_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(-f1, CockpitCantZ501_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitCantZ501_Bombardier() {
        super("3DO/Cockpit/Pe-2-Bombardier/BombardierCantZ501.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((CantZ501) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((CantZ501) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitCantZ501_Bombardier.class, "astatePilotIndx", 0);
    }
