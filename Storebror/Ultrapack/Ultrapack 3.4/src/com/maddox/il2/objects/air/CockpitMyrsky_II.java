        ...
        public boolean tick() {
            ...
            if (CockpitMyrsky_II.this.fm != null) {
                ...
                if (Math.abs(CockpitMyrsky_II.this.fm.Or.getKren()) < 30F) {
                    CockpitMyrsky_II.this.setNew.azimuth = ((35F * CockpitMyrsky_II.this.setOld.azimuth) + -CockpitMyrsky_II.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitMyrsky_II.this.setOld.azimuth > 270F) && (CockpitMyrsky_II.this.setNew.azimuth < 90F)) {
                    CockpitMyrsky_II.this.setOld.azimuth -= 360F;
                }
                if ((CockpitMyrsky_II.this.setOld.azimuth < 90F) && (CockpitMyrsky_II.this.setNew.azimuth > 270F)) {
                    CockpitMyrsky_II.this.setOld.azimuth += 360F;
                }
                CockpitMyrsky_II.this.setNew.waypointAzimuth = ((10F * CockpitMyrsky_II.this.setOld.waypointAzimuth) + (CockpitMyrsky_II.this.waypointAzimuth() - CockpitMyrsky_II.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
