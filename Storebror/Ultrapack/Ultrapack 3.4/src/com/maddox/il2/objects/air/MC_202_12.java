...
public class MC_202_12 extends MC_202xyz {
    ...
    static {
        Class class1 = MC_202_12.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "M.C.202");
        Property.set(class1, "meshName_it", "3DO/Plane/MC-202_XII(it)/hier.him");
        Property.set(class1, "PaintScheme_it", new PaintSchemeFCSPar02());
        Property.set(class1, "meshName", "3DO/Plane/MC-202_XII(Multi1)/hier.him");
