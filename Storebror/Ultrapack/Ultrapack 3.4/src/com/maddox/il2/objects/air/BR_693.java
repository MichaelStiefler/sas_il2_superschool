...
public class BR_693 extends BR_690 {
    static {
        Class class1 = BR_693.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Br-693");
        Property.set(class1, "meshName", "3DO/Plane/Breguet-693/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1942F);
        Property.set(class1, "FlightModel", "FlightModels/BR693.fmd");
