...
public class CockpitLanc_Bombardier extends CockpitPilot {
    class Interpolater extends com.maddox.il2.engine.InterpolateRef {

        public boolean tick() {
            if (CockpitLanc_Bombardier.this.bEntered) {
                float f = ((LancasterX) CockpitLanc_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((LancasterX) CockpitLanc_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitLanc_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitLanc_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((LancasterX) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((LancasterX) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
