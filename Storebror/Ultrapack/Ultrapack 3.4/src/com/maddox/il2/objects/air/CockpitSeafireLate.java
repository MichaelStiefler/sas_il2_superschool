...
public class CockpitSeafireLate extends CockpitPilot {
        ...
        public boolean tick() {
            if (CockpitSeafireLate.this.fm != null) {
                ...
                if (Math.abs(CockpitSeafireLate.this.fm.Or.getKren()) < 30F) {
                    CockpitSeafireLate.this.setNew.azimuth = (0.97F * CockpitSeafireLate.this.setOld.azimuth) + (0.03F * -CockpitSeafireLate.this.fm.Or.getYaw());
                }
                if ((CockpitSeafireLate.this.setOld.azimuth > 270F) && (CockpitSeafireLate.this.setNew.azimuth < 90F)) {
                    CockpitSeafireLate.this.setOld.azimuth -= 360F;
                }
                if ((CockpitSeafireLate.this.setOld.azimuth < 90F) && (CockpitSeafireLate.this.setNew.azimuth > 270F)) {
                    CockpitSeafireLate.this.setOld.azimuth += 360F;
                }
                CockpitSeafireLate.this.setNew.waypointAzimuth = (0.91F * CockpitSeafireLate.this.setOld.waypointAzimuth) + (0.09F * (CockpitSeafireLate.this.waypointAzimuth() - CockpitSeafireLate.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
    ...
    protected void setCameraOffset() {
        this.cameraCenter.add(0.029999999329447746D, 0.0D, 0.0D);
    }
