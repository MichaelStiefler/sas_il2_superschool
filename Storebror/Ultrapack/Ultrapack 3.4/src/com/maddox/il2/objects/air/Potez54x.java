...
public abstract class Potez54x extends Scheme2 {
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, 60F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, -60F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 60F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, -60F * f, 0.0F);
        hiermesh.chunkSetAngles("Door1_D0", 0.0F, -85F * f, 0.0F);
        hiermesh.chunkSetAngles("Door2_D0", 0.0F, 170F * f, 0.0F);
    }

    protected void moveGear(float f) {
        Potez54x.moveGear(this.hierMesh(), f);
    }
    ...
    public void moveCockpitDoor(float f) {
        Aircraft.xyz[1] = Aircraft.cvt(f, 0.01F, 1.0F, 0.0F, 0.1F);
        this.hierMesh().chunkSetLocate("TurretExt1_D0", Aircraft.xyz, Aircraft.ypr);
        this.resetYPRmodifier();
        Aircraft.xyz[1] = Aircraft.cvt(f, 0.01F, 1.0F, 0.0F, 0.1F);
        this.hierMesh().chunkSetLocate("TurretExt2_D0", Aircraft.xyz, Aircraft.ypr);
        this.resetYPRmodifier();
        Aircraft.xyz[1] = Aircraft.cvt(f, 0.01F, 1.0F, 0.0F, -0.1F);
        this.hierMesh().chunkSetLocate("TurretBase3B_D0", Aircraft.xyz, Aircraft.ypr);
