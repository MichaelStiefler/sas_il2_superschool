        ...
        public boolean tick() {
            ...
            if (CockpitOspreyS.this.fm != null) {
                ...
                if (Math.abs(CockpitOspreyS.this.fm.Or.getKren()) < 30F) {
                    CockpitOspreyS.this.setNew.azimuth = ((35F * CockpitOspreyS.this.setOld.azimuth) + -CockpitOspreyS.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitOspreyS.this.setOld.azimuth > 270F) && (CockpitOspreyS.this.setNew.azimuth < 90F)) {
                    CockpitOspreyS.this.setOld.azimuth -= 360F;
                }
                if ((CockpitOspreyS.this.setOld.azimuth < 90F) && (CockpitOspreyS.this.setNew.azimuth > 270F)) {
                    CockpitOspreyS.this.setOld.azimuth += 360F;
                }
                CockpitOspreyS.this.setNew.waypointAzimuth = ((10F * CockpitOspreyS.this.setOld.waypointAzimuth) + (CockpitOspreyS.this.waypointAzimuth() - CockpitOspreyS.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
