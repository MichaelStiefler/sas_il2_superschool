...
public abstract class SEAGLADIATOR extends Scheme1 implements TypeFighter, TypeTNBFighter {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            ...
            if (this.chunkDamageVisible("DinghyBay1") < 2) this.hitChunk("DinghyBay1", shot);
