...
public class G3M2_11 extends G3M implements TypeBomber {
    ...
    public void update(float f) {
        super.update(f);
        if (this.FM.CT.getGear() > 0.9F) this.resetYPRmodifier();
        if (this.iGunPos == 0) {
            ...
            this.hierMesh().chunkSetLocate("Turret2C_D0", Aircraft.xyz, Aircraft.ypr);
            this.hierMesh().chunkSetLocate("Turret3C_D0", Aircraft.xyz, Aircraft.ypr);
            if (this.fGunPos > 0.8F) if (this.fGunPos < 0.9F) {

            }
        }
        if (this.FM.AS.isMaster()) {
            if (this.FM.turret[2].target != null && this.FM.AS.astatePilotStates[6] < 90) this.iGunPos = 1;
        ...
        if (this == World.getPlayerAircraft() && Main3D.cur3D().cockpitCur instanceof CockpitGunner) this.iGunPos = 1;
    }
    ...
    public boolean turretAngles(int i, float af[]) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                float f2 = Math.abs(f);
                if (f1 < Aircraft.cvt(f2, 140F, 180F, -1F, 25F)) f1 = Aircraft.cvt(f2, 140F, 180F, -1F, 25F);
                break;
        }
        af[0] = -f;
        af[1] = f1;
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1,
                new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_ExternalBomb01", "_ExternalDev01", "_ExternalBomb02", "_ExternalDev02", "_ExternalBomb03", "_ExternalDev03", "_ExternalBomb04", "_ExternalDev04", "_ExternalBomb05", "_ExternalDev05",
                        "_ExternalBomb06", "_ExternalDev06", "_ExternalBomb07", "_ExternalDev07", "_ExternalBomb08", "_ExternalDev08", "_ExternalBomb09", "_ExternalDev09", "_ExternalBomb10", "_ExternalDev10", "_ExternalBomb11", "_ExternalDev11",
                        "_ExternalBomb12", "_ExternalDev12" });
    }
}
