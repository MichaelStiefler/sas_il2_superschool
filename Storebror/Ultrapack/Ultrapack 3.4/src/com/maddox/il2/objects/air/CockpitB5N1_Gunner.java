...
public class CockpitB5N1_Gunner extends CockpitGunner {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if ((CockpitB5N1_Gunner.this.ac != null) && CockpitB5N1_Gunner.this.ac.bChangedPit) {
                CockpitB5N1_Gunner.this.reflectPlaneToModel();
                CockpitB5N1_Gunner.this.ac.bChangedPit = false;
            }
            if (CockpitB5N1_Gunner.this.fm != null) {
                CockpitB5N1_Gunner.this.setTmp = CockpitB5N1_Gunner.this.setOld;
                CockpitB5N1_Gunner.this.setOld = CockpitB5N1_Gunner.this.setNew;
                CockpitB5N1_Gunner.this.setNew = CockpitB5N1_Gunner.this.setTmp;
                CockpitB5N1_Gunner.this.setNew.azimuth.setDeg(CockpitB5N1_Gunner.this.setOld.azimuth.getDeg(1.0F), CockpitB5N1_Gunner.this.fm.Or.azimut());
                CockpitB5N1_Gunner.this.setNew.altimeter = CockpitB5N1_Gunner.this.fm.getAltitude();
            }
            return true;
        }
    ...
    public void clipAnglesGun(Orient orient) {
        ...
        if (f < 0.0F) {
            if (f < -20F) {
                f2 = this.cvt(f, -41F, -20F, -35F, -15F);
            } else {
                f2 = this.cvt(f, -20F, -10F, -15F, -8F);
            }
        } else if (f > 20F) {
            f2 = this.cvt(f, 20F, 41F, -15F, -35F);
        } else {
            f2 = this.cvt(f, 10F, 20F, -8F, -15F);
        }
        if (f < -54F) {
            f = -54F;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Need_Navairspeed", 0.0F, this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 30F), CockpitB5N1_Gunner.speedometerScale), 0.0F);
        ...
        if (f1 > 0.0F) {
            this.mesh.chunkSetAngles("Z_Need_FreeairTemp", 0.0F, this.cvt(f1, 0.0F, 40F, 0.0F, 32F), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_Need_FreeairTemp", 0.0F, this.cvt(f1, -60F, 0.0F, -48F, 0.0F), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Torpedosight", ((B5N1) this.aircraft()).fSightCurSideslip, 0.0F, 0.0F);
    ...
    protected void reflectPlaneMats() {
        ...
        Mat mat1 = hiermesh.material(hiermesh.materialFind("Pilot2"));
    ...
    static {
        Property.set(CockpitB5N1_Gunner.class, "aiTuretNum", 0);
        Property.set(CockpitB5N1_Gunner.class, "weaponControlNum", 10);
        Property.set(CockpitB5N1_Gunner.class, "astatePilotIndx", 1);
        Property.set(CockpitB5N1_Gunner.class, "normZN", 0.8F);
    }
