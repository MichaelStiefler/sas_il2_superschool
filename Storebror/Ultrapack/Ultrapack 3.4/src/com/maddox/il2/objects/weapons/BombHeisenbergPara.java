...
public class BombHeisenbergPara extends Bomb {
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            this.getSpeed(BombHeisenbergPara.v3d);
            BombHeisenbergPara.v3d.scale(0.99D);
            if (BombHeisenbergPara.v3d.z < -10D) {
                BombHeisenbergPara.v3d.z += 1.1F * Time.tickConstLenFs();
            }
            this.setSpeed(BombHeisenbergPara.v3d);
