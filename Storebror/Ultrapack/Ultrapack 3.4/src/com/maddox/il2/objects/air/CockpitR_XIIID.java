    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (Math.abs(CockpitR_XIIID.this.fm.Or.getKren()) < 30F) {
                CockpitR_XIIID.this.setNew.azimuth = ((35F * CockpitR_XIIID.this.setOld.azimuth) + CockpitR_XIIID.this.fm.Or.azimut()) / 36F;
            }
            if ((CockpitR_XIIID.this.setOld.azimuth > 270F) && (CockpitR_XIIID.this.setNew.azimuth < 90F)) {
                CockpitR_XIIID.this.setOld.azimuth -= 360F;
            }
            if ((CockpitR_XIIID.this.setOld.azimuth < 90F) && (CockpitR_XIIID.this.setNew.azimuth > 270F)) {
                CockpitR_XIIID.this.setOld.azimuth += 360F;
            }
