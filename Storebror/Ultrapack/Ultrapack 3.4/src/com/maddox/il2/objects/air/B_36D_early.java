...
public class B_36D_early extends B_36X implements TypeBomber {

    static {
        Class class1 = B_36D_early.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/B-36D_early.fmd");
