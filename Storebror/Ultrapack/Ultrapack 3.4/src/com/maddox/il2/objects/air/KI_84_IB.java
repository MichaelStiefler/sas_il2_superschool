...
public class KI_84_IB extends KI_84 {
    ...
    static {
        Class class1 = KI_84_IB.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ki-84");
        Property.set(class1, "meshName", "3DO/Plane/Ki-84-Ib(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_ja", "3DO/Plane/Ki-84-Ib(ja)/hier.him");
