...
public class CockpitWalrus_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitWalrus_Bombardier.this.bEntered) {
                float f = ((Walrus) CockpitWalrus_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((Walrus) CockpitWalrus_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitWalrus_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitWalrus_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitWalrus_Bombardier() {
        super("3DO/Cockpit/Walrus-Bombardier/BombardierWalrus.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((Walrus) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((Walrus) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitWalrus_Bombardier.class, "astatePilotIndx", 0);
    }
}
