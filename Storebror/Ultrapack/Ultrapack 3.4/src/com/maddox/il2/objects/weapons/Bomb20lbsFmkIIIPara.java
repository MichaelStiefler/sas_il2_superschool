...
public class Bomb20lbsFmkIIIPara extends Bomb {

    public Bomb20lbsFmkIIIPara() {
        this.chute = null;
        this.bOnChute = false;
    }
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            this.getSpeed(Bomb20lbsFmkIIIPara.v3d);
            Bomb20lbsFmkIIIPara.v3d.scale(0.97D);
            if (Bomb20lbsFmkIIIPara.v3d.z < -2D) {
                Bomb20lbsFmkIIIPara.v3d.z += 1.1F * Time.tickConstLenFs();
            }
            this.setSpeed(Bomb20lbsFmkIIIPara.v3d);
    ...
    static {
        Class class1 = Bomb20lbsFmkIIIPara.class;
        Property.set(class1, "mesh", "3DO/Arms/20lbs_F_MkIII_Para/mono.sim");
