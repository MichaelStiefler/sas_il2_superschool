    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitRo43.this.fm != null) {
                ...
                CockpitRo43.this.setNew.azimuth = (0.97F * CockpitRo43.this.setOld.azimuth) + (0.03F * -CockpitRo43.this.fm.Or.getYaw());
                if ((CockpitRo43.this.setOld.azimuth > 270F) && (CockpitRo43.this.setNew.azimuth < 90F)) {
                    CockpitRo43.this.setOld.azimuth -= 360F;
                }
                if ((CockpitRo43.this.setOld.azimuth < 90F) && (CockpitRo43.this.setNew.azimuth > 270F)) {
                    CockpitRo43.this.setOld.azimuth += 360F;
                }
                CockpitRo43.this.setNew.waypointAzimuth = (0.91F * CockpitRo43.this.setOld.waypointAzimuth) + (0.09F * (CockpitRo43.this.waypointAzimuth() - CockpitRo43.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
