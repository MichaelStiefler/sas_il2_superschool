...
public class B_29 extends B_29X implements TypeBomber, TypeX4Carrier, TypeGuidedBombCarrier {
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) this.fSightCurReadyness += 0.0333333F * f;
            ...
            if (this.fSightCurDistance < this.calibDistance + B_29.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(B_29.toMeters(this.fSightCurAltitude) * (2F / 9.81F))) this.bSightBombDump = true;
