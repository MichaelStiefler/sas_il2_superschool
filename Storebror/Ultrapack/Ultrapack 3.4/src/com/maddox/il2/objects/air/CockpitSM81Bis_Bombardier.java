...
public class CockpitSM81Bis_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSM81Bis_Bombardier.this.bEntered) {
                float f = ((SM81x) ((SM81Bis) CockpitSM81Bis_Bombardier.this.aircraft())).fSightCurForwardAngle;
                float f1 = 0.0F;
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(CockpitSM81Bis_Bombardier.this.aAim + f1, CockpitSM81Bis_Bombardier.this.tAim + f, 0.0F);
            }
            CockpitSM81Bis_Bombardier.this.setTmp = CockpitSM81Bis_Bombardier.this.setOld;
            CockpitSM81Bis_Bombardier.this.setOld = CockpitSM81Bis_Bombardier.this.setNew;
            CockpitSM81Bis_Bombardier.this.setNew = CockpitSM81Bis_Bombardier.this.setTmp;
            CockpitSM81Bis_Bombardier.this.setNew.altimeter = CockpitSM81Bis_Bombardier.this.fm.getAltitude();
            CockpitSM81Bis_Bombardier.this.setNew.azimuth.setDeg(CockpitSM81Bis_Bombardier.this.setOld.azimuth.getDeg(1.0F), 90F + CockpitSM81Bis_Bombardier.this.fm.Or.azimut());
            return true;
        }
    ...
    public CockpitSM81Bis_Bombardier() {
        super("3DO/Cockpit/SM81x-Bombardier/hierBis.him", "he111");
        this.bEntered = false;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 460F, 0.0F, 23F), CockpitSM81Bis_Bombardier.speedometerScale), 0.0F);
        ...
        if (!((NetAircraft) (this.aircraft())).thisWeaponsName.startsWith("1x")) {
            ...
            f2 *= 0.00872664F;
            float f3 = ((SM81x) ((SM81Bis) this.aircraft())).fSightSetForwardAngle - (float) Math.toRadians(f2);
            ...
            this.mesh.chunkSetAngles("Cylinder", 0.0F, ((SM81x) ((SM81Bis) this.aircraft())).fSightCurSideslip, 0.0F);
        }
    }
