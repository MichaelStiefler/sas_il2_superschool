...
public class BombMine_MineJJ_G10N extends AerialMine2 implements BombParaAerialMine2 {
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            this.setMesh("3DO/Arms/MineJJ_G10N/Open/mono.sim");
            this.getSpeed(BombMine_MineJJ_G10N.v3d);
            BombMine_MineJJ_G10N.v3d.scale(0.99D);
            if (BombMine_MineJJ_G10N.v3d.z < -10D) {
                BombMine_MineJJ_G10N.v3d.z += 1.1F * Time.tickConstLenFs();
            }
            this.setSpeed(BombMine_MineJJ_G10N.v3d);
            ...
            this.bOnChute = false;
            this.setMesh("3DO/Arms/MineJJ/mono.sim");
        }
...
//          Explosions.torpedoEnter_Water(AerialMine.P, 4F, 1.0F);
        ...
        if ((this.chute != null) && (Bomb.P.z <= (0.05D + World.land().HQ(Bomb.P.x, Bomb.P.y)))) {
            this.setMesh("3DO/Arms/MineJJ_G10N/Sea/mono.sim");
            this.drawing(true);
        }
    }
