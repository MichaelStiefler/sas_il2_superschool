...
public class CockpitCa311M_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitCa311M_Bombardier.this.bEntered) {
                float f = ((Ca_311M) CockpitCa311M_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((Ca_311M) CockpitCa311M_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitCa311M_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(-f1, CockpitCa311M_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public CockpitCa311M_Bombardier() {
        super("3DO/Cockpit/Pe-2-Bombardier/BombardierCa311.him", "he111");
        this.bEntered = false;
        try {
            Loc loc = new Loc();
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((Ca_311M) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((Ca_311M) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
    ...
    static {
        Property.set(CockpitCa311M_Bombardier.class, "astatePilotIndx", 0);
    }
}
