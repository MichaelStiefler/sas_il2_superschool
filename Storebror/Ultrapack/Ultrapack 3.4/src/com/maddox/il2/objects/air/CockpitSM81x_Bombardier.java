...
public class CockpitSM81x_Bombardier extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSM81x_Bombardier.this.bEntered) {
                float f = ((SM81x) CockpitSM81x_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = 0.0F;
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setSimpleAimOrient(CockpitSM81x_Bombardier.this.aAim + f1, CockpitSM81x_Bombardier.this.tAim + f, 0.0F);
            }
            CockpitSM81x_Bombardier.this.setTmp = CockpitSM81x_Bombardier.this.setOld;
            CockpitSM81x_Bombardier.this.setOld = CockpitSM81x_Bombardier.this.setNew;
            CockpitSM81x_Bombardier.this.setNew = CockpitSM81x_Bombardier.this.setTmp;
            CockpitSM81x_Bombardier.this.setNew.altimeter = CockpitSM81x_Bombardier.this.fm.getAltitude();
            CockpitSM81x_Bombardier.this.setNew.azimuth.setDeg(CockpitSM81x_Bombardier.this.setOld.azimuth.getDeg(1.0F), 90F + CockpitSM81x_Bombardier.this.fm.Or.azimut());
            return true;
        }
    ...
    public CockpitSM81x_Bombardier() {
        super("3DO/Cockpit/SM81x-Bombardier/hier.him", "he111");
        this.bEntered = false;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 460F, 0.0F, 23F), CockpitSM81x_Bombardier.speedometerScale), 0.0F);
        ...
        if (!((NetAircraft) (this.aircraft())).thisWeaponsName.startsWith("1x")) {
            ...
            f2 *= 0.00872664F;
            float f3 = ((SM81x) this.aircraft()).fSightSetForwardAngle - (float) Math.toRadians(f2);
            ...
            this.mesh.chunkSetAngles("Cylinder", 0.0F, ((SM81x) this.aircraft()).fSightCurSideslip, 0.0F);
        }
    }
