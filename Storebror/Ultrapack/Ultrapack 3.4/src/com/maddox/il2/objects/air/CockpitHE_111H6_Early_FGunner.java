...
public class CockpitHE_111H6_Early_FGunner extends CockpitGunner {
    ...
    public void clipAnglesGun(Orient orient) {
        ...
        if (f1 > 40F) f1 = 40F;
        if (f1 < -25F) f1 = -25F;
        if (f1 > 15F) if (f > -1.12F * f1 + 56.8F) f = -1.12F * f1 + 56.8F;
        else if (f < 1.12F * f1 - 56.8F) f = 1.12F * f1 - 56.8F;
    ...
    public CockpitHE_111H6_Early_FGunner() {
        super("3DO/Cockpit/He-111P-4-BGun/hier-FGunner-H6-Early.him", "he111_gunner");
        this.hook1 = null;
        this.iCocking = 0;
    ...
    static {
        Property.set(CockpitHE_111H6_Early_FGunner.class, "aiTuretNum", 5);
        Property.set(CockpitHE_111H6_Early_FGunner.class, "weaponControlNum", 15);
        Property.set(CockpitHE_111H6_Early_FGunner.class, "astatePilotIndx", 3);
    }
}
