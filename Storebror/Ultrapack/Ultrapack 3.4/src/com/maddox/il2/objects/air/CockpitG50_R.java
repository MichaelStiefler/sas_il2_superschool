...
public class CockpitG50_R extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitG50_R.this.setNew.azimuth = CockpitG50_R.this.fm.Or.getYaw();
            if ((CockpitG50_R.this.setOld.azimuth > 270F) && (CockpitG50_R.this.setNew.azimuth < 90F)) {
                CockpitG50_R.this.setOld.azimuth -= 360F;
            }
            if ((CockpitG50_R.this.setOld.azimuth < 90F) && (CockpitG50_R.this.setNew.azimuth > 270F)) {
                CockpitG50_R.this.setOld.azimuth += 360F;
            }
            CockpitG50_R.this.setNew.waypointAzimuth = ((10F * CockpitG50_R.this.setOld.waypointAzimuth) + (CockpitG50_R.this.waypointAzimuth(30F) - CockpitG50_R.this.setOld.azimuth)) / 11F;
            return true;
        }
