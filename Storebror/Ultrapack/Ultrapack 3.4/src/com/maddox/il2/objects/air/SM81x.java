...
public abstract class SM81x extends Scheme2 {
    ...
    public void onAircraftLoaded() {
        ...
        if (this instanceof SM73) {
            return;
        }
        boolean showRack250 = this.thisWeaponsName.toLowerCase().startsWith("2x500") || this.thisWeaponsName.toLowerCase().startsWith("4x250");
        boolean showRack100 = this.thisWeaponsName.toLowerCase().startsWith("16x");
        boolean showRack50 = this.thisWeaponsName.toLowerCase().startsWith("28x");
        boolean showRack31 = this.thisWeaponsName.toLowerCase().startsWith("56x");
        boolean showRackSpezzoN = this.thisWeaponsName.toLowerCase().startsWith("6xspezzo");
        boolean showDoor = !this.thisWeaponsName.toLowerCase().startsWith("18xpara");
        if ((this instanceof SM81T) || (this instanceof SM81GR)) {
            this.hierMesh().chunkVisible("Door_D0", showDoor);
        }
        if (this instanceof SM81T) {
            return;
        }

        this.hierMesh().chunkVisible("Rack250_L_D0", showRack250);
        this.hierMesh().chunkVisible("Rack250_R_D0", showRack250);
        this.hierMesh().chunkVisible("RackM_D0", showRack250);
        this.hierMesh().chunkVisible("Rack100_4_L_D0", showRack100);
        this.hierMesh().chunkVisible("Rack100_4_Ln_D0", showRack100);
        this.hierMesh().chunkVisible("Rack100_4_R_D0", showRack100);
        this.hierMesh().chunkVisible("Rack100_4_Rn_D0", showRack100);
        this.hierMesh().chunkVisible("Rack50_14_L_D0", showRack50);
        this.hierMesh().chunkVisible("Rack50_14_R_D0", showRack50);
        this.hierMesh().chunkVisible("Rack31_28_L_D0", showRack31);
        this.hierMesh().chunkVisible("Rack31_28B_L_D0", showRack31);
        this.hierMesh().chunkVisible("Rack31_28_R_D0", showRack31);
        this.hierMesh().chunkVisible("Rack31_28B_R_D0", showRack31);
        this.hierMesh().chunkVisible("Spezzoniera14_6_L_D0", false);
        this.hierMesh().chunkVisible("Spezzoniera14_6_Ln_D0", showRackSpezzoN);
        this.hierMesh().chunkVisible("Spezzoniera14_6_R_D0", false);
        this.hierMesh().chunkVisible("Spezzoniera14_6_Rn_D0", showRackSpezzoN);
    }
