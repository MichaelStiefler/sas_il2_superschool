...
public class BombSack extends Bomb {
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            this.getSpeed(BombSack.v3d);
            BombSack.v3d.scale(0.97D);
            if (BombSack.v3d.z < -2D) {
                BombSack.v3d.z += 1.1F * Time.tickConstLenFs();
            }
            this.setSpeed(BombSack.v3d);
    ...
    static {
        Class class1 = BombSack.class;
        Property.set(class1, "mesh", "3DO/Arms/Sack/mono.sim");
