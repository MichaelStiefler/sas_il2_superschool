        ...
        public boolean tick() {
            if (CockpitSpiteful14.this.fm != null) {
                ...
                if (Math.abs(CockpitSpiteful14.this.fm.Or.getKren()) < 30F) {
                    CockpitSpiteful14.this.setNew.azimuth = (0.97F * CockpitSpiteful14.this.setOld.azimuth) + (0.03F * -CockpitSpiteful14.this.fm.Or.getYaw());
                }
                if ((CockpitSpiteful14.this.setOld.azimuth > 270F) && (CockpitSpiteful14.this.setNew.azimuth < 90F)) {
                    CockpitSpiteful14.this.setOld.azimuth -= 360F;
                }
                if ((CockpitSpiteful14.this.setOld.azimuth < 90F) && (CockpitSpiteful14.this.setNew.azimuth > 270F)) {
                    CockpitSpiteful14.this.setOld.azimuth += 360F;
                }
                CockpitSpiteful14.this.setNew.waypointAzimuth = (0.91F * CockpitSpiteful14.this.setOld.waypointAzimuth) + (0.09F * (CockpitSpiteful14.this.waypointAzimuth() - CockpitSpiteful14.this.setOld.azimuth)) + World.Rnd().nextFloat(-10F, 10F);
