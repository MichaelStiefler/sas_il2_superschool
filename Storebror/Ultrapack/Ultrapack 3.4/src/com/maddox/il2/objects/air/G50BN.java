...
public class G50BN extends G50bis_xyz {
    ...
    static {
        Class class1 = G50BN.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "G.50");
        Property.set(class1, "meshName", "3DO/Plane/G-50BN(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "originCountry", PaintScheme.countryItaly);
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1944.8F);
        Property.set(class1, "FlightModel", "FlightModels/G50BNrecon.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitG50B.class, CockpitG50_R.class });
