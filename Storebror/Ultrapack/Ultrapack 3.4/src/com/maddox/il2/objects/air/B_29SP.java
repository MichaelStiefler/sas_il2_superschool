...
public class B_29SP extends B_29X implements TypeBomber {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/B-29SP.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitB29SP.class, CockpitB29SP_Bombardier.class, CockpitB29SP_AGunner.class });
        weaponTriggersRegister(class1, new int[] { 14, 14, 3, 3 });
        weaponHooksRegister(class1, new String[] { "_MGUN11", "_MGUN12", "_BombSpawn01", "_BombSpawn02" });
    }
}
