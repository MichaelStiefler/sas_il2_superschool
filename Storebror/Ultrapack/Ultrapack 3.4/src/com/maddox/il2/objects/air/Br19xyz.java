...
public abstract class Br19xyz extends Scheme1 implements TypeScout, TypeBomber, TypeStormovik {
    ...
    public void onAircraftLoaded() {
        ...
        if ((this instanceof Breguet_19H) || (this instanceof Breguet_19L)) {
            boolean rackD = this.thisWeaponsName.equals("4x100KgHE") || this.thisWeaponsName.equals("2x200KgHE") || this.thisWeaponsName.equals("24x10KgHE");
            boolean rackF = rackD || this.thisWeaponsName.equals("8x50KgGAMM") || this.thisWeaponsName.equals("32x10KgHE");

            this.hierMesh().chunkVisible("RackD_DoorF_D0", rackD);
            this.hierMesh().chunkVisible("RackD_DoorB_D0", rackD);
            this.hierMesh().chunkVisible("RackF_Door_D0", rackF);
            return;
        }
    ...
    private void moveGunner() {
        ...
        if (this.gunnerAnimation > 0.5D) {
            ...
            if ((this instanceof Breguet_19HV) || (this instanceof Breguet_19LV)) {
                this.hierMesh().chunkSetAngles("TurretBase_D0", 0.0F, 70F, 0.0F);
                this.hierMesh().chunkSetAngles("GunMount_D0", 0.0F, -50F, 0.0F);
            }
            ...
            if ((this instanceof Breguet_19HV) || (this instanceof Breguet_19LV)) {
                this.hierMesh().chunkSetAngles("TurretBase_D0", 0.0F, 0.0F, 0.0F);
                this.hierMesh().chunkSetAngles("GunMount_D0", 0.0F, 0.0F, 0.0F);
            }
        }
    }
