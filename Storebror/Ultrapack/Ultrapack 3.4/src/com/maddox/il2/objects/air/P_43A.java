...
public class P_43A extends P_43xyz {
    static {
        Class class1 = P_43A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Lancer");
        Property.set(class1, "meshName", "3DO/Plane/P-43A(multi1)/hier.him");
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 3, 3, 9, 9, 9, 3 });
