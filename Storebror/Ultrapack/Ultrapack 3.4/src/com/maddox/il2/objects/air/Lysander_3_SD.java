...
public class Lysander_3_SD extends LysanderX implements TypeBomber, TypeScout, TypeTransport {

    static {

        Class class1 = Lysander_3_SD.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Lizzie");
        Property.set(class1, "meshName", "3do/plane/Lysander_3_SD/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1956F);
        Property.set(class1, "FlightModel", "FlightModels/Lysander3_SD.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitLysander_1.class, CockpitLysander_SD_Ob.class });
        ...
        Aircraft.weaponHooksRegister(class1,
                new String[] { "_MGUN01", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalDev04",
                        ...
                        "_ExternalDev07", "_ExternalBomb17", "_ExternalBomb18", "_ExternalBomb19", "_ExternalBomb20", "_ExternalBomb21", "_ExternalBomb22", "_ExternalBomb23", "_ExternalBomb24", "_MGUN03" });
    }
