...
public class CockpitHE_111P4_FGunner extends CockpitGunner {
    ...
    public void clipAnglesGun(Orient orient) {
        ...
        if (f1 > 42F) f1 = 42F;
        if (f1 < -40F) f1 = -40F;
        if (f1 > -7.5F && f < 0.5959F * f1 - 35.5278F) f = 0.5959F * f1 - 35.5278F;
        else if (f1 > -7.5F && f > -0.5959F * f1 + 35.5278F) f = -0.5959F * f1 + 35.5278F;
    ...
    public CockpitHE_111P4_FGunner() {
        super("3DO/Cockpit/He-111P-4-BGun/hier-FGunner.him", "he111_gunner");
        this.hook1 = null;
        this.iCocking = 0;
    ...
    static {
        Property.set(CockpitHE_111P4_FGunner.class, "aiTuretNum", 5);
        Property.set(CockpitHE_111P4_FGunner.class, "weaponControlNum", 15);
        Property.set(CockpitHE_111P4_FGunner.class, "astatePilotIndx", 3);
    }
}
