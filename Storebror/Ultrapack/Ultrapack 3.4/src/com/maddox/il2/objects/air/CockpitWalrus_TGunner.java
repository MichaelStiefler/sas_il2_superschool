...
public class CockpitWalrus_TGunner extends CockpitGunner {
    ...
    public CockpitWalrus_TGunner() {
        super("3DO/Cockpit/Walrus-TGun/TGunnerWalrus.him", "he111_gunner");
    ...
    static {
        Property.set(CockpitWalrus_TGunner.class, "aiTuretNum", 1);
        Property.set(CockpitWalrus_TGunner.class, "weaponControlNum", 11);
        Property.set(CockpitWalrus_TGunner.class, "astatePilotIndx", 2);
    }
}
