...
public class GUIDifficulty extends GameState {
    ...
    public class DialogClient extends GUIDialogClient {
        public boolean notify(GWindow gwindow, int i, int i_0_) {
            ...
            if (gwindow == GUIDifficulty.this.bExit) {
                if (GUIDifficulty.this.bFirst) Main.stateStack().pop();
            ...
            // ---------------------------------------
            /*
             * if (gwindow == sNo_Map_Icons) { sNo_Fog_Of_War_Icons.setEnable(sNo_Map_Icons.isChecked()); if (!sNo_Map_Icons.isChecked()) sNo_Fog_Of_War_Icons.setChecked(true, false); }
             */
            // ---------------------------------------
        ...
        public void render() {
            ...
            if (GUIDifficulty.this.bFirst || GUIDifficulty.this.bSecond) this.draw(this.x1024(512.0F), this.y1024(577.0F), this.x1024(224.0F), this.y1024(48.0F), 2, GUIDifficulty.this.i18n("diff.Next"));
            if (GUIDifficulty.this.bFirst) {
                ...
                /*
                 * draw(x1024(128.0F), y1024(32.0F), x1024(272.0F), y1024(48.0F), 0, GUIDifficulty.this.i18n("diff.NoMapIcons")); draw(x1024(128.0F), y1024(96.0F), x1024(272.0F), y1024(48.0F), 0, GUIDifficulty.this.i18n("diff.NoPlayerIcon"));
                 * draw(x1024(128.0F), y1024(160.0F), x1024(272.0F), y1024(48.0F), 0, GUIDifficulty.this.i18n("diff.NoFogOfWarIcons")); draw(x1024(128.0F), y1024(224.0F), x1024(272.0F), y1024(48.0F), 0, GUIDifficulty.this.i18n("diff.NoMinimapPath"));
                 */
        ...
        public void setPosSize() {
            ...
            // --------------------------------------------------
            /*
             * sNo_Map_Icons.setPosC(x1024(88.0F), y1024(56.0F)); sNo_Player_Icon.setPosC(x1024(88.0F), y1024(120.0F)); sNo_Fog_Of_War_Icons.setPosC(x1024(88.0F), y1024(184.0F)); sNoMinimapPath.setPosC(x1024(88.0F), y1024(248.0F));
             */
    ...
    public void enterPush(GameState gamestate) {
        if (gamestate.id() == 27) this.bEnable = false;
        else this.bEnable = true;
        this._enter();
    }
    ...
    private void setShow(boolean bool, GWindow gwindow) {
        if (bool) gwindow.showWindow();
        else gwindow.hideWindow();
    }
    ...
    private void showHide() {
        ...
        // ---------------------------------------
        /*
         * setShow(bThird, sNo_Player_Icon); setShow(bThird, sNo_Fog_Of_War_Icons);
         */
        // ---------------------------------------
    ...
    private void reset() {
        ...
        // ---------------------------------------
        /*
         * sNo_Player_Icon.setChecked(difficultysettings.No_Player_Icon, false); sNo_Fog_Of_War_Icons.setChecked(difficultysettings.No_Fog_Of_War_Icons, false); sNo_Fog_Of_War_Icons.setEnable(sNo_Map_Icons.isChecked() & bEnable);
         */
        // ---------------------------------------
    ...
    public void _leave() {
        if (this.bEnable) {
            ...
            // ---------------------------------------
            /*
             * difficultysettings.No_Player_Icon = sNo_Player_Icon.isChecked(); difficultysettings.No_Fog_Of_War_Icons = sNo_Fog_Of_War_Icons.isChecked();
             */
            // ---------------------------------------
    ...
    protected GUIDifficulty(GWindowRoot gwindowroot, int i) {
        ...
        // ---------------------------------------
        /*
         * sNo_Player_Icon = ((GUISwitchBox3)dialogClient.addControl(new GUISwitchBox3(dialogClient))); sNo_Fog_Of_War_Icons = ((GUISwitchBox3)dialogClient.addControl(new GUISwitchBox3(dialogClient)));
         */
        // ---------------------------------------
