...
//    private static final String _VERSION                      = "4.10.1_(UP_EDITION)";
    private static final String   CORE_VERSION_NUMBER   = "4.51";
    ...
    private static final String   MIN_PATCH_LEVEL       = "2";
    private static final String   MAX_PATCH_LEVEL       = "3";
    private static final String   PATCH_LEVEL           = "3";
    private static final String[] PATCHLEVEL_G          = { "3" };
    private static final String[] PATCHLEVEL_Y          = { "2", "1", "0" };

//    private static final String   MIN_PATCH_LEVEL       = "1";
//    private static final String   MAX_PATCH_LEVEL       = "2";
//    private static final String   PATCH_LEVEL           = "2";
//    private static final String[] PATCHLEVEL_G          = { "2" };
//    private static final String[] PATCHLEVEL_Y          = { "1", "0" };

    private static final String   VERSION_STRING        = "Ultrapack";
    private static final String   PRODUCT               = VERSION_STRING + "_" + VERSION_NUMBER;
    private static final String  _VERSION              = PRODUCT;
...
//    public static final String  NET_VERSION                   = "FB_PF_v_4.10.1m_(UP_EDITION)";
    ...
    public static final String  NET_VERSION                   = PRODUCT;
