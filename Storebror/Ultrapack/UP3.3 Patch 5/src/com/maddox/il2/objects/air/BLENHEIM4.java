...
public class BLENHEIM4 extends BLENHEIM {
    ...
    static {
        ...
        Property.set(class1, "meshName_fi", "3DO/Plane/BlenheimMkIV(fi)/hier.him");
        Property.set(class1, "PaintScheme_fi", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1938F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Blenheim_MkIV.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitBLENHEIM1F.class, CockpitBLENHEIM4_Bombardier.class, CockpitBLENHEIM_TGunner.class });
        Property.set(class1, "LOSElevation", 0.73425F);
        weaponTriggersRegister(class1, new int[] { 0, 10, 3, 3 });
        weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_BombSpawn01", "_BombSpawn02" });
    }
}
