...
public class BombGunTorpTypeMXhoming extends TorpedoGun {
    ...
    static {
        Class class1 = BombGunTorpTypeMXhoming.class;
        Property.set(class1, "bulletClass", (Object) BombTorpTypeMXhoming.class);
