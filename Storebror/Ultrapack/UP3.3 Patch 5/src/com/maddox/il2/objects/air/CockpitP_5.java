...
public class CockpitP_5 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        HierMesh hiermesh = aircraft().hierMesh();
        mesh.chunkVisible("Pilot3_D0", hiermesh.isChunkVisible("Pilot2_D0"));
        mesh.chunkVisible("Pilot3_D1", hiermesh.isChunkVisible("Pilot2_D1"));
        mesh.chunkVisible("HMask3_D0", hiermesh.isChunkVisible("HMask2_D0"));
    }
    ...
    static 
    {
        Property.set(CockpitP_5.class, "normZNs", new float[] {
            1.9F, 0.7F, 0.7F, 0.7F
        });
    }
}
