...
public class CockpitU_2VSxyz extends CockpitPilot
{
    ...
    public CockpitU_2VSxyz(String hier, String type)
    {
        ...
        {
            mesh.chunkVisible("RocketKey", true);
            mesh.chunkVisible("Z_SW_Rocket", true);
        }
        setNightMats(false);
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        Cockpit.xyz[1] = 0.0F;
        mesh.chunkSetLocate("Z_SW_Rocket", Cockpit.xyz, Cockpit.ypr);
    ...
    static 
    {
        Property.set(CockpitU_2VSxyz.class, "normZNs", new float[] {
            0.7F, 0.6F, 0.6F, 0.6F
        });
