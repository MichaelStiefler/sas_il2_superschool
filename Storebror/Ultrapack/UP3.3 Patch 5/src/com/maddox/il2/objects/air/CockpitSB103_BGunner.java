...
public class CockpitSB103_BGunner extends CockpitGunner
{
    ...
    public CockpitSB103_BGunner()
    {
        super("3DO/Cockpit/SB_103-BGunner/hier.him", "he111_gunner");
        bNeedSetUp = true;
        entered = false;
        firstEnter = false;
        hatch = 0.0F;
    ...
    static 
    {
        Property.set(CockpitSB103_BGunner.class, "aiTuretNum", 2);
        Property.set(CockpitSB103_BGunner.class, "weaponControlNum", 12);
        Property.set(CockpitSB103_BGunner.class, "astatePilotIndx", 2);
        Property.set(CockpitSB103_BGunner.class, "normZN", 1.7F);
        Property.set(CockpitSB103_BGunner.class, "gsZN", 1.7F);
    }
}
