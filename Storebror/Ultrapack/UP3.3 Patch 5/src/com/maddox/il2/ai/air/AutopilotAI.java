...
public class AutopilotAI extends Autopilotage {
    ...
    public void update(float f) {
        ...
        if (this.bStabAltitude || this.bWayPoint) {
            ...
            float f_3_ = 0F;
            float f_4_ = 0F;
//            float fMaxAutopilotElevatorAboveReferenceAltitude = Property.floatValue(this.FM.actor.getClass(), "MaxAutopilotElevatorAboveReferenceAltitude", Float.MAX_VALUE);
            float fAutopilotElevatorAboveReferenceAltitudeFactor = Property.floatValue(this.FM.actor.getClass(), "AutopilotElevatorAboveReferenceAltitudeFactor", 3.3E-4F);
                   if (d > -50.0) {
//                float f_3_ = 5.0F + 2.5E-4F * this.FM.getAltitude();
            ...
            if (d < 50.0) {
//                float f_4_ = -15.0F + this.FM.M.mass * 3.3E-4F;
//                f_4_ = -15.0F + this.FM.M.mass * 3.3E-4F;
//                f_4_ = -15.0F + this.FM.M.mass * Aircraft.cvt(this.FM.M.mass, 30000F, 10000000F, 3.3E-4F, 1.0E-6F);
//                if (f_4_ > fMaxAutopilotElevatorAboveReferenceAltitude) f_4_ = fMaxAutopilotElevatorAboveReferenceAltitude;
                f_4_ = -15.0F + this.FM.M.mass * fAutopilotElevatorAboveReferenceAltitudeFactor;
...
//              System.out.println("" + this.FM.actor.getClass().getName().substring(this.FM.actor.getClass().getName().lastIndexOf(".") + 1)
//              + " getW().y=" + this.FM.getW().y
//              + ", getAW().y=" + this.FM.getAW().y);
...
//            float f_8_ = -15.0F + this.FM.M.mass * 3.3E-4F;
            float f_8_ = -15.0F + this.FM.M.mass * fAutopilotElevatorAboveReferenceAltitudeFactor;
//            if (f_8_ > fMaxAutopilotElevatorAboveReferenceAltitude) f_8_ = fMaxAutopilotElevatorAboveReferenceAltitude;
//          /  float f_8_ = -15.0F + this.FM.M.mass * Aircraft.cvt(this.FM.M.mass, 30000F, 10000000F, 3.3E-4F, 1.0E-6F);
//            if (this.FM.actor instanceof G10N1) System.out.println("mass=" + this.FM.M.mass + ", cvt=" + Aircraft.cvt(this.FM.M.mass, 30000F, 10000000F, 3.3E-4F, 1.0E-6F) + ", mult=" + this.FM.M.mass * Aircraft.cvt(this.FM.M.mass, 30000F, 10000000F, 3.3E-4F, 1.0E-6F));
...
//            System.out.println("" + this.FM.actor.getClass().getName().substring(this.FM.actor.getClass().getName().lastIndexOf("."))
//                    + " mass=" + this.FM.M.mass
//                    + ", d=" + d
//                    + ", d_1_=" + d_1_
//                    + ", d_2_=" + d_2_
...
//                    + ", f_8_=" + f_8_
//                    + ", f_9_=" + f_9_
//                    + ", ElevatorControl=" + this.FM.CT.ElevatorControl
//                    + ", Ev=" + this.Ev
//                    );
//            
//            if (this.FM.actor instanceof G10N1) System.out.println("AutopilotAI ElevatorControl=" + this.FM.CT.ElevatorControl);
//            if (this.FM.actor instanceof G10N1) {
