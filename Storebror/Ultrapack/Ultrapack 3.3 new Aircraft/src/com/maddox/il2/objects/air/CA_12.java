...
public class CA_12 extends CA_X implements TypeFighter {

	static {
		Class class1 = CA_12.class;
		new NetAircraft.SPAWN(class1);
		Property.set(class1, "iconFar_shortClassName", "Boomer");
		Property.set(class1, "meshName", "3DO/Plane/CAC-Boomerang12(Multi1)/hier12.him");
		Property.set(class1, "PaintScheme", new PaintSchemeFMPar02());
		Property.set(class1, "originCountry", PaintScheme.countryBritain);
		Property.set(class1, "yearService", 1942F);
		Property.set(class1, "yearExpired", 1943F);
		Property.set(class1, "FlightModel", "FlightModels/CA12.fmd");
