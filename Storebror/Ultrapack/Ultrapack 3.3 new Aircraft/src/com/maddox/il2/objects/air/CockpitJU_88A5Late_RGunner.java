...
public class CockpitJU_88A5Late_RGunner extends CockpitGunner {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (JU_88A5Late.bChangedPit) {
				CockpitJU_88A5Late_RGunner.this.reflectPlaneToModel();
				JU_88A5Late.bChangedPit = false;
			}
			if (CockpitJU_88A5Late_RGunner.this.fm != null) {
				CockpitJU_88A5Late_RGunner.this.setTmp = CockpitJU_88A5Late_RGunner.this.setOld;
				CockpitJU_88A5Late_RGunner.this.setOld = CockpitJU_88A5Late_RGunner.this.setNew;
				CockpitJU_88A5Late_RGunner.this.setNew = CockpitJU_88A5Late_RGunner.this.setTmp;
				CockpitJU_88A5Late_RGunner.this.setNew.throttle1 = 0.85F * CockpitJU_88A5Late_RGunner.this.setOld.throttle1 + CockpitJU_88A5Late_RGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
				CockpitJU_88A5Late_RGunner.this.setNew.prop1 = 0.85F * CockpitJU_88A5Late_RGunner.this.setOld.prop1 + CockpitJU_88A5Late_RGunner.this.fm.EI.engines[0].getControlProp() * 0.15F;
				CockpitJU_88A5Late_RGunner.this.setNew.throttle2 = 0.85F * CockpitJU_88A5Late_RGunner.this.setOld.throttle2 + CockpitJU_88A5Late_RGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
				CockpitJU_88A5Late_RGunner.this.setNew.prop2 = 0.85F * CockpitJU_88A5Late_RGunner.this.setOld.prop2 + CockpitJU_88A5Late_RGunner.this.fm.EI.engines[1].getControlProp() * 0.15F;
				CockpitJU_88A5Late_RGunner.this.setNew.altimeter = CockpitJU_88A5Late_RGunner.this.fm.getAltitude();
				float f = CockpitJU_88A5Late_RGunner.this.waypointAzimuth();
				CockpitJU_88A5Late_RGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A5Late_RGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88A5Late_RGunner.this.setOld.azimuth.getDeg(1.0F));
				CockpitJU_88A5Late_RGunner.this.setNew.azimuth.setDeg(CockpitJU_88A5Late_RGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A5Late_RGunner.this.fm.Or.azimut());
				CockpitJU_88A5Late_RGunner.this.setNew.vspeed = (199F * CockpitJU_88A5Late_RGunner.this.setOld.vspeed + CockpitJU_88A5Late_RGunner.this.fm.getVertSpeed()) / 200F;
				if (CockpitJU_88A5Late_RGunner.this.cockpitDimControl) {
					if (CockpitJU_88A5Late_RGunner.this.setNew.dimPosition > 0.0F) CockpitJU_88A5Late_RGunner.this.setNew.dimPosition = CockpitJU_88A5Late_RGunner.this.setOld.dimPosition - 0.05F;
				} else if (CockpitJU_88A5Late_RGunner.this.setNew.dimPosition < 1.0F) CockpitJU_88A5Late_RGunner.this.setNew.dimPosition = CockpitJU_88A5Late_RGunner.this.setOld.dimPosition + 0.05F;
				float f1 = CockpitJU_88A5Late_RGunner.this.prevFuel - CockpitJU_88A5Late_RGunner.this.fm.M.fuel;
				CockpitJU_88A5Late_RGunner.this.prevFuel = CockpitJU_88A5Late_RGunner.this.fm.M.fuel;
				f1 /= 0.72F;
				f1 /= Time.tickLenFs();
				f1 *= 3600F;
				CockpitJU_88A5Late_RGunner.this.setNew.cons = 0.91F * CockpitJU_88A5Late_RGunner.this.setOld.cons + 0.09F * f1;
				if (CockpitJU_88A5Late_RGunner.this.buzzerFX != null)
					if (CockpitJU_88A5Late_RGunner.this.fm.Loc.z < ((JU_88A5Late) CockpitJU_88A5Late_RGunner.this.aircraft()).fDiveRecoveryAlt && ((JU_88A5Late) ((Interpolate) CockpitJU_88A5Late_RGunner.this.fm).actor).diveMechStage == 1)
						CockpitJU_88A5Late_RGunner.this.buzzerFX.play();
					else if (CockpitJU_88A5Late_RGunner.this.buzzerFX.isPlaying()) CockpitJU_88A5Late_RGunner.this.buzzerFX.stop();
			}
			return true;
		}
	...
	public void moveGun(Orient orient) {
		...
		float f2 = f1;
		this.mesh.chunkSetAngles("zTurret3A", 0.0F, -f, 0.0F);
		this.mesh.chunkSetAngles("zTurret3B", 0.0F, f1, 0.0F);
		if (f > 10F) f = 10F;
		if (f < -35F) f = -35F;
		if (f1 < -10F) f1 = -10F;
		if (f1 > 20F) f1 = 20F;
	...
	public void clipAnglesGun(Orient orient) {
		...
		if (f1 < -10F) f1 = -10F;
		if (f < -45F) {
			if (f1 < this.cvt(f, -50F, -45F, -8.2F, -10F)) f1 = this.cvt(f, -50F, -45F, -8.2F, -10F);
		} else if (f < -3F) {
			if (f1 < this.cvt(f, -8.9F, -3F, -10F, -1.72F)) f1 = this.cvt(f, -8.9F, -3F, -10F, -1.72F);
		} else if (f < 5.3F) {
			if (f1 < this.cvt(f, -3F, 5.3F, -1.72F, -1.72F)) f1 = this.cvt(f, -3F, 5.3F, -1.72F, -1.72F);
		} else if (f1 < this.cvt(f, 5.3F, 25F, -1.72F, -3F)) f1 = this.cvt(f, 5.3F, 25F, -1.72F, -3F);
	...
	protected void interpTick() {
		if (this.isRealMode()) {
			...
			this.mesh.chunkSetLocate("zLever3", Cockpit.xyz, Cockpit.ypr);
		}
	}
	...
	public CockpitJU_88A5Late_RGunner() {
		super("3DO/Cockpit/Ju-88A-4Late-TGun/hier-RGun-A5.him", "he111");
		this.hook1 = null;
		this.iCocking = 0;
	...
	static {
		Property.set(CockpitJU_88A5Late_RGunner.class, "aiTuretNum", 2);
		Property.set(CockpitJU_88A5Late_RGunner.class, "weaponControlNum", 12);
		Property.set(CockpitJU_88A5Late_RGunner.class, "astatePilotIndx", 2);
		Property.set(CockpitJU_88A5Late_RGunner.class, "normZN", 0.75F);
		Property.set(CockpitJU_88A5Late_RGunner.class, "gsZN", 0.75F);
	}
}
