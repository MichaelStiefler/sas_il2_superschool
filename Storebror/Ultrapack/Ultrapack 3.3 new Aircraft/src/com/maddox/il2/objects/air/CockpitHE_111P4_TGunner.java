...
public class CockpitHE_111P4_TGunner extends CockpitGunner {
	...
	public CockpitHE_111P4_TGunner() {
		super("3DO/Cockpit/He-111P-4-TGun/hier.him", "he111_gunner");
	...
	static {
		Property.set(CockpitHE_111P4_TGunner.class, "aiTuretNum", 1);
		Property.set(CockpitHE_111P4_TGunner.class, "weaponControlNum", 11);
		Property.set(CockpitHE_111P4_TGunner.class, "astatePilotIndx", 2);
	}
}
