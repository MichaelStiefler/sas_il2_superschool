...
public class CockpitHE_111H6_Early_NGunner extends CockpitGunner {
	...
	public CockpitHE_111H6_Early_NGunner() {
		super("3DO/Cockpit/He-111P-4-NGun/hier-H6-Early.him", "he111_gunner");
		this.iCocking = 0;
		this.way = 0.0F;
	}
	...
	static {
		Property.set(CockpitHE_111H6_Early_NGunner.class, "aiTuretNum", 0);
		Property.set(CockpitHE_111H6_Early_NGunner.class, "weaponControlNum", 10);
		Property.set(CockpitHE_111H6_Early_NGunner.class, "astatePilotIndx", 1);
	}
}
