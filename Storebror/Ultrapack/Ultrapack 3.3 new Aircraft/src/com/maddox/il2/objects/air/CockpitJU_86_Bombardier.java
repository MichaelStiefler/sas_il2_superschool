...
public class CockpitJU_86_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (CockpitJU_86_Bombardier.this.bEntered) {
				float f = ((JU_86) CockpitJU_86_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((JU_86) CockpitJU_86_Bombardier.this.aircraft()).fSightCurSideslip;
				CockpitJU_86_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(-f1, CockpitJU_86_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	...
	public CockpitJU_86_Bombardier() {
		super("3DO/Cockpit/Ju-86-Bombardier/hier.him", "he111");
		this.bEntered = false;
		try {
			Loc loc = new Loc();
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1", ((JU_86) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
		float f1 = this.cvt(((JU_86) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
	...
	static {
		Property.set(CockpitJU_86_Bombardier.class, "astatePilotIndx", 0);
	}
}
