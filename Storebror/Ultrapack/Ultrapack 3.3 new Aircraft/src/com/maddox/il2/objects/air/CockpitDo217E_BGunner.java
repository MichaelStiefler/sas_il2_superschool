...
public class CockpitDo217E_BGunner extends CockpitGunner {
	...
	public void moveGun(Orient orient) {
		...
		this.mesh.chunkSetAngles("z_Turret3A", 0.0F, orient.getYaw(), 0.0F);
		this.mesh.chunkSetAngles("z_Turret3B", 0.0F, orient.getTangage(), 0.0F);
	}
	...
	public CockpitDo217E_BGunner() {
		super("3DO/Cockpit/Do217E2/hierBGun.him", "he111_gunner");
		this.w = new Vector3f();
	...
	static {
		Property.set(CockpitDo217E_BGunner.class, "aiTuretNum", 2);
		Property.set(CockpitDo217E_BGunner.class, "weaponControlNum", 12);
		Property.set(CockpitDo217E_BGunner.class, "astatePilotIndx", 3);
	}
}
