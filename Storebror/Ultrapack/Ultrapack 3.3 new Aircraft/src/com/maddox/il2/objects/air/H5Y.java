...
public class H5Y extends H5YX implements TypeBomber {
	...
	static {
		Class class1 = H5Y.class;
		new NetAircraft.SPAWN(class1);
		Property.set(class1, "iconFar_shortClassName", "H5Y");
		Property.set(class1, "meshName", "3DO/Plane/H5Y/hier.him");
		Property.set(class1, "PaintScheme", new PaintSchemeBMPar04());
		Property.set(class1, "yearService", 1938F);
		Property.set(class1, "yearExpired", 2048F);
		Property.set(class1, "FlightModel", "FlightModels/H5Y.fmd");
		Property.set(class1, "cockpitClass", new Class[] { CockpitH5Y.class });
