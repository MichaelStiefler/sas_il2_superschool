...
public class CockpitLiberator_GR_V_TGunner extends CockpitGunner {
	...
	public CockpitLiberator_GR_V_TGunner() {
		super("3DO/Cockpit/B-25J-TGun/TGunnerB24D.him", "bf109");
	...
	static {
		Property.set(CockpitLiberator_GR_V_TGunner.class, "aiTuretNum", 1);
		Property.set(CockpitLiberator_GR_V_TGunner.class, "weaponControlNum", 11);
		Property.set(CockpitLiberator_GR_V_TGunner.class, "astatePilotIndx", 3);
	}
}
