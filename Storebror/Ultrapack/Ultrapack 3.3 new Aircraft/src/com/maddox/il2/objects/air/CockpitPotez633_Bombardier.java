...
public class CockpitPotez633_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (CockpitPotez633_Bombardier.this.bEntered) {
				float f = ((Potez_633) CockpitPotez633_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((Potez_633) CockpitPotez633_Bombardier.this.aircraft()).fSightCurSideslip;
				CockpitPotez633_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setSimpleAimOrient(-f1, CockpitPotez633_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	...
	public CockpitPotez633_Bombardier() {
		super("3DO/Cockpit/Potez-Bombardier/hier.him", "he111");
		this.bEntered = false;
		try {
			Loc loc = new Loc();
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1", ((Potez_633) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
		float f1 = this.cvt(((Potez_633) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
	...
	static {
		Property.set(CockpitPotez633_Bombardier.class, "astatePilotIndx", 0);
	}
}
