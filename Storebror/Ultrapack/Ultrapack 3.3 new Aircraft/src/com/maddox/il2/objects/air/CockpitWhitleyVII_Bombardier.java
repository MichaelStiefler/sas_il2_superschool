...
public class CockpitWhitleyVII_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			float f = ((WhitleyMkVII) CockpitWhitleyVII_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((WhitleyMkVII) CockpitWhitleyVII_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitWhitleyVII_Bombardier.calibrAngle = 360F - CockpitWhitleyVII_Bombardier.this.fm.Or.getPitch();
			CockpitWhitleyVII_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, CockpitWhitleyVII_Bombardier.calibrAngle + f);
			if (CockpitWhitleyVII_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitWhitleyVII_Bombardier.this.aAim + 10F * f1, CockpitWhitleyVII_Bombardier.this.tAim + CockpitWhitleyVII_Bombardier.calibrAngle + f, 0.0F);
			}
			return true;
		}
	...
	public CockpitWhitleyVII_Bombardier() {
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((WhitleyMkVII) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((WhitleyMkVII) this.aircraft()).fSightCurReadyness > 0.93F;
	...
	static {
		Property.set(CockpitWhitleyVII_Bombardier.class, "astatePilotIndx", 0);
	}
}
