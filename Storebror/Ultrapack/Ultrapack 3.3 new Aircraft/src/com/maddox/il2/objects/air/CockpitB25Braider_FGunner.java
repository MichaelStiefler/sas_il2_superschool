...
public class CockpitB25Braider_FGunner extends CockpitGunner {
	...
	public CockpitB25Braider_FGunner() {
	...
	static {
		Property.set(CockpitB25Braider_FGunner.class, "aiTuretNum", 0);
		Property.set(CockpitB25Braider_FGunner.class, "weaponControlNum", 10);
		Property.set(CockpitB25Braider_FGunner.class, "astatePilotIndx", 2);
	}
}
