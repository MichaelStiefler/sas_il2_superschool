...
public abstract class CA_Twins extends Scheme2 implements TypeBomber, TypeTransport {
	...
	public void moveWheelSink() {
		...
		this.hierMesh().chunkSetAngles("GearLS7_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.25F, 0.0F, 15F), 0.0F);
		this.hierMesh().chunkSetAngles("GearLS8_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.25F, 80F, 57F), 0.0F);
		this.hierMesh().chunkSetAngles("GearLS9_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.25F, 0.0F, -8F), 0.0F);
		Aircraft.xyz[2] = Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.25F, 0.0F, 0.2F);
		this.hierMesh().chunkSetLocate("GearLS10_D0", Aircraft.xyz, Aircraft.ypr);
		...
		this.hierMesh().chunkSetAngles("GearRS7_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, 15F), 0.0F);
		this.hierMesh().chunkSetAngles("GearRS8_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 80F, 57F), 0.0F);
		this.hierMesh().chunkSetAngles("GearRS9_D0", 0.0F, Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, -8F), 0.0F);
		Aircraft.xyz[2] = Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.25F, 0.0F, 0.2F);
		this.hierMesh().chunkSetLocate("GearRS10_D0", Aircraft.xyz, Aircraft.ypr);
	}
	...
	protected void hitBone(String s, Shot shot, Point3d point3d) {
		if (s.startsWith("xx")) {
			...
			if (s.startsWith("xxspar")) {
				if ((s.endsWith("li1") || s.endsWith("li2")) && World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(Aircraft.v1.x), 0.0F, 1.0F, 1.0F, 0.08F) && this.chunkDamageVisible("WingLIn") > 2
						&& this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
					Aircraft.debugprintln(this, "*** WingLIn Spars Damaged..");
					this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
				}
				if ((s.endsWith("ri1") || s.endsWith("ri2")) && World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(Aircraft.v1.x), 0.0F, 1.0F, 1.0F, 0.08F) && this.chunkDamageVisible("WingRIn") > 2
						&& this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
