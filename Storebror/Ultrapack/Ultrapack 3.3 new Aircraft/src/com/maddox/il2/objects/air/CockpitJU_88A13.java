		...
		public boolean tick() {
			...
			if (CockpitJU_88A13.this.fm != null) {
				...
				if (CockpitJU_88A13.this.cockpitDimControl) {
					if (CockpitJU_88A13.this.setNew.dimPosition > 0.0F) CockpitJU_88A13.this.setNew.dimPosition = CockpitJU_88A13.this.setOld.dimPosition - 0.05F;
				} else if (CockpitJU_88A13.this.setNew.dimPosition < 1.0F) CockpitJU_88A13.this.setNew.dimPosition = CockpitJU_88A13.this.setOld.dimPosition + 0.05F;
				...
				if (CockpitJU_88A13.this.buzzerFX != null)
					if (CockpitJU_88A13.this.fm.Loc.z < ((JU_88A13) CockpitJU_88A13.this.aircraft()).fDiveRecoveryAlt && ((JU_88A13) ((Interpolate) CockpitJU_88A13.this.fm).actor).diveMechStage == 1) CockpitJU_88A13.this.buzzerFX.play();
					else if (CockpitJU_88A13.this.buzzerFX.isPlaying()) CockpitJU_88A13.this.buzzerFX.stop();
