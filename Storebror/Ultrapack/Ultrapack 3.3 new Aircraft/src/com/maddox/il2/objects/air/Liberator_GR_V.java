...
public class Liberator_GR_V extends B_24 implements TypeBomber {

	public Liberator_GR_V() {
	...
	protected void nextDMGLevel(String s, int i, Actor actor) {
		...
		if (this.FM.isPlayers()) Liberator_GR_V.bChangedPit = true;
	}
	...
	public void typeBomberAdjDistancePlus() {
		...
		this.fSightCurDistance = Liberator_GR_V.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
	...
	public void typeBomberUpdate(float f) {
		...
		if (this.fSightCurReadyness < 1.0F) this.fSightCurReadyness += 0.0333333F * f;
			...
			this.fSightCurDistance -= Liberator_GR_V.toMetersPerSecond(this.fSightCurSpeed) * f;
			if (this.fSightCurDistance < 0.0F) {
				this.fSightCurDistance = 0.0F;
				this.typeBomberToggleAutomation();
			}
			this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / Liberator_GR_V.toMeters(this.fSightCurAltitude)));
			if (this.fSightCurDistance < Liberator_GR_V.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(Liberator_GR_V.toMeters(this.fSightCurAltitude) * (2F / 9.81F))) this.bSightBombDump = true;
	...
	static {
		Class class1 = Liberator_GR_V.class;
		new NetAircraft.SPAWN(class1);
		Property.set(class1, "iconFar_shortClassName", "B-24");
		Property.set(class1, "meshName", "3DO/Plane/Liberator_GRV(Multi1)/hier.him");
		Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
		Property.set(class1, "meshName_gb", "3DO/Plane/Liberator_GRV(RAF)/hier.him");
		Property.set(class1, "PaintScheme_gb", new PaintSchemeFMPar06());
		Property.set(class1, "noseart", 1);
		Property.set(class1, "yearService", 1942.5F);
		Property.set(class1, "yearExpired", 1944.9F);
		Property.set(class1, "FlightModel", "FlightModels/B-24J.fmd");
		Property.set(class1, "cockpitClass", new Class[] { CockpitLiberator_GR_V.class, CockpitLiberator_GR_V_Bombardier.class, CockpitLiberator_GR_V_FGunner.class, CockpitLiberator_GR_V_TGunner.class, CockpitLiberator_GR_V_BGunner.class,
				CockpitLiberator_GR_V_RGunner.class, CockpitLiberator_GR_V_LGunner.class, CockpitLiberator_GR_V_AGunner.class });
		Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 11, 12, 12, 13, 14, 15, 15, 3, 3, 3, 3, 3, 3, 3, 3, 9, 9, 9, 9, 9, 9, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 9, 1, 1, 1, 1, 9 });
		Aircraft.weaponHooksRegister(class1,
				new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07",
						"_BombSpawn08", "_ExternalDev05", "_ExternalDev06", "_ExternalDev07", "_ExternalDev08", "_ExternalDev09", "_ExternalDev10", "_ExternalDev11", "_ExternalDev12", "_ExternalRock01", "_ExternalRock08", "_ExternalRock03",
						"_ExternalRock06", "_ExternalRock05", "_ExternalRock04", "_ExternalRock07", "_ExternalRock02", "_ExternalDev13", "_MGUN11", "_MGUN12", "_MGUN13", "_MGUN14", "_ExternalDev14" });
	}
}
