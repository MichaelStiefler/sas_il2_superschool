...
public class CockpitHE_111H6_Early_BGunner extends CockpitGunner {
	...
	public CockpitHE_111H6_Early_BGunner() {
		super("3DO/Cockpit/He-111P-4-BGun/hier-H6-Early.him", "he111_gunner");
		this.hook1 = null;
		this.iCocking = 0;
		this.iOldVisDrums = 2;
		this.iNewVisDrums = 2;
	...
	static {
		Property.set(CockpitHE_111H6_Early_BGunner.class, "aiTuretNum", 2);
		Property.set(CockpitHE_111H6_Early_BGunner.class, "weaponControlNum", 12);
		Property.set(CockpitHE_111H6_Early_BGunner.class, "astatePilotIndx", 3);
	}
}
