...
public class CockpitHE_177A5 extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			CockpitHE_177A5.this.setTmp = CockpitHE_177A5.this.setOld;
			CockpitHE_177A5.this.setOld = CockpitHE_177A5.this.setNew;
			CockpitHE_177A5.this.setNew = CockpitHE_177A5.this.setTmp;
			CockpitHE_177A5.this.fm.CT.forceCockpitDoor(1.0F);
			CockpitHE_177A5.this.fm.CT.cockpitDoorControl = 1.0F;
			if (CockpitHE_177A5.this.cockpitDimControl) {
				if (CockpitHE_177A5.this.setNew.dimPos < 1.0F) CockpitHE_177A5.this.setNew.dimPos = CockpitHE_177A5.this.setOld.dimPos + 0.03F;
			} else if (CockpitHE_177A5.this.setNew.dimPos > 0.0F) CockpitHE_177A5.this.setNew.dimPos = CockpitHE_177A5.this.setOld.dimPos - 0.03F;
			CockpitHE_177A5.this.setNew.altimeter = CockpitHE_177A5.this.fm.getAltitude();
			CockpitHE_177A5.this.setNew.throttlel = (10F * CockpitHE_177A5.this.setOld.throttlel + CockpitHE_177A5.this.fm.EI.engines[0].getControlThrottle()) / 11F;
			CockpitHE_177A5.this.setNew.throttler = (10F * CockpitHE_177A5.this.setOld.throttler + CockpitHE_177A5.this.fm.EI.engines[1].getControlThrottle()) / 11F;
			CockpitHE_177A5.this.setNew.vspeed = (499F * CockpitHE_177A5.this.setOld.vspeed + CockpitHE_177A5.this.fm.getVertSpeed()) / 500F;
			CockpitHE_177A5.this.setNew.elevTrim = 0.85F * CockpitHE_177A5.this.setOld.elevTrim + CockpitHE_177A5.this.fm.CT.getTrimElevatorControl() * 0.15F;
			CockpitHE_177A5.this.setNew.rudderTrim = 0.85F * CockpitHE_177A5.this.setOld.rudderTrim + CockpitHE_177A5.this.fm.CT.getTrimRudderControl() * 0.15F;
			CockpitHE_177A5.this.setNew.ailTrim = 0.85F * CockpitHE_177A5.this.setOld.ailTrim + CockpitHE_177A5.this.fm.CT.getTrimAileronControl() * 0.15F;
			CockpitHE_177A5.this.setNew.propL = 0.85F * CockpitHE_177A5.this.setOld.propL + CockpitHE_177A5.this.fm.EI.engines[0].getControlProp() * 0.15F;
			CockpitHE_177A5.this.setNew.propR = 0.85F * CockpitHE_177A5.this.setOld.propR + CockpitHE_177A5.this.fm.EI.engines[1].getControlProp() * 0.15F;
			float f = CockpitHE_177A5.this.prevFuel - CockpitHE_177A5.this.fm.M.fuel;
			CockpitHE_177A5.this.prevFuel = CockpitHE_177A5.this.fm.M.fuel;
			f /= 0.72F;
			f /= Time.tickLenFs();
			f *= 3600F;
			CockpitHE_177A5.this.setNew.cons = 0.91F * CockpitHE_177A5.this.setOld.cons + 0.09F * f;
			float f1 = CockpitHE_177A5.this.waypointAzimuth();
			CockpitHE_177A5.this.setNew.waypointAzimuth.setDeg(CockpitHE_177A5.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitHE_177A5.this.setOld.azimuth.getDeg(1.0F));
			CockpitHE_177A5.this.setNew.azimuth.setDeg(CockpitHE_177A5.this.setOld.azimuth.getDeg(1.0F), CockpitHE_177A5.this.fm.Or.azimut());
			CockpitHE_177A5.this.setNew.beaconDirection = (10F * CockpitHE_177A5.this.setOld.beaconDirection + CockpitHE_177A5.this.getBeaconDirection()) / 11F;
			CockpitHE_177A5.this.setNew.beaconRange = (10F * CockpitHE_177A5.this.setOld.beaconRange + CockpitHE_177A5.this.getBeaconRange()) / 11F;
			return true;
		}
...
//		}
	...
	public CockpitHE_177A5() {
		super("3DO/Cockpit/He-177A-5/hier.him", "he111");
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("Z_Alt1Set", 0.0F, ((HE_177A5) this.aircraft()).fSightCurAltitude * 360F / 6000F, 0.0F);
		...
		this.mesh.chunkSetAngles("z_RPM1", 0.0F, this.cvt(f2, 600F, 3600F, -172F, 156F), 0.0F);
		this.mesh.chunkSetAngles("z_RPM2", 0.0F, this.cvt(f3, 600F, 3600F, -172F, 156F), 0.0F);
		...
		this.mesh.chunkVisible("RWL_Ein", this.fm.CT.getGear() < 0.025F || !this.fm.Gears.lgear);
		this.mesh.chunkVisible("RWL_Aus", this.fm.CT.getGear() > 0.999F && this.fm.Gears.lgear);
		this.mesh.chunkVisible("RWR_Ein", this.fm.CT.getGear() < 0.001F || !this.fm.Gears.rgear);
		this.mesh.chunkVisible("RWR_Aus", this.fm.CT.getGear() > 0.975F && this.fm.Gears.rgear);
		this.mesh.chunkVisible("RWC_Ein", this.fm.CT.getGear() < 0.01F || !this.fm.Gears.cgear);
		this.mesh.chunkVisible("RWC_Aus", this.fm.CT.getGear() > 0.999F && this.fm.Gears.cgear);
		...
		this.mesh.chunkVisible("RK_Ein", this.fm.CT.getFlap() < 0.1F);
		this.mesh.chunkVisible("RK_Start", this.fm.CT.getFlap() > 0.1F && this.fm.CT.getFlap() < 0.5F);
		this.mesh.chunkVisible("RK_Aus", this.fm.CT.getFlap() > 0.5F);
...
//		}
	...
	private void showToKG() {
		System.out.println("CockpitHE_177 showToKG()");
