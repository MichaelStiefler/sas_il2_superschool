...
public class CockpitJU_88G6 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (CockpitJU_88G6.this.fm != null) {
				...
				} else CockpitJU_88G6.this.setNew.waypointAzimuth.setDeg(CockpitJU_88G6.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88G6.this.setOld.azimuth.getDeg(1.0F));
				...
				if (CockpitJU_88G6.this.cockpitDimControl) {
					if (CockpitJU_88G6.this.setNew.dimPosition > 0.0F) CockpitJU_88G6.this.setNew.dimPosition = CockpitJU_88G6.this.setNew.dimPosition - 0.05F;
				} else if (CockpitJU_88G6.this.setNew.dimPosition < 1.0F) CockpitJU_88G6.this.setNew.dimPosition = CockpitJU_88G6.this.setNew.dimPosition + 0.05F;
	...
	public CockpitJU_88G6() {
		...
		this.cockpitRadarLiSN2 = new RadarLiSN2Equipment(this, 29, 70F, 5F, 0.2F, 0.012F, 0.011637F, 0.073296F);
