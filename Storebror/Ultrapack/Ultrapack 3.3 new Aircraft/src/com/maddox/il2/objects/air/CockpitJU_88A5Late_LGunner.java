...
public class CockpitJU_88A5Late_LGunner extends CockpitGunner {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (JU_88A5Late.bChangedPit) {
				CockpitJU_88A5Late_LGunner.this.reflectPlaneToModel();
				JU_88A5Late.bChangedPit = false;
			}
			if (CockpitJU_88A5Late_LGunner.this.fm != null) {
				CockpitJU_88A5Late_LGunner.this.setTmp = CockpitJU_88A5Late_LGunner.this.setOld;
				CockpitJU_88A5Late_LGunner.this.setOld = CockpitJU_88A5Late_LGunner.this.setNew;
				CockpitJU_88A5Late_LGunner.this.setNew = CockpitJU_88A5Late_LGunner.this.setTmp;
				CockpitJU_88A5Late_LGunner.this.setNew.throttle1 = 0.85F * CockpitJU_88A5Late_LGunner.this.setOld.throttle1 + CockpitJU_88A5Late_LGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
				CockpitJU_88A5Late_LGunner.this.setNew.prop1 = 0.85F * CockpitJU_88A5Late_LGunner.this.setOld.prop1 + CockpitJU_88A5Late_LGunner.this.fm.EI.engines[0].getControlProp() * 0.15F;
				CockpitJU_88A5Late_LGunner.this.setNew.throttle2 = 0.85F * CockpitJU_88A5Late_LGunner.this.setOld.throttle2 + CockpitJU_88A5Late_LGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
				CockpitJU_88A5Late_LGunner.this.setNew.prop2 = 0.85F * CockpitJU_88A5Late_LGunner.this.setOld.prop2 + CockpitJU_88A5Late_LGunner.this.fm.EI.engines[1].getControlProp() * 0.15F;
				CockpitJU_88A5Late_LGunner.this.setNew.altimeter = CockpitJU_88A5Late_LGunner.this.fm.getAltitude();
				float f = CockpitJU_88A5Late_LGunner.this.waypointAzimuth();
				CockpitJU_88A5Late_LGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A5Late_LGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88A5Late_LGunner.this.setOld.azimuth.getDeg(1.0F));
				CockpitJU_88A5Late_LGunner.this.setNew.azimuth.setDeg(CockpitJU_88A5Late_LGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A5Late_LGunner.this.fm.Or.azimut());
				CockpitJU_88A5Late_LGunner.this.setNew.vspeed = (199F * CockpitJU_88A5Late_LGunner.this.setOld.vspeed + CockpitJU_88A5Late_LGunner.this.fm.getVertSpeed()) / 200F;
				if (CockpitJU_88A5Late_LGunner.this.cockpitDimControl) {
					if (CockpitJU_88A5Late_LGunner.this.setNew.dimPosition > 0.0F) CockpitJU_88A5Late_LGunner.this.setNew.dimPosition = CockpitJU_88A5Late_LGunner.this.setOld.dimPosition - 0.05F;
				} else if (CockpitJU_88A5Late_LGunner.this.setNew.dimPosition < 1.0F) CockpitJU_88A5Late_LGunner.this.setNew.dimPosition = CockpitJU_88A5Late_LGunner.this.setOld.dimPosition + 0.05F;
				float f1 = CockpitJU_88A5Late_LGunner.this.prevFuel - CockpitJU_88A5Late_LGunner.this.fm.M.fuel;
				CockpitJU_88A5Late_LGunner.this.prevFuel = CockpitJU_88A5Late_LGunner.this.fm.M.fuel;
				f1 /= 0.72F;
				f1 /= Time.tickLenFs();
				f1 *= 3600F;
				CockpitJU_88A5Late_LGunner.this.setNew.cons = 0.91F * CockpitJU_88A5Late_LGunner.this.setOld.cons + 0.09F * f1;
				if (CockpitJU_88A5Late_LGunner.this.buzzerFX != null)
					if (CockpitJU_88A5Late_LGunner.this.fm.Loc.z < ((JU_88A5Late) CockpitJU_88A5Late_LGunner.this.aircraft()).fDiveRecoveryAlt && ((JU_88A5Late) ((Interpolate) CockpitJU_88A5Late_LGunner.this.fm).actor).diveMechStage == 1)
						CockpitJU_88A5Late_LGunner.this.buzzerFX.play();
					else if (CockpitJU_88A5Late_LGunner.this.buzzerFX.isPlaying()) CockpitJU_88A5Late_LGunner.this.buzzerFX.stop();
			}
			return true;
		}
	...
	public void clipAnglesGun(Orient orient) {
		...
		if (f1 < -10F) f1 = -10F;
		if (f > 45F) {
			if (f1 < this.cvt(f, 45F, 50F, -10F, -8.2F)) f1 = this.cvt(f, 45F, 50F, -10F, -8.2F);
		} else if (f > 3F) {
	...
	protected void interpTick() {
		if (this.isRealMode()) {
			...
			this.mesh.chunkSetLocate("zLever2", Cockpit.xyz, Cockpit.ypr);
		}
	}
	...
	public CockpitJU_88A5Late_LGunner() {
		super("3DO/Cockpit/Ju-88A-4Late-TGun/hier-LGun-A5.him", "he111");
		this.hook1 = null;
	...
	static {
		Property.set(CockpitJU_88A5Late_LGunner.class, "aiTuretNum", 1);
		Property.set(CockpitJU_88A5Late_LGunner.class, "weaponControlNum", 11);
		Property.set(CockpitJU_88A5Late_LGunner.class, "astatePilotIndx", 2);
		Property.set(CockpitJU_88A5Late_LGunner.class, "normZN", 0.75F);
		Property.set(CockpitJU_88A5Late_LGunner.class, "gsZN", 0.75F);
	}
}
