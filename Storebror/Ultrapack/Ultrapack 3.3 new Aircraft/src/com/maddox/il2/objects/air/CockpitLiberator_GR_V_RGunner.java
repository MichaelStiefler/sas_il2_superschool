...
public class CockpitLiberator_GR_V_RGunner extends CockpitGunner {
	...
	public CockpitLiberator_GR_V_RGunner() {
		super("3DO/Cockpit/B-25J-RGun/RGunnerB24D.him", "he111_gunner");
		this.hook1 = null;
	}

	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("TurretLA", 0.0F, this.aircraft().FM.turret[3].tu[0], 0.0F);
		this.mesh.chunkSetAngles("TurretLB", 0.0F, this.aircraft().FM.turret[3].tu[1], 0.0F);
		this.mesh.chunkSetAngles("TurretLC", 0.0F, this.aircraft().FM.turret[3].tu[1], 0.0F);
	...
	static {
		Property.set(CockpitLiberator_GR_V_RGunner.class, "aiTuretNum", 4);
		Property.set(CockpitLiberator_GR_V_RGunner.class, "weaponControlNum", 14);
		Property.set(CockpitLiberator_GR_V_RGunner.class, "astatePilotIndx", 6);
	}
}
