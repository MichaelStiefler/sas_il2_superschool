...
public class CockpitHE_111P4_NGunner extends CockpitGunner {
	...
	protected void interpTick() {
		...
		Cockpit.ypr[1] = 0.0F;
		this.mesh.chunkSetLocate("Lever", Cockpit.xyz, Cockpit.ypr);
	}
	...
	public CockpitHE_111P4_NGunner() {
		super("3DO/Cockpit/He-111P-4-NGun/hier.him", "he111_gunner");
		this.iCocking = 0;
		this.way = 0.0F;
	}
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("TurretNA", 0.0F, this.fm.turret[6].tu[0], 0.0F);
		this.mesh.chunkSetAngles("TurretNB", 0.0F, this.fm.turret[6].tu[1], 0.0F);
	...
	static {
		Property.set(CockpitHE_111P4_NGunner.class, "aiTuretNum", 0);
		Property.set(CockpitHE_111P4_NGunner.class, "weaponControlNum", 10);
		Property.set(CockpitHE_111P4_NGunner.class, "astatePilotIndx", 1);
	}
}
