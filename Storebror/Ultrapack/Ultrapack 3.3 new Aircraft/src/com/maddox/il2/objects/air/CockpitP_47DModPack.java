...
public class CockpitP_47DModPack extends CockpitPilot {
	...
	private void loadLocalSoundsFX() {
		if (this.sounds != null) {
			SoundFX soundfx = this.sounds[15];
			if (soundfx == null) {
				this.soundfx1 = this.aircraft().newSound(sfxPreset, false, false);
				if (this.soundfx1 != null) {
					this.soundfx1.setParent(this.aircraft().getRootFX());
					this.sounds[15] = this.soundfx1;
					this.soundfx1.setUsrFlag(15);
					this.soundfx1.setPosition(new Point3d(1.0D, 0.0D, 0.0D));
					this.sndWind = this.sounds[15];
					printDebugMessage("*** Canopy wind sound loaded");
				}
			}
			soundfx = this.sounds[14];
			if (soundfx == null) {
				this.soundfx1 = this.aircraft().newSound(sfxPreset, false, false);
				if (this.soundfx1 != null) {
					this.soundfx1.setParent(this.aircraft().getRootFX());
					this.sounds[14] = this.soundfx1;
					this.soundfx1.setUsrFlag(14);
					this.soundfx1.setPosition(new Point3d(0.5D, 0.0D, -0.5D));
					this.sndFlaps = this.sounds[14];
					printDebugMessage("*** Flaps sound loaded");
				}
			}
			soundfx = this.sounds[13];
			if (soundfx == null) {
				this.soundfx1 = this.aircraft().newSound(sfxPreset, false, false);
				if (this.soundfx1 != null) {
					this.soundfx1.setParent(this.aircraft().getRootFX());
					this.sounds[13] = this.soundfx1;
					this.soundfx1.setUsrFlag(13);
					this.soundfx1.setPosition(new Point3d(0.5D, 0.0D, -0.5D));
					this.sndFlapsEnd = this.sounds[13];
					printDebugMessage("*** FlapsEnd sound loaded");
				}
			}
			soundfx = this.sounds[12];
			if (soundfx == null) {
				this.soundfx1 = this.aircraft().newSound(sfxPreset, false, false);
				if (this.soundfx1 != null) {
					this.soundfx1.setParent(this.aircraft().getRootFX());
					this.sounds[12] = this.soundfx1;
					this.soundfx1.setUsrFlag(12);
					this.soundfx1.setPosition(new Point3d(0.0D, 0.0D, -1D));
					((P_47ModPack) this.aircraft()).soundGearDn = this.sounds[12];
					printDebugMessage("*** GearDn sound loaded");
				}
			}
			soundfx = this.sounds[11];
			if (soundfx == null) {
				this.soundfx1 = this.aircraft().newSound(sfxPreset, false, false);
				if (this.soundfx1 != null) {
					this.soundfx1.setParent(this.aircraft().getRootFX());
					this.sounds[11] = this.soundfx1;
					this.soundfx1.setUsrFlag(11);
					this.soundfx1.setPosition(new Point3d(0.0D, 0.0D, -1D));
					((P_47ModPack) this.aircraft()).soundGearUp = this.sounds[11];
					printDebugMessage("*** GearUp sound loaded");
				}
			}
			soundfx = this.sounds[10];
			if (soundfx == null) {
				this.soundfx1 = this.aircraft().newSound(sfxPreset, false, false);
				if (this.soundfx1 != null) {
					this.soundfx1.setParent(this.aircraft().getRootFX());
					this.sounds[10] = this.soundfx1;
					this.soundfx1.setUsrFlag(10);
					this.soundfx1.setPosition(new Point3d(0.0D, 0.0D, -1D));
					((P_47ModPack) this.aircraft()).soundWheels = this.sounds[10];
					printDebugMessage("*** GearUp sound loaded");
				}
			}
			soundfx = this.sounds[8];
			if (soundfx == null) {
				this.soundfx1 = this.aircraft().newSound(sfxPreset, false, false);
				if (this.soundfx1 != null) {
					this.soundfx1.setParent(this.aircraft().getRootFX());
					this.sounds[8] = this.soundfx1;
					this.soundfx1.setUsrFlag(8);
					this.soundfx1.setPosition(new Point3d(0.5D, 0.0D, -0.5D));
					this.sndTurbo = this.sounds[8];
					printDebugMessage("*** Turbo sound loaded");
				}
			}
			soundfx = this.sounds[7];
			if (soundfx == null) {
				this.soundfx1 = this.aircraft().newSound(sfxPreset, false, false);
				if (this.soundfx1 != null) {
					this.soundfx1.setParent(this.aircraft().getRootFX());
					this.sounds[7] = this.soundfx1;
					this.soundfx1.setUsrFlag(7);
					this.soundfx1.setPosition(new Point3d(-0.5D, 0.7D, -0.1D));
