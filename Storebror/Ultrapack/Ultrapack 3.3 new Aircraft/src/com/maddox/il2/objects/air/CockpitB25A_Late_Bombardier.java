...
public class CockpitB25A_Late_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			CockpitB25A_Late_Bombardier.this.setTmp = CockpitB25A_Late_Bombardier.this.setOld;
			CockpitB25A_Late_Bombardier.this.setOld = CockpitB25A_Late_Bombardier.this.setNew;
			CockpitB25A_Late_Bombardier.this.setNew = CockpitB25A_Late_Bombardier.this.setTmp;
			float f = ((B25A_Late) CockpitB25A_Late_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((B25A_Late) CockpitB25A_Late_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitB25A_Late_Bombardier.calibrAngle = 360F - CockpitB25A_Late_Bombardier.this.fm.Or.getPitch();
			CockpitB25A_Late_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, CockpitB25A_Late_Bombardier.calibrAngle + f);
			if (CockpitB25A_Late_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitB25A_Late_Bombardier.this.aAim + 10F * f1, CockpitB25A_Late_Bombardier.this.tAim + CockpitB25A_Late_Bombardier.calibrAngle + f, 0.0F);
			}
			CockpitB25A_Late_Bombardier.this.mesh.chunkSetAngles("TurretA", 0.0F, CockpitB25A_Late_Bombardier.this.aircraft().FM.turret[0].tu[0], 0.0F);
			CockpitB25A_Late_Bombardier.this.mesh.chunkSetAngles("TurretB", 0.0F, CockpitB25A_Late_Bombardier.this.aircraft().FM.turret[0].tu[1], 0.0F);
			float f2 = CockpitB25A_Late_Bombardier.this.waypointAzimuth();
			CockpitB25A_Late_Bombardier.this.setNew.azimuth.setDeg(CockpitB25A_Late_Bombardier.this.setOld.azimuth.getDeg(1.0F), CockpitB25A_Late_Bombardier.this.fm.Or.azimut());
			if (CockpitB25A_Late_Bombardier.this.useRealisticNavigationInstruments()) {
				CockpitB25A_Late_Bombardier.this.setNew.waypointAzimuth.setDeg(f2 - 90F);
				CockpitB25A_Late_Bombardier.this.setOld.waypointAzimuth.setDeg(f2 - 90F);
			} else CockpitB25A_Late_Bombardier.this.setNew.waypointAzimuth.setDeg(CockpitB25A_Late_Bombardier.this.setOld.waypointAzimuth.getDeg(0.1F), f2);
			return true;
		}
	...
	public CockpitB25A_Late_Bombardier() {
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((B25A_Late) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((B25A_Late) this.aircraft()).fSightCurReadyness > 0.93F;
	...
	static {
		Property.set(CockpitB25A_Late_Bombardier.class, "astatePilotIndx", 0);
	}
}
