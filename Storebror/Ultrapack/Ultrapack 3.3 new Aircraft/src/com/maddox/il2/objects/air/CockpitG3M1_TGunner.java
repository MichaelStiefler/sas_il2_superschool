...
public class CockpitG3M1_TGunner extends CockpitGunner {
	...
	protected void doFocusLeave() {
		this.aircraft().hierMesh().chunkVisible("Turret1B_D0", this.aircraft().hierMesh().isChunkVisible("Turret1C_D0"));
		super.doFocusLeave();
	}
	...
	public CockpitG3M1_TGunner() {
		super("3DO/Cockpit/G3M1-TGun/hier.him", "he111_gunner");
	...
	static {
		Property.set(CockpitG3M1_TGunner.class, "aiTuretNum", 0);
		Property.set(CockpitG3M1_TGunner.class, "weaponControlNum", 10);
		Property.set(CockpitG3M1_TGunner.class, "astatePilotIndx", 1);
	}
}
