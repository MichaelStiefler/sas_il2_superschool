...
public class D4Y2 extends D4Y implements TypeDiveBomber {
	...
	static {
		...
		Property.set(class1, "FlightModel", "FlightModels/D4Y2.fmd");
		Property.set(class1, "cockpitClass", new Class[] { CockpitD4Y2.class, CockpitD4Y2_TGunner.class });
