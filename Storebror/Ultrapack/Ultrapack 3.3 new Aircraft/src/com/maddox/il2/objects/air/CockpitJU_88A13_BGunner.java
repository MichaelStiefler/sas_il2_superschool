...
public class CockpitJU_88A13_BGunner extends CockpitGunner {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (CockpitJU_88A13_BGunner.this.fm != null) {
				CockpitJU_88A13_BGunner.this.setTmp = CockpitJU_88A13_BGunner.this.setOld;
				CockpitJU_88A13_BGunner.this.setOld = CockpitJU_88A13_BGunner.this.setNew;
				CockpitJU_88A13_BGunner.this.setNew = CockpitJU_88A13_BGunner.this.setTmp;
				CockpitJU_88A13_BGunner.this.setNew.throttle1 = 0.85F * CockpitJU_88A13_BGunner.this.setOld.throttle1 + CockpitJU_88A13_BGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
				CockpitJU_88A13_BGunner.this.setNew.prop1 = 0.85F * CockpitJU_88A13_BGunner.this.setOld.prop1 + CockpitJU_88A13_BGunner.this.fm.EI.engines[0].getControlProp() * 0.15F;
				CockpitJU_88A13_BGunner.this.setNew.throttle2 = 0.85F * CockpitJU_88A13_BGunner.this.setOld.throttle2 + CockpitJU_88A13_BGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
				CockpitJU_88A13_BGunner.this.setNew.prop2 = 0.85F * CockpitJU_88A13_BGunner.this.setOld.prop2 + CockpitJU_88A13_BGunner.this.fm.EI.engines[1].getControlProp() * 0.15F;
				CockpitJU_88A13_BGunner.this.setNew.altimeter = CockpitJU_88A13_BGunner.this.fm.getAltitude();
				float f = CockpitJU_88A13_BGunner.this.waypointAzimuth();
				CockpitJU_88A13_BGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A13_BGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88A13_BGunner.this.setOld.azimuth.getDeg(1.0F));
				CockpitJU_88A13_BGunner.this.setNew.azimuth.setDeg(CockpitJU_88A13_BGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A13_BGunner.this.fm.Or.azimut());
				CockpitJU_88A13_BGunner.this.setNew.vspeed = (199F * CockpitJU_88A13_BGunner.this.setOld.vspeed + CockpitJU_88A13_BGunner.this.fm.getVertSpeed()) / 200F;
				if (CockpitJU_88A13_BGunner.this.cockpitDimControl) {
					if (CockpitJU_88A13_BGunner.this.setNew.dimPosition > 0.0F) CockpitJU_88A13_BGunner.this.setNew.dimPosition = CockpitJU_88A13_BGunner.this.setOld.dimPosition - 0.05F;
				} else if (CockpitJU_88A13_BGunner.this.setNew.dimPosition < 1.0F) CockpitJU_88A13_BGunner.this.setNew.dimPosition = CockpitJU_88A13_BGunner.this.setOld.dimPosition + 0.05F;
				float f1 = CockpitJU_88A13_BGunner.this.prevFuel - CockpitJU_88A13_BGunner.this.fm.M.fuel;
				CockpitJU_88A13_BGunner.this.prevFuel = CockpitJU_88A13_BGunner.this.fm.M.fuel;
				f1 /= 0.72F;
				f1 /= Time.tickLenFs();
				f1 *= 3600F;
				CockpitJU_88A13_BGunner.this.setNew.cons = 0.91F * CockpitJU_88A13_BGunner.this.setOld.cons + 0.09F * f1;
				if (CockpitJU_88A13_BGunner.this.buzzerFX != null)
					if (CockpitJU_88A13_BGunner.this.fm.Loc.z < ((JU_88A13) CockpitJU_88A13_BGunner.this.aircraft()).fDiveRecoveryAlt && ((JU_88A13) ((Interpolate) CockpitJU_88A13_BGunner.this.fm).actor).diveMechStage == 1)
						CockpitJU_88A13_BGunner.this.buzzerFX.play();
					else if (CockpitJU_88A13_BGunner.this.buzzerFX.isPlaying()) CockpitJU_88A13_BGunner.this.buzzerFX.stop();
			}
			return true;
		}
	...
	public CockpitJU_88A13_BGunner() {
		super("3DO/Cockpit/Ju-88A-13-BGun/hier.him", "he111");
	...
	static {
		Property.set(CockpitJU_88A13_BGunner.class, "aiTuretNum", 3);
		Property.set(CockpitJU_88A13_BGunner.class, "weaponControlNum", 13);
		Property.set(CockpitJU_88A13_BGunner.class, "astatePilotIndx", 3);
	}
}
