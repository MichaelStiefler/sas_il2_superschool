...
public class CockpitDo17_LGunner extends CockpitGunner {
	...
	static {
		Property.set(CockpitDo17_LGunner.class, "aiTuretNum", 3);
		Property.set(CockpitDo17_LGunner.class, "weaponControlNum", 13);
		Property.set(CockpitDo17_LGunner.class, "astatePilotIndx", 4);
	}
}
