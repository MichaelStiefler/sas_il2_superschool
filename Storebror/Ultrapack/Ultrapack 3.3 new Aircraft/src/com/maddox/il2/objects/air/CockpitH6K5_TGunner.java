...
public class CockpitH6K5_TGunner extends CockpitGunner {
	...
	public CockpitH6K5_TGunner() {
		super("3DO/Cockpit/H6K5-TGun/hier.him", "he111_gunner");
	...
	static {
		Property.set(CockpitH6K5_TGunner.class, "aiTuretNum", 3);
		Property.set(CockpitH6K5_TGunner.class, "weaponControlNum", 13);
		Property.set(CockpitH6K5_TGunner.class, "astatePilotIndx", 5);
	}
}
