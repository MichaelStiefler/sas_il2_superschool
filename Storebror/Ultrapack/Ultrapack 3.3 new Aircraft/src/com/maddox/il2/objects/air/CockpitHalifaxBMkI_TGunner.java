...
public class CockpitHalifaxBMkI_TGunner extends CockpitGunner {
	...
	public CockpitHalifaxBMkI_TGunner() {
		super("3DO/Cockpit/HalifaxBMkI-TGun/hier.him", "bf109");
	...
	static {
		Property.set(CockpitHalifaxBMkI_TGunner.class, "aiTuretNum", 1);
		Property.set(CockpitHalifaxBMkI_TGunner.class, "weaponControlNum", 11);
		Property.set(CockpitHalifaxBMkI_TGunner.class, "astatePilotIndx", 3);
	}
}
