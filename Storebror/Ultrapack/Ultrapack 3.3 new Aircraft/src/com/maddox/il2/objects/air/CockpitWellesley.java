...
public class CockpitWellesley extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitWellesley.this.fm != null) {
				...
				CockpitWellesley.this.setNew.azimuth = 0.97F * CockpitWellesley.this.setOld.azimuth + 0.03F * -CockpitWellesley.this.fm.Or.getYaw();
				if (CockpitWellesley.this.setOld.azimuth > 270F && CockpitWellesley.this.setNew.azimuth < 90F) CockpitWellesley.this.setOld.azimuth -= 360F;
				if (CockpitWellesley.this.setOld.azimuth < 90F && CockpitWellesley.this.setNew.azimuth > 270F) CockpitWellesley.this.setOld.azimuth += 360F;
				CockpitWellesley.this.setNew.waypointAzimuth = 0.91F * CockpitWellesley.this.setOld.waypointAzimuth + 0.09F * (CockpitWellesley.this.waypointAzimuth() - CockpitWellesley.this.setOld.azimuth) + World.Rnd().nextFloat(-10F, 10F);
				...
				if (CockpitWellesley.this.fm.CT.GearControl < 0.5F) {
					if (CockpitWellesley.this.setNew.gearPhi > 0.0F) CockpitWellesley.this.setNew.gearPhi = CockpitWellesley.this.setOld.gearPhi - 0.021F;
				} else if (CockpitWellesley.this.setNew.gearPhi < 1.0F) CockpitWellesley.this.setNew.gearPhi = CockpitWellesley.this.setOld.gearPhi + 0.021F;
			}
			return true;
		}
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), speedometerScale), 0.0F, 0.0F);
