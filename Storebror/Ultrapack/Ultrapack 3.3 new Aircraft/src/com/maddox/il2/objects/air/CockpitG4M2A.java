	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitG4M2A.this.fm != null) {
				...
				if (CockpitG4M2A.this.useRealisticNavigationInstruments()) CockpitG4M2A.this.setNew.waypointAzimuth.setDeg(CockpitG4M2A.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitG4M2A.this.waypointAzimuth());
				else CockpitG4M2A.this.setNew.waypointAzimuth.setDeg(CockpitG4M2A.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitG4M2A.this.fm.Or.azimut() + 90F);
