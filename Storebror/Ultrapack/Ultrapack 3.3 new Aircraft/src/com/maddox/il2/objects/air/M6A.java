...
public abstract class M6A extends Scheme1 implements TypeStormovik, TypeSailPlane {
	...
	protected void moveElevator(float f) {
		if (this.bHasElevatorControl) {
			...
			this.hierMesh().chunkSetAngles("VatorL1_D0", 0.0F, -30F * this.FM.CT.ElevatorControl, 0.0F);
			this.hierMesh().chunkSetAngles("VatorR_D0", 0.0F, -30F * this.FM.CT.ElevatorControl, 0.0F);
			this.hierMesh().chunkSetAngles("VatorR1_D0", 0.0F, -30F * this.FM.CT.ElevatorControl, 0.0F);
		}
	}
	...
	protected void moveRudder(float f) {
		...
		this.hierMesh().chunkSetAngles("GearC22_D0", 0.0F, -30F * f, 0.0F);
	}
...
//            turretUp = false;
	...
	public void update(float f) {
		...
		if (!this.gunnerDead && !this.gunnerEjected) {
			...
			Aircraft.xyz[1] = Aircraft.cvt(this.turretMove, 0.05F, 0.12F, 0.0F, -0.4F);
			Aircraft.xyz[2] = Aircraft.cvt(this.turretMove, 0.05F, 0.12F, 0.0F, 0.02F);
			this.resetYPRmodifier();
			this.hierMesh().chunkSetAngles("Blister3_D0", 0.0F, this.turretMove * 170F, 0.0F);
		}
		if (this.FM.turret[0].bIsAIControlled) {
			if (this.FM.turret[0].target != null && this.FM.AS.astatePilotStates[2] < 90) this.turretUp = true;
			if (Time.current() > this.btme) {
				this.btme = Time.current() + World.Rnd().nextLong(5000L, 12000L);
				if (this.FM.turret[0].target == null && this.FM.AS.astatePilotStates[2] < 90) this.turretUp = false;
			}
		} else this.turretUp = true;

	}

	protected void moveWingFold(HierMesh hiermesh, float f) {
		hiermesh.chunkSetAngles("CFdamyL_D0", 0.0F, Aircraft.cvt(f, 0.0F, 0.25F, 0.0F, 90F), 0.0F);
		hiermesh.chunkSetAngles("CFdamyR_D0", 0.0F, 0.0F, Aircraft.cvt(f, 0.0F, 0.25F, 0.0F, -90F));
		hiermesh.chunkSetAngles("WingLIn_D0", 0.0F, 0.0F, Aircraft.cvt(f, 0.28F, 1.0F, 0.0F, -85F));
		hiermesh.chunkSetAngles("WingRIn_D0", 0.0F, Aircraft.cvt(f, 0.28F, 1.0F, 0.0F, 85F), 0.0F);
		hiermesh.chunkSetAngles("StabL1_D0", 0.0F, -90F * f, 0.0F);
		hiermesh.chunkSetAngles("StabR1_D0", 0.0F, 90F * f, 0.0F);
		hiermesh.chunkSetAngles("Keel2_D0", -0F, 118F * f, 0.0F);
	}
