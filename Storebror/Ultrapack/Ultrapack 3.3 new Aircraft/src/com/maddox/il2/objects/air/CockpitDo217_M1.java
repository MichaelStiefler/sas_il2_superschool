...
public class CockpitDo217_M1 extends CockpitPilot {
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			CockpitDo217_M1.this.fm.CT.forceCockpitDoor(1.0F);
			CockpitDo217_M1.this.fm.CT.cockpitDoorControl = 1.0F;
			if (CockpitDo217_M1.this.cockpitDimControl) {
				if (CockpitDo217_M1.this.setNew.dimPos < 1.0F) CockpitDo217_M1.this.setNew.dimPos = CockpitDo217_M1.this.setOld.dimPos + 0.03F;
			} else if (CockpitDo217_M1.this.setNew.dimPos > 0.0F) CockpitDo217_M1.this.setNew.dimPos = CockpitDo217_M1.this.setOld.dimPos - 0.03F;
			...
			} else CockpitDo217_M1.this.setNew.waypointAzimuth.setDeg(CockpitDo217_M1.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitDo217_M1.this.setOld.azimuth.getDeg(1.0F));
