...
public class CockpitHE_111H6_Late_Bombardier extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			float f = ((HE_111) CockpitHE_111H6_Late_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((HE_111) CockpitHE_111H6_Late_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitHE_111H6_Late_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
			if (CockpitHE_111H6_Late_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitHE_111H6_Late_Bombardier.this.aAim + 10F * f1, CockpitHE_111H6_Late_Bombardier.this.tAim + f, 0.0F);
			}
			CockpitHE_111H6_Late_Bombardier.this.mesh.chunkSetAngles("TurretA", 0.0F, CockpitHE_111H6_Late_Bombardier.this.aircraft().FM.turret[0].tu[0], 0.0F);
			CockpitHE_111H6_Late_Bombardier.this.mesh.chunkSetAngles("TurretB", 0.0F, CockpitHE_111H6_Late_Bombardier.this.aircraft().FM.turret[0].tu[1], 0.0F);
			CockpitHE_111H6_Late_Bombardier.this.setTmp = CockpitHE_111H6_Late_Bombardier.this.setOld;
			CockpitHE_111H6_Late_Bombardier.this.setOld = CockpitHE_111H6_Late_Bombardier.this.setNew;
			CockpitHE_111H6_Late_Bombardier.this.setNew = CockpitHE_111H6_Late_Bombardier.this.setTmp;
			float f2 = CockpitHE_111H6_Late_Bombardier.this.waypointAzimuthInvertMinus(30F);
			if (CockpitHE_111H6_Late_Bombardier.this.useRealisticNavigationInstruments()) {
				CockpitHE_111H6_Late_Bombardier.this.setNew.waypointAzimuth.setDeg(f2 - 90F);
				CockpitHE_111H6_Late_Bombardier.this.setOld.waypointAzimuth.setDeg(f2 - 90F);
				CockpitHE_111H6_Late_Bombardier.this.setNew.radioCompassAzimuth.setDeg(CockpitHE_111H6_Late_Bombardier.this.setOld.radioCompassAzimuth.getDeg(0.02F),
						CockpitHE_111H6_Late_Bombardier.this.radioCompassAzimuthInvertMinus() - CockpitHE_111H6_Late_Bombardier.this.setOld.azimuth.getDeg(1.0F) - 90F);
			} else CockpitHE_111H6_Late_Bombardier.this.setNew.waypointAzimuth.setDeg(CockpitHE_111H6_Late_Bombardier.this.setOld.waypointAzimuth.getDeg(0.1F), f2 - CockpitHE_111H6_Late_Bombardier.this.setOld.azimuth.getDeg(1.0F));
			CockpitHE_111H6_Late_Bombardier.this.setNew.azimuth.setDeg(CockpitHE_111H6_Late_Bombardier.this.setOld.azimuth.getDeg(1.0F), CockpitHE_111H6_Late_Bombardier.this.fm.Or.azimut());
			return true;
		}
