...
public class CockpitPE2_402 extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitPE2_402.this.fm != null) {
				...
				if (CockpitPE2_402.this.fm.CT.Weapons[3] != null) if (((PE_2NEW) CockpitPE2_402.this.aircraft()).BombLoadType == 1) {
				...
				if (CockpitPE2_402.this.useRealisticNavigationInstruments()) CockpitPE2_402.this.setNew.waypointAzimuth.setDeg(CockpitPE2_402.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitPE2_402.this.getBeaconDirection());
				else CockpitPE2_402.this.setNew.waypointAzimuth.setDeg(CockpitPE2_402.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_402.this.waypointAzimuth() - CockpitPE2_402.this.setOld.azimuth.getDeg(1.0F));
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.resetYPRmodifier();
		if (this.fm.CT.AirBrakeControl > 0.5F) Cockpit.xyz[1] = -0.0175F;
		...
		} else if (this.fm.EI.engines[0].isHasControlCompressor() && !this.fm.EI.engines[1].isHasControlCompressor()) this.Compressor = this.fm.EI.engines[0].getControlCompressor();
		else if (!this.fm.EI.engines[0].isHasControlCompressor() && this.fm.EI.engines[1].isHasControlCompressor()) this.Compressor = this.fm.EI.engines[1].getControlCompressor();
