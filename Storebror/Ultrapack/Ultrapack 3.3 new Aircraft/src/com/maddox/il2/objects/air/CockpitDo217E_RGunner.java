...
public class CockpitDo217E_RGunner extends CockpitGunner {
	...
	public void moveGun(Orient orient) {
		...
		this.mesh.chunkSetAngles("z_Turret5A", 0.0F, orient.getYaw(), 0.0F);
		this.mesh.chunkSetAngles("z_Turret5B", 0.0F, orient.getTangage(), 0.0F);
	}
	...
	public CockpitDo217E_RGunner() {
		super("3DO/Cockpit/Do217E2/hierRGun.him", "he111_gunner");
		this.w = new Vector3f();
	...
	static {
		Property.set(CockpitDo217E_RGunner.class, "aiTuretNum", 4);
		Property.set(CockpitDo217E_RGunner.class, "weaponControlNum", 14);
		Property.set(CockpitDo217E_RGunner.class, "astatePilotIndx", 5);
	}
}
