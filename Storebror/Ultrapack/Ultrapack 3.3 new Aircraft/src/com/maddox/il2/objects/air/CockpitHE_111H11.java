...
public class CockpitHE_111H11 extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			} else CockpitHE_111H11.this.setNew.waypointAzimuth.setDeg(CockpitHE_111H11.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111H11.this.setOld.azimuth.getDeg(1.0F));
			...
			if (f2 < 100F || CockpitHE_111H11.this.fm.EI.engines[0].getRPM() < 600F) f2 = 1.0F;
			if (f3 < 100F || CockpitHE_111H11.this.fm.EI.engines[1].getRPM() < 600F) f3 = 1.0F;
			...
			if (f4 > 55F || f4 < -55F || f5 < -55F || f5 > 55F) CockpitHE_111H11.this.Pn.z = 236D;
			else {
				...
				if (CockpitHE_111H11.this.fm.CT.getGear() > 0.5F) CockpitHE_111H11.this.Pn.z = CockpitHE_111H11.this.cvt((float) CockpitHE_111H11.this.Pn.z, 0.0F, 150F, 0.0F, 236F);
				else CockpitHE_111H11.this.Pn.z = CockpitHE_111H11.this.cvt((float) CockpitHE_111H11.this.Pn.z, 0.0F, 750F, 0.0F, 236F);
			}
	...
	public void reflectCockpitState() {
		...
		if ((this.fm.AS.astateCockpitState & 0x40) != 0) this.mesh.chunkVisible("PanelT_D1", true);
