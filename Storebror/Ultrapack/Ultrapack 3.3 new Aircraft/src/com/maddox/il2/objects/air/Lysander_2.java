...
public class Lysander_2 extends LysanderX implements TypeBomber, TypeScout, TypeTransport {

	static {
		Class class1 = Lysander_2.class;
		new NetAircraft.SPAWN(class1);
		Property.set(class1, "iconFar_shortClassName", "Lizzie");
		Property.set(class1, "meshName", "3do/plane/Lysander_2/hier.him");
		Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
		Property.set(class1, "yearService", 1939F);
		Property.set(class1, "yearExpired", 1956F);
		Property.set(class1, "FlightModel", "FlightModels/Lysander2.fmd");
		Property.set(class1, "cockpitClass", new Class[] { CockpitLysander_1.class, CockpitLysander_1_Gunner.class });
