...
public class CockpitG4M2A_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			float f = ((G4M) CockpitG4M2A_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((G4M) CockpitG4M2A_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitG4M2A_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
			if (CockpitG4M2A_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitG4M2A_Bombardier.this.aAim + 10F * f1, CockpitG4M2A_Bombardier.this.tAim + f, 0.0F);
			}
			CockpitG4M2A_Bombardier.this.mesh.chunkSetAngles("Turret1A", 0.0F, -CockpitG4M2A_Bombardier.this.aircraft().FM.turret[0].tu[0], 0.0F);
			CockpitG4M2A_Bombardier.this.mesh.chunkSetAngles("Turret1B", 0.0F, CockpitG4M2A_Bombardier.this.aircraft().FM.turret[0].tu[1], 0.0F);
			return true;
		}
	...
	public CockpitG4M2A_Bombardier() {
		super("3DO/Cockpit/G4M2A-Bombardier/hier.him", "he111");
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (this.bEntered) {
			this.mesh.chunkSetAngles("zAngleMark", -this.floatindex(this.cvt(((G4M) this.aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
			boolean flag = ((G4M) this.aircraft()).fSightCurReadyness > 0.93F;
	...
	static {
		Property.set(CockpitG4M2A_Bombardier.class, "astatePilotIndx", 0);
	}
}
