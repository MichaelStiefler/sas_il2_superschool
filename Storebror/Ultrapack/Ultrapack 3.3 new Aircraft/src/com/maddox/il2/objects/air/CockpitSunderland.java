...
public class CockpitSunderland extends CockpitPilot {
	...
	protected float waypointAzimuth() {
		...
		float f = (float) (180D / Math.PI * Math.atan2(-this.tmpV.y, this.tmpV.x));
		while (f <= -180F)
			f += 180F;
		while (f > 180F)
			f -= 180F;
	...
	public void reflectWorldToInstruments(float f) {
		...
		this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), speedometerScale), 0.0F, 0.0F);
		this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), speedometerScale), 0.0F, 0.0F);
		...
		if (f2 < 0.0F) this.mesh.chunkSetAngles("Z_Temp5", this.cvt(f2, -40F, 0.0F, 0.0F, 45F), 0.0F, 0.0F);
		else this.mesh.chunkSetAngles("Z_Temp5", this.cvt(f2, 0.0F, 60F, 45F, 90F), 0.0F, 0.0F);
		f2 = Atmosphere.temperature((float) this.fm.Loc.z) - 273.09F + 44.4F * this.fm.EI.engines[1].getPowerOutput();
		if (f2 < 0.0F) this.mesh.chunkSetAngles("Z_Temp6", this.cvt(f2, -40F, 0.0F, 0.0F, 45F), 0.0F, 0.0F);
		else this.mesh.chunkSetAngles("Z_Temp6", this.cvt(f2, 0.0F, 60F, 45F, 90F), 0.0F, 0.0F);
