...
public class CockpitHE_111ABE_BGunner extends CockpitGunner {
	...
	public CockpitHE_111ABE_BGunner() {
		super("3DO/Cockpit/He-111ABE-BGun/hier.him", "he111_gunner");
		this.hook1 = null;
		this.iCocking = 0;
	...
	static {
		Property.set(CockpitHE_111ABE_BGunner.class, "aiTuretNum", 2);
		Property.set(CockpitHE_111ABE_BGunner.class, "weaponControlNum", 12);
		Property.set(CockpitHE_111ABE_BGunner.class, "astatePilotIndx", 3);
	}
}
