	...
	protected void interpTick() {
		if (this.isRealMode()) {
			...
			if (this.bGunFire) {
				...
				if (this.hook3 == null) this.hook3 = new HookNamed(this.aircraft(), "_MGUN07");
				this.doHitMasterAircraft(this.aircraft(), this.hook3, "_MGUN07");
				if (this.hook4 == null) this.hook4 = new HookNamed(this.aircraft(), "_MGUN08");
				this.doHitMasterAircraft(this.aircraft(), this.hook4, "_MGUN08");
			}
		}
	}
