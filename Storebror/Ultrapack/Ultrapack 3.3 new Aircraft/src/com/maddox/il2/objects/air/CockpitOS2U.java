	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitOS2U.this.fm != null) {
				...
				if (Math.abs(CockpitOS2U.this.fm.Or.getKren()) < 30F) CockpitOS2U.this.setNew.azimuth = (35F * CockpitOS2U.this.setOld.azimuth + -CockpitOS2U.this.fm.Or.getYaw()) / 36F;
				if (CockpitOS2U.this.setOld.azimuth > 270F && CockpitOS2U.this.setNew.azimuth < 90F) CockpitOS2U.this.setOld.azimuth -= 360F;
				if (CockpitOS2U.this.setOld.azimuth < 90F && CockpitOS2U.this.setNew.azimuth > 270F) CockpitOS2U.this.setOld.azimuth += 360F;
				CockpitOS2U.this.setNew.waypointAzimuth = (10F * CockpitOS2U.this.setOld.waypointAzimuth + (CockpitOS2U.this.waypointAzimuth() - CockpitOS2U.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
