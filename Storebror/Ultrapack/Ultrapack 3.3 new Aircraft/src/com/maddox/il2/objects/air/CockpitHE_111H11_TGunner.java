...
public class CockpitHE_111H11_TGunner extends CockpitGunner {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			CockpitHE_111H11_TGunner.this.setTmp = CockpitHE_111H11_TGunner.this.setOld;
			CockpitHE_111H11_TGunner.this.setOld = CockpitHE_111H11_TGunner.this.setNew;
			CockpitHE_111H11_TGunner.this.setNew = CockpitHE_111H11_TGunner.this.setTmp;
			if (CockpitHE_111H11_TGunner.this.cockpitDimControl) {
				if (CockpitHE_111H11_TGunner.this.setNew.dimPosition > 0.0F) CockpitHE_111H11_TGunner.this.setNew.dimPosition = CockpitHE_111H11_TGunner.this.setOld.dimPosition - 0.05F;
			} else if (CockpitHE_111H11_TGunner.this.setNew.dimPosition < 1.0F) CockpitHE_111H11_TGunner.this.setNew.dimPosition = CockpitHE_111H11_TGunner.this.setOld.dimPosition + 0.05F;
			return true;
		}
	...
	public CockpitHE_111H11_TGunner() {
		super("3DO/Cockpit/He-111P-4-TGun/hier-H11.him", "he111_gunner");
	...
	static {
		Property.set(CockpitHE_111H11_TGunner.class, "aiTuretNum", 1);
		Property.set(CockpitHE_111H11_TGunner.class, "weaponControlNum", 11);
		Property.set(CockpitHE_111H11_TGunner.class, "astatePilotIndx", 2);
	}
}
