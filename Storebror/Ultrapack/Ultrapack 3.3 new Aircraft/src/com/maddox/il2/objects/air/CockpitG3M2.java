	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (CockpitG3M2.this.fm != null) {
				...
				if (CockpitG3M2.this.useRealisticNavigationInstruments()) CockpitG3M2.this.setNew.waypointAzimuth.setDeg(CockpitG3M2.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitG3M2.this.waypointAzimuth());
				else CockpitG3M2.this.setNew.waypointAzimuth.setDeg(CockpitG3M2.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitG3M2.this.fm.Or.azimut() + 90F);
