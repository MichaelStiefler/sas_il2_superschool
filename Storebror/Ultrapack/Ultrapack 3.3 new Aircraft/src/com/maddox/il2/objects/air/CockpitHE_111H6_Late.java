	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			...
			if (CockpitHE_111H6_Late.this.useRealisticNavigationInstruments()) {
				...
				CockpitHE_111H6_Late.this.setNew.radioCompassAzimuth.setDeg(CockpitHE_111H6_Late.this.setOld.radioCompassAzimuth.getDeg(0.02F),
						CockpitHE_111H6_Late.this.radioCompassAzimuthInvertMinus() - CockpitHE_111H6_Late.this.setOld.azimuth.getDeg(1.0F) - 90F);
			} else CockpitHE_111H6_Late.this.setNew.waypointAzimuth.setDeg(CockpitHE_111H6_Late.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111H6_Late.this.setOld.azimuth.getDeg(1.0F));
			...
			if (f2 < 100F || CockpitHE_111H6_Late.this.fm.EI.engines[0].getRPM() < 600F) f2 = 1.0F;
			if (f3 < 100F || CockpitHE_111H6_Late.this.fm.EI.engines[1].getRPM() < 600F) f3 = 1.0F;
