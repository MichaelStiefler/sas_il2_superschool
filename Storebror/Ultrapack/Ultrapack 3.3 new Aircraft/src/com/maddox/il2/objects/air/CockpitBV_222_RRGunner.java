...
public class CockpitBV_222_RRGunner extends CockpitGunner {
	...
	static {
		Property.set(CockpitBV_222_RRGunner.class, "aiTuretNum", 3);
		Property.set(CockpitBV_222_RRGunner.class, "weaponControlNum", 13);
		Property.set(CockpitBV_222_RRGunner.class, "astatePilotIndx", 5);
	}
}
