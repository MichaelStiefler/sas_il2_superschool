...
public class CockpitF1M_Gunner extends CockpitGunner {
	...
	public CockpitF1M_Gunner() {
		super("3DO/Cockpit/F1M-TGun/hier.him", "he111_gunner");
		this.hook1 = null;
	...
	static {
		Property.set(CockpitF1M_Gunner.class, "aiTuretNum", 0);
		Property.set(CockpitF1M_Gunner.class, "weaponControlNum", 10);
		Property.set(CockpitF1M_Gunner.class, "astatePilotIndx", 1);
	}
}
