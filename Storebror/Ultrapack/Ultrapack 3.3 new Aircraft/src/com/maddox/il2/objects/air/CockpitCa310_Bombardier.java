...
public class CockpitCa310_Bombardier extends CockpitPilot {
	class Interpolater extends InterpolateRef {

		public boolean tick() {
			if (CockpitCa310_Bombardier.this.bEntered) {
				float f = ((Ca_310) CockpitCa310_Bombardier.this.aircraft()).fSightCurForwardAngle;
				float f1 = -((Ca_310) CockpitCa310_Bombardier.this.aircraft()).fSightCurSideslip;
				CockpitCa310_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setSimpleAimOrient(-f1, CockpitCa310_Bombardier.this.tAim + f, 0.0F);
			}
			return true;
		}
	...
	public CockpitCa310_Bombardier() {
		super("3DO/Cockpit/Pe-2-Bombardier/BombardierCa310.him", "he111");
		this.bEntered = false;
		try {
			Loc loc = new Loc();
	...
	public void reflectWorldToInstruments(float f) {
		this.mesh.chunkSetAngles("zMark1", ((Ca_310) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
		float f1 = this.cvt(((Ca_310) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
	...
	static {
		Property.set(CockpitCa310_Bombardier.class, "astatePilotIndx", 0);
	}
}
