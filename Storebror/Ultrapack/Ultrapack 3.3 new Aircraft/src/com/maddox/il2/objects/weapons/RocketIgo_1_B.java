...
public class RocketIgo_1_B extends RocketBomb {
	...
	class Mirror extends ActorNet {
		...
		public boolean netInput(NetMsgInput netmsginput) throws IOException {
			...
			RocketIgo_1_B.this.setSpeed(RocketIgo_1_B.v);
			return true;
		}
	...
	class Master extends ActorNet implements NetUpdate {
		...
		public void netUpdate() {
			try {
				...
				RocketIgo_1_B.this.getSpeed(RocketIgo_1_B.v);
				this.out.writeFloat((float) RocketIgo_1_B.v.x);
				this.out.writeFloat((float) RocketIgo_1_B.v.y);
				this.out.writeFloat((float) RocketIgo_1_B.v.z);
