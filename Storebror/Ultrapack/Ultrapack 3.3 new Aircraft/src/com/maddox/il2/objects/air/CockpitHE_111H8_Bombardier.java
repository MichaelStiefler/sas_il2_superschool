...
public class CockpitHE_111H8_Bombardier extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			float f = ((HE_111) CockpitHE_111H8_Bombardier.this.aircraft()).fSightCurForwardAngle;
			float f1 = ((HE_111) CockpitHE_111H8_Bombardier.this.aircraft()).fSightCurSideslip;
			CockpitHE_111H8_Bombardier.this.mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, f);
			if (CockpitHE_111H8_Bombardier.this.bEntered) {
				HookPilot hookpilot = HookPilot.current;
				hookpilot.setInstantOrient(CockpitHE_111H8_Bombardier.this.aAim + 10F * f1, CockpitHE_111H8_Bombardier.this.tAim + f, 0.0F);
			}
			CockpitHE_111H8_Bombardier.this.setTmp = CockpitHE_111H8_Bombardier.this.setOld;
			CockpitHE_111H8_Bombardier.this.setOld = CockpitHE_111H8_Bombardier.this.setNew;
			CockpitHE_111H8_Bombardier.this.setNew = CockpitHE_111H8_Bombardier.this.setTmp;
			float f2 = CockpitHE_111H8_Bombardier.this.waypointAzimuthInvertMinus(30F);
			if (CockpitHE_111H8_Bombardier.this.useRealisticNavigationInstruments()) {
				CockpitHE_111H8_Bombardier.this.setNew.waypointAzimuth.setDeg(f2 - 90F);
				CockpitHE_111H8_Bombardier.this.setOld.waypointAzimuth.setDeg(f2 - 90F);
				CockpitHE_111H8_Bombardier.this.setNew.radioCompassAzimuth.setDeg(CockpitHE_111H8_Bombardier.this.setOld.radioCompassAzimuth.getDeg(0.02F),
						CockpitHE_111H8_Bombardier.this.radioCompassAzimuthInvertMinus() - CockpitHE_111H8_Bombardier.this.setOld.azimuth.getDeg(1.0F) - 90F);
			} else CockpitHE_111H8_Bombardier.this.setNew.waypointAzimuth.setDeg(CockpitHE_111H8_Bombardier.this.setOld.waypointAzimuth.getDeg(0.1F), f2 - CockpitHE_111H8_Bombardier.this.setOld.azimuth.getDeg(1.0F));
			CockpitHE_111H8_Bombardier.this.setNew.azimuth.setDeg(CockpitHE_111H8_Bombardier.this.setOld.azimuth.getDeg(1.0F), CockpitHE_111H8_Bombardier.this.fm.Or.azimut());
			return true;
		}
	...
	public CockpitHE_111H8_Bombardier() {
		super("3DO/Cockpit/He-111P-4-Bombardier/hier-H8.him", "he111");
	...
	public void reflectWorldToInstruments(float f) {
		...
		if (this.bEntered) {
			...
			this.mesh.chunkVisible("Kuto_Nose", true);
			this.mesh.chunkVisible("zReticle", flag);
			this.mesh.chunkVisible("zAngleMark", flag);
		} else {
			this.mesh.chunkVisible("BlackBox", false);
			this.mesh.chunkVisible("Kuto_Nose", false);
			this.mesh.chunkVisible("zReticle", false);
			this.mesh.chunkVisible("zAngleMark", false);
		}
		this.mesh.chunkVisible("Kuto_MidL", this.aircraft().hierMesh().isChunkVisible("Kuto_MidL_D0"));
		this.mesh.chunkVisible("Kuto_MidR", this.aircraft().hierMesh().isChunkVisible("Kuto_MidR_D0"));
	...
	static {
		Property.set(CockpitHE_111H8_Bombardier.class, "astatePilotIndx", 1);
	}
}
