...
public class CockpitLysander_1_Gunner extends CockpitGunner {
	...
	public CockpitLysander_1_Gunner() {
		super("3DO/Cockpit/Lysander_1_Gunner/hier.him", "bf109");
	...
	static {
		Property.set(CockpitLysander_1_Gunner.class, "aiTuretNum", 0);
		Property.set(CockpitLysander_1_Gunner.class, "weaponControlNum", 10);
		Property.set(CockpitLysander_1_Gunner.class, "astatePilotIndx", 1);
	}
}
