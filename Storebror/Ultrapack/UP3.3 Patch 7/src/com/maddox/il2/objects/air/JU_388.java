...
public abstract class JU_388 extends Scheme2 {
    ...
    public void blisterRemoved(int i) {
        ...
        } else if (i == 2 || i == 3 || i == 4) if (!this.blisterRemoved) this.doRemoveBlister1();
    }
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
        float f3 = Math.max(-f2 * 1600F, -80F);
        ...
        float f4 = f1 < 0.5F ? Math.abs(Math.min(f1, 0.1F)) : Math.abs(Math.min(1.0F - f1, 0.1F));
        if (f4 < 0.002F) f4 = 0.0F;
        float f5 = f < 0.5F ? Math.abs(Math.min(f, 0.1F)) : Math.abs(Math.min(1.0F - f, 0.1F));
        ...
        f4 = cvt(f1, 0.0F, 0.5F, 0.0F, 0.1F);
        if (f4 < 0.002F) f4 = 0.0F;
        f5 = cvt(f, 0.0F, 0.5F, 0.0F, 0.1F);
        if (f5 < 0.002F) f5 = 0.0F;
        ...
        hiermesh.chunkSetAngles("GearR8_D0", 0.0F, 0.0F, 93F * f1);
        hiermesh.chunkSetAngles("GearL8_D0", 0.0F, 0.0F, 93F * f);
        hiermesh.chunkSetAngles("GearR3_D0", 85F * f1, 0.0F, 0.0F);
        hiermesh.chunkSetAngles("GearL3_D0", -85F * f, 0.0F, 0.0F);
        hiermesh.chunkSetAngles("GearR9_D0", 0.0F, 0.0F, -116F * f1);
        hiermesh.chunkSetAngles("GearL9_D0", 0.0F, 0.0F, -116F * f);
        hiermesh.chunkSetAngles("GearR10_D0", 0.0F, 0.0F, 126F * f1);
