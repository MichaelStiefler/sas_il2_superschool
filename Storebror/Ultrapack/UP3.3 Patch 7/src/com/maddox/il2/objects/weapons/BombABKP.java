...
//        setStartDelayedExplosion(true);
        if(/*fuze == null || */delayExplosion == 0.0F)
            t1 = Time.current() + 3000L;
        else
            t1 = Time.current() + (long)(1000F * delayExplosion);
    }

    public void interpolateTick()
    {
        super.interpolateTick();
        if(t1 < Time.current() && !bursted)
            doFireContaineds();
    }
    ...
    protected void doFireContaineds(int i, Class class1, Class class2, Class class3, Class class4)
    {
        ...
        bomb.pos.setAbs(point3d, pos.getAbsOrient());
        bomb.pos.reset();
        bomb.start();
        ...
        bomb1.pos.setAbs(point3d, pos.getAbsOrient());
        bomb1.pos.reset();
        bomb1.start();
        ...
        bomb2.pos.setAbs(point3d, pos.getAbsOrient());
        bomb2.pos.reset();
        bomb2.start();
        ...
        String s = Property.stringValue(getClass(), "mesh_tail", null);
