...
public class U_2VS_shkas extends U_2VS_TD {
    static 
    {
        Class class1 = U_2VS_shkas.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "U-2");
        Property.set(class1, "meshName", "3do/plane/U_2VS/hier_ShKAS.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitU_2VS_ShKAS.class, CockpitU_2VSLNB_Bombardier.class, CockpitU_2VSLNB_TGunner.class
        });
