...
public class KI_15_II extends KI_15xyz {

    static {
        Class class1 = KI_15_II.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ki-15");
        Property.set(class1, "meshName", "3DO/Plane/Ki-15/hierII.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/Ki-15-II.fmd");
