    ...
    implements TypeBomber
{
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitHalifaxBMkIII.class, CockpitHalifaxBMkIII_Bombardier.class, CockpitHalifaxBMkIII_FGunner.class, CockpitHalifaxBMkIII_TGunner.class, CockpitHalifaxBMkIII_AGunner.class
        });
