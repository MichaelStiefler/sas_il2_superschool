    ...
    implements TypeStormovik
{
    ...
    public void onAircraftLoaded()
    {
        ...
        if(FM.CT.Weapons[3] != null && ((FM.CT.Weapons[3][0] instanceof BombGunTorpMk13) || (FM.CT.Weapons[3][0] instanceof BombGunTorpMk13late)))
        {
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitA_20G.class, CockpitA_20G_TGunner.class, CockpitA_20G_BGunner.class
        });
