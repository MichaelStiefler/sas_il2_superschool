...
public abstract class JU_88 extends Scheme2
{
    ...
    public void rareAction(float f, boolean flag)
    {
        ...
        if(flag && World.Rnd().nextFloat() < 0.2F)
        {
            ...
            if(FM.AS.astateTankStates[0] > 4 && World.Rnd().nextFloat() < 0.11F)
                nextDMGLevel(FM.AS.astateEffectChunks[0] + "0", 0, this);
            if(FM.AS.astateTankStates[1] > 4 && World.Rnd().nextFloat() < 0.11F)
                nextDMGLevel(FM.AS.astateEffectChunks[1] + "0", 0, this);
            if(FM.AS.astateTankStates[1] > 4 && World.Rnd().nextFloat() < 0.11F)
                FM.AS.hitTank(this, 2, 3);
            if(FM.AS.astateTankStates[2] > 4 && World.Rnd().nextFloat() < 0.11F)
                FM.AS.hitTank(this, 1, 3);
            if(FM.AS.astateTankStates[2] > 4 && World.Rnd().nextFloat() < 0.11F)
                nextDMGLevel(FM.AS.astateEffectChunks[2] + "0", 0, this);
            if(FM.AS.astateTankStates[3] > 4 && World.Rnd().nextFloat() < 0.11F)
