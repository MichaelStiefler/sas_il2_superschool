        ...
        private void $1() {
            if (F_86A.this.ts) {
                ...
                if (f2 > 0.6F) {
                    ...
                    F_86A.this.ictl = false;
                }
                if (this.ftl > 0.0F) {
                    if (World.Rnd().nextFloat() > 0.6F) {
                        if (F_86A.this.FM.CT.RudderControl > 0.0F) {
                            F_86A.this.FM.CT.RudderControl -= this.ftl * f2;
                        } else if (F_86A.this.FM.CT.RudderControl < 0.0F) {
                            F_86A.this.FM.CT.RudderControl += this.ftl * f2;
                        } else {
                    ...
                    if (F_86A.this.FM.CT.RudderControl > 1.0F) {
                        F_86A.this.FM.CT.RudderControl = 1.0F;
                    }
                    if (F_86A.this.FM.CT.RudderControl < -1.0F) {
                        F_86A.this.FM.CT.RudderControl = -1.0F;
                    }
