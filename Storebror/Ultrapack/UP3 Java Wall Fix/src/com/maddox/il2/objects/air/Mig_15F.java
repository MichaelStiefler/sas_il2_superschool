    ...
    private class _cls0
    {
        ...
        private void $1()
        {
            if(ts)
            {
                ...
                float f2 = Aircraft.cvt(mn, mn >= Mig_15F.mteb ? Mig_15F.uteb : Mig_15F.lteb, mn >= Mig_15F.mteb ? Mig_15F.lteb : Mig_15F.uteb, mn >= Mig_15F.mteb ? thef : bhef, mn >= Mig_15F.mteb ? phef : thef);
                float f3 = Aircraft.cvt(mn, mn >= Mig_15F.mteb ? Mig_15F.uteb : Mig_15F.lteb, mn >= Mig_15F.mteb ? Mig_15F.lteb : Mig_15F.uteb, mn >= Mig_15F.mteb ? wef / f1 : mef, mn >= Mig_15F.mteb ? lef / f1 : wef / f1);
