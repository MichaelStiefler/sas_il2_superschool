    ...
    implements TypeFighter
{
    ...
    protected boolean cutFM(int i, int j, Actor actor)
    {
        ...
        case 33:
            FM.AS.hitTank(this, 1, World.Rnd().nextInt(3, 6));
            return super.cutFM(34, j, actor);

        case 36:
            FM.AS.hitTank(this, 2, World.Rnd().nextInt(3, 6));
