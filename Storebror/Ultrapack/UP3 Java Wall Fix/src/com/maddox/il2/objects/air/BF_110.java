    ...
    protected void hitBone(String s, Shot shot, Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.endsWith("p1"))
                {
                    if(Math.abs(point3d.y) > 0.231D)
                        getEnergyPastArmor(8.585D / (Math.abs(v1.y) + 9.9999997473787516E-005D), shot);
                    else
                ...
                if(s.endsWith("p3"))
                {
                    ...
                    {
                        getEnergyPastArmor(8.585D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    } else
                    {
                        if(point3d.z < 0.09D)
                        {
                        ...
                        if(point3d.z > 0.288D && Math.abs(point3d.y) < 0.077D)
                            getEnergyPastArmor(World.Rnd().nextFloat(8.5F, 12.46F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                        else
                            getEnergyPastArmor(10.51D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    }
                } else
                if(s.endsWith("p4"))
                {
                ...
                if(s.endsWith("p5"))
                    getEnergyPastArmor(5.51D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p6"))
                {
                    if(point3d.z > 0.448D)
                    {
                        ...
                        getEnergyPastArmor(10.604999542236328D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    } else
                    if(Math.abs(point3d.y) > 0.264D)
                    {
                        if(point3d.z > 0.021000000000000001D)
                        {
                            getEnergyPastArmor(8.51D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                        } else
                        {
                            debuggunnery("Armor: Bullet Went Through a Pilofacturing Hole..");
                            return;
                    ...
                    } else
                    {
                        ...
                        getEnergyPastArmor(8.0600004196166992D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                    }
                } else
                if(s.endsWith("p7"))
                    getEnergyPastArmor(6.059999942779541D / (Math.abs(v1.z) + 9.9999997473787516E-005D), shot);
                else
                if(s.endsWith("p8"))
                {
            ...
            if(s.startsWith("xxspar"))
            {
                ...
                if(s.startsWith("xxspart") && chunkDamageVisible("Tail1") > 2 && getEnergyPastArmor(3.5F / (float)Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F && World.Rnd().nextFloat() < 0.75F)
                {
    ...
    public void onAircraftLoaded()
    {
        ...
        if(this instanceof BF_110G2)
        {
            ...
            for(int i = 0; i < aobj.length; i++)
            {
                ...
                {
                    hierMesh().chunkVisible("4xMG17", false);
                    hierMesh().chunkVisible("2xMK108", true);
                }
            }
