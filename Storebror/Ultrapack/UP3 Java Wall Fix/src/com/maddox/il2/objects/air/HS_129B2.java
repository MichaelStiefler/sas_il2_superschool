...
public class HS_129B2 extends HS_129
{
    ...
    public void onAircraftLoaded()
    {
        ...
        if(aobj != null)
        {
            for(int i = 0; i < aobj.length; i++)
            {
                ...
                if(aobj[i] instanceof PylonHS129MG17S)
    ...
    static 
    {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] {
            ...
            "_MGUN05", "_MGUN06", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08", 
