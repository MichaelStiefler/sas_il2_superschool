    ...
    implements TypeFighter
{
    ...
    public I_16FixedSkis()
    {
        ...
        skiAngleR = 0.0F;
        spring = 0.15F;
        wireRandomizer1 = 1.0F;
        wireRandomizer2 = 1.0F;
        wireRandomizer3 = 1.0F;
        wireRandomizer4 = 1.0F;
    }
        ...
        if(s.startsWith("xx"))
        {
            ...
            } else
            {
                ...
                if(s.startsWith("xxeng"))
                {
                    ...
                    if(s.endsWith("prop"))
                    {
                        if(getEnergyPastArmor(0.45F / (Math.abs((float)Aircraft.v1.x) + 0.0001F), shot) > 0.0F && World.Rnd().nextFloat() < 0.05F)
                        {
    ...
    protected void moveFan(float f)
    {
        if(Config.isUSE_RENDER())
        {
            ...
            float f3 = Aircraft.cvt(FM.getSpeed(), 30F, 80F, 1.0F, 0.0F);
            ...
            if(FM.Gears.gWheelSinking[0] > 0.0F)
            {
                ...
                hierMesh().chunkSetAngles("SkiL1_D0", World.Rnd().nextFloat(-f4, f4), World.Rnd().nextFloat(-f4 * 2.0F, f4 * 2.0F) - skiAngleL, World.Rnd().nextFloat(f4, f4));
            } else
            {
            ...
            if(FM.Gears.gWheelSinking[1] > 0.0F)
            {
                ...
                hierMesh().chunkSetAngles("SkiR1_D0", World.Rnd().nextFloat(-f4, f4), World.Rnd().nextFloat(-f4 * 2.0F, f4 * 2.0F) + skiAngleR, World.Rnd().nextFloat(f4, f4));
            ...
            hierMesh().chunkSetAngles("SkiC1_D0", 0.0F, -((skiAngleL + skiAngleR) / 2.0F), 0.0F);
            float f5 = skiAngleL / 20F;
            ...
            if(skiAngleL < 0.0F)
            {
                hierMesh().chunkSetAngles("WireL1_d0", 0.0F, f5 * -15F, 0.0F);
                hierMesh().chunkSetAngles("WireL12_d0", 0.0F, f5 * -15F, 0.0F);
            ...
            } else
            {
                ...
                hierMesh().chunkSetAngles("WireL1_d0", 0.0F, -f5 * (56.5F * f6), f5 * (-37F * f3) * wireRandomizer3);
                hierMesh().chunkSetAngles("WireL12_d0", 0.0F, -f5 * (77.3F * f6), f5 * (28F * f3) * wireRandomizer4);
                float f8 = f5 * -5F;
                float f10 = f5 * 10F;
                float f12 = f5 * 15F;
                float f14 = f5 * 20F;
                float f16 = f5 * (5F * f3) * wireRandomizer3;
                float f18 = f5 * (10F * f3) * wireRandomizer3;
                float f20 = f5 * (-5F * f3) * wireRandomizer4;
                hierMesh().chunkSetAngles("WireL2_d0", 0.0F, f8, f18);
                hierMesh().chunkSetAngles("WireL3_d0", 0.0F, f10, f16);
                hierMesh().chunkSetAngles("WireL4_d0", 0.0F, f12, f18);
                hierMesh().chunkSetAngles("WireL5_d0", 0.0F, f12, f16);
                hierMesh().chunkSetAngles("WireL6_d0", 0.0F, f12, f18);
                hierMesh().chunkSetAngles("WireL7_d0", 0.0F, f10, f16);
                hierMesh().chunkSetAngles("WireL8_d0", 0.0F, f12, f18);
                hierMesh().chunkSetAngles("WireL9_d0", 0.0F, f12, f16);
                hierMesh().chunkSetAngles("WireL10_d0", 0.0F, f10, f18);
                hierMesh().chunkSetAngles("WireL11_d0", 0.0F, f8, f16);
                hierMesh().chunkSetAngles("WireL13_d0", 0.0F, f10, f20);
                hierMesh().chunkSetAngles("WireL14_d0", 0.0F, f12, f20);
                hierMesh().chunkSetAngles("WireL15_d0", 0.0F, f12, f20);
                hierMesh().chunkSetAngles("WireL16_d0", 0.0F, f14, f20);
                hierMesh().chunkSetAngles("WireL17_d0", 0.0F, f10, 0.0F);
                hierMesh().chunkSetAngles("WireL18_d0", 0.0F, f10, f20);
                hierMesh().chunkSetAngles("WireL19_d0", 0.0F, f12, f20);
                hierMesh().chunkSetAngles("WireL20_d0", 0.0F, f10, f20);
                hierMesh().chunkSetAngles("WireL21_d0", 0.0F, f10, f20);
                hierMesh().chunkSetAngles("WireL22_d0", 0.0F, f12, f20);
            }
            f5 = skiAngleR / 20F;
            ...
            if(skiAngleR < 0.0F)
            {
                hierMesh().chunkSetAngles("WireR1_d0", 0.0F, f5 * -15F, 0.0F);
                hierMesh().chunkSetAngles("WireR12_d0", 0.0F, f5 * -15F, 0.0F);
            ...
            } else
            {
                float f7 = 1.0F;
                if(f5 < 0.5F)
                    f7 = Aircraft.cvt(f5, 0.0F, 0.5F, 1.0F, 0.95F);
                else
                    f7 = Aircraft.cvt(f5, 0.5F, 1.0F, 0.95F, 1.0F);
                hierMesh().chunkSetAngles("WireR1_d0", 0.0F, -f5 * (56.5F * f7), f5 * (-37F * f3) * wireRandomizer1);
                hierMesh().chunkSetAngles("WireR12_d0", 0.0F, -f5 * (77.3F * f7), f5 * (28F * f3) * wireRandomizer2);
                float f9 = f5 * -5F;
                float f11 = f5 * 10F;
                float f13 = f5 * 15F;
                float f15 = f5 * 20F;
                float f17 = f5 * (5F * f3) * wireRandomizer1;
                float f19 = f5 * (10F * f3) * wireRandomizer1;
                float f21 = f5 * (-5F * f3) * wireRandomizer2;
                hierMesh().chunkSetAngles("WireR2_d0", 0.0F, f9, f19);
                hierMesh().chunkSetAngles("WireR3_d0", 0.0F, f11, f17);
                hierMesh().chunkSetAngles("WireR4_d0", 0.0F, f11, f19);
                hierMesh().chunkSetAngles("WireR5_d0", 0.0F, f13, f17);
                hierMesh().chunkSetAngles("WireR6_d0", 0.0F, f13, f19);
                hierMesh().chunkSetAngles("WireR7_d0", 0.0F, f13, f17);
                hierMesh().chunkSetAngles("WireR8_d0", 0.0F, f11, f19);
                hierMesh().chunkSetAngles("WireR9_d0", 0.0F, f13, f17);
                hierMesh().chunkSetAngles("WireR10_d0", 0.0F, f13, f19);
                hierMesh().chunkSetAngles("WireR11_d0", 0.0F, f9, f17);
                hierMesh().chunkSetAngles("WireR13_d0", 0.0F, f11, f21);
                hierMesh().chunkSetAngles("WireR14_d0", 0.0F, f11, f21);
                hierMesh().chunkSetAngles("WireR15_d0", 0.0F, f13, f21);
                hierMesh().chunkSetAngles("WireR16_d0", 0.0F, f15, f21);
                hierMesh().chunkSetAngles("WireR17_d0", 0.0F, f13, 0.0F);
                hierMesh().chunkSetAngles("WireR18_d0", 0.0F, f11, f21);
                hierMesh().chunkSetAngles("WireR19_d0", 0.0F, f11, f21);
                hierMesh().chunkSetAngles("WireR20_d0", 0.0F, f13, f21);
                hierMesh().chunkSetAngles("WireR21_d0", 0.0F, f11, f21);
                hierMesh().chunkSetAngles("WireR22_d0", 0.0F, f13, f21);
            }
        }
        super.moveFan(f);
    }
