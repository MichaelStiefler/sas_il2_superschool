...
public class TB_3_4M_34R extends TB_3
{
    ...
    public void rareAction(float f, boolean flag)
    {
        ...
        if(flag)
        {
            ...
            for(int j = 0; j < 4; j++)
                if(FM.AS.astateTankStates[j] > 3 && FM.AS.astatePilotStates[4] < 50F && FM.AS.astatePilotStates[7] < 50F && World.Rnd().nextFloat() < 0.1F)
                    FM.AS.repairTank(j);
    ...
    static 
    {
        ...
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitTB_3.class, CockpitTB_3_Bombardier3.class, CockpitTB_3_NGunner.class, CockpitTB_3_TGunner3.class, CockpitTB_3_RGunner.class
        });
