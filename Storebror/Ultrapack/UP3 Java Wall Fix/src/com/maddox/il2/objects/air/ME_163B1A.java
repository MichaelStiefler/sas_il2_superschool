    ...
    implements TypeFighter, TypeBNZFighter
{
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d)
    {
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                if(s.endsWith("1"))
                {
                    ...
                    if(getEnergyPastArmor(World.Rnd().nextFloat(30F, 90F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot) < 0.0F)
                        doRicochet(shot);
                } else
                if(s.endsWith("2"))
            ...
            if(s.startsWith("xxcontrols"))
            {
                ...
                case 1:
                    if(getEnergyPastArmor(2.2F / (float)Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) > 0.0F && World.Rnd().nextFloat() < 0.25F)
                        FM.AS.setControlsDamage(shot.initiator, 2);
                    break;

                case 2:
                    if(getEnergyPastArmor(2.2F / (float)Math.sqrt(v1.y * v1.y + v1.z * v1.z), shot) <= 0.0F)
                        break;
            ...
            {
                if(s.startsWith("xxsparli") && chunkDamageVisible("WingLIn") > 2 && World.Rnd().nextFloat() < 1.0D - 0.92D * Math.abs(v1.x) && getEnergyPastArmor(17.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingLIn Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if(s.startsWith("xxsparri") && chunkDamageVisible("WingRIn") > 2 && World.Rnd().nextFloat() < 1.0D - 0.92D * Math.abs(v1.x) && getEnergyPastArmor(17.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingRIn Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlm") && chunkDamageVisible("WingLMid") > 2 && World.Rnd().nextFloat() < 1.0D - 0.92D * Math.abs(v1.x) && getEnergyPastArmor(17.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingLMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparrm") && chunkDamageVisible("WingRMid") > 2 && World.Rnd().nextFloat() < 1.0D - 0.92D * Math.abs(v1.x) && getEnergyPastArmor(17.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingRMid Spars Damaged..");
                    nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if(s.startsWith("xxsparlo") && chunkDamageVisible("WingLOut") > 2 && World.Rnd().nextFloat() < 1.0D - 0.92D * Math.abs(v1.x) && getEnergyPastArmor(17.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F)
                {
                    debuggunnery("*** WingLOut Spars Damaged..");
                    nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if(s.startsWith("xxsparro") && chunkDamageVisible("WingROut") > 2 && World.Rnd().nextFloat() < 1.0D - 0.92D * Math.abs(v1.x) && getEnergyPastArmor(17.799999237060547D / (1.0001000165939331D - Math.abs(v1.y)), shot) > 0.0F)
                {
        ...
        if(s.startsWith("xcf"))
        {
            if(Pd.x > 2.01D && getEnergyPastArmor(11.11F / ((float)Math.sqrt(v1.y * v1.y + v1.z * v1.z) + 0.0001F), shot) <= 0.0F)
            {
                doRicochet(shot);
                return;
            }
            if(Pd.x > 0.8D && Pd.x < 2D)
                if(Pd.z > 0.425D)
                {
    ...
    public void moveWheelSink()
    {
        ...
        {
            float f = cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.066F, -45F, 0.0F);
