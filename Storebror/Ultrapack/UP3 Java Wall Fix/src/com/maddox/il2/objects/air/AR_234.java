    ...
    implements TypeBomber, TypeDiveBomber
{
    ...
    {
        resetYPRmodifier();
        xyz[1] = cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -0.3274F);
        hierMesh().chunkSetLocate("GearL3_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearL4_D0", 0.0F, cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -46F), 0.0F);
        hierMesh().chunkSetAngles("GearL5_D0", 0.0F, cvt(FM.Gears.gWheelSinking[0], 0.0F, 0.32F, 0.0F, -46F), 0.0F);
        xyz[1] = cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -0.3274F);
        hierMesh().chunkSetLocate("GearR3_D0", xyz, ypr);
        hierMesh().chunkSetAngles("GearR4_D0", 0.0F, cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -46F), 0.0F);
        hierMesh().chunkSetAngles("GearR5_D0", 0.0F, cvt(FM.Gears.gWheelSinking[1], 0.0F, 0.32F, 0.0F, -46F), 0.0F);
    }
        ...
        if(s.startsWith("xx"))
        {
            if(s.startsWith("xxarmor"))
            {
                ...
                if(s.startsWith("xxarmorp"))
                    getEnergyPastArmor(15.149999618530273D / (Math.abs(v1.x) + 9.9999997473787516E-006D), shot);
                return;
            }
