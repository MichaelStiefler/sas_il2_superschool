...
public class BF_109G6HARTMANN extends BF_109
    implements TypeAcePlane
{

    public BF_109G6HARTMANN()
    {
        kangle = 0.0F;
    }
    ...
    static 
    {
        Class class1 = BF_109G6HARTMANN.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Bf109");
        Property.set(class1, "meshName", "3do/plane/Bf-109G-6Early(ofHartmann)/hier.him");
