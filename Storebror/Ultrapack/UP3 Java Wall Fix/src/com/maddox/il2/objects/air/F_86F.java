    ...
    private class _cls0
    {
        ...
        private void $1()
        {
            if(ts)
            {
                ...
                float f2 = Aircraft.cvt(mn, mn >= F_86F.mteb ? F_86F.uteb : F_86F.lteb, mn >= F_86F.mteb ? F_86F.lteb : F_86F.uteb, mn >= F_86F.mteb ? thef : bhef, mn >= F_86F.mteb ? phef : thef);
                float f3 = Aircraft.cvt(mn, mn >= F_86F.mteb ? F_86F.uteb : F_86F.lteb, mn >= F_86F.mteb ? F_86F.lteb : F_86F.uteb, mn >= F_86F.mteb ? wef / f1 : mef, mn >= F_86F.mteb ? lef / f1 : wef / f1);
