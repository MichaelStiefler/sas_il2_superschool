    ...
    implements TypeFighter, TypeTNBFighter
{
    ...
    private final void doRemoveBlisters()
    {
        ...
        if(hierMesh().chunkFindCheck("blister4_D0") != -1)
        {
            ...
            Wreckage wreckage = new Wreckage(this, hierMesh().chunkFind("blister4_D0"));
        ...
        if(hierMesh().chunkFindCheck("blister3_D0") != -1)
        {
            ...
            Wreckage wreckage1 = new Wreckage(this, hierMesh().chunkFind("blister3_D0"));
    ...
    public void moveWheelSink()
    {
        ...
        Aircraft.xyz[1] = -Aircraft.cvt(suspL, 0.0F, 0.24F, 0.0F, 0.24F);
        hierMesh().chunkSetLocate("GearL2_D0", Aircraft.xyz, Aircraft.ypr);
        suspR = FM.Gears.gWheelSinking[1] * f + suspension;
        Aircraft.xyz[1] = -Aircraft.cvt(suspR, 0.0F, 0.24F, 0.0F, 0.24F);
        ...
        if(s.startsWith("xx"))
        {
            ...
            } else
            {
                ...
                if(s.startsWith("xxeng"))
                {
                    ...
                    if(s.endsWith("prop"))
                    {
                        if(getEnergyPastArmor(0.44999998807907104D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F && World.Rnd().nextFloat() < 0.05F)
                        {
                ...
                if(s.startsWith("xxtank1") && getEnergyPastArmor(0.1F, shot) > 0.0F && World.Rnd().nextFloat() < 0.5F)
                {
