...
public class N1K3J extends N1K3
{
    ...
    public void onAircraftLoaded()
    {
        ...
        if(abulletemitter[0] == GunEmpty.get() && abulletemitter[2] == GunEmpty.get())
            hierMesh().chunkVisible("RailL", false);
        if(abulletemitter[1] == GunEmpty.get() && abulletemitter[3] == GunEmpty.get())
            hierMesh().chunkVisible("RailR", false);
    }

    static 
    {
        Class class1 = N1K3J.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "N1K");
        Property.set(class1, "meshName", "3DO/Plane/N1K3-J(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar01());
        Property.set(class1, "meshName_ja", "3DO/Plane/N1K3-J(ja)/hier.him");
        Property.set(class1, "PaintScheme_ja", new PaintSchemeFCSPar05());
        Property.set(class1, "yearService", 1945F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/N1K3-J.fmd");
