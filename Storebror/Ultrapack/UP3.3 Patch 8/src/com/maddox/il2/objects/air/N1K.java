...
public abstract class N1K extends Scheme1 implements TypeFighter {
    ...
    public void update(float f) {
        ...
        if (this.FM.CT.FlapsControl <= 0.32F && this.FM.CT.FlapsControl >= 0.05F) {
            ...
            if (this.mBar < 315F && this.FM.getOverload() > 0.0F && f1 < 128F) {
                ...
                if (this.desiredPosition > 1.0F) this.desiredPosition = 1.0F;
                if (this.curFlaps < this.desiredPosition) this.curFlaps = this.flapsMovement(f, this.desiredPosition, this.curFlaps, 999F, cvt(this.FM.getSpeedKMH(), 150F, 280F, 0.15F, 0.08F));
                else this.curFlaps = this.flapsMovement(f, this.desiredPosition, this.curFlaps, 999F, cvt(this.FM.getSpeedKMH(), 150F, 280F, 0.15F, 0.25F));
                this.FM.CT.forceFlaps(this.curFlaps);
            } else {
                this.desiredPosition = 0.0F;
                this.curFlaps = this.flapsMovement(f, this.desiredPosition, this.curFlaps, 999F, cvt(this.FM.getSpeedKMH(), 150F, 280F, 0.15F, 0.25F));
                this.FM.CT.forceFlaps(this.curFlaps);
            }
            if (Math.abs(this.desiredPosition - this.curFlaps) >= 0.02F) this.sfxFlaps(true);
            else this.sfxFlaps(false);
        } else this.autoEng = false;
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        ...
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, cvt(f, 0.75F, 0.95F, 0.0F, -60F), 0.0F);
        ...
        if (f > 0.75F) hiermesh.chunkSetAngles("GearL5_D0", 0.0F, cvt(f, 0.75F, 0.95F, -45F, -65F), 0.0F);
        else hiermesh.chunkSetAngles("GearL5_D0", 0.0F, cvt(f, 0.4F, 0.75F, 0.0F, -45F), 0.0F);
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, cvt(f, 0.05F, 0.95F, 0.0F, -130F), 0.0F);
        if (f > 0.75F) hiermesh.chunkSetAngles("GearL7_D0", 0.0F, cvt(f, 0.725F, 0.95F, -86F, -133F), 0.0F);
        else hiermesh.chunkSetAngles("GearL7_D0", 0.0F, cvt(f, 0.05F, 0.725F, 0.0F, -86F), 0.0F);
        ...
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, cvt(f, 0.05F, 0.95F, 0.0F, -85F), 0.0F);
        xyz[1] = cvt(f, 0.4F, 0.75F, 0.0F, -0.205F);
        hiermesh.chunkSetLocate("GearR3_D0", xyz, ypr);
        xyz[1] = cvt(f, 0.75F, 0.94F, 0.0F, -0.05F);
        hiermesh.chunkSetLocate("GearR4_D0", xyz, ypr);
        if (f > 0.75F) hiermesh.chunkSetAngles("GearR5_D0", 0.0F, cvt(f, 0.75F, 0.95F, -45F, -65F), 0.0F);
        else hiermesh.chunkSetAngles("GearR5_D0", 0.0F, cvt(f, 0.4F, 0.75F, 0.0F, -45F), 0.0F);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, cvt(f, 0.05F, 0.95F, 0.0F, -130F), 0.0F);
        if (f > 0.75F) hiermesh.chunkSetAngles("GearR7_D0", 0.0F, cvt(f, 0.725F, 0.95F, -86F, -133F), 0.0F);
        else hiermesh.chunkSetAngles("GearR7_D0", 0.0F, cvt(f, 0.05F, 0.725F, 0.0F, -86F), 0.0F);
        xyz[1] = cvt(f, 0.05F, 0.95F, 0.0F, -0.1F);
        hiermesh.chunkSetLocate("GearR8_D0", xyz, ypr);
        hiermesh.chunkSetAngles("GearR9_D0", 0.0F, cvt(f, 0.05F, 0.115F, 0.0F, -85F), 0.0F);
        hiermesh.chunkSetAngles("GearR10_D0", 0.0F, cvt(f, 0.05F, 0.85F, 0.0F, -85F), 0.0F);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                } else if (s.endsWith("p2")) this.getEnergyPastArmor(13.13D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("p3")) this.getEnergyPastArmor(World.Rnd().nextFloat(8.7F, 9.81F) / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                return;
            }
    ...
    // TODO: Fix inverted prop movement!
    protected void moveFan(float f) {
        int propState = 0;
        for (int engineIndex = 0; engineIndex < this.FM.EI.getNum(); engineIndex++) {
            if (this.oldProp[engineIndex] < 2) {
                propState = Math.abs((int) (this.FM.EI.engines[engineIndex].getw() * 0.06F));
                if (propState >= 1) propState = 1;
                if (propState != this.oldProp[engineIndex] && this.hierMesh().isChunkVisible(Props[engineIndex][this.oldProp[engineIndex]])) {
                    this.hierMesh().chunkVisible(Props[engineIndex][this.oldProp[engineIndex]], false);
                    this.oldProp[engineIndex] = propState;
                    this.hierMesh().chunkVisible(Props[engineIndex][propState], true);
                }
            }
            if (propState == 0) this.propPos[engineIndex] = (this.propPos[engineIndex] + 57.3F * this.FM.EI.engines[engineIndex].getw() * f) % 360.0F;
            else {
                float engineW = 57.3F * this.FM.EI.engines[engineIndex].getw();
                engineW %= 2880.0F;
                engineW /= 2880.0F;
                if (engineW <= 0.5F) engineW *= 2.0F;
                else engineW = engineW * 2.0F - 2.0F;
                engineW *= 1200.0F;
                this.propPos[engineIndex] = (this.propPos[engineIndex] + engineW * f) % 360.0F;
            }
