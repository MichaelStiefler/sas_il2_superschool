...
public class CockpitBattleMkII_TGunner extends CockpitGunner {
    ...
    public CockpitBattleMkII_TGunner() {
        super("3DO/Cockpit/D3A1-TGun/TGunnerBattle.him", "he111_gunner");
        this.hook1 = null;
    ...
    static {
        Property.set(CockpitBattleMkII_TGunner.class, "aiTuretNum", 0);
        Property.set(CockpitBattleMkII_TGunner.class, "weaponControlNum", 10);
        Property.set(CockpitBattleMkII_TGunner.class, "astatePilotIndx", 1);
        Property.set(CockpitBattleMkII_TGunner.class, "normZN", 0.10F);
        Property.set(CockpitBattleMkII_TGunner.class, "gsZN", 0.10F);
    }
}
