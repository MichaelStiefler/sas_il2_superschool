...
public class CockpitGLADIATOR1 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (Math.abs(CockpitGLADIATOR1.this.fm.Or.getKren()) < 30F) CockpitGLADIATOR1.this.setNew.azimuth = (21F * CockpitGLADIATOR1.this.setOld.azimuth + CockpitGLADIATOR1.this.fm.Or.azimut()) / 22F;
            if (CockpitGLADIATOR1.this.setOld.azimuth > 270F && CockpitGLADIATOR1.this.setNew.azimuth < 90F) CockpitGLADIATOR1.this.setOld.azimuth -= 360F;
            if (CockpitGLADIATOR1.this.setOld.azimuth < 90F && CockpitGLADIATOR1.this.setNew.azimuth > 270F) CockpitGLADIATOR1.this.setOld.azimuth += 360F;
            ...
            if (CockpitGLADIATOR1.this.setNew.prop < CockpitGLADIATOR1.this.fm.EI.engines[0].getControlProp() - 0.01F) CockpitGLADIATOR1.this.setNew.prop += 0.0025F;
            if (CockpitGLADIATOR1.this.setNew.prop > CockpitGLADIATOR1.this.fm.EI.engines[0].getControlProp() + 0.01F) CockpitGLADIATOR1.this.setNew.prop -= 0.0025F;
