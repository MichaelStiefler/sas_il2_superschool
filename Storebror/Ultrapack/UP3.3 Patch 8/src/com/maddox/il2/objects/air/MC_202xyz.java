        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.startsWith("xxarmorp")) {
                    ...
                    switch (i) {
                        ...
                        case 1:
                            this.getEnergyPastArmor(20.2D / (Math.abs(v1.x) + 0.0001D), shot);
                            if (shot.power <= 0.0F) this.doRicochetBack(shot);
                            break;

                        case 2:
                            this.getEnergyPastArmor(12.88D / (Math.abs(v1.x) + 0.0001D), shot);
                            break;

                        case 3:
                            this.getEnergyPastArmor(9D / (Math.abs(v1.x) + 0.0001D), shot);
                            break;
                    }
                }
                return;
            ...
            if (s.startsWith("xxcontrols")) {
                ...
                switch (j) {
                    ...
                    case 6:
                    case 8:
                        if (this.getEnergyPastArmor(4D / (Math.abs(v1.x) + 0.0001D), shot) > 0.0F && World.Rnd().nextFloat() < 0.5F) {
            ...
            if (s.startsWith("xxspar")) {
                ...
                if (s.startsWith("xxsparli") && this.chunkDamageVisible("WingLIn") > 2 && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 0.0001D), shot) > 0.0F) {
                    this.debuggunnery("Spar Construction: WingLIn Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparri") && this.chunkDamageVisible("WingRIn") > 2 && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 0.0001D), shot) > 0.0F) {
                    this.debuggunnery("Spar Construction: WingRIn Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlm") && this.chunkDamageVisible("WingLMid") > 2 && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 0.0001D), shot) > 0.0F) {
                    this.debuggunnery("Spar Construction: WingLMid Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparrm") && this.chunkDamageVisible("WingRMid") > 2 && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 0.0001D), shot) > 0.0F) {
                    this.debuggunnery("Spar Construction: WingRMid Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlo") && this.chunkDamageVisible("WingLOut") > 2 && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 0.0001D), shot) > 0.0F) {
                    this.debuggunnery("Spar Construction: WingLOut Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if (s.startsWith("xxsparro") && this.chunkDamageVisible("WingROut") > 2 && this.getEnergyPastArmor(6.96D / (Math.abs(v1.x) + 0.0001D), shot) > 0.0F) {
