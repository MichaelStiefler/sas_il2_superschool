...
public class CockpitJU_88A4Late_NGunner extends CockpitGunner {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (JU_88A4Late.bChangedPit) {
                CockpitJU_88A4Late_NGunner.this.reflectPlaneToModel();
                JU_88A4Late.bChangedPit = false;
            }
            if (CockpitJU_88A4Late_NGunner.this.fm != null) {
                CockpitJU_88A4Late_NGunner.this.setTmp = CockpitJU_88A4Late_NGunner.this.setOld;
                CockpitJU_88A4Late_NGunner.this.setOld = CockpitJU_88A4Late_NGunner.this.setNew;
                CockpitJU_88A4Late_NGunner.this.setNew = CockpitJU_88A4Late_NGunner.this.setTmp;
                CockpitJU_88A4Late_NGunner.this.setNew.throttle1 = 0.85F * CockpitJU_88A4Late_NGunner.this.setOld.throttle1 + CockpitJU_88A4Late_NGunner.this.fm.EI.engines[0].getControlThrottle() * 0.15F;
                CockpitJU_88A4Late_NGunner.this.setNew.prop1 = 0.85F * CockpitJU_88A4Late_NGunner.this.setOld.prop1 + CockpitJU_88A4Late_NGunner.this.fm.EI.engines[0].getControlProp() * 0.15F;
                CockpitJU_88A4Late_NGunner.this.setNew.throttle2 = 0.85F * CockpitJU_88A4Late_NGunner.this.setOld.throttle2 + CockpitJU_88A4Late_NGunner.this.fm.EI.engines[1].getControlThrottle() * 0.15F;
                CockpitJU_88A4Late_NGunner.this.setNew.prop2 = 0.85F * CockpitJU_88A4Late_NGunner.this.setOld.prop2 + CockpitJU_88A4Late_NGunner.this.fm.EI.engines[1].getControlProp() * 0.15F;
                CockpitJU_88A4Late_NGunner.this.setNew.altimeter = CockpitJU_88A4Late_NGunner.this.fm.getAltitude();
                float f = CockpitJU_88A4Late_NGunner.this.waypointAzimuth();
                CockpitJU_88A4Late_NGunner.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4Late_NGunner.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88A4Late_NGunner.this.setOld.azimuth.getDeg(1.0F));
                CockpitJU_88A4Late_NGunner.this.setNew.azimuth.setDeg(CockpitJU_88A4Late_NGunner.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4Late_NGunner.this.fm.Or.azimut());
                CockpitJU_88A4Late_NGunner.this.setNew.vspeed = (199F * CockpitJU_88A4Late_NGunner.this.setOld.vspeed + CockpitJU_88A4Late_NGunner.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88A4Late_NGunner.this.cockpitDimControl) {
                    if (CockpitJU_88A4Late_NGunner.this.setNew.dimPosition > 0.0F) CockpitJU_88A4Late_NGunner.this.setNew.dimPosition = CockpitJU_88A4Late_NGunner.this.setOld.dimPosition - 0.05F;
                } else if (CockpitJU_88A4Late_NGunner.this.setNew.dimPosition < 1.0F) CockpitJU_88A4Late_NGunner.this.setNew.dimPosition = CockpitJU_88A4Late_NGunner.this.setOld.dimPosition + 0.05F;
                float f1 = CockpitJU_88A4Late_NGunner.this.prevFuel - CockpitJU_88A4Late_NGunner.this.fm.M.fuel;
                CockpitJU_88A4Late_NGunner.this.prevFuel = CockpitJU_88A4Late_NGunner.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88A4Late_NGunner.this.setNew.cons = 0.91F * CockpitJU_88A4Late_NGunner.this.setOld.cons + 0.09F * f1;
                if (CockpitJU_88A4Late_NGunner.this.buzzerFX != null)
                    if (CockpitJU_88A4Late_NGunner.this.fm.Loc.z < ((JU_88A4Late) CockpitJU_88A4Late_NGunner.this.aircraft()).fDiveRecoveryAlt && ((JU_88A4Late) ((Interpolate) CockpitJU_88A4Late_NGunner.this.fm).actor).diveMechStage == 1)
                        CockpitJU_88A4Late_NGunner.this.buzzerFX.play();
                    else if (CockpitJU_88A4Late_NGunner.this.buzzerFX.isPlaying()) CockpitJU_88A4Late_NGunner.this.buzzerFX.stop();
            }
            return true;
        }
    ...
    public CockpitJU_88A4Late_NGunner() {
...
//        if ((this.fm.AS.astateCockpitState & 0x40) == 0);
    ...
    static {
        Property.set(CockpitJU_88A4Late_NGunner.class, "aiTuretNum", 0);
        Property.set(CockpitJU_88A4Late_NGunner.class, "weaponControlNum", 10);
        Property.set(CockpitJU_88A4Late_NGunner.class, "astatePilotIndx", 1);
        Property.set(CockpitJU_88A4Late_NGunner.class, "normZN", 0.75F);
        Property.set(CockpitJU_88A4Late_NGunner.class, "gsZN", 0.75F);
    }
}
