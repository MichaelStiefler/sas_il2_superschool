        ...
        public boolean tick() {
            if (CockpitF2A3.this.fm != null) {
                ...
                if (Math.abs(CockpitF2A3.this.fm.Or.getKren()) < 30F) {
                    CockpitF2A3.this.setNew.azimuth = ((35F * CockpitF2A3.this.setOld.azimuth) + -CockpitF2A3.this.fm.Or.getYaw()) / 36F;
                }
                if ((CockpitF2A3.this.setOld.azimuth > 270F) && (CockpitF2A3.this.setNew.azimuth < 90F)) {
                    CockpitF2A3.this.setOld.azimuth -= 360F;
                }
                if ((CockpitF2A3.this.setOld.azimuth < 90F) && (CockpitF2A3.this.setNew.azimuth > 270F)) {
                    CockpitF2A3.this.setOld.azimuth += 360F;
                }
                CockpitF2A3.this.setNew.waypointAzimuth = ((10F * CockpitF2A3.this.setOld.waypointAzimuth) + (CockpitF2A3.this.waypointAzimuth() - CockpitF2A3.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
