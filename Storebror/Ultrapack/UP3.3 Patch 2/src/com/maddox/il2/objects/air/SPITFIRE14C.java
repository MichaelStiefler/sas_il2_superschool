...
public class SPITFIRE14C extends SPITFIRE9 implements TypeBNZFighter {
    ...
    static {
        Class class1 = SPITFIRE14C.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Spit");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireMkXIVC(Multi1)/hier.him");
