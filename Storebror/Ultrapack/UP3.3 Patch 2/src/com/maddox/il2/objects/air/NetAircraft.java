...
//            }
        ...
        private Actor _actorSpawn(ActorSpawnArg actorspawnarg) {
            ...
            } else if (com.maddox.il2.game.Mission.isDogfight() && com.maddox.il2.ai.World.cur().diffCur.Takeoff_N_Landing && com.maddox.il2.game.Main.cur().netServerParams.isMaster()) {
...
//            }
    ...
    private int getWeaponsAmount() {
        ...
        for (int i_92_ = 0; i_92_ < i; i_92_++) {
            ...
            if (bulletemitters != null) for (int i_93_ = 0; i_93_ < bulletemitters.length; i_93_++)
