...
public class CockpitBattleMkII extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBattleMkII.this.fm != null) {
                ...
                CockpitBattleMkII.this.setNew.azimuth = 0.97F * CockpitBattleMkII.this.setOld.azimuth + 0.03F * -CockpitBattleMkII.this.fm.Or.getYaw();
                if (CockpitBattleMkII.this.setOld.azimuth > 270F && CockpitBattleMkII.this.setNew.azimuth < 90F) CockpitBattleMkII.this.setOld.azimuth -= 360F;
                if (CockpitBattleMkII.this.setOld.azimuth < 90F && CockpitBattleMkII.this.setNew.azimuth > 270F) CockpitBattleMkII.this.setOld.azimuth += 360F;
                CockpitBattleMkII.this.setNew.waypointAzimuth = 0.91F * CockpitBattleMkII.this.setOld.waypointAzimuth + 0.09F * (CockpitBattleMkII.this.waypointAzimuth() - CockpitBattleMkII.this.setOld.azimuth) + World.Rnd().nextFloat(-10F, 10F);
                ...
                if (CockpitBattleMkII.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitBattleMkII.this.setNew.gearPhi > 0.0F) CockpitBattleMkII.this.setNew.gearPhi = CockpitBattleMkII.this.setOld.gearPhi - 0.021F;
                } else if (CockpitBattleMkII.this.setNew.gearPhi < 1.0F) CockpitBattleMkII.this.setNew.gearPhi = CockpitBattleMkII.this.setOld.gearPhi + 0.021F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[1] = FaireyBattle.smoothCvt(this.fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.48F);
        ...
        if (this.setNew.gearPhi < 0.5F) this.mesh.chunkSetAngles("Z_Gear2", this.cvt(this.setNew.gearPhi, 0.0F, 0.2F, 0.0F, -65F), 0.0F, 0.0F);
        else this.mesh.chunkSetAngles("Z_Gear2", this.cvt(this.setNew.gearPhi, 0.8F, 1.0F, -65F, 0.0F), 0.0F, 0.0F);
        float f1;
        ...
        f1 = 0.0F;
        if (this.fm.AS.bLandingLightOn) f1 = 66F;
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), radScale), 0.0F, 0.0F);
