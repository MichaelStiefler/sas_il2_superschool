    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitHalifaxBMkII.this.fm != null) {
                ...
                CockpitHalifaxBMkII.this.setNew.azimuth = (35F * CockpitHalifaxBMkII.this.setOld.azimuth + -CockpitHalifaxBMkII.this.fm.Or.getYaw()) / 36F;
                if (CockpitHalifaxBMkII.this.setOld.azimuth > 270F && CockpitHalifaxBMkII.this.setNew.azimuth < 90F) CockpitHalifaxBMkII.this.setOld.azimuth -= 360F;
                if (CockpitHalifaxBMkII.this.setOld.azimuth < 90F && CockpitHalifaxBMkII.this.setNew.azimuth > 270F) CockpitHalifaxBMkII.this.setOld.azimuth += 360F;
                CockpitHalifaxBMkII.this.setNew.waypointAzimuth = (10F * CockpitHalifaxBMkII.this.setOld.waypointAzimuth + CockpitHalifaxBMkII.this.waypointAzimuth() + World.Rnd().nextFloat(-30F, 30F)) / 11F;
                ...
                switch (CockpitHalifaxBMkII.this.iWiper) {
                    ...
                    case 0:
                        if (Mission.curCloudsType() > 4 && CockpitHalifaxBMkII.this.fm.getSpeedKMH() < 220F && CockpitHalifaxBMkII.this.fm.getAltitude() < Mission.curCloudsHeight() + 300F) CockpitHalifaxBMkII.this.iWiper = 1;
                        break;

                    case 1:
                        CockpitHalifaxBMkII.this.setNew.wiper = CockpitHalifaxBMkII.this.setOld.wiper - 0.05F;
                        if (CockpitHalifaxBMkII.this.setNew.wiper < -1.03F) CockpitHalifaxBMkII.this.iWiper++;
                        if (CockpitHalifaxBMkII.this.wiState >= 2) break;
                        if (CockpitHalifaxBMkII.this.wiState == 0) {
                            ...
                            if (CockpitHalifaxBMkII.this.fxw != null) CockpitHalifaxBMkII.this.fxw.play(CockpitHalifaxBMkII.this.wiStart);
                        }
                        if (CockpitHalifaxBMkII.this.fxw != null) {
                    ...
                    case 2:
                        CockpitHalifaxBMkII.this.setNew.wiper = CockpitHalifaxBMkII.this.setOld.wiper + 0.05F;
                        if (CockpitHalifaxBMkII.this.setNew.wiper > 1.03F) CockpitHalifaxBMkII.this.iWiper++;
                        if (CockpitHalifaxBMkII.this.wiState > 1) CockpitHalifaxBMkII.this.wiState = 1;
                        break;

                    case 3:
                        CockpitHalifaxBMkII.this.setNew.wiper = CockpitHalifaxBMkII.this.setOld.wiper - 0.05F;
                        if (CockpitHalifaxBMkII.this.setNew.wiper >= 0.02F) break;
                        if (CockpitHalifaxBMkII.this.fm.getSpeedKMH() > 250F || CockpitHalifaxBMkII.this.fm.getAltitude() > Mission.curCloudsHeight() + 400F) CockpitHalifaxBMkII.this.iWiper++;
                        else CockpitHalifaxBMkII.this.iWiper = 1;
                        break;
                    ...
                    case 4:
                        ...
                        if (CockpitHalifaxBMkII.this.fxw != null) CockpitHalifaxBMkII.this.fxw.cancel();
                        break;
                }
            }
            return true;
