    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxArmor")) {
                ...
                if (s.endsWith("p1")) this.getEnergyPastArmor(12.7D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("p2")) this.getEnergyPastArmor(12.7D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
                else if (s.endsWith("p3")) this.getEnergyPastArmor(12.7D / (Math.abs(v1.x) + 9.9999997473787516E-005D), shot);
