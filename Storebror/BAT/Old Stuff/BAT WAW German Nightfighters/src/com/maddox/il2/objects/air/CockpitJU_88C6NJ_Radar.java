...
public class CockpitJU_88C6NJ_Radar extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (JU_88C6NJ.bChangedPit) {
                CockpitJU_88C6NJ_Radar.this.reflectPlaneToModel();
                JU_88C6NJ.bChangedPit = false;
            }
            if (CockpitJU_88C6NJ_Radar.this.fm != null) {
                CockpitJU_88C6NJ_Radar.this.setTmp = CockpitJU_88C6NJ_Radar.this.setOld;
                CockpitJU_88C6NJ_Radar.this.setOld = CockpitJU_88C6NJ_Radar.this.setNew;
                CockpitJU_88C6NJ_Radar.this.setNew = CockpitJU_88C6NJ_Radar.this.setTmp;
                CockpitJU_88C6NJ_Radar.this.setNew.throttle1 = (0.85F * CockpitJU_88C6NJ_Radar.this.setOld.throttle1) + (CockpitJU_88C6NJ_Radar.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_88C6NJ_Radar.this.setNew.prop1 = (0.85F * CockpitJU_88C6NJ_Radar.this.setOld.prop1) + (CockpitJU_88C6NJ_Radar.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_88C6NJ_Radar.this.setNew.throttle2 = (0.85F * CockpitJU_88C6NJ_Radar.this.setOld.throttle2) + (CockpitJU_88C6NJ_Radar.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_88C6NJ_Radar.this.setNew.prop2 = (0.85F * CockpitJU_88C6NJ_Radar.this.setOld.prop2) + (CockpitJU_88C6NJ_Radar.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_88C6NJ_Radar.this.setNew.altimeter = CockpitJU_88C6NJ_Radar.this.fm.getAltitude();
                float f = CockpitJU_88C6NJ_Radar.this.waypointAzimuth();
                CockpitJU_88C6NJ_Radar.this.setNew.waypointAzimuth.setDeg(CockpitJU_88C6NJ_Radar.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88C6NJ_Radar.this.setOld.azimuth.getDeg(1.0F));
                CockpitJU_88C6NJ_Radar.this.setNew.azimuth.setDeg(CockpitJU_88C6NJ_Radar.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88C6NJ_Radar.this.fm.Or.azimut());
                CockpitJU_88C6NJ_Radar.this.setNew.vspeed = ((199F * CockpitJU_88C6NJ_Radar.this.setOld.vspeed) + CockpitJU_88C6NJ_Radar.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88C6NJ_Radar.this.cockpitDimControl) {
                    if (CockpitJU_88C6NJ_Radar.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88C6NJ_Radar.this.setNew.dimPosition = CockpitJU_88C6NJ_Radar.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88C6NJ_Radar.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88C6NJ_Radar.this.setNew.dimPosition = CockpitJU_88C6NJ_Radar.this.setOld.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88C6NJ_Radar.this.prevFuel - CockpitJU_88C6NJ_Radar.this.fm.M.fuel;
                CockpitJU_88C6NJ_Radar.this.prevFuel = CockpitJU_88C6NJ_Radar.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88C6NJ_Radar.this.setNew.cons = (0.91F * CockpitJU_88C6NJ_Radar.this.setOld.cons) + (0.09F * f1);
            }
            return true;
        }
    }
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            Loc loc1 = new Loc(0D, 0D, 0D, 90F, 0F, 0F);
            Loc loc2 = new Loc();
    ...
    public CockpitJU_88C6NJ_Radar() {
        super("3DO/Cockpit/Ju-88C6MOD/C6NJRadarhier.him", "he111");
...
// Hook cameraHook = new HookNamed(this.mesh, "CAMERA");
// this.pos.setBase(aircraft(), cameraHook, false);
        }
    }
