...
public class RadarLiSN2 {
    public class SpikeHolder {
        ...
        public SpikeHolder(float f) {
            this.slope = f;
            this.spikes = new ArrayList(RadarLiSN2.this.maxNumOfSpikes);
        }
    }
    ...
    public class Contact {
        ...
        public void transform() {
            float f = RadarLiSN2.this.dB2size(RadarLiSN2.this.baseNoiseAtDist(this.dist) - RadarLiSN2.RECEIVER_SENSITIVITY);
            for (int i = 0; i < 4; i++) {
                this.size[i] = RadarLiSN2.this.dB2size(this.size[i]);
                if (this.size[i] > 0.0F) {
                    this.acc[i] += this.size[i] / f;
                }
            }

            this.dist *= RadarLiSN2.this.displayWidth;
        }
    ...
    public void rareAction() {
        ...
        for (int j = 0; j < i; j++) {
            if (!Actor.isValid(((Contact) this.contacts.get(j)).actor)) {
                ...
                if ((Math.abs(point3d2.x - point3d.x) > this.MAX_DIST_FASTREJECT) || (Math.abs(point3d2.y - point3d.y) > this.MAX_DIST_FASTREJECT)) {
                    this.contacts.remove(j);
                    i--;
                    j--;
                }
        ...
        for (int k = 0; k < i; k++) {
            ...
            if ((actor instanceof Aircraft) && !actor.equals(this.me)) {
                Point3d point3d1 = actor.pos.getAbsPoint();
                if ((Math.abs(point3d2.x - point3d1.x) < this.MAX_DIST_FASTREJECT) && (Math.abs(point3d2.y - point3d1.y) < this.MAX_DIST_FASTREJECT)) {
                    int l;
    ...
    protected void updateAGL() {
        Point3d point3d = this.me.pos.getAbsPoint();
        ...
        for (int i = 0; i < this.AGL_SAMPLES; i++) {
            ...
            float f3 = f - (float) Engine.land().HQ_Air(point3d.x + (f1 * f), point3d.y + (f2 * f));
            f3 *= f3;
            f3 += f4 * ((f1 * f1) + (f2 * f2));
            if (f3 < f5) {
                f5 = f3;
    ...
    public void setMode(int i) {
        if (i == 1) {
            this.displayWidth = this.displayWidthBak / 4000F;
    ...
    public int[] getContacts(Vector2f avector2f[][]) {
        ...
        for (int i = 0; i < this.contacts.size(); i++) {
            ...
            if (Actor.isValid(contact.actor)) {
                ...
                if (f > 10500F) {
                    contact.setInvis();
                } else if (this.shortMode && (f > 4200F)) {
                    contact.setInvis();
                } else {
...
// float f9 = transmitEcho - 0.5F * f3;
            ...
            float f5;
            float f7;
            for (; (k1++ < (2 * this.maxNumOfSpikes)) && (this.spikeHolder[j].size() < this.maxNumOfSpikes); this.spikeHolder[j].addSpike(f5, f7)) {
// f5 = 0.5F * f3 + transmitEcho;
                f5 = (this.rnd.nextFloat() * f3) + this.transmitEcho;
                f7 = this.dB2size(this.noiseAtDist(f5) - RECEIVER_SENSITIVITY);
                f5 *= this.displayWidth;
            }
    ...
    private float           aGain[][]              = { { 2.9F, 2.75F, 2.28F, 1.39F, -0.11F, -2.97F, -10F, -2.97F }, { 3.6F, 3.45F, 2.98F, 2.09F, 0.59F, -2.27F, -10F, -2.27F }, { 4.2F, 4.05F, 3.58F, 2.69F, 1.19F, -1.67F, -10F, -1.67F }, { 4.7F, 4.55F, 4.08F, 3.19F, 1.69F, -1.17F, -10F, -1.17F }, { 4.9F, 4.75F, 4.28F, 3.39F, 1.89F, -0.97F, -10F, -0.97F }, { 4.8F, 4.65F, 4.18F, 3.29F, 1.79F, -1.07F, -10F, -1.07F }, { 4.6F, 4.45F, 3.98F, 3.09F, 1.59F, -1.27F, -10F, -1.27F }, { 4.2F, 4.05F, 3.58F, 2.69F, 1.19F, -1.67F, -10F, -1.67F }, { 3.7F, 3.55F, 3.08F, 2.19F, 0.69F, -2.17F, -10F, -2.17F }, { 3.3F, 3.15F, 2.68F, 1.79F, 0.29F, -2.57F, -10F, -2.57F }, { 2.4F, 2.25F, 1.78F, 0.89F, -0.61F, -3.47F, -10F, -3.47F }, { 1.6F, 1.45F, 0.98F, 0.09F, -1.41F, -4.27F, -10F, -4.27F }, { 1.8F, 1.65F, 1.18F, 0.29F, -1.21F, -4.07F, -10F, -4.07F }, { 1.9F, 1.75F, 1.28F, 0.39F, -1.11F, -3.97F, -10F, -3.97F }, { 1.7F, 1.55F, 1.08F, 0.19F, -1.31F, -4.17F, -10F, -4.17F }, { 1.2F, 1.05F, 0.58F, -0.31F, -1.81F, -4.67F, -10F, -4.67F },
            { 0.6F, 0.45F, -0.02F, -0.91F, -2.41F, -5.27F, -10F, -5.27F }, { 0.0F, -0.15F, -0.62F, -1.51F, -3.01F, -5.87F, -10F, -5.87F }, { 0.0F, -0.15F, -0.62F, -1.51F, -3.01F, -5.87F, -10F, -5.87F }, { 0.0F, -0.15F, -0.62F, -1.51F, -3.01F, -5.87F, -10F, -5.87F }, { 0.6F, 0.45F, -0.02F, -0.91F, -2.41F, -5.27F, -10F, -5.27F }, { 0.8F, 0.65F, 0.18F, -0.71F, -2.21F, -5.07F, -10F, -5.07F }, { 1.4F, 1.25F, 0.78F, -0.11F, -1.61F, -4.47F, -10F, -4.47F }, { 1.7F, 1.55F, 1.08F, 0.19F, -1.31F, -4.17F, -10F, -4.17F }, { 2.0F, 1.85F, 1.38F, 0.49F, -1.01F, -3.87F, -10F, -3.87F }, { 2.2F, 2.05F, 1.58F, 0.69F, -0.81F, -3.67F, -10F, -3.67F }, { 2.4F, 2.25F, 1.78F, 0.89F, -0.61F, -3.47F, -10F, -3.47F }, { 2.7F, 2.55F, 2.08F, 1.19F, -0.31F, -3.17F, -10F, -3.17F }, { 3F, 2.85F, 2.38F, 1.49F, -0.01F, -2.87F, -10F, -2.87F }, { 3.3F, 3.15F, 2.68F, 1.79F, 0.29F, -2.57F, -10F, -2.57F }, { 3.4F, 3.25F, 2.78F, 1.89F, 0.39F, -2.47F, -10F, -2.47F }, { 2.5F, 2.35F, 1.88F, 0.99F, -0.51F, -3.37F, -10F, -3.37F },
            { 1.8F, 1.65F, 1.18F, 0.29F, -1.21F, -4.07F, -10F, -4.07F }, { 0.6F, 0.45F, -0.02F, -0.91F, -2.41F, -5.27F, -10F, -5.27F }, { 1.3F, 1.15F, 0.68F, -0.21F, -1.71F, -4.57F, -10F, -4.57F }, { 2.2F, 2.05F, 1.58F, 0.69F, -0.81F, -3.67F, -10F, -3.67F }, { 2.9F, 2.75F, 2.28F, 1.39F, -0.11F, -2.97F, -10F, -2.97F } };
