...
// Source File Name: F8F2Racer.java
...
public class F8F2Racer extends F8F {
...
// System.out.println("F8F2Racer Wepon Loading List:" + string);
...
// System.out.println(" No." + (i + 1) + ":" + weponName + "(" + weponCount + ")");
    ...
    static {
        Class class1 = F8F2Racer.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F8F");
        Property.set(class1, "meshName", "3DO/Plane/F8F-2(Multi1)/racer_hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_us", "3DO/Plane/F8F-2/racer_hier.him");
