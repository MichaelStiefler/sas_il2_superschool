...
public class F_4C extends F_4fuelReceiver implements TypeX4Carrier, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeFastJet {
    ...
    public float getFlowRate() {
        return F_4C.FlowRate;
    }

    public float getFuelReserve() {
        return F_4C.FuelReserve;
    }
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(F_4C.NEG_G_TOLERANCE_FACTOR, F_4C.NEG_G_TIME_FACTOR, F_4C.NEG_G_RECOVERY_FACTOR, F_4C.POS_G_TOLERANCE_FACTOR, F_4C.POS_G_TIME_FACTOR, F_4C.POS_G_RECOVERY_FACTOR);
    }
    ...
    private boolean InertialNavigation() {
        ...
        Vector3d vector3d = new Vector3d();
        Aircraft aircraft = World.getPlayerAircraft();
        if ((aircraft.getSpeed(vector3d) > 20D) && (aircraft.pos.getAbsPoint().z >= 150D) && (aircraft instanceof F_4C)) {
            this.pos.getAbs(point3d);
            if (Mission.cur() != null) {
                this.error++;
                if (this.error > 99) {
    ...
    private static final float POS_G_TIME_FACTOR      = 2.5F;
    ...
    static {
        Class class1 = F_4C.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F4C");
        ...
        Property.set(class1, "FlightModel", "FlightModels/F4C.fmd:F4E");
