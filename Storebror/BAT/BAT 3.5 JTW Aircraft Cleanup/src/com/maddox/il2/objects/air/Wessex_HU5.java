...
public class Wessex_HU5 extends Scheme1 implements TypeScout, TypeTransport {
    ...
    protected void moveGear(float f) {
        Wessex_HU5.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Wessex_HU5.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Wessex");
        Property.set(class1, "meshName", "3DO/Plane/WessexHU5(Multi1)/hier.him");
