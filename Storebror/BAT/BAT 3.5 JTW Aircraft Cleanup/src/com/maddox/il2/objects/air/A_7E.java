...
public class A_7E extends A_7fuelReceiver implements TypeCountermeasure, TypeThreatDetector, TypeFastJet {
    ...
    static {
        Class class1 = A_7E.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "A-7E");
        Property.set(class1, "meshName", "3DO/Plane/A7E/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar06());
        Property.set(class1, "yearService", 1966.9F);
        Property.set(class1, "yearExpired", 1994.3F);
        Property.set(class1, "FlightModel", "FlightModels/A7D_E.fmd:Vought_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitA_7.class, CockpitA_7Bombardier.class, CockpitA_7FLIR.class });
