...
public class AV_8B extends AV_8 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeDockable, TypeRadarWarningReceiver, TypeLaserDesignator, TypeRadar, TypeSemiRadar, TypeGroundRadar {
            ...
            if (this.FM.CT.Weapons[i] != null) {
                for (int j = 0; j < this.FM.CT.Weapons[i].length; j++) {
                    if (this.FM.CT.Weapons[i][j].haveBullets()) {
                        ...
                        } else if (this.FM.CT.Weapons[i][j] instanceof RocketGunChaff_gn16) {
                            this.counterChaffList.add(this.FM.CT.Weapons[i][j]);
                        } else if ((this.FM.CT.Weapons[i][j] instanceof BombGunGBU10_Mk84LGB_gn16) || (this.FM.CT.Weapons[i][j] instanceof BombGunGBU12_Mk82LGB_gn16) || (this.FM.CT.Weapons[i][j] instanceof BombGunGBU16_Mk83LGB_gn16)) {
                            this.bHasPaveway = true;
                            this.bHadLGweapons = true;
                            this.FM.bNoDiveBombing = true;
                        } else if ((this.FM.CT.Weapons[i][j] instanceof BombGunGBU38_Mk82JDAM_gn16) || (this.FM.CT.Weapons[i][j] instanceof BombGunGBU32_Mk83JDAM_gn16) || (this.FM.CT.Weapons[i][j] instanceof BombGunGBU31_Mk84JDAM_gn16)) {
                            this.FM.bNoDiveBombing = true;
                        } else if (this.FM.CT.Weapons[i][j] instanceof RocketGunAGM84E_gn16) {
                            this.bHasAGM = true;
                        } else if (this.FM.CT.Weapons[i][j] instanceof RocketGunAGM65E_gn16) {
                            this.bHasLAGM = true;
                            this.bHasAGM = true;
                            this.bHadLGweapons = true;
                        } else if ((this.FM.CT.Weapons[i][j] instanceof RocketGunAGM84D_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGunAGM84J_gn16)) {
                            this.bHasAShM = true;
                        } else if ((this.FM.CT.Weapons[i][j] instanceof RocketGun5inchZuniMk71_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGun5inchZuniMk71AP_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGun5inchZuniMk71WPFAC_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGun5inchZuniMk71WPFO_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGunHYDRA_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGunHYDRA_WPFAC_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGunHYDRA_WPFO_gn16)) {
                            this.bHasUGR = true;
                        }
                    } else if (this.FM.CT.Weapons[i][j] instanceof Pylon_AN_AAQ28_gn16) {
                        this.bHasLaser = true;
                    }
                }
                ...
                for (int j = 0; j < this.FM.CT.Weapons[i].length; j++) {
                    if (this.FM.CT.Weapons[i][j].haveBullets()) {
                        if (this.FM.CT.Weapons[i][j] instanceof RocketGunAGM84E_gn16) {
                            ...
                            this.bHasAShM = true;
                        } else if ((this.FM.CT.Weapons[i][j] instanceof RocketGun5inchZuniMk71_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGun5inchZuniMk71AP_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGun5inchZuniMk71WPFAC_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGunHYDRA_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGunHYDRA_WPFAC_gn16) || (this.FM.CT.Weapons[i][j] instanceof RocketGunHYDRA_WPFO_gn16)) {
                            this.bHasUGR = true;
                        }
                    }
                }
        ...
        if ((!this.FM.isPlayers() || !(this.FM instanceof RealFlightModel) || !((RealFlightModel) this.FM).isRealMode()) && (this.FM instanceof Maneuver) && (this.FM.AP.way.curr().Action == 3)) {
            ...
            if ((actor == null) && (this.FM.AP.way.curr().getTarget() != null) && (Time.current() > (this.lastAIMissileSelect + 8000L))) {
                if (this.bHasAShM && (this.FM.AP.way.curr().getTarget() instanceof TgtShip) && (this.FM.CT.rocketNameSelected != "AGM-84A") && (this.FM.CT.rocketNameSelected != "AGM-84D") && (this.FM.CT.rocketNameSelected != "AGM-84J")) {
                    for (int i = 0; i < 4; i++) {
                        if ((this.FM.CT.rocketNameSelected == "AGM-84A") || (this.FM.CT.rocketNameSelected == "AGM-84D") || (this.FM.CT.rocketNameSelected == "AGM-84J")) {
                            break;
                        }
                        this.FM.CT.toggleRocketHook();
                    }
                ...
                if ((!this.bHasAShM || !(this.FM.AP.way.curr().getTarget() instanceof TgtShip)) && this.bHasAGM && (this.FM.CT.rocketNameSelected != "AGM-65E")) {
                    for (int j = 0; j < 4; j++) {
                        if (this.FM.CT.rocketNameSelected == "AGM-65E") {
                            break;
                        }
                        this.FM.CT.toggleRocketHook();
                    }
                ...
                if (!this.bHasAGM && this.bHasUGR && !this.bHasAShM && (this.FM.CT.rocketNameSelected != "Zuni") && (this.FM.CT.rocketNameSelected != "ZuniFAC") && (this.FM.CT.rocketNameSelected != "ZuniFO") && (this.FM.CT.rocketNameSelected != "Hydra") && (this.FM.CT.rocketNameSelected != "HydraFAC") && (this.FM.CT.rocketNameSelected != "HydraFO")) {
                    for (int k = 0; k < 4; k++) {
                        if ((this.FM.CT.rocketNameSelected == "Zuni") || (this.FM.CT.rocketNameSelected == "ZuniFAC") || (this.FM.CT.rocketNameSelected == "ZuniFO") || (this.FM.CT.rocketNameSelected == "Hydra") || (this.FM.CT.rocketNameSelected == "HydraFAC") || (this.FM.CT.rocketNameSelected == "HydraFO")) {
                            break;
                        }
                        this.FM.CT.toggleRocketHook();
                    }
    ...
    private boolean InertialNavigation() {
        ...
        if ((aircraft.getSpeed(vector3d) > 20D) && (aircraft.pos.getAbsPoint().z >= 150D) && (aircraft instanceof F_4B)) {
            this.pos.getAbs(point3d);
            if (Mission.cur() != null) {
                this.error++;
                if (this.error > 99) {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitAV_8B.class, CockpitAV8FLIR.class });
