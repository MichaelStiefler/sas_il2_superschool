...
public class TU_142 extends TU_95X implements TypeBomber, TypeGuidedMissileCarrier, TypeX4Carrier, TypeFastJet, TypeFuelDump, TypeSupersonic, TypeDockable {
    ...
    public float getFlowRate() {
        return TU_142.FlowRate;
    }

    public float getFuelReserve() {
        return TU_142.FuelReserve;
    }
    ...
    private boolean Radar() {
        ...
        for (java.util.Map.Entry entry = Engine.name2Actor().nextEntry(null); entry != null; entry = Engine.name2Actor().nextEntry(entry)) {
            ...
            if (((actor instanceof BigshipGeneric) || (actor instanceof ShipGeneric)) && (actor.getArmy() != World.getPlayerArmy()) && (actor != World.getPlayerAircraft())) {
                ...
                s1 = "surface, ";
                if (actor.getClass().getName().endsWith("_Sub")) {
                    byte0 = 30;
                }
                s1 = "submerged submarine, ";
                if (actor.getClass().getName().endsWith("_Srf") || actor.getClass().getName().startsWith("Sub_")) {
                    byte0 = 50;
                }
                s1 = "surfaced submarine, ";
                if ((k1 <= byte0) && (i2 >= 210) && (i2 <= 270) && (Math.sqrt(j1 * j1) <= 20D)) {
                    HUD.logCenter("                                              " + s + s1 + " bearing " + i1 + "\260" + ", range " + j2 + " km");
                }
            }
        }
    ...
    static {
        Class class1 = TU_142.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "TU-142");
        Property.set(class1, "meshName", "3DO/Plane/Tu-142/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar06());
        Property.set(class1, "yearService", 1943.5F);
        Property.set(class1, "yearExpired", 2800.9F);
        Property.set(class1, "FlightModel", "FlightModels/TU_142.fmd:TU_142FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitTU142.class, CockpitTU142_Bombardier.class, CockpitTU142RADAR.class, CockpitTU95_AGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 10, 11, 11, 12, 12, 13, 13, 14, 14, 3, 3, 3, 3, 2, 2, 2, 2, 9, 9, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN09", "_MGUN10", "_MGUN11", "_MGUN12", "_MGUN12", "_MGUN12", "_MGUN12", "_MGUN12", "_Flare01", "_Flare02", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_ExternalRock01", "_ExternalRock01", "_ExternalRock02", "_ExternalRock02", "_ExternalDev01", "_ExternalDev02", "_ExternalRock03", "_ExternalRock03", "_ExternalRock04", "_ExternalRock04", "_ExternalRock05", "_ExternalRock05", "_ExternalRock06", "_ExternalRock06", "_ExternalRock07", "_ExternalRock07", "_ExternalRock08", "_ExternalRock08", "_ExternalDev03", "_ExternalDev04" });
    }
}
