...
public class Su_17M2 extends Sukhoi implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeAcePlane, TypeFuelDump, TypeX4Carrier {
    ...
    public float getFlowRate() {
        return Su_17M2.FlowRate;
    }

    public float getFuelReserve() {
        return Su_17M2.FuelReserve;
    }
    ...
    static {
        Class class1 = Su_17M2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Su-17");
        Property.set(class1, "meshName", "3DO/Plane/Su-17M/hierSU17.him");
