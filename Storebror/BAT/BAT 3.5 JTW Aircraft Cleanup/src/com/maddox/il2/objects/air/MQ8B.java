...
public class MQ8B extends Scheme1 implements TypeScout, TypeTransport, TypeStormovik {
    ...
    public void computeVerticalThrust() {
        ...
        float f3 = Aircraft.cvt(this.FM.getAltitude(), 0.0F, 2800F, 1.0F, 0.5F);
        float f4 = 0.0F;
        if ((this.FM.EI.engines[0].getStage() > 5) && (this.FM.EI.getPowerOutput() > 0.2F) && flag && (f1 < 7F)) {
            f4 = 1.5F * f;
        } else if ((this.FM.EI.engines[0].getStage() > 5) && (this.FM.EI.getPowerOutput() > 0.2F) && flag && (f1 > 7F)) {
            f4 = 1.15F * f;
    ...
    public void computeOrizzontalThrust() {
        ...
        if ((this.FM.EI.engines[0].getStage() > 5) && !flag) {
            f3 = 0.21F * f;
        } else if ((this.FM.EI.engines[0].getStage() > 5) && (f1 > 3F) && flag) {
            f3 = 0.18F * f;
        }
    ...
    public void computeHovering() {
        ...
        float f2 = Aircraft.cvt(f1, 0.0F, 100F, 1.0F, 0.0F);
        float f3 = 0.0F;
        if ((this.FM.EI.engines[0].getStage() > 5) && !flag && (f1 < 35F) && (this.FM.getSpeedKMH() > 8F) && this.FM.CT.StabilizerControl) {
            f3 = 0.18F * f;
        }
        this.FM.producedAF.x -= f3 * (10F * this.FM.M.mass) * (1.0F * f2);
    }
    ...
    static {
        Class class1 = MQ8B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "FireScout");
        Property.set(class1, "meshName", "3DO/Plane/MQ-8B/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitUAV.class });
