...
public class F_111 extends Mig_19 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump {
    ...
    public float getFlowRate() {
        return F_111.FlowRate;
    }

    public float getFuelReserve() {
        return F_111.FuelReserve;
    }
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(F_111.NEG_G_TOLERANCE_FACTOR, F_111.NEG_G_TIME_FACTOR, F_111.NEG_G_RECOVERY_FACTOR, F_111.POS_G_TOLERANCE_FACTOR, F_111.POS_G_TIME_FACTOR, F_111.POS_G_RECOVERY_FACTOR);
...
//    private static final float POS_G_RECOVERY_FACTOR = 1.5F;
    ...
    static {
        Class class1 = F_111.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F-111");
        Property.set(class1, "meshName", "3DO/Plane/F-111/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitTU16A.class, CockpitTU16A_Bombardier.class });
