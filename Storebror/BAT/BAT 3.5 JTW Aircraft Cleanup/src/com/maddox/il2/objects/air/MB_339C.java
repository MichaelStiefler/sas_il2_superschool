...
public class MB_339C extends MB_339Modern {
    ...
    protected static void XweaponsRegister(Class class1, String s, String as[]) {
        ...
        ArrayList arraylist = MB_339C.XweaponsListProperty(class1);
        HashMapInt hashmapint = MB_339C.XweaponsMapProperty(class1);
