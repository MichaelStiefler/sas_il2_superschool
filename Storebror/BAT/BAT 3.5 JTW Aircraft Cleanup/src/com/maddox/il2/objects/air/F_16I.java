...
public class F_16I extends F_16fuelReceiver implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("CFT")) {
            this.hierMesh().chunkVisible("CFtanks", true);
            float f = 2724.8F;
            float f1 = ((FlightModelMain) (this.FM)).M.fuel / this.FM.M.maxFuel;
            this.FM.M.maxFuel += f;
            this.FM.M.fuel += f * f1;
            this.FM.M.referenceWeight += f * f1;
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/F-16I.fmd:f16_fm");
        Property.set(class1, "cockpitClass", new Class[] { CockpitF_16C_B52.class, CockpitF16FLIR.class });
