...
public class SeaHawk extends SeaHawk_X {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/SeaHawk.fmd:SeaHawk_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitSeaHawk.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 9, 9, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04", "_ExternalRock05", "_ExternalRock06", "_ExternalRock07", "_ExternalRock08", "_ExternalRock09", "_ExternalRock10", "_ExternalRock11", "_ExternalRock12", "_ExternalRock13", "_ExternalRock14", "_ExternalRock15", "_ExternalRock16", "_ExternalRock17", "_ExternalRock18", "_ExternalRock19", "_ExternalRock20", "_ExternalDev01", "_ExternalDev02", "_ExternalBomb01", "_ExternalDev02" });
    }
}
