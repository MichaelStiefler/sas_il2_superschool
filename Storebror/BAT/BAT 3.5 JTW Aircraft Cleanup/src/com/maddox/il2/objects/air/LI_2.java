...
public class LI_2 extends Scheme2 implements TypeTransport, TypeBomber {
    ...
    public void msgShot(Shot shot) {
        ...
        if (shot.chunkName.startsWith("Nose") && (((Tuple3d) (Aircraft.Pd)).x > 4.9D) && (Aircraft.Pd.z > -0.090000003576278687D) && (World.Rnd().nextFloat() < 0.1F)) {
        ...
        if (shot.chunkName.startsWith("Turret1")) {
            ...
            if ((Aircraft.Pd.z > 1.335D) && (shot.initiator == World.getPlayerAircraft()) && World.cur().isArcade()) {
        ...
        if (shot.chunkName.startsWith("Tail") && (((Tuple3d) (Aircraft.Pd)).x < -5.8D) && (((Tuple3d) (Aircraft.Pd)).x > -6.7899999618530273D) && (((Tuple3d) (Aircraft.Pd)).z > -0.449D) && (Aircraft.Pd.z < 0.12399999797344208D)) {
