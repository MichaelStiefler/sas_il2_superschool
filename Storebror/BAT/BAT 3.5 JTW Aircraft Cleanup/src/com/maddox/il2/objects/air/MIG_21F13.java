...
public class MIG_21F13 extends MIG_21 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    public void typeFighterAceMakerRangeFinder() {
        ...
        MIG_21F13.hunted = Main3D.cur3D().getViewPadlockEnemy();
        if (MIG_21F13.hunted == null) {
            MIG_21F13.hunted = War.GetNearestEnemyAircraft(((Interpolate) (this.FM)).actor, 2000F, 9);
        }
        if (MIG_21F13.hunted != null) {
            this.k14Distance = (float) ((Interpolate) (this.FM)).actor.pos.getAbsPoint().distance(MIG_21F13.hunted.pos.getAbsPoint());
    ...
    static {
        Class class1 = MIG_21F13.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MiG21");
        Property.set(class1, "meshName", "3DO/Plane/MiG-21F/hier21F13.him");
