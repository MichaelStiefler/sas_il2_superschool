...
public class TU_85_1 extends B_29X implements TypeBomber {
    ...
    static {
        Class class1 = TU_85_1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "TU-85");
        Property.set(class1, "meshName", "3DO/Plane/Tu-85/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
        Property.set(class1, "yearService", 1947F);
        Property.set(class1, "yearExpired", 1960F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitTU85.class, CockpitTU85_Bombardier.class, CockpitTU85_TGunner.class, CockpitTU85_T2Gunner.class, CockpitTU85_FGunner.class, CockpitTU85_AGunner.class, CockpitTU85_RGunner.class });
        Property.set(class1, "FlightModel", "FlightModels/Tu-85.fmd:TU85_FM");
