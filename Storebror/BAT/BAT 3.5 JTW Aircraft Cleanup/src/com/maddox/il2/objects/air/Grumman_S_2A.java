...
public class Grumman_S_2A extends Grumman_S_2 implements TypeBomber, TypeStormovik, TypeStormovikArmored {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = Grumman_S_2A.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= Grumman_S_2A.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / Grumman_S_2A.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (Grumman_S_2A.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(Grumman_S_2A.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitGrumman_S_2A.class, CockpitGrumman_S_2A_Bombardier.class });
