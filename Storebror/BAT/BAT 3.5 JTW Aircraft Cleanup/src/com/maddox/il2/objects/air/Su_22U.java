...
public class Su_22U extends Sukhoi implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump {
    ...
    public float getFlowRate() {
        return Su_22U.FlowRate;
    }

    public float getFuelReserve() {
        return Su_22U.FuelReserve;
    }
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(Su_22U.NEG_G_TOLERANCE_FACTOR, Su_22U.NEG_G_TIME_FACTOR, Su_22U.NEG_G_RECOVERY_FACTOR, Su_22U.POS_G_TOLERANCE_FACTOR, Su_22U.POS_G_TIME_FACTOR, Su_22U.POS_G_RECOVERY_FACTOR);
    }
    ...
    public void computeR29BS300_AB() {
        if ((this.FM.EI.engines[0].getThrustOutput() > 1.001F) && (this.FM.EI.engines[0].getStage() > 5)) {
            this.FM.producedAF.x += 27000D;
        }
    ...
    static {
        Class class1 = Su_22U.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Su-17");
        Property.set(class1, "meshName", "3DO/Plane/Su-17UM/hierSU17UM.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "noseart", 1);
        Property.set(class1, "yearService", 1972F);
        Property.set(class1, "yearExpired", 2020F);
        Property.set(class1, "FlightModel", "FlightModels/Su-22U.fmd:Sukhoi_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitSu_7Uc.class, CockpitSu_7Bombardier.class, CockpitSu_7Ui.class });
