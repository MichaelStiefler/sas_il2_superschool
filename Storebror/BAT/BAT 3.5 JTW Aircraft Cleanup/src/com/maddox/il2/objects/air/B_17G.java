...
public class B_17G extends B_17 implements TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = B_17G.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= B_17G.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / B_17G.toMeters(this.fSightCurAltitude)));
            this.calibDistance = B_17G.toMetersPerSecond(this.fSightCurSpeed) * AircraftLH.floatindex(Aircraft.cvt(B_17G.toMeters(this.fSightCurAltitude), 0.0F, 7000F, 0.0F, 7F), B_17G.calibrationScale);
            if (this.fSightCurDistance < (this.calibDistance + (B_17G.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(B_17G.toMeters(this.fSightCurAltitude) * (2F / 9.81F))))) {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitB17G.class, CockpitB17G_Bombardier.class, CockpitB17G_FGunner.class, CockpitB17G_FLGunner.class, CockpitB17G_FRGunner.class, CockpitB17G_TGunner.class, CockpitB17G_AGunner.class, CockpitB17G_BGunner.class, CockpitB17G_LGunner.class, CockpitB17G_RGunner.class });
