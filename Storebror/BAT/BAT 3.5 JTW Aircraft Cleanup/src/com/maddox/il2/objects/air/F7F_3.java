...
public class F7F_3 extends F7F implements TypeFighter, TypeBNZFighter, TypeStormovik {
    ...
    public void onAircraftLoaded() {
        ...
        if ((this.thisWeaponsName.indexOf("1x") == -1) && (this.thisWeaponsName.indexOf("3x") == -1)) {
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
        F7F_3.moveGear(hiermesh, f, f1, f2, true);
    }

    protected void moveGear(float f, float f1, float f2) {
        F7F_3.moveGear(this.hierMesh(), f, f1, f2, this.FM.CT.GearControl > 0.5F);
    }

    public static void moveGear(HierMesh hiermesh, float f, boolean bDown) {
        F7F_3.moveGear(hiermesh, f, f, f, bDown);
    }

    public static void moveGear(HierMesh hiermesh, float f) {
        F7F_3.moveGear(hiermesh, f, f, f, true);
    }

    protected void moveGear(float f) {
        F7F_3.moveGear(this.hierMesh(), f, this.FM.CT.GearControl > 0.5F);
    }
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalDev04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04", "_ExternalRock05", "_ExternalRock06", "_ExternalRock07", "_ExternalRock08", "_ExternalRock09", "_ExternalRock10" });
    }
}
