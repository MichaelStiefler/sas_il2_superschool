...
public class Hunter_FGA9 extends Hunter implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    static {
        Class airClass = Hunter_FGA9.class;
        new NetAircraft.SPAWN(airClass);
        Property.set(airClass, "iconFar_shortClassName", "Hunter");
        Property.set(airClass, "meshName", "3DO/Plane/Hunter(Multi1)/hier_FGA9.him");
        ...
        Property.set(airClass, "FlightModel", "FlightModels/HunterFGA9.fmd:Hunter_FM");
