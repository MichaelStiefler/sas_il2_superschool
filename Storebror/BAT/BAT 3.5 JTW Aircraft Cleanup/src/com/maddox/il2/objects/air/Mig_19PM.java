...
public class Mig_19PM extends Mig_19 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    public float getFlowRate() {
        return Mig_19PM.FlowRate;
    }

    public float getFuelReserve() {
        return Mig_19PM.FuelReserve;
    }
    ...
    private boolean RP5() {
        ...
        if (aircraft instanceof Mig_19PM) {
            flag1 = true;
        }
        if (d3 < 0.0D) {
            d3 = 0.0D;
    ...
    static {
        Class class1 = Mig_19PM.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MiG-19");
        Property.set(class1, "meshName", "3DO/Plane/Mig-19/hier19PM.him");
