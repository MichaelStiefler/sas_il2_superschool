...
public class PB4Y_2 extends PB4Y implements TypeBomber, TypeX4Carrier, TypeGuidedBombCarrier {
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            if (this.fSightCurDistance < (PB4Y_2.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(PB4Y_2.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_MGUN10", "_MGUN11", "_MGUN12", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_ExternalBomb01", "_ExternalBomb03", "_ExternalBomb02", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb07", "_ExternalBomb06", "_ExternalBomb08" });
    }
}
