...
public class Huey_Gunship extends HueyX implements TypeScout, TypeTransport {

    public Huey_Gunship() {
    }

    static {
        Class class1 = Huey_Gunship.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Huey_Gunship");
        Property.set(class1, "meshName", "3DO/Plane/Huey_Gunship/hier.him");
