...
public class CanberraBIMk8 extends Canberra implements TypeStormovik {
    ...
    static {
        Class class1 = CanberraBIMk8.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Canberra B(I) Mk.8");
        Property.set(class1, "meshName", "3DO/Plane/Canberra_B(I).8(Multi1)/hier.him");
        ...
        Property.set(class1, "FlightModel", "FlightModels/CanberraMk8.fmd:CANBERRA");
        Property.set(class1, "cockpitClass", new Class[] { CockpitCanberraMk8.class, CockpitCanberraBombardier.class, CockpitCanberraBombardier2.class });
