...
public class F84G2 extends F84 implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker {
    ...
    protected void moveGear(float f, float f1, float f2) {
        F84G2.moveGear(this.hierMesh(), f, f1, f2);
    }
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitF84G2.class });
