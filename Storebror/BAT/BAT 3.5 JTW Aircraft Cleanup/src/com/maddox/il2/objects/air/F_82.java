...
public class F_82 extends F82 {
    ...
    public void moveCockpitDoor(float f) {
        ...
        this.hierMesh().chunkSetAngles("Head2_D0", 12F * f1, 0.0F, 0.0F);
    ...
    static {
        Class class1 = F_82.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F-82");
        Property.set(class1, "meshName", "3DO/Plane/F-82F(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "noseart", 1);
        Property.set(class1, "yearService", 1947F);
        Property.set(class1, "yearExpired", 1957.5F);
        Property.set(class1, "FlightModel", "FlightModels/F82F.fmd:F82F_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitF_82.class });
