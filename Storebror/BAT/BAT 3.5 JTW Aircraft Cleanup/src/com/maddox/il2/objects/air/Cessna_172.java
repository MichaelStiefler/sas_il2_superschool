...
public class Cessna_172 extends Scheme1 implements TypeScout, TypeTransport, TypeFighter {
    ...
    protected void moveGear(float f) {
        Cessna_172.moveGear(this.hierMesh(), f);
    }
    ...
    public void moveWheelSink() {
        ...
        this.hierMesh().chunkSetAngles("GearL2_D0", 0.0F, AircraftLH.floatindex(f, Cessna_172.gearL2), 0.0F);
        ...
        this.hierMesh().chunkSetAngles("GearR2_D0", 0.0F, -AircraftLH.floatindex(f, Cessna_172.gearL2), 0.0F);
    }

    protected void moveRudder(float f) {
        this.hierMesh().chunkSetAngles("Rudder1_D0", 30F * f, 0.0F, 0.0F);
        this.hierMesh().chunkSetAngles("GearC2_D0", -30F * f, 0.0F, 0.0F);
    }
    ...
    static {
        Class class1 = Cessna_172.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Cessna-172");
        Property.set(class1, "meshName", "3DO/Plane/Cessna-172/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "meshName_us", "3DO/Plane/Cessna-172(US)/hier.him");
        Property.set(class1, "PaintScheme_us", new PaintSchemeBMPar04());
        Property.set(class1, "originCountry", PaintScheme.countryUSA);
        Property.set(class1, "yearService", 1947.9F);
