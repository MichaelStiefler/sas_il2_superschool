...
public class MIG21PF extends MIG_21 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    public void typeFighterAceMakerRangeFinder() {
        ...
        MIG21PF.hunted = Main3D.cur3D().getViewPadlockEnemy();
        if (MIG21PF.hunted == null) {
            MIG21PF.hunted = War.GetNearestEnemyAircraft(((Interpolate) (this.FM)).actor, 2000F, 9);
        }
        if (MIG21PF.hunted != null) {
            this.k14Distance = (float) ((Interpolate) (this.FM)).actor.pos.getAbsPoint().distance(MIG21PF.hunted.pos.getAbsPoint());
