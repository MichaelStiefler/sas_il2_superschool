...
public class KC_135R_Drogue extends KC_135Tanker2 {

    public KC_135R_Drogue() {
    }
    ...
    static {
        Class class1 = KC_135R_Drogue.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Stratotanker");
        Property.set(class1, "meshName", "3DO/Plane/C-135/hierKC-135R_Drogue.him");
        Property.set(class1, "PaintScheme_us", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1943F);
        Property.set(class1, "yearExpired", 1956.6F);
        Property.set(class1, "FlightModel", "FlightModels/KC-135R.fmd:C135FM");
