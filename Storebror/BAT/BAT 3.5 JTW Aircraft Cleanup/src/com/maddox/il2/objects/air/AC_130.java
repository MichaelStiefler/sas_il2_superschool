...
public class AC_130 extends KC_130 implements TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = AC_130.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= AC_130.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / AC_130.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (AC_130.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(AC_130.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
    ...
    public void update(float f) {
        ...
        if (pilot != null) {
            Actor actor = War.GetNearestEnemy(this, this.getArmy(), 2000F);
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitAC_130.class });
        Property.set(class1, "LOSElevation", 0.725F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 3, 1, 1, 1 });
