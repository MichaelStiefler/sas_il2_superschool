...
public class Wessex_HAR3 extends Scheme1 implements TypeScout, TypeTransport {
    ...
    protected void moveGear(float f) {
        Wessex_HAR3.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Wessex_HAR3.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Wessex");
        Property.set(class1, "meshName", "3DO/Plane/WessexHAR3(Multi1)/hier.him");
