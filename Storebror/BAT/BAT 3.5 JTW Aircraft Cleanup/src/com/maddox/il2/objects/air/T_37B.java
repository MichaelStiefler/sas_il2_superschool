...
public class T_37B extends T_37 implements TypeStormovik {
    ...
    public float getFlowRate() {
        return T_37B.FlowRate;
    }

    public float getFuelReserve() {
        return T_37B.FuelReserve;
    }
    ...
    static {
        Class class1 = T_37B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "T-37");
        Property.set(class1, "meshName", "3DO/Plane/A-37/hierT37.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1966F);
        Property.set(class1, "yearExpired", 1999F);
        Property.set(class1, "FlightModel", "FlightModels/T-37B.fmd:A37FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitT_37.class, CockpitT_37.class });
