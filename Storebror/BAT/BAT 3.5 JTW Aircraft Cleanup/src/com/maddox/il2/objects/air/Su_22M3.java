...
public class Su_22M3 extends Sukhoi implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeLaserSpotter {
    ...
    public float getFlowRate() {
        return Su_22M3.FlowRate;
    }

    public float getFuelReserve() {
        return Su_22M3.FuelReserve;
    }
    ...
    public void laserUpdate() {
        if (!this.laserLock) {
            ...
            Su_22M3.LaserLoc1.set(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
            this.LaserHook[1].computePos(this, Actor._tmpLoc, Su_22M3.LaserLoc1);
            Su_22M3.LaserLoc1.get(Su_22M3.LaserP1);
            Su_22M3.LaserLoc1.set(30000D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
            this.LaserHook[1].computePos(this, Actor._tmpLoc, Su_22M3.LaserLoc1);
            Su_22M3.LaserLoc1.get(Su_22M3.LaserP2);
            Engine.land();
            if (Landscape.rayHitHQ(Su_22M3.LaserP1, Su_22M3.LaserP2, Su_22M3.LaserPL)) {
                Su_22M3.LaserPL.z -= 0.95D;
                Su_22M3.LaserP2.interpolate(Su_22M3.LaserP1, Su_22M3.LaserPL, 1.0F);
                TypeLaserSpotter.spot.set(Su_22M3.LaserP2);
                Eff3DActor.New(null, null, new Loc(((Tuple3d) (Su_22M3.LaserP2)).x, ((Tuple3d) (Su_22M3.LaserP2)).y, Su_22M3.LaserP2.z, 0.0F, 0.0F, 0.0F), 1.0F, "3DO/Effects/Fireworks/FlareWhiteWide.eff", 0.1F);
            }
        } else if (this.laserLock) {
            Su_22M3.LaserP3.x = Su_22M3.LaserP2.x + (-(this.fSightCurForwardAngle * 6F));
            Su_22M3.LaserP3.y = Su_22M3.LaserP2.y + (this.fSightCurSideslip * 6F);
            Su_22M3.LaserP3.z = Su_22M3.LaserP2.z;
            TypeLaserSpotter.spot.set(Su_22M3.LaserP3);
            Eff3DActor.New(null, null, new Loc(((Tuple3d) (Su_22M3.LaserP3)).x, ((Tuple3d) (Su_22M3.LaserP3)).y, Su_22M3.LaserP3.z, 0.0F, 0.0F, 0.0F), 1.0F, "3DO/Effects/Fireworks/FlareWhiteWide.eff", 0.1F);
        }
    }
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(Su_22M3.NEG_G_TOLERANCE_FACTOR, Su_22M3.NEG_G_TIME_FACTOR, Su_22M3.NEG_G_RECOVERY_FACTOR, Su_22M3.POS_G_TOLERANCE_FACTOR, Su_22M3.POS_G_TIME_FACTOR, Su_22M3.POS_G_RECOVERY_FACTOR);
    }
    ...
    static {
        Class class1 = Su_22M3.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Su-17");
        Property.set(class1, "meshName", "3DO/Plane/Su-17M3/hierSU22M3.him");
