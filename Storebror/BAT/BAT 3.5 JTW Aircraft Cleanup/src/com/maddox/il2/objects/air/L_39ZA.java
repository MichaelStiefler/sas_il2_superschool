...
public class L_39ZA extends L39A implements TypeFighter, TypeStormovik, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit {
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(L_39ZA.NEG_G_TOLERANCE_FACTOR, L_39ZA.NEG_G_TIME_FACTOR, L_39ZA.NEG_G_RECOVERY_FACTOR, L_39ZA.POS_G_TOLERANCE_FACTOR, L_39ZA.POS_G_TIME_FACTOR, L_39ZA.POS_G_RECOVERY_FACTOR);
...
//    private static final float POS_G_RECOVERY_FACTOR = 2.0F;
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.endsWith("armed")) {
            this.hierMesh().chunkVisible("PylonL1", true);
            this.hierMesh().chunkVisible("PylonR1", true);
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitL39.class, CockpitL39_2.class, CockpitL39Bombardier.class });
        Property.set(class1, "LOSElevation", 0.965F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 9, 9, 0, 0, 9, 9, 3, 3, 3, 3, 2, 2, 2, 2, 9, 2, 2, 2, 2, 9, 2, 2, 2, 2, 2, 2, 2, 2, 9, 9, 9, 9, 2, 2, 2, 2, 9, 2, 2, 9, 9, 9, 9, 2, 2, 2, 2, 9, 9, 9, 9, 9, 9, 3, 3, 3, 3, 9, 9, 3, 3, 3, 3 });
