...
public class Su_20 extends Sukhoi implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeAcePlane, TypeFuelDump {
    ...
    public float getFlowRate() {
        return Su_20.FlowRate;
    }

    public float getFuelReserve() {
        return Su_20.FuelReserve;
    }
    ...
    static {
        Class class1 = Su_20.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Su-20");
        Property.set(class1, "meshName", "3DO/Plane/Su-17/hierSU20.him");
