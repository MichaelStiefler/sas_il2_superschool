...
public class A_37 extends T_37 implements TypeStormovik {
    ...
    public float getFlowRate() {
        return A_37.FlowRate;
    }

    public float getFuelReserve() {
        return A_37.FuelReserve;
    }
    ...
    static {
        ...
        Property.set(class1, "meshName", "3DO/Plane/A-37/hierA.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1966F);
        Property.set(class1, "yearExpired", 1999F);
        Property.set(class1, "FlightModel", "FlightModels/A-37A.fmd:A37FM");
