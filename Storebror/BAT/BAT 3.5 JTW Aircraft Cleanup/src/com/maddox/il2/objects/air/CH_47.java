...
public class CH_47 extends Scheme2 implements TypeTransport {
    ...
    protected void moveGear(float f) {
        CH_47.moveGear(this.hierMesh(), f);
    }
    ...
    protected void moveFan(float f) {
        ...
        if (this.FM.EI.engines[1].getw() > 100F) {
    ...
    public void computeVerticalThrust() {
        ...
        float f3 = Aircraft.cvt(this.FM.getAltitude(), 0.0F, 5500F, 1.0F, 0.5F);
        float f4 = 0.0F;
        if ((this.FM.EI.engines[0].getStage() > 5) && (this.FM.EI.getPowerOutput() > 0.2F) && flag && (f1 < 15F)) {
            f4 = 1.68F * f;
        } else if ((this.FM.EI.engines[0].getStage() > 5) && (this.FM.EI.getPowerOutput() > 0.2F) && flag && (f1 > 15F)) {
            f4 = 1.23F * f;
    ...
    public void computeOrizzontalThrust() {
        ...
        if ((this.FM.EI.engines[0].getStage() > 5) && !flag) {
            f3 = 0.18F * f;
        } else if ((this.FM.EI.engines[0].getStage() > 5) && (f1 > 2.0F) && flag) {
            f3 = 0.14F * f;
        }
    ...
    public void computeHovering() {
        ...
        float f2 = Aircraft.cvt(f1, 0.0F, 100F, 1.0F, 0.0F);
        float f3 = 0.0F;
        if ((this.FM.EI.engines[0].getStage() > 5) && !flag && (f1 < 50F) && (this.FM.getSpeedKMH() > 6F) && this.FM.CT.StabilizerControl) {
            f3 = 0.3F * f;
        }
        this.FM.producedAF.x -= f3 * (10F * this.FM.M.mass) * (1.0F * f2);
    }
    ...
    public void computeEngine() {
        ...
        if (f > 6D) {
            ...
            float f2 = f * f;
            float f3 = f2 * f;
            f1 = ((0.0444444F * f3) - (0.0666667F * f2)) + (5.46667F * f);
        }
    ...
    static {
        Class class1 = CH_47.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Wessex");
        Property.set(class1, "meshName", "3DO/Plane/CH-47/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1950F);
        Property.set(class1, "yearExpired", 1960.5F);
        Property.set(class1, "FlightModel", "FlightModels/CH-47.fmd:CH47FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitCH_47.class });
