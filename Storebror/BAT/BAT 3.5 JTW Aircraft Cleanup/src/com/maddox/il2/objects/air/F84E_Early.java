...
public class F84E_Early extends F84 implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker {
    ...
    protected void moveGear(float f, float f1, float f2) {
        F84E_Early.moveGear(this.hierMesh(), f, f1, f2);
    }
    ...
    static {
        Class class1 = F84E_Early.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F84E");
        Property.set(class1, "meshName", "3DO/Plane/F84E/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitF84E.class });
