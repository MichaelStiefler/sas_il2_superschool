...
public class Su_9B extends Sukhoi implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    protected void moveGear(float f) {
        ...
        Su_9B.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Su_9B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Su-9");
        Property.set(class1, "meshName", "3DO/Plane/Su-9/hierSU9.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitSu_9.class, CockpitMig_17Radar.class });
