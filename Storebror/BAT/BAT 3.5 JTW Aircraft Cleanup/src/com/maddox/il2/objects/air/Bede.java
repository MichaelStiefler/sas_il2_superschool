...
public class Bede extends L39G implements TypeFighter, TypeStormovik, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit {
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(Bede.NEG_G_TOLERANCE_FACTOR, Bede.NEG_G_TIME_FACTOR, Bede.NEG_G_RECOVERY_FACTOR, Bede.POS_G_TOLERANCE_FACTOR, Bede.POS_G_TIME_FACTOR, Bede.POS_G_RECOVERY_FACTOR);
