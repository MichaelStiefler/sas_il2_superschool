...
public class He115 extends He115x implements TypeBomber, TypeStormovik, TypeSeaPlane {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = He115.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= He115.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / He115.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (He115.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(He115.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/He115.fmd:He115_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHe115.class });
        Property.set(class1, "LOSElevation", 0.92575F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 2, 2, 2, 2, 2, 2, 2, 3 });
