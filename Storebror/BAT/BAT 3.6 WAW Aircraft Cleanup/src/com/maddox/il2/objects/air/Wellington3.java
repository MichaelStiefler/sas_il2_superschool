...
public class Wellington3 extends Wellington implements TypeBomber {
    ...
    public void typeBomberReplicateToNet(NetMsgGuaranted netmsgguaranted) throws IOException {
        ...
        netmsgguaranted.writeFloat(this.fSightCurReadyness);
        netmsgguaranted.writeBoolean(this.bSightAutomation);
        netmsgguaranted.writeBoolean(this.bSightBombDump);
    }
    ...
    public void typeBomberReplicateFromNet(NetMsgInput netmsginput) throws IOException {
        ...
        if (this.fSightCurAltitude > 0.0F) {
            this.fSightCurDistance = 1000F;
            this.fSightCurReadyness = 1.0F;
            this.bSightAutomation = false;
            this.bSightBombDump = false;
            return;
        } else {
            this.fSightCurAltitude = -this.fSightCurAltitude;
            this.fSightCurDistance = netmsginput.readFloat();
            this.fSightCurReadyness = netmsginput.readFloat();
            this.bSightAutomation = netmsginput.readBoolean();
            this.bSightBombDump = netmsginput.readBoolean();
            return;
        }
    }
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitWellington_MKIII.class, CockpitWellington_MkIII_Bombardier.class, CockpitWellington_MkIII_AGunner.class, CockpitWellington_MkIII_FGunner.class, CockpitWellington_MkIII_LGunner.class, CockpitWellington_MkIII_RGunner.class });
