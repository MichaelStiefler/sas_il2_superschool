...
public class BattleMkII extends FaireyBattle implements TypeBomber {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/BattleMkII.fmd:BattleFM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitBattleMkII.class, CockpitFB5N2_Bombardier.class, CockpitBattleMkII_TGunner.class });
        Property.set(class1, "LOSElevation", 0.7394F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 10, 9, 3, 9, 3, 9, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_ExternalDev01", "_ExternalBomb01", "_ExternalDev02", "_ExternalBomb02", "_ExternalDev03", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08", "_ExternalBomb09", "_ExternalBomb10", "_ExternalBomb11" });
    }
}
