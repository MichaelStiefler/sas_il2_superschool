...
public class RWD_13 extends Scheme1 implements TypeScout, TypeTransport {
    ...
    public void moveWheelSink() {
        ...
        this.hierMesh().chunkSetAngles("GearL2_D0", 0.0F, AircraftLH.floatindex(f, RWD_13.gearL2), 0.0F);
        this.hierMesh().chunkSetAngles("GearL4_D0", 0.0F, AircraftLH.floatindex(f, RWD_13.gearL4), 0.0F);
        this.hierMesh().chunkSetAngles("GearL5_D0", 0.0F, AircraftLH.floatindex(f, RWD_13.gearL5), 0.0F);
        ...
        this.hierMesh().chunkSetAngles("GearR2_D0", 0.0F, -AircraftLH.floatindex(f, RWD_13.gearL2), 0.0F);
        this.hierMesh().chunkSetAngles("GearR4_D0", 0.0F, -AircraftLH.floatindex(f, RWD_13.gearL4), 0.0F);
        this.hierMesh().chunkSetAngles("GearR5_D0", 0.0F, -AircraftLH.floatindex(f, RWD_13.gearL5), 0.0F);
    }
    ...
    public void moveCockpitDoor(float f) {
        this.hierMesh().chunkSetAngles("Blister1_D0", 80F * f, 0.0F, 0.0F);
        this.hierMesh().chunkSetAngles("Blister2_D0", -80F * f, 0.0F, 0.0F);
        this.hierMesh().chunkSetAngles("Blister3_D0", 0.0F, -180F * f, 0.0F);
    ...
    protected void moveSlats(float f) {
        this.resetYPRmodifier();
        Aircraft.xyz[0] = Aircraft.cvt(this.FM.getAOA(), 6.8F, 15F, 0.0F, 0.125F);
        Aircraft.xyz[1] = Aircraft.cvt(this.FM.getAOA(), 6.8F, 15F, 0.0F, -0.125F);
        ...
        if (this.lLight == null) {
            ...
            for (int j = 0; j < 4; j++) {
                if (this.FM.AS.astateLandingLightEffects[j] != null) {
                    RWD_13.lLightLoc1.set(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
                    this.lLightHook[j].computePos(this, Actor._tmpLoc, RWD_13.lLightLoc1);
                    RWD_13.lLightLoc1.get(RWD_13.lLightP1);
                    RWD_13.lLightLoc1.set(2000D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
                    this.lLightHook[j].computePos(this, Actor._tmpLoc, RWD_13.lLightLoc1);
                    RWD_13.lLightLoc1.get(RWD_13.lLightP2);
                    Engine.land();
                    if (Landscape.rayHitHQ(RWD_13.lLightP1, RWD_13.lLightP2, RWD_13.lLightPL)) {
                        RWD_13.lLightPL.z++;
                        RWD_13.lLightP2.interpolate(RWD_13.lLightP1, RWD_13.lLightPL, 0.95F);
                        this.lLight[j].setPos(RWD_13.lLightP2);
                        float f = (float) RWD_13.lLightP1.distance(RWD_13.lLightPL);
                        float f1 = (f * 0.5F) + 60F;
    ...
    static {
        Class class1 = RWD_13.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "RWD13");
        Property.set(class1, "meshName", "3do/plane/RWD13/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "originCountry", PaintScheme.countryGermany);
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1956F);
        Property.set(class1, "FlightModel", "FlightModels/RWD13.fmd:RWD13FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitRWD_13.class });
