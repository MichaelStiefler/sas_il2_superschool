...
public class CaproniCA33 extends Scheme3 implements TypeTransport, TypeBomber {
    ...
    protected void moveGear(float f) {
        CaproniCA33.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = CaproniCA33.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "CA33");
        Property.set(class1, "meshName", "3DO/Plane/CaproniCA33/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1916F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/CaproniCA33.fmd:CA32CA33_4101FM");
