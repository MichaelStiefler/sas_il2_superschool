...
public class AEG_JIa extends GermanBi {
    ...
    static {
        Class class1 = AEG_JIa.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "AEGJIa");
        Property.set(class1, "meshName", "3do/plane/AEG-J/hierJIa.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1916F);
        Property.set(class1, "yearExpired", 1925F);
        Property.set(class1, "FlightModel", "FlightModels/AEGJI.fmd:AEGJ");
