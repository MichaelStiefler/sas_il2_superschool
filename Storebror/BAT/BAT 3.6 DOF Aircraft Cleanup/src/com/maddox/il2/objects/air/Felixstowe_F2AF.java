...
public class Felixstowe_F2AF extends Felixstowe_X implements TypeSeaPlane, TypeBomber, TypeTransport {

    public Felixstowe_F2AF() {
    ...
    static {
        Class class1 = Felixstowe_F2AF.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Felixstowe");
        Property.set(class1, "meshName", "3DO/Plane/Felixstowe_F2AF/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar04());
        Property.set(class1, "yearService", 1943F);
        Property.set(class1, "yearExpired", 2048F);
        Property.set(class1, "FlightModel", "FlightModels/Felixstowe.fmd:Felixstowe_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitFelixstowe_F2AF.class, CockpitFelixstowe_F2AF_Bombardier.class, CockpitFelixstowe_F2AF_NGunner.class, CockpitFelixstowe_F2AF_TGunner.class });
        Property.set(class1, "LOSElevation", 0.73425F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 10, 11, 11, 3, 3, 3, 3, 9, 9, 2 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalDev01", "_ExternalDev02", "_ExternalBomb06" });
    }
}
