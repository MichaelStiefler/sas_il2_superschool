...
public class Breguet14_E2 extends Breguet implements TypeStormovik {
    ...
    static {
        Class class1 = Breguet14_E2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Breguet14_E2");
        Property.set(class1, "meshName", "3DO/Plane/Breguet14_E2/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitBreguet14_E1.class, CockpitBreguet14_E2.class });
        Property.set(class1, "FlightModel", "FlightModels/Breguet14_E2.fmd:Breguet_FM");
