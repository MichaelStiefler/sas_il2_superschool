...
public class DH2 extends Scheme1 implements TypeFighter, TypeTNBFighter {

    public DH2() {
        this.dynamoOrient = 0.0F;
        this.bDynamoRotary = false;
        DH2.bChangedPit = true;
    }
    ...
    protected void moveAileron(float f) {
        ...
        this.hierMesh().chunkSetAngles("AroneLa_D0", 0.0F, 20F * f, 0.0F);
        this.hierMesh().chunkSetAngles("AroneR_D0", 0.0F, 20F * f, 0.0F);
        this.hierMesh().chunkSetAngles("AroneRa_D0", 0.0F, 20F * f, 0.0F);
    }
    ...
    public void moveWheelSink() {
        ...
        Aircraft.xyz[2] = -0.21F * f;
        Aircraft.xyz[1] = Aircraft.cvt(this.FM.Gears.gWheelSinking[2], 0.0F, 0.09F, 0.0F, 0.09F);
        this.hierMesh().chunkSetLocate("GearC1_D0", Aircraft.xyz, Aircraft.ypr);
    }
    ...
    protected void moveFan(float f) {
        ...
        if (this.oldProp[j] < 2) {
            ...
            if ((i != this.oldProp[j]) && this.hierMesh().isChunkVisible(DH2.Props[j][this.oldProp[j]])) {
                this.hierMesh().chunkVisible(DH2.Props[0][this.oldProp[j]], false);
                this.oldProp[j] = i;
                this.hierMesh().chunkVisible(DH2.Props[j][i], true);
            }
        }
        if (i == 0) {
        ...
        this.hierMesh().chunkSetAngles(DH2.Props[j][0], 0.0F, 0.0F, this.propPos[j]);
        if (this.oldProp[k] < 2) {
            i = Math.abs((int) (this.FM.EI.engines[0].getw() * 0.06F));
            if (i >= 1) {
                i = 1;
            }
            if ((i != this.oldProp[k]) && this.hierMesh().isChunkVisible(DH2.Props[k][this.oldProp[k]])) {
                this.hierMesh().chunkVisible(DH2.Props[k][this.oldProp[k]], false);
                this.oldProp[k] = i;
                this.hierMesh().chunkVisible(DH2.Props[k][i], true);
            }
        }
        if (i == 0) {
        ...
        this.hierMesh().chunkSetAngles(DH2.Props[k][0], 0.0F, this.propPos[k], 0.0F);
    }
    ...
    static {
        Class class1 = DH2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "DH2");
        Property.set(class1, "meshName", "3DO/Plane/DH2/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/DH2.fmd:DH2_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitDH2.class });
