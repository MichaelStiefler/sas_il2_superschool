...
public class Avro_504_L_Hydro extends Avro implements TypeFighter, TypeBomber, TypeSeaPlane, TypeScout, TypeTransport {

    public Avro_504_L_Hydro() {
    ...
    static {
        Class class1 = Avro_504_L_Hydro.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "504Hydro");
        Property.set(class1, "meshName", "3do/plane/Avro_504_L_Hydro/hierLHydro.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1967.8F);
        Property.set(class1, "FlightModel", "FlightModels/Avro_504_L_Hydro.fmd:Avro_504_L_Hydro_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitAvro504_L_PIL.class, CockpitAvro504_L_Ob.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 1, 3, 3, 3, 3 });
