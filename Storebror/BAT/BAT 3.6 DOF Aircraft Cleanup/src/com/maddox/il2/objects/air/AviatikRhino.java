...
public class AviatikRhino extends AviatikR {
    ...
    static {
        Class class1 = AviatikRhino.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Aviatik");
        Property.set(class1, "meshName", "3DO/Plane/AviatikRhino/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitAviatikRhino.class, CockpitAviatikRhino_TGunner.class });
