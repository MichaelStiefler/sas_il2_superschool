...
public class VoisinLAS_RUS extends Voisin1 {

    public VoisinLAS_RUS() {
    }
    ...
    static {
        Class class1 = VoisinLAS_RUS.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "VoisinLAS_RUS");
        Property.set(class1, "meshName", "3do/plane/VoisinLAS_RUS/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1967.8F);
        Property.set(class1, "FlightModel", "FlightModels/VoisinLAS_RUS.fmd:Voisin_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitVoisinLAS.class, CockpitVoisinLAS_TGunner.class });
