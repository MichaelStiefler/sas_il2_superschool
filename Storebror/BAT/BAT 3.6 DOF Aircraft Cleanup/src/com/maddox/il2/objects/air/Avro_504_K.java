...
public class Avro_504_K extends Avro implements TypeStormovik, TypeScout, TypeTransport {
    ...
    static {
        Class class1 = Avro_504_K.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "504");
        Property.set(class1, "meshName", "3do/plane/Avro_504_K/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1967.8F);
        Property.set(class1, "FlightModel", "FlightModels/Avro_504_K.fmd:Avro_504_K_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitAvro504_PIL.class, CockpitAvro504_Ob.class });
