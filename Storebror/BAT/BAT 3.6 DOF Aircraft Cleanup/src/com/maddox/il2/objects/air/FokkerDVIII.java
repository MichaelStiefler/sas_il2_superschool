...
public class FokkerDVIII extends Scheme1 implements TypeScout, TypeFighter {
    ...
    static {
        Class class1 = FokkerDVIII.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "FokkerDVIII");
        Property.set(class1, "meshName", "3DO/Plane/FokkerDVIII/hier.him");
        ...
        Property.set(class1, "FlightModel", "FlightModels/FokkerDVIII.fmd:FokkerDVIII");
        Property.set(class1, "cockpitClass", new Class[] { CockpitFokkerDVIII.class });
