...
public class MoraneSaulnier_I extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {

    public MoraneSaulnier_I() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_I.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_I");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_I/hierI.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1967.8F);
        Property.set(class1, "FlightModel", "FlightModels/MoraneSaulnier_N.fmd:MoraneSaulnier_N_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnier_I.class });
