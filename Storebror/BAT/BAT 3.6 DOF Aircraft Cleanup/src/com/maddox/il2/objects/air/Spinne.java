...
public class Spinne extends Scheme1 {
    ...
    protected void moveGear(float f) {
        Spinne.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Spinne.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Spinne");
        Property.set(class1, "meshName", "3DO/Plane/Spinne/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitSpinne.class });
