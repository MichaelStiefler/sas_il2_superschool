...
public class Oeffag_CII extends OeffagC implements TypeStormovik {
    ...
    static {
        Class class1 = Oeffag_CII.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Oeffag_CII");
        Property.set(class1, "meshName", "3DO/Plane/Oeffag_CII/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitOeffag_CII.class, CockpitOeffag_CII_TGunner.class });
