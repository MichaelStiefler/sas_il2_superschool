...
public class Felixstowe_F2A extends Felixstowe_X implements TypeSeaPlane, TypeBomber, TypeTransport {

    public Felixstowe_F2A() {
    ...
    static {
        Class class1 = Felixstowe_F2A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Felixstowe");
        Property.set(class1, "meshName", "3DO/Plane/Felixstowe_F2A/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitFelixstowe_F2A.class, CockpitFelixstowe_F2A_Bombardier.class, CockpitFelixstowe_F2A_NGunner.class, CockpitFelixstowe_F2A_TGunner.class });
