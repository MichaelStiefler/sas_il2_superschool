...
public class Bleriot11 extends Scheme1 {
    ...
    protected void moveGear(float f) {
        Bleriot11.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Bleriot11.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Bleriot");
        Property.set(class1, "meshName", "3DO/Plane/Bleriot11/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitBleriot11.class });
