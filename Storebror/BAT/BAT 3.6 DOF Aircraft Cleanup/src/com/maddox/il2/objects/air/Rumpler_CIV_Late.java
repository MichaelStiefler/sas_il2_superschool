...
public class Rumpler_CIV_Late extends RumplerX {

    public Rumpler_CIV_Late() {
    }
    ...
    static {
        Class class1 = Rumpler_CIV_Late.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Rumpler");
        Property.set(class1, "meshName", "3DO/Plane/Rumpler_CIV_Late/hier.him");
