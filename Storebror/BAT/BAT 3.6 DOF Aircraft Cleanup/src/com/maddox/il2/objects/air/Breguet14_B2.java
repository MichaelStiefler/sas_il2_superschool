...
public class Breguet14_B2 extends Breguet implements TypeStormovik {
    ...
    static {
        Class class1 = Breguet14_B2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Breguet14_B2");
        Property.set(class1, "meshName", "3DO/Plane/Breguet14_B2/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitBreguet14_B2.class, CockpitBreguet14_B2_TGunner.class });
        Property.set(class1, "FlightModel", "FlightModels/Breguet14_B2.fmd:Breguet_FM");
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 10, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
