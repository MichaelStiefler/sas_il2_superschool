...
public class Gotha_GV extends Gotha_X implements TypeBomber {
    ...
    static {
        Class class1 = Gotha_GV.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Gotha_GV");
        Property.set(class1, "meshName", "3DO/Plane/Gotha_GV/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitGotha_GV.class, CockpitGotha_GV_Bombardier.class, CockpitGotha_GV_NGunner.class, CockpitGotha_GV_TGunner.class });
