...
public class BE2c extends BE2 implements TypeStormovik {
    ...
    static {
        Class class1 = BE2c.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "BE2c");
        Property.set(class1, "meshName", "3do/plane/BE2c/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1916F);
        Property.set(class1, "yearExpired", 1935.8F);
        Property.set(class1, "FlightModel", "FlightModels/BE2c.fmd:BE2c");
