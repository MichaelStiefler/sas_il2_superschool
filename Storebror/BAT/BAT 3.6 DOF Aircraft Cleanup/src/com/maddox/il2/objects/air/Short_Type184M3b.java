...
public class Short_Type184M3b extends Short implements TypeSeaPlane, TypeBomber, TypeScout, TypeTransport {

    public Short_Type184M3b() {
    ...
    static {
        Class class1 = Short_Type184M3b.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Short184");
        Property.set(class1, "meshName", "3do/plane/Short_Type184/hierS184M3b.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitShort184_PIL.class, CockpitShort184_TGunner.class });
