...
public class AircoDH9a extends Airco implements TypeStormovik {
    ...
    static {
        Class class1 = AircoDH9a.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "AircoDH9a");
        Property.set(class1, "meshName", "3DO/Plane/AircoDH9a/hier.him");
