...
public class Dirigibile_M extends TB_3xx {
    ...
    static {
        Class class1 = Dirigibile_M.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Dirigibile_M");
        Property.set(class1, "meshName", "3DO/Plane/Dirigibile_M/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitDirigibile_M.class });
