...
public class Pfalz_A1 extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {
    ...
    static {
        Class class1 = Pfalz_A1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Pfalz_A1");
        Property.set(class1, "meshName", "3do/plane/Pfalz_A1/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPfalzA1_PIL.class, CockpitPfalzA1_Ob.class });
