...
public class Caudron_G_VI extends Caudron_X implements TypeFighter, TypeStormovik {
    ...
    public boolean isbDynamoOperational() {
        return this.bDynamoOperational;
    }

    public void setbDynamoOperational(boolean bDynamoOperational) {
        this.bDynamoOperational = bDynamoOperational;
    }

    public float getDynamoOrient() {
        return this.dynamoOrient;
    }

    public void setDynamoOrient(float dynamoOrient) {
        this.dynamoOrient = dynamoOrient;
    }

    public boolean isbDynamoRotary() {
        return this.bDynamoRotary;
    }

    public void setbDynamoRotary(boolean bDynamoRotary) {
        this.bDynamoRotary = bDynamoRotary;
    }
    ...
    static {
        Class class1 = Caudron_G_VI.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Caudron6");
        Property.set(class1, "meshName", "3DO/Plane/Caudron_G_VI/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar04());
        Property.set(class1, "yearService", 1943F);
        Property.set(class1, "yearExpired", 2048F);
        Property.set(class1, "FlightModel", "FlightModels/Caudron_G_IV.fmd:Caudron_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitCaudron_G_VI.class, CockpitCaudron_G_VI_TGunner.class });
        Property.set(class1, "LOSElevation", 0.73425F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 10, 3, 3, 3, 3, 9, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalDev01", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08" });
    }
}
