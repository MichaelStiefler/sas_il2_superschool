...
public class CaproniCA32_350hp extends Scheme3 implements TypeTransport, TypeBomber {

    public CaproniCA32_350hp() {
    ...
    protected void moveGear(float f) {
        CaproniCA32_350hp.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = CaproniCA32_350hp.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "CA32_350");
        Property.set(class1, "meshName", "3DO/Plane/CaproniCA33/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1915F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/CaproniCA32_350hp.fmd:CA32CA33_4101FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitCaproniCA32.class, CockpitCaproniCA32_NGunner.class, CockpitCaproniCA32_TGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
