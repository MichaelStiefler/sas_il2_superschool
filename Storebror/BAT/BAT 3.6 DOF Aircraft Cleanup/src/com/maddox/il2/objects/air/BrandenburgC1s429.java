...
public class BrandenburgC1s429 extends Brandenburg {

    public BrandenburgC1s429() {
    }
    ...
    protected void nextDMGLevel(String s, int i, Actor actor) {
        ...
        if (this.FM.isPlayers()) {
            BrandenburgC1s429.bChangedPit = true;
        }
    }
    ...
    static {
        Class class1 = BrandenburgC1s429.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "HansaC1");
        Property.set(class1, "meshName", "3DO/Plane/BrandenburgC1(P)/hier429.him");
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 1, 0, 10, 9, 9, 3, 3, 3, 3, 3, 3, 3, 3, 3, 11 });
