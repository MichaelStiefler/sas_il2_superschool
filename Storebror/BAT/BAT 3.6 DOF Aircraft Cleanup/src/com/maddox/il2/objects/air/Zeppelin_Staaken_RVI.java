...
public class Zeppelin_Staaken_RVI extends Scheme3 implements TypeTransport, TypeBomber {

    public Zeppelin_Staaken_RVI() {
    ...
    static {
        Class class1 = Zeppelin_Staaken_RVI.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "StaakenRVI");
        Property.set(class1, "meshName", "3DO/Plane/Zeppelin_Staaken_RVI/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitZeppelin_Staaken_RVI.class });
