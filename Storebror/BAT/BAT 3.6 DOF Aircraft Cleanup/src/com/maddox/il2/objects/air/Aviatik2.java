...
public class Aviatik2 extends Aviatikx2 {
    ...
    static {
        Class class1 = Aviatik2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Aviatik");
        Property.set(class1, "meshName", "3DO/Plane/Aviatik2/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitAviatik2.class, CockpitAviatik2_TGunner.class });
