...
public class MoraneSaulnier_L_Plate extends MoraneSaulnier implements TypeFighter, TypeBomber, TypeScout, TypeStormovik {

    public MoraneSaulnier_L_Plate() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_L_Plate.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_Plate");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_L_Plate/hierPlate.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnier_L_Plate.class, CockpitMoraneSaulnier_L_Plate_TGunner.class });
