...
public class MoraneSaulnier_N extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {

    public MoraneSaulnier_N() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_N.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_N");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_N/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnierN.class });
