...
public class Gotha_GIII extends Gotha_X implements TypeBomber {
    ...
    static {
        Class class1 = Gotha_GIII.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Gotha_GIII");
        Property.set(class1, "meshName", "3DO/Plane/Gotha_GIII/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar04());
        Property.set(class1, "yearService", 1943F);
        Property.set(class1, "yearExpired", 2048F);
        Property.set(class1, "FlightModel", "FlightModels/Gotha_GIV.fmd:Gotha_GIV_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitGotha_GIII.class, CockpitGotha_GIII_Bombardier.class, CockpitGotha_GIII_NGunner.class, CockpitGotha_GIII_TGunner.class });
