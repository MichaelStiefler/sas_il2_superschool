...
public class Farman_F40 extends Farman {
    ...
    static {
        Class class1 = Farman_F40.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Farman_F40");
        Property.set(class1, "meshName", "3do/plane/Farman_F40/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1967.8F);
        Property.set(class1, "FlightModel", "FlightModels/Farman_F40.fmd:Farman_FMNew");
        Property.set(class1, "cockpitClass", new Class[] { CockpitFarman_F40.class, CockpitFarman_F40_TGunner.class });
