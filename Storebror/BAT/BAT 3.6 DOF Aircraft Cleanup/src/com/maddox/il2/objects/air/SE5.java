...
public class SE5 extends SE5x {
    ...
    static {
        Class class1 = SE5.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SE5");
        Property.set(class1, "meshName", "3do/plane/SE5/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1917F);
        Property.set(class1, "yearExpired", 1925.8F);
        Property.set(class1, "FlightModel", "FlightModels/SE5.fmd:SE5_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitSE5.class });
