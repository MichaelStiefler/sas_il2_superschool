...
public class LodkaG7 extends U_SYP implements TypeAmphibiousPlane, TypeFighter {

    public LodkaG7() {
        LodkaG7.bChangedPit = true;
    }
    ...
    static {
        Class class1 = LodkaG7.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Hansa7");
        Property.set(class1, "meshName", "3DO/Plane/LodkaG(Multi)/hierG7.him");
