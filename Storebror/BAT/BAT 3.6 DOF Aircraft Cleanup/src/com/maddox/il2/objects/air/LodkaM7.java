...
public class LodkaM7 extends U_SYP implements TypeAmphibiousPlane, TypeFighter {

    public LodkaM7() {
        LodkaM7.bChangedPit = true;
    }
    ...
    static {
        Class class1 = LodkaM7.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Macchi7");
        Property.set(class1, "meshName", "3DO/Plane/Lodka(Multi)/hierM7.him");
