...
public class Pfalz_E1 extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {
    ...
    static {
        Class class1 = Pfalz_E1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "E1");
        Property.set(class1, "meshName", "3do/plane/Pfalz_E1/hierPfalz.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1967.8F);
        Property.set(class1, "FlightModel", "FlightModels/Pfalz_E1.fmd:Pfalz_E1_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitPfalz_E1.class });
