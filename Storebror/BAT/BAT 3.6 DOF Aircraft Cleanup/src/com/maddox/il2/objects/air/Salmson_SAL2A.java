...
public class Salmson_SAL2A extends Salmson implements TypeStormovik {

    public Salmson_SAL2A() {
    }
    ...
    static {
        Class class1 = Salmson_SAL2A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Salmson_SAL2A");
        Property.set(class1, "meshName", "3DO/Plane/Salmson_SAL2A/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitSalmson_SAL2A.class, CockpitSalmson_SAL2A_TGunner.class });
        Property.set(class1, "FlightModel", "FlightModels/Salmson_SAL2A.fmd:SalmsonFM");
