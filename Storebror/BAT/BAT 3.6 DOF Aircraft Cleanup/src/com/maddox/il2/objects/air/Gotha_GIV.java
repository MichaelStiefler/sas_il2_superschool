...
public class Gotha_GIV extends Gotha_X implements TypeBomber {
    ...
    static {
        Class class1 = Gotha_GIV.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Gotha_GIV");
        Property.set(class1, "meshName", "3DO/Plane/Gotha_GIV/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitGotha_GIV.class, CockpitGotha_GIV_Bombardier.class, CockpitGotha_GIV_NGunner.class, CockpitGotha_GIV_TGunner.class });
