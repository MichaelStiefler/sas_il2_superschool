...
public class Pfalz_E3 extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {
    ...
    static {
        Class class1 = Pfalz_E3.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Pfalz_E3");
        Property.set(class1, "meshName", "3do/plane/Pfalz_E3/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPfalz_E3.class });
