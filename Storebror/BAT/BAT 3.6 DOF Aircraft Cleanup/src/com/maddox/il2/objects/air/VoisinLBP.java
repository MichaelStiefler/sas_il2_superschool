...
public class VoisinLBP extends Voisin1 {
    ...
    static {
        Class class1 = VoisinLBP.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "VoisinLBP");
        Property.set(class1, "meshName", "3do/plane/VoisinLBP/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitVoisinLBP.class, CockpitVoisinLBP_TGunner.class });
