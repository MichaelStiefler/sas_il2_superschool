...
public class MoraneSaulnier_LR extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {

    public MoraneSaulnier_LR() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_LR.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_LR");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_LR/hierLR.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnier_LR.class, CockpitMoraneSaulnier_LR_TGunner.class });
