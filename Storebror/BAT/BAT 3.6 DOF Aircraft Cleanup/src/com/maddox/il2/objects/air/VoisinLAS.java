...
public class VoisinLAS extends Voisin1 {
    ...
    static {
        Class class1 = VoisinLAS.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "VoisinLAS");
        Property.set(class1, "meshName", "3do/plane/VoisinLAS/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1967.8F);
        Property.set(class1, "FlightModel", "FlightModels/VoisinLAS.fmd:Voisin_FM");
