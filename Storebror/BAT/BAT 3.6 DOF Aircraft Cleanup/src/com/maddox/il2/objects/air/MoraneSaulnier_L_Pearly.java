...
public class MoraneSaulnier_L_Pearly extends MoraneSaulnier implements TypeFighter, TypeBomber, TypeScout, TypeStormovik {

    public MoraneSaulnier_L_Pearly() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_L_Pearly.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_Pearly");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_L_Pearly/hierPearly.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnier_L_Pearly.class, CockpitMoraneSaulnier_L_Pearly_TGunner.class });
