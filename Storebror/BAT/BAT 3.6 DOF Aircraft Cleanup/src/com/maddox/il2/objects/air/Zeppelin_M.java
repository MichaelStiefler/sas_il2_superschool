...
public class Zeppelin_M extends Dirigeable {
    ...
    static {
        Class class1 = Zeppelin_M.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Zeppelin");
        Property.set(class1, "meshName", "3DO/Plane/Zeppelin_M/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitZeppelin_M.class });
