...
public class SM_S55m extends Scheme1 implements TypeTransport, TypeBomber, TypeSailPlane {
    ...
    protected void moveRudder(float f) {
        ...
        this.hierMesh().chunkSetAngles("Rudder3_D0", 0.0F, -30F * f, 0.0F);
    }
    ...
    protected void moveGear(float f) {
        SM_S55m.moveGear(this.hierMesh(), f);
    }
    ...
    public void msgShot(Shot shot) {
        ...
        if (shot.chunkName.startsWith("Pilot4")) {
            this.killPilot(shot.initiator, 3);
        }
        if (shot.chunkName.startsWith("Pilot5")) {
            this.killPilot(shot.initiator, 4);
        }
        super.msgShot(shot);
    }
    ...
    static {
        Class class1 = SM_S55m.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SM_S55m");
        Property.set(class1, "meshName", "3DO/Plane/SM_S55m/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1930F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/SM_S55m.fmd:SM_S55m4101FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitSM_S55m.class, CockpitSM_S55m_NLGunner.class, CockpitSM_S55m_NRGunner.class, CockpitSM_S55m_TLGunner.class, CockpitSM_S55m_TRGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 13, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08", "_ExternalBomb09", "_ExternalBomb10", "_ExternalBomb11", "_ExternalBomb12", "_ExternalBomb13", "_ExternalBomb14", "_ExternalBomb15", "_ExternalBomb16", "_ExternalBomb17" });
    }
}
