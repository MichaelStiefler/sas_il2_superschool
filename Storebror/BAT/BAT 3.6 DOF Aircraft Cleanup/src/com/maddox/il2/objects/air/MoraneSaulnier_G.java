...
public class MoraneSaulnier_G extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {

    public MoraneSaulnier_G() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_G.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_G");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_G/hierG.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnierG.class });
