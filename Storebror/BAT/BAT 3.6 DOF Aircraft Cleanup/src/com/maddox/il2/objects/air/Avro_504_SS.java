...
public class Avro_504_SS extends Avro implements TypeStormovik, TypeScout, TypeTransport {
    ...
    static {
        Class class1 = Avro_504_SS.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "504SS");
        Property.set(class1, "meshName", "3do/plane/Avro_504_SS/hierSS.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitAvro504_SS.class });
