...
public class Avro_504_HD extends Avro implements TypeFighter, TypeStormovik, TypeScout, TypeTransport {
    ...
    static {
        Class class1 = Avro_504_HD.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "504HD");
        Property.set(class1, "meshName", "3do/plane/Avro_504_HD/hierHD.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitAvro504_HD.class });
