...
public class LodkaM5 extends U_SYP implements TypeAmphibiousPlane, TypeStormovik {

    public LodkaM5() {
        LodkaM5.bChangedPit = true;
    }
    ...
    static {
        Class class1 = LodkaM5.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Macchi5");
        Property.set(class1, "meshName", "3DO/Plane/Lodka(Multi)/hierM5.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1917F);
        Property.set(class1, "yearExpired", 1927F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitLodka.class });
        Property.set(class1, "FlightModel", "FlightModels/LodkaM.fmd:LodkaM_FM");
