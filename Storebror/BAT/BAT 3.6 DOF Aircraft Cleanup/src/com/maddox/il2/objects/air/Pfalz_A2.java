...
public class Pfalz_A2 extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {
    ...
    static {
        Class class1 = Pfalz_A2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Pfalz_A2");
        Property.set(class1, "meshName", "3do/plane/Pfalz_A2/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPfalzA2_PIL.class, CockpitPfalzA2_Ob.class });
