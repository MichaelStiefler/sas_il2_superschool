...
public class LodkaG5 extends U_SYP implements TypeAmphibiousPlane, TypeStormovik {

    public LodkaG5() {
        LodkaG5.bChangedPit = true;
    }
    ...
    static {
        Class class1 = LodkaG5.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Hansa5");
        Property.set(class1, "meshName", "3DO/Plane/LodkaG(Multi)/hierG5.him");
        ...
        Property.set(class1, "FlightModel", "FlightModels/LodkaG.fmd:LodkaG_FM");
