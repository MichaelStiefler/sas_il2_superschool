...
public class Short_Type184R extends Short implements TypeSeaPlane, TypeBomber, TypeScout, TypeTransport {

    public Short_Type184R() {
    ...
    static {
        Class class1 = Short_Type184R.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Short184");
        Property.set(class1, "meshName", "3do/plane/Short_Type184/hierS184R.him");
