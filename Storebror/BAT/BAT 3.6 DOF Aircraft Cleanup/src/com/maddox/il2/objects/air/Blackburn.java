...
public class Blackburn extends Scheme1 {
    ...
    protected void moveGear(float f) {
        Blackburn.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Blackburn.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Blackburn");
        Property.set(class1, "meshName", "3DO/Plane/Blackburn/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitBlackburn.class });
