...
public class MoraneSaulnier_L_RG extends MoraneSaulnier implements TypeFighter, TypeBomber, TypeScout, TypeStormovik {

    public MoraneSaulnier_L_RG() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_L_RG.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_LRG");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_L_RG/hierLRG.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnier_L_RG.class, CockpitMoraneSaulnier_L_RG_TGunner.class });
