...
public class MoraneSaulnier_H extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {

    public MoraneSaulnier_H() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_H.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_H");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_H/hierH.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1967.8F);
        Property.set(class1, "FlightModel", "FlightModels/MoraneSaulnier_H.fmd:MoraneSaulnier_H_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnierH.class });
