...
public class SB_Bomber_RFC_Sea extends TB_3xx implements TypeSailPlane {

    public SB_Bomber_RFC_Sea() {
    ...
    static {
        Class class1 = SB_Bomber_RFC_Sea.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SB_Bomber_RFC_Sea");
        Property.set(class1, "meshName", "3DO/Plane/TB-3-4M-17Xsea(gb)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1916F);
        Property.set(class1, "yearExpired", 1925.5F);
        Property.set(class1, "FlightModel", "FlightModels/TB-3-4M-17xsea.fmd:TB3sea_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitTB_3x.class });
