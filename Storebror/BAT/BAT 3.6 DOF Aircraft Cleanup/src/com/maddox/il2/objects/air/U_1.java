...
public class U_1 extends Avro implements TypeStormovik, TypeScout, TypeTransport {
    ...
    static {
        Class class1 = U_1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "U_1");
        Property.set(class1, "meshName", "3do/plane/U_1/hierU_1.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitU_1_PIL.class, CockpitU_1_Ob.class });
