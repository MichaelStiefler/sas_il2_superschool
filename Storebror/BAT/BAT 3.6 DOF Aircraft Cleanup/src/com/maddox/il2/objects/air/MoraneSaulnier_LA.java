...
public class MoraneSaulnier_LA extends MoraneSaulnier implements TypeFighter, TypeScout, TypeStormovik {

    public MoraneSaulnier_LA() {
    }
    ...
    static {
        Class class1 = MoraneSaulnier_LA.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MS_LA");
        Property.set(class1, "meshName", "3do/plane/MoraneSaulnier_LA/hierLA.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMoraneSaulnier_LA.class, CockpitMoraneSaulnier_LA_TGunner.class });
