...
public class He115 extends He115x {
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            if (this.fSightCurDistance < (He115.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(He115.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitHe115.class, CockpitHe115_Bombardier.class });
