...
public class CockpitHe115 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitHe115.this.setTmp = CockpitHe115.this.setOld;
            CockpitHe115.this.setOld = CockpitHe115.this.setNew;
            CockpitHe115.this.setNew = CockpitHe115.this.setTmp;
            CockpitHe115.this.setNew.altimeter = CockpitHe115.this.fm.getAltitude();
            if (CockpitHe115.this.cockpitDimControl) {
                if (CockpitHe115.this.setNew.dimPosition > 0.0F) {
                    CockpitHe115.this.setNew.dimPosition = CockpitHe115.this.setNew.dimPosition - 0.05F;
                }
            } else if (CockpitHe115.this.setNew.dimPosition < 1.0F) {
                CockpitHe115.this.setNew.dimPosition = CockpitHe115.this.setNew.dimPosition + 0.05F;
            }
            CockpitHe115.this.setNew.throttle1 = (0.91F * CockpitHe115.this.setOld.throttle1) + (0.09F * CockpitHe115.this.fm.EI.engines[0].getControlThrottle());
            CockpitHe115.this.setNew.throttle2 = (0.91F * CockpitHe115.this.setOld.throttle2) + (0.09F * CockpitHe115.this.fm.EI.engines[1].getControlThrottle());
            CockpitHe115.this.setNew.mix1 = (0.88F * CockpitHe115.this.setOld.mix1) + (0.12F * CockpitHe115.this.fm.EI.engines[0].getControlMix());
            CockpitHe115.this.setNew.mix2 = (0.88F * CockpitHe115.this.setOld.mix2) + (0.12F * CockpitHe115.this.fm.EI.engines[1].getControlMix());
            CockpitHe115.this.setNew.azimuth = CockpitHe115.this.fm.Or.getYaw();
            if ((CockpitHe115.this.setOld.azimuth > 270F) && (CockpitHe115.this.setNew.azimuth < 90F)) {
                CockpitHe115.this.setOld.azimuth -= 360F;
            }
            if ((CockpitHe115.this.setOld.azimuth < 90F) && (CockpitHe115.this.setNew.azimuth > 270F)) {
                CockpitHe115.this.setOld.azimuth += 360F;
            }
            CockpitHe115.this.setNew.waypointAzimuth = ((10F * CockpitHe115.this.setOld.waypointAzimuth) + (CockpitHe115.this.waypointAzimuth() - CockpitHe115.this.setOld.azimuth) + World.Rnd().nextFloat(-30F, 30F)) / 11F;
            Variables variables = CockpitHe115.this.setNew;
            float f = 0.9F * CockpitHe115.this.setOld.radioalt;
            float f1 = 0.1F;
            float f2 = CockpitHe115.this.fm.getAltitude();
            World.cur();
            World.land();
            variables.radioalt = f + (f1 * (f2 - Landscape.HQ_Air((float) CockpitHe115.this.fm.Loc.x, (float) CockpitHe115.this.fm.Loc.y)));
            CockpitHe115.this.setNew.vspeed = ((199F * CockpitHe115.this.setOld.vspeed) + CockpitHe115.this.fm.getVertSpeed()) / 200F;
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitHe115.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitHe115.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHe115.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHe115.rpmScale), 0.0F, 0.0F);
