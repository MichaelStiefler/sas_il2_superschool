...
//                boolean flag2 = true;
    ...
    private void CreateGuns()
    {
        ...
        for(int i = 0; i < parts.length; i++)
        {
            ...
            {
                arms[j].aime = new Aim(this, isNetMirror(), SLOWFIRE_K * shippartproperties.DELAY_AFTER_SHOOT, true);
                hasTracking++;
            } else
            {
...
//            float f4 = Float.valueOf(stringtokenizer.nextToken()).floatValue();
    ...
    public int targetGun(Aim aim, Actor actor, float f, boolean flag)
    {
        ...
        int j = aim.setRotationForTargeting(this, o, point3d1, firingdevice.headYaw, firingdevice.gunPitch, vector3d, f2, f1, shippartproperties.HEAD_YAW_RANGE, shippartproperties.GUN_MIN_PITCH, shippartproperties.GUN_MAX_PITCH, f3, fd1, 0.0F);
        return j;
    }
