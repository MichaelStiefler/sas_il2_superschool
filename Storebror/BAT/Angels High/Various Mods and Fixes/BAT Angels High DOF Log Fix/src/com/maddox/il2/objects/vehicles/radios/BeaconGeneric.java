...
//          beaconproperties.meshSummer = getS(sectfile, s, "MeshSummer");
            ...
            int i = (beaconproperties.meshSummer1 == null ? 1 : 0) + (beaconproperties.meshDesert1 == null ? 1 : 0) + (beaconproperties.meshWinter1 == null ? 1 : 0);
            if(i != 0 && i != 3)
            {
            ...
            if(sectfile.get(s, "PanzerHead", -9865.345F) == -9865.345F)
                ...
                beaconproperties.PANZER_HEAD = getF(sectfile, s, "PanzerHead", 0.001F, 9.999F);
            if(sectfile.get(s, "PanzerHeadTop", -9865.345F) == -9865.345F)
                beaconproperties.PANZER_HEAD_TOP = beaconproperties.PANZER_BODY_TOP;
            else
                beaconproperties.PANZER_HEAD_TOP = getF(sectfile, s, "PanzerHeadTop", 0.001F, 9.999F);
            ...
            beaconproperties.HITBY_MASK = f > 0.015F ? -2 : -1;
            Property.set(class1, "iconName", "icons/" + getS(sectfile, s, "Icon") + ".mat");
            Property.set(class1, "meshName", beaconproperties.meshSummer);
            if(sectfile.get(s, "IsBlindLandingBeacon", false))
                BeaconGeneric.bBlindLandingBeacon = true;
            try
            {
                if (class1 == Beacon.LorenzBLBeacon.class || class1 == Beacon.LorenzBLBeacon_LongRunway.class || class1 == Beacon.LorenzBLBeacon_AAIAS.class || BeaconGeneric.bBlindLandingBeacon)
//                if(class1 == (BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon == null ? (BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon = BeaconGeneric._mthclass$("com.maddox.il2.objects.vehicles.radios.Beacon$LorenzBLBeacon")) : BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon) || class1 == (BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon_LongRunway == null ? (BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon_LongRunway = BeaconGeneric._mthclass$("com.maddox.il2.objects.vehicles.radios.Beacon$LorenzBLBeacon_LongRunway")) : BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon_LongRunway) || class1 == (BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon_AAIAS == null ? (BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon_AAIAS = BeaconGeneric._mthclass$("com.maddox.il2.objects.vehicles.radios.Beacon$LorenzBLBeacon_AAIAS")) : BeaconGeneric.class$com$maddox$il2$objects$vehicles$radios$Beacon$LorenzBLBeacon_AAIAS) || BeaconGeneric.bBlindLandingBeacon)
                {
...
//            Object obj = null;
    ...
    private static void sampleMountains(Aircraft aircraft)
    {
        ...
        for(int i = 0; i < 10; i++)
        {
            ...
            float f4 = Math.abs(currentMntSampleRow - 25);
            ...
            currentMntSampleCol++;
            f = Math.abs(currentMntSampleCol - 25);
...
//        float f3 = 0.0F;
        ...
        if(flag)
        {
            ...
            float f9 = cvt(World.Sun().ToSun.z, -0.2F, 0.1F, 0.75F, 1.0F);
            if(World.Sun().ToSun.z > -0.1F && World.Sun().ToSun.z < 0.1F && Math.random() < 0.10000000000000001D)
                f9 += (float)Math.random() * 0.2F;
            float f11 = 1.0F - getConeOfSilenceMultiplier(d, d6);
            f1 = cvt((float)(d1 + (double)f5) * f9, 0.0F, 7000000F, 0.0F, 1.0F);
            f1 = f1 + f11 + floatindex(cvt((float)d * f9, 0.0F, 270000F, 0.0F, 6F), signalPropagationScale);
            if(f9 < 1.0F)
                nightError = cvt(f1, 0.65F, 1.0F, 0.0F, 1.0F);
            else
                nightError = 0.0F;
        } else
        if(flag2)
        {
            ...
            float f6 = cvt((float)d4, -10000F, 0.0F, 1.0F, 0.0F);
            f1 = f1 + f6 + floatindex(cvt((float)d, 0.0F, 190000F, 0.0F, 6F), signalPropagationScale);
        } else
        if(flag1)
        {
            float f7 = 0.0F;
            ...
            float f10 = cvt(World.Sun().ToSun.z, -0.2F, 0.2F, 0.4F, 1.0F);
            if(World.Sun().ToSun.z > -0.1F && World.Sun().ToSun.z < 0.1F && Math.random() < 0.20000000000000001D)
                f10 += (float)Math.random() * 0.3F;
            float f12 = 1.0F - getConeOfSilenceMultiplier(d, d7);
            f1 = cvt((float)(d1 + (double)f7) * f10, 0.0F, 6000000F, 0.0F, 1.0F);
            f1 = f1 + f12 + floatindex(cvt((float)d * f10, 0.0F, 300000F, 0.0F, 6F), signalPropagationScale);
            if(f10 < 1.0F)
                nightError = cvt(f1, 0.65F, 1.0F, 0.0F, 1.0F);
            else
                nightError = 0.0F;
    ...
    {
        double d2 = (double)f * Math.sin(d / 6371000D) * (double)(6371000F + f1);
        double d3 = d1 + 6371000D + (double)f * (Math.cos(d / 6371000D) * (double)(6371000F + f1) - d1 - 6371000D);
        double d4 = Math.sqrt(d2 * d2 + d3 * d3) - 6371000D;
        if(d4 > 0.0D)
            return d4;
        else
            return 0.0D;
    ...
    private void send_DeathCommand(Actor actor)
    {
        if(isNetMaster())
        {
            ...
            try
            {
                ...
                netmsgguaranted.writeNetObj(actor == null ? ((com.maddox.rts.NetObj) ((ActorNet)null)) : ((com.maddox.rts.NetObj) (actor.net)));
