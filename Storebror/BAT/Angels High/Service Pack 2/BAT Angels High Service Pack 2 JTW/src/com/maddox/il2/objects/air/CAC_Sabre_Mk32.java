...
public class CAC_Sabre_Mk32 extends F_86F implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit {
    ...
    static {
        ...
        try {
            Property.set(class1, "cockpitClass", new Class[] { Class.forName("CockpitF_86Flate") });
        ...
        try {
            ...
            a_lweaponslot[0] = new Aircraft._WeaponSlot(1, "MGunADEN30ki", 150);
            a_lweaponslot[1] = new Aircraft._WeaponSlot(1, "MGunADEN30ki", 150);
            a_lweaponslot[12] = new Aircraft._WeaponSlot(9, "PylonF86_Sidewinder", 1);
            a_lweaponslot[13] = new Aircraft._WeaponSlot(2, "RocketGunAIM9B", 1);
            a_lweaponslot[14] = new Aircraft._WeaponSlot(2, "RocketGunNull", 1);
            a_lweaponslot[15] = new Aircraft._WeaponSlot(9, "PylonF86_Sidewinder", 1);
