...
public class BombCargoBale extends Bomb {

    public BombCargoBale() {
        this.chute = null;
        this.bOnChute = false;
    }
    ...
    public void interpolateTick() {
        ...
        if (this.bOnChute) {
            ...
            this.setSpeed(v3d);
        } else if (super.curTm > this.ttcurTM) {
            this.bOnChute = true;
            this.chute = new Chute(this);
            this.chute.collide(false);
            this.chute.mesh().setScale(1.0F);
            this.chute.pos.setRel(new Point3d(-0.5D, 0.0D, -1.4D), new Orient(0.0F, 0.0F, 0.0F));
        }
    }
    ...
    static {
        Class class1 = BombCargoBale.class;
        Property.set(class1, "mesh", "3DO/Arms/CargoBale/mono.sim");
