...
public class Fuze_7_15 extends Fuze {
    static {
        Class localClass = com.maddox.il2.objects.weapons.Fuze_7_15.class;
...
//        float f1 = World.Rnd().nextFloat(7F, 15F);
//        float f2 = Math.round(f1);
//        Property.set(localClass, "fixedDelay", new float[] {
//            f2
//        });
        Property.set(localClass, "fixedDelay", new float[] { TrueRandom.nextInt(7, 15) });
    }
}
