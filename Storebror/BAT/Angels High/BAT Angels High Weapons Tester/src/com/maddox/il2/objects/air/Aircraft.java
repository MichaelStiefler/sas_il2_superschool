...
public abstract class Aircraft extends NetAircraft implements MsgCollisionListener, MsgCollisionRequestListener, MsgExplosionListener, MsgShotListener, MsgEndActionListener, Predator {
    ...
    protected static final String[][] Props              = { { "Prop1_D0", "PropRot1_D0", "Prop1_D1" }, { "Prop2_D0", "PropRot2_D0", "Prop2_D1" }, { "Prop3_D0", "PropRot3_D0", "Prop3_D1" }, { "Prop4_D0", "PropRot4_D0", "Prop4_D1" }, { "Prop5_D0", "PropRot5_D0", "Prop5_D1" }, { "Prop6_D0", "PropRot6_D0", "Prop6_D1" }, { "Prop7_D0", "PropRot7_D0", "Prop7_D1" }, { "Prop8_D0", "PropRot8_D0", "Prop8_D1" } };
    //Adds addition aircraft to ZBReceiver list
    static {
        planesWithZBReceiver = (new Class[] { com.maddox.il2.objects.air.F4U.class, com.maddox.il2.objects.air.F4F.class, com.maddox.il2.objects.air.TBF.class, com.maddox.il2.objects.air.SBD.class, com.maddox.il2.objects.air.PBYX.class, com.maddox.il2.objects.air.F6F.class, com.maddox.il2.objects.air.F2A2.class, com.maddox.il2.objects.air.SEAFIRE3.class, com.maddox.il2.objects.air.SEAFIRE3F.class, com.maddox.il2.objects.air.Fulmar.class, com.maddox.il2.objects.air.Swordfish.class, com.maddox.il2.objects.air.MOSQUITO.class, com.maddox.il2.objects.air.B_25.class, com.maddox.il2.objects.air.A_20.class, com.maddox.il2.objects.air.B_17.class, com.maddox.il2.objects.air.B_24.class, com.maddox.il2.objects.air.B_29.class, com.maddox.il2.objects.air.BEAU.class, com.maddox.il2.objects.air.P_80.class, com.maddox.il2.objects.air.P_39.class, com.maddox.il2.objects.air.P_51.class, com.maddox.il2.objects.air.P_47.class, com.maddox.il2.objects.air.P_40.class, com.maddox.il2.objects.air.P_38.class,
                com.maddox.il2.objects.air.P_36.class, com.maddox.il2.objects.air.A_20.class, com.maddox.il2.objects.air.C_47.class, com.maddox.il2.objects.air.P_80.class, com.maddox.il2.objects.air.TypeZBReceiver.class });
    }

    // TODO: Changed by SAS~Storebror: Dump any Weapon exception to logfile!
    private static String lastAirClass = "unknown";
    //---
    ...
    public static class _WeaponSlot {
        ...
        public _WeaponSlot(int i, String s, int j) throws Exception {
            ...
            // TODO: Changed by SAS~Storebror: Dump any Weapon exception to logfile!
            try {
                ObjIO.classForName("weapons." + s);
            } catch (Exception e) {
                System.out.println("Error Creating Weapons Slot! AirClass=" + lastAirClass + ", Trigger=" + i + ", Weapon=" + s + ", amount=" + j);
                e.printStackTrace();
            }
            this.clazz = ObjIO.classForName("weapons." + s);
            // ---
            this.bullets = j;
        }
    }
    ...
    public boolean cut(String s) {
        ...
        this.debugprintln("" + s + " goes off..");
        if (World.Rnd().nextFloat() < this.bailProbabilityOnCut(s)) {
            this.debugprintln("BAILING OUT - " + s + " gone, can't keep on..");
            this.hitDaSilk();
        }
        if (!this.isChunkAnyDamageVisible(s)) {
            this.debugprintln("" + s + " is already cut off - operation rejected..");
            return false;
        }
        int ai[] = this.hideSubTrees(s + "_D");
        if (ai == null) {
            return false;
        }
        for (int i = 0; i < ai.length; i++) {
            ...
            for (int l = 0; l < 4; l++) {
                if (this.hierMesh().chunkName().startsWith(this.FM.AS.astateEffectChunks[l + 0])) {
                    this.FM.AS.changeTankEffectBase(l, wreckage);
                }
            }

            for (int i1 = 0; i1 < this.FM.EI.getNum(); i1++) {
                if (this.hierMesh().chunkName().startsWith(this.FM.AS.astateEffectChunks[i1 + 4])) {
                    this.FM.AS.changeEngineEffectBase(i1, wreckage);
                    this.FM.AS.changeSootEffectBase(i1, wreckage);
                }
            }

            for (int j1 = 0; j1 < 6; j1++) {
                if (this.hierMesh().chunkName().startsWith(this.FM.AS.astateEffectChunks[j1 + 12])) {
                    this.FM.AS.changeNavLightEffectBase(j1, wreckage);
                }
            }

            for (int k1 = 0; k1 < 4; k1++) {
                if (this.hierMesh().chunkName().startsWith(this.FM.AS.astateEffectChunks[k1 + 18])) {
                    this.FM.AS.changeLandingLightEffectBase(k1, wreckage);
                }
            }

            for (int l1 = 0; l1 < this.FM.EI.getNum(); l1++) {
                if (this.hierMesh().chunkName().startsWith(this.FM.AS.astateEffectChunks[l1 + 22])) {
                    this.FM.AS.changeOilEffectBase(l1, wreckage);
                }
            }

            if (this.hierMesh().chunkName().startsWith(s) && (World.Rnd().nextInt(0, 99) < 50)) {
        ...
        ai = this.hierMesh().getSubTrees(s + "_D");
        for (int j = 0; j < ai.length; j++) {
            this.detachGun(ai[j]);
        }

        String s1 = s + "_CAP";
        if (this.hierMesh().chunkFindCheck(s1) >= 0) {
            this.hierMesh().chunkVisible(s1, true);
        }
        for (int k = 0; k < ai.length; k++) {
            for (int i2 = 3; i2 < this.FM.Gears.pnti.length; i2++) {
                try {
                    if ((this.FM.Gears.pnti[i2] != -1) && (ai[k] == this.hierMesh().chunkByHookNamed(this.FM.Gears.pnti[i2]))) {
                        this.FM.Gears.pnti[i2] = -1;
                    }
                } catch (Exception exception) {
                    System.out.println("FATAL ERROR: Gear pnti[] cut failed on tt[] = " + i2 + " - " + this.FM.Gears.pnti.length);
                }
            }

        }

        this.hierMesh().setCurChunk(ai[0]);
    ...
    public boolean cut_Subtrees(String s) {
        ...
        int i = this.hierMesh().chunkFindCheck(s + "_D0");
        if (i >= 0) {
            int j;
            for (j = 0; j <= 9; j++) {
                int k = this.hierMesh().chunkFindCheck(s + "_D" + j);
                if (k < 0) {
                    continue;
                }
                this.hierMesh().setCurChunk(k);
        ...
        for (int l = 0; l < ai.length; l++) {
            if (i < 0) {
                ...
                this.hierMesh().setCurChunk(ai[l]);
            }
            for (int k1 = 0; k1 < 4; k1++) {
                if (this.hierMesh().chunkName().startsWith(this.FM.AS.astateEffectChunks[k1 + 0])) {
                    this.FM.AS.changeTankEffectBase(k1, ((Actor) (obj)));
                }
            }

            for (int l1 = 0; l1 < 4; l1++) {
                if (this.hierMesh().chunkName().startsWith(this.FM.AS.astateEffectChunks[l1 + 4])) {
                    this.FM.AS.changeEngineEffectBase(l1, ((Actor) (obj)));
                    this.FM.AS.changeSootEffectBase(l1, ((Actor) (obj)));
                }
            }
        ...
        for (int j1 = 0; j1 < ai.length; j1++) {
            for (int i2 = 3; i2 < this.FM.Gears.pnti.length; i2++) {
                try {
                    if ((this.FM.Gears.pnti[i2] != -1) && (ai[j1] == this.hierMesh().chunkByHookNamed(this.FM.Gears.pnti[i2]))) {
                        this.FM.Gears.pnti[i2] = -1;
                    }
                } catch (Exception exception) {
                    System.out.println("FATAL ERROR: Gear pnti[] cut failed on tt[] = " + i2 + " - " + this.FM.Gears.pnti.length);
    ...
    protected boolean cutFM(int i, int j, Actor actor) {
        ...
        switch (i) {
            ...
            case 2: // '\002'
                if (this.isEnablePostEndAction(0.0D)) {
                    this.postEndAction(0.0D, actor, 2, null);
                }
                return false;
    ...
    protected void nextDMGLevel(String s, int i, Actor actor) {
        ...
        if (s4 == null) {
            if (!this.isNet() || this.isNetMaster()) {
                this.nextCUTLevel(s, i, actor);
            }
            return;
        } else {
            int l = this.part(s);
    ...
    protected void nextDMGLevels(int i, int j, String s, Actor actor) {
        ...
        if (this.isNet()) {
            if (this.isNetPlayer() && !World.cur().diffCur.Vulnerability) {
                return;
            }
            ...
            int k = this.part(s);
            if (!this.isNetMaster()) {
                this.netPutHits(true, null, i, j, k, actor);
            }
            this.netPutHits(false, null, i, j, k, actor);
            if ((actor != this) && this.FM.isPlayers() && (actor instanceof Aircraft) && ((Aircraft) actor).isNetPlayer() && (j != 0) && (i > 3)) {
                ...
                } else if (s.startsWith("Tail") && !this.FM.isSentBuryNote()) {
                    Chat.sendLogRnd(3, "gore_blowtail", (Aircraft) actor, this);
                }
            }
        }
        while (i-- > 0) {
            this.nextDMGLevel(s, j, actor);
        }
    }

    protected void nextCUTLevel(String s, int i, Actor actor) {
        this.FM.dryFriction = 1.0F;
        this.debugprintln("Detected NCL in " + s + "..");
        if ((this == World.getPlayerAircraft()) && !World.cur().diffCur.Vulnerability) {
            return;
        }
        int j = s.length() - 1;
        ...
        int k = this.part(s);
        if (this.cutFM(k, i, actor)) {
            this.FM.cut(k, i, actor);
            this.netPutCut(k, i, actor);
            if (this.FM.isPlayers() && (this != actor) && (actor instanceof Aircraft) && ((Aircraft) actor).isNetPlayer() && (i == 2) && !this.FM.isSentWingNote() && !this.FM.isSentBuryNote() && ((k == 34) || (k == 37) || (k == 33) || (k == 36))) {
    ...
    public boolean isEnablePostEndAction(double d) {
        ...
        long l = Time.current() + (int) (d * 1000D);
    ...
    public void postEndAction(double d, Actor actor, int i, Eff3DActor eff3dactor) {
        if (!this.isEnablePostEndAction(d)) {
            ...
            this.timePostEndAction = Time.current() + (int) (d * 1000D);
    ...
    public void msgEndAction(Object obj, int i) {
        ...
        if (this.isAlive()) {
            if (this.FM.isPlayers() && !this.FM.isSentBuryNote()) {
                switch (i) {
                    case 2: // '\002'
                        if (Actor.isAlive(endactionparam.initiator) && (endactionparam.initiator instanceof Aircraft) && ((Aircraft) endactionparam.initiator).isNetPlayer() && ((this.FM.Loc.z - Engine.land().HQ_Air(this.FM.Loc.x, this.FM.Loc.y)) > 100D)) {
            ...
            switch (i) {
                case 2: // '\002'
                    ...
                    this.doExplosion();
                    for (int j = 0; j < this.FM.AS.astateEngineStates.length; j++) {
                        this.FM.AS.hitEngine(this, j, 1000);
                    }

                    for (int k = 0; k < this.FM.AS.astateTankStates.length; k++) {
                        this.FM.AS.hitTank(this, k, 1000);
                    }

                    float f = cvt(this.FM.M.fuel, 100F, 2000F, 5F, 40F);
                    Actor actor1 = null;
                    String s = null;
                    if (this.FM.Gears.onGround() && (this.FM.Vrel.lengthSquared() < 70D)) {
                        f = 0.0F;
                    } else {
                        Point3d point3d = new Point3d(this.FM.Loc);
                        Point3d point3d1 = new Point3d(this.FM.Loc);
                        Point3d point3d2 = new Point3d();
                        this.FM.Vrel.set(this.FM.Vwld);
                        this.FM.Vrel.normalize();
                        this.FM.Vrel.scale(20D);
                        point3d1.add(this.FM.Vrel);
                        ...
                        if (Actor.isAlive(actor1) && (actor1 instanceof ActorHMesh)) {
                            ...
                            if ((actor1 instanceof BigshipGeneric) || (actor1 instanceof ShipGeneric)) {
                                float f4 = 0.018F * (float) this.FM.Vwld.length();
                                if (f4 > 1.0F) {
                                    f4 = 1.0F;
                                }
                                if (f4 < 0.1F) {
                                ...
                                float f5 = this.FM.M.fuel;
                                if (f5 > 300F) {
                                    f5 = 300F;
                                }
                                f = f4 * (50F + (0.7F * this.FM.CT.getWeaponMass()) + (0.3F * f5));
                            }
                        }
                    }
                    float f1 = 0.5F * f;
                    ...
                    MsgExplosion.send(actor1, s, this.FM.Loc, this, f, 0.9F * f, 0, f1);
                    MsgExplosion.send(actor1, s, this.FM.Loc, this, 0.5F * f, 0.25F * f, 1, f2);
                    // fall through
            ...
            for (; l < Math.min(this.FM.crew, 9); l++) {
                if (!this.FM.AS.isPilotDead(l)) {
                    this.FM.AS.hitPilot(this.FM.actor, l, 100);
                }
            }

            this.setDamager(endactionparam.initiator, 4);
            Actor actor = this.getDamager();
            World.onActorDied(this, actor, this.getAssister(actor));
        }
        MsgDestroy.Post(Time.current(), this);
    }

    protected void doExplosion() {
        if (this.FM.Loc.z < (Engine.cur.land.HQ_Air(this.FM.Loc.x, this.FM.Loc.y) + this.FM.Length / 2.0F)) {
            World.cur();
    ...
    public void msgCollisionRequest(Actor actor, boolean aflag[]) {
        ...
        if (actor instanceof BigshipGeneric) {
            ...
            if (flag && (((Time.tickCounter() + this.hashCode()) & 0xf) != 0)) {
                aflag[0] = false;
            }
        } else if (flag && ((Time.tickCounter() & 0xf) != 0) && (actor instanceof Aircraft) && this.FM.Gears.isUnderDeck()) {
            aflag[0] = !((Aircraft) actor).FM.Gears.isUnderDeck();
        }
        if (Engine.collideEnv().isDoCollision() && (actor instanceof Aircraft) && Mission.isCoop() && actor.isNetMirror() && (this.isMirrorUnderDeck() || this.FM.Gears.isUnderDeck() || (Time.tickCounter() <= 2))) {
            aflag[0] = false;
        }
    }
    ...
    public void msgCollision(Actor actor, String s, String s1) {
        ...
        if (actor instanceof ActorCrater) {
            ...
            if ((this.netUser() != null) && (this.netUser() == ((ActorCrater) actor).netOwner)) {
                return;
            }
        }
        ...
        if (actor instanceof Wreckage) {
            ...
            if ((this.netUser() != null) && (this.netUser() == ((Wreckage) actor).netOwner)) {
                return;
            } else {
                actor.collide(false);
                this.nextDMGLevels(3, 0, s, this);
                return;
            }
        }
        if (actor instanceof Paratrooper) {
            ...
            if (Vd.length() > 30D) {
                ...
                this.nextDMGLevels(4, 0, s, actor);
            }
            return;
        }
        if ((actor instanceof RocketryRocket) && s1.startsWith("Wing")) {
            ...
            vector3d.set(0.0D, flag ? this.hierMesh().collisionR() : -this.hierMesh().collisionR(), 0.0D);
            ...
            vector3d.z += (flag ? 1.0D : -1D) * this.FM.getW().x * this.hierMesh().collisionR();
        ...
        if (this.FM.turnOffCollisions && (s.startsWith("Wing") || s.startsWith("Arone") || s.startsWith("Keel") || s.startsWith("Rudder") || s.startsWith("Stab") || s.startsWith("Vator") || s.startsWith("Nose") || s.startsWith("Tail"))) {
            return;
        }
        if ((actor instanceof Aircraft) && Actor.isValid(actor) && (this.getArmy() == actor.getArmy())) {
            ...
            if (((this.FM.Loc.z - 2.0F * this.FM.Gears.H) < d) && ((aircraft.FM.Loc.z - 2.0F * aircraft.FM.Gears.H) < d)) {
                this.setDamagerExclude(actor);
            }
        }
        if ((s != null) && (this.hierMesh().chunkFindCheck(s) != -1)) {
            this.hierMesh().setCurChunk(s);
            this.hierMesh().getChunkLocObj(tmpLoc1);
            Vd.set(this.FM.Vwld);
            this.FM.Or.transformInv(Vd);
            Vd.normalize();
            Vd.negate();
            Vd.scale(2000F / this.FM.M.mass);
    ...
    private void splintersHit(Explosion explosion) {
        ...
        for (int k = 0; k < i; k++) {
            ...
            if (d > f) {
                tmpP1.interpolate(tmpP1, tmpP2, 1.0D - (f / d));
            }
            tmpP2.interpolate(tmpP1, tmpP2, 2D);
            int j = this.hierMesh().detectCollisionLineMulti(tmpLocExp, tmpP1, tmpP2);
            if (j <= 0) {
                continue;
            }
            ...
            this.hierMesh();
            shot.p.interpolate(tmpP1, tmpP2, Mesh.collisionDistMulti(0));
    ...
    public void msgExplosion(Explosion explosion) {
        ...
        if (explosion.chunkName != null) {
            ...
            if (explosion.chunkName.startsWith("Wing") && (explosion.power > 0.0025F)) {
                if (explosion.chunkName.startsWith("WingL")) {
                    ...
                    this.FM.AS.setFMSFX(explosion.initiator, 2, (int) (explosion.power * 20000F));
                }
                if (explosion.chunkName.startsWith("WingR")) {
                    this.debugprintln("Large Shockwave Hits the Right Wing - Wing Stalls.");
                    this.FM.AS.setFMSFX(explosion.initiator, 3, (int) (explosion.power * 20000F));
                }
            }
        }
        float f2;
        ...
        this.debugprintln("Splash hit from " + ((explosion.initiator instanceof Aircraft) ? ((Aircraft) explosion.initiator).typedName() : explosion.initiator.name()) + " in " + explosion.chunkName + " for " + (int) ((100F * f2) / (0.01F + (3F * this.FM.Sq.getToughness(this.part(explosion.chunkName))))) + " % ( " + f2 + " kg)..");
        if (explosion.chunkName == null) {
            f2 /= 0.01F;
        } else {
            if (explosion.chunkName.endsWith("_D0") && !explosion.chunkName.startsWith("Gear")) {
                if (f2 > 0.01F) {
                    f2 = 1.0F + ((f2 - 0.01F) / this.FM.Sq.getToughness(this.part(explosion.chunkName)));
                } else {
                    f2 /= 0.01F;
                }
            } else {
                f2 /= this.FM.Sq.getToughness(this.part(explosion.chunkName));
            }
            f2 += this.FM.Sq.eAbsorber[this.part(explosion.chunkName)];
        }
        if (f2 >= 1.0F) {
            this.setDamager(explosion.initiator, (int) f2);
        }
        if (explosion.chunkName != null) {
            if ((int) f2 > 0) {
                this.setDamager(explosion.initiator, 1);
                if (explosion.chunkName.startsWith("Pilot")) {
                    this.killPilot(explosion.initiator, explosion.chunkName.charAt(5) - 49);
                    return;
                }
                if (explosion.chunkName.startsWith("Head")) {
                    this.killPilot(explosion.initiator, explosion.chunkName.charAt(4) - 49);
                    return;
                }
            }
            this.nextDMGLevels((int) f2, 1, explosion.chunkName, explosion.initiator);
        } else {
            int i = 0;
            do {
                ...
                if (this.isChunkAnyDamageVisible(partNamesForAll[l])) {
                    this.nextDMGLevels((int) f2, 1, partNamesForAll[l] + "_D0", explosion.initiator);
                    break;
                }
                i++;
            } while (true);
        ...
        if (explosion.chunkName != null) {
            this.FM.Sq.eAbsorber[this.part(explosion.chunkName)] = f2 - (int) f2;
        }
        if (f2 > 8F) {
            if ((f2 / partNamesForAll.length) > 1.5F) {
                for (int j = 0; j < partNamesForAll.length; j++) {
                    if (this.isChunkAnyDamageVisible(partNamesForAll[j])) {
                        this.nextDMGLevels(3, 1, partNamesForAll[j] + "_D0", explosion.initiator);
                    }
                }
                ...
                for (int i1 = 0; i1 < k; i1++) {
                    ...
                    if (this.isChunkAnyDamageVisible(partNamesForAll[j1])) {
                        this.nextDMGLevels(3, 1, partNamesForAll[j1] + "_D0", explosion.initiator);
                    }
                }
    ...
    protected void setExplosion(Explosion explosion) {
        ...
        if ((explosion.chunkName == null) && !this.isChunkAnyDamageVisible("CF")) {
            explosion.chunkName = partNames[43];
        }
        if (bWasAlive) {
            bWasAlive = !this.FM.isTakenMortalDamage();
    ...
    public void msgShot(Shot shot) {
        ...
        if (shot.chunkName != null) {
            if (shot.chunkName == partNames[43]) {
                ...
                if (shot.chunkName.startsWith("Wing") && (shot.chunkName.endsWith("_D3") || (shot.chunkName.endsWith("_D2") && (this.FM.Skill >= 2)))) {
                    this.FM.setCapableOfACM(false);
                }
                if ((this.FM instanceof Pilot) && (World.Rnd().nextInt(-1, 8) < this.FM.Skill)) {
                    ((Pilot) this.FM).setAsDanger(shot.initiator);
                }
                if (Config.isUSE_RENDER() && (this.FM instanceof RealFlightModel)) {
                    _tmpPoint.set(this.pos.getAbsPoint());
                    _tmpPoint.sub(shot.p);
                    this.msgSndShot(shot.mass, _tmpPoint.x, _tmpPoint.y, _tmpPoint.z);
                }
                shot.bodyMaterial = 2;
                if (this.isNetPlayer()) {
                ...
                if (tmpBonesHit > 0) {
                    ...
                    for (int i = 0; i < tmpBonesHit; i++) {
                        ...
                        if (shot.power > 0.0F) {
                            ...
                            if (this.FM.CT.bHasGearControl && (string.toLowerCase().startsWith("xgear") || string.toLowerCase().startsWith("gear")) && (this.getEnergyPastArmor(2.0F, shot) > 0.0F) && (shot.power > 2500.0F)) {
                                int i_76_ = -1;
                                String string_77_ = "";
                                if (string.toLowerCase().startsWith("x")) {
                                    string_77_ = string.substring(5, 6).toUpperCase();
                                } else {
                                    string_77_ = string.substring(4, 5).toUpperCase();
                                }
                                int i_78_ = 0;
                                int i_79_ = World.Rnd().nextInt(0, 150);
                                if (this.FM.CT.getGear() > 0.99) {
                                    if (i_79_ < 5) {
                                        i_78_ = 8;
                                    } else if (i_79_ < 10) {
                                        i_78_ = 7;
                                ...
                                if (((i_76_ == 0) || (i_76_ == 1)) && (i_79_ > 99) && (this.chunkDamageVisible("WingLIn") > 1) && (this.chunkDamageVisible("WingRIn") > 1)) {
                                    this.FM.AS.hitGear(shot.initiator, 0, 4);
                                    this.FM.AS.hitGear(shot.initiator, 1, 4);
                                } else if (i_78_ != 0) {
                                    if (shot.power > 40000.0F) {
                                        i_76_ += 3;
                                    }
                                    if (i_78_ == 8) {
                                        if (World.Rnd().nextFloat() < 0.5) {
                                            this.FM.AS.hitGear(shot.initiator, 1, 8);
                                            this.FM.AS.hitGear(shot.initiator, 0, 8);
                                        } else {
                                            this.FM.AS.hitGear(shot.initiator, i_76_, i_78_);
                                        }
                                    } else {
                                        this.FM.AS.hitGear(shot.initiator, i_76_, i_78_);
                                    }
                ...
                if (bool) {
                    ...
                    Shot shot_80_ = shot;
                    this.hierMesh();
                    shot_80_.chunkName = Mesh.collisionNameMulti(0, 0);
                    ...
                    this.debugprintln("Bullet hit from " + (shot.initiator instanceof Aircraft ? ((Aircraft) shot.initiator).typedName() : shot.initiator.name()) + " in " + shot.chunkName + " for " + (int) ((100.0F * f) / (0.01F + (3.0F * (this.FM.Sq.getToughness(this.part(shot.chunkName)))))) + " %..");
                    shot.bodyMaterial = 2;
                    if ((this.FM instanceof Pilot) && (World.Rnd().nextInt(-1, 8) < this.FM.Skill)) {
                        ((Pilot) this.FM).setAsDanger(shot.initiator);
                    }
    ...
    protected void hitChunk(String s, Shot shot) {
        if (s.lastIndexOf("_") == -1) {
            s = s + "_D" + this.chunkDamageVisible(s);
        }
        float f = shot.powerToTNT();
        if (s.endsWith("_D0") && !s.startsWith("Gear")) {
            if (f > 0.01F) {
                f = 1.0F + ((f - 0.01F) / this.FM.Sq.getToughness(this.part(s)));
            } else {
                f /= 0.01F;
            }
        } else {
            f /= this.FM.Sq.getToughness(this.part(s));
        }
        f += this.FM.Sq.eAbsorber[this.part(s)];
        int i = (int) f;
        this.FM.Sq.eAbsorber[this.part(s)] = f - i;
        if (i > 0) {
            this.setDamager(shot.initiator, i);
        }
        this.nextDMGLevels(i, 2, s, shot.initiator);
    }
    ...
    protected void hitFlesh(int i, Shot shot, int j) {
        ...
        this.debuggunnery("*** Pilot " + i + " hit for " + k + "% (" + (int) shot.power + " J)");
        this.FM.AS.hitPilot(shot.initiator, i, k);
    ...
    protected float getEnergyPastArmor(float f, float f1, Shot shot) {
        shot.power -= (shot.powerType != 0 ? 1.0F : 2.0F) * (f * 1700F * Math.cos(f1));
        return shot.power;
    }
    ...
    protected float getEnergyPastArmor(double d, float f, Shot shot) {
        shot.power -= (shot.powerType != 0 ? 1.0F : 2.0F) * (d * 1700D * Math.cos(f));
        return shot.power;
    }

    protected float getEnergyPastArmor(double d, Shot shot) {
        shot.power -= (shot.powerType != 0 ? 1.0F : 2.0F) * (d * 1700D);
        return shot.power;
    }

    public static boolean isArmorPenetrated(double d, Shot shot) {
        return shot.power > ((shot.powerType != 0 ? 1.0F : 2.0F) * (d * 1700D));
    }

    protected void netHits(int i, int j, int k, Actor actor) {
        if (this.isNetMaster()) {
            this.setDamager(actor, i);
        }
        while (i-- > 0) {
            this.nextDMGLevel(partNames[k] + "_D0", j, actor);
        }
    }
    ...
    protected void addGun(BulletEmitter bulletemitter, int i) {
        ...
        this.FM.CT.Weapons[i] = abulletemitter1;
    ...
    public void detachGun(int i) {
        ...
        for (int j = 0; j < this.FM.CT.Weapons.length; j++) {
            ...
            for (int k = 0; k < abulletemitter.length; k++) {
                abulletemitter[k] = abulletemitter[k].detach(this.hierMesh(), i);
            }
    ...
    public void updateLLights() {
        ...
        if (this.lLight == null) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                this.lLight[i].setColor(0.4941176F, 0.9098039F, 0.9607843F);
        ...
        for (int j = 0; j < 4; j++) {
            if (this.FM.AS.astateLandingLightEffects[j] != null) {
                ...
                this.lLightHook[j].computePos(this, _tmpLoc, lLightLoc1);
    ...
    public void update(float f) {
        ...
        if (controls.bHasGearControl) {
            ...
            if (Math.abs(this.GearL_ - f6) > 0.003F) {
                ...
                this.moveGear(this.GearL_ = f6, this.GearR_ = f7, this.GearC_ = f8);
            } else if (Math.abs(this.GearR_ - f7) > 0.003F) {
                if (!(this instanceof I_16)) {
                ...
                this.moveGear(this.GearL_ = f6, this.GearR_ = f7, this.GearC_ = f8);
            } else if (Math.abs(this.GearC_ - f8) > 0.003F) {
                if (!(this instanceof I_16)) {
        ...
        if (controls.bHasArrestorControl) {
            ...
            if (Math.abs(this.arrestor_ - f1) > 0.003F) {
                this.moveArrestorHook(this.arrestor_ = f1);
            }
        }
        if (controls.bHasWingControl) {
            float f2 = controls.getWing();
            if (Math.abs(this.wingfold_ - f2) > 0.0005F) {
                this.moveWingFold(this.wingfold_ = f2);
            }
        }
        if (controls.bHasCockpitDoorControl) {
            float f3 = controls.getCockpitDoor();
            if (Math.abs(this.cockpitDoor_ - f3) > 0.0005F) {
                this.moveCockpitDoor(this.cockpitDoor_ = f3);
            }
        }
        if (controls.bHasFlapsControl) {
            float f4 = controls.getFlap();
            if (Math.abs(this.Flap_ - f4) > 0.003F) {
                if (Math.abs(f4 - controls.FlapsControl) <= 0.003F) {
                    this.sfxFlaps(false);
                } else {
                    this.sfxFlaps(true);
                }
                this.moveFlap(this.Flap_ = f4);
            }
        }
        //TODO: Variable Wing Control
        if (controls.bHasVarWingControl) {
            float f_102x_ = controls.getVarWing();
            if (Math.abs(this.VarWing_ - f_102x_) > EpsSmooth_) {
                if (Math.abs(f_102x_ - controls.VarWingControl) <= EpsSmooth_) {
                    this.sfxFlaps(false);
                } else {
                    this.sfxFlaps(true);
                }
                this.moveVarWing(this.VarWing_ = f_102x_);
            }
        }
        float f5 = controls.getRudder();
        if (Math.abs(this.Rudder_ - f5) > 0.03F) {
            this.moveRudder(this.Rudder_ = f5);
        }
        f5 = controls.getElevator();
        if (Math.abs(this.Elevator_ - f5) > 0.03F) {
            this.moveElevator(this.Elevator_ = f5);
        }
        f5 = controls.getAileron();
        if (Math.abs(this.Aileron_ - f5) > 0.03F) {
            this.moveAileron(this.Aileron_ = f5);
        }
        f5 = controls.getBayDoor();
        if (Math.abs(this.BayDoor_ - f5) > 0.025F) {
            this.BayDoor_ += 0.025F * (f5 <= this.BayDoor_ ? -1F : 2.0F);
            this.moveBayDoor(this.BayDoor_);
        }
        f5 = controls.getAirBrake();
        if (Math.abs(this.AirBrake_ - f5) > 0.003F) {
            this.moveAirBrake(this.AirBrake_ = f5);
        ...
        if (Math.abs(this.Refuel_ - f5) > EpsSmooth_) {
            this.moveRefuel(this.Refuel_ = f5);
            if (Math.abs(this.Refuel_ - 0.5F) >= 0.48F) {
                this.sfxAirBrake();
            }
        }
        // TODO: Added for catapult launch bar on the nose gear
        f5 = controls.getCatLaunchBar();
        if (Math.abs(this.CatLaunchBar_ - f5) > EpsSmooth_) {
            this.moveCatLaunchBar(this.CatLaunchBar_ = f5);
        }
        f5 = this.FM.Gears.getSteeringAngle();
        if (Math.abs(this.Steering_ - f5) > 0.003F) {
            this.moveSteering(this.Steering_ = f5);
        }
        ...
        if (Mission.isSingle()) {
            if (this == World.getPlayerAircraft()) {
                ...
                if (realflightmodel.isRealMode() && this.isAircraftTaxing()) {
            ...
            if (Mission.isServer() && this.isNetPlayer() && this.isAircraftTaxing()) {
                Maneuver.updateCollisionMap(this.FM);
            }
        }
    }

    public void setFM(int i, boolean flag) {
        this.setFM(Property.stringValue(this.getClass(), "FlightModel", null), i, flag);
    }
    ...
    public void setFM(String s, int i, boolean flag) {
        ...
        switch (i) {
            ...
            case 1: // '\001'
                this.FM = new RealFlightModel(s);
                break;

            case 2: // '\002'
                this.FM = new FlightModel(s);
                this.FM.AP = new Autopilotage();
                break;
        }
        this.FM.actor = this;
        this.FM.AS.set(this, flag && !NetMissionTrack.isPlaying());
        this.FM.EI.setNotMirror(flag && !NetMissionTrack.isPlaying());
        ...
        if (s1.compareToIgnoreCase("PNEUMATIC") == 0) {
            byte0 = 0;
        } else if (s1.compareToIgnoreCase("ELECTRIC") == 0) {
            byte0 = 1;
        } else if (s1.compareToIgnoreCase("HYDRAULIC") == 0) {
            byte0 = 2;
        } else {
    ...
    public Aircraft() {
        this.spawnLocSingleCoop = null;
        this.spawnActorName = null;
        this.stationarySpawnLocSet = false;
        this.timePostEndAction = -1L;
        this.buried = false;
        this.BayDoor_ = 0.0F;
        this.AirBrake_ = 0.0F;
        this.Steering_ = 0.0F;
    ...
    public void prepareCamouflage() {
        ...
        prepareMeshCamouflage(s, this.hierMesh(), this.getClass(), this.getRegiment());
    }
    ...
    public void load(SectFile sectfile, String s, int i, NetChannel netchannel, int j) throws Exception {
            ...
            if (k >= 0) {
                ...
                do {
                    ...
                    if (s4.equals(s1) && s6.startsWith("vehicles.planes.Plane")) {
                        ...
                        this.spawnLocSingleCoop = new Loc(d, d1, 0.0D, f, 0.0F, 0.0F);
                        break;
                    }
                    j1++;
                } while (true);
        ...
        if (sectfile.exist(s, "Skill" + i)) {
            this.FM.setSkill(sectfile.get(s, "Skill" + i, 1));
        } else {
            this.FM.setSkill(sectfile.get(s, "Skill", 1));
        }
        this.FM.M.fuel = sectfile.get(s, "Fuel", 100F, 0.0F, 100F) * 0.01F * this.FM.M.maxFuel;
        if (sectfile.exist(s, "numberOn" + i)) {
            this.bPaintShemeNumberOn = sectfile.get(s, "numberOn" + i, 1, 0, 1) == 1;
        }
        this.FM.AS.bIsEnableToBailout = sectfile.get(s, "Parachute", 1, 0, 1) == 1;
        if (Mission.isServer()) {
        ...
        if (i1 >= 0) {
            ...
            for (int l1 = 0; l1 < k1; l1++) {
                ...
                if (obj instanceof BulletEmitter) {
                    ...
                    this.addGun(bulletemitter, j2);
                }
            }

        } else {
            this.thisWeaponsName = sectfile.get(s, "weapons", (String) null);
            if (this.thisWeaponsName != null) {
                this.weaponsLoad(this, this.thisWeaponsName);
            }
        }
        if (this == World.getPlayerAircraft()) {
            this.createCockpits();
        ...
        this.FM.Gears.zutiCheckPlaneForSkisAndWinterCamo(this.getClass().toString());
    }
    ...
    public int HitbyMask() {
        try {
            return this.FM.Vwld.length() >= 2D ? -25 : -1;
    ...
    public int chooseShotpoint(BulletProperties bulletproperties) {
        return !this.FM.isTakenMortalDamage() ? 0 : -1;
    }
    ...
    public static void weapons(Class class1) {
        // TODO: Changed by SAS~Storebror: Dump any Weapon exception to logfile!
        lastAirClass = class1.getName();
        //---
        try {
            int i = Finger.Int("ce" + class1.getName() + "vd");
            BufferedReader bufferedreader2 = new BufferedReader(new InputStreamReader(new KryptoInputFilter(new SFSInputStream(Finger.LongFN(0L, "cod/" + Finger.incInt(i, "adt"))), getSwTbl(i))));

            // TODO: Added by SAS~Storebror, dump cod'ded weapon files if found!
            try {
                new File(HomePath.toFileSystemName("extract/cod", 0)).mkdirs();
                PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(HomePath.toFileSystemName("extract/cod/" + class1.getName().substring(class1.getName().lastIndexOf('.') + 1), 0))));
                String bufferedreader2Line = null;
                while ((bufferedreader2Line = bufferedreader2.readLine()) != null) {
                    pw.println(bufferedreader2Line);
                }
                pw.close();
...
//		    exception.printStackTrace(); // Show Errors on weapon slot creation, don't hide cod'ded weapon errors from BAT devs!
        }
    }
    ...
    public static int[] getWeaponTriggersRegistered(Class class1) {
        return (int[]) Property.value(class1, "weaponTriggers", null);
    }
    ...
    public static String[] getWeaponHooksRegistered(Class class1) {
        return (String[]) Property.value(class1, "weaponHooks", null);
    }
    ...
    public static _WeaponSlot[] getWeaponSlotsRegistered(Class class1, String s) {
        HashMapInt hashmapint = weaponsMapProperty(class1);
        return (_WeaponSlot[]) hashmapint.get(Finger.Int(s));
    }
    ...
    protected void weaponsLoad(Aircraft aircraft, String s) throws Exception {
        ...
        if (!hashmapint.containsKey(i)) {
            ...
            this.weaponsLoad(aircraft, i, hashmapint);
            return;
        }
    }
    ...
    protected void weaponsLoad(Aircraft aircraft, int i, HashMapInt hashmapint) throws Exception {
        ...
        for (int j = 0; j < as.length; j++) {
            ...
            if (aircraft.mesh().hookFind(as[j]) != -1) {
                ...
                } else if (a_lweaponslot[j].bullets == -12345) {
                    bulletemitter.loadBullets();
                } else {
                    ...
                    case 0: // '\0'
                        if (bulletemitter instanceof MGunAircraftGeneric) {
                            if (World.getPlayerAircraft() == aircraft) {
                                ...
                                ((MGunAircraftGeneric) bulletemitter).setConvDistance(this.FM.convAI + (this.FM.convAI * 0.25F), Property.floatValue(aircraft.getClass(), "LOSElevation", 0.75F));
                            }
                        }
                        break;
                    ...
                    case 1: // '\001'
                        if (bulletemitter instanceof MGunAircraftGeneric) {
                            if (World.getPlayerAircraft() == aircraft) {
                                ...
                                ((MGunAircraftGeneric) bulletemitter).setConvDistance(this.FM.convAI, Property.floatValue(aircraft.getClass(), "LOSElevation", 0.75F));
                            }
                        }
                        break;
    ...
    public void missionStarting() {
        ...
        // +++ Select Bomb mod
        if (this.FM.CT.bHasBombSelect) {
            this.FM.CT.registerBombs();
        }
        // --- Select Bomb mod
        if (this == World.getPlayerAircraft()) {
            return;
            ...
            for (int j = 0; j < abulletemitter.length; j++) {
                ...
                if (flag) {
                    ...
                    if (Mission.isCoop()) {
                        ...
                        this.FM.AS.replicateFuzeStatesToNet(k, 1, f);
                    }
                } else {
    ...
    public void createCockpits() {
        ...
        this.deleteCockpits();
        Object obj = Property.value(this.getClass(), "cockpitClass");
        if (obj == null) {
            return;
        }
    ...
    public boolean isChunkAnyDamageVisible(String s) {
        ...
        for (int i = 0; i < 4; i++) {
            if ((this.hierMesh().chunkFindCheck(s + i) != -1) && this.hierMesh().isChunkVisible(s + i)) {
                return true;
            }
        }
    ...
    public void hitDaSilk() {
        ...
        if ((this.FM.Loc.z - Engine.land().HQ_Air(this.FM.Loc.x, this.FM.Loc.y)) > 20D) {
    ...
    protected void doRemoveBodyChunkFromPlane(String s) {
        if (this.hierMesh().chunkFindCheck(s + "_D0") != -1) {
            this.hierMesh().chunkVisible(s + "_D0", false);
        }
        if (this.hierMesh().chunkFindCheck(s + "_D1") != -1) {
            this.hierMesh().chunkVisible(s + "_D1", false);
        }
    }
    ...
    public void onAircraftLoaded() {
        ...
        // +++ Import from 4.13.2m
        this.FM.CT.setBombModeDefaults();
        this.FM.CT.setWeaponFireModeDefaults();
        // --- Import from 4.13.2m
    }
    ...
    protected void debugprintln(String s) {
        if (World.cur().isDebugFM()) {
            System.out.println("<" + this.name() + "> (" + this.typedName() + ") " + s);
        }
    }
    ...
    public void debuggunnery(String s) {
        if (World.cur().isDebugFM()) {
            System.out.println("<" + this.name() + "> (" + this.typedName() + ") *** BULLET *** : " + s);
        }
    }
    ...
    protected float bailProbabilityOnCut(String s) {
        ...
        if (s.startsWith("StabL") && !this.isChunkAnyDamageVisible("VatorR")) {
            return 0.99F;
        }
        if (s.startsWith("StabR") && !this.isChunkAnyDamageVisible("VatorL")) {
            return 0.99F;
        }
        if (s.startsWith("Stab")) {
            return 0.33F;
        }
        if (s.startsWith("VatorL") && !this.isChunkAnyDamageVisible("VatorR")) {
            return 0.99F;
        }
        if (s.startsWith("VatorR") && !this.isChunkAnyDamageVisible("VatorL")) {
            return 0.99F;
        }
    ...
    public CellAirPlane getCellAirPlane() {
        ...
        cellairplane = (CellAirPlane) Property.value(this.getClass(), "CellObject", (Object) null);
        if (cellairplane == null) {
            tmpLocCell.set(0.0D, 0.0D, this.FM.Gears.H, 0.0F, this.FM.Gears.Pitch, 0.0F);
            cellairplane = new CellAirPlane(new com.maddox.il2.ai.air.CellObject[1][1], this.hierMesh(), tmpLocCell, 1.0D);
    ...
    public float getWheelWidth(int i) {
        float f = cvt(this.FM.Wingspan, 10F, 40F, 0.12F, 0.42F);
        if (i == 2) {
            f = (float) (f * 0.59999999999999998D);
        }
        return f;
    }
    ...
    public boolean hasIntervalometer() {
        if (!World.cur().diffCur.Limited_Ammo) {
            ...
            return this.FM.actor instanceof TypeBomber;
        }
    }
    ...
    public int getBombTrainMaxAmount() {
        return this.FM.CT.getWeaponCount(3);
    }
    // --- Import from 4.13.2m
}
