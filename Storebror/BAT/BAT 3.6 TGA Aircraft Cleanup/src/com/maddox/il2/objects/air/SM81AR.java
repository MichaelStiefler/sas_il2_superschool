...
public class SM81AR extends SM81x implements TypeBomber, TypeTransport {
    ...
    static {
        Class class1 = SM81AR.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SM81");
        Property.set(class1, "meshName", "3DO/Plane/SM81/hierAR.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar01());
        Property.set(class1, "yearService", 1936.8F);
        Property.set(class1, "yearExpired", 1944.5F);
        Property.set(class1, "FlightModel", "FlightModels/SM81AR.fmd:SM81AR_FM");
