...
public class Zeppelin_P extends Dirigeable {
    ...
    static {
        Class class1 = Zeppelin_P.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Zeppelin");
        Property.set(class1, "meshName", "3DO/Plane/Zeppelin_P/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitZeppelin_P.class });
