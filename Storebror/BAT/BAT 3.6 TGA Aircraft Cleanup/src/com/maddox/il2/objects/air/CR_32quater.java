...
public class CR_32quater extends Scheme1 implements TypeFighter, TypeTNBFighter {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("2_")) {
            this.hierMesh().chunkVisible("Cassette_D0", true);
            return;
        } else {
            return;
        }
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.startsWith("xxspar")) {
                    ...
                    if (s.startsWith("xxspart") && (this.chunkDamageVisible("Tail1") > 2) && (this.getEnergyPastArmor(3.5F / (float) Math.sqrt((((Tuple3d) (Aircraft.v1)).y * Aircraft.v1.y) + (Aircraft.v1.z * Aircraft.v1.z)), shot) > 0.0F)) {
