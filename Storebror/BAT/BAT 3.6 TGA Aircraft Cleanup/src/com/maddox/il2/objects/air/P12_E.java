...
public class P12_E extends Scheme1 implements TypeFighter {
    ...
    static {
        Class class1 = P12_E.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "P12");
        Property.set(class1, "meshName", "3DO/Plane/P-12E(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar02());
        Property.set(class1, "yearService", 1931F);
        Property.set(class1, "yearExpired", 1941F);
        Property.set(class1, "FlightModel", "FlightModels/P12.fmd:P12_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitP12_E.class });
