...
public class FiatBr20Early extends FiatBr2x implements TypeBomber, TypeTransport {

    public FiatBr20Early() {
    }
    ...
    static {
        Class class1 = FiatBr20Early.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Br.20");
        Property.set(class1, "meshName", "3DO/Plane/FiatBr20/hierE.him");
