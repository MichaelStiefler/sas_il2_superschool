...
public class Ba65TK extends Ba_65xyz {
    ...
    protected void moveGear(float f) {
        Ba65TK.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Ba65TK.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ba65");
        Property.set(class1, "meshName", "3DO/Plane/Ba65/hierTK.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_it", "3DO/Plane/Ba65/hierTK.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/Ba65TK.fmd:Ba65TK_FM");
