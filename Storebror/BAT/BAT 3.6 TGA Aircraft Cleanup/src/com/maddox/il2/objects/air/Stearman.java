...
public class Stearman extends U_2 implements TypeStormovik {
    ...
    static {
        Class class1 = Stearman.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Stearman");
        Property.set(class1, "meshName", "3DO/Plane/Stearman/hier.him");
