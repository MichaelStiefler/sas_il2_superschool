...
public class He_111A extends He111ABE implements TypeBomber, TypeTransport {
    ...
    static {
        Class class1 = He_111A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "He-111");
        Property.set(class1, "meshName", "3DO/Plane/He111ABE/hierA.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar01());
        Property.set(class1, "yearService", 1937.8F);
        Property.set(class1, "yearExpired", 1943.5F);
        Property.set(class1, "FlightModel", "FlightModels/He111A.fmd:He111ABE_FM");
