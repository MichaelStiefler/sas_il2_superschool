...
public class TB_1_ANT4 extends TB_3 {
    ...
    static void tb1InitStatic(Class aircraftClass) {
        new NetAircraft.SPAWN(aircraftClass);
        Property.set(aircraftClass, "iconFar_shortClassName", "ANT4");
        Property.set(aircraftClass, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(aircraftClass, "yearService", 1932F);
        Property.set(aircraftClass, "yearExpired", 1945.5F);
        Property.set(aircraftClass, "FlightModel", "FlightModels/TB_1_ANT_4.fmd:ANT4_FM");
        Property.set(aircraftClass, "cockpitClass", new Class[] { CockpitANT_4T.class, CockpitANT_4T_Bombardier.class });
        Property.set(aircraftClass, "weaponsList", new ArrayList());
        Property.set(aircraftClass, "weaponsMap", new HashMapInt());
        Aircraft.weaponTriggersRegister(aircraftClass, new int[] { 10, 10, 11, 11, 12, 12, 9, 9, 9, 9, 3, 3, 3, 3, 3, 3, 3, 3, 9, 9, 9, 9, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(aircraftClass, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalDev04", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08", "_ExternalDev05", "_ExternalDev06", "_ExternalDev07", "_ExternalDev08", "_ExternalBomb09", "_ExternalBomb10", "_ExternalBomb11", "_ExternalBomb12", "_BombSpawn01", "_BombSpawn02" });
    }
    ...
    static {
        ...
        Property.set(class1, "meshName", "3DO/Plane/TB_1_ANT4/hier.him");
    }
}
