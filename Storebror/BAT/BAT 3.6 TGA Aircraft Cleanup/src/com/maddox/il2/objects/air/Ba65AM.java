...
public class Ba65AM extends Ba_65A {
    ...
    protected void moveGear(float f) {
        Ba65AM.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Ba65AM.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ba65M");
        Property.set(class1, "meshName", "3DO/Plane/Ba65/hierAM.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_it", "3DO/Plane/Ba65/hierAM.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/BA65MA.fmd:Ba65MA_FM");
