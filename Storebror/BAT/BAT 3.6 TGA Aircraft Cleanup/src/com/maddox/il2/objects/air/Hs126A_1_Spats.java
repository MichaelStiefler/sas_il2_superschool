...
public class Hs126A_1_Spats extends HS126 {
    ...
    public Hs126A_1_Spats() {
    }

    static {
        Class class1 = Hs126A_1_Spats.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Hs126A_1_Spats");
        Property.set(class1, "meshName", "3DO/Plane/Hs126A_1_Spats/hierSpats.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_de", "3DO/Plane/Hs126A_1_Spats/hierSpats.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
