...
public class F3F_2 extends Scheme1 implements TypeFighter {
    ...
    static {
        Class class1 = F3F_2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F3F-2");
        Property.set(class1, "meshName", "3DO/Plane/F3F-2(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar02());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/F3F2.fmd:F3F2_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitF3F2.class });
