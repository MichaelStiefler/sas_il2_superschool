...
public class SM73 extends SM81x implements TypeBomber, TypeTransport {
    ...
    static {
        Class class1 = SM73.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SM73");
        Property.set(class1, "meshName", "3DO/Plane/SM81/hierS73.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar01());
        Property.set(class1, "yearService", 1936.8F);
        Property.set(class1, "yearExpired", 1944.5F);
        Property.set(class1, "FlightModel", "FlightModels/SM81PX.fmd:SM81PX_FM");
