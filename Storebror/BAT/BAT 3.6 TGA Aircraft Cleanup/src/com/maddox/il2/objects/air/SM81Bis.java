...
public class SM81Bis extends SM81x implements TypeBomber, TypeTransport {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.equals("56x24T")) {
            this.hierMesh().chunkVisible("Rack250_L_D0", false);
            this.hierMesh().chunkVisible("Rack250_R_D0", false);
            this.hierMesh().chunkVisible("RackM_D0", false);
            this.hierMesh().chunkVisible("Rack100_4_L_D0", false);
    ...
    static {
        Class class1 = SM81Bis.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SM81");
        Property.set(class1, "meshName", "3DO/Plane/SM81/hierBis.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar01());
        Property.set(class1, "yearService", 1936.8F);
        Property.set(class1, "yearExpired", 1944.5F);
        Property.set(class1, "FlightModel", "FlightModels/SM81Bis.fmd:SM81Bis_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitSM81Bis.class, CockpitSM81Bis_Bombardier.class });
