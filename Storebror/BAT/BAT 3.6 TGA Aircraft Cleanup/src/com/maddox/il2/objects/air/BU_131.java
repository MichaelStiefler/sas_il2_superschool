...
public class BU_131 extends Scheme1 implements TypeScout {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xpilot") || s.startsWith("xhead")) {
            ...
            if (s.startsWith("xaroneln") && (this.chunkDamageVisible("AroneLN") < 1)) {
                this.hitChunk("AroneLN", shot);
            }
            if (s.startsWith("xaronern") && (this.chunkDamageVisible("AroneRN") < 1)) {
                this.hitChunk("AroneRN", shot);
            }
            if (s.startsWith("xaronelv") && (this.chunkDamageVisible("AroneLN") < 1)) {
                this.hitChunk("AroneLV", shot);
            }
            if (s.startsWith("xaronerv") && (this.chunkDamageVisible("AroneRN") < 1)) {
    ...
    static {
        Class class1 = BU_131.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "BUCK");
        Property.set(class1, "meshName", "3DO/Plane/BU-131/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1936F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/BU131.fmd:BU131_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitBU131.class });
