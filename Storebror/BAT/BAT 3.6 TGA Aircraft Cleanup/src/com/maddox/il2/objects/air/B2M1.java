...
public class B2M1 extends B2Mabc {

    public B2M1() {
    }

    static {
        Class class1 = B2M1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "B2M1");
        Property.set(class1, "meshName", "3DO/Plane/B2M1(Multi1)/hier.him");
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 10, 10, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
