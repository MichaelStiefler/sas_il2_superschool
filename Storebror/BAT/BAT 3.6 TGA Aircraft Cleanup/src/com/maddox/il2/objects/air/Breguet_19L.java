...
public class Breguet_19L extends Biplanexyz {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.equals("4x100KgHE")) {
            this.hierMesh().chunkVisible("RackD_DoorF_D0", true);
            this.hierMesh().chunkVisible("RackD_DoorB_D0", true);
            this.hierMesh().chunkVisible("RackF_Door_D0", true);
            return;
        }
        if (this.thisWeaponsName.equals("2x200KgHE")) {
            this.hierMesh().chunkVisible("RackD_DoorF_D0", true);
            this.hierMesh().chunkVisible("RackD_DoorB_D0", true);
            this.hierMesh().chunkVisible("RackF_Door_D0", true);
            return;
        }
        if (this.thisWeaponsName.equals("8x50KgGAMM")) {
            this.hierMesh().chunkVisible("RackD_DoorF_D0", false);
            this.hierMesh().chunkVisible("RackD_DoorB_D0", false);
            this.hierMesh().chunkVisible("RackF_Door_D0", true);
            return;
        }
        if (this.thisWeaponsName.equals("32x10KgHE")) {
            this.hierMesh().chunkVisible("RackD_DoorF_D0", false);
            this.hierMesh().chunkVisible("RackD_DoorB_D0", false);
            this.hierMesh().chunkVisible("RackF_Door_D0", true);
            return;
        }
        if (this.thisWeaponsName.equals("44x10KgHE")) {
            this.hierMesh().chunkVisible("RackD_DoorF_D0", false);
            this.hierMesh().chunkVisible("RackD_DoorB_D0", false);
            this.hierMesh().chunkVisible("RackF_Door_D0", false);
            return;
        }
        if (this.thisWeaponsName.equals("24x10KgHE")) {
            this.hierMesh().chunkVisible("RackD_DoorF_D0", true);
            this.hierMesh().chunkVisible("RackD_DoorB_D0", true);
            this.hierMesh().chunkVisible("RackF_Door_D0", true);
            return;
    ...
    static {
        Class class1 = Breguet_19L.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "He45");
        Property.set(class1, "meshName", "3DO/Plane/Breguet_19/hierL.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_it", "3DO/Plane/Breguet_19/hierL.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/Breguet19L.fmd:Breguet19L_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitBreguet_19L.class });
