...
public class FI_156_ALONE extends Scheme1 implements TypeScout, TypeTransport {
    ...
    protected void moveGear(float f) {
        FI_156_ALONE.moveGear(this.hierMesh(), f);
    }
    ...
    public void moveWheelSink() {
        ...
        this.hierMesh().chunkSetAngles("GearL2_D0", 0.0F, AircraftLH.floatindex(f, FI_156_ALONE.gearL2), 0.0F);
        this.hierMesh().chunkSetAngles("GearL4_D0", 0.0F, AircraftLH.floatindex(f, FI_156_ALONE.gearL4), 0.0F);
        this.hierMesh().chunkSetAngles("GearL5_D0", 0.0F, AircraftLH.floatindex(f, FI_156_ALONE.gearL5), 0.0F);
        ...
        this.hierMesh().chunkSetAngles("GearR2_D0", 0.0F, -AircraftLH.floatindex(f, FI_156_ALONE.gearL2), 0.0F);
        this.hierMesh().chunkSetAngles("GearR4_D0", 0.0F, -AircraftLH.floatindex(f, FI_156_ALONE.gearL4), 0.0F);
        this.hierMesh().chunkSetAngles("GearR5_D0", 0.0F, -AircraftLH.floatindex(f, FI_156_ALONE.gearL5), 0.0F);
    }
    ...
    static {
        Class class1 = FI_156_ALONE.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Fi-156");
        Property.set(class1, "meshName", "3do/plane/Fi-156/hierAlone.him");
