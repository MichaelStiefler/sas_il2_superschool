...
public class ANT_20bis extends TB_4 {
    ...
    static {
        Class class1 = ANT_20bis.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "ANT20");
        Property.set(class1, "meshName", "3Do/Plane/ANT-20bis/hierANT20.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1932F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/Me-323.fmd:323");
        Property.set(class1, "cockpitClass", new Class[] { CockpitANT20.class, CockpitANT20_Bombardier.class });
