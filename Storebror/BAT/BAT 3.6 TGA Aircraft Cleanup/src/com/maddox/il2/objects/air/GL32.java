...
public class GL32 extends ParasolZ {
    ...
    static {
        Class class1 = GL32.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "GL32");
        Property.set(class1, "meshName", "3DO/Plane/GL32/hier32.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1934F);
        Property.set(class1, "yearExpired", 1942F);
        Property.set(class1, "FlightModel", "FlightModels/GL-32.fmd:Parasol2_FM");
