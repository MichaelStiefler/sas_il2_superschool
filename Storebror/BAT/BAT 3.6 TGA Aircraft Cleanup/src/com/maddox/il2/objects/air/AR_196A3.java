...
public class AR_196A3 extends AR_196 {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 2; j++) {
                if (this.FM.Gears.clpGearEff[i][j] != null) {
                    AR_196A3.tmpp.set(this.FM.Gears.clpGearEff[i][j].pos.getAbsPoint());
                    AR_196A3.tmpp.z = 0.01D;
                    this.FM.Gears.clpGearEff[i][j].pos.setAbs(AR_196A3.tmpp);
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_CANNON01", "_CANNON02", "_MGUN02", "_ExternalBomb01", "_ExternalBomb02" });
    }
}
