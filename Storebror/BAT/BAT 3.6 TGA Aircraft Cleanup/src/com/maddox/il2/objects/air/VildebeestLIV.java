...
public class VildebeestLIV extends Biplanexyz {

    public VildebeestLIV() {
    }
    ...
    static {
        Class class1 = VildebeestLIV.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "VildebeestL");
        Property.set(class1, "meshName", "3DO/Plane/Vildebeest/hierLIV.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_it", "3DO/Plane/Vildebeest/hierLIV.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1935F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/VildebeestLIV.fmd:VildebeestLIV_FM");
