...
public class LH_Sirius extends LS123 {
    ...
    static {
        Class class1 = LH_Sirius.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Mail");
        Property.set(class1, "meshName", "3DO/Plane/LH_Sirius/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitLHSirius.class });
        Property.set(class1, "FlightModel", "FlightModels/LHSirius.fmd:LHSirius_FM");
