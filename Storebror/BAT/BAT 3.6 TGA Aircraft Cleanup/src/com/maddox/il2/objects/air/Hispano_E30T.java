...
public class Hispano_E30T extends Trainerxyz {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.equals("default")) {
            this.hierMesh().chunkVisible("GearC1_D0", true);
            this.hierMesh().chunkVisible("GearC2_D0", true);
            this.hierMesh().chunkVisible("GearC3_D0", false);
            return;
        }
        if (this.thisWeaponsName.equals("4x10KgR5")) {
    ...
    static {
        Class class1 = Hispano_E30T.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "E-30");
        Property.set(class1, "meshName", "3DO/Plane/Hispano_E30/hierT.him");
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_ExternalDev01", "_ExternalBombT1", "_ExternalBombT2", "_ExternalBombT3", "_ExternalBombT4" });
    }
}
