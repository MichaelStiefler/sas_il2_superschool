...
public class FiatCr20Asso extends ParasolX {
    ...
    static {
        Class class1 = FiatCr20Asso.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Cr20");
        Property.set(class1, "meshName", "3DO/Plane/Cr20/hierasso.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_it", "3DO/Plane/Cr20/hierasso.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1934F);
        Property.set(class1, "yearExpired", 1942F);
        Property.set(class1, "FlightModel", "FlightModels/Cr20Asso.fmd:Cr20Asso_FM");
