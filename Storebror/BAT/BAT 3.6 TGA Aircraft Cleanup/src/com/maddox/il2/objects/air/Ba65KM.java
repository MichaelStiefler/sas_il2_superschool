...
public class Ba65KM extends Ba_65A {
    ...
    protected void moveGear(float f) {
        Ba65KM.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        ...
        Property.set(class1, "meshName", "3DO/Plane/Ba65/hierKM.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_it", "3DO/Plane/Ba65/hierKM.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/Ba65MK.fmd:Ba65MK_FM");
