...
public class D510 extends ParasolX {
    ...
    static {
        Class class1 = D510.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "D510");
        Property.set(class1, "meshName", "3DO/Plane/D510/hier510.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1934F);
        Property.set(class1, "yearExpired", 1942F);
        Property.set(class1, "FlightModel", "FlightModels/D510.fmd:Parasol_FM");
