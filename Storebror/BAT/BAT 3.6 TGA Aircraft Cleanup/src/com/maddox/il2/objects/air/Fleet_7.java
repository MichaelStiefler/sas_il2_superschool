...
public class Fleet_7 extends U_2 implements TypeStormovik {
    ...
    static {
        Class class1 = Fleet_7.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Fleet_7");
        Property.set(class1, "meshName", "3DO/Plane/Fleet_7/hier.him");
