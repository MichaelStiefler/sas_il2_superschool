...
public class P_3Orion extends KC_130 implements TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = P_3Orion.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= P_3Orion.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / P_3Orion.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (P_3Orion.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(P_3Orion.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
    ...
    static {
        Class class1 = P_3Orion.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "P-3Orion");
        Property.set(class1, "meshName", "3DO/Plane/P-3Orion(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
        Property.set(class1, "meshName_us", "3DO/Plane/P-3Orion(USA)/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitC_54.class });
