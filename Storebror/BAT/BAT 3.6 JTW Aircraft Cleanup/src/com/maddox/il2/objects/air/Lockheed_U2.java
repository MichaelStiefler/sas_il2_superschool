...
public class Lockheed_U2 extends L39G implements TypeFighter, TypeStormovik, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit {
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(Lockheed_U2.NEG_G_TOLERANCE_FACTOR, Lockheed_U2.NEG_G_TIME_FACTOR, Lockheed_U2.NEG_G_RECOVERY_FACTOR, Lockheed_U2.POS_G_TOLERANCE_FACTOR, Lockheed_U2.POS_G_TIME_FACTOR, Lockheed_U2.POS_G_RECOVERY_FACTOR);
...
//    private static final float POS_G_RECOVERY_FACTOR = 2.0F;
    ...
    static {
        Class class1 = Lockheed_U2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Lockheed-U2");
        Property.set(class1, "meshName", "3DO/Plane/Lockheed-U2(Multi1)/hier.him");
