...
public class CH_3E extends Scheme1 implements TypeScout, TypeTransport, TypeStormovik {
    ...
    protected void moveGear(float f) {
        CH_3E.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = CH_3E.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "CH3E");
        Property.set(class1, "meshName", "3DO/Plane/CH-3E/hier.him");
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11 });
