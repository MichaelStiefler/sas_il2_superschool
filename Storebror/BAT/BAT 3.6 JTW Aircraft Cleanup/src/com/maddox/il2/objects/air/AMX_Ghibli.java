...
public class AMX_Ghibli extends AMXinternational implements TypeFighter, TypeStormovik, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit {
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(AMX_Ghibli.NEG_G_TOLERANCE_FACTOR, AMX_Ghibli.NEG_G_TIME_FACTOR, AMX_Ghibli.NEG_G_RECOVERY_FACTOR, AMX_Ghibli.POS_G_TOLERANCE_FACTOR, AMX_Ghibli.POS_G_TIME_FACTOR, AMX_Ghibli.POS_G_RECOVERY_FACTOR);
    }
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        ...
        float f4 = Aircraft.cvt(f, 0.2F, 0.8F, 0.0F, -105F);
    ...
    protected void moveGear(float f) {
        AMX_Ghibli.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = AMX_Ghibli.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "AMX_Ghibli");
        Property.set(class1, "meshName", "3DO/Plane/AMX_Ghibli(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1971F);
        Property.set(class1, "yearExpired", 1999F);
        Property.set(class1, "FlightModel", "FlightModels/AMX.fmd:AMX_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitAMX_Ghibli.class });
        Property.set(class1, "LOSElevation", 0.965F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 9, 9, 0, 0, 9, 9, 3, 3, 3, 3, 2, 2, 2, 2, 9, 2, 2, 2, 2, 9, 2, 2, 2, 2 });
