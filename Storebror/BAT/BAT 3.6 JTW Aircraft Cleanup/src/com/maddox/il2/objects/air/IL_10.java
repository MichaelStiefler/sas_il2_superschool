    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.startsWith("xxarmorp")) {
                    ...
                    switch (i) {
                        ...
                        case 1:
                            this.getEnergyPastArmor(12.88D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                        ...
                        case 7:
                        case 8:
                            this.getEnergyPastArmor(8D / (Math.abs(Aircraft.v1.y) + 9.9999997473787516E-005D), shot);
                            shot.powerType = 0;
                        ...
                        case 3:
                            this.getEnergyPastArmor(16D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
                            break;
                        ...
                        case 6:
                            this.getEnergyPastArmor(8D / (Math.abs(Aircraft.v1.z) + 9.9999997473787516E-005D), shot);
                            shot.powerType = 0;
                            if ((shot.power <= 0.0F) && (Math.abs(Aircraft.v1.z) < 0.43999999761581421D)) {
                                this.doRicochet(shot);
                            }
                            break;
                    }
            ...
            if (s.startsWith("xxspar")) {
                ...
                if (s.startsWith("xxsparli") && (this.chunkDamageVisible("WingLIn") > 2) && (World.Rnd().nextFloat() > (Math.abs(Aircraft.v1.x) + 0.11999999731779099D)) && (this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)) {
                    this.debuggunnery("Spar Construction: WingLIn Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparri") && (this.chunkDamageVisible("WingRIn") > 2) && (World.Rnd().nextFloat() > (Math.abs(Aircraft.v1.x) + 0.11999999731779099D)) && (this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)) {
                    this.debuggunnery("Spar Construction: WingRIn Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlm") && (this.chunkDamageVisible("WingLMid") > 2) && (World.Rnd().nextFloat() > (Math.abs(Aircraft.v1.x) + 0.11999999731779099D)) && (this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)) {
                    this.debuggunnery("Spar Construction: WingLMid Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparrm") && (this.chunkDamageVisible("WingRMid") > 2) && (World.Rnd().nextFloat() > (Math.abs(Aircraft.v1.x) + 0.11999999731779099D)) && (this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)) {
                    this.debuggunnery("Spar Construction: WingRMid Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlo") && (this.chunkDamageVisible("WingLOut") > 2) && (World.Rnd().nextFloat() > (Math.abs(Aircraft.v1.x) + 0.11999999731779099D)) && (this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)) {
                    this.debuggunnery("Spar Construction: WingLOut Spar Hit, Breaking in Half..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if (s.startsWith("xxsparro") && (this.chunkDamageVisible("WingROut") > 2) && (World.Rnd().nextFloat() > (Math.abs(Aircraft.v1.x) + 0.11999999731779099D)) && (this.getEnergyPastArmor(6.96D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)) {
        ...
        if (s.startsWith("xcockpit")) {
            if (point3d.z > 0.775D) {
                ...
                if ((Aircraft.v1.x < -0.9D) && (this.getEnergyPastArmor(12D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot) > 0.0F)) {
        ...
        if (s.startsWith("xcf")) {
            if (point3d.z < 0.672D) {
                this.getEnergyPastArmor(6D / (Math.abs(Math.sqrt((Aircraft.v1.y * Aircraft.v1.y) + (Aircraft.v1.z * Aircraft.v1.z))) + 9.9999997473787516E-005D), shot);
                if ((shot.power <= 0.0F) && (Math.abs(Aircraft.v1.x) > 0.86599999666213989D)) {
                    this.doRicochet(shot);
                }
            }
            ...
            if (point3d.z > 0.549D) {
                this.getEnergyPastArmor(2D / (Math.abs(Aircraft.v1.z) + 9.9999997473787516E-005D), shot);
            } else if (point3d.x > 2.819D) {
                this.getEnergyPastArmor(6D / (Math.abs(Aircraft.v1.x) + 9.9999997473787516E-005D), shot);
            } else {
                this.getEnergyPastArmor(4D / (Math.abs(Math.sqrt((Aircraft.v1.y * Aircraft.v1.y) + (Aircraft.v1.z * Aircraft.v1.z))) + 9.9999997473787516E-005D), shot);
            }
