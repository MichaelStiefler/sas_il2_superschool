...
public class BirdDog extends Scheme1 implements TypeStormovik {
    ...
    static {
        Class class1 = BirdDog.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "O-1");
        Property.set(class1, "meshName", "3DO/Plane/BirdDog/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1950.9F);
        Property.set(class1, "yearExpired", 1962.3F);
        Property.set(class1, "FlightModel", "FlightModels/BirdDog.fmd:BirdDog_FM");
