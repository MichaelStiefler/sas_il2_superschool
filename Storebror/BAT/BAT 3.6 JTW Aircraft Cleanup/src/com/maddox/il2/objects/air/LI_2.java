...
public class LI_2 extends Scheme2 implements TypeTransport, TypeBomber {
    ...
    public void msgShot(Shot shot) {
        ...
        if (shot.chunkName.startsWith("Tail") && (((Tuple3d) (Aircraft.Pd)).x < -5.8D) && (((Tuple3d) (Aircraft.Pd)).x > -6.7899999618530273D) && (Aircraft.Pd.z > -0.449D) && (Aircraft.Pd.z < 0.12399999797344208D)) {
