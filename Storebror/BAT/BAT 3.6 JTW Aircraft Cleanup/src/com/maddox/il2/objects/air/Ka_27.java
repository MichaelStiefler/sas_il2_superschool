...
public class Ka_27 extends Scheme2a implements TypeScout, TypeTransport, TypeStormovik {
    ...
    protected void moveGear(float f) {
        Ka_27.moveGear(this.hierMesh(), f);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            ...
            if (s.startsWith("xxspar")) {
                if ((s.endsWith("t1") || s.endsWith("t2") || s.endsWith("t3") || s.endsWith("t4")) && (this.chunkDamageVisible("Tail1") > 2) && (this.getEnergyPastArmor(3.5F / (float) Math.sqrt((((Tuple3d) (Aircraft.v1)).y * ((Tuple3d) (Aircraft.v1)).y) + (Aircraft.v1.z * Aircraft.v1.z)), shot) > 0.0F)) {
    ...
    public void update(float f) {
        ...
        if ((this.FM.getAltitude() > 0.0F) && (this.FM.getSpeedKMH() >= 230D) && (this.FM.EI.engines[0].getStage() > 5)) {
            this.FM.producedAF.x -= 6000D;
        }
        if ((this.FM.getAltitude() > 0.0F) && (this.FM.getSpeedKMH() >= 230D) && (this.FM.EI.engines[1].getStage() > 5)) {
            this.FM.producedAF.x -= 6000D;
        }
        ...
        if ((this.FM.EI.engines[0].getw() > 100F) && (this.FM.EI.engines[1].getw() > 100F)) {
            this.FM.producedAF.x += 20000D * (-this.FM.CT.getElevator() * this.FM.EI.engines[0].getThrustOutput());
            this.FM.producedAF.z -= 13000D * (-this.FM.CT.getElevator() * this.FM.EI.engines[0].getThrustOutput());
