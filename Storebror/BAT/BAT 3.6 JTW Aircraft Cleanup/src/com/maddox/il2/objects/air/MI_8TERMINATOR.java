...
public class MI_8TERMINATOR extends Scheme2a implements TypeScout, TypeTransport, TypeStormovik {
    ...
    protected void moveGear(float f) {
        MI_8TERMINATOR.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = MI_8TERMINATOR.class;
