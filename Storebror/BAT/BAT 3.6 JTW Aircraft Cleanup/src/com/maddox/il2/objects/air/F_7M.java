...
public class F_7M extends MIG_21 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    public void typeFighterAceMakerRangeFinder() {
        ...
        F_7M.hunted = Main3D.cur3D().getViewPadlockEnemy();
        if (F_7M.hunted == null) {
            F_7M.hunted = War.GetNearestEnemyAircraft(((Interpolate) (this.FM)).actor, 2000F, 9);
        }
        if (F_7M.hunted != null) {
            this.k14Distance = (float) ((Interpolate) (this.FM)).actor.pos.getAbsPoint().distance(F_7M.hunted.pos.getAbsPoint());
    ...
    public void computeWP_7M_AB() {
        if ((this.FM.EI.engines[0].getThrustOutput() > 1.001F) && (this.FM.EI.engines[0].getStage() > 5)) {
            this.FM.producedAF.x += 15100D;
        }
    ...
    static {
        Class class1 = F_7M.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MiG21");
        Property.set(class1, "meshName", "3DO/Plane/F-7/hierF7M.him");
        ...
        Property.set(class1, "FlightModel", "FlightModels/F-7M.fmd:MIG21");
