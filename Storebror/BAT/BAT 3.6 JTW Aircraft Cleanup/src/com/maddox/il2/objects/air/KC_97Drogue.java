...
public class KC_97Drogue extends KC_97Tanker2 implements TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = KC_97Drogue.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= KC_97Drogue.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / KC_97Drogue.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (KC_97Drogue.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(KC_97Drogue.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
    ...
    static {
        Class class1 = KC_97Drogue.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "KC-97");
        Property.set(class1, "meshName", "3DO/Plane/KC_97P(Multi1)/hierDrogue.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
        Property.set(class1, "yearService", 1948.5F);
        Property.set(class1, "yearExpired", 1960.9F);
        Property.set(class1, "FlightModel", "FlightModels/KC-97P.fmd:C97FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitC_97.class, CockpitKC_97P_BGunner.class });
