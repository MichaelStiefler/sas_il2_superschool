...
public class F_104G extends F_104 implements TypeGuidedMissileCarrier, TypeThreatDetector, TypeGSuit, TypeAcePlane {
    ...
    public float getFlowRate() {
        return F_104G.FlowRate;
    }

    public float getFuelReserve() {
        return F_104G.FuelReserve;
    }
    ...
    static {
        Class class1 = F_104G.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F-104G");
