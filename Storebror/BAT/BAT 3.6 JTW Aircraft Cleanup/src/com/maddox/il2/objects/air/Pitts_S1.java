...
public class Pitts_S1 extends Scheme1 implements TypeScout, TypeBomber, TypeStormovik {
    ...
    static {
        Class class1 = Pitts_S1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Pitts");
        Property.set(class1, "meshName", "3DO/Plane/Pitts-S1/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/Z50.fmd:Z50");
        Property.set(class1, "cockpitClass", new Class[] { CockpitPitts_S1.class });
