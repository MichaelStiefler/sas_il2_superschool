...
public class JetBomber extends JB implements TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = JetBomber.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= JetBomber.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / JetBomber.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (JetBomber.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(JetBomber.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
