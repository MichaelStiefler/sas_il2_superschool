...
public class F9F6 extends F9F_Cougar {
    ...
    protected void moveSlats(float f) {
        ...
        this.hierMesh().chunkSetAngles("WingSlatL", 0.0F, Aircraft.cvt(this.FM.getAOA(), 6.8F, 15F, 0.0F, 8.5F), 0.0F);
        this.hierMesh().chunkSetLocate("WingSlatL", Aircraft.xyz, Aircraft.ypr);
        this.hierMesh().chunkSetAngles("WingSlatR", 0.0F, Aircraft.cvt(this.FM.getAOA(), 6.8F, 15F, 0.0F, 8.5F), 0.0F);
        this.hierMesh().chunkSetLocate("WingSlatR", Aircraft.xyz, Aircraft.ypr);
    }
    ...
    protected void slatsOff() {
        if (!this.bSlatsOff) {
            ...
            this.hierMesh().chunkSetAngles("WingSlatL", 0.0F, 8.5F, 0.0F);
            this.hierMesh().chunkSetLocate("WingSlatL", Aircraft.xyz, Aircraft.ypr);
            this.hierMesh().chunkSetAngles("WingSlatR", 0.0F, 8.5F, 0.0F);
            this.hierMesh().chunkSetLocate("WingSlatR", Aircraft.xyz, Aircraft.ypr);
            this.bSlatsOff = true;
        }
    }
    ...
    static {
        ...
        Property.set(class1, "iconFar_shortClassName", "F9F-6");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitF9F_Cougar.class });
