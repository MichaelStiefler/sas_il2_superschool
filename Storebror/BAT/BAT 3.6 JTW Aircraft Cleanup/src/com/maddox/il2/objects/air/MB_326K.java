...
public class MB_326K extends MB_326X {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMB_326.class, CockpitMB_326Bombardier.class });
