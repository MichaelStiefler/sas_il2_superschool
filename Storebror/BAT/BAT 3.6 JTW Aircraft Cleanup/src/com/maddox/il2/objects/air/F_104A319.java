...
public class F_104A319 extends F_104 implements TypeGuidedMissileCarrier, TypeThreatDetector, TypeGSuit, TypeAcePlane {
    ...
    public float getFlowRate() {
        return F_104A319.FlowRate;
    }

    public float getFuelReserve() {
        return F_104A319.FuelReserve;
    }
    ...
    static {
        Class class1 = F_104A319.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F-104A");
        Property.set(class1, "meshName", "3DO/Plane/F-104/hierF104A319.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1966F);
        Property.set(class1, "yearExpired", 1999F);
        Property.set(class1, "FlightModel", "FlightModels/F-104A319.fmd:F104FM");
