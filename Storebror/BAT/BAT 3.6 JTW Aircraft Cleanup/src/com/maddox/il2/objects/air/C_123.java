...
public class C_123 extends Scheme2 implements TypeTransport {
    ...
    public static void moveGear(HierMesh hiermesh, float f) {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, 0.0F, 15F * f);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, 0.0F, 15F * f);
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, 0.0F, -10F * f);
        hiermesh.chunkSetAngles("GearL3_D0", 0.0F, 140F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, -140F * f, 0.0F);
        hiermesh.chunkSetAngles("GearC3_D0", 0.0F, 140F * f, 0.0F);
        hiermesh.chunkSetAngles("GearC4_D0", 0.0F, -140F * f, 0.0F);
    }

    protected void moveGear(float f) {
        C_123.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = C_123.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "C123");
        Property.set(class1, "meshName", "3DO/Plane/C-123/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1953F);
        Property.set(class1, "yearExpired", 2021F);
        Property.set(class1, "FlightModel", "FlightModels/C123.fmd:C123_FM");
        Property.set(class1, "cockpitClass", new Class[] { Cockpit_C_123.class });
