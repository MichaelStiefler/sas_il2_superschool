...
public class F84G3 extends F84 implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker, TypeDockable {
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (this.FM.AP.way.isLanding() && (this.FM.getSpeed() > (this.FM.VmaxFLAPS * 2D)) && !this.FM.isPlayers()) {
            this.FM.CT.AirBrakeControl = 1.0F;
        } else if (this.FM.AP.way.isLanding() && (this.FM.getSpeed() < (this.FM.VmaxFLAPS * 1.5D)) && !this.FM.isPlayers()) {
    ...
    protected void moveGear(float f, float f1, float f2) {
        F84G3.moveGear(this.hierMesh(), f, f1, f2);
    }

    public static void moveGear(HierMesh hiermesh, float f) {
        F84G3.moveGear(hiermesh, f, f, f);
    }

    protected void moveGear(float f) {
        F84G3.moveGear(this.hierMesh(), f);
    }
    ...
    private void receivingRefuel(float f) {
        ...
        if (this.typeDockableIsDocked()) {
            ...
            if (this.FM.M.fuel < (this.FM.M.maxFuel - 28F)) {
                float f1 = ((TypeTankerBoom) this.queen_).requestRefuel(this, 28F, f);
                this.FM.M.fuel += f1;
            } else {
