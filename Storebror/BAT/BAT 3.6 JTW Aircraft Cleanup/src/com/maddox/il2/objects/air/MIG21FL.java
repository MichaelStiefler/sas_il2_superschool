...
public class MIG21FL extends MIG_21 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    public void typeFighterAceMakerRangeFinder() {
        ...
        MIG21FL.hunted = Main3D.cur3D().getViewPadlockEnemy();
        if (MIG21FL.hunted == null) {
            MIG21FL.hunted = War.GetNearestEnemyAircraft(((Interpolate) (this.FM)).actor, 2000F, 9);
        }
        if (MIG21FL.hunted != null) {
            this.k14Distance = (float) ((Interpolate) (this.FM)).actor.pos.getAbsPoint().distance(MIG21FL.hunted.pos.getAbsPoint());
    ...
    static {
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 9, 9, 9, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 9, 9, 3, 3, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 4, 3, 3 });
