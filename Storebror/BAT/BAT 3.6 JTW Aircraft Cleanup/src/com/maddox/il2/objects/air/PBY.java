...
public class PBY extends PBYX implements TypeBomber {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith(".50")) {
            this.hierMesh().chunkVisible("Guns1_D0", true);
        } else if (this.thisWeaponsName.startsWith("20mm")) {
            this.hierMesh().chunkVisible("Guns2_D0", true);
        } else if (this.thisWeaponsName.startsWith("25mm")) {
            this.hierMesh().chunkVisible("Guns3_D0", true);
        } else if (this.thisWeaponsName.startsWith("Rockets+.50")) {
            this.hierMesh().chunkVisible("Guns1_D0", true);
            this.hierMesh().chunkVisible("Rockets_L", true);
            this.hierMesh().chunkVisible("Rockets_R", true);
        } else if (this.thisWeaponsName.startsWith("Rockets+20mm")) {
            this.hierMesh().chunkVisible("Guns2_D0", true);
            this.hierMesh().chunkVisible("Rockets_L", true);
            this.hierMesh().chunkVisible("Rockets_R", true);
        } else if (this.thisWeaponsName.startsWith("Rockets+25mm")) {
            this.hierMesh().chunkVisible("Guns3_D0", true);
            this.hierMesh().chunkVisible("Rockets_L", true);
            this.hierMesh().chunkVisible("Rockets_R", true);
        } else if (this.thisWeaponsName.startsWith("Rockets")) {
            this.hierMesh().chunkVisible("Rockets_L", true);
            this.hierMesh().chunkVisible("Rockets_R", true);
        } else {
            this.hierMesh().chunkVisible("Rockets_L", false);
            this.hierMesh().chunkVisible("Rockets_R", false);
            this.hierMesh().chunkVisible("Guns1_D0", false);
            this.hierMesh().chunkVisible("Guns2_D0", false);
        }
    }
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPBY5.class, CockpitPBY_Bombardier.class, CockpitPBY_TGunner.class, CockpitPBY_LGunner.class, CockpitPBY_RGunner.class });
        Property.set(class1, "LOSElevation", 0.73425F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 3, 3, 3, 3, 9, 9, 3, 2, 0, 0, 0, 0, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalDev01", "_ExternalDev02", "_ExternalBomb05", "_ExternalBomb06", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_CANNON01", "_CANNON02", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04", "_ExternalRock05", "_ExternalRock06", "_ExternalRock07", "_ExternalRock08" });
    }
}
