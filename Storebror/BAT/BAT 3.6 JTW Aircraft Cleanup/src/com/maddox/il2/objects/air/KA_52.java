...
public class KA_52 extends Scheme2a implements TypeStormovik, TypeBayDoor, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector {
    ...
    protected void moveGear(float f) {
        KA_52.moveGear(this.hierMesh(), f);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        boolean flag1 = this instanceof KA_52;
        if (s.startsWith("xx")) {
    ...
    static {
        Class class1 = KA_52.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "KA-52");
        Property.set(class1, "meshName", "3DO/Plane/KA_52/hier.him");
