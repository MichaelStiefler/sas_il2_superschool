...
public class H21 extends Scheme1 implements TypeScout, TypeTransport {
    ...
    public void computeMass() {
        float f = Aircraft.cvt(this.FM.getSpeedKMH(), 140F, 200F, 4058F, 6300F);
        if (this.FM.getSpeedKMH() > 140F) {
