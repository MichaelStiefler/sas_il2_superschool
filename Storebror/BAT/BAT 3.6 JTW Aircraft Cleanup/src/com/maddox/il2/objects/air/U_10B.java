...
public class U_10B extends Scheme1 implements TypeStormovik {
    ...
    static {
        Class class1 = U_10B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "U_10B");
        Property.set(class1, "meshName", "3DO/Plane/U-10B/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1950.9F);
        Property.set(class1, "yearExpired", 1962.3F);
        Property.set(class1, "FlightModel", "FlightModels/U10B.fmd:U10FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitBirdDog.class });
