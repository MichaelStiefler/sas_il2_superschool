...
public class C_123K extends KC_130 implements TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = C_123K.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= C_123K.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / C_123K.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (C_123K.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(C_123K.toMeters(this.fSightCurAltitude) * (2F / 9.81F)))) {
    ...
    static {
        Class class1 = C_123K.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "C_123K");
        Property.set(class1, "meshName", "3DO/Plane/C-123K(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
        Property.set(class1, "meshName_us", "3DO/Plane/C-123K(USA)/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitC_123K.class });
