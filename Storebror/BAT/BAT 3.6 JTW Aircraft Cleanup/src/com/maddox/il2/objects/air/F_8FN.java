...
public class F_8FN extends F_8fuelReceiver implements TypeCountermeasure, TypeFastJet {
    ...
    public void computeLoadoutsDrag() {
        ...
        if (this.thisWeaponsName.startsWith("2xR550")) {
            polares.CxMin_0 = 0.023F;
        }
        if (this.thisWeaponsName.startsWith("2xR530")) {
        ...
        for (java.util.Map.Entry entry = Engine.name2Actor().nextEntry(null); entry != null; entry = Engine.name2Actor().nextEntry(entry)) {
            ...
            if (flag1 && (actor instanceof Aircraft) && (actor.getArmy() != World.getPlayerArmy()) && (actor != World.getPlayerAircraft()) && (actor.getSpeed(vector3d) > 20D)) {
                ...
                if (((double) j1 <= (double) l2) && (j1 >= 100D) && (j1 >= 700D) && (l1 >= -20) && (l1 <= 20) && (Math.sqrt(j2 * j2) <= 40D)) {
                    HUD.log(AircraftHotKeys.hudLogWeaponId, "APQ-94: Contact " + s1 + s2 + ", " + i2 + "m");
                    this.freq = 3;
                } else {
                    this.freq = 7;
                }
    ...
    static {
        Class class1 = F_8FN.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F-8");
        Property.set(class1, "meshName", "3DO/Plane/F-8E/hierF8FN.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar06());
        Property.set(class1, "yearService", 1956.9F);
        Property.set(class1, "yearExpired", 1994.3F);
        Property.set(class1, "FlightModel", "FlightModels/F8FN.fmd:Vought_FM");
