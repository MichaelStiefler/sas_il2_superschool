...
public class MB_339A_FAA extends MB_339 {
    ...
    protected static void XweaponsRegister(Class class1, String s, String as[]) {
        ...
        ArrayList arraylist = MB_339A_FAA.XweaponsListProperty(class1);
        HashMapInt hashmapint = MB_339A_FAA.XweaponsMapProperty(class1);
    ...
    static {
        Class class1 = MB_339A_FAA.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MB-339");
        Property.set(class1, "meshName", "3DO/Plane/MB-339/hierA.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1979.9F);
        Property.set(class1, "yearExpired", 2020.3F);
        Property.set(class1, "FlightModel", "FlightModels/MB-339A.fmd:MB339FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitMB339.class, CockpitT_33i.class });
