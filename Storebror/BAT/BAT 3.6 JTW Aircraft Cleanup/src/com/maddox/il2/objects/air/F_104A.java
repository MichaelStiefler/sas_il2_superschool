...
public class F_104A extends F_104 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane {
    ...
    public float getFlowRate() {
        return F_104A.FlowRate;
    }

    public float getFuelReserve() {
        return F_104A.FuelReserve;
    }
    ...
    public void computeJ79GE3A_AB() {
        if ((this.FM.EI.engines[0].getThrustOutput() > 1.001F) && (this.FM.EI.engines[0].getStage() > 5)) {
            this.FM.producedAF.x += 19240D;
        }
    ...
    static {
        Class class1 = F_104A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F-104A");
        Property.set(class1, "meshName", "3DO/Plane/F-104/hierF104A.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1966F);
        Property.set(class1, "yearExpired", 1999F);
        Property.set(class1, "FlightModel", "FlightModels/F-104A.fmd:F104FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitF_104G.class });
