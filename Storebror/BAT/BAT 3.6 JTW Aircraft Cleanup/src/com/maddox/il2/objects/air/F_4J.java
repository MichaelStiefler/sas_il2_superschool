...
public class F_4J extends F_4 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeFastJet {
    ...
    public float getFlowRate() {
        return F_4J.FlowRate;
    }

    public float getFuelReserve() {
        return F_4J.FuelReserve;
    }
    ...
    private boolean InertialNavigation() {
        ...
        Vector3d vector3d = new Vector3d();
        Aircraft aircraft = World.getPlayerAircraft();
        if ((aircraft.getSpeed(vector3d) > 20D) && (aircraft.pos.getAbsPoint().z >= 150D) && (aircraft instanceof F_4J)) {
            this.pos.getAbs(point3d);
            if (Mission.cur() != null) {
                this.error++;
                if (this.error > 99) {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/F4J.fmd:F4E");
