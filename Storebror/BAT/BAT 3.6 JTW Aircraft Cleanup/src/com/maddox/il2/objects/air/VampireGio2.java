...
public class VampireGio2 extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeStormovik {
    ...
    protected void moveGear(float f) {
        VampireGio2.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = VampireGio2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Vampire");
        Property.set(class1, "meshName", "3DO/Plane/Vampire2(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar06());
        Property.set(class1, "originCountry", PaintScheme.countryGermany);
        Property.set(class1, "yearService", 1946F);
        Property.set(class1, "yearExpired", 1948.5F);
        Property.set(class1, "FlightModel", "FlightModels/VampireGio2.fmd:VampireGio_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitVampireGio.class });
