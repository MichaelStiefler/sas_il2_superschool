...
public class G_91PAN extends G_91 implements TypeFastJet {
    ...
    static {
        Class class1 = G_91PAN.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "G.91");
        Property.set(class1, "meshName", "3DO/Plane/G.91/hierPAN.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitG_91.class });
