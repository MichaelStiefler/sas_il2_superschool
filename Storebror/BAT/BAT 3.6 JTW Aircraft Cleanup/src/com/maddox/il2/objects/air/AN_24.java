...
public class AN_24 extends Scheme1 implements TypeTransport {
    ...
    protected void moveFlap(float f) {
        ...
        this.hierMesh().chunkSetAngles("Flap3_D0", 0.0F, 0.0F, f1);
        this.hierMesh().chunkSetAngles("Flap4_D0", 0.0F, 0.0F, f1);
    }
    ...
    protected void moveGear(float f) {
        AN_24.moveGear(this.hierMesh(), f);
    }

    protected void moveBayDoor(float f) {
        this.hierMesh().chunkSetAngles("Bay_D0", 0.0F, 40F * f, 0.0F);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xcf")) {
            ...
            if (this.chunkDamageVisible("Engine2") < 3) {
    ...
    static {
        Class class1 = AN_24.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "AN24");
        Property.set(class1, "meshName", "3DO/Plane/AN24/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/AN26.fmd:AN26_FM");
        Property.set(class1, "cockpitClass", new Class[] { Cockpit_AN24.class });
