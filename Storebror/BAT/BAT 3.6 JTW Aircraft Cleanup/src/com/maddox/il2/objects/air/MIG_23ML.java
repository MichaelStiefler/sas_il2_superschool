...
public class MIG_23ML extends MIG_23 implements TypeLaserSpotter {
    ...
    private boolean SAPFIR23() {
        ...
        if (aircraft instanceof MIG_23ML) {
            flag1 = true;
        }
        if (d3 < 0.0D) {
            d3 = 0.0D;
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitMIG_23ML.class, CockpitMIG_23Bombardier.class });
