...
public class TU_22U extends TU_22fuelReceiver implements TypeCountermeasure, TypeFuelDump {
    ...
    public float getFlowRate() {
        return TU_22U.FlowRate;
    }

    public float getFuelReserve() {
        return TU_22U.FuelReserve;
    }
    ...
    static {
        Class class1 = TU_22U.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Tu-22");
        Property.set(class1, "meshName", "3DO/Plane/Tu-22/hierTu22U.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitTU_22.class, CockpitTU_22U.class, CockpitTU_22_Bombardier.class });
