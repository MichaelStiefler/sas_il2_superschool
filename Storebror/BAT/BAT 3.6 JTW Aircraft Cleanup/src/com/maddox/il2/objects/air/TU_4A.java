...
public class TU_4A extends B_29X implements TypeBomber {
    ...
    static {
        Class class1 = TU_4A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "TU-4A");
        Property.set(class1, "meshName", "3DO/Plane/Tu-4A/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar05());
        Property.set(class1, "yearService", 1947F);
        Property.set(class1, "yearExpired", 1960F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitTU4A.class, CockpitTU4A_Bombardier.class, CockpitTU4A_TGunner.class, CockpitTU4A_T2Gunner.class, CockpitTU4A_FGunner.class, CockpitTU4A_AGunner.class, CockpitTU4A_RGunner.class });
