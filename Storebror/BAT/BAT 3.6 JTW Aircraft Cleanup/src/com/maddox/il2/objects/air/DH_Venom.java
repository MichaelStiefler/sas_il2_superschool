...
public class DH_Venom extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeStormovik {
    ...
    protected void moveGear(float f) {
        DH_Venom.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/VenomDH.fmd:DeHavilland_FM");
