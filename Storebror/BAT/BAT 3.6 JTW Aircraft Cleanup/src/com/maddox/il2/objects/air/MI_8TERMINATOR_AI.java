...
public class MI_8TERMINATOR_AI extends Scheme1 implements TypeScout, TypeTransport, TypeStormovik {
    ...
    protected void moveGear(float f) {
        MI_8TERMINATOR_AI.moveGear(this.hierMesh(), f);
    }
        ...
        if (s.startsWith("xx")) {
            ...
            if (s.startsWith("xxcontrols")) {
                ...
                switch (j) {
                    ...
                    case 3:
                        if (this.getEnergyPastArmor(0.25F / ((float) Math.sqrt((((Tuple3d) (Aircraft.v1)).y * ((Tuple3d) (Aircraft.v1)).y) + (Aircraft.v1.z * Aircraft.v1.z)) + 0.0001F), shot) <= 0.0F) {
                            break;
                        }
