...
public class H_5 extends Scheme1 implements TypeScout, TypeTransport {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.endsWith("SAR")) {
            this.hierMesh().chunkVisible("Grua_D0", true);
            return;
        } else {
            return;
        }
    ...
    public void doMurderPilot(int i) {
        switch (i) {
            case 0:
                ...
                this.hierMesh().chunkVisible("HMask1_D0", false);
                this.hierMesh().chunkVisible("Casco1_D0", false);
                break;
            ...
            case 1:
                ...
                this.hierMesh().chunkVisible("HMask2_D0", false);
                this.hierMesh().chunkVisible("Casco2_D0", false);
                break;
        }
    }
    ...
    public void computeMass() {
        float f = Aircraft.cvt(this.FM.getSpeedKMH(), 90F, 190F, 1718F, 3500F);
    ...
    static {
        Class class1 = H_5.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Dragonfly");
        Property.set(class1, "meshName", "3DO/Plane/H-5/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1950F);
        Property.set(class1, "yearExpired", 1960.5F);
        Property.set(class1, "FlightModel", "FlightModels/H-5.fmd:H5FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitDragonfly.class });
