...
public class CH25 extends Scheme1 implements TypeScout, TypeTransport {
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.startsWith("xxspar")) {
                    ...
                    if (s.startsWith("xxspart") && (this.chunkDamageVisible("Tail1") > 2) && (this.getEnergyPastArmor(9.5F / (float) Math.sqrt((((Tuple3d) (Aircraft.v1)).y * ((Tuple3d) (Aircraft.v1)).y) + (Aircraft.v1.z * Aircraft.v1.z)), shot) > 0.0F)) {
    ...
    public void computeMass() {
        float f = Aircraft.cvt(this.FM.getSpeedKMH(), 80F, 150F, 1874F, 4000F);
        if (this.FM.getSpeedKMH() > 80F) {
    ...
    static {
        Class class1 = CH25.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "CH25");
        Property.set(class1, "meshName", "3DO/Plane/CH25/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1950F);
        Property.set(class1, "yearExpired", 1960.5F);
        Property.set(class1, "FlightModel", "FlightModels/CH-25.fmd:Piasecki_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitH21.class });
