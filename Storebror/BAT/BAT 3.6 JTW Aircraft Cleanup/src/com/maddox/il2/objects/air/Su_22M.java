...
public class Su_22M extends Sukhoi implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeX4Carrier {
    ...
    public float getFlowRate() {
        return Su_22M.FlowRate;
    }

    public float getFuelReserve() {
        return Su_22M.FuelReserve;
    }
    ...
    public void getGFactors(TypeGSuit.GFactors gfactors) {
        gfactors.setGFactors(Su_22M.NEG_G_TOLERANCE_FACTOR, Su_22M.NEG_G_TIME_FACTOR, Su_22M.NEG_G_RECOVERY_FACTOR, Su_22M.POS_G_TOLERANCE_FACTOR, Su_22M.POS_G_TIME_FACTOR, Su_22M.POS_G_RECOVERY_FACTOR);
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Su-22M.fmd:Sukhoi_FM");
