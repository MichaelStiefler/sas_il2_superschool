...
public class Sikorsky_CH34 extends Scheme1 implements TypeScout, TypeTransport {

    public Sikorsky_CH34() {
        this.suka = new Loc();
    ...
    protected void moveGear(float f) {
        Sikorsky_CH34.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = Sikorsky_CH34.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Choctaw");
        Property.set(class1, "meshName", "3DO/Plane/Sikorsky-CH34(Multi1)/hier.him");
