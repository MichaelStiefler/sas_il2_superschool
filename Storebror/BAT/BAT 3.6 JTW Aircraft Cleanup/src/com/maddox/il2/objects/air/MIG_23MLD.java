...
public class MIG_23MLD extends MIG_23 implements TypeLaserSpotter {
    ...
    private boolean SAPFIR23() {
        ...
        if (aircraft instanceof MIG_23MLD) {
            flag1 = true;
        }
        if (d3 < 0.0D) {
            d3 = 0.0D;
    ...
    static {
        Class class1 = MIG_23MLD.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "MiG-23");
        Property.set(class1, "meshName", "3DO/Plane/MiG-23/hierMiG23MLD.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "noseart", 1);
        Property.set(class1, "yearService", 1972F);
        Property.set(class1, "yearExpired", 2020F);
        Property.set(class1, "FlightModel", "FlightModels/MiG-23MLD.fmd:MIG23FM");
