...
public class Sea_Venom extends Scheme1 implements TypeFighter, TypeBNZFighter, TypeStormovik, TypeSupersonic {
    ...
    protected void moveGear(float f) {
        Sea_Venom.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/SeaVenom.fmd:DeHavilland_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitDH_Venom.class });
