...
public class A_10A extends A_10 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane {
    ...
    public float getFlowRate() {
        return A_10A.FlowRate;
    }

    public float getFuelReserve() {
        return A_10A.FuelReserve;
    }
    ...
    static {
        Class class1 = A_10A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "A-10A");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitA_10.class, CockpitA_10Bombardier.class });
