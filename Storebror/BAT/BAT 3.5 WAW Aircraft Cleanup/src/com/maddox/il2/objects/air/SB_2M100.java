...
public class SB_2M100 extends SB_2M100A implements TypeBomber {
    ...
    static {
        Class class1 = SB_2M100.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SB");
        Property.set(class1, "meshNameDemo", "3DO/Plane/SB-2M-100(Russian)/hier.him");
        Property.set(class1, "meshName", "3DO/Plane/SB-2M-100(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "meshName_ru", "3DO/Plane/SB-2M-100(Russian)/hier.him");
