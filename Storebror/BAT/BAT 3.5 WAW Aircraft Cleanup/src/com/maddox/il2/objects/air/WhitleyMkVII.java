...
public class WhitleyMkVII extends WhitleyBombers implements TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = WhitleyMkVII.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= WhitleyMkVII.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / WhitleyMkVII.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (WhitleyMkVII.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(WhitleyMkVII.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
    ...
    static {
        Class class1 = WhitleyMkVII.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Whitley");
        Property.set(class1, "meshName", "3DO/Plane/WhitleyMkVII(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar01());
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/Whitleybombers.fmd:Whitley_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitWhitley.class, CockpitWhitleyVII_Bombardier.class, CockpitWhitley_AGunner.class, CockpitWhitley_FGunner.class });
        Property.set(class1, "LOSElevation", 1.4078F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 10, 11, 11, 11, 11, 12, 13, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08" });
    }
}
