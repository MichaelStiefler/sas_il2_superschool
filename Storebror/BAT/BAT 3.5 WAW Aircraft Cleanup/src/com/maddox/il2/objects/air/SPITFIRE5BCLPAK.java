...
public class SPITFIRE5BCLPAK extends SPITFIRE {

    public SPITFIRE5BCLPAK() {
    }
    ...
    protected void moveGear(float f) {
        SPITFIRE5BCLPAK.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = SPITFIRE5BCLPAK.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SpitVbcw");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireMkVbCLPAK(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "meshName_gb", "3DO/Plane/SpitfireMkVbCLPAK(GB)/hier.him");
