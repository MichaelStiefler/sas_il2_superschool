...
public class DAPBEAU extends BEAU implements TypeFighter, TypeStormovik {

    public DAPBEAU() {
    }

    static {
        Class class1 = DAPBEAU.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Beaufighter");
        Property.set(class1, "meshName", "3DO/Plane/DAPBeaufighter(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "meshName_gb", "3DO/Plane/DAPBeaufighter(AU)/hier.him");
