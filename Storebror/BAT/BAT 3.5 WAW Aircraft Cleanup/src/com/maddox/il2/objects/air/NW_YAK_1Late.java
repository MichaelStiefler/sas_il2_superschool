...
public class NW_YAK_1Late extends YAK implements TypeTNBFighter {
    ...
    static {
        Class class1 = NW_YAK_1Late.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/Yak-1Late.fmd");
