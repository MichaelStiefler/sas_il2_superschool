...
public class CCBEAU10 extends BEAU implements TypeFighter, TypeStormovik {

    public CCBEAU10() {
    }

    static {
        Class class1 = CCBEAU10.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Beaufighter");
        Property.set(class1, "meshName", "3DO/Plane/CCBeaufighterMk10(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "meshName_gb", "3DO/Plane/CCBeaufighterMk10(GB)/hier.him");
