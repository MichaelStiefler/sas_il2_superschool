...
public class HS_129B3Wa extends HS_129 {
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (!this.BK75dropped && !this.FM.isPlayers() && (this.isNetMaster() || !this.isNet()) && !this.FM.AS.isPilotDead(0) && !this.isNetPlayer() && (this.FM.AS.astateBailoutStep == 0) && ((this.FM.AS.astateEngineStates[0] > 2) || (this.FM.AS.astateEngineStates[1] > 2) || (this.FM.EI.engines[0].getReadyness() < 0.5F) || (this.FM.EI.engines[1].getReadyness() < 0.5F) || (((Maneuver) this.FM).get_maneuver() == 49) || this.FM.isReadyToReturn())) {
            this.FM.CT.dropExternalStores(true);
        }
    }
    ...
    public boolean dropExternalStores(boolean flag) {
        if (!this.BK75dropped) {
            if (flag && ((this.FM.getSpeedKMH() > 342F) || (this.FM.getSpeedKMH() < 95F))) {
                return false;
            }
