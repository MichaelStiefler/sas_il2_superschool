...
public class Martin_B_10B extends Martin_B10_USAAC implements TypeBomber {

    public Martin_B_10B() {
        this.bChangedExts = false;
        Martin_B_10B.bChangedPit = true;
    ...
    static {
        Class class1 = Martin_B_10B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Martin-Bomber");
        Property.set(class1, "meshName", "3DO/Plane/Martin-B-10B(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar04());
        Property.set(class1, "yearService", 1935F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/B-10B.fmd:Martin123_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitB_10B.class, CockpitB10B_Bombardier.class, CockpitIB_10B_FGunner.class, CockpitIB_10B_Topgun.class });
