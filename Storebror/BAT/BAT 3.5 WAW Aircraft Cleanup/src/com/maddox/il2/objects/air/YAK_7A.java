...
public class YAK_7A extends YAK implements TypeTNBFighter {
    ...
    protected void moveGear(float f, float f1, float f2) {
        YAK_7A.moveGear(this.hierMesh(), f, f1, f2);
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Yak-7A.fmd");
