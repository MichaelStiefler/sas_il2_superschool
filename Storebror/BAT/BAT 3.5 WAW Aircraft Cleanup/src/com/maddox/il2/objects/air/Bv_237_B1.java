...
public class Bv_237_B1 extends Bv_237X implements TypeFighter, TypeStormovik, TypeX4Carrier {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("50mm Cannon")) {
                ...
                if (s.startsWith("xxeng2")) {
                    if (s.endsWith("cas") && (this.getEnergyPastArmor(0.1F, shot) > 0.0F)) {
                        ...
                        if (World.Rnd().nextFloat() < (shot.power / 28000F)) {
                            ...
                            Aircraft.debugprintln(this, "*** Engine Crank Case Hit - Cylinder Feed Out, " + this.FM.EI.engines[1].getCylindersOperable() + "/" + this.FM.EI.engines[1].getCylinders() + " Left..");
                        }
                        ...
                        Aircraft.debugprintln(this, "*** Engine Crank Case Hit - Readyness Reduced to " + this.FM.EI.engines[1].getReadyness() + "..");
                    }
