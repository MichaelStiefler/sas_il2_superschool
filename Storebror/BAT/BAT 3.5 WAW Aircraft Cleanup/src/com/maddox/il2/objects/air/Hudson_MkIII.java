...
public class Hudson_MkIII extends Hudson123 implements TypeStormovik, TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = Hudson_MkIII.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= Hudson_MkIII.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / Hudson_MkIII.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (Hudson_MkIII.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(Hudson_MkIII.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
    ...
    static {
        Class class1 = Hudson_MkIII.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Hudson");
        Property.set(class1, "meshName", "3DO/Plane/HudsonMkIII(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Hudson_MkIII.fmd:Hudsons_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHudsonMkI.class, CockpitHudsonMkIII_Bombardier.class, CockpitHudson_TGunner.class });
        Property.set(class1, "LOSElevation", 0.5265F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 10, 10, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10" });
    }
}
