...
public class LAGG_3RD extends LAGG_3 {
    ...
    public void update(float f) {
        if (this.FM.AS.isMaster()) {
            if (this.curctl == -1F) {
                ...
                if ((((this.curctl - this.oldctl) / f) > 3F) && (this.FM.EI.engines[0].getRPM() < 2100F) && (this.FM.EI.engines[0].getStage() == 6) && (World.Rnd().nextFloat() < 0.25F)) {
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
        ...
        hiermesh.chunkSetAngles("GearC99_D0", 0.0F, -75F * f2, 0.0F);
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxammo")) {
                if (this.getEnergyPastArmor(4.81F, shot) > 0.0F) {
                    ...
                    if (World.Rnd().nextFloat() < 0.012F) {
                        this.FM.AS.explodeTank(shot.initiator, 0);
                    }
            ...
            if (s.startsWith("xxcontrols")) {
                ...
                } else if (this.getEnergyPastArmor(0.31F, shot) > 0.0F) {
                    this.FM.AS.setControlsDamage(shot.initiator, 1);
                }
                return;
            }
