...
public class IL_2T_DZZ extends IL_2 {

    public IL_2T_DZZ() {
    }

    static {
        Class class1 = IL_2T_DZZ.class;
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 10, 3, 2, 2, 2, 2 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_ExternalBomb07", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04" });
    }
}
