...
public class D4Y2 extends D4Y_ten implements TypeDiveBomber, TypeBomber {
    ...
    static {
        Class class1 = D4Y2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "D4Y");
        Property.set(class1, "meshName", "3DO/Plane/D4Y2(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_ja", "3DO/Plane/D4Y2(ja)/hier.him");
        Property.set(class1, "PaintScheme_ja", new PaintSchemeFCSPar05());
        Property.set(class1, "yearService", 1944F);
        Property.set(class1, "yearExpired", 1946.5F);
        Property.set(class1, "FlightModel", "FlightModels/D4Y2.fmd:D4Y2_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitD4Y2.class, CockpitD4Y2_Bombardier.class, CockpitD4Y2_TGunner.class });
