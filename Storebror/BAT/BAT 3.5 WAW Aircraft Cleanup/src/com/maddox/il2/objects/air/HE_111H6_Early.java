...
public class HE_111H6_Early extends HE_111 {

    public HE_111H6_Early() {
        this.slider = false;
        this.sliderX = 0.0F;
        this.sliderZ = 0.0F;
    ...
    static {
        Class class1 = HE_111H6_Early.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "He-111");
        Property.set(class1, "meshName", "3do/plane/He-111H-6-Early/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1941.4F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/He-111H-6-Early.fmd:HE111");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHE_111H6_Early.class, CockpitHE_111H6_Early_Bombardier.class, CockpitHE_111H6_Early_NGunner.class, CockpitHE_111H6_Early_TGunner.class, CockpitHE_111H6_Early_BGunner.class, CockpitHE_111H6_Early_FGunner.class, CockpitHE_111H6_Early_LGunner.class, CockpitHE_111H6_Early_RGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 13, 14, 15, 0, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08" });
    }
}
