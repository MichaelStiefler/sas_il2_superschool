...
public class HE_111H11 extends HE_111 {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/He-111H-11.fmd:HE111");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHE_111H11.class, CockpitHE_111H11_Bombardier.class, CockpitHE_111H11_NGunner.class, CockpitHE_111H11_TGunner.class, CockpitHE_111H11_BGunner.class, CockpitHE_111H11_FGunner.class, CockpitHE_111H11_LGunner.class, CockpitHE_111H11_RGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 13, 14, 15, 12, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN08", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08", "_ExternalBomb09", "_ExternalBomb10", "_ExternalBomb11", "_ExternalBomb12", "_ExternalBomb13", "_ExternalBomb14", "_ExternalBomb15", "_ExternalBomb16", "_ExternalBomb17", "_ExternalBomb18" });
    }
}
