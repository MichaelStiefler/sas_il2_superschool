...
public class JU_52_3MG3E extends JU_52 implements TypeBomber {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("12x")) {
            if (Config.isUSE_RENDER()) {
                ...
                this.hierMesh().chunkVisible("Pilot6_D0", true);
                this.hierMesh().chunkVisible("Pilot7_D0", true);
                this.hierMesh().chunkVisible("Pilot8_D0", true);
                this.hierMesh().chunkVisible("Pilot9_D0", true);
                this.hierMesh().chunkVisible("Pilot10_D0", true);
                this.hierMesh().chunkVisible("Pilot11_D0", true);
                this.hierMesh().chunkVisible("Pilot12_D0", true);
                this.hierMesh().chunkVisible("Pilot13_D0", true);
                this.hierMesh().chunkVisible("Pilot14_D0", true);
                this.hierMesh().chunkVisible("Pilot15_D0", true);
                this.hierMesh().chunkVisible("Helm4_D0", true);
                this.hierMesh().chunkVisible("Helm5_D0", true);
                this.hierMesh().chunkVisible("Helm6_D0", true);
                this.hierMesh().chunkVisible("Helm7_D0", true);
                this.hierMesh().chunkVisible("Helm8_D0", true);
                this.hierMesh().chunkVisible("Helm9_D0", true);
                this.hierMesh().chunkVisible("Helm10_D0", true);
                this.hierMesh().chunkVisible("Helm11_D0", true);
                this.hierMesh().chunkVisible("Helm12_D0", true);
                this.hierMesh().chunkVisible("Helm13_D0", true);
                this.hierMesh().chunkVisible("Helm14_D0", true);
                this.hierMesh().chunkVisible("Helm15_D0", true);
            }
            return;
        }
        if (this.thisWeaponsName.startsWith("5x")) {
            if (Config.isUSE_RENDER()) {
                ...
                this.hierMesh().chunkVisible("CargoA_03", true);
                this.hierMesh().chunkVisible("CargoA_04", true);
                this.hierMesh().chunkVisible("CargoA_05", true);
            }
            return;
        }
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_BombSpawn01", "_BombSpawn02", "_BombSpawn02", "_BombSpawn03", "_BombSpawn03", "_BombSpawn04", "_BombSpawn04", "_BombSpawn05", "_BombSpawn05", "_BombSpawn06", "_BombSpawn06", "_BombSpawn07", "_BombSpawn07" });
    }
}
