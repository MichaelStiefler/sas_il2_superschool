...
public class Do217_E2 extends Do217 {
    ...
    static {
        Class class1 = Do217_E2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Do-217");
        Property.set(class1, "meshName", "3do/plane/Do217_E2/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/Do217E-2.fmd:Do217E_FM_4101");
        Property.set(class1, "cockpitClass", new Class[] { CockpitDo217_E2.class, CockpitDo217E_Bombardier.class, CockpitDo217E_NGunner.class, CockpitDo217E_TGunner.class, CockpitDo217E_BGunner.class, CockpitDo217E_LGunner.class, CockpitDo217E_RGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 10, 11, 12, 13, 14, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN10", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10", "_BombSpawn05" });
    }
}
