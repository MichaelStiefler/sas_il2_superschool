...
public class HampdenMkI extends HAMPDEN {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/HAMP.fmd:Hampden_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHampdenMkI.class, CockpitHampdenMkI_Bombardier.class });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_ExternalDev01", "_ExternalDev02", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb04", "_ExternalBomb03", "_ExternalBomb05", "_ExternalBomb06" });
    }
}
