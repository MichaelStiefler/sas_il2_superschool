...
public class Ca_310 extends CA_Twins implements TypeBomber, TypeStormovik, TypeTransport {

    public Ca_310() {
        this.bChangedExts = false;
        Ca_310.bChangedPit = true;
    ...
    protected void moveGear(float f) {
        Ca_310.moveGear(this.hierMesh(), f);
    }
    ...
    public void typeBomberAdjSideslipPlus() {
        this.fSightCurSideslip += 0.10000000000000001D;
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            ...
            if (s.startsWith("xxspar")) {
                if ((s.endsWith("lm1") || s.endsWith("lm2")) && (World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) (Aircraft.v1)).x), 0.0F, 1.0F, 1.0F, 0.08F)) && (this.chunkDamageVisible("WingLMid") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if ((s.endsWith("rm1") || s.endsWith("rm2")) && (World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) (Aircraft.v1)).x), 0.0F, 1.0F, 1.0F, 0.08F)) && (this.chunkDamageVisible("WingRMid") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if ((s.endsWith("lo1") || s.endsWith("lo2")) && (World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) (Aircraft.v1)).x), 0.0F, 1.0F, 1.0F, 0.33F)) && (this.chunkDamageVisible("WingLOut") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if ((s.endsWith("ro1") || s.endsWith("ro2")) && (World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) (Aircraft.v1)).x), 0.0F, 1.0F, 1.0F, 0.33F)) && (this.chunkDamageVisible("WingROut") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingROut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if ((s.endsWith("k1") || s.endsWith("k2")) && (World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) (Aircraft.v1)).x), 0.0F, 1.0F, 1.0F, 0.26F)) && (this.chunkDamageVisible("Keel1") > 1) && (this.getEnergyPastArmor(8.6F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
            ...
            if (s.startsWith("xxtank")) {
                ...
                if ((i1 < 4) && (this.getEnergyPastArmor(0.1F, shot) > 0.0F)) {
                    if (shot.power < 14100F) {
                        if (this.FM.AS.astateTankStates[i1] < 1) {
                        ...
                        if ((shot.powerType == 3) && (this.FM.AS.astateTankStates[i1] > 2) && (World.Rnd().nextFloat() < 0.07F)) {
    ...
    public void update(float f) {
        if (this.FM.AS.isMaster() && Config.isUSE_RENDER()) {
            if ((this.FM.CT.PowerControl > 1.0F) && (this.FM.EI.engines[0].getStage() == 6)) {
        ...
        if (this.FM.AS.isMaster() && Config.isUSE_RENDER()) {
            if ((this.FM.CT.PowerControl > 1.0F) && (this.FM.EI.engines[1].getStage() == 6)) {
                this.FM.AS.setSootState(this, 1, 1);
            } else {
    ...
    static {
        Class class1 = Ca_310.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ca.310");
        Property.set(class1, "meshName", "3DO/Plane/Ca-310/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Ca310.fmd:Ca310_FM");
        Property.set(class1, "LOSElevation", 0.73425F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitCa_310.class, CockpitCa310_Bombardier.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 10, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN07", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10", "_BombSpawn11", "_BombSpawn12", "_BombSpawn13", "_BombSpawn14" });
    }
}
