...
public class Junkers_F13Ski extends Scheme1 implements TypeStormovik, TypeBomber, TypeScout {
    ...
    static {
        Class class1 = Junkers_F13Ski.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ju.F13S");
        Property.set(class1, "meshName", "3DO/Plane/Junkers_F13Ski/hier-Ski.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitJunkers_F13Ski.class });
