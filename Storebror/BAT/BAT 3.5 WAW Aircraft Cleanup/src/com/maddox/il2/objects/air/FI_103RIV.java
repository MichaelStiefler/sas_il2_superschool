...
public class FI_103RIV extends Scheme1 implements TypeDockable, MsgCollisionRequestListener {
    ...
    public void onAircraftLoaded() {
        this.FM.M.massEmpty = 1500F;
        this.FM.M.maxWeight = 2177F;
        this.FM.M.fuel *= 1.6873F;
        this.FM.CruiseSpeed = 640F;
        this.FM.Range = 2800F;
        this.FM.AOA_Crit = 15F;
        this.FM.VmaxAllowed = 2000F;
        this.FM.Wingspan = 5.72F;
        this.FM.Length = 8.38F;
        this.FM.CT.bHasFlapsControl = false;
        this.FM.Sq.liftKeel *= 0.67F;
        this.FM.Sq.squareRudders *= 0.67F;
        this.FM.Sq.liftStab *= 0.67F;
        this.FM.Sq.squareElevators *= 0.67F;
        if (this.FM.isPlayers()) {
            this.FM.SensYaw *= 0.67F;
            this.FM.SensPitch *= 0.67F;
        }
    ...
    public void update(float f) {
        ...
        if (this.FM.AS.isMaster()) {
            ...
            if ((this.FM.M.fuel == 0.0F) || this.typeDockableIsDocked()) {
                this.FM.EI.setThrottle(0.0F);
                this.FM.EI.engines[0].setEngineStops(this);
            } else if (this.FM.CT.PowerControl < (this.max_pow / 2.0F)) {
                this.FM.EI.engines[0].setEngineStops(this);
            } else if (this.FM.CT.PowerControl > (this.max_pow / 2.0F)) {
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (flag && (this.FM.AP.way.curr().Action == 3) && this.typeDockableIsDocked() && (Math.abs(((Aircraft) this.queen_).FM.Or.getKren()) < 3F) && (!this.FM.isPlayers() || (this.FM.isPlayers() && (this.FM instanceof RealFlightModel) && !((RealFlightModel) this.FM).isRealMode()))) {
    ...
    private void checkAsDrone() {
        if (this.target_ == null) {
            ...
            if (Actor.isValid(this.target_) && (this.target_ instanceof Wing)) {
                ...
                if ((this.target_ instanceof HE_111H2) || (this.target_ instanceof G4M2E)) {
        ...
        if (Actor.isValid(this.target_) && ((this.target_ instanceof HE_111H2) || (this.target_ instanceof G4M2E) || (this.target_ instanceof HE_111Z) || (this.target_ instanceof FW_200C3U4))) {
    ...
    public void typeDockableAttemptAttach() {
        if (this.FM.AS.isMaster() && !this.typeDockableIsDocked()) {
            ...
            if ((aircraft instanceof HE_111H2) || (this.target_ instanceof G4M2E) || (this.target_ instanceof HE_111Z) || (this.target_ instanceof FW_200C3U4)) {
    ...
    static {
        ...
        Property.set(class1, "iconFar_shortClassName", "V-4");
