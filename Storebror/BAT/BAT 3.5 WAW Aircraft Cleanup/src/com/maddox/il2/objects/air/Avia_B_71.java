...
public class Avia_B_71 extends SB implements TypeBomber {
    ...
    static {
        Class class1 = Avia_B_71.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "B-71");
        Property.set(class1, "meshName", "3DO/Plane/Avia_B-71(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "meshName_de", "3do/Plane/Avia_B-71(de)/hier.him");
        Property.set(class1, "PaintScheme_de", new PaintSchemeBMPar00s());
        Property.set(class1, "meshName_sk", "3do/Plane/Avia_B-71(sk)/hier.him");
        Property.set(class1, "PaintScheme_sk", new PaintSchemeBMPar00s());
        Property.set(class1, "yearService", 1938F);
        Property.set(class1, "yearExpired", 1944F);
        Property.set(class1, "FlightModel", "FlightModels/B-71.fmd:B71_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitSB.class, CockpitAvia_B_71_Bombardier.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10", "_BombSpawn11", "_BombSpawn12", "_BombSpawn13", "_BombSpawn14", "_BombSpawn15", "_BombSpawn16", "_BombSpawn17", "_BombSpawn18", "_BombSpawn19", "_BombSpawn20", "_BombSpawn21", "_BombSpawn22", "_BombSpawn23", "_BombSpawn24", "_BombSpawn25", "_BombSpawn26", "_BombSpawn27" });
    }
}
