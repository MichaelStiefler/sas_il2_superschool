...
public class SPITFIREF22 extends SPITFIRE9 implements TypeFighterAceMaker, TypeBNZFighter {
    ...
    static {
        Class class1 = SPITFIREF22.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "originCountry", PaintScheme.countryBritain);
        Property.set(class1, "iconFar_shortClassName", "Spitfire F Mk.22");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireF22(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar06());
        Property.set(class1, "yearService", 1943F);
        Property.set(class1, "yearExpired", 1946.5F);
        Property.set(class1, "FlightModel", "FlightModels/Spitfire-F22.fmd:SPITF22");
        Property.set(class1, "cockpitClass", new Class[] { CockpitSpitF22.class });
