...
public class SpitfireLFIXe25lbsCWM66DAVID extends SPITFIRE9 {

    public SpitfireLFIXe25lbsCWM66DAVID() {
    }

    static {
        Class var_class = SpitfireLFIXe25lbsCWM66DAVID.class;
        new NetAircraft.SPAWN(var_class);
        Property.set(var_class, "iconFar_shortClassName", "Spit");
        Property.set(var_class, "meshName", "3DO/Plane/SpitfireMkIXeD(Multi1)/hier_cp.him");
        Property.set(var_class, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(var_class, "meshName_gb", "3DO/Plane/SpitfireMkIXeD(GB)/hier_cp.him");
        ...
        Property.set(var_class, "FlightModel", "FlightModels/Spitfire-LF-IXe-M66-25-CW.fmd:SPIT9_FM");
