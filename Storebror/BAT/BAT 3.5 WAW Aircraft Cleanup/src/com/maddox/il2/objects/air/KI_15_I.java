...
public class KI_15_I extends Scheme1 implements TypeScout, TypeBomber, TypeStormovik {
    ...
    protected void moveGear(float f) {
        KI_15_I.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        ...
        Property.set(class1, "meshName", "3DO/Plane/Ki-15-I/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "originCountry", PaintScheme.countryJapan);
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/Ki15I.fmd:Ki15_FM");
