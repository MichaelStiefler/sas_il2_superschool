...
public class Junkers_F13Float_Utility extends Scheme1 implements TypeSeaPlane, TypeBomber, TypeScout {

    public Junkers_F13Float_Utility() {
        Junkers_F13Float_Utility.bChangedPit = true;
        this.setPit(null);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxcontrols")) {
                ...
                if (s.endsWith("li1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLIn") > 2) && (this.getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 4.4F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if (s.endsWith("ri1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingRIn") > 2) && (this.getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 4.4F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if (s.endsWith("lm1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLMid") > 2) && (this.getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 3.3F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if (s.endsWith("rm1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingRMid") > 2) && (this.getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 3.3F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if (s.endsWith("lo1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLOut") > 2) && (this.getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 2.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if (s.endsWith("ro1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingROut") > 2) && (this.getEnergyPastArmor(5.5F * World.Rnd().nextFloat(1.0F, 2.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingROut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if (s.startsWith("xxspart") && (this.chunkDamageVisible("Tail1") > 2) && (this.getEnergyPastArmor(3.86F / (float) Math.sqrt((((Tuple3d) (Aircraft.v1)).y * ((Tuple3d) (Aircraft.v1)).y) + (((Tuple3d) (Aircraft.v1)).z * ((Tuple3d) (Aircraft.v1)).z)), shot) > 0.0F) && (World.Rnd().nextFloat() < 0.15F)) {
    ...
    public CockpitJunkers_F13Float getPit() {
        return this.pit;
    }

    public void setPit(CockpitJunkers_F13Float pit) {
        this.pit = pit;
    }

    private CockpitJunkers_F13Float pit;
    ...
    static {
        Class class1 = Junkers_F13Float_Utility.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ju.F13FU");
        Property.set(class1, "meshName", "3DO/Plane/Junkers_F13Float_Utility/hier-JuF13H.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitJunkers_F13Float_Utility.class });
        Property.set(class1, "FlightModel", "FlightModels/JuF13float.fmd:JuF13float_FM");
