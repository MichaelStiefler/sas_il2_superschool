...
public class TU_2T extends TU_2 implements TypeBomber {
    ...
    protected void moveFlap(float f) {
        ...
        this.hierMesh().chunkSetAngles("Flap02_D0", 0.0F, -15F * f, 0.0F);
        this.hierMesh().chunkSetAngles("Flap03_D0", 0.0F, -15F * f, 0.0F);
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitTU_2S.class, CockpitTU_2S_TGunner.class, CockpitTU_2S_RTGunner.class, CockpitTU_2S_BGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 1, 1, 10, 11, 12, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_CANNON01", "_CANNON02", "_MGUN01", "_MGUN02", "_MGUN03", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_BombSpawn01" });
    }
}
