...
public class SPITFIRE14C extends SPITFIRE implements TypeBNZFighter {
    ...
    protected void moveGear(float f) {
        SPITFIRE14C.moveGear(this.hierMesh(), f);
    }
    ...
    public void moveCockpitDoor(float f) {
        ...
        try {
            if (this.FM.CT.bMoveSideDoor) {
                this.hierMesh().chunkSetAngles("Blister2_D0", 0.0F, 170F * f, 0.0F);
                return;
            }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/SpitfireXIVC.fmd");
