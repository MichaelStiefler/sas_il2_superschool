...
public class Martin_B_10Bfloats extends Martin_B10_Float implements TypeBomber, TypeSeaPlane {
    ...
    static {
        Class class1 = Martin_B_10Bfloats.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/B-10Float.fmd:Martin123_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitB_10B.class, CockpitB10float_Bombardier.class, CockpitIB_10B_FGunner.class, CockpitIB_10B_Topgun.class });
