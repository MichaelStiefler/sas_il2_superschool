...
public class FI_167 extends Scheme1 implements TypeScout, TypeBomber, TypeStormovik {
    ...
    static {
        Class class1 = FI_167.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "FI_167");
        Property.set(class1, "meshName", "3DO/Plane/Fi-167(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1938F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/He45.fmd:He45_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitFi_167.class });
