...
public class TA_152C3 extends TA_152NEW implements TypeX4Carrier, TypeStormovik {
    ...
    protected void moveGear(float f) {
        TA_152C3.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_CANNON01", "_CANNON03", "_CANNON04", "_CANNON05", "_CANNON06", "_ExternalDev01", "_ExternalDev02", "_ExternalRock01", "_ExternalRock01", "_ExternalRock02", "_ExternalRock02", "_ExternalBomb02", "_ExternalBomb03", "_ExternalDev03", "_ExternalDev04", "_ExternalBomb01", "_ExternalBomb04" });
    }
}
