...
public class B4Y1 extends B4Yxyz {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/B4Y1.fmd:B4Y1_FM");
        Property.set(class1, "cockpitClass", new Class[] { Cockpit_RanwersLetovB4Y.class, CockpitB4Y1_TGunner.class });
