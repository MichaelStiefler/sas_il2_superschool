...
public class SPITFIRE5BCLP extends SPITFIRE5 {

    public SPITFIRE5BCLP() {
    }

    static {
        Class class1 = SPITFIRE5BCLP.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/Spitfire-F-Vb-M45-16-CW.fmd");
