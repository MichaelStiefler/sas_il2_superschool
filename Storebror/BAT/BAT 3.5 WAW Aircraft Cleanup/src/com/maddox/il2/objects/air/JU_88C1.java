...
public class JU_88C1 extends JU_88Axx implements TypeFighter, TypeBNZFighter, TypeStormovik {
    ...
    public boolean turretAngles(int i, float af[]) {
        ...
        switch (i) {
            ...
            case 0:
                ...
                } else if (f1 < Aircraft.cvt(f, -40F, -30F, 25F, -5F)) {
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MG1701", "_MG1702", "_MG1703", "_MGFF01", "_BombSpawn15", "_BombSpawn16", "_BombSpawn17", "_BombSpawn18", "_BombSpawn19", "_BombSpawn20", "_BombSpawn21", "_BombSpawn22", "_BombSpawn23", "_BombSpawn24" });
    }
}
