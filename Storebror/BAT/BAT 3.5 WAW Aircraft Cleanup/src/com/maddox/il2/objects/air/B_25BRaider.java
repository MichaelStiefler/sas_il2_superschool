...
public class B_25BRaider extends B_25 implements TypeBomber {
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            if (this.fSightCurDistance < (B_25BRaider.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(B_25BRaider.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
