...
public class P_40F extends P_40 implements TypeStormovik {
    ...
    public void update(float f1) {
        super.update(f1);
        P_40F.f = Aircraft.cvt(this.FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 5F, -17F);
        this.hierMesh().chunkSetAngles("Water2_D0", 0.0F, P_40F.f, 0.0F);
        this.hierMesh().chunkSetAngles("Water3_D0", 0.0F, P_40F.f, 0.0F);
        P_40F.f = Math.min(P_40F.f, 0.0F);
        this.hierMesh().chunkSetAngles("Water1_D0", 0.0F, P_40F.f, 0.0F);
        this.hierMesh().chunkSetAngles("Water4_D0", 0.0F, P_40F.f, 0.0F);
    ...
    static {
        Class class1 = P_40F.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "P-40");
        Property.set(class1, "meshName", "3DO/Plane/P-40F(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar03());
        Property.set(class1, "meshName_us", "3DO/Plane/P-40F(USA)/hier.him");
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_ExternalBomb01", "_ExternalDev01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb08", "_ExternalBomb09" });
    }
}
