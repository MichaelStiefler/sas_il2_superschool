...
public class B_26B extends B26 implements TypeBomber, TypeStormovik, TypeStormovikArmored {
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            if (this.fSightCurDistance < (B_26B.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(B_26B.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
