...
public class P_40L extends P_40 implements TypeStormovik {
    ...
    public void update(float f1) {
        super.update(f1);
        P_40L.f = Aircraft.cvt(this.FM.EI.engines[0].getControlRadiator(), 0.0F, 1.0F, 5F, -17F);
        this.hierMesh().chunkSetAngles("Water2_D0", 0.0F, P_40L.f, 0.0F);
        this.hierMesh().chunkSetAngles("Water3_D0", 0.0F, P_40L.f, 0.0F);
        P_40L.f = Math.min(P_40L.f, 0.0F);
        this.hierMesh().chunkSetAngles("Water1_D0", 0.0F, P_40L.f, 0.0F);
        this.hierMesh().chunkSetAngles("Water4_D0", 0.0F, P_40L.f, 0.0F);
