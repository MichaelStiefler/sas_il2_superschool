...
public class Ca_311M extends CA_Twins2 implements TypeBomber, TypeStormovik, TypeTransport {
    ...
    static {
        Class class1 = Ca_311M.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ca311M");
        Property.set(class1, "meshName", "3DO/Plane/Ca-311M(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Ca311.fmd:Ca311_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitCa_311.class, CockpitCa311M_Bombardier.class });
