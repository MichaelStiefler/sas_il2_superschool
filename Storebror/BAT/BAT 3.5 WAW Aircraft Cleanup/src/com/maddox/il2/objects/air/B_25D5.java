...
public class B_25D5 extends B_25_Strafer implements TypeBomber, TypeStormovik, TypeStormovikArmored {
    ...
    static {
        ...
        try {
            ...
            System.out.println("Error B25D5 'cockpitClass' NOT initialized: " + exception.getMessage());
        }
        Property.set(class1, "LOSElevation", 0.73425F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 0, 0, 0, 0, 11, 11, 9, 9, 9, 9, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 9, 9, 9, 9, 9, 9, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2 });
