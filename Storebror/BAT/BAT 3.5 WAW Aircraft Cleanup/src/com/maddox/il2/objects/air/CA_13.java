...
public class CA_13 extends Scheme1 implements TypeFighter {
    ...
    protected void moveGear(float f) {
        CA_13.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        ...
        Property.set(class1, "meshName", "3DO/Plane/CAC-Boomerangs(Multi1)/hier13.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar02());
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1943F);
        Property.set(class1, "FlightModel", "FlightModels/CA13.fmd:CA12_FM");
