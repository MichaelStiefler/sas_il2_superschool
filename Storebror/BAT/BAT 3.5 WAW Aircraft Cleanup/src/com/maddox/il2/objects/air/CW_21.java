...
public class CW_21 extends CW21xyz {
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
        ...
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, Aircraft.cvt(f1, 0.3F, 0.99F, 0.0F, -82F), 0.0F);
        float f3 = Math.max(-f * 1500F, -94F);
        hiermesh.chunkSetAngles("GearL6_D0", 0.0F, f3, 0.0F);
        hiermesh.chunkSetAngles("GearR6_D0", 0.0F, Math.max(-f1 * 1500F, -94F), 0.0F);
        hiermesh.chunkSetAngles("LLight_D0", 0.0F, f3, 0.0F);
        ...
        Aircraft.ypr[0] = Aircraft.cvt(f2, 0.01F, 0.99F, 0.0F, 75F);
