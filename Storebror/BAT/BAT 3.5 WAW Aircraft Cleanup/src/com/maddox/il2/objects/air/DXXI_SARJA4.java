...
public class DXXI_SARJA4 extends DXXI implements TypeScout {
    ...
    private void customization() {
        ...
        com.maddox.il2.engine.Mat mat = this.hierMesh().material(j);
        String s = mat.Name();
        ...
        if (Config.isUSE_RENDER()) {
            ...
            if (World.cur().camouflage == 1) {
                ...
                if (this.FM.Gears.gWheelSinking[0] > 0.0F) {
                    ...
                    if (this.skiAngleL > ((f4 * -10F) + 0.01D)) {
                        this.skiAngleL -= this.spring;
                    } else if (this.skiAngleL < ((f4 * -10F) - 0.01D)) {
                        this.skiAngleL += this.spring;
                    }
                ...
                if (this.FM.Gears.gWheelSinking[1] > 0.0F) {
                    ...
                    if (this.skiAngleR > ((f4 * -10F) + 0.01D)) {
                        this.skiAngleR -= this.spring;
                    } else if (this.skiAngleR < ((f4 * -10F) - 0.01D)) {
                        this.skiAngleR += this.spring;
                    }
