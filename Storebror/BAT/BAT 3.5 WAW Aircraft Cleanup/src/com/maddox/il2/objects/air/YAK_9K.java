...
public class YAK_9K extends YAK implements TypeStormovik {
    ...
    public void update(float f) {
        ...
        if (Math.abs(this.flapps - f1) > 0.01F) {
            this.flapps = f1;
            this.hierMesh().chunkSetAngles("Wind_luk", 0.0F, 12F * f1, 0.0F);
    ...
    static {
        Class class1 = YAK_9K.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Yak");
        Property.set(class1, "meshName", "3DO/Plane/Yak-9K(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_fr", "3DO/Plane/Yak-9K(Multi1)/hier.him");
