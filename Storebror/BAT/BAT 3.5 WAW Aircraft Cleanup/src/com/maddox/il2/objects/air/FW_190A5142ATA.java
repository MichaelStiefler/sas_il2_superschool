...
public class FW_190A5142ATA extends FW_190 implements TypeFighter, TypeBNZFighter {

    public FW_190A5142ATA() {
    }
    ...
    protected void nextDMGLevel(String s, int i, Actor actor) {
        ...
        if (this.FM.isPlayers()) {
            FW_190A5142ATA.bChangedPit = true;
        }
    }
    ...
    static {
        Class class1 = FW_190A5142ATA.class;
