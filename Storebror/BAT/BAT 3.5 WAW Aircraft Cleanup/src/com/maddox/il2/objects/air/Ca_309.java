...
public class Ca_309 extends CA_Twins implements TypeBomber, TypeStormovik, TypeTransport {
    ...
    protected void moveGear(float f) {
        Ca_309.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Ca309.fmd:Ca309_FM");
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN07", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10", "_BombSpawn11", "_BombSpawn12", "_BombSpawn13", "_BombSpawn14", "_MGUN03" });
    }
}
