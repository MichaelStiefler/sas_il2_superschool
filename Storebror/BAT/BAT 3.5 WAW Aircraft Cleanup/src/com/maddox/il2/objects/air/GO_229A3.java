...
public class GO_229A3 extends GO_229 implements TypeFighterAceMaker, TypeBNZFighter, TypeX4Carrier, TypeStormovik {
    ...
    public void onAircraftLoaded() {
        ...
        this.pos.getRelPoint();
        this.pos.getRelOrient();
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Ho-229A3.fmd:Ho-229A3_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitGO_229A3.class });
        Property.set(class1, "LOSElevation", 0.51305F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 1, 1, 3, 3, 3, 3, 3, 3, 3, 3, 9, 9, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04", "_ExternalBomb01", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb04", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalDev04", "_ExternalRock01", "_ExternalRock01", "_ExternalRock02", "_ExternalRock02", "_ExternalRock03", "_ExternalRock03", "_ExternalRock04", "_ExternalRock04", "_ExternalRock05", "_ExternalRock05", "_ExternalRock06", "_ExternalRock06" });
    }
}
