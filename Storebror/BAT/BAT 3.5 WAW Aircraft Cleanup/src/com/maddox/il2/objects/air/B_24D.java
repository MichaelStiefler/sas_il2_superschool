...
public class B_24D extends B_24 implements TypeBomber {
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            if (this.fSightCurDistance < (B_24D.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(B_24D.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitB_24D.class, CockpitB_24D_Bombardier.class, CockpitB_24D_FGunner.class, CockpitB_24D_TGunner.class, CockpitB_24D_BGunner.class, CockpitB_24D_RGunner.class, CockpitB_24D_LGunner.class, CockpitB_24D_AGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 11, 12, 12, 13, 14, 15, 15, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_MGUN10", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08" });
    }
}
