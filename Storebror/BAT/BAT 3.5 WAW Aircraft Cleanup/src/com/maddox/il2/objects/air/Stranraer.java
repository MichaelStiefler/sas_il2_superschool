...
public class Stranraer extends StranraerX implements TypeBomber {
    ...
    static {
        Class class1 = Stranraer.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Stranraer");
        Property.set(class1, "meshName", "3DO/Plane/Stranraer/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPBY.class, CockpitPBY_Bombardier.class, CockpitStranraer_TGunner.class, CockpitStranraer_NGunner.class });
