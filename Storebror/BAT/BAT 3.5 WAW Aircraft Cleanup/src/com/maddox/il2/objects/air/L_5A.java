...
public class L_5A extends Scheme1 implements TypeScout, TypeTransport, TypeFighter {
    ...
    public void moveWheelSink() {
        ...
        this.hierMesh().chunkSetAngles("GearL2_D0", 0.0F, AircraftLH.floatindex(f, L_5A.gearL2), 0.0F);
        ...
        this.hierMesh().chunkSetAngles("GearR2_D0", 0.0F, -AircraftLH.floatindex(f, L_5A.gearL2), 0.0F);
    }
    ...
    static {
        Class class1 = L_5A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "L-5");
        Property.set(class1, "meshName", "3DO/Plane/L-5A/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "originCountry", PaintScheme.countryUSA);
        Property.set(class1, "yearService", 1940.9F);
        Property.set(class1, "yearExpired", 1955.3F);
        Property.set(class1, "FlightModel", "FlightModels/L5Sentinel.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitL_5.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 9, 9, 9, 9, 2, 2, 2, 2, 1, 1, 1, 1, 1, 1, 1, 1, 1 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalDev04", "_ExternalRock01", "_ExternalRock02", "_ExternalRock03", "_ExternalRock04", "_CANNON01", "_CANNON02", "_CANNON03", "_CANNON04", "_CANNON05", "_CANNON06", "_CANNON07", "_CANNON08", "_CANNON09" });
    }
}
