...
public class HE_111H8 extends HE_111 {
    ...
    public void update(float f) {
        ...
        if (this.FM.AS.astatePlayerIndex == 3) {
            if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[3]) {
                this.SturmanBusy(3);
            } else if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[4]) {
                this.SturmanBusy(4);
            }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/He-111H-8.fmd:HE111");
