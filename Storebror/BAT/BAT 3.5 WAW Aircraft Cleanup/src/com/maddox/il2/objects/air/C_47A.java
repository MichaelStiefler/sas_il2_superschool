...
public class C_47A extends Scheme2 implements TypeTransport, TypeBomber {
    ...
    public void msgShot(Shot shot) {
        ...
        if (shot.chunkName.startsWith("Tail") && (Aircraft.Pd.x < -5.8000001907348633D) && (Aircraft.Pd.x > -6.7899999618530273D) && (Aircraft.Pd.z > -0.44900000000000001D) && (Aircraft.Pd.z < 0.12399999797344208D)) {
    ...
    static {
        Class class1 = C_47A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Skytrain");
        Property.set(class1, "meshNameDemo", "3DO/Plane/C-47AB(USA)/hier.him");
        Property.set(class1, "meshName", "3DO/Plane/C-47AB(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "meshName_us", "3DO/Plane/C-47AB(USA)/hier.him");
        Property.set(class1, "PaintScheme_us", new PaintSchemeBMPar04());
        Property.set(class1, "originCountry", PaintScheme.countryUSA);
        Property.set(class1, "noseart", 1);
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 2999.9F);
        Property.set(class1, "FlightModel", "FlightModels/C-47A.fmd");
