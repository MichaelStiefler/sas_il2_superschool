...
public class Hudson_MkI extends Hudson123 implements TypeStormovik, TypeBomber {
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = Hudson_MkI.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= Hudson_MkI.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / Hudson_MkI.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (Hudson_MkI.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(Hudson_MkI.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
    ...
    static {
        Class class1 = Hudson_MkI.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Hudson");
        Property.set(class1, "meshName", "3DO/Plane/HudsonMkI(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Hudson_MkI.fmd:Hudsons_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHudsonMkI.class, CockpitHudsonMkI_Bombardier.class, CockpitHudson_TGunner.class });
