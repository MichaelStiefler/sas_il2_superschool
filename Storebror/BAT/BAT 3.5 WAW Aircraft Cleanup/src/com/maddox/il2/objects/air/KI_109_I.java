...
public class KI_109_I extends KI_109 implements TypeFighter {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Ki109.fmd:Ki109_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitKI_109.class, CockpitKI_109_TGunner.class });
        Property.set(class1, "LOSElevation", 1.4078F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 10 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_CANNON01", "_MGUN01" });
    }
}
