...
public class HE_111P4 extends HE_111 {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        } else if (s.equals("xxengine1arm")) {
            this.getEnergyPastArmor(6F, shot);
        } else if (s.equals("xxengine2arm")) {
            this.getEnergyPastArmor(6F, shot);
    ...
    public void update(float f) {
        ...
        if (this.FM.AS.astatePlayerIndex == 1) {
            if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[1]) {
                ...
                this.SturmanBusy(2);
            } else if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[3]) {
                this.SturmanBusy(3);
            }
        ...
        if (this.FM.AS.astatePlayerIndex == 3) {
            if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[5]) {
                this.SturmanBusy(5);
            } else if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[6]) {
                this.SturmanBusy(6);
            }
            ...
            if (this.FM.turret.length != 0) {
                ...
                if (actor1 == null) {
                    actor1 = this.FM.turret[5].target;
                }
                if (actor1 != null) {
                    if (Actor.isValid(actor1)) {
                        ...
                        Aircraft.tmpLoc2.transformInv(Aircraft.tmpLoc3.getPoint());
                        if (Aircraft.tmpLoc3.getPoint().x > 0.0D) {
                            this.SturmanBusy(6);
                        } else {
                            this.SturmanBusy(5);
                        }
        ...
        if (this.FM.AS.astatePlayerIndex == 4) {
            if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[8]) {
                this.SturmanBusy(8);
            } else if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[7]) {
                this.SturmanBusy(7);
            }
            ...
            if (this.FM.turret.length != 0) {
                ...
                if (actor2 == null) {
                    actor2 = this.FM.turret[4].target;
                }
                if (actor2 != null) {
    ...
    public void hitDaSilk() {
        ...
        if ((this.FM.AS.astatePilotStates[2] < 95) && (this.FM.CT.getCockpitDoor() < 0.01F)) {
            this.FM.AS.setCockpitDoor(this, 1);
        }
        super.hitDaSilk();
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/He-111P-4.fmd:HE111");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHE_111P4.class, CockpitHE_111P4_Bombardier.class, CockpitHE_111P4_NGunner.class, CockpitHE_111P4_NBGunner.class, CockpitHE_111P4_TGunner.class, CockpitHE_111P4_BGunner.class, CockpitHE_111P4_FGunner.class, CockpitHE_111P4_LGunner.class, CockpitHE_111P4_RGunner.class });
