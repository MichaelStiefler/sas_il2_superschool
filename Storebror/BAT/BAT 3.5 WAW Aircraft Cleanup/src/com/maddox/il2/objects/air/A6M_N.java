...
public class A6M_N extends JC_A6M implements TypeSailPlane {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 2; j++) {
                if (this.FM.Gears.clpGearEff[i][j] != null) {
                    A6M_N.tmpp.set(this.FM.Gears.clpGearEff[i][j].pos.getAbsPoint());
                    A6M_N.tmpp.z = 0.01D;
                    this.FM.Gears.clpGearEff[i][j].pos.setAbs(A6M_N.tmpp);
    ...
    static {
        Class class1 = A6M_N.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "A6M");
        Property.set(class1, "meshName", "3DO/Plane/A6M-N(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar01());
        Property.set(class1, "meshName_ja", "3DO/Plane/A6M-N(ja)/hier.him");
