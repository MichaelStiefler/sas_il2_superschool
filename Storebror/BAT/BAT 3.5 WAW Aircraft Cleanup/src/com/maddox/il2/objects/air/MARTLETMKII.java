...
public class MARTLETMKII extends F4F {

    public MARTLETMKII() {
    }

    static {
        Class class1 = MARTLETMKII.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F4F");
        Property.set(class1, "meshName", "3DO/Plane/MartletMkII/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar03());
        Property.set(class1, "yearService", 1942F);
        Property.set(class1, "yearExpired", 1948.5F);
        Property.set(class1, "FlightModel", "FlightModels/MartletMkII.fmd:MARTLET");
        Property.set(class1, "cockpitClass", new Class[] { CockpitMARTLETMKII.class });
