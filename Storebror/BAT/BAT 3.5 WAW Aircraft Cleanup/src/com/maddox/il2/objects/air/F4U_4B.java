...
public class F4U_4B extends F4U implements TypeFighter, TypeStormovik {
    ...
    static {
        Class class1 = F4U_4B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F4U4");
        Property.set(class1, "meshName", "3DO/Plane/F4U4B(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_us", "3DO/Plane/F4U4B(USA)/hier.him");
        ...
        Property.set(class1, "FlightModel", "FlightModels/F4U-4B.fmd:F4ULate_FM");
