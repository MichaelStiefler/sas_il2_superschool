...
public class JU_88A4Late extends JU_88Axx implements TypeBomber, TypeDiveBomber, TypeScout {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.endsWith("RustA")) {
            ...
            if (this.thisWeaponsName.endsWith("1xTank900L_RustB")) {
                f1 += 45F;
            } else if (this.thisWeaponsName.endsWith("2xTank900L_RustB")) {
                f1 += 110F;
            }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Ju-88A-4Late.fmd:Ju-88A-4Late");
        Property.set(class1, "cockpitClass", new Class[] { CockpitJU_88A4Late.class, CockpitJU_88A4Late_Bombardier.class, CockpitJU_88A4Late_NGunner.class, CockpitJU_88A4Late_LGunner.class, CockpitJU_88A4Late_RGunner.class, CockpitJU_88A4Late_BGunner.class });
