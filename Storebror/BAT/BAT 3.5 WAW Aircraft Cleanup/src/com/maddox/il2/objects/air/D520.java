...
public class D520 extends Scheme1 implements TypeFighter {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                if (s.endsWith("p1")) {
                    this.getEnergyPastArmor(14.2F / (1E-005F + (float) Math.abs(((Tuple3d) (Aircraft.v1)).x)), shot);
                }
                return;
            }
            ...
            if (s.startsWith("xxspar")) {
                ...
                if (s.startsWith("xxsparli") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLIn") > 2) && (this.getEnergyPastArmor(9.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingLIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparri") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingRIn") > 2) && (this.getEnergyPastArmor(9.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingRIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlm") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLMid") > 2) && (this.getEnergyPastArmor(9.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparrm") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingRMid") > 2) && (this.getEnergyPastArmor(9.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlo") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLOut") > 2) && (this.getEnergyPastArmor(9.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if (s.startsWith("xxsparro") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingROut") > 2) && (this.getEnergyPastArmor(9.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/D520.fmd:D520");
