...
public class TFX extends BEAU implements TypeFighter, TypeStormovik {

    public TFX() {
    }

    static {
        Class class1 = TFX.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Beaufighter");
        Property.set(class1, "meshName", "3DO/Plane/TFX(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "meshName_gb", "3DO/Plane/TFX(GB)/hier.him");
