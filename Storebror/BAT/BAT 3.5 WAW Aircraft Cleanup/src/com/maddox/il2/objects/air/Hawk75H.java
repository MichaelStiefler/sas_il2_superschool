    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            ...
            if (s.startsWith("xxspar")) {
                if (s.endsWith("li1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLIn") > 2) && (this.getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if (s.endsWith("ri1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingRIn") > 2) && (this.getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if (s.endsWith("lm1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLMid") > 2) && (this.getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if (s.endsWith("rm1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingRMid") > 2) && (this.getEnergyPastArmor(8.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if (s.endsWith("lo1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingLOut") > 2) && (this.getEnergyPastArmor(4.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if (s.endsWith("ro1") && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(((Tuple3d) (Aircraft.v1)).x)))) && (this.chunkDamageVisible("WingROut") > 2) && (this.getEnergyPastArmor(4.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
