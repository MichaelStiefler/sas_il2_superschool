...
public class HalifaxBMkII extends Scheme4 implements TypeBomber, TypeTransport {
    ...
    protected void moveGear(float f) {
        HalifaxBMkII.moveGear(this.hierMesh(), f);
    }
    ...
    public void typeBomberAdjDistancePlus() {
        ...
        this.fSightCurDistance = HalifaxBMkII.toMeters(this.fSightCurAltitude) * (float) Math.tan(Math.toRadians(this.fSightCurForwardAngle));
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            this.fSightCurDistance -= HalifaxBMkII.toMetersPerSecond(this.fSightCurSpeed) * f;
            if (this.fSightCurDistance < 0.0F) {
                this.fSightCurDistance = 0.0F;
                this.typeBomberToggleAutomation();
            }
            this.fSightCurForwardAngle = (float) Math.toDegrees(Math.atan(this.fSightCurDistance / HalifaxBMkII.toMeters(this.fSightCurAltitude)));
            if (this.fSightCurDistance < (HalifaxBMkII.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(HalifaxBMkII.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
    ...
    static {
        Class class1 = HalifaxBMkII.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "HalifaxII");
        Property.set(class1, "meshName", "3DO/Plane/HalifaxBMkII/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "originCountry", PaintScheme.countryRussia);
        Property.set(class1, "yearService", 1940F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/Lancaster.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHalifaxBMkII.class, CockpitHalifaxBMkII_Bombardier.class, CockpitHalifaxBMkII_NGunner.class, CockpitHalifaxBMkII_TGunner.class, CockpitHalifaxBMkII_AGunner.class });
