...
public class HE_111H16 extends HE_111 {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("1x")) {
            ...
            this.hierMesh().chunkVisible("PVC1006_L", false);
        }
        ...
        if (this.thisWeaponsName.startsWith("1xSC2500_F1790")) {
            this.FM.CT.bHasBayDoorControl = false;
        } else if (this.thisWeaponsName.startsWith("1xSC2000_F1790")) {
            this.FM.CT.bHasBayDoorControl = false;
        } else if (this.thisWeaponsName.startsWith("1xSC1800_F2425")) {
            this.FM.CT.bHasBayDoorControl = false;
        } else if (this.thisWeaponsName.startsWith("1xPC1600_F2555")) {
            this.FM.CT.bHasBayDoorControl = false;
        } else if (this.thisWeaponsName.startsWith("1xAB1000_F3175")) {
            this.FM.CT.bHasBayDoorControl = false;
        } else if (this.thisWeaponsName.startsWith("1xSC1000_F3000")) {
            this.FM.CT.bHasBayDoorControl = false;
        }
        for (int i = 0; i < 2; i++) {
            try {
    ...
    public void update(float f) {
        ...
        if (this.FM.AS.astatePlayerIndex == 4) {
            if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[6]) {
                this.SturmanBusy(6);
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/He-111H-16.fmd:HE111");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHE_111H11.class, CockpitHE_111H11_Bombardier.class, CockpitHE_111H11_NGunner.class, CockpitHE_111H16_TGunner.class, CockpitHE_111H16_BGunner.class, CockpitHE_111H16_LGunner.class, CockpitHE_111H16_RGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 13, 14, 12, 13, 14, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08" });
    }
}
