...
public class Fokker_DXXIII extends Scheme2 implements TypeFighter {
    ...
    public void moveCockpitDoor(float f) {
        if (f > this.canopyF) {
            if ((this.FM.Gears.onGround() && (this.FM.getSpeed() < 5F)) || (this.tiltCanopyOpened && (this.FM.isPlayers() || this.isNetPlayer()))) {
                ...
                this.hierMesh().chunkSetAngles("Blister1L", 0.0F, -f * 155F, 0.0F);
            } else {
                this.resetYPRmodifier();
                this.slideCanopyOpened = true;
                Aircraft.xyz[1] = f * 0.265F;
                this.hierMesh().chunkSetLocate("Blister2L", Aircraft.xyz, Aircraft.ypr);
            }
        } else if ((this.FM.Gears.onGround() && (this.FM.getSpeed() < 5F) && !this.slideCanopyOpened) || this.tiltCanopyOpened) {
            this.hierMesh().chunkSetAngles("Blister1L", 0.0F, -f * 155F, 0.0F);
            if ((this.FM.getSpeed() > 50F) && (f < 0.6F) && !this.blisterRemoved[0]) {
    ...
    public void hitDaSilk() {
        super.hitDaSilk();
        if ((!this.blisterRemoved[0] || !this.blisterRemoved[1]) && this.FM.AS.bIsAboutToBailout && !this.FM.AS.isPilotDead(0)) {
    ...
    private final void doRemoveBlisterFull() {
        if (this.hierMesh().chunkFindCheck("Blister1_D0") != -1) {
            ...
            if (!this.blisterRemoved[0]) {
                Wreckage wreckage = new Wreckage(this, this.hierMesh().chunkFind("Blister1L"));
                wreckage.collide(true);
                Vector3d vector3d = new Vector3d();
                vector3d.set(this.FM.Vwld);
                wreckage.setSpeed(vector3d);
                wreckage = new Wreckage(this, this.hierMesh().chunkFind("Blister2L"));
                wreckage.collide(true);
                vector3d = new Vector3d();
                vector3d.set(this.FM.Vwld);
                wreckage.setSpeed(vector3d);
                this.blisterRemoved[0] = true;
            }
            if (!this.blisterRemoved[1]) {
                Wreckage wreckage1 = new Wreckage(this, this.hierMesh().chunkFind("Blister1R"));
                wreckage1.collide(true);
                Vector3d vector3d1 = new Vector3d();
                vector3d1.set(this.FM.Vwld);
                wreckage1.setSpeed(vector3d1);
                this.blisterRemoved[1] = true;
            }
        }
    }
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2, float af[]) {
        ...
        hiermesh.chunkSetAngles("GearC9_D0", 0.0F, Aircraft.cvt(f2, 0.1F + af[2], 0.85F + af[2], 0.0F, 1.0F), 0.0F);
        Aircraft.xyz[1] = Aircraft.cvt(f2, 0.1F + af[2], 0.85F + af[2], 0.0F, 0.09F);
        hiermesh.chunkSetLocate("GearC10_D0", Aircraft.xyz, Aircraft.ypr);
        hiermesh.chunkSetAngles("GearC11_D0", 0.0F, Aircraft.cvt(f2, 0.1F + af[2], 0.2F + af[2], 0.0F, 100F), 0.0F);
        hiermesh.chunkSetAngles("GearC12_D0", 0.0F, Aircraft.cvt(f2, 0.1F + af[2], 0.2F + af[2], 0.0F, -100F), 0.0F);
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, Aircraft.cvt(f, 0.1F + af[0], 0.85F + af[0], 0.0F, -86F), 0.0F);
        hiermesh.chunkSetAngles("GearL10_D0", 0.0F, Aircraft.cvt(f, 0.1F + af[0], 0.2071F + af[0], 0.0F, -110F), 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, Aircraft.cvt(f1, 0.1F + af[1], 0.85F + af[1], 0.0F, -86F), 0.0F);
        hiermesh.chunkSetAngles("GearR10_D0", 0.0F, Aircraft.cvt(f1, 0.1F + af[1], 0.2071F + af[1], 0.0F, -110F), 0.0F);
    }
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (this.tiltCanopyOpened && !this.blisterRemoved[0] && (this.FM.getSpeed() > 75F)) {
            this.doRemoveBlisterLeft();
        }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                if (s.endsWith("p1")) {
                    this.getEnergyPastArmor(35.890000000000001D / (Math.abs(Aircraft.v1.x) + 0.0001D), shot);
                    if (shot.power <= 0.0F) {
                        this.doRicochetBack(shot);
                    }
                } else if (s.endsWith("p2")) {
                    this.getEnergyPastArmor(12.710000000000001D, shot);
                } else if (s.endsWith("p3")) {
                    this.getEnergyPastArmor(12.710000000000001D / (Math.abs(Aircraft.v1.x) + 0.0001D), shot);
                }
                return;
            }
