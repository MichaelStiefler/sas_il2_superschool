...
public class SPITFIRE5C2FB extends SPITFIRE {
    ...
    protected void moveGear(float f) {
        SPITFIRE5C2FB.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = SPITFIRE5C2FB.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Spit");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireMkVcFB(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "meshName_gb", "3DO/Plane/SpitfireMkVcFB(GB)/hier.him");
