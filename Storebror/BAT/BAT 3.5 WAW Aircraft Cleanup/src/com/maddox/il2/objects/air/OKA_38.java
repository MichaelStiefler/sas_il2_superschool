...
public class OKA_38 extends Scheme1 implements TypeScout, TypeTransport {
    ...
    public void moveWheelSink() {
        ...
        this.hierMesh().chunkSetAngles("GearL1_D0", 0.0F, AircraftLH.floatindex(f, OKA_38.gearL1), 0.0F);
        this.hierMesh().chunkSetAngles("GearL2_D0", 0.0F, AircraftLH.floatindex(f, OKA_38.gearL2), 0.0F);
        this.hierMesh().chunkSetAngles("GearL4_D0", 0.0F, AircraftLH.floatindex(f, OKA_38.gearL4), 0.0F);
        this.hierMesh().chunkSetAngles("GearL5_D0", 0.0F, AircraftLH.floatindex(f, OKA_38.gearL5), 0.0F);
        ...
        this.hierMesh().chunkSetAngles("GearR1_D0", 0.0F, -AircraftLH.floatindex(f, OKA_38.gearL1), 0.0F);
        this.hierMesh().chunkSetAngles("GearR2_D0", 0.0F, -AircraftLH.floatindex(f, OKA_38.gearL2), 0.0F);
        this.hierMesh().chunkSetAngles("GearR4_D0", 0.0F, -AircraftLH.floatindex(f, OKA_38.gearL4), 0.0F);
        this.hierMesh().chunkSetAngles("GearR5_D0", 0.0F, -AircraftLH.floatindex(f, OKA_38.gearL5), 0.0F);
    }
    ...
    private void sfxInitNew() {
        if (this.sndRoot != null) {
            SectFile sectfile = new SectFile("presets/sounds/aircraft.oka.prs");
        ...
        if (this.lLight == null) {
            ...
            for (int j = 0; j < 4; j++) {
                if (this.FM.AS.astateLandingLightEffects[j] != null) {
                    OKA_38.lLightLoc1.set(0.0D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
                    this.lLightHook[j].computePos(this, Actor._tmpLoc, OKA_38.lLightLoc1);
                    OKA_38.lLightLoc1.get(OKA_38.lLightP1);
                    OKA_38.lLightLoc1.set(2000D, 0.0D, 0.0D, 0.0F, 0.0F, 0.0F);
                    this.lLightHook[j].computePos(this, Actor._tmpLoc, OKA_38.lLightLoc1);
                    OKA_38.lLightLoc1.get(OKA_38.lLightP2);
                    Engine.land();
                    if (Landscape.rayHitHQ(OKA_38.lLightP1, OKA_38.lLightP2, OKA_38.lLightPL)) {
                        OKA_38.lLightPL.z++;
                        OKA_38.lLightP2.interpolate(OKA_38.lLightP1, OKA_38.lLightPL, 0.95F);
                        this.lLight[j].setPos(OKA_38.lLightP2);
                        float f = (float) OKA_38.lLightP1.distance(OKA_38.lLightPL);
                        float f1 = (f * 0.5F) + 60F;
    ...
    private static final float gearL1[]   = { 0.0F, 3F, 8F, 15F, 20F, 25F };
    ...
    static {
        Class class1 = OKA_38.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "OKA-38");
        Property.set(class1, "meshName", "3do/plane/OKA-38/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "originCountry", PaintScheme.countryRussia);
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 1956F);
        Property.set(class1, "FlightModel", "FlightModels/OKA38.fmd:OKA38");
        Property.set(class1, "cockpitClass", new Class[] { CockpitOKA_38.class });
