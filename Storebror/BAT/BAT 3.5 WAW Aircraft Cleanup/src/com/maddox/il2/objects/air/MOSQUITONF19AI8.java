...
public class MOSQUITONF19AI8 extends MOSQUITO implements TypeFighter, TypeStormovik {

    public MOSQUITONF19AI8() {
    }

    static {
        Class class1 = MOSQUITONF19AI8.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/Mosquito-NFMkXIX.fmd:NF19MRL25");
