...
public class D3A2 extends D3A implements TypeDiveBomber, TypeBomber {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitD3A2.class, CockpitD3A2_Bombardier.class, CockpitD3A2_TGunner.class });
