...
public class SPITFIRE5C2LFCLP extends SPITFIRE {

    public SPITFIRE5C2LFCLP() {
    }
    ...
    static {
        Class class1 = SPITFIRE5C2LFCLP.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Spit");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireMkVcLFCLP(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "meshName_gb", "3DO/Plane/SpitfireMkVcLFCLP(GB)/hier.him");
