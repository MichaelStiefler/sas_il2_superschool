...
public class KI_43_IC extends KI_43 {
    ...
    static {
        Class class1 = KI_43_IC.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ki-43");
        Property.set(class1, "meshName", "3DO/Plane/Ki-43-Ic(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_ja", "3DO/Plane/Ki-43-Ic(ja)/hier.him");
