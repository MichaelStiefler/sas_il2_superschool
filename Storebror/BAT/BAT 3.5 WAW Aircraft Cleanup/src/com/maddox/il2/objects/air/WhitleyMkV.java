...
public class WhitleyMkV extends WhitleyBombers implements TypeBomber {
    ...
    static {
        Class class1 = WhitleyMkV.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Whitley");
        Property.set(class1, "meshName", "3DO/Plane/WhitleyMkV(Multi1)/hier.him");
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitWhitley.class, CockpitWhitley_Bombardier.class, CockpitWhitley_AGunner.class, CockpitWhitley_FGunner.class });
