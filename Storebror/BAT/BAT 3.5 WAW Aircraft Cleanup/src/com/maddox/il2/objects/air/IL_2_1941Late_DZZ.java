...
public class IL_2_1941Late_DZZ extends IL_2 {

    public IL_2_1941Late_DZZ() {
    }
    ...
    public void doMurderPilot(int i) {
        if (i == 1) {
            ...
            this.hierMesh().chunkVisible("Turret1A_D1", false);
    ...
    static {
        Class class1 = IL_2_1941Late_DZZ.class;
