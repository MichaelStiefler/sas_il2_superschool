...
public class Ju_87A1 extends JU_87 {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.equals("1xSC500")) {
    ...
    static {
        Class class1 = Ju_87A1.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ju87A");
        Property.set(class1, "meshName", "3do/Plane/Ju-87B-2/hierA1.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "yearService", 1934F);
        Property.set(class1, "yearExpired", 1942F);
        Property.set(class1, "FlightModel", "FlightModels/Ju-87A-1.fmd:Ju87A_FM");
