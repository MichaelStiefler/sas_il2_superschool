...
public class SpitfireFIXcEarlyM63DAVID extends SPITFIRE9 {

    public SpitfireFIXcEarlyM63DAVID() {
    }

    static {
        Class var_class = SpitfireFIXcEarlyM63DAVID.class;
        new NetAircraft.SPAWN(var_class);
        Property.set(var_class, "iconFar_shortClassName", "Spit");
        Property.set(var_class, "meshName", "3DO/Plane/SpitfireMkIXcD(Multi1)/hier_early.him");
        Property.set(var_class, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(var_class, "meshName_gb", "3DO/Plane/SpitfireMkIXcD(GB)/hier_early.him");
        ...
        Property.set(var_class, "FlightModel", "FlightModels/Spitfire-F-IXc-M63-18.fmd:SPIT9_FM");
