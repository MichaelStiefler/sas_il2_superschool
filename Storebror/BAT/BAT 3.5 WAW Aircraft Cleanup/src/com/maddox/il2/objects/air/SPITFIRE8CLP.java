...
public class SPITFIRE8CLP extends SPITFIRE {
    ...
    protected void moveGear(float f) {
        SPITFIRE8CLP.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_CANNON01", "_CANNON02", "_ExternalDev08" });
    }
}
