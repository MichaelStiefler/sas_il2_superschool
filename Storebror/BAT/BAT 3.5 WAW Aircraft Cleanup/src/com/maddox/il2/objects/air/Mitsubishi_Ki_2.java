...
public class Mitsubishi_Ki_2 extends KI2_cde implements TypeBomber, TypeTransport {
    ...
    static {
        Class class1 = Mitsubishi_Ki_2.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ki-2");
        Property.set(class1, "meshName", "3DO/Plane/Mitsubishi-Ki-2(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Mitsubishi-Ki-2.fmd:Mitsubishi_Ki2_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitKi2Front.class, CockpitKI_2_Bombardier.class });
        Property.set(class1, "LOSElevation", 0.73425F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
