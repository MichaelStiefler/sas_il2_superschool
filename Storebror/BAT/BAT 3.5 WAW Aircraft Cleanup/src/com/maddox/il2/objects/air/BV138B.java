...
public class BV138B extends BV138abc implements TypeScout, TypeBomber, TypeSeaPlane {
    ...
    static {
        Class class1 = BV138B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "BV138B");
        Property.set(class1, "meshName", "3DO/Plane/BV138B/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/BV138M.fmd:BV138s_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitBV138B.class, CockpitBV138_FGunner.class, CockpitBV138_TGunner.class, CockpitBV138_RGunner.class });
