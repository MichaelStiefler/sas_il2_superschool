...
public class SpitfireMKVc2Land extends SPITFIRE {

    public SpitfireMKVc2Land() {
    }
    ...
    protected void moveGear(float f) {
        SpitfireMKVc2Land.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class var_class = SpitfireMKVc2Land.class;
        new NetAircraft.SPAWN(var_class);
        Property.set(var_class, "iconFar_shortClassName", "Spit");
        Property.set(var_class, "meshName", "3DO/Plane/SpitfireMkVc2Land(Multi1)/hier.him");
        Property.set(var_class, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(var_class, "meshName_gb", "3DO/Plane/SpitfireMkVc2Land(GB)/hier.him");
