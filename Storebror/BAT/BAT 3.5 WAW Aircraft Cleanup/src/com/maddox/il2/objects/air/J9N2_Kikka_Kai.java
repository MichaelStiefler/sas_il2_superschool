...
public class J9N2_Kikka_Kai extends KikkaKai123 implements TypeFighter, TypeBNZFighter {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Kikka_Kai.fmd:Kikka_Kai_FM");
        Property.set(class1, "cockpitClass", new Class[] { Cockpit_KikkaKai.class });
