...
public class Ju_F13 extends Scheme1 implements TypeStormovik, TypeBomber, TypeScout, TypeTransport {

    public Ju_F13() {
        Ju_F13.bChangedPit = true;
    }

    public void registerPit(CockpitJu_F13 cockpitju_f13) {
    }
    ...
    static {
        Class class1 = Ju_F13.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ju.F13");
        Property.set(class1, "meshName", "3DO/Plane/Ju_F13(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitJu_F13.class, CockpitJu_F13_Bombardier.class });
