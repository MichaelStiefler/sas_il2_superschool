...
public class ME_262A2NJ extends ME_262B implements TypeX4Carrier, TypeRadarLiSN2Carrier {
    ...
    public void movePilotsHead(float f, float f1) {
        if (Config.isUSE_RENDER() && ((this.headTp < f1) || (this.headTm > f1) || (this.headYp < f) || (this.headYm > f))) {
            ...
            f *= 0.7F;
            f1 *= 0.7F;
            ME_262A2NJ.tmpOrLH.setYPR(0.0F, 0.0F, 0.0F);
            ME_262A2NJ.tmpOrLH.increment(0.0F, f, 0.0F);
            ME_262A2NJ.tmpOrLH.increment(f1, 0.0F, 0.0F);
            ME_262A2NJ.tmpOrLH.increment(0.0F, 0.0F, (-0.2F * f1) + (0.05F * f));
            this.headOr[0] = ME_262A2NJ.tmpOrLH.getYaw();
            this.headOr[1] = ME_262A2NJ.tmpOrLH.getPitch();
            this.headOr[2] = ME_262A2NJ.tmpOrLH.getRoll();
