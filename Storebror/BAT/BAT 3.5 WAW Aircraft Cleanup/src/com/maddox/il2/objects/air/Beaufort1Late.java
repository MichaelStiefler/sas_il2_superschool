...
public class Beaufort1Late extends Beaufort {

    public Beaufort1Late() {
    }
    ...
    static {
        Class class1 = Beaufort1Late.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Beaufort");
        Property.set(class1, "meshName", "3DO/Plane/Beaufort/hierLate.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar09gb());
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/Beaufort_MkI_late.fmd");
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_ExternalBomb01", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10", "_BombSpawn11", "_BombSpawn12", "_BombSpawn13", "_BombSpawn14" });
    }
}
