...
public class FW_190A6LULU extends FW_190 implements TypeFighter, TypeBNZFighter {
    ...
    public void onAircraftLoaded() {
        ...
        if (!(this.getGunByHookName("_CANNON05") instanceof GunEmpty)) {
            this.hierMesh().chunkVisible("FuG125L_D0", false);
            this.hierMesh().chunkVisible("FuG125R_D0", false);
            this.hierMesh().chunkVisible("FuG1251_D0", false);
            this.hierMesh().chunkVisible("FuG1252_D0", false);
            this.hierMesh().chunkVisible("Deflect_D0", false);
            this.hierMesh().chunkVisible("FuG217L_D0", true);
            this.hierMesh().chunkVisible("FuG217R_D0", true);
        }
        if (!(this.getGunByHookName("_CANNON06") instanceof GunEmpty)) {
            this.hierMesh().chunkVisible("FuG125L_D0", false);
            this.hierMesh().chunkVisible("FuG125R_D0", false);
            this.hierMesh().chunkVisible("FuG1251_D0", false);
            this.hierMesh().chunkVisible("FuG1252_D0", false);
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/fw-190a6_RLP.fmd");
