...
public class FA_223 extends Scheme1 implements TypeScout, TypeTransport, TypeStormovik {
    ...
    public void computeVerticalThrust() {
        ...
        float f1 = Pitot.Indicator((float) ((Tuple3d) (((FlightModelMain) (this.FM)).Loc)).z, this.FM.getSpeed()) * 3.6F;
    ...
    static {
        Class class1 = FA_223.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Fa223");
        Property.set(class1, "meshName", "3DO/Plane/FA-223/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "yearService", 1950F);
        Property.set(class1, "yearExpired", 1960.5F);
        Property.set(class1, "FlightModel", "FlightModels/FA223A.fmd:FA223FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitFA_223.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 9, 9, 9, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1 });
        Aircraft.weaponTriggersRegister(class1, new int[] { 3, 3, 0, 0, 9, 9, 9, 2, 2, 9, 2, 2, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_BombSpawn01", "_BombSpawn02", "_MGUN01", "_MGUN02", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalRock01", "_ExternalRock02", "_ExternalDev04", "_ExternalRock03", "_ExternalRock04", "_BombSpawn03", "_BombSpawn04" });
    }
}
