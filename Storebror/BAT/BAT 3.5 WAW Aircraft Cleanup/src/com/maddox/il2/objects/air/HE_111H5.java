...
public class HE_111H5 extends HE_111 {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("OnePVC")) {
            this.hierMesh().chunkVisible("PVC1006_R", false);
            this.FM.M.massEmpty -= 40F;
            if (this.thisWeaponsName.startsWith("OnePVC_1xSC2500")) {
                this.FM.M.fuel = (this.FM.M.fuel / this.FM.M.maxFuel) * 1790F;
                this.FM.M.maxFuel = 1790F;
            }
            if (this.thisWeaponsName.startsWith("OnePVC_1xSC2000")) {
                this.FM.M.fuel = (this.FM.M.fuel / this.FM.M.maxFuel) * 2484F;
                this.FM.M.maxFuel = 2484F;
            }
            if (this.thisWeaponsName.startsWith("OnePVC_1xSC1800")) {
                this.FM.M.fuel = (this.FM.M.fuel / this.FM.M.maxFuel) * 2484F;
                this.FM.M.maxFuel = 2484F;
            }
            if (this.thisWeaponsName.startsWith("OnePVC_2xSC1000")) {
                this.FM.M.fuel = (this.FM.M.fuel / this.FM.M.maxFuel) * 2484F;
                this.FM.M.maxFuel = 2484F;
            }
        }
    ...
    public void update(float f) {
        ...
        if (this.FM.AS.astatePlayerIndex == 3) {
            if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[4]) {
                this.SturmanBusy(4);
            } else if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[5]) {
                this.SturmanBusy(5);
            }
        ...
        if (this.FM.AS.astatePlayerIndex == 4) {
            if (Main3D.cur3D().cockpitCur == Main3D.cur3D().cockpits[7]) {
                this.SturmanBusy(7);
            ...
            if (this.FM.turret.length != 0) {
                ...
                if (actor1 == null) {
                    actor1 = this.FM.turret[4].target;
                }
                if (actor1 != null) {
        ...
        if (this.FM.turret[6].tMode == 2) {
            this.FM.turret[6].tMode = 4;
        }
        super.update(f);
    }
    ...
    public void moveCockpitDoor(float f) {
        ...
        if (f > 0.126F) {
            this.hierMesh().chunkVisible("Kolpak2_D0", false);
        } else {
            this.hierMesh().chunkVisible("Kolpak2_D0", true);
        }
        if (f < 0.199F) {
            this.hierMesh().chunkSetAngles("Kolpak3_D0", 0.0F, 0.0F, -315F * f);
        }
    }
    ...
    public void doMurderPilot(int i) {
        switch (i) {
            ...
            case 0:
                ...
                if (this.FM.AS.astatePilotStates[2] > 95) {
            ...
            case 2:
                ...
                if (this.FM.AS.astatePilotStates[0] > 95) {
                    this.FM.turret[6].bIsOperable = false;
                }
                break;
    ...
    static {
        Class class1 = HE_111H5.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "He-111");
        Property.set(class1, "meshName", "3do/plane/He-111H-5/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1940.8F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/He-111H-5.fmd:HE111");
        Property.set(class1, "cockpitClass", new Class[] { CockpitHE_111H6_Early.class, CockpitHE_111H6_Early_Bombardier.class, CockpitHE_111H6_Early_NGunner.class, CockpitHE_111H5_TGunner.class, CockpitHE_111H5_BGunner.class, CockpitHE_111H5_FGunner.class, CockpitHE_111H5_LGunner.class, CockpitHE_111H5_RGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 13, 14, 15, 0, 3, 3, 3, 3 });
