...
public class KI_44_IIOTSU extends KI_44 {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("2xMG_2x40mm") || this.thisWeaponsName.endsWith("2xMG_2x40mm")) {
            this.hierMesh().chunkVisible("CWingLIn_D0", true);
            this.hierMesh().chunkVisible("CWingRIn_D0", true);
            ...
            this.hierMesh().chunkVisible("WingLIn_D3", false);
            ...
            this.hierMesh().chunkVisible("WingRIn_D3", false);
        }
        if (this.thisWeaponsName.startsWith("2xDpt") || this.thisWeaponsName.endsWith("2xDpt")) {
            this.hierMesh().chunkVisible("CWingLIn_D0", true);
            this.hierMesh().chunkVisible("CWingRIn_D0", true);
            this.hierMesh().chunkVisible("WingLIn_D0", false);
            this.hierMesh().chunkVisible("WingLIn_D1", false);
