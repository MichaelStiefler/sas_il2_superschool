...
public class JU_88A5Late extends JU_88Axx implements TypeBomber, TypeDiveBomber, TypeScout {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.endsWith("RustA")) {
            ...
            if (this.thisWeaponsName.endsWith("xTank900L_RustF")) {
                f1 += 90F;
                if (this.thisWeaponsName.endsWith("2xTank900L_RustF")) {
                    f1 += 30F;
                }
            }
        }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.equals("xturret2b")) {
            this.JamAmmo(3);
        } else if (s.equals("xturret3b")) {
            this.JamAmmo(2);
        } else {
    ...
    public boolean turretAngles(int i, float af[]) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                if (f > 45F) {
                    if (f1 < Aircraft.cvt(f, 45F, 50F, -10F, -8.2F)) {
                        f1 = Aircraft.cvt(f, 45F, 50F, -10F, -8.2F);
                    }
                    break;
                }
                if (f > 3F) {
                    if (f1 < Aircraft.cvt(f, 3F, 8.4F, -1.72F, -10F)) {
                        f1 = Aircraft.cvt(f, 3F, 8.4F, -1.72F, -10F);
                    }
                    break;
                }
                if (f > -5.3F) {
                    if (f1 < Aircraft.cvt(f, -5.3F, 3F, -1.72F, -1.72F)) {
                        f1 = Aircraft.cvt(f, -5.3F, 3F, -1.72F, -1.72F);
                    }
                    break;
                }
                if (f1 < Aircraft.cvt(f, -25F, -5.3F, -3F, -1.72F)) {
                    f1 = Aircraft.cvt(f, -25F, -5.3F, -3F, -1.72F);
                }
                break;
            ...
            case 2:
                ...
                if (f < -45F) {
                    if (f1 < Aircraft.cvt(f, -50F, -45F, -8.2F, -10F)) {
                        f1 = Aircraft.cvt(f, -50F, -45F, -8.2F, -10F);
                    }
                    break;
                }
                if (f < -3F) {
                    if (f1 < Aircraft.cvt(f, -8.9F, -3F, -10F, -1.72F)) {
                        f1 = Aircraft.cvt(f, -8.9F, -3F, -10F, -1.72F);
                    }
                    break;
                }
                if (f < 5.3F) {
                    if (f1 < Aircraft.cvt(f, -3F, 5.3F, -1.72F, -1.72F)) {
                        f1 = Aircraft.cvt(f, -3F, 5.3F, -1.72F, -1.72F);
                    }
                    break;
                }
                if (f1 < Aircraft.cvt(f, 5.3F, 25F, -1.72F, -3F)) {
                    f1 = Aircraft.cvt(f, 5.3F, 25F, -1.72F, -3F);
                }
                break;
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitJU_88A5Late.class, CockpitJU_88A5Late_Bombardier.class, CockpitJU_88A5Late_NGunner.class, CockpitJU_88A5Late_LGunner.class, CockpitJU_88A5Late_RGunner.class, CockpitJU_88A5Late_BGunner.class });
        ...
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn08a", "_BombSpawn09", "_BombSpawn09a", "_BombSpawn10", "_BombSpawn11", "_BombSpawn12", "_BombSpawn13", "_BombSpawn14", "_BombSpawn15", "_BombSpawn15a", "_BombSpawn16", "_BombSpawn16a", "_BombSpawn17", "_BombSpawn18", "_BombSpawn19", "_BombSpawn20", "_BombSpawn21", "_BombSpawn22", "_BombSpawn23", "_BombSpawn24", "_ExternalBomb04", "_ExternalBomb02", "_ExternalBomb01", "_ExternalBomb03", "_ExternalBomb05", "_ExternalBomb06", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalDev04" });
    }
}
