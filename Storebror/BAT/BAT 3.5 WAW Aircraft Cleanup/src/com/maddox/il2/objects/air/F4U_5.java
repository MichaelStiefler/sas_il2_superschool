...
public class F4U_5 extends F4U implements TypeFighter, TypeDiveBomber, TypeStormovik {
    ...
    static {
        Class class1 = F4U_5.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "F4U5");
        Property.set(class1, "meshName", "3DO/Plane/F4U5(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar05());
        Property.set(class1, "meshName_us", "3DO/Plane/F4U5(USA)/hier.him");
        ...
        Property.set(class1, "FlightModel", "FlightModels/F4U-5.fmd:F4ULate_FM");
