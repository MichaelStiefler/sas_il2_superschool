...
public class HE_111Z extends Scheme5 implements TypeTransport, TypeDockable {
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                if (s.endsWith("p1") || s.endsWith("p6")) {
                    ...
                    this.getEnergyPastArmor(5D / (Math.abs(Aircraft.v1.z) + 9.9999997473787516E-005D), shot);
                } else if (s.endsWith("p3a") || s.endsWith("p3b") || s.endsWith("p8a") || s.endsWith("p8b")) {
                    this.getEnergyPastArmor(8D / ((Math.abs(Aircraft.v1.x) * World.Rnd().nextFloat(1.0F, 1.2F)) + 9.9999997473787516E-005D), shot);
                } else if (s.endsWith("p4") || s.endsWith("p9")) {
                    if (Aircraft.v1.x > 0.70710676908493042D) {
                        this.getEnergyPastArmor(8D / ((Aircraft.v1.x * World.Rnd().nextFloat(1.0F, 1.2F)) + 0.0010000000474974513D), shot);
                    } else if (Aircraft.v1.x > -0.70710676908493042D) {
                        this.getEnergyPastArmor(6F, shot);
                    }
                } else if (s.endsWith("o1") || s.endsWith("o2") || s.endsWith("o3") || s.endsWith("o4") || s.endsWith("o5")) {
                    if (Aircraft.v1.x > 0.70710676908493042D) {
                        this.getEnergyPastArmor(8D / ((Aircraft.v1.x * World.Rnd().nextFloat(1.0F, 1.2F)) + 9.9999997473787516E-005D), shot);
                    } else {
                ...
                if ((s.endsWith("ta1") || s.endsWith("ta2")) && (World.Rnd().nextFloat() < 0.1F) && (this.chunkDamageVisible("Tail1") > 2) && (this.getEnergyPastArmor(12.9F / (float) Math.sqrt((Aircraft.v1.y * Aircraft.v1.y) + (Aircraft.v1.z * Aircraft.v1.z)), shot) > 0.0F)) {
                    this.debuggunnery("Tail1 Spars Broken in Half..");
                    this.nextDMGLevels(3, 2, "Tail1_D3", shot.initiator);
                }
                if ((s.endsWith("ta3") || s.endsWith("ta4")) && (World.Rnd().nextFloat() < 0.1F) && (this.chunkDamageVisible("Tail2") > 2) && (this.getEnergyPastArmor(12.9F / (float) Math.sqrt((Aircraft.v1.y * Aircraft.v1.y) + (Aircraft.v1.z * Aircraft.v1.z)), shot) > 0.0F)) {
                    this.debuggunnery("Tail2 Spars Broken in Half..");
                    this.nextDMGLevels(3, 2, "Tail2_D3", shot.initiator);
                }
                if ((s.endsWith("li1") || s.endsWith("li2")) && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(Aircraft.v1.x)))) && (this.chunkDamageVisible("WingLIn") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingLIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if ((s.endsWith("ri1") || s.endsWith("ri2")) && (World.Rnd().nextFloat() < (1.0D - (0.92000001668930054D * Math.abs(Aircraft.v1.x)))) && (this.chunkDamageVisible("WingRIn") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingRIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if ((s.endsWith("lm1") || s.endsWith("lm2")) && (World.Rnd().nextFloat() < (1.0D - (0.86000001430511475D * Math.abs(Aircraft.v1.x)))) && (this.chunkDamageVisible("WingLMid") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if ((s.endsWith("rm1") || s.endsWith("rm2")) && (World.Rnd().nextFloat() < (1.0D - (0.86000001430511475D * Math.abs(Aircraft.v1.x)))) && (this.chunkDamageVisible("WingRMid") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if ((s.endsWith("lo1") || s.endsWith("lo2")) && (World.Rnd().nextFloat() < (1.0D - (0.79000002145767212D * Math.abs(Aircraft.v1.x)))) && (this.chunkDamageVisible("WingLOut") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if ((s.endsWith("ro1") || s.endsWith("ro2")) && (World.Rnd().nextFloat() < (1.0D - (0.79000002145767212D * Math.abs(Aircraft.v1.x)))) && (this.chunkDamageVisible("WingROut") > 2) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("WingROut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if ((s.endsWith("k1") || s.endsWith("k2")) && (World.Rnd().nextFloat() < (1.0D - (0.79000002145767212D * Math.abs(Aircraft.v1.x)))) && (this.chunkDamageVisible("Keel1") > 1) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                    this.debuggunnery("Keel1 Spars Damaged..");
                    this.nextDMGLevels(1, 2, "Keel1_D2", shot.initiator);
                }
                if ((s.endsWith("k3") || s.endsWith("k4")) && (World.Rnd().nextFloat() < (1.0D - (0.79000002145767212D * Math.abs(Aircraft.v1.x)))) && (this.chunkDamageVisible("Keel1") > 1) && (this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F)) {
                ...
                if (s.endsWith("prop")) {
                    ...
                    if (this.getEnergyPastArmor(0.1F, shot) > 0.0F) {
                        if (World.Rnd().nextFloat() < (shot.power / 200000F)) {
                            this.debuggunnery("Engine" + (j + 1) + " Crank Case Hit - Engine Stucks..");
                            this.FM.AS.setEngineStuck(shot.initiator, j);
                        }
                        if (World.Rnd().nextFloat() < (shot.power / 50000F)) {
                            this.debuggunnery("Engine" + (j + 1) + " Crank Case Hit - Engine Damaged..");
                        ...
                        if (World.Rnd().nextFloat() < (shot.power / 28000F)) {
                            ...
                            this.debuggunnery("Engine" + (j + 1) + " Crank Case Hit - Cylinder Feed Out, " + this.FM.EI.engines[j].getCylindersOperable() + "/" + this.FM.EI.engines[j].getCylinders() + " Left..");
                        }
                        ...
                        this.debuggunnery("Engine" + (j + 1) + " Crank Case Hit - Readyness Reduced to " + this.FM.EI.engines[j].getReadyness() + "..");
                    }
                } else if (s.endsWith("cyls")) {
                    if ((this.getEnergyPastArmor(1.45F, shot) > 0.0F) && (World.Rnd().nextFloat() < (this.FM.EI.engines[j].getCylindersRatio() * 1.75F))) {
                        this.FM.EI.engines[j].setCyliderKnockOut(shot.initiator, World.Rnd().nextInt(1, (int) (shot.power / 4800F)));
                        this.debuggunnery("Engine" + (j + 1) + " Cylinders Hit, " + this.FM.EI.engines[j].getCylindersOperable() + "/" + this.FM.EI.engines[j].getCylinders() + " Left..");
                        ...
                        if (World.Rnd().nextFloat() < (shot.power / 24000F)) {
                            this.debuggunnery("Engine" + (j + 1) + " Cylinders Hit - Engine Fires..");
                            this.FM.AS.hitEngine(shot.initiator, j, 3);
                        }
                        this.getEnergyPastArmor(25F, shot);
                    }
                } else if (s.endsWith("supc")) {
                    if ((this.getEnergyPastArmor(0.05F, shot) > 0.0F) && (World.Rnd().nextFloat() < 0.89F)) {
                        this.debuggunnery("Engine" + (j + 1) + " Supercharger Out..");
                        this.FM.AS.setEngineSpecificDamage(shot.initiator, j, 0);
                    }
                } else if (s.endsWith("oil1") && (this.getEnergyPastArmor(0.21F, shot) > 0.0F)) {
                ...
                if (this.getEnergyPastArmor(0.2F, shot) > 0.0F) {
                    if (shot.power < 14100F) {
                        ...
                        if ((this.FM.AS.astateTankStates[k] < 4) && (World.Rnd().nextFloat() < 0.03F)) {
                            this.FM.AS.hitTank(shot.initiator, k, 1);
                        }
                        if ((shot.powerType == 3) && (this.FM.AS.astateTankStates[k] > 2) && (World.Rnd().nextFloat() < 0.03F)) {
                            this.FM.AS.hitTank(shot.initiator, k, 10);
                        }
                    } else {
                        this.FM.AS.hitTank(shot.initiator, k, World.Rnd().nextInt(0, (int) (shot.power / 20000F)));
                    }
                }
            }
            ...
            this.FM.EI.engines[l].setReadyness(shot.initiator, this.FM.EI.engines[l].getReadyness() - World.Rnd().nextFloat(0.0F, shot.power / 128000.9F));
            this.debuggunnery("Engine" + (l + 1) + " Hit - Readyness Reduced to " + this.FM.EI.engines[l].getReadyness() + "..");
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (flag) {
            ...
            if ((this.FM.AS.astateTankStates[2] > 4) && (World.Rnd().nextFloat() < 0.07F)) {
                this.nextDMGLevel(this.FM.AS.astateEffectChunks[2] + "0", 0, this);
            }
            if ((this.FM.AS.astateTankStates[3] > 4) && (World.Rnd().nextFloat() < 0.07F)) {
    ...
    public void update(float f) {
        super.update(f);
        if ((!(this.FM instanceof RealFlightModel) || !((RealFlightModel) this.FM).isRealMode()) && (this.FM.AP.way.curr().Action == 3) && this.typeDockableIsDocked() && (Math.abs(this.FM.Or.getKren()) < 10F)) {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitHE_111Z.class, CockpitHE_111Z_RNGunner.class, CockpitHE_111Z_LNGunner.class, CockpitHE_111Z_RTGunner.class, CockpitHE_111Z_LTGunner.class, CockpitHE_111Z_RBGunner.class, CockpitHE_111Z_LBGunner.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 13, 14, 15, 16, 17 });
