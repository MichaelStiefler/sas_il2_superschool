...
public class U_2TM extends Scheme1 implements TypeScout, TypeTransport, TypeBomber {
    ...
    public void msgShot(Shot shot) {
        ...
        if (shot.chunkName.startsWith("Engine")) {
            ...
            if ((Aircraft.v1.x < 0.10000000000000001D) && (World.Rnd().nextFloat() < 0.57F)) {
    ...
    static {
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 9, 9, 9, 9, 9, 9, 9, 9 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_ExternalBomb01", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb03", "_ExternalBomb04", "_ExternalBomb04", "_ExternalBomb05", "_ExternalBomb05", "_ExternalBomb06", "_ExternalBomb06", "_ExternalBomb07", "_ExternalBomb07", "_ExternalBomb08", "_ExternalBomb08", "_ExternalDev01", "_ExternalDev02", "_ExternalDev03", "_ExternalDev04", "_ExternalDev05", "_ExternalDev06", "_ExternalDev07", "_ExternalDev08" });
    }
}
