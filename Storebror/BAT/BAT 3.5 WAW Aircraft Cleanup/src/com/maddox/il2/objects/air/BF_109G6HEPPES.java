...
public class BF_109G6HEPPES extends BF_109 implements TypeBNZFighter, TypeAcePlane {
    ...
    protected void moveGear(float f, float f1, float f2) {
        BF_109G6HEPPES.moveGear(this.hierMesh(), f, f1, f2);
    }
    ...
    static {
        Class class1 = BF_109G6HEPPES.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Bf109");
        Property.set(class1, "meshName", "3DO/Plane/Bf-109G-6Early(ofHeppes)/hier.him");
