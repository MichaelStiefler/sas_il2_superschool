...
public class FI_103_V1 extends Scheme1 implements TypeDockable, MsgCollisionRequestListener {
    ...
    public void onAircraftLoaded() {
        ...
        this.FM.M.fuel *= 1.65F;
        this.FM.CruiseSpeed = 640F;
        this.FM.Range = 2800F;
        this.FM.AOA_Crit = 15F;
        this.FM.VmaxAllowed = 2000F;
        this.FM.Wingspan = 5.37F;
        this.FM.Length = 8.325F;
        this.FM.Sq.liftWingLOut *= 0.78F;
        this.FM.Sq.liftWingROut *= 0.78F;
        this.FM.CT.bHasFlapsControl = false;
        this.FM.Sq.liftKeel *= 0.5F;
        this.FM.Sq.squareRudders *= 0.25F;
        this.FM.SensYaw *= 0.25F;
        ...
        if (!this.isNetMirror() && !this.typeDockableIsDocked()) {
            ...
            if (World.land().HQ_Air(this.FM.Loc.x, this.FM.Loc.y) >= (this.FM.Loc.z - 1.0D)) {
                ...
                if (this.FM instanceof Maneuver) {
                    ((Maneuver) this.FM).set_maneuver(13);
                }
            }
        }
    }
    ...
    public void rareAction(float f, boolean flag) {
        ...
        if (flag && (this.FM.AP.way.curr().Action == 3) && this.typeDockableIsDocked() && (Math.abs(((Aircraft) this.queen_).FM.Or.getKren()) < 10F) && !(((Aircraft) this.queen_).FM instanceof RealFlightModel) && !((RealFlightModel) ((Aircraft) this.queen_).FM).isRealMode()) {
