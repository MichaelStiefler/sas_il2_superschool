...
public class SPITFIRE8CLPFB extends SPITFIRE {

    public SPITFIRE8CLPFB() {
        this.flapps = 0.0F;
    }
    ...
    protected void moveGear(float f) {
        SPITFIRE8CLPFB.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = SPITFIRE8CLPFB.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Spit");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireMkVIIICLPFB(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "meshName_gb", "3DO/Plane/SpitfireMkVIIICLPFB(GB)/hier.him");
