...
public class FW_190A2 extends FW_190 implements TypeFighter, TypeStormovik, TypeStormovikArmored {
    ...
    static {
        ...
        Property.set(class1, "meshName", "3DO/Plane/Fw-190A-2/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar01());
        Property.set(class1, "yearService", 1942.1F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Fw-190A-2.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitFW_190A2.class });
