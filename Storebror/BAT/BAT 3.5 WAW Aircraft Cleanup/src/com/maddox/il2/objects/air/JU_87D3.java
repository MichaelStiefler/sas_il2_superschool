...
public class JU_87D3 extends JU_87 implements TypeStormovik {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Ju-87D-3.fmd");
        Property.set(class1, "meshName", "3do/plane/Ju-87D-3/hier.him");
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 10, 10, 3, 3, 3, 3, 3, 3, 3 });
