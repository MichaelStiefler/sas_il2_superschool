...
public class KI_48_II_KAMIKAZE extends KI_48 implements MsgCollisionRequestListener, MsgCollisionListener {
    ...
    protected void doExplosion() {
        ...
        if ((this.FM.Loc.z - 10D) < World.land().HQ_Air(this.FM.Loc.x, this.FM.Loc.y)) {
            if (Engine.land().isWater(this.FM.Loc.x, this.FM.Loc.y)) {
                ...
                Explosions.BOMB1000a_Land(this.FM.Loc, 1.0F, 1.0F, true, false);
            }
        }
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Ki-48-II.fmd:Ki48-II_FM");
