...
public class KI_45_OTSU extends KI_45 implements TypeJazzPlayer {
    ...
    public void onAircraftLoaded() {
        ...
        if (this.thisWeaponsName.startsWith("2xHo103_slanted")) {
            ...
            if (this.pit != null) {
                this.pit.showJazzSight();
            }
            if (this.gunner != null) {
                this.gunner.showJazz();
            }
        }
    }
    ...
    public Vector3d getAttackVector() {
        return KI_45_OTSU.ATTACK_VECTOR;
    }
    ...
    static {
        ...
        Property.set(class1, "meshName", "3do/plane/Ki-45(Multi1)/OTSU_hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar02());
        Property.set(class1, "meshName_ja", "3do/plane/Ki-45(ja)/OTSU_hier.him");
