...
public class HalifaxBMkI extends Scheme4 implements TypeBomber, TypeTransport {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitHalifaxBMkI.class, CockpitHalifaxBMkI_Bombardier.class, CockpitHalifaxBMkI_NGunner.class, CockpitHalifaxBMkI_TGunner.class, CockpitHalifaxBMkI_AGunner.class });
