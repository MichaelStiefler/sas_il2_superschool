...
public class PZL23B extends PZL23xyz implements TypeDiveBomber {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitPZL23B.class, CockpitPZL23B_TGunner.class, CockpitPZL23B_BGunner.class });
