...
public class LAGG_3SERIES66 extends LAGG_3 implements TypeTNBFighter {
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
        ...
        float f3 = Math.max(-f2 * 1400F, -80F);
    ...
    static {
        Class class1 = LAGG_3SERIES66.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "LaGG");
        Property.set(class1, "meshName", "3do/plane/LaGG-3series66/hier.him");
