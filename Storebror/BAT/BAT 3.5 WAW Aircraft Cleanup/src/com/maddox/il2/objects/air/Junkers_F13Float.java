...
public class Junkers_F13Float extends Scheme1 implements TypeSeaPlane, TypeBomber, TypeScout {

    public Junkers_F13Float() {
        Junkers_F13Float.bChangedPit = true;
        this.setPit(null);
    }
    ...
    static {
        Class class1 = Junkers_F13Float.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ju.F13F");
        Property.set(class1, "meshName", "3DO/Plane/Junkers_F13Float/hier-JuF13H.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitJunkers_F13Float.class });
