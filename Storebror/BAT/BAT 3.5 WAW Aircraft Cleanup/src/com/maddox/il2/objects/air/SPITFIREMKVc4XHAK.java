...
public class SPITFIREMKVc4XHAK extends SPITFIRE5 {

    public SPITFIREMKVc4XHAK() {
    }
    ...
    protected void moveGear(float f) {
        SPITFIREMKVc4XHAK.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = SPITFIREMKVc4XHAK.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SpitVc4");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireMkVc4XHAK(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "meshName_gb", "3DO/Plane/SpitfireMkVc4XHAK(GB)/hier.him");
        Property.set(class1, "PaintScheme_gb", new PaintSchemeFMPar04());
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1946.5F);
        Property.set(class1, "FlightModel", "FlightModels/Spitfire-F-Vc-4H-M45-12-trop.fmd");
