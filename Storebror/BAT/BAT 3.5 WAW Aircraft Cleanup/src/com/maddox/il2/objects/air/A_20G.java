...
public class A_20G extends A_20 implements TypeStormovik {
    ...
    static {
        ...
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 0, 0, 10, 10, 11, 3, 3, 3, 3, 3, 3, 3, 9, 9, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_ExternalBomb01", "_ExternalBomb02", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_ExternalDev01", "_ExternalDev02", "_ExternalBomb03", "_ExternalBomb04" });
    }
}
