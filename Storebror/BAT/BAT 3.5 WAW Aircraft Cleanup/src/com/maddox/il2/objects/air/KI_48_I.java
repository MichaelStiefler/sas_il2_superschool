...
public class KI_48_I extends KI_48 implements TypeBomber {
    ...
    static {
        Class class1 = KI_48_I.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ki-48");
        Property.set(class1, "meshName", "3do/plane/Ki-48-II(Multi1)/I_hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar02());
        Property.set(class1, "meshName_ja", "3do/plane/Ki-48-II(ja)/I_hier.him");
        Property.set(class1, "PaintScheme_ja", new PaintSchemeFCSPar05());
        Property.set(class1, "yearService", 1940F);
        Property.set(class1, "yearExpired", 1945F);
        Property.set(class1, "FlightModel", "FlightModels/Ki-48-I.fmd:Ki48-I_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitKI_48.class, CockpitKI_48_I_Bombardier.class, CockpitKI_48_NGunner.class, CockpitKI_48_I_TGunner.class, CockpitKI_48_I_VGunner.class });
        Property.set(class1, "LOSElevation", 1.4078F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 11, 12, 11, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09", "_BombSpawn10", "_BombSpawn11", "_BombSpawn12" });
    }
}
