...
public class A_20C extends A_20 implements TypeBomber, TypeStormovik {
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitA_20C.class, CockpitA_20C_Bombardier.class, CockpitA_20C_TGunner.class, CockpitA_20C_BGunner.class });
        Property.set(class1, "LOSElevation", 0.92575F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 10, 10, 11, 3, 3, 3, 3, 3, 3, 3, 9, 9, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN07", "_MGUN08", "_MGUN09", "_ExternalBomb01", "_ExternalBomb02", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_ExternalDev01", "_ExternalDev02", "_ExternalBomb03", "_ExternalBomb04" });
    }
}
