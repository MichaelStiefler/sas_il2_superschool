...
public class Junkers_F13_Utility extends Scheme1 implements TypeStormovik, TypeBomber, TypeScout {

    public Junkers_F13_Utility() {
        Junkers_F13_Utility.bChangedPit = true;
        this.setPit(null);
    }
    ...
    public CockpitJunkers_F13_Utility getPit() {
        return this.pit;
    }

    public void setPit(CockpitJunkers_F13_Utility pit) {
        this.pit = pit;
    }

    private CockpitJunkers_F13_Utility pit;
    ...
    static {
        Class class1 = Junkers_F13_Utility.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Ju.F13U");
        Property.set(class1, "meshName", "3DO/Plane/Junkers_F13_Utility/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "yearService", 1933F);
        Property.set(class1, "yearExpired", 1967F);
        Property.set(class1, "cockpitClass", new Class[] { CockpitJunkers_F13_Utility.class });
