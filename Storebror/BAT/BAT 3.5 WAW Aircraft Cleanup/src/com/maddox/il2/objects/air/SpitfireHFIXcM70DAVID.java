...
public class SpitfireHFIXcM70DAVID extends SPITFIRE9 {

    public SpitfireHFIXcM70DAVID() {
    }

    static {
        Class var_class = SpitfireHFIXcM70DAVID.class;
        ...
        Property.set(var_class, "FlightModel", "FlightModels/Spitfire-HF-IXc-M70-18.fmd:SPIT9_FM");
