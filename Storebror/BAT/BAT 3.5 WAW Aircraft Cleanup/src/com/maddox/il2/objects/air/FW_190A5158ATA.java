...
public class FW_190A5158ATA extends FW_190 implements TypeFighter, TypeBNZFighter {

    public FW_190A5158ATA() {
    }
    ...
    protected void nextDMGLevel(String s, int i, Actor actor) {
        ...
        if (this.FM.isPlayers()) {
            FW_190A5158ATA.bChangedPit = true;
        }
    }
    ...
    static {
        Class class1 = FW_190A5158ATA.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/fw-190a5-1_58Ata.fmd");
