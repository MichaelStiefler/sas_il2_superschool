...
public class LANCASTER_MKIIIB_SPECIAL extends Scheme4 implements TypeTransport, TypeBomber {

    public LANCASTER_MKIIIB_SPECIAL() {
    ...
    public void msgShot(Shot shot) {
        ...
        if (shot.chunkName.startsWith("CF")) {
            if ((Aircraft.Pd.x > 4.5500001907348633D) && (Aircraft.Pd.x < 7.1500000953674316D) && (Aircraft.Pd.z > 0.57999998331069946D)) {
                if (World.Rnd().nextFloat() < 0.233F) {
                    if (Aircraft.Pd.z > 1.2100000381469731D) {
            ...
            if ((Aircraft.Pd.x > 9.5299997329711914D) && (Aircraft.Pd.z < 0.1400000005960465D) && (Aircraft.Pd.z > -0.62999999523162842D)) {
                this.FM.AS.hitPilot(shot.initiator, 2, (int) (shot.power * 0.002F));
            }
            if ((Aircraft.Pd.x > 2.4749999046325679D) && (Aircraft.Pd.x < 4.4899997711181641D) && (Aircraft.Pd.z > 0.61000001430511475D) && ((shot.power * Math.sqrt((Aircraft.v1.y * Aircraft.v1.y) + (Aircraft.v1.z * Aircraft.v1.z))) > 11900D) && (World.Rnd().nextFloat() < 0.45F)) {
                for (int i = 0; i < 4; i++) {
        ...
        if (shot.chunkName.startsWith("Turret3")) {
            if (Aircraft.Pd.z > 0.30445000529289251D) {
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/LANCASTER_MKIIIB_SPECIAL.fmd:LANCASTER_MKIIIB_SPECIAL_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitLancMKIIIB.class, CockpitLANCMKIIIB_Bombardier.class, CockpitLanc_FGunner.class, CockpitLanc_AGunner.class });
        Property.set(class1, "LOSElevation", 0.73425F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 10, 11, 11, 12, 12, 10, 10, 3, 3, 3, 3, 3, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN09", "_MGUN10", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04", "_BombSpawn05", "_BombSpawn06", "_BombSpawn07", "_BombSpawn08", "_BombSpawn09" });
    }
}
