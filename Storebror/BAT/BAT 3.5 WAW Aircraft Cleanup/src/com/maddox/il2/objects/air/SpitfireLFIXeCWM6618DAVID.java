...
public class SpitfireLFIXeCWM6618DAVID extends SPITFIRE9 {

    public SpitfireLFIXeCWM6618DAVID() {
    }

    static {
        Class var_class = SpitfireLFIXeCWM6618DAVID.class;
        ...
        Property.set(var_class, "FlightModel", "FlightModels/Spitfire-LF-IXe-M66-18-CW.fmd:SPIT9_FM");
