...
public class DC_3B extends Scheme2 implements TypeTransport {
    ...
    protected void moveGear(float f) {
        DC_3B.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = DC_3B.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Douglas Civil");
        Property.set(class1, "meshNameDemo", "3DO/Plane/DC-3B(USA)/DC-3B.him");
        Property.set(class1, "meshName", "3DO/Plane/DC-3B(Multi1)/DC-3B.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(class1, "meshName_us", "3DO/Plane/DC-3B(USA)/DC-3B.him");
        Property.set(class1, "PaintScheme_us", new PaintSchemeBMPar04());
        Property.set(class1, "originCountry", PaintScheme.countryUSA);
        Property.set(class1, "noseart", 1);
        Property.set(class1, "yearService", 1939F);
        Property.set(class1, "yearExpired", 2999.9F);
        Property.set(class1, "FlightModel", "FlightModels/DC-3B.fmd:DC3B_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitDC3B.class });
