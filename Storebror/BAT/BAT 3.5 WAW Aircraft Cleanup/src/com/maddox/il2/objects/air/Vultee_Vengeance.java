...
public class Vultee_Vengeance extends Vengeance_v1 implements TypeStormovik, TypeDiveBomber {

    public Vultee_Vengeance() {
    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Vultee-Vengeance.fmd:Vengeance_FM");
        Property.set(class1, "cockpitClass", new Class[] { CockpitVengeanceP.class, CockpitVengeanceTG.class });
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 0, 0, 0, 0, 0, 10, 10, 3, 3, 3, 3, 9, 9, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_MGUN01", "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_ExternalBomb01", "_ExternalBomb02", "_ExternalBomb03", "_ExternalBomb04", "_ExternalDev01", "_ExternalDev02", "_BombSpawn01", "_BombSpawn02" });
    }
}
