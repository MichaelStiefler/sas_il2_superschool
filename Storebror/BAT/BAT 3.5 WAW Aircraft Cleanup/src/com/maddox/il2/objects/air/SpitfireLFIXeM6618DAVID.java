...
public class SpitfireLFIXeM6618DAVID extends SPITFIRE9 {

    public SpitfireLFIXeM6618DAVID() {
    }

    static {
        Class var_class = SpitfireLFIXeM6618DAVID.class;
        ...
        Property.set(var_class, "FlightModel", "FlightModels/Spitfire-LF-IXe-M66-18.fmd:SPIT9_FM");
