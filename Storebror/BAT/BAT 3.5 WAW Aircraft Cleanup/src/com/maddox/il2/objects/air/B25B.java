...
public class B25B extends B_25 implements TypeBomber {
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (this.fSightCurReadyness < 1.0F) {
            ...
            if (this.fSightCurDistance < (B25B.toMetersPerSecond(this.fSightCurSpeed) * Math.sqrt(B25B.toMeters(this.fSightCurAltitude) * 0.2038736F))) {
    ...
    static {
        Class var_class = B25B.class;
        new NetAircraft.SPAWN(var_class);
        Property.set(var_class, "iconFar_shortClassName", "B-25");
        Property.set(var_class, "meshName", "3DO/Plane/B-25B(Multi1)/hier.him");
        Property.set(var_class, "PaintScheme", new PaintSchemeBMPar02());
        Property.set(var_class, "meshName_us", "3DO/Plane/B-25B(USA)/hier.him");
        ...
        Property.set(var_class, "FlightModel", "FlightModels/B-25B.fmd");
        Property.set(var_class, "cockpitClass", new Class[] { CockpitB25B.class, CockpitB25B_Bombardier.class, CockpitB25B_FGunner.class, CockpitB25B_TGunner.class });
        Property.set(var_class, "LOSElevation", 0.73425F);
        Aircraft.weaponTriggersRegister(var_class, new int[] { 10, 11, 11, 12, 12, 3, 3, 3 });
        Aircraft.weaponHooksRegister(var_class, new String[] { "_MGUN02", "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03" });
    }
}
