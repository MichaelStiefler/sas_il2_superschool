...
public class SPITFIREMKVc2AK extends SPITFIRE5 {

    public SPITFIREMKVc2AK() {
    }
    ...
    protected void moveGear(float f) {
        SPITFIREMKVc2AK.moveGear(this.hierMesh(), f);
    }
    ...
    static {
        Class class1 = SPITFIREMKVc2AK.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "SpitVc2");
        Property.set(class1, "meshName", "3DO/Plane/SpitfireMkVc2AK(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "meshName_gb", "3DO/Plane/SpitfireMkVc2AK(GB)/hier.him");
