...
public class Huey_D_AI extends HueyXAI implements TypeScout, TypeTransport, TypeStormovik {
    ...
    static {
        final Class class1 = Huey_D_AI.class;
        ...
        try {
            ...
            a_lweaponslot[0] = new Aircraft._WeaponSlot(11, "MGunM60", 500);
            a_lweaponslot[1] = new Aircraft._WeaponSlot(11, "MGunM60", 500);
            a_lweaponslot[4] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[5] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[6] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[7] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[8] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[9] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[10] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[11] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[12] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[13] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[14] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            a_lweaponslot[15] = new Aircraft._WeaponSlot(2, "RocketGun_M3", 1);
            arraylist.add(s);
            hashmapint.put(Finger.Int(s), a_lweaponslot);
            s = "Miniguns&Rockets";
            a_lweaponslot = new Aircraft._WeaponSlot[byte0];
