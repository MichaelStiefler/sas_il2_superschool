...
public abstract class F4F extends Scheme1 implements TypeFighter, TypeTNBFighter {
    ...
    public void moveCockpitDoor(float f) {
        ...
        Aircraft.xyz[2] = Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, -0.05735F);
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
        moveGear(hiermesh, Aircraft.cvt(f, 0.01F, 0.91F, 0.0F, 1.0F), Aircraft.cvt(f1, 0.09F, 0.98F, 0.0F, 1.0F), 0.0F, true);
        hiermesh.chunkSetAngles("LampGear_D0", 0.0F, Aircraft.cvt(f, 0.01F, 0.99F, 0.0F, -90F), 0.0F);
    }

    protected static final void moveGear(HierMesh hiermesh, float f, float f1, float f2, boolean flag) {
        hiermesh.chunkSetAngles("GearL2_D0", 0.0F, -87F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL3_D0", 0.0F, -115.5F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL4_D0", 0.0F, -90F * f, 0.0F);
        hiermesh.chunkSetAngles("GearL5_D0", 0.0F, -88.5F * f, 0.0F);
        hiermesh.chunkSetAngles("GearR2_D0", 0.0F, -87F * f1, 0.0F);
        hiermesh.chunkSetAngles("GearR3_D0", 0.0F, -115.5F * f1, 0.0F);
        hiermesh.chunkSetAngles("GearR4_D0", 0.0F, -90F * f1, 0.0F);
        hiermesh.chunkSetAngles("GearR5_D0", 0.0F, -88.5F * f1, 0.0F);
        if (flag) {
            hiermesh.chunkSetAngles("GearL2X_D0", 0.0F, -87F * f, 0.0F);
            hiermesh.chunkSetAngles("GearL3X_D0", 0.0F, -115.5F * f, 0.0F);
            hiermesh.chunkSetAngles("GearR2X_D0", 0.0F, -87F * f1, 0.0F);
            hiermesh.chunkSetAngles("GearR3X_D0", 0.0F, -115.5F * f1, 0.0F);
        }
    }
    ...
    protected static final void moveGear(HierMesh hiermesh, float f, boolean flag) {
    ...
    public void moveWheelSink() {
        if (this.FM.CT.getGear() > 0.99F) {
            moveGear(this.hierMesh(), Aircraft.cvt(this.FM.Gears.gWheelSinking[0], 0.0F, 0.5F, 1.0F, 0.57F), Aircraft.cvt(this.FM.Gears.gWheelSinking[1], 0.0F, 0.5F, 1.0F, 0.57F), 0.0F, false);
        }
    }
    ...
    public void update(float f) {
        ...
        if (f3 > 0.01F) {
            if (this.FM.Gears.arrestorVAngle != 0.0F) {
                this.arrestor = Aircraft.cvt(this.FM.Gears.arrestorVAngle, -f4, f4, -f4, f4);
        ...
        float f6 = Math.max(0.01F, 1.0F - ((f5 - 130F) * 0.007F));
        if ((f5 > 130F) && ((double) this.FM.CT.getFlap() > (double) f6) && (this.FM.CT.FlapsControl != 0.0F)) {
            this.FM.CT.forceFlaps(f6);
            if (f5 > 270F) {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            ...
            if (s.startsWith("xxarmor")) {
                ...
                if (s.endsWith("f1")) {
                    // +++
                    // "xxarmorf1" is the cockpit's front armor.
...
// }
                    ...
                    this.getEnergyPastArmor(World.Rnd().nextFloat(16F, 36F) / (Math.abs(Aircraft.v1.x) + 0.0001D), shot);
                    this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 2);
                    if (shot.power <= 0.0F) {
                        this.doRicochetBack(shot);
                    }
                } else if (s.endsWith("p2")) {
                    this.getEnergyPastArmor(11D / (Math.abs(Aircraft.v1.x) + 0.0001D), shot);
                } else if (s.endsWith("p3")) {
                    this.getEnergyPastArmor(11.5D / (Math.abs(Aircraft.v1.x) + 0.0001D), shot);
                }
                return;
            }
    ...
    static {
        Property.set(F4F.class, "originCountry", PaintScheme.countryUSA);
    }
}
