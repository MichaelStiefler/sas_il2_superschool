...
public abstract class He46xyz extends Scheme1 implements TypeScout, TypeBomber, TypeTransport, TypeStormovik {
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                ...
                if (s.startsWith("xxspar")) {
                    ...
                    if (s.startsWith("xxspart") && (this.chunkDamageVisible("Tail1") > 2) && (this.getEnergyPastArmor(3.5F / (float) Math.sqrt((((Tuple3d) (Aircraft.v1)).y * ((Tuple3d) (Aircraft.v1)).y) + (((Tuple3d) (Aircraft.v1)).z * ((Tuple3d) (Aircraft.v1)).z)), shot) > 0.0F)) {
    ...
    static {
        Property.set(He46xyz.class, "originCountry", PaintScheme.countryRussia);
    }
}
