...
public class CockpitHe46 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        public boolean tick() {
            CockpitHe46.this.setTmp = CockpitHe46.this.setOld;
            CockpitHe46.this.setOld = CockpitHe46.this.setNew;
            CockpitHe46.this.setNew = CockpitHe46.this.setTmp;
            CockpitHe46.this.setNew.throttle = ((10F * CockpitHe46.this.setOld.throttle) + CockpitHe46.this.fm.CT.PowerControl) / 11F;
            CockpitHe46.this.setNew.vspeed = ((199F * CockpitHe46.this.setOld.vspeed) + CockpitHe46.this.fm.getVertSpeed()) / 200F;
            float f = CockpitHe46.this.waypointAzimuth();
            if (BaseGameVersion.is410orLater() && CockpitHe46.this.useRealisticNavigationInstruments()) {
                CockpitHe46.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitHe46.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
                CockpitHe46.this.setNew.waypointAzimuth.setDeg(CockpitHe46.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHe46.this.setOld.azimuth.getDeg(1.0F));
            }
            CockpitHe46.this.setNew.azimuth.setDeg(CockpitHe46.this.setOld.azimuth.getDeg(1.0F), CockpitHe46.this.fm.Or.azimut());
            CockpitHe46.this.w.set(CockpitHe46.this.fm.getW());
            CockpitHe46.this.fm.Or.transform(CockpitHe46.this.w);
            CockpitHe46.this.setNew.turn = ((12F * CockpitHe46.this.setOld.turn) + ((Tuple3f) (CockpitHe46.this.w)).z) / 13F;
            return true;
        }
    ...
    public CockpitHe46() {
        super("3DO/Cockpit/He46/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        float f1 = Pitot.Indicator((float) ((Tuple3d) (this.fm.Loc)).z, this.fm.getSpeedKMH());
