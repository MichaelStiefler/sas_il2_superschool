...
public class HS126A extends HS126 {
    static {
        Class class1 = HS126A.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "HS126A");
        Property.set(class1, "meshName", "3DO/Plane/HS-126A/hierC2.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
        Property.set(class1, "meshName_it", "3DO/Plane/HS-126A/hierC2.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar00());
