...
public abstract class ME_264 extends Scheme4 implements TypeBomber, TypeRocketBoost {
    ...
    public void setOnGround(Point3d point3d, Orient orient, Vector3d vector3d) {
        ...
        if (this.thisWeaponsName.indexOf("_boost") != -1) this.setBoostState(1);
    }
    ...
    public void update(float f) {
        ...
        if (BaseGameVersion.is412orLater()) {
            bayDoor = this.getBayDoor();
        } else {
            bayDoor = Reflection.getFloat(this, "BayDoor_");
        }
    ...
    public void setBoostState(int state) {
        ...
        if (((state ^ this.boostState) & 1) != 0) { // The existence of boosters has changed
            if ((state & 1) != 0) { // Boosters exist now
                this.doAttachBoosters();
            } else { // Boosters don't exist anymore
                this.doCutBoosters();
            }
        }
        if (((state ^ this.boostState) & 2) != 0) { // The boosters activity state changed
            if ((state & 2) != 0) { // Boosters are active now
                this.doFireBoosters();
    ...
    private void boostUpdate() {
        ...
        if (this.boosterFireOutTime == -1L && this.FM.Gears.onGround() && this.FM.EI.getPowerOutput() > 0.8F && this.FM.EI.engines[0].getStage() == 6 && this.FM.EI.engines[1].getStage() == 6 && this.FM.getSpeedKMH() > 20F) {
            ...
            this.setBoostState(this.boostState | 2);
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) if (s.endsWith("01")) getEnergyPastArmor(12.7D / (Math.abs(Aircraft.v1.z) + 0.000001D), shot);
            ...
            else if (s.endsWith("03")) getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.y) + 0.000001D), shot);
            else if (s.endsWith("04")) getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.y) + 0.000001D), shot);
            ...
            } else if (s.endsWith("06")) getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("07")) getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.y) + 0.000001D), shot);
            else if (s.endsWith("08")) getEnergyPastArmor(9.53D / (Math.abs(Aircraft.v1.y) + 0.000001D), shot);
            else if (s.endsWith("09")) getEnergyPastArmor(6.35D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("10")) {
                getEnergyPastArmor(22D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
                this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x20);
            } else if (s.endsWith("11")) {
                if (getEnergyPastArmor(52D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot) > 0.0F) this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 8);
            } else if (s.endsWith("12")) getEnergyPastArmor(52D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("13")) getEnergyPastArmor(6.35D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("14")) getEnergyPastArmor(7.9375D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
                ...
                getEnergyPastArmor(9.525D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
                this.FM.AS.setCockpitState(shot.initiator, this.FM.AS.astateCockpitState | 0x20);
            } else if (s.endsWith("17")) getEnergyPastArmor(15.875D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("18")) getEnergyPastArmor(9.525D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("19")) getEnergyPastArmor(9.525D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("20")) getEnergyPastArmor(51D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("21")) getEnergyPastArmor(22D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("22")) getEnergyPastArmor(52D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("23")) getEnergyPastArmor(9.525D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            else if (s.endsWith("24")) getEnergyPastArmor(9.525D / (Math.abs(Aircraft.v1.x) + 0.000001D), shot);
            ...
            if (s.startsWith("xxammo")) {
                int i = s.charAt(6) - 48;
                if (s.length() == 8) i = 10 + (s.charAt(7) - 48);
            ...
            if (s.startsWith("xxcontrols")) {
                ...
                if (s.length() == 12) j = 10 + (s.charAt(11) - 48);
                switch (j) {
                    default:
                        break;
                    ...
                    case 5:
                    case 6:
                        if (World.Rnd().nextFloat() < 0.252F && getEnergyPastArmor(5.2F, shot) > 0.0F && World.Rnd().nextFloat() < 0.125F) this.FM.AS.setControlsDamage(shot.initiator, 2);
                    ...
                    case 9:
                    case 10:
                        if (World.Rnd().nextFloat() < 0.252F && getEnergyPastArmor(5.2F, shot) > 0.0F && World.Rnd().nextFloat() < 0.125F) this.FM.AS.setControlsDamage(shot.initiator, 1);
                        getEnergyPastArmor(2.0F, shot);
                        break;
                }
                return;
            ...
            if (s.startsWith("xxoil")) {
                int l = s.charAt(5) - 49;
                if (getEnergyPastArmor(0.21F, shot) > 0.0F && World.Rnd().nextFloat() < 0.2435F) this.FM.AS.hitOil(shot.initiator, l);
            ...
            if (s.startsWith("xxautopilot")) {
                if (getEnergyPastArmor(World.Rnd().nextFloat(1.0F, 4F), shot) > 0.0F) this.FM.AS.setControlsDamage(shot.initiator, 2);
                return;
            }
        ...
        if (s.startsWith("xcf")) {
            if (chunkDamageVisible("CF") < 3) hitChunk("CF", shot);
            return;
        }
        ...
        if (s.startsWith("xkeel2")) {
            if (chunkDamageVisible("Keel2") < 2) hitChunk("Keel2", shot);
            return;
        }
        if (s.startsWith("xrudder1")) {
            if (chunkDamageVisible("Rudder1") < 1) hitChunk("Rudder1", shot);
            return;
        }
        if (s.startsWith("xrudder2")) {
            if (chunkDamageVisible("Rudder2") < 1) hitChunk("Rudder2", shot);
            return;
        }
        if (s.startsWith("xvatorl")) {
            if (chunkDamageVisible("VatorL") < 2) hitChunk("VatorL", shot);
            return;
        }
        if (s.startsWith("xvatorr")) {
            if (chunkDamageVisible("VatorR") < 2) hitChunk("VatorR", shot);
            return;
        }
        if (s.startsWith("xstabl")) {
            if (chunkDamageVisible("StabL") < 2) hitChunk("StabL", shot);
            return;
        }
        if (s.startsWith("xstabr")) {
            if (chunkDamageVisible("StabR") < 2) hitChunk("StabR", shot);
            return;
        }
        if (s.startsWith("xwinglin")) {
            if (chunkDamageVisible("WingLIn") < 3) hitChunk("WingLIn", shot);
            return;
        }
        if (s.startsWith("xwingrin")) {
            if (chunkDamageVisible("WingRIn") < 3) hitChunk("WingRIn", shot);
            return;
        }
        if (s.startsWith("xwinglmid")) {
            if (chunkDamageVisible("WingLMid") < 3) hitChunk("WingLMid", shot);
            return;
        }
        if (s.startsWith("xwingrmid")) {
            if (chunkDamageVisible("WingRMid") < 3) hitChunk("WingRMid", shot);
            return;
        }
        if (s.startsWith("xwinglout")) {
            if (chunkDamageVisible("WingLOut") < 3) hitChunk("WingLOut", shot);
            return;
        }
        if (s.startsWith("xwingrout")) {
            if (chunkDamageVisible("WingROut") < 3) hitChunk("WingROut", shot);
            return;
        }
        if (s.startsWith("xaronel")) {
            if (chunkDamageVisible("AroneL") < 1) hitChunk("AroneL", shot);
            return;
        }
        if (s.startsWith("xaroner")) {
            if (chunkDamageVisible("AroneR") < 1) hitChunk("AroneR", shot);
            return;
        }
        if (s.startsWith("xengine1")) {
            if (chunkDamageVisible("Engine1") < 2) hitChunk("Engine1", shot);
            return;
        }
        if (s.startsWith("xengine2")) {
            if (chunkDamageVisible("Engine2") < 2) hitChunk("Engine2", shot);
            return;
        }
        if (s.startsWith("xengine3")) {
            if (chunkDamageVisible("Engine3") < 2) hitChunk("Engine3", shot);
            return;
        }
        if (s.startsWith("xengine4")) {
            if (chunkDamageVisible("Engine4") < 2) hitChunk("Engine4", shot);
            return;
        }
    ...
    public void doMurderPilot(int i) {
        ...
        if (i<4) hierMesh().chunkVisible("HMask" + (i + 1) + "_D0", false);
        hierMesh().chunkVisible("Pilot" + (i + 1) + "_D1", true);
        if (i<4) hierMesh().chunkVisible("Head" + (i + 1) + "_D0", false);
    }
    ...
    public void typeBomberUpdate(float f) {
        ...
        if (fSightCurReadyness < 1.0F) fSightCurReadyness += 0.0333333F * f;
            ...
            if ((double) fSightCurDistance < (double) toMetersPerSecond(fSightCurSpeed) * Math.sqrt(toMeters(fSightCurAltitude) * (2F / 9.81F))) bSightBombDump = true;
            if (bSightBombDump) if (this.FM.isTick(3, 0)) {
    ...
    public boolean turretAngles(int i, float af[]) {
        ...
        switch (i) {
            ...
            case 1:
                pitchLimit = -5F;
                if (yawAbs < 13F) pitchLimit = Math.max(pitchLimit,  0F);
                else if (yawAbs < 18F) pitchLimit = Math.max(pitchLimit,  CommonTools.smoothCvt(yawAbs, 13F, 18F, 0F, 10F));
                else if (yawAbs < 30F) pitchLimit = Math.max(pitchLimit,  10F);
                else if (yawAbs < 35F) pitchLimit = Math.max(pitchLimit,  CommonTools.smoothCvt(yawAbs, 30F, 35F, 10F, -5F));
                else if (yawAbs < 85F) pitchLimit = Math.max(pitchLimit,  -5F);
                else if (yawAbs < 90F) pitchLimit = Math.max(pitchLimit,  CommonTools.smoothCvt(yawAbs, 85F, 90F, -5F, 2F));
                else pitchLimit = Math.max(pitchLimit,  2F);
                if (pitch > 73F) {
                    pitch = 73F;
                    flag = false;
                }
            ...
            case 2:
                {
                    pitchLimit = 5F;
                    if (yawAbs < 5F) pitchLimit = Math.min(pitchLimit, CommonTools.smoothCvt(yawAbs, 0F, 5F, -2F, 0F));
                    else if (yawAbs < 45F) pitchLimit = Math.min(pitchLimit, CommonTools.smoothCvt(yawAbs, 5F, 45F, 0F, 5F));
                    else if (yawAbs > 135F) pitchLimit = Math.min(pitchLimit, CommonTools.smoothCvt(yawAbs, 135F, 180F, 5F, 0F));
                    float bayDoor = 0F;
                    if (BaseGameVersion.is412orLater()) {
                        bayDoor = this.getBayDoor();
                    } else {
                    ...
                    if (gearL > 0F && yaw > 35F && yaw < 65F && pitch > -15F) flag = false;
                    if (gearR > 0F && yaw < -35F && yaw > -65F && pitch > -15F) flag = false;
                    if (gearC > 0F && yawAbs > 140F && pitch > -45F) flag = false;
                }
                break;
            ...
            case 3:
                {
                    pitchLimit = 5F;
                    if (yawAbs < 45F) pitchLimit = Math.min(pitchLimit, CommonTools.smoothCvt(yawAbs, 0F, 45F, 0F, 5F));
                    else if (yawAbs > 135F) pitchLimit = Math.min(pitchLimit, CommonTools.smoothCvt(yawAbs, 135F, 180F, 5F, -2F));
                    if (pitch < -73F) {
                        pitch = -73F;
                        flag = false;
                    }
                    ...
                    if (gearL > 0F && yaw > 115F && yaw < 145F && pitch > -15F) flag = false;
                    if (gearR > 0F && yaw < -115F && yaw > -145F && pitch > -15F) flag = false;
                    if (gearC > 0F && yawAbs > 175F && pitch > -10F) flag = false;
                }
                break;
