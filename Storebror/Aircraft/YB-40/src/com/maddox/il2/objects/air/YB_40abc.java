...
public abstract class YB_40abc extends Scheme4 implements TypeTransport {
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        ...
        if (s.startsWith("xx")) {
            if (s.startsWith("xxarmor")) {
                if (s.endsWith("p1") || s.endsWith("p1")) {
                    this.getEnergyPastArmor(2.4F, shot);
                } else if (s.endsWith("p9")) {
                    this.getEnergyPastArmor(16.87D / (Math.abs(Aircraft.v1.x) + 0.0001D), shot);
                }
                return;
            }
            if (s.startsWith("xxcontrols")) {
                ...
                switch (j) {
                    ...
                    case 1:
                    case 2:
                        if ((World.Rnd().nextFloat() < 0.0625F) && (this.getEnergyPastArmor(10.4F, shot) > 0.0F)) {
                            Aircraft.debugprintln(this, "*** Control Column: Hit, Controls Destroyed..");
                            this.FM.AS.setControlsDamage(shot.initiator, 2);
                            this.FM.AS.setControlsDamage(shot.initiator, 1);
                            this.FM.AS.setControlsDamage(shot.initiator, 0);
                        }
                        this.getEnergyPastArmor(4.0F, shot);
                        break;

                    case 5:
                    case 6:
                        if (World.Rnd().nextFloat() < 0.00025F) {
                            this.FM.AS.setControlsDamage(shot.initiator, 1);
                        }
                        break;
                    ...
                    case 10:
                        i = j - 7;
                        if (this.getEnergyPastArmor(4.4F, shot) > 0.0F) {
                            if (World.Rnd().nextFloat() < 0.0625F) {
                    ...
                    case 11:
                    case 12:
                        if ((this.getEnergyPastArmor(2.0F, shot) > 0.0F) && (World.Rnd().nextFloat() < 0.125F)) {
                            this.FM.AS.setControlsDamage(shot.initiator, 0);
            ...
            if (s.startsWith("xxspar")) {
                if (s.startsWith("xxsparli") && (this.chunkDamageVisible("WingLIn") > 2) && (this.getEnergyPastArmor(19.6F * World.Rnd().nextFloat(2.0F, 6F), shot) > 0.0F) && (World.Rnd().nextFloat() < 0.0625F)) {
                    Aircraft.debugprintln(this, "*** WingLIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparri") && (this.chunkDamageVisible("WingRIn") > 2) && (this.getEnergyPastArmor(19.6F * World.Rnd().nextFloat(2.0F, 6F), shot) > 0.0F) && (World.Rnd().nextFloat() < 0.0625F)) {
                    Aircraft.debugprintln(this, "*** WingRIn Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRIn_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlm") && (this.chunkDamageVisible("WingLMid") > 2) && (this.getEnergyPastArmor(16.8F * World.Rnd().nextFloat(2.0F, 4.0F), shot) > 0.0F) && (World.Rnd().nextFloat() < 0.0625F)) {
                    Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparrm") && (this.chunkDamageVisible("WingRMid") > 2) && (this.getEnergyPastArmor(16.8F * World.Rnd().nextFloat(2.0F, 4.0F), shot) > 0.0F) && (World.Rnd().nextFloat() < 0.0625F)) {
                    Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if (s.startsWith("xxsparlo") && (this.chunkDamageVisible("WingLOut") > 2) && (this.getEnergyPastArmor(16.6F * World.Rnd().nextFloat(2.0F, 4.0F), shot) > 0.0F) && (World.Rnd().nextFloat() < 0.0625F)) {
                    Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if (s.startsWith("xxsparro") && (this.chunkDamageVisible("WingROut") > 2) && (this.getEnergyPastArmor(16.6F * World.Rnd().nextFloat(2.0F, 4.0F), shot) > 0.0F) && (World.Rnd().nextFloat() < 0.0625F)) {
                    Aircraft.debugprintln(this, "*** WingROut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if (s.startsWith("xxspark") && (this.chunkDamageVisible("Keel1") > 1) && (this.getEnergyPastArmor(16.6F * World.Rnd().nextFloat(2.0F, 4.0F), shot) > 0.0F)) {
            ...
            if (s.startsWith("xxbomb")) {
                if ((World.Rnd().nextFloat() < 0.00025F) && (this.FM.CT.Weapons[3] != null) && this.FM.CT.Weapons[3][0].haveBullets()) {
            ...
            if (s.startsWith("xxlock")) {
                ...
                if (s.startsWith("xxlockr") && (this.getEnergyPastArmor(6.5F * World.Rnd().nextFloat(2.0F, 3.0F), shot) > 0.0F)) {
                    this.debuggunnery("Lock Construction: Rudder1 Lock Shot Off..");
                    this.nextDMGLevels(3, 2, "Rudder1_D" + this.chunkDamageVisible("Rudder1"), shot.initiator);
                }
                if (s.startsWith("xxlockvl") && (this.getEnergyPastArmor(6.5F * World.Rnd().nextFloat(2.0F, 3.0F), shot) > 0.0F)) {
                    this.debuggunnery("Lock Construction: VatorL Lock Shot Off..");
                    this.nextDMGLevels(3, 2, "VatorL_D" + this.chunkDamageVisible("VatorL"), shot.initiator);
                }
                if (s.startsWith("xxlockvr") && (this.getEnergyPastArmor(6.5F * World.Rnd().nextFloat(2.0F, 3.0F), shot) > 0.0F)) {
                    this.debuggunnery("Lock Construction: VatorR Lock Shot Off..");
                    this.nextDMGLevels(3, 2, "VatorR_D" + this.chunkDamageVisible("VatorR"), shot.initiator);
                }
                if (s.startsWith("xxlockal") && (this.getEnergyPastArmor(6.5F * World.Rnd().nextFloat(2.0F, 3.0F), shot) > 0.0F)) {
                    this.debuggunnery("Lock Construction: AroneL Lock Shot Off..");
                    this.nextDMGLevels(3, 2, "AroneL_D" + this.chunkDamageVisible("AroneL"), shot.initiator);
                }
                if (s.startsWith("xxlockar") && (this.getEnergyPastArmor(6.5F * World.Rnd().nextFloat(2.0F, 3.0F), shot) > 0.0F)) {
            ...
            if (s.startsWith("xxeng")) {
                ...
                if (s.endsWith("case")) {
                    ...
                    } else if (World.Rnd().nextFloat() < 0.0025F) {
                        this.FM.EI.engines[k].setCyliderKnockOut(shot.initiator, 1);
                    } else {
                        this.FM.EI.engines[k].setReadyness(shot.initiator, this.FM.EI.engines[k].getReadyness() - 0.00041F);
                ...
                if (s.endsWith("cyls")) {
                    if ((this.getEnergyPastArmor(11.7F, shot) > 0.0F) && (World.Rnd().nextFloat() < (this.FM.EI.engines[k].getCylindersRatio() * 0.375F))) {
                        this.FM.EI.engines[k].setCyliderKnockOut(shot.initiator, World.Rnd().nextInt(1, (int) (shot.power / 38000F)));
                        ...
                        if (World.Rnd().nextFloat() < (shot.power / 36000F)) {
                            this.FM.AS.hitEngine(shot.initiator, k, 2);
                            Aircraft.debugprintln(this, "*** Engine (" + k + ") Cylinders Hit - Engine Fires..");
                        }
                    }
                    this.getEnergyPastArmor(50F, shot);
                }
                if (s.endsWith("mag1")) {
                ...
                if (s.endsWith("prop") && (this.getEnergyPastArmor(1.0F, shot) > 0.0F) && (World.Rnd().nextFloat() < 0.25F)) {
            ...
            if (s.startsWith("xxoiltank")) {
                ...
                if ((this.getEnergyPastArmor(1.1F, shot) > 0.0F) && (World.Rnd().nextFloat() < 0.12175F)) {
            ...
            if (s.startsWith("xxtank")) {
                ...
                if (this.getEnergyPastArmor(2.0F, shot) > 0.0F) {
                    ...
                    if (shot.powerType == 3) {
                        if (shot.power < 32200F) {
                            if ((this.FM.AS.astateTankStates[l] < 4) && (World.Rnd().nextFloat() < 0.0525F)) {
                                this.FM.AS.hitTank(shot.initiator, l, 1);
                            }
                        } else {
                            this.FM.AS.hitTank(shot.initiator, l, World.Rnd().nextInt(1, 1 + (int) (shot.power / 32200F)));
                        }
                    } else if (shot.power > 32200F) {
                        this.FM.AS.hitTank(shot.initiator, l, World.Rnd().nextInt(1, 1 + (int) (shot.power / 32200F)));
                    }
                }
                return;
            ...
            if (s.startsWith("xxactu0")) {
                ...
                if ((this.getEnergyPastArmor(12.6F, shot) > 0.0F) && this.FM.AS.isMaster()) {
        ...
        if (s.startsWith("xmgun")) {
            ...
            if ((this.getEnergyPastArmor(2.9F, shot) > 0.0F) && (World.Rnd().nextFloat() < 0.175F)) {
                switch (k1) {
                    case 1:
                        k1 = 10;
                        i = 0;
    ...
    static {
        Property.set(YB_40abc.class, "originCountry", PaintScheme.countryUSA);
    }
}
