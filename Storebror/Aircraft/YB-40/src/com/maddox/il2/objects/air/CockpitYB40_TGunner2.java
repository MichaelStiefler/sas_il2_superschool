...
public class CockpitYB40_TGunner2 extends CockpitGunner {
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            this.aircraft().hierMesh().chunkVisible("Turret9B_D0", false);
            return true;
        } else {
            return false;
        }
    ...
    protected void doFocusLeave() {
        this.aircraft().hierMesh().chunkVisible("Turret9B_D0", this.aircraft().hierMesh().isChunkVisible("Turret9A_D0"));
        super.doFocusLeave();
    }
    ...
    public void clipAnglesGun(Orient orient) {
        ...
        if (f1 < this.cvt(f2, 140F, 180F, -1F, 25F)) {
            f1 = this.cvt(f2, 140F, 180F, -1F, 25F);
        }
    ...
    protected void interpTick() {
        ...
        if (this.bGunFire) {
            if (this.hook1 == null) {
                this.hook1 = new HookNamed(this.aircraft(), "_MGUN13");
            }
            this.doHitMasterAircraft(this.aircraft(), this.hook1, "_MGUN13");
            if (this.hook2 == null) {
                this.hook2 = new HookNamed(this.aircraft(), "_MGUN14");
            }
            this.doHitMasterAircraft(this.aircraft(), this.hook2, "_MGUN14");
        }
    }
    ...
    static {
        ...
        Property.set(CockpitYB40_TGunner2.class, "astatePilotIndx", 9);
    }
}
