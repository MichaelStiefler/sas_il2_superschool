...
public class CockpitYB40 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitYB40.this.fm != null) {
                ...
                if (BaseGameVersion.is410orLater() && CockpitYB40.this.useRealisticNavigationInstruments()) {
                    CockpitYB40.this.setNew.waypointAzimuth.setDeg(f);
                    CockpitYB40.this.setOld.waypointAzimuth.setDeg(f);
                    CockpitYB40.this.setNew.radioCompassAzimuth.setDeg(CockpitYB40.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitYB40.this.radioCompassAzimuthInvertMinus() - CockpitYB40.this.setOld.azimuth.getDeg(1.0F));
                    if (CockpitYB40.this.fm.AS.listenLorenzBlindLanding && CockpitYB40.this.fm.AS.isAAFIAS) {
                        CockpitYB40.this.setNew.ilsLoc = ((10F * CockpitYB40.this.setOld.ilsLoc) + CockpitYB40.this.getBeaconDirection()) / 11F;
                        CockpitYB40.this.setNew.ilsGS = ((10F * CockpitYB40.this.setOld.ilsGS) + CockpitYB40.this.getGlidePath()) / 11F;
                    } else {
                        CockpitYB40.this.setNew.ilsLoc = 0.0F;
                        CockpitYB40.this.setNew.ilsGS = 0.0F;
                    }
                } else {
                    CockpitYB40.this.setNew.waypointAzimuth.setDeg(CockpitYB40.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitYB40.this.setNew.radioCompassAzimuth.setDeg(CockpitYB40.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitYB40.this.setOld.azimuth.getDeg(0.1F));
                }
                if (CockpitYB40.this.yb40 != null) {
                    CockpitYB40.this.setNew.PDI = CockpitYB40.this.yb40.fSightCurSideslip;
                }
    ...
    public CockpitYB40() {
        ...
        if (this.aircraft() instanceof YB_40) {
            this.yb40 = (YB_40) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Zslip2", 0.0F, this.cvt(((Tuple3f) (this.w)).z, -0.23562F, 0.23562F, 23F, -23F), 0.0F);
        ...
        this.mesh.chunkSetAngles("ZFuelPress1", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        this.mesh.chunkSetAngles("ZFuelPress2", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        this.mesh.chunkSetAngles("ZFuelPress3", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        this.mesh.chunkSetAngles("ZFuelPress4", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        ...
        if (BaseGameVersion.is412orLater()) {
            this.mesh.chunkVisible("Z_GearGreen", (this.fm.CT.getGearC() > 0.99F) && (this.fm.CT.getGearL() > 0.99F) && (this.fm.CT.getGearR() > 0.99F));
            this.mesh.chunkVisible("Z_GearRedL", (this.fm.CT.getGearL() < 0.98F) && this.fm.Gears.lgear);
            this.mesh.chunkVisible("Z_GearRedR", (this.fm.CT.getGearR() < 0.98F) && this.fm.Gears.rgear);
        } else {
            this.mesh.chunkVisible("Z_GearGreen", this.fm.CT.getGear() > 0.99F);
            this.mesh.chunkVisible("Z_GearRedL", (this.fm.CT.getGear() < 0.98F) && this.fm.Gears.lgear);
            this.mesh.chunkVisible("Z_GearRedR", (this.fm.CT.getGear() < 0.98F) && this.fm.Gears.rgear);
        }
    }
