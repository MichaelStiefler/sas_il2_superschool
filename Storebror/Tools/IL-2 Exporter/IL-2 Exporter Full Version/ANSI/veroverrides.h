...
#define MAXVER_INTERNALNAME "il2_exporter\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "IL2exp_Full_Max2012_64Bit.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "IL-2 Full Export (SAS)\0"//should  be overidden on a per-dll level
