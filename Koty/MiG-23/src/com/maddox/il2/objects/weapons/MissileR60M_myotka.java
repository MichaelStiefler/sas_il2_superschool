...
public class MissileR60M_myotka extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileR60M_myotka(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileR60M_myotka(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
        MissileInit(actor, netchannel, i, point3d, orient, f);
    }

    public MissileR60M_myotka()
    {
    }

    static 
    {
        Class class1 = MissileR60M_myotka.class;
