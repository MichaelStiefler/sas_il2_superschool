// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 08.12.2019 15:01:13
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   MissileR24T.java
...
public class MissileR24T extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileR24T(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileR24T(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
    ...
    static 
    {
        Class class1 = MissileR24T.class;
        Property.set(class1, "mesh", "3do/arms/R-24T/mono.sim");
        ...
        Property.set(class1, "failureRate", 25F);
