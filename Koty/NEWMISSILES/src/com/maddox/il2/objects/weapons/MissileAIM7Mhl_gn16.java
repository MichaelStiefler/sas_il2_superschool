...
public class MissileAIM7Mhl_gn16 extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileAIM7Mhl_gn16(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileAIM7Mhl_gn16()
    {
    }

    public MissileAIM7Mhl_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
    ...
    static 
    {
        Class class1 = MissileAIM7Mhl_gn16.class;
        ...
        Property.set(class1, "force", 25577);
        Property.set(class1, "timeSustain", 11F);
        Property.set(class1, "forceSustain", 4500);
