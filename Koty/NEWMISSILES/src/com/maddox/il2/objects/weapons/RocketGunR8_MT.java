...
public class RocketGunR8_MT extends MissileGun
    implements RocketGunWithDelay
{

    public RocketGunR8_MT()
    {
    }

    static 
    {
        Class class1 = RocketGunR8_MT.class;
        Property.set(class1, "bulletClass", (Object)MissileR8_MT.class);
