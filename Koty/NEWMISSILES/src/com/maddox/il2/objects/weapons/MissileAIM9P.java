...
public class MissileAIM9P extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileAIM9P(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileAIM9P(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.MissileAIM9P.class;
        Property.set(class1, "mesh", "3do/arms/AIM9J/mono.sim");
        ...
        Property.set(class1, "friendlyName", "AIM-9P");
