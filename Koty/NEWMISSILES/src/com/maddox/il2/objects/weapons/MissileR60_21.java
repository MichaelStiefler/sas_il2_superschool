...
public class MissileR60_21 extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileR60_21(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileR60_21(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
        MissileInit(actor, netchannel, i, point3d, orient, f);
    }

    public MissileR60_21()
    {
    }

    static 
    {
        Class class1 = MissileR60_21.class;
        ...
        Property.set(class1, "power", 3.0F);
