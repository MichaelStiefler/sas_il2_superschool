...
public class MissileAIM9M extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileAIM9M(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileAIM9M(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.MissileAIM9M.class;
        ...
        Property.set(class1, "smoke", "effects/Smokes/SmokeBlack_BuletteTrail.eff");
        ...
        Property.set(class1, "stepsForFullTurn", 1);
