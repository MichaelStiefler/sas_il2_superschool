// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 19.04.2018 13:57:56
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   MGunMiniGun.java
...
public class MGunMiniGun extends MGunBrowning50s
{
    ...
    public GunProperties createProperties()
    {
        ...
        gunproperties.maxDeltaAngle = 0.5F;//0.229F;
        ...
        gunproperties.bullet[0].massa = 0.0105F;
        gunproperties.bullet[0].kalibr = 0.000044F;//1.05062E-007F;
        gunproperties.bullet[0].speed = 853F;//1070F;
        ...
        gunproperties.bullet[1].massa = 0.0105F;
        gunproperties.bullet[1].kalibr = 0.000044F;//1.05062E-007F;
        gunproperties.bullet[1].speed = 853F;//1070F;
        ...
        gunproperties.bullet[2].kalibr = 0.000044F;//1.05062E-007F;
        gunproperties.bullet[2].speed = 853F;//1070F;
        ...
        gunproperties.bullet[3].massa = 0.0105F;
        gunproperties.bullet[3].kalibr = 0.000044F;//1.05062E-007F;
        gunproperties.bullet[3].speed = 853F;//1070F;
