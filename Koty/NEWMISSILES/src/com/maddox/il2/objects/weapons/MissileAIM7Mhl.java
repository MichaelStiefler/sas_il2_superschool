...
public class MissileAIM7Mhl extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileAIM7Mhl(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileAIM7Mhl()
    {
    }

    public MissileAIM7Mhl(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
    ...
    static 
    {
        Class class1 = MissileAIM7Mhl.class;
