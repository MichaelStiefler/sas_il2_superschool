...
public class MissileR60M_21 extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileR60M_21(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileR60M_21(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
        MissileInit(actor, netchannel, i, point3d, orient, f);
    }

    public MissileR60M_21()
    {
    }

    static 
    {
        Class class1 = MissileR60M_21.class;
        ...
        Property.set(class1, "maxFOVto", 170F);
