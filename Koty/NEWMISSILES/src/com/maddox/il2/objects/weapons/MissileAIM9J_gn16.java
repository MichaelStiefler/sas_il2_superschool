...
// Source File Name:   MissileAIM9J_gn16.java
...
public class MissileAIM9J_gn16 extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileAIM9J_gn16(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileAIM9J_gn16()
    {
    }

    public MissileAIM9J_gn16(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.MissileAIM9J_gn16.class;
...
//      Property.set(class1, "flameSustain", "3do/Effects/RocketSidewinder/RocketSidewinderFlame.sim");
        ...
        Property.set(class1, "timeSustain", 37F);
        ...
        Property.set(class1, "massa", 77F);
        Property.set(class1, "massaEnd", 52.2F);
        ...
        Property.set(class1, "friendlyName", "AIM-9J");
