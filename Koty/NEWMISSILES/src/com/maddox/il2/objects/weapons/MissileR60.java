...
public class MissileR60 extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileR60(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileR60(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
