...
public class MissileR8_MT extends Missile
{
    static class SPAWN extends Missile.SPAWN
    {
        ...
        {
            new MissileR8_MT(actor, netchannel, i, point3d, orient, f);
        }
    ...
    public MissileR8_MT(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
    ...
    static 
    {
        Class class1 = MissileR8_MT.class;
        Property.set(class1, "mesh", "3do/arms/R-8MT/mono.sim");
...
//      Property.set(class1, "flameSustain", "3do/Effects/RocketSidewinder/RocketSidewinderFlame.sim");
        ...
        Property.set(class1, "friendlyName", "R-8MT");
