// Decompiled by DJ v3.12.12.96 Copyright 2011 Atanas Neshkov  Date: 17.01.2015 12:35:28
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   CockpitBF_110G4NJ.java
...
//            CockpitPilot, Aircraft, Cockpit, BF_110G4NJ
...
public class CockpitBF_110G4NJ extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            BF_110G4NJ _tmp = (BF_110G4NJ)aircraft();
            if(BF_110G4NJ.bChangedPit)
            {
                reflectPlaneToModel();
                BF_110G4NJ _tmp1 = (BF_110G4NJ)aircraft();
            ...
            World.cur(); World.land(); CockpitBF_110G4NJ.this.setNew.radioalt = (0.9F * CockpitBF_110G4NJ.this.setOld.radioalt + 0.1F * (CockpitBF_110G4NJ.this.fm.getAltitude() - Landscape.HQ_Air((float)CockpitBF_110G4NJ.this.fm.Loc.x, (float)CockpitBF_110G4NJ.this.fm.Loc.y)));
