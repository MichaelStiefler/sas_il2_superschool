// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov  Date: 3/06/2013 3:59:07 PM
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   RocketAGM.java
...
public class RocketAGM extends Rocket
{
    ...
    implements NetUpdate
{
    ...
    public void netUpdate()
    {
        ...
        {
            out.unLockAndClear();
            pos.getAbs(RocketAGM.p, RocketAGM.or);
            out.writeFloat((float)RocketAGM.p.x);
            out.writeFloat((float)RocketAGM.p.y);
            out.writeFloat((float)RocketAGM.p.z);
            RocketAGM.or.wrap();
            int i = (int)((RocketAGM.or.getYaw() * 32000F) / 180F);
            int j = (int)((RocketAGM.or.tangage() * 32000F) / 90F);
            out.writeShort(i);
            out.writeShort(j);
...
class Mirror extends ActorNet
{
        ...
        throws IOException
    {
        ...
        RocketAGM.p.x = netmsginput.readFloat();
        RocketAGM.p.y = netmsginput.readFloat();
        RocketAGM.p.z = netmsginput.readFloat();
        int i = netmsginput.readShort();
        int j = netmsginput.readShort();
        float f = -(((float)i * 180F) / 32000F);
        float f1 = ((float)j * 90F) / 32000F;
        RocketAGM.or.set(f, f1, 0.0F);
        pos.setAbs(RocketAGM.p, RocketAGM.or);
        return true;
    }
    ...
    implements NetSpawn
{
    ...
    public void netSpawn(int i, NetMsgInput netmsginput)
    {
        ...
        try
        {
            ...
            RocketAGM rocketAGM = new RocketAGM(actor, netmsginput.channel(), i, point3d, orient, f);
        }
        catch(Exception exception)
        {
    ...
    public RocketAGM(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f)
    {
        fm = null;
        tStart = 0L;
        prevd = 1000F;
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.RocketAGM.class;
