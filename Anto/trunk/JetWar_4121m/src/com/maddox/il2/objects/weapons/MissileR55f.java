...
public class MissileR55f extends Missile {
  ...
  static {
    Class class1 = com.maddox.il2.objects.weapons.MissileR55f.class;
    Property.set(class1, "mesh", "3do/arms/R-55f/mono.sim");
    ...
    Property.set(class1, "power", 1.135F); // RL Data: 11.35kg HE warhead, for realism reduced to 1/4th of it's RL weight
    ...
    Property.set(class1, "PkDistMax", 4500.0F); // max Distance for Pk calculation
    ...
    Property.set(class1, "stepsForFullTurn", 12.0F); // No. of 100ms ticks for full control surface turn
    ...
    Property.set(class1, "friendlyName", "R-55"); // Display Name of this missile
