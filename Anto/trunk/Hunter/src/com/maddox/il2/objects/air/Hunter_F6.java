...
public class Hunter_F6 extends Hunter
implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector
{
 ...
 // <editor-fold defaultstate="collapsed" desc="Countermeasures">
  ...
  // </editor-fold>
    ...
    static 
    {
        Class localClass = com.maddox.il2.objects.air.Hunter_F6.class;
        new NetAircraft.SPAWN(localClass);
        Property.set(localClass, "iconFar_shortClassName", "Hunter F6");
        Property.set(localClass, "meshName", "3DO/Plane/Hunter_F4(Multi1)/hierF6.him");
        ...
        Property.set(localClass, "FlightModel", "FlightModels/HunterF6.fmd");
    ...
    // 33 = Inner Bomb Right       = _ExternalBomb06
        ...
        try
        {
            ...
            for(int j = 6; j < 30; j++)
                a_lweaponslot[j] = null;
            a_lweaponslot[26] = new Aircraft._WeaponSlot(9, "PylonF86_Bombs", 1);
            a_lweaponslot[27] = new Aircraft._WeaponSlot(3, "BombGun500lbsMC", 1);
            a_lweaponslot[28] = new Aircraft._WeaponSlot(9, "PylonF86_Bombs", 1);
            a_lweaponslot[29] = new Aircraft._WeaponSlot(3, "BombGun500lbsMC", 1);
