...
public class BombBLU_27Napalm extends Bomb
{

    public BombBLU_27Napalm()
    {
    }
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.weapons.BombBLU_27Napalm.class;
        Property.set(class1, "mesh", "3DO/Arms/BLU_27_Napalm/mono.sim");
        Property.set(class1, "radius", 108.6805F);
        Property.set(class1, "power", 225F);
        Property.set(class1, "powerType", 2);
        Property.set(class1, "kalibr", 0.47F);
        Property.set(class1, "massa", 780F);
