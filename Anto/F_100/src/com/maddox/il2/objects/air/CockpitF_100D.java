  ...
  class Interpolater extends InterpolateRef {
    ...
    public boolean tick() {
      if (fm != null) {
        ...
        setNew.k14w = (5F * CockpitF_100D.k14TargetWingspanScale[((F_100) aircraft()).k14WingspanType])
                / f;
        setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
        setNew.k14wingspan = 0.9F
                * setOld.k14wingspan
                + 0.1F
                * CockpitF_100D.k14TargetMarkScale[((F_100) aircraft()).k14WingspanType];
        ...
        float f3 = floatindex((f - 200F) * 0.04F,
                CockpitF_100D.k14BulletDrop)
                - CockpitF_100D.k14BulletDrop[0];
