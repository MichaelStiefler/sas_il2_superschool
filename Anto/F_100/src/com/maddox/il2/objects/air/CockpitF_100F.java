...
public class CockpitF_100F extends CockpitPilot {
  ...
  class Interpolater extends InterpolateRef {
    ...
    public boolean tick() {
      if (fm != null) {
        ...
        setNew.k14w = (5F * CockpitF_100F.k14TargetWingspanScale[((F_100) aircraft()).k14WingspanType])
                / f;
        setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
        setNew.k14wingspan = 0.9F
                * setOld.k14wingspan
                + 0.1F
                * CockpitF_100F.k14TargetMarkScale[((F_100) aircraft()).k14WingspanType];
        setNew.k14mode = 0.8F * setOld.k14mode + 0.2F
                * (float) ((F_100) aircraft()).k14Mode;
        ...
        float f3 = floatindex((f - 200F) * 0.04F,
                CockpitF_100F.k14BulletDrop)
                - CockpitF_100F.k14BulletDrop[0];
  ...
  public void reflectWorldToInstruments(float f) {
    ...
    resetYPRmodifier();
    mesh.chunkSetAngles("Canopy", 0.0F, 0.0F, 45F * ((FlightModelMain) (fm)).CT.getCockpitDoor());
