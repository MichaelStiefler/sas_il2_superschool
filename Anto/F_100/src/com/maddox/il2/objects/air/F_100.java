...
public class F_100 extends Scheme1 implements TypeSupersonic, TypeFighter,
TypeBNZFighter, TypeFighterAceMaker, TypeRadarGunsight, TypeStormovik, TypeGSuit, TypeZBReceiver, TypeFuelDump, TypeFastJet {
	...
	public static float FuelReserve = 1000F;//Minimum amount of total fuel that can't be drained - "Reserve Tank"
	...
	private class $0 {
		...
		public void rs(int ii) {
			if (ii == 0 || ii == 1) {
				access$234(F_100.this, 0.68);
			}
			if (ii == 31 || ii == 32) {
				access$334(F_100.this, 0.68);
			}
			if (ii == 15 || ii == 16) {
				access$434(F_100.this, 0.68);
			}
		}
		...
		private void $1() {
			if (ts) {
				...
				float f2 = Aircraft.cvt(mn, mn < F_100.mteb ? F_100.lteb
						: F_100.uteb,
						mn < F_100.mteb ? F_100.uteb : F_100.lteb,
								mn < F_100.mteb ? bhef : thef, mn < F_100.mteb ? thef
										: phef);
				float f3 = Aircraft.cvt(mn, mn < F_100.mteb ? F_100.lteb
						: F_100.uteb,
						mn < F_100.mteb ? F_100.uteb : F_100.lteb,
								mn < F_100.mteb ? mef : wef / f1, mn < F_100.mteb ? wef
										/ f1 : lef / f1);
	...
	public F_100() {
		...
		ts = false;
		ictl = false;
		$1 = new $0(0.0F, 13000.0F, 0.65F, 1.0F, 0.01F, 1.0F, 0.2F, 1.0F, 0.5F,
				0.6F, 0.0F);
	...
	public void update(float paramFloat) {
		...
		if(super.FM instanceof Maneuver)
			if(typeDockableIsDocked())
			{
				...
				if(((FlightModelMain) (super.FM)).M.fuel < ((FlightModelMain) (super.FM)).M.maxFuel)
					((FlightModelMain) (super.FM)).M.fuel += 20F * paramFloat;
			} else
				if(!(super.FM instanceof RealFlightModel) || !((RealFlightModel)super.FM).isRealMode())
				{
		...
		if (FM.AS.isMaster() && Config.isUSE_RENDER()) {
			if (FM.EI.engines[0].getThrustOutput() > 0.45F
					&& FM.EI.engines[0].getStage() == 6) {
				if (FM.EI.engines[0].getThrustOutput() > 1.001F) {
					FM.AS.setSootState(this, 0, 5);
				} else if (FM.EI.engines[0].getThrustOutput() > 0.65F
						&& FM.EI.engines[0].getThrustOutput() <= 1.001F) {
		...
		if(((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x += 26000D;
		if(((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() < 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
		...
		if(super.FM.getAltitude() > 9000F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 1300D;
		if(super.FM.getAltitude() > 10000F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() < 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 600D;
		if(super.FM.getAltitude() > 10000F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 3400D;
		if(super.FM.getAltitude() > 10000F && (double)calculateMach() >= 1.3500000000000001D && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
		...
		if(super.FM.getAltitude() > 11000F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 2600D;
		if(super.FM.getAltitude() > 11000F && (double)calculateMach() >= 1.3D && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 7000D;
		if(super.FM.getAltitude() > 11500F && (double)calculateMach() >= 1.22D && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 7000D;
		if(super.FM.getAltitude() > 12000F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 1800D;
		if(super.FM.getAltitude() > 12000F && (double)calculateMach() >= 1.1499999999999999D && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 7000D;
		if(super.FM.getAltitude() > 12500F && (double)calculateMach() >= 1.1000000000000001D && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 7000D;
		if(super.FM.getAltitude() > 13000F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 1600D;
		if(super.FM.getAltitude() > 13500F && (double)calculateMach() >= 1.05D && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 7000D;
		...
		if(super.FM.getAltitude() > 15000F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 1300D;
		if(super.FM.getAltitude() > 15500F && (double)calculateMach() >= 0.96999999999999997D && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 7000D;
		...
		if(super.FM.getAltitude() > 17000F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 8350D;
		if(super.FM.getAltitude() > 18200F && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
			((FlightModelMain) (super.FM)).producedAF.x -= 9200D;
	...
	/* synthetic */
	static float access$234(F_100 x0, double x1) {
		return x0.actl *= x1;
	}

	/* synthetic */
	static float access$334(F_100 x0, double x1) {
		return x0.ectl *= x1;
	}

	/* synthetic */
	static float access$434(F_100 x0, double x1) {
		return x0.rctl *= x1;
	}

	static {
		Class localClass = com.maddox.il2.objects.air.F_100.class;
