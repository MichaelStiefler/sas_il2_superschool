...
public class RealFlightModel extends Pilot {
	...
	public void update(float f) {
		...
		Cwl.x = -d * (double) (Wing.new_CxM(f7, fullMach) + f14 + 0.5F * GearCX * CT.getGearR() + 0.5F * GearCX * CT.getGearL() + radiatorCX * (EI.getRadiatorPos() + CT.getCockpitDoor() + f15) + Sq.dragAirbrakeCx * CT.getAirBrake()) + Sq.dragChuteCx
				* CT.getDragChute();
