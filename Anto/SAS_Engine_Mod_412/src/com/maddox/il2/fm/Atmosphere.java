...
public class Atmosphere
{
    ...
    public static final void set(float f, float f1)
    {
        ...
        if(Engine.land().config.declin < 0)
            i += 6;
        if(i > 12)
            i -= 12;
        ...
        if(Engine.land().config.climate == "Subtropics")
        {
            switch(i)
            {
            case 1: // '\001'
        ...
        if(Engine.land().config.climate == "TropicalRainforest")
        {
            switch(i)
            {
            case 1: // '\001'
        ...
        if(Engine.land().config.climate == "TropicalSavanna")
        {
            switch(i)
            {
            case 1: // '\001'
        ...
        if(Engine.land().config.climate == "HumidContinental")
        {
            switch(i)
            {
            case 1: // '\001'
        ...
        if(Engine.land().config.climate == "Mediterranean")
        {
            switch(i)
            {
            case 1: // '\001'
        ...
        if(Engine.land().config.climate == "Subarctic")
        {
            switch(i)
            {
            case 1: // '\001'
        ...
        if(Engine.land().config.climate == "Arid")
        {
            switch(i)
            {
            case 1: // '\001'
        ...
        System.out.println("Month = " + Mission.curMonth() + " , Hour = " + (int)Math.floor(World.getTimeofDay()));
