...
public class Main3D extends Main
{
    ...
    public static final String gameHotKeyCmdEnvs[] = {
        "Console", "hotkeys", "HookView", "PanView", "HeadMove", "SnapView", "pilot", "move", "gunner", "misc",
        "orders", "aircraftView", "timeCompression", "gui"
    };
...
;
    ...
    private String playNetRecordedMission(String s, boolean flag)
    {
        ...
        catch(Exception exception)
        {
            ...
            if(playRecordedStreams != null) try { playRecordedStreams.close(); } catch(Exception innerexception) { }
            playRecordedStreams = null;
    ...
    public String startPlayRecordedMission()
    {
        ...
        if(!keyRecord.startPlay(playRecordedSect, playRecorderIndx, 12, playRecordedMissionCallback))
    ...
    //TODO: Random splashscreen method
