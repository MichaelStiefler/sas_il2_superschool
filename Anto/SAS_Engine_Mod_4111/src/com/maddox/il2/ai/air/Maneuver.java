    ...
    public void update(float f) {
        ...
        case 21: // '\025'
            ...
            if (AP.way.isLandingOnShip() && AP.way.isLanding()) {
                ...
                //TODO: DBW AI Mod Edits
                if (CT.bHasCockpitDoorControl && !(super.actor instanceof TypeSupersonic | super.actor instanceof TypeSupersonic | super.CT.bNoCarrierCanopyOpen))
            ...
            if (Gears.onGround()) {
                if (EI.engines[0].getStage() == 0) {
                    ...
                    if (canTakeoff) {
                        if (!bStage7) {
                            if (bStage6) {
                                if (bFastLaunchAI || !this.CT.bHasWingControl || this.CT.bHasWingControl && this.CT.getWing() < 0.5F)
                                    bStage7 = true;
                            } else if (bStage4) {
                                ...
                                if (this.CT.bHasCockpitDoorControl && (super.actor instanceof TypeSupersonic | super.actor instanceof TypeSupersonic | super.CT.bNoCarrierCanopyOpen)) {
                                    if (bFastLaunchAI)
                                        this.CT.forceCockpitDoor(0.0F);
                                ...
                                double d6;
                                if (bCatapultAI) {
                                    d3 = -((Tuple3d) (cellairfield.leftUpperCorner())).x - this.Gears.getCatapultOffsetX();
                                    d6 = ((Tuple3d) (cellairfield.leftUpperCorner())).y - this.Gears.getCatapultOffsetY();
                                } else {
                                    d3 = -((Tuple3d) (cellairfield.leftUpperCorner())).x - (double) (cellairfield.getWidth() / 2 - 3);
                                    d6 = this.brakeShoeLoc.getX() + (double) aircraft.getCellAirPlane().getHeight() + 4D;
                                }
