...
public class CockpitME_262Sb extends CockpitPilot {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.gun[0] == null) {
            this.gun[0] = this.aircraft().getGunByHookName("_CANNON03");
            this.gun[1] = this.aircraft().getGunByHookName("_CANNON01");
            this.gun[2] = this.aircraft().getGunByHookName("_CANNON02");
            this.gun[3] = this.aircraft().getGunByHookName("_CANNON04");
        }
