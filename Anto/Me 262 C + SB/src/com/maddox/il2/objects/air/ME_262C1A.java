...
public class ME_262C1A extends ME_262 {
    ...
    public void update(float f) {
        ...
        if (this.FM.AS.isMaster()) {
            if (this.prevThtl < 0.25F) {
                this.FM.EI.engines[ROCKET_INDEX].setControlThrottle(2F/17F);
            } else if (this.prevThtl < 0.50F) {
                this.FM.EI.engines[ROCKET_INDEX].setControlThrottle(7F/17F);
            } else if (this.prevThtl < 0.75F) {
                this.FM.EI.engines[ROCKET_INDEX].setControlThrottle(12F/17F);
            } else {
    ...
    private static final float MAX_ROCKET_FUEL = 1774.0F;
    private static final float ROCKET_BURN_SECONDS = 180.0F;
