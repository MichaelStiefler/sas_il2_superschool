...
public class MissileAIM9C extends Missile {

  static class SPAWN extends Missile.SPAWN {

    public void doSpawn(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
      new MissileAIM9C(actor, netchannel, i, point3d, orient, f);
    }
  }

  public MissileAIM9C(Actor actor, NetChannel netchannel, int i, Point3d point3d, Orient orient, float f) {
  ...
  static {
    Class class1 = com.maddox.il2.objects.weapons.MissileAIM9C.class;
    Property.set(class1, "mesh", "3do/arms/AIM9C/mono.sim");
