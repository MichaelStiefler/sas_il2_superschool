// Source File Name: CockpitF_86K.java
// Author:           
...
public class CockpitF_86K extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				float f = ((F_86D) aircraft()).k14Distance;
				setNew.k14w = (5F * CockpitF_86K.k14TargetWingspanScale[((F_86D) aircraft()).k14WingspanType])
						/ f;
				setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
				setNew.k14wingspan = 0.9F
						* setOld.k14wingspan
						+ 0.1F
						* CockpitF_86K.k14TargetMarkScale[((F_86D) aircraft()).k14WingspanType];
				setNew.k14mode = 0.8F * setOld.k14mode + 0.2F
						* (float) ((F_86D) aircraft()).k14Mode;
	...
	private float machNumber() {
		return ((F_86D) super.aircraft()).calculateMach();
	}
