...
public class CockpitB29_Bombardier extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            ...
            if(bEntered)
            {
                ...
                hookpilot.setSimpleAimOrient(aAim + 10F * f1, tAim + CockpitB29_Bombardier.calibrAngle + f, 0.0F);
            }
            if(fm != null)
            {
                if(bNeedSetUp)
    ...
    static 
    {
        Property.set(com.maddox.il2.objects.air.CockpitB29_Bombardier.class, "astatePilotIndx", 1);
    }
}