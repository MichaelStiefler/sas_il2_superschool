...
;
    ...
    public static void AirFlak(Point3d point3d, int i)
    {
        ...
        case 1: // '\001'
            s = s + "Germ_88mm/";	//line 902, NoClassDefFoundError thrown here!
            break;
        ...
        if (World.Sun().ToSun.z > 0.1F) {
	        ...
	        float lightPointRange = MiscEffects.cvt(World.Sun().ToSun.z, -0.3F, 0.1F, 1000F, 100F);
	        float burnSize = MiscEffects.cvt(World.Sun().ToSun.z, -0.3F, 0.1F, 10F, 1F) * (0.5F + World.rnd().nextFloat());
