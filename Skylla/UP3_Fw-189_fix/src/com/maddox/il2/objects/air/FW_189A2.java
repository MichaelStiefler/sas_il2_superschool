...
import com.maddox.il2.objects.air.PaintSchemeBMPar03;
...
public class FW_189A2 extends Scheme3 implements TypeScout, TypeBomber {
   ...
   static Class class$com$maddox$il2$objects$air$FW_189A2;
   static Class class$com$maddox$il2$objects$air$CockpitFw189;
   static Class class$com$maddox$il2$objects$air$CockpitFw189_RGunner;
   static Class class$com$maddox$il2$objects$air$CockpitFw189_BGunner;
   ...
   public void msgShot(Shot var1) {
      ...
      if(var1.chunkName.startsWith("WingLIn")) {
         ...
         if(Aircraft.v1.x < 0.25D && World.Rnd().nextFloat() < 0.25F && World.Rnd().nextFloat(0.01F, 0.121F) < var1.mass) {
            this.FM.AS.hitTank(var1.initiator, 0, (int)(1.0F + var1.mass * 26.08F));
         }
      }
      ...
      if(var1.chunkName.startsWith("WingRIn")) {
         ...
         if(Aircraft.v1.x < 0.25D && World.Rnd().nextFloat() < 0.25F && World.Rnd().nextFloat(0.01F, 0.121F) < var1.mass) {
            this.FM.AS.hitTank(var1.initiator, 1, (int)(1.0F + var1.mass * 26.08F));
         }
      }

      if(var1.chunkName.startsWith("Engine1")) {
         if(World.Rnd().nextFloat(0.0F, 1.0F) < 0.5F) {
            this.FM.AS.hitEngine(var1.initiator, 0, (int)(1.0F + var1.mass * 20.7F));
         }

         if(World.Rnd().nextFloat() < 0.01F) {
            this.FM.AS.hitEngine(var1.initiator, 0, 5);
         }
      }

      if(var1.chunkName.startsWith("Engine2")) {
         if(World.Rnd().nextFloat(0.0F, 1.0F) < 0.5F) {
            this.FM.AS.hitEngine(var1.initiator, 1, (int)(1.0F + var1.mass * 20.7F));
         }

         if(World.Rnd().nextFloat() < 0.01F) {
            this.FM.AS.hitEngine(var1.initiator, 1, 5);
         }
      }

      if(var1.chunkName.startsWith("Pilot1")) {
         if(Aircraft.v1.x > -0.5D || (double)var1.power * -Aircraft.v1.x > 12800.0D) {
            this.killPilot(var1.initiator, 0);
            this.FM.setCapableOfBMP(false, var1.initiator);
            if(Aircraft.Pd.z > 0.5D && var1.initiator == World.getPlayerAircraft() && World.cur().isArcade()) {
      ...
      if(var1.chunkName.startsWith("Tail1") && World.Rnd().nextFloat() < 0.05F) {
         this.FM.AS.hitTank(var1.initiator, 0, (int)(1.0F + var1.mass * 26.08F));
      }

      if(var1.chunkName.startsWith("Tail2") && World.Rnd().nextFloat() < 0.05F) {
         this.FM.AS.hitTank(var1.initiator, 1, (int)(1.0F + var1.mass * 26.08F));
      }
   ...
   public void rareAction(float var1, boolean var2) {
      ...
      for(int var3 = 1; var3 < 4; ++var3) {
         if(this.FM.getAltitude() < 3000.0F) {
            this.hierMesh().chunkVisible("HMask" + var3 + "_D0", false);
         } else {
            this.hierMesh().chunkVisible("HMask" + var3 + "_D0", this.hierMesh().isChunkVisible("Pilot" + var3 + "_D0"));
         }
      }
   ...
   public void typeBomberUpdate(float var1) {
      ...
      if(this.FM.isPlayers()) {
         ...
         if(var2.z - World.land().HQ(var2.x, var2.y) < 0.009999999776482582D) {
            this.hierMesh().chunkVisible("CF_D0", true);
         }
   ...
   static {
      ...
      Property.set(clazz, "PaintScheme", (Object)(new PaintSchemeBMPar03()));
      ...
      Aircraft.weaponsRegister(clazz, "default", new String[]{"MGunMG17k 660", "MGunMG17k 660", null, null, null, null, "MGunMG81t 1000", "MGunMG81t 1000", "MGunMG81t 1500", "MGunMG81t 1500"});
      Aircraft.weaponsRegister(clazz, "4xSC50", new String[]{"MGunMG17k 660", "MGunMG17k 660", "BombGunSC50", "BombGunSC50", "BombGunSC50", "BombGunSC50", "MGunMG81t 1000", "MGunMG81t 1000", "MGunMG81t 1500", "MGunMG81t 1500"});
      Aircraft.weaponsRegister(clazz, "none", new String[]{null, null, null, null, null, null, null, null, null, null});
   }
}