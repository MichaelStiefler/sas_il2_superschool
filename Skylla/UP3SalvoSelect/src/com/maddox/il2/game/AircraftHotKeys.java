...
// T-ODO: Disabled for 410 compatibility
/*
...
// private int cptdmg;
    ...
    // T-ODO: +++ Added by SAS~Storebor: Show Player Aircraft before any AI Actors! +++
...
// private com.maddox.il2.fm.FlightModel baFM;
    ...
    class HotKeyCmdFire extends HotKeyCmd {
        ...
        public void tick() {
            if (Time.tick() > this.time + 500L)
                AircraftHotKeys.this.doCmdPilotTick(this.cmd, true);
        }
    ...
    public void setPropAuto(boolean bool) {
        if (!bool || this.FM.EI.isSelectionAllowsAutoProp())
            this.bPropAuto = bool;
    }
...
// baFM = flightmodel;
    ...
    private boolean setPilot() {
        ...
        // T-ODO: Added by |ZUTI| - changed to enable gunners as bombardier.
        // -----------------------------------------------------------------
    ...
    private void hudWeapon(boolean bool, int weaponId) {
        ...
        if (bulletemitters != null) {
            ...
            if (!bool)
                ...
                // T-ODO: Added by |ZUTI|: 3 = bombs or other ordinance
                if (weaponId == 3) {
    ...
    private boolean viewAllowed(boolean bool) {
        ...
        if (!bool)
            return false;
        if (bool && this.iExtViewGround == -1 && this.iExtViewDead == -1)
            return true;
    ...
    // T-ODO: Changed by |ZUTI|: from private to public.
    public void doCmdPilot(int i, boolean bool) {
        if (!this.setBombAimerAircraft())
            return;
        if (bool) {
            switch (i) {
                case 139:
...
// boolean bool_12_ = false;
            ...
            switch (i) {
                ...
                case 18:
                    ...
                    break;
                case 19:
                    if (this.bBombBayDoors && this.hasBayDoors())
                    ...
                    // ----------------------------------------------------------------
                        ...
                        this.FM.CT.WeaponControl[3] = bool;
            ...
            if (!bool) {
                switch (i) {
                    default:
                        break;
                    case 71:
                        // T-ODO: Storebror, get rid of "instanceof" name references crashing for missing dependencies,
                        // add conf.ini selectable "stabilizers for all aircraft"

// //T-ODO: Modified to ensure 410 compatibility
...
// */)
                ...
                switch (i) {
                    ...
                    case 7:
                        ...
                        } else if (this.FM.EI.isSelectionHasControlRadiator()) {
                            if (this.FM.CT.getRadiatorControlAuto()) {
                                this.FM.CT.setRadiatorControlAuto(false, this.FM.EI);
                                if (World.cur().diffCur.ComplexEManagement) {
                                    this.FM.CT.setRadiatorControl(0.0F);
                    ...
                    case 3:
                        if (!this.FM.CT.StabilizerControl)
                            this.FM.CT.ElevatorControl = -1.0F;
                        break;
                    case 4:
                        if (!this.FM.CT.StabilizerControl)
                            this.FM.CT.ElevatorControl = 1.0F;
                    ...
                    case 5:
                        if (!this.FM.CT.StabilizerControl)
                            this.FM.CT.AileronControl = -1.0F;
                        break;
                    case 6:
                        if (!this.FM.CT.StabilizerControl)
                            this.FM.CT.AileronControl = 1.0F;
                    ...
                    case 20:
                        ...
                        break;
                    // T-ODO: Added by |ZUTI| for Bomb bay door mod:
                    // ----------------------------------------------
                    case 131: {
                        if (this.bBombBayDoors) {
                            if (this.hasBayDoors()) {
                                ...
                                if (this.FM.CT.BayDoorControl != 0.0F) {
                                    // T-ODO: Added by |ZUTI| - notify users that AC closed it's bomb bay doors
                  ...
                  // ----- todo skylla: enhanced weapon release control -----
                    ...
                    case 61:
                        ...
                        break;
                    case 31:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.0F);
                        break;
                    case 32:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.1F);
                        break;
                    case 33:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.2F);
                        break;
                    case 34:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.3F);
                        break;
                    case 35:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.4F);
                        break;
                    case 36:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.5F);
                        break;
                    case 37:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.6F);
                        break;
                    case 38:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.7F);
                        break;
                    case 39:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.8F);
                        break;
                    case 40:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(0.9F);
                        break;
                    case 41:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(1.0F);
                        break;
                    case 73:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(this.lastProp + 0.05F);
                        break;
                    case 74:
                        if (this.FM.EI.isSelectionHasControlProp())
                            this.setPropControl(this.lastProp - 0.05F);
                    ...
                    case 114:
                        if (this.FM.EI.isSelectionHasControlFeather() && World.cur().diffCur.ComplexEManagement && this.FM.EI.getFirstSelected() != null)
                            this.FM.EI.setFeather(this.FM.EI.getFirstSelected().getControlFeather() != 0 ? 0 : 1);
                        break;
                    case 75:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.0F);
                        break;
                    case 76:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.1F);
                        break;
                    case 77:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.2F);
                        break;
                    case 78:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.3F);
                        break;
                    case 79:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.4F);
                        break;
                    case 80:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.5F);
                        break;
                    case 81:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.6F);
                        break;
                    case 82:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.7F);
                        break;
                    case 83:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.8F);
                        break;
                    case 84:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(0.9F);
                        break;
                    case 85:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(1.0F);
                        break;
                    case 86:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(this.FM.CT.getMixControl() + 0.2F);
                        break;
                    case 87:
                        if (this.FM.EI.isSelectionHasControlMix())
                            this.setMixControl(this.FM.CT.getMixControl() - 0.2F);
                    ...
                    case 113:
                        if (this.FM.EI.isSelectionHasControlExtinguisher()) {
                            for (int i_20_ = 0; i_20_ < this.FM.EI.getNum(); i_20_++) {
                                if (this.FM.EI.getCurControl(i_20_))
                                    this.FM.EI.engines[i_20_].setExtinguisherFire();
                            }
                        }
                        break;
                    case 53:
                    ...
                    case 125:
                        if (aircraft instanceof TypeBomber) {
                            // T-ODO: Added by |ZUTI|: assigning result to designated variable
    ...
    // T-ODO: Added by |ZUTI|: added boolean zutiCheckCommand to avoid doubling of
    ...
    private void doCmdPilotTick(int i, boolean zutiCheckCommand) {
        ...
        switch (i) {
            ...
            case 139:
                //T-ODO: Implement 4.10.1 Codechanges +++
        ...
        if (this.setPilot()) {
            ...
            // T-ODO: Added by |ZUTI|: if checkCommand parameter is true then check it and process
            ...
            switch (i) {
                default:
                    break;
                case 44:
                    if (this.FM.CT.bHasElevatorTrim && this.FM.CT.getTrimElevatorControl() < 0.5F)
                        this.FM.CT.setTrimElevatorControl(this.FM.CT.getTrimElevatorControl() + 0.00625F);
                    break;
                case 45:
                    if (this.FM.CT.bHasElevatorTrim && this.FM.CT.getTrimElevatorControl() > -0.5F)
                        this.FM.CT.setTrimElevatorControl(this.FM.CT.getTrimElevatorControl() - 0.00625F);
                    break;
                case 47:
                    if (this.FM.CT.bHasAileronTrim && this.FM.CT.getTrimAileronControl() < 0.5F)
                        this.FM.CT.setTrimAileronControl(this.FM.CT.getTrimAileronControl() + 0.00625F);
                    break;
                case 48:
                    if (this.FM.CT.bHasAileronTrim && this.FM.CT.getTrimAileronControl() > -0.5F)
                        this.FM.CT.setTrimAileronControl(this.FM.CT.getTrimAileronControl() - 0.00625F);
                    break;
                case 50:
                    if (this.FM.CT.bHasRudderTrim && this.FM.CT.getTrimRudderControl() < 0.5F)
                        this.FM.CT.setTrimRudderControl(this.FM.CT.getTrimRudderControl() + 0.00625F);
                    break;
                case 51:
                    if (this.FM.CT.bHasRudderTrim && this.FM.CT.getTrimRudderControl() > -0.5F)
                        this.FM.CT.setTrimRudderControl(this.FM.CT.getTrimRudderControl() - 0.00625F);
    ...
    // T-ODO: Changed by |ZUTI|: changed from private to public
    public void doCmdPilotMove(int i, float f) {
        if (this.setPilot()) {
            switch (i) {
                case 1: {
                    float f_22_ = f * 0.55F + 0.55F;
                    if (Math.abs(f_22_ - this.lastPower) >= 0.01F)
                        this.setPowerControl(f_22_);
                    break;
                }
                case 7: {
                    float f_23_ = f * 0.5F + 0.5F;
                    if (Math.abs(f_23_ - this.lastProp) >= 0.02F && this.FM.EI.isSelectionHasControlProp())
                        this.setPropControl(f_23_);
                    break;
                }
                case 2:
                    if (!this.FM.CT.bHasFlapsControl)
                ...
                case 3:
                    if (!this.FM.CT.StabilizerControl)
                        this.FM.CT.AileronControl = f;
                    break;
                case 4:
                    if (!this.FM.CT.StabilizerControl)
                        this.FM.CT.ElevatorControl = f;
                    break;
                case 5:
                    if (!this.FM.CT.StabilizerControl)
                        this.FM.CT.RudderControl = f;
                    break;
                case 6:
                ...
                case 8:
                    if (this.FM.CT.bHasAileronTrim)
                        this.FM.CT.setTrimAileronControl(f * 0.5F);
                    break;
                case 9:
                    if (this.FM.CT.bHasElevatorTrim)
                        this.FM.CT.setTrimElevatorControl(f * 0.5F);
                    break;
                case 10:
                    if (this.FM.CT.bHasRudderTrim)
                        this.FM.CT.setTrimRudderControl(f * 0.5F);
                    break;
                // TAK++
                case 11: // BrakeRight
                ...
                case 20: // '\024'
                    ...
                    if (java.lang.Math.abs(f8 - this.lastProp1) >= 0.02F && 0 < this.FM.EI.getNum() && this.FM.EI.engines[0].isHasControlProp())
                        this.setPropControl(f8, 1);
                    break;

                case 21: // '\025'
                    float f9 = f * 0.5F + 0.5F;
                    if (java.lang.Math.abs(f9 - this.lastProp2) >= 0.02F && 1 < this.FM.EI.getNum() && this.FM.EI.engines[1].isHasControlProp())
                        this.setPropControl(f9, 2);
                    break;

                case 22: // '\026'
                    float f10 = f * 0.5F + 0.5F;
                    if (java.lang.Math.abs(f10 - this.lastProp3) >= 0.02F && 2 < this.FM.EI.getNum() && this.FM.EI.engines[2].isHasControlProp())
                        this.setPropControl(f10, 3);
                    break;

                case 23: // '\027'
                    float f11 = f * 0.5F + 0.5F;
                    if (java.lang.Math.abs(f11 - this.lastProp4) >= 0.02F && 3 < this.FM.EI.getNum() && this.FM.EI.engines[3].isHasControlProp())
                        this.setPropControl(f11, 4);
                    break;
                default:
                    return;
            }

            // T-ODO: Added by |ZUTI|: send data over to the new only if mover is not owner of RealFlightModel
    ...
    public void createPilotHotKeys() {
        ...
        // T-ODO: Added by |ZUTI|: Bomb Bay Door mod keys
        // -----------------------------------------------------------------------------
    ...
    public static boolean isCockpitRealMode(int i) {
        if (Main3D.cur3D().cockpits[i] instanceof CockpitPilot) {
            // T-ODO: Added by |ZUTI|: try/catch block
            try {
...
// Object object = null;
        ...
        for (int i = 0; i < 10; i++) {
            HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "cockpitRealOn" + i, null) {
                ...
                public void begin() {
                    if (AircraftHotKeys.this.isMiscValid())
                        setCockpitRealMode(this.indx, true);
                }
            });
            HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "cockpitRealOff" + i, null) {
                ...
                public void begin() {
                    if (AircraftHotKeys.this.isMiscValid())
                        setCockpitRealMode(this.indx, false);
                }
            });
                ...
                public void begin() {
                    if (AircraftHotKeys.this.isMiscValid()) {
                        if (Main3D.cur3D().cockpits != null && this.indx < Main3D.cur3D().cockpits.length) {
                            ...
                            if (!NetMissionTrack.isPlaying()) {
                                Aircraft aircraft = World.getPlayerAircraft();
                                // T-ODO: Added by |ZUTI|: once player spawns as gunner isPlayeGunner function is useless.
                                ...
                                if (World.isPlayerGunner() && World.getPlayerGunner().zutiGetCockpitNum() > 0)
                                    aircraft.netCockpitEnter(World.getPlayerGunner(), this.indx);
                                else
                                    aircraft.netCockpitEnter(aircraft, this.indx);
                            }
                        }
                    }
                }
            ...
            HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "cockpitLeave" + i, null) {
                ...
                public void begin() {
                    if (AircraftHotKeys.this.isMiscValid()) {
                        if (Main3D.cur3D().cockpits != null && this.indx < Main3D.cur3D().cockpits.length && (Main3D.cur3D().cockpits[this.indx] instanceof CockpitGunner) && isCockpitRealMode(this.indx))
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "ejectPilot", "02") {
            ...
            public void begin() {
                ...
                // T-ODO: Added by |ZUTI|: enable bailout if player is gunner
    ...
    public void switchToCockpit(int i) {
        ...
        // T-ODO: Added by |ZUTI|: NEEDS TO BE CALLED!!!!!
    ...
    public void netSwitchToCockpit(int i) {
        if (!Main3D.cur3D().isDemoPlaying()) {
            if (i == this.switchToCockpitRequest)
                new MsgAction(true, new Integer(i)) {
                    public void doAction(Object object) {
    ...
    private int nextValidCockpit() {
        ...
        for (int x = 0; x < cockpits - 1; x++) {
            ...
            // T-ODO: Added by |ZUTI|: added new check for dogfight mode!
            // --------------------------------------------
            if (Mission.isDogfight()) {
            ...
            // --------------------------------------------
            else if (this.isValidCockpit(cockpitNr))
                return cockpitNr;
        }
        return -1;
    }
    ...
    public void createViewHotKeys() {
        ...
        for (int i = 0; i < 10; i++) {
            HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "cockpitView" + i, "0" + i) {
                ...
                public void begin() {
                    // T-ODO: Altered by |ZUTI|: disabled because this option bypasses security locks to prevent two
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "OutsideViewFollow", "46") {
            ...
            public void begin() {
                ...
                if (!Actor.isValid(((Actor) (obj))))
                    obj = AircraftHotKeys.this.getViewActor();
                if (Actor.isValid(((Actor) (obj)))) {
...
//
// // T-ODO: Added by |ZUTI|: Disable showing of paratroopers! New difficulty setting?
// // -------------------------------------------------
