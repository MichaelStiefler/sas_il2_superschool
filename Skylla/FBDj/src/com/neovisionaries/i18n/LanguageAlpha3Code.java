 ...
 *
 * <p>
 * ISO 639-2 code for <a href="http://en.wikipedia.org/wiki/Newari_language" >Newari</a> is {@code new}, but in this enum, the corresponding entry is not {@code new} but {@link #New} (the first letter is capital), because {@code new} is a special word for
...
public enum LanguageAlpha3Code {
    ...
    /**
     * <a href="http://en.wikipedia.org/wiki/Danish_language">Danish</a> {@link LanguageCode#da da}).
     */
    dan("Danish") {
        @Override
        public LanguageCode getAlpha2() {
    ...
    /**
     * <a href="http://en.wikipedia.org/wiki/Interlingua">Interlingua</a> {@link LanguageCode#ia ia}).
     */
    ina("Interlingua") {
        @Override
        public LanguageCode getAlpha2() {
     ...
     *
     * <p>
     * In most cases, this method simply returns <code>this</code> object. On the other hand, language codes that have two alpha-3 codes, namely, ISO 639-2/T code ("terminological" code) and ISO 639-2/B code ("bibliographic" code), return their
     * counterparts. For example, {@link #deu LanguageAlpha3Code.deu}{@code .getSynonym()} returns {@link #ger LanguageAlpha3Code.ger}.
     * </p>
     *
     * @return
     *         <a href="http://en.wikipedia.org/wiki/ISO_639-2">ISO 639-2</a>
     ...
     *
     * <p>
     * Most languages have just one <a href="http://en.wikipedia.org/wiki/ISO_639-2">ISO 639-2</a> code and they simply return <code>this</code> object. Only ISO 639-2/T codes ("terminological" codes) return counterpart objects. For example,
     * {@link LanguageAlpha3Code#fra LanguageAlpha3Code.fra}{@code .getAlpha3B()} returns {@link LanguageAlpha3Code#fre LanguageAlpha3Code.fre}.
     * </p>
     *
     * @return
     ...
     *
     * <p>
     * Most languages have just one <a href="http://en.wikipedia.org/wiki/ISO_639-2">ISO 639-2</a> code and they simply return <code>this</code> object. Only ISO 639-2/B codes ("bibliographic" codes) return counterpart objects. For example,
     * {@link LanguageAlpha3Code#fre LanguageAlpha3Code.fre}{@code .getAlpha3T()} returns {@link LanguageAlpha3Code#fra LanguageAlpha3Code.fra}.
     *
     * </p>
     *
     * @return
     ...
     *            If {@code false}, this method internally canonicalizes the given code by {@link String#toLowerCase()} and then performs search. For
     ...
     *
     *            As an exceptional case, both {@code getByCode("New", true)} and {@code getByCode("new", true)} return {@link #New} (Newari).
     *
     * @return
     *         A {@code LanguageAlpha3Code} instance, or {@code null} if not found.
     *         If <a href="http://en.wikipedia.org/wiki/ISO_639-1">ISO 639-1</a>
