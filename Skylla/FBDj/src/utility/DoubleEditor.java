...
public class DoubleEditor extends DefaultCellEditor {
     ...
     * 
     */
    private static final long serialVersionUID = -9093798380339453080L;
    ...
    public DoubleEditor(Double min, Double max) {
        ...
        ftf.getActionMap().put("check", new AbstractAction() {
             ...
             * 
             */
            private static final long serialVersionUID = 6614260647398013716L;
    ...
    /**
     * Lets the user know that the text they entered is bad. Returns true if the user elects to revert to the last good value. Otherwise, returns false,
    ...
    protected boolean userSaysRevert() {
        ...
        int answer = JOptionPane.showOptionDialog(SwingUtilities.getWindowAncestor(ftf), "The value must be an Double between " + minimum + " and " + maximum + ".\n" + "You can either continue editing " + "or revert to the last valid value.",
