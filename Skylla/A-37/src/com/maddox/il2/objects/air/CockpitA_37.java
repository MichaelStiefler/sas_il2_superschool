...
public class CockpitA_37 extends CockpitPilot {
        ...
        public boolean tick() {
            if(fm != null) {
                ...
                if(setNew.stbyPosition3 < 1.0F)
                    setNew.stbyPosition3 = setOld.stbyPosition3 + 0.005F;
                float f = ((A_37) aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitA_37.k14TargetWingspanScale[((A_37) aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitA_37.k14TargetMarkScale[((A_37) aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((A_37) aircraft()).k14Mode;
                ...
                float f3 = floatindex((f - 200F) * 0.04F, CockpitA_37.k14BulletDrop) - CockpitA_37.k14BulletDrop[0];
    ...
    protected float waypointAzimuth() {
        WayPoint waypoint = ((A_37) aircraft()).FM.AP.way.curr();
        if(waypoint == null) {
            return 0.0F;
        } else {
            waypoint.getP(tmpP);
            tmpV.sub(tmpP, ((A_37) aircraft()).FM.Loc);
    ...
    public void reflectWorldToInstruments(float f) {
        if(A_37.bChangedPit)
            A_37.bChangedPit = false;
        if((((A_37) aircraft()).FM.AS.astateCockpitState & 2) == 0) {
            int i = ((A_37) aircraft()).k14Mode;
            boolean flag = i < 2;
        ...
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((A_37) aircraft()).FM.CT.getCockpitDoor(), 0.01F, 0.99F, -0.52F, 0.0F);
        ...
        resetYPRmodifier();
        resetYPRmodifier();
        if(((A_37) aircraft()).FM.Gears.nOfGearsOnGr == 0) {
            Cockpit.xyz[1] = 0.0F;
            ...
            if(((A_37) aircraft()).FM.CT.getCockpitDoor() == 1.0F) {
                super.mesh.chunkSetLocate("CanopyOpen01", Cockpit.xyz, Cockpit.ypr);
                super.mesh.chunkSetLocate("CanopyOpen02", Cockpit.xyz, Cockpit.ypr);
                super.mesh.chunkSetLocate("CanopyOpen03", Cockpit.xyz, Cockpit.ypr);
            }
        }
        super.mesh.chunkSetAngles("Z_GearHandle", 0.0F, 0.0F, 50F * (pictGear = 0.82F * pictGear + 0.18F * ((A_37) aircraft()).FM.CT.GearControl));
        super.mesh.chunkSetAngles("Z_FlapsLever", -35F * ((A_37) aircraft()).FM.CT.FlapsControl, 0.0F, 0.0F);
        ...
        w.set(((A_37) aircraft()).FM.getW());
        ((A_37) aircraft()).FM.Or.transform(w);
        super.mesh.chunkSetAngles("Z_G-Factor", cvt(super.fm.getOverload(), -4F, 12F, -80.5F, 241.5F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Fuel", cvt(((A_37) aircraft()).FM.M.fuel, 0.0F, 1358F, -150F, 150F), 0.0F, 0.0F);
        ...
        super.mesh.chunkSetAngles("Z_horizont1a", 0.0F, -((A_37) aircraft()).FM.Or.getKren(), 0.0F);
        super.mesh.chunkSetAngles("Z_Suction", cvt(((A_37) aircraft()).FM.EI.engines[0].getRPM(), 0.0F, 3500F, 100F, 395F), 0.0F, 0.0F);
        resetYPRmodifier();
        Cockpit.xyz[1] = cvt(((A_37) aircraft()).FM.CT.getRudder(), -1F, 1.0F, -0.035F, 0.035F);
        super.mesh.chunkSetLocate("Pedal_L", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[1] = -Cockpit.xyz[1];
        super.mesh.chunkSetLocate("Pedal_R", Cockpit.xyz, Cockpit.ypr);
        resetYPRmodifier();
        Cockpit.xyz[2] = cvt(((A_37) aircraft()).FM.Or.getTangage(), -45F, 45F, 0.0328F, -0.0328F);
        super.mesh.chunkSetLocate("Z_horizont1b", Cockpit.xyz, Cockpit.ypr);
        super.mesh.chunkSetAngles("Stick01", (pictElev = 0.7F * pictElev + 0.15F * ((A_37) aircraft()).FM.CT.ElevatorControl) * 16F, 0.0F, -(pictAiler = 0.85F * pictAiler + 0.15F * ((A_37) aircraft()).FM.CT.AileronControl) * 15F);
        super.mesh.chunkSetAngles("Stick02", (pictElev = 0.7F * pictElev + 0.15F * ((A_37) aircraft()).FM.CT.ElevatorControl) * 16F, 0.0F, -(pictAiler = 0.85F * pictAiler + 0.15F * ((A_37) aircraft()).FM.CT.AileronControl) * 15F);
        pictMet1 = 0.96F * pictMet1 + 0.04F * (0.6F * ((A_37) aircraft()).FM.EI.engines[0].getThrustOutput() * ((A_37) aircraft()).FM.EI.engines[0].getControlThrottle() * (((A_37) aircraft()).FM.EI.engines[0].getStage() == 6 ? 1.0F : 0.02F));
        super.mesh.chunkSetAngles("Z_Compass-Emerg1", cvt(((A_37) aircraft()).FM.Or.getTangage(), -30F, 30F, 30F, -30F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Compass-Emerg3", cvt(((A_37) aircraft()).FM.Or.getKren(), -45F, 45F, -45F, 45F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Compass-Emerg2", -interp(setNew.azimuth, setOld.azimuth, f), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_RPM-1", cvt(((A_37) aircraft()).FM.EI.engines[0].getRPM(), 0.0F, 2550F, -180F, 50F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_RPM-2", cvt(((A_37) aircraft()).FM.EI.engines[0].getRPM(), 2550F, 3500F, -10F, 335F), 0.0F, 0.0F);
        super.mesh.chunkSetAngles("Z_Exhaust_Temp", cvt(((A_37) aircraft()).FM.EI.engines[0].tOilOut, 20F, 95F, -160F, -25F), 0.0F, 0.0F);
        ...
        super.mesh.chunkSetAngles("Z_Speed", floatindex(cvt(Pitot.Indicator((float)((Tuple3d) (((A_37) aircraft()).FM.Loc)).z, super.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), speedometerScale), 0.0F, 0.0F);
        ...
        super.mesh.chunkVisible("FlareGearUp_R", ((A_37) aircraft()).FM.CT.getGear() < 0.01F || !((A_37) aircraft()).FM.Gears.rgear);
        super.mesh.chunkVisible("FlareGearUp_L", ((A_37) aircraft()).FM.CT.getGear() < 0.01F || !((A_37) aircraft()).FM.Gears.lgear);
        super.mesh.chunkVisible("FlareGearUp_C", ((A_37) aircraft()).FM.CT.getGear() < 0.01F);
        super.mesh.chunkVisible("FlareGearDn_R", ((A_37) aircraft()).FM.CT.getGear() > 0.99F && ((A_37) aircraft()).FM.Gears.rgear);
        super.mesh.chunkVisible("FlareGearDn_L", ((A_37) aircraft()).FM.CT.getGear() > 0.99F && ((A_37) aircraft()).FM.Gears.lgear);
        super.mesh.chunkVisible("FlareGearDn_C", ((A_37) aircraft()).FM.CT.getGear() > 0.99F);
        super.mesh.chunkVisible("Z_FlareFuel", ((A_37) aircraft()).FM.M.fuel < 150F);
        super.mesh.chunkVisible("Z_FlareFire1", ((A_37) aircraft()).FM.AS.astateEngineStates[0] > 2);
        super.mesh.chunkVisible("Z_FlareFire2", ((A_37) aircraft()).FM.AS.astateEngineStates[0] > 2);
        resetYPRmodifier();
        ...
        if(((A_37) aircraft()).FM.CT.getCockpitDoor() > 0.49F && super.fm.getSpeed() > 164F * f1) {
            ((A_37) aircraft()).FM.CT.bHasCockpitDoorControl = false;
        ...
        if(((A_37) aircraft()).FM.AS.bIsAboutToBailout && !super.fm.brakeShoe && super.fm.getSpeedKMH() >= 100F && ((A_37) aircraft()).FM.Gears.nOfGearsOnGr == 0) {
        ...
        if(((A_37) aircraft()).FM.AS.bIsAboutToBailout) {
            super.mesh.chunkVisible("CanopyOpen01", false);
            super.mesh.chunkVisible("CanopyOpen02", false);
            super.mesh.chunkVisible("CanopyOpen03", false);
            super.mesh.chunkVisible("XGlassDamage4", false);
        }
        if(((A_37) aircraft()).FM.CT.cockpitDoorControl == 1.0F && !((A_37) aircraft()).FM.AS.bIsAboutToBailout) {
            if(((A_37) aircraft()).FM.CT.getCockpitDoor() > 0.0F && ((A_37) aircraft()).FM.CT.getCockpitDoor() < 0.2F) {
        ...
        } else if(((A_37) aircraft()).FM.CT.cockpitDoorControl == 0.0F && !((A_37) aircraft()).FM.AS.bIsAboutToBailout) {
            if(((A_37) aircraft()).FM.CT.getCockpitDoor() < 1.0F && ((A_37) aircraft()).FM.CT.getCockpitDoor() > 0.8F) {
                super.mesh.chunkVisible("CanLever01", false);
        ...
        } else if(((A_37) aircraft()).FM.AS.bIsAboutToBailout && super.fm.getSpeedKMH() < 100F && ((A_37) aircraft()).FM.Gears.nOfGearsOnGr > 0) {
            super.mesh.chunkVisible("CanLever01", false);
            super.mesh.chunkVisible("CanLever04", true);
        }
        if(((A_37) aircraft()).FM.CT.BayDoorControl == 1.0F) {
            super.mesh.chunkVisible("Z_Master1", false);
            super.mesh.chunkVisible("Z_Master2", true);
        }
        if(((A_37) aircraft()).FM.CT.BayDoorControl == 0.0F) {
            super.mesh.chunkVisible("Z_Master1", true);
            super.mesh.chunkVisible("Z_Master2", false);
        }
        if(((A_37) aircraft()).FM.CT.arrestorControl <= 0.5F) {
        ...
        if(((A_37) aircraft()).FM.EI.engines[0].getStage() < 6 && ((A_37) aircraft()).FM.Gears.nOfGearsOnGr == 0) {
    ...
    public void reflectCockpitState() {
        ...
        if((((A_37) aircraft()).FM.AS.astateCockpitState & 1) != 0) {
            super.mesh.chunkVisible("XGlassDamage1", true);
            super.mesh.chunkVisible("XGlassDamage2", true);
        }
        if(((((A_37) aircraft()).FM.AS.astateCockpitState & 0x80) != 0 || (((A_37) aircraft()).FM.AS.astateCockpitState & 0x40) != 0) && (((A_37) aircraft()).FM.AS.astateCockpitState & 4) != 0) {
            super.mesh.chunkVisible("XGlassDamage1", true);
            super.mesh.chunkVisible("XGlassDamage2", true);
            super.mesh.chunkVisible("XGlassDamage3", true);
            super.mesh.chunkVisible("XGlassDamage4", true);
        }
        if(((((A_37) aircraft()).FM.AS.astateCockpitState & 8) != 0 || (((A_37) aircraft()).FM.AS.astateCockpitState & 0x10) != 0) && (((A_37) aircraft()).FM.AS.astateCockpitState & 0x20) != 0)
            retoggleLight();
    }
    ...
    static {
        Property.set(CockpitA_37.class, "normZN", 0.93F);
        Property.set(CockpitA_37.class, "gsZN", 0.93F);
    }
