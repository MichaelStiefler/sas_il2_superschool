  ...
  class Interpolater extends InterpolateRef {
    ...
    public boolean tick() {
      if (fm != null) {
        ...
        setNew.k14w = (5F * CockpitF_86F.k14TargetWingspanScale[((F_86F) aircraft()).k14WingspanType])
                / f;
        setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
        setNew.k14wingspan = 0.9F
                * setOld.k14wingspan
                + 0.1F
                * CockpitF_86F.k14TargetMarkScale[((F_86F) aircraft()).k14WingspanType];
        ...
        float f3 = floatindex((f - 200F) * 0.04F,
                CockpitF_86F.k14BulletDrop)
                - CockpitF_86F.k14BulletDrop[0];
