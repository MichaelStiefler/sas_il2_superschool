...
public class CockpitTU4 extends CockpitPilot
{
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        super.mesh.chunkSetAngles("zOilFlap1", 0.0F, -35F * ((FlightModelMain) (super.fm)).EI.engines[0].getControlRadiator(), 0.0F);
        super.mesh.chunkSetAngles("zOilFlap2", 0.0F, -35F * ((FlightModelMain) (super.fm)).EI.engines[1].getControlRadiator(), 0.0F);
        ...
        super.mesh.chunkSetAngles("zCompressor1", 0.0F, cvt(((FlightModelMain) (super.fm)).EI.engines[0].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
        super.mesh.chunkSetAngles("zCompressor2", 0.0F, cvt(((FlightModelMain) (super.fm)).EI.engines[1].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
