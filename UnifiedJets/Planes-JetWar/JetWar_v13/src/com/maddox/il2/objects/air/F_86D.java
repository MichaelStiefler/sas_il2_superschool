...
public class F_86D extends Scheme1 implements TypeSupersonic, TypeBNZFighter, TypeZBReceiver,
        TypeFighterAceMaker, TypeRadarGunsight, TypeFighter, TypeGSuit, TypeFuelDump {
  ...
  private class $0 {
    ...
    private void $1() {
      if (ts) {
        ...
        float f2 = Aircraft.cvt(mn, mn < F_86D.mteb ? F_86D.lteb
                : F_86D.uteb,
                mn < F_86D.mteb ? F_86D.uteb : F_86D.lteb,
                mn < F_86D.mteb ? bhef : thef, mn < F_86D.mteb ? thef
                : phef);
        float f3 = Aircraft.cvt(mn, mn < F_86D.mteb ? F_86D.lteb
                : F_86D.uteb,
                mn < F_86D.mteb ? F_86D.uteb : F_86D.lteb,
                mn < F_86D.mteb ? mef : wef / f1, mn < F_86D.mteb ? wef
                / f1 : lef / f1);
  ...
  public void rareAction(float paramFloat, boolean paramBoolean) {
    ...
    if (FM.AS.isMaster() && Config.isUSE_RENDER()) {
      ...
      F_86D.mn = f / Atmosphere.sonicSpeed((float) FM.Loc.z);
  ...
  public void moveCockpitDoor(float paramFloat) {
    ...
    this.hierMesh().chunkSetAngles("Blister1_D0", 0.0F, 0.0F, 45.0F * paramFloat);
  ...
  public void update(float paramFloat) {
    ...
    if (Math.abs(BayDoor_ - f6) > 0.025F) {
      this.BayDoor_ = this.BayDoor_ + 0.025F * (f6 <= BayDoor_ ? -1F : 2.0F);
  ...
  static {
    Class localClass = com.maddox.il2.objects.air.F_86D.class;
