...
public class CockpitTU4_RGunner extends CockpitGunner
{
    ...
    public CockpitTU4_RGunner()
    {
        super("3DO/Cockpit/A-20G-TGun/RGunnerTU4.him", "he111_gunner");
        bNeedSetUp = true;
        prevTime = -1L;
        prevA0 = 0.0F;
        hook1 = null;
    ...
    static 
    {
        Property.set(com.maddox.il2.objects.air.CockpitTU4_RGunner.class, "aiTuretNum", 3);
        Property.set(com.maddox.il2.objects.air.CockpitTU4_RGunner.class, "weaponControlNum", 13);
        Property.set(com.maddox.il2.objects.air.CockpitTU4_RGunner.class, "astatePilotIndx", 5);
    }
}