...
public class RocketLR55 extends Rocket {

  public RocketLR55() {
  }

  public void start(float f, int i) {
    setMesh("3DO/Arms/LR55/mono_open.sim");
    super.start(f, i);
    speed.normalize();
    speed.scale(525D);
    noGDelay = -1L;
  ...
  static {
    Class class1 = com.maddox.il2.objects.weapons.RocketLR55.class;
    Property.set(class1, "mesh", "3DO/Arms/LR55/mono.sim");
    ...
    Property.set(class1, "force", 1213.2F);
