	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				float f = (((Mig_17) (Object) CockpitMig_17.this.aircraft()).k14Distance);
				setNew.k14w = 5.0F * (CockpitMig_17.k14TargetWingspanScale[(((Mig_17) (Object) CockpitMig_17.this.aircraft()).k14WingspanType)]) / f;
				setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
				setNew.k14wingspan = (0.9F * setOld.k14wingspan
						+ 0.1F * (CockpitMig_17.k14TargetMarkScale[(((Mig_17) (Object) CockpitMig_17.this.aircraft()).k14WingspanType)]));
				setNew.k14mode = (0.8F * setOld.k14mode
						+ 0.2F * (float) (((Mig_17) (Object) CockpitMig_17.this.aircraft()).k14Mode));
				...
				float f_2_ = (CockpitMig_17.this.floatindex((f - 200.0F) * 0.04F,
						CockpitMig_17.k14BulletDrop)
						- CockpitMig_17.k14BulletDrop[0]);
