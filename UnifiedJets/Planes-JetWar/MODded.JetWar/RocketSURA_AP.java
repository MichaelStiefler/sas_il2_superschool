// Source File Name: RocketSURA_AP.java
// Author:           
...
public class RocketSURA_AP extends Rocket {

  public RocketSURA_AP() {
  }

  public void start(float f, int i) {
    setMesh("3DO/Arms/SURA-D_AP/mono_open.sim");
    super.start(f, i);
    speed.normalize();
    speed.scale(525D);
    noGDelay = -1L;
  ...
  static {
    Class class1 = com.maddox.il2.objects.weapons.RocketSURA_AP.class;
    Property.set(class1, "mesh", "3DO/Arms/SURA-D_AP/mono.sim");
