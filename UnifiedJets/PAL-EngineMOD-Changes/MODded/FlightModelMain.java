...
public class FlightModelMain extends FMMath
{
    ...
    public void load(String s)
    {
		...
		//By PAL, Orighinal Engine MOD was saying 3, not corresponding, not needed anymore
		if (j != 0 && j != 1 && j != 2/*3*/) throw new RuntimeException(s1);
        CT.bHasFlapsControl = j > 0;//By PAL, stock: == 1;
		//By PAL, What means this? Half Implemented in the rest of the Engine MOD.
		CT.bHasFlapsControlSwitch = j == 2;
		//By PAL, stock with 5 maximum levels, CT.bHasFlapsControlRed = j < 3, not used anymore
...
//        CT.bHasFlapsControlRed = j < 3;
      //TODO: Modified flap parameters in flight model. Allows up to 5 stages of flaps.
        ...
        if(CT.nFlapStages != -1 && CT.FlapStageMax != -1F)
        {
        ...
        //By PAL, on Test, bHasFlapsControlSwitch is a special case (Auto Manage?) but not implemented yet:
		if ((CT.bHasFlapsControlSwitch) && (CT.FlapStageText == null) && (CT.nFlapStages > 0))
		{
