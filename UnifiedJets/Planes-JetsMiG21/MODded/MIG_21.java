...
// Decompiled by DJ v3.12.12.98 Copyright 2014 Atanas Neshkov  Date: 05/10/2015 02:22:22 a.m.
    ...
    implements TypeSupersonic, TypeFastJet, TypeFighter, TypeBNZFighter, TypeFighterAceMaker, TypeGSuit
{
    ...
    {
        gfactors.setGFactors(1.5F, 1.5F, 2.0F, 7F, 2.5F, 2.5F);
    }
...
//        catch(NullPointerException nullpointerexception) { }
		//By PAL, see how to make all to work (specialized with 6000F of range and this basic ones: call them from classes);
		//sirenaWarning(4000F);
        engineSurge(f);
        ...
        //By PAL, problem here not catched
...
;
    ...
    public void computeLift()
    {
        ...
        } else
        {
            ...
            float f7 = f6 * f;
            float f8 = f7 * f;
            f1 = ((((((-0.234283F * f7 + 2.14209F * f6) - 7.91332F * f5) + 14.9548F * f4) - 14.9547F * f3) + 7.22336F * f2) - 1.24396F * f) + 0.09F;
        }
        polares.lineCyCoeff = f1;
    }

    public void computeAOA()
    {
        Polares polares = (Polares)Reflection.getValue(FM, "Wing");
        float f = calculateMach();
        if(calculateMach() < 0.0F);
        float f1 = 0.0F;
        if((double)f > 0.49000000953674316D)
        {
            f1 = 8F;
        } else
        {
            ...
            float f3 = f2 * f;
            float f4 = f3 * f;
            f1 = (198.341F * f3 - 149.17F * f2 - 3.09956F * f) + 22F;
        }
        polares.AOACritH_0 = f1;
        polares.AOACritL_0 = -f1 + 3F;
    }
    ...
    public void computeEnergy()
    {
        ...
        if(calculateMach() < 0.0F);
        float f1 = 0.0F;
        if((double)f >= 1.2999999523162842D)
        {
            f1 = 10F;
        } else
        {
            ...
            float f4 = f3 * f;
            float f5 = f4 * f;
            f1 = ((-541.262F * f4 + 950.16F * f3) - 456.27F * f2) + 77.6233F * f + 8F;
        }
        polares.parabCxCoeff_0 = f1 * 0.0001F;
        polares.parabCxCoeff_0 = f1 * 0.00012F;
    }
    ...
    public void computeEngine()
    {
        ...
        } else
        {
            ...
            float f3 = f2 * f;
            float f4 = f3 * f;
            f1 = (0.00376984F * f3 - 0.0771825F * f2) + 0.591667F * f;
        }
    ...
    public void computeSupersonicLimiter()
    {
        ...
        if(FM.EI.engines[0].getThrustOutput() > 1.001F && FM.EI.engines[0].getStage() == 6 && (double)calculateMach() >= 1.05D)
            ...
            {
                float f2 = f * f;
                f1 = (4.81818E-005F * f2 - 0.000537727F * f) + 0.0015F;
            }
