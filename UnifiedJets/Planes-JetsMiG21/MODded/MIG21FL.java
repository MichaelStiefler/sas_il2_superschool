...
// Decompiled by DJ v3.12.12.98 Copyright 2014 Atanas Neshkov  Date: 05/10/2015 02:13:36 a.m.
// Home Page:  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   MIG21FL.java
...
public class MIG21FL extends MIG_21
    implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector
{
    ...
    public void computeR11F300_AB()
    {
        if(((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
            ((FlightModelMain) (super.FM)).producedAF.x += 18000D;
        ...
        if(FM.EI.engines[0].getThrustOutput() > 1.001F && FM.EI.engines[0].getStage() == 6)
            ...
            } else
            {
                ...
                float f3 = f2 * f;
                float f4 = f3 * f;
                f1 = (0.04385F * f3 - 0.864394F * f2) + 3.19853F * f;
            }
    ...
    static 
    {
        Class class1 = com.maddox.il2.objects.air.MIG21FL.class;
