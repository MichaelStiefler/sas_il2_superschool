// Decompiled by DJ v3.12.12.98 Copyright 2014 Atanas Neshkov  Date: 05/10/2015 07:11:07 a.m.
// Home Page:  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   CockpitMIG21PFM.java
...
//            CockpitPilot, MIG_21, Aircraft, Cockpit

public class CockpitMIG21PFM extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f1 = ((MIG_21)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitMIG21PFM.k14TargetWingspanScale[((MIG_21)aircraft()).k14WingspanType]) / f1;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitMIG21PFM.k14TargetMarkScale[((MIG_21)aircraft()).k14WingspanType];
                ...
                float f4 = floatindex((f1 - 200F) * 0.04F, CockpitMIG21PFM.k14BulletDrop) - CockpitMIG21PFM.k14BulletDrop[0];
    ...
    public CockpitMIG21PFM()
    {
        super("3DO/Cockpit/MiG-21PFM/hier.him", "bf109");
            ...
            if(Actor.isValid(aircraft) && Actor.isAlive(aircraft) && trefresh + 30L < l)
            {
                ...
                for(int j = 0; j < i; j++)
                {
                    ...
                    if((actor instanceof Aircraft) && actor != World.getPlayerAircraft() && actor.getArmy() != World.getPlayerArmy() && tracking)
                    {
                        ...
                        if(((Tuple3d) (point3d1)).x < (double)(((MIG_21)aircraft()).lockrange + 0.01F) * d3 - (double)(200F * f) && ((Tuple3d) (point3d1)).y < tangage + ((Tuple3d) (point3d1)).x * d && ((Tuple3d) (point3d1)).y > tangage - ((Tuple3d) (point3d1)).x * d && ((Tuple3d) (point3d1)).z < azimult + ((Tuple3d) (point3d1)).x * d && ((Tuple3d) (point3d1)).z > azimult - ((Tuple3d) (point3d1)).x * d)
                            radarTracking.add(point3d1);
                    }
                }
