// Source File Name: CockpitF_86A.java
// Author:           
...
public class CockpitF_86A extends CockpitPilot {
  ...
  class Interpolater extends InterpolateRef {
    ...
    public boolean tick() {
      if (fm != null) {
        ...
        setNew.k14w = (5F * CockpitF_86A.k14TargetWingspanScale[((F_86F) aircraft()).k14WingspanType])
                / f;
        setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
        setNew.k14wingspan = 0.9F
                * setOld.k14wingspan
                + 0.1F
                * CockpitF_86A.k14TargetMarkScale[((F_86F) aircraft()).k14WingspanType];
        ...
        float f3 = floatindex((f - 200F) * 0.04F,
                CockpitF_86A.k14BulletDrop)
                - CockpitF_86A.k14BulletDrop[0];
  ...
  public void reflectWorldToInstruments(float f) {
    ...
    mesh.chunkSetAngles("Z_AirBrakes", 29F * fm.CT.AirBrakeControl, 0.0F,
            0.0F);
    mesh.chunkSetAngles("Z_Hydro-Pres86", 0.0F, cvt(interp(
            setNew.stbyPosition, setOld.stbyPosition, f), 0.0F, 1.0F,
            -253F, 10F), 0.0F);
    mesh.chunkSetAngles("Z_Ammeter86", 0.0F, cvt(interp(
            setNew.stbyPosition2, setOld.stbyPosition2, f), 0.0F, 1.0F,
            -55F, 30F), 0.0F);
    resetYPRmodifier();
    ...
    mesh.chunkSetAngles("Z_Target", 0.0F, 0.0F, setNew.k14wingspan);
    ...
    mesh.chunkSetAngles("Z_TurnBank86-2", cvt(getBall(7D), -7F, 7F, -15F,
            15F), 0.0F, 0.0F);
    mesh.chunkSetAngles("Z_G-Factor", cvt(fm.getOverload() + 1, -4F, 12F,
    ...
    if (setNew.stbyPosition < 0.8F) {
      mesh.chunkVisible("Z_HydroLamp", true);
    } else {
      mesh.chunkVisible("Z_HydroLamp", false);
    }
