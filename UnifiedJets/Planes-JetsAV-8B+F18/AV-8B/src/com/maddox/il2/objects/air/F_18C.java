...
public class F_18C extends F_18 implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeGSuit, TypeAcePlane, TypeFuelDump, TypeStormovikArmored, TypeDockable {
	...
	static {
		...
		try {
			...
			arraylist.add(s);
			hashmapint.put(Finger.Int(s), a_lweaponslot);
			s = "4xGBU-12 + 2xAGM65E + 1xDT + 2xAIM-9";
			a_lweaponslot = new Aircraft._WeaponSlot[byte0];
			a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61A1", 450);
			a_lweaponslot[2] = new Aircraft._WeaponSlot(9, "FLIRPOD", 1);
			a_lweaponslot[4] = new Aircraft._WeaponSlot(9, "LAZERPOD", 1);
			...
			arraylist.add(s);
			hashmapint.put(Finger.Int(s), a_lweaponslot);
			s = "4xGBU-12 + 2xZuni + 1xDT + 2xAIM-9";
			a_lweaponslot = new Aircraft._WeaponSlot[byte0];
			a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61A1", 450);
			a_lweaponslot[2] = new Aircraft._WeaponSlot(9, "FLIRPOD", 1);
			a_lweaponslot[4] = new Aircraft._WeaponSlot(9, "LAZERPOD", 1);
			...
			arraylist.add(s);
			hashmapint.put(Finger.Int(s), a_lweaponslot);
			s = "4xZuni + 4xGBU-12 + 2xAIM-9 + 2xAIM-7 + 1xDT";
			a_lweaponslot = new Aircraft._WeaponSlot[byte0];
			a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61A1", 450);
			a_lweaponslot[2] = new Aircraft._WeaponSlot(9, "FLIRPOD", 1);
			a_lweaponslot[4] = new Aircraft._WeaponSlot(9, "LAZERPOD", 1);
			...
			arraylist.add(s);
			hashmapint.put(Finger.Int(s), a_lweaponslot);
			s = "4xJDAM84 + 2xZuni + 1xDT + 2xAIM-9 + 2xAIM-7";
			a_lweaponslot = new Aircraft._WeaponSlot[byte0];
			a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61A1", 450);
			a_lweaponslot[1] = new Aircraft._WeaponSlot(5, "RocketGunAIM7M", 1);
			a_lweaponslot[2] = new Aircraft._WeaponSlot(5, "RocketGunNull", 1);
			...
			arraylist.add(s);
			hashmapint.put(Finger.Int(s), a_lweaponslot);
			s = "2xAIM-9 + 2xAIM-7 + 2xJDAM84 + 2xAGM65E";
			a_lweaponslot = new Aircraft._WeaponSlot[byte0];
			a_lweaponslot[0] = new Aircraft._WeaponSlot(0, "MGunM61A1", 450);
			a_lweaponslot[1] = new Aircraft._WeaponSlot(5, "RocketGunAIM7M", 1);
			a_lweaponslot[2] = new Aircraft._WeaponSlot(5, "RocketGunNull", 1);
