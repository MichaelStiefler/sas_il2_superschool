...
//            CockpitPilot, B_29, TU_95, Aircraft

public class CockpitTU95_Bombardier extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((TU_95)aircraft()).fSightCurForwardAngle;
            float f1 = ((TU_95)aircraft()).fSightCurSideslip;
            CockpitTU95_Bombardier.calibrAngle = 360F - fm.Or.getPitch();
            mesh.chunkSetAngles("BlackBox", -10F * f1, 0.0F, CockpitTU95_Bombardier.calibrAngle + f);
            if(bEntered)
            {
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(aAim + 10F * f1, tAim + CockpitTU95_Bombardier.calibrAngle + f, 0.0F);
            }
            if(fm != null)
            {
                if(bNeedSetUp)
    ...
    public CockpitTU95_Bombardier()
    {
        super("3DO/Cockpit/TU95-Bombardier/BombardierTU95.him", "he111");
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        if(bEntered)
        {
            mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((TU_95)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((TU_95)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        Property.set(com.maddox.il2.objects.air.CockpitTU95_Bombardier.class, "astatePilotIndx", 0);
    }
