//By PAL, Vega version, updated.

// Decompiled by DJ v3.12.12.98 Copyright 2014 Atanas Neshkov  Date: 12/10/2015 05:20:23 a.m.
// Home Page:  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   F_100.java
...
//            Scheme1, Chute, Aircraft, TypeTankerDrogue, 
//            TypeDockable, TypeSupersonic, TypeFighter, TypeBNZFighter, 
//            TypeFighterAceMaker, TypeRadarGunsight, TypeStormovik, TypeGSuit, 
//            TypeZBReceiver, TypeFuelDump, TypeFastJet, Cockpit, 
...
;
    ...
    public void update(float f)
    {
        ...
        computeCy();
        Flaps();
        if(!isTrainer && (FM.AS.bIsAboutToBailout || overrideBailout) && !ejectComplete && FM.getSpeedKMH() > 15F)
        {
        ...
        if(d >= 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x += d * 24000D;
        if(d < 1.0010000467300415D && super.FM.CT.GearControl < 0.1F && flag)
            ((FlightModelMain) (super.FM)).producedAF.x += d * 5000D;
        if(super.FM.getAltitude() > 9000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 1250D;
        if(super.FM.getAltitude() > 10000F && d < 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 600D;
        if(super.FM.getAltitude() > 10000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 3000D;
        if(super.FM.getAltitude() > 10000F && (double)calculateMach() >= 1.3500000000000001D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 7000D;
        if(super.FM.getAltitude() > 11000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 2300D;
        if(super.FM.getAltitude() > 11000F && (double)calculateMach() >= 1.3D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 7000D;
        if(super.FM.getAltitude() > 11500F && (double)calculateMach() >= 1.22D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 7000D;
        if(super.FM.getAltitude() > 12000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 1600D;
        if(super.FM.getAltitude() > 12000F && (double)calculateMach() >= 1.1499999999999999D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 7000D;
        if(super.FM.getAltitude() > 12500F && (double)calculateMach() >= 1.1000000000000001D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 7000D;
        if(super.FM.getAltitude() > 13000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 1500D;
        if(super.FM.getAltitude() > 13500F && (double)calculateMach() >= 1.05D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 7000D;
        if(super.FM.getAltitude() > 14000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 1200D;
        if(super.FM.getAltitude() > 15000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 1300D;
        if(super.FM.getAltitude() > 15500F && (double)calculateMach() >= 0.96999999999999997D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 7000D;
        if(super.FM.getAltitude() > 16000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 1350D;
        if(super.FM.getAltitude() > 17000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 7500D;
        if(super.FM.getAltitude() > 18200F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 8300D;
        if(super.FM.getAltitude() > 20000F && d > 1.0010000467300415D && flag)
            ((FlightModelMain) (super.FM)).producedAF.x -= d * 11000D;
        super.update(f);
    }
    ...
    public void computeLimiters()
    {
        ...
        if(super.FM.getAltitude() > 0.0F && (double)calculateMach() >= 1.3100000000000001D && ((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && ((FlightModelMain) (super.FM)).EI.engines[0].getStage() > 5)
            ((FlightModelMain) (super.FM)).Sq.dragParasiteCx += 0.003F;
    }
    ...
    {
        Polares polares = (Polares)Reflection.getValue(FM, "Wing");
        if(((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() > 1.001F && !Flaps)
        {
            polares.Cy0_1 += 0.59999999999999998D;
            Flaps = true;
        }
        if(((FlightModelMain) (super.FM)).EI.engines[0].getThrustOutput() < 1.001F && Flaps)
        {
