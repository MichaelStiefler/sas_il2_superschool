...
public class F_105 extends Scheme1 implements TypeSupersonic, TypeFighter, TypeBNZFighter, TypeFighterAceMaker, TypeStormovik, TypeGSuit, TypeLaserSpotter, TypeDockable, TypeX4Carrier, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector,
        TypeFastJet {
    private class _cls0 {
        ...
        private void sbcls1() {
            if (F_105.this.ts) {
                float f = Aircraft.cvt(F_105.this.FM.getAltitude(), this.lal, this.tal, this.bef, this.tef);
                float f1 = Aircraft.cvt(F_105.this.mn, F_105.this.mn < F_105.mteb ? F_105.lteb : F_105.uteb, F_105.this.mn < F_105.mteb ? F_105.uteb : F_105.lteb, F_105.this.mn < F_105.mteb ? this.bhef : this.thef, F_105.this.mn < F_105.mteb ? this.thef
                        : this.phef);
                float f2 = Aircraft.cvt(F_105.this.mn, F_105.this.mn < F_105.mteb ? F_105.lteb : F_105.uteb, F_105.this.mn < F_105.mteb ? F_105.uteb : F_105.lteb, F_105.this.mn < F_105.mteb ? this.mef : this.wef / f, F_105.this.mn < F_105.mteb ? this.wef
                        / f : this.lef / f);
                ((RealFlightModel) F_105.this.FM).producedShakeLevel += 0.1125F * f1;
                F_105.this.FM.SensPitch = F_105.this.ectl * f2 * f2;
                F_105.this.FM.SensRoll = F_105.this.actl * f2;
                F_105.this.FM.SensYaw = F_105.this.rctl * f2;
                if (f1 > 0.6F)
                    F_105.this.ictl = true;
                else
                    F_105.this.ictl = false;
                if (this.ftl > 0.0F) {
                    if (World.Rnd().nextFloat() > 0.6F)
                        if (F_105.this.FM.CT.RudderControl > 0.0F)
                            F_105.this.FM.CT.RudderControl -= this.ftl * f1;
                        else if (F_105.this.FM.CT.RudderControl < 0.0F) {
                            F_105.this.FM.CT.RudderControl += this.ftl * f1;
                        } else {
                            Controls controls = F_105.this.FM.CT;
                            controls.RudderControl = controls.RudderControl + (World.Rnd().nextFloat() > 0.5F ? this.ftl * f1 : -this.ftl * f1);
                        }
                    if (F_105.this.FM.CT.RudderControl > 1.0F)
                        F_105.this.FM.CT.RudderControl = 1.0F;
                    if (F_105.this.FM.CT.RudderControl < -1F)
                        F_105.this.FM.CT.RudderControl = -1F;
                }
            } else {
                F_105.this.FM.SensPitch = F_105.this.ectl;
                F_105.this.FM.SensRoll = F_105.this.actl;
                F_105.this.FM.SensYaw = F_105.this.rctl;
            }
        }
...
//        }
    ...
    public static void moveGear(HierMesh hiermesh, float f, float f1, float f2) {
        ...
        hiermesh.chunkSetAngles("GearC10_D0", 0.0F, Aircraft.cvt(f2, 0.69F, 0.74F, 0.0F, -90F), 0.0F);
        hiermesh.chunkSetAngles("GearC2_D0", 0.0F, Aircraft.cvt(f2, 0.63F, 0.99F, 0.0F, -105F), 0.0F);
        hiermesh.chunkSetAngles("Gear5e_D0", 0.0F, Aircraft.cvt(f2, 0.63F, 0.99F, 0.0F, -90F), 0.0F);
    }
    ...
    public void moveWheelSink() {
        ...
        this.hierMesh().chunkSetLocate("GearC03_D0", Aircraft.xyz, Aircraft.ypr);
//        if (this.curctl == -1F) {
...
//            if (this.curctl < 0.0F)
//                this.curctl = 0.0F;
//            float f = 0.25F * this.curctl * Math.max(Aircraft.cvt(this.FM.EI.engines[0].getThrustOutput(), 0.5F, 0.8F, 0.0F, 1.0F), Aircraft.cvt(this.FM.getSpeedKMH(), 0.0F, 80F, 0.0F, 1.0F));
//            this.FM.setGC_Gear_Shift(this.H1 - f);
//            this.resetYPRmodifier();
//            Aircraft.xyz[0] = -0.4F * f;
//            float f1 = Aircraft.cvt(this.FM.Gears.gWheelSinking[2] - Aircraft.xyz[0], 0.0F, 0.45F, 0.0F, 1.0F);
//            this.hierMesh().chunkSetLocate("GearC6_D0", Aircraft.xyz, Aircraft.ypr);
//            this.hierMesh().chunkSetAngles("GearC8_D0", 0.0F, -37.5F * f1, 0.0F);
//            this.hierMesh().chunkSetAngles("GearC9_D0", 0.0F, -75F * f1, 0.0F);
//        }
//        this.oldctl = this.curctl;
    ...
    protected void moveRudder(float f) {
        ...
        this.hierMesh().chunkSetAngles("GearC03_D0", 0.0F, 30F * f, 0.0F);
//        this.hierMesh().chunkSetAngles("Rudder1_D0", 0.0F, -30F * f, 0.0F);
//        if (this.FM.CT.GearControl > 0.5F)
//            this.hierMesh().chunkSetAngles("GearC7_D0", 0.0F, -50F * f, 0.0F);
    }
...
//        this.hierMesh().chunkSetAngles("VatorR_D0", 0.0F, -12F * f, 0.0F);
    ...
    protected void moveAirBrake(float f) {
        this.hierMesh().chunkSetAngles("Brake01_D0", 0.0F, 40F * f, 0.0F);
//        this.resetYPRmodifier();
...
//        this.hierMesh().chunkSetLocate("BrakeB02e_D0", Aircraft.xyz, Aircraft.ypr);
    ...
    public void computeEngine() {
        if (super.FM.getAltitude() >= 0.0F && this.calculateMach() <= 0.34999999999999998D && this.FM.EI.engines[0].getThrustOutput() > 0.8F && this.FM.EI.engines[0].getStage() > 5)
    ...
    protected void checkAsDrone() {
        ...
        if (Actor.isValid(this.target_) && (this.target_ instanceof TypeTankerBoom)) {
