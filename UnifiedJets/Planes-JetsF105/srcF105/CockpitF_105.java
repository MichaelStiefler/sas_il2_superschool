// Decompiled by DJ v3.10.10.93 Copyright 2007 Atanas Neshkov Date: 11/04/2015 02:15:20
...
public class CockpitF_105 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF_105.this.fm != null) {
                CockpitF_105.this.setTmp = CockpitF_105.this.setOld;
                CockpitF_105.this.setOld = CockpitF_105.this.setNew;
                CockpitF_105.this.setNew = CockpitF_105.this.setTmp;
                CockpitF_105.this.setNew.throttle = 0.85F * CockpitF_105.this.setOld.throttle + CockpitF_105.this.fm.CT.PowerControl * 0.15F;
                CockpitF_105.this.setNew.prop = 0.85F * CockpitF_105.this.setOld.prop + CockpitF_105.this.fm.CT.getStepControl() * 0.15F;
                CockpitF_105.this.setNew.stage = 0.85F * CockpitF_105.this.setOld.stage + CockpitF_105.this.fm.EI.engines[0].getControlCompressor() * 0.15F;
                CockpitF_105.this.setNew.mix = 0.85F * CockpitF_105.this.setOld.mix + CockpitF_105.this.fm.EI.engines[0].getControlMix() * 0.15F;
                CockpitF_105.this.setNew.altimeter = CockpitF_105.this.fm.getAltitude();
                float f = CockpitF_105.this.waypointAzimuth();
                if (CockpitF_105.this.useRealisticNavigationInstruments()) {
                    CockpitF_105.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitF_105.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitF_105.this.setNew.waypointAzimuth.setDeg(CockpitF_105.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitF_105.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitF_105.this.setNew.azimuth.setDeg(CockpitF_105.this.setOld.azimuth.getDeg(1.0F), CockpitF_105.this.fm.Or.azimut());
                CockpitF_105.this.setNew.vspeed = (199F * CockpitF_105.this.setOld.vspeed + CockpitF_105.this.fm.getVertSpeed()) / 200F;
                float f1 = ((F_105) CockpitF_105.this.aircraft()).k14Distance;
                CockpitF_105.this.setNew.k14w = (5F * CockpitF_105.k14TargetWingspanScale[((F_105) CockpitF_105.this.aircraft()).k14WingspanType]) / f1;
                CockpitF_105.this.setNew.k14w = 0.9F * CockpitF_105.this.setOld.k14w + 0.1F * CockpitF_105.this.setNew.k14w;
                CockpitF_105.this.setNew.k14wingspan = 0.9F * CockpitF_105.this.setOld.k14wingspan + 0.1F * CockpitF_105.k14TargetMarkScale[((F_105) CockpitF_105.this.aircraft()).k14WingspanType];
                CockpitF_105.this.setNew.k14mode = 0.8F * CockpitF_105.this.setOld.k14mode + 0.2F * ((F_105) CockpitF_105.this.aircraft()).k14Mode;
                com.maddox.JGP.Vector3d vector3d = ((SndAircraft) (CockpitF_105.this.aircraft())).FM.getW();
                double d = 0.00125D * f1;
                float f2 = (float) Math.toDegrees(d * vector3d.z);
                float f3 = -(float) Math.toDegrees(d * vector3d.y);
                float f4 = CockpitF_105.this.floatindex((f1 - 200F) * 0.04F, CockpitF_105.k14BulletDrop) - CockpitF_105.k14BulletDrop[0];
                f3 += (float) Math.toDegrees(Math.atan(f4 / f1));
                CockpitF_105.this.setNew.k14x = 0.92F * CockpitF_105.this.setOld.k14x + 0.08F * f2;
                CockpitF_105.this.setNew.k14y = 0.92F * CockpitF_105.this.setOld.k14y + 0.08F * f3;
                if (CockpitF_105.this.setNew.k14x > 7F)
                    CockpitF_105.this.setNew.k14x = 7F;
                if (CockpitF_105.this.setNew.k14x < -7F)
                    CockpitF_105.this.setNew.k14x = -7F;
                if (CockpitF_105.this.setNew.k14y > 7F)
                    CockpitF_105.this.setNew.k14y = 7F;
                if (CockpitF_105.this.setNew.k14y < -7F)
                    CockpitF_105.this.setNew.k14y = -7F;
                CockpitF_105.this.buzzerFX(CockpitF_105.this.fm.getSpeed() < 63F && CockpitF_105.this.fm.Gears.nOfGearsOnGr < 1);
                CockpitF_105.this.setNew.beaconDirection = (10F * CockpitF_105.this.setOld.beaconDirection + CockpitF_105.this.getBeaconDirection()) / 11F;
                CockpitF_105.this.setNew.beaconRange = (10F * CockpitF_105.this.setOld.beaconRange + CockpitF_105.this.getBeaconRange()) / 11F;
                if (CockpitF_105.this.fm.EI.engines[0].getStage() < 6) {
                    if (CockpitF_105.this.setNew.stbyPosition > 0.0F)
                        CockpitF_105.this.setNew.stbyPosition = CockpitF_105.this.setOld.stbyPosition - 0.002F;
                } else if (CockpitF_105.this.setNew.stbyPosition < 1.0F)
                    CockpitF_105.this.setNew.stbyPosition = CockpitF_105.this.setOld.stbyPosition + 0.002F;
                if (CockpitF_105.this.setNew.stbyPosition2 < 1.0F)
                    CockpitF_105.this.setNew.stbyPosition2 = CockpitF_105.this.setOld.stbyPosition2 + 0.002F;
            }
            return true;
        }
    ...
    public CockpitF_105() {
        ...
        this.pictAiler = 0.0F;
        this.pictElev = 0.0F;
        super.cockpitNightMats = (new String[] { "Sabre_Compass1", "Needles86", "Gaug86_01", "Gaug86_02", "Gaug86_03", "Gaug86_04", "Gaug86_05", "Gaug86_06" });
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Azimuth86_1", -this.setNew.azimuth.getDeg(f) + this.setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
        this.resetYPRmodifier();
        ...
        this.resetYPRmodifier();
        this.mesh.chunkSetAngles("Canopy", 0.0F, 0.0F, 30F * this.fm.CT.getCockpitDoor());
        ...
        if (((Interpolate) (this.fm)).actor instanceof TypeGuidedMissileCarrier) {
            this.mesh.chunkVisible("MissileControl", true);
            this.mesh.chunkVisible("MissileControlRange", true);
        } else {
            this.mesh.chunkVisible("MissileControl", false);
            this.mesh.chunkVisible("MissileControlRange", false);
        }
        if (((Interpolate) (this.fm)).actor instanceof TypeGuidedMissileCarrier) {
    ...
    public void reflectCockpitState() {
        if ((this.fm.AS.astateCockpitState & 2) != 0) {
            ...
            this.mesh.chunkVisible("Gaug86_05", false);
            this.mesh.chunkVisible("Gaug86_05_Dam", true);
            ...
            this.mesh.chunkVisible("Z_Exhaust_Temp", false);
            this.mesh.chunkVisible("Z_Hour86", false);
            this.mesh.chunkVisible("Z_Minute86", false);
            this.mesh.chunkVisible("Z_Second86", false);
            this.mesh.chunkVisible("Z_Ammeter86", false);
        }
