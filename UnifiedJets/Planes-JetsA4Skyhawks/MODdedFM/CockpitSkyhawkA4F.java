// Decompiled by DJ v3.12.12.98 Copyright 2014 Atanas Neshkov  Date: 17/10/2015 02:32:06 p.m.
// Home Page:  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   CockpitSkyhawkA4F.java
...
//            CockpitPilot, Cockpit, SkyhawkA4F

public class CockpitSkyhawkA4F extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                float f4 = ((SkyhawkA4F)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitSkyhawkA4F.k14TargetWingspanScale[((SkyhawkA4F)aircraft()).k14WingspanType]) / f4;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSkyhawkA4F.k14TargetMarkScale[((SkyhawkA4F)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((SkyhawkA4F)aircraft()).k14Mode;
                ...
                float f3 = floatindex((f4 - 200F) * 0.04F, CockpitSkyhawkA4F.k14BulletDrop) - CockpitSkyhawkA4F.k14BulletDrop[0];
 ...
 //BY PAL, new methods:
  ...
  private float machNumber() {
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        {
            int i = ((SkyhawkA4F)aircraft()).k14Mode;
            boolean flag = i < 2;
