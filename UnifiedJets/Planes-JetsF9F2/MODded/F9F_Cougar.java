// Decompiled by DJ v3.12.12.96 Copyright 2011 Atanas Neshkov  Date: 14/10/2015 10:16:03 a.m.
// Home Page: http://members.fortunecity.com/neshkov/dj.html  http://www.neshkov.com/dj.html - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   F9F_Cougar.java
...
//            TypeStormovik, TypeGSuit, TypeGuidedMissileCarrier, TypeCountermeasure, 
//            TypeThreatDetector, TypeFastJet, TypeSupersonic, TypeFuelDump, 
//            TypeZBReceiver, Aircraft, Cockpit, PaintScheme, 
//            EjectionSeat
    ...
    implements TypeFighter, TypeBNZFighter, TypeFighterAceMaker, TypeStormovik, TypeGSuit, TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector, TypeFastJet, TypeSupersonic, TypeFuelDump, TypeZBReceiver
{
    ...
    public void update(float f)
    {
        ...
        if(!isTrainer && (((FlightModelMain) (super.FM)).AS.bIsAboutToBailout || overrideBailout) && !ejectComplete && !((FlightModelMain) (super.FM)).Gears.onGround())
        {
...
;
    ...
    public void computeCy()
    {
        ...
        float f1 = 0.0F;
        if((double)f > 0.80000001192092896D)
        {
            f1 = 0.075F;
        } else
        {
            float f2 = f * f;
            float f3 = f2 * f;
            f1 = (0.0109524F * f2 - 0.026881F * f) + 0.089F;
        }
