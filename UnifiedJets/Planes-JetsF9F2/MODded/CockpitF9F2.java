// Decompiled by DJ v3.12.12.96 Copyright 2011 Atanas Neshkov  Date: 14/10/2015 10:16:56 a.m.
...
public class CockpitF9F2 extends CockpitPilot
{
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                if(setNew.stbyPosition3 < 1.0F)
                    setNew.stbyPosition3 = setOld.stbyPosition3 + 0.005F;
                float f = ((F9F)aircraft()).k14Distance;
                setNew.k14w = (5F * CockpitF9F2.k14TargetWingspanScale[((F9F)aircraft()).k14WingspanType]) / f;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitF9F2.k14TargetMarkScale[((F9F)aircraft()).k14WingspanType];
                setNew.k14mode = 0.8F * setOld.k14mode + 0.2F * (float)((F9F)aircraft()).k14Mode;
                ...
                float f3 = floatindex((f - 200F) * 0.04F, CockpitF9F2.k14BulletDrop) - CockpitF9F2.k14BulletDrop[0];
    ...
    public void reflectWorldToInstruments(float f)
    {
        ...
        resetYPRmodifier();
        if(((FlightModelMain) (super.fm)).EI.getCatapult() && !super.fm.brakeShoe && ((FlightModelMain) (super.fm)).Gears.nOfGearsOnGr > 0)
        {
            Cockpit.xyz[1] = -0.02F;
    ...
    static 
    {
        Property.set(com.maddox.il2.objects.air.CockpitF9F2.class, "normZN", 0.93F);
        Property.set(com.maddox.il2.objects.air.CockpitF9F2.class, "gsZN", 0.93F);
    }
