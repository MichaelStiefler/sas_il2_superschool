...
public class CockpitMig_15F extends CockpitPilot {
	...
	class Interpolater extends InterpolateRef {
		...
		public boolean tick() {
			if (fm != null) {
				...
				float f = (((Mig_15F) (Object) CockpitMig_15F.this.aircraft()).k14Distance);
				setNew.k14w = 5.0F * (CockpitMig_15F.k14TargetWingspanScale[(((Mig_15F) (Object) CockpitMig_15F.this.aircraft()).k14WingspanType)]) / f;
				setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
				setNew.k14wingspan = (0.9F * setOld.k14wingspan
						+ 0.1F * (CockpitMig_15F.k14TargetMarkScale[(((Mig_15F) (Object) CockpitMig_15F.this.aircraft()).k14WingspanType)]));
				setNew.k14mode = (0.8F * setOld.k14mode
						+ 0.2F * (float) (((Mig_15F) (Object) CockpitMig_15F.this.aircraft()).k14Mode));
				...
				float f_2_ = (CockpitMig_15F.this.floatindex((f - 200.0F) * 0.04F,
						CockpitMig_15F.k14BulletDrop)
						- CockpitMig_15F.k14BulletDrop[0]);
	...
	public void reflectWorldToInstruments(float f) {
		if (com.maddox.il2.objects.air.Mig_15F.bChangedPit) {
			com.maddox.il2.objects.air.Mig_15F.bChangedPit = false;
		}
		...
		if(fm.actor instanceof Mig_15)
			super.mesh.chunkVisible("Left2", false);
		else
			super.mesh.chunkVisible("Left2", true);
	}
