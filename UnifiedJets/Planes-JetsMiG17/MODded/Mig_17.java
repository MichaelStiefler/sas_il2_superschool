...
public class Mig_17 extends Scheme1 implements TypeSupersonic, TypeFighter, TypeBNZFighter, TypeFighterAceMaker {
  ...
  private class $0 {
    ...
    public void rs(int ii) {
      if (ii == 0 || ii == 1) {
        access$234(Mig_17.this, 0.68);
      }
      if (ii == 31 || ii == 32) {
        access$334(Mig_17.this, 0.68);
      }
      if (ii == 15 || ii == 16) {
        access$434(Mig_17.this, 0.68);
      }
    }
    ...
    private void $1() {
      if (ts) {
        ...
        float f2 = Aircraft.cvt(mn,
                (mn < Mig_17.mteb ? Mig_17.lteb
                : Mig_17.uteb),
                (mn < Mig_17.mteb ? Mig_17.uteb
                : Mig_17.lteb),
                mn < Mig_17.mteb ? bhef : thef,
                mn < Mig_17.mteb ? thef : phef);
        float f3 = Aircraft.cvt(mn,
                (mn < Mig_17.mteb ? Mig_17.lteb
                : Mig_17.uteb),
                (mn < Mig_17.mteb ? Mig_17.uteb
                : Mig_17.lteb),
                mn < Mig_17.mteb ? mef : wef / f1,
                mn < Mig_17.mteb ? wef / f1 : lef / f1);
    ...
    new MsgAction(false, this) {
      ...
      public void doAction(Object paramObject) {
        ...
        if (Actor.isValid(localAircraft)) {
          ...
          new EjectionSeat(7, localLoc1, localVector3d,
                  localAircraft);
        }
      }
    };
  ...
  {
  		//By PAL		
        if(((FlightModelMain) (super.FM)).CT.GearControl > 0.99F)
        {
			//By PAL, limited to twist 30 degrees only (inverted).
			if(f < -30F)
	    		hierMesh().chunkSetAngles("GearC7_D0", 0.0F, +30F, 0.0F);
	    	else
			if(f > 30F)
	    		hierMesh().chunkSetAngles("GearC7_D0", 0.0F, -30F, 0.0F);
	    	else
...
//			hierMesh().chunkSetAngles("GearC7_D0", 0.0F, 0.0F*f, 0.0F);
//		else
//			hierMesh().chunkSetAngles("GearC7_D0", 0.0F, 15F*f, 0.0F); 
  }  
  ...
  protected void moveAirBrake(float paramFloat) {
    this.resetYPRmodifier();
    this.hierMesh().chunkSetAngles("Brake01_D0", 10.0F * paramFloat, -55.0F * paramFloat,
            0.0F);
    this.hierMesh().chunkSetAngles("Brake02_D0", 10.0F * paramFloat, -55.0F * paramFloat,
            0.0F);
  }
  ...
  private final void umnr() {
    ...
    mig_17.mn = f / Atmosphere.sonicSpeed((float) FM.Loc.z);
    if (mn >= lteb) {
      ts = true;
    } else {
      ts = false;
  ...
  public void doSetSootState(int paramInt1, int paramInt2) {
    ...
    switch (paramInt2) {
      ...
      case 5:
        FM.AS.astateSootEffects[paramInt1][0] = Eff3DActor.New(this, this.findHook("_Engine1EF_01"), null, 0.75F, "3DO/Effects/Aircraft/TurboZippo.eff", -1.0F);
        FM.AS.astateSootEffects[paramInt1][1] = Eff3DActor.New(this, this.findHook("_Engine1EF_02"), null, 2.0F, "3DO/Effects/Aircraft/TurboJRD1100F.eff", -1F);
        break;
    }
  }

  /*synthetic*/ static float access$234(Mig_17 x0, double x1) {
    return x0.actl *= x1;
  }

  /*synthetic*/ static float access$334(Mig_17 x0, double x1) {
    return x0.ectl *= x1;
  }

  /*synthetic*/ static float access$434(Mig_17 x0, double x1) {
    return x0.rctl *= x1;
  }

  static {
    Class localClass = com.maddox.il2.objects.air.Mig_17.class;
