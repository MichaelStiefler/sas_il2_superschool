...
// Source File Name:   CockpitSu_11.java
...
public class CockpitSu_11 extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                setNew.k14w = (5F * CockpitSu_11.k14TargetWingspanScale[((Sukhoi)aircraft()).k14WingspanType]) / f1;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSu_11.k14TargetMarkScale[((Sukhoi)aircraft()).k14WingspanType];
                ...
                float f4 = floatindex((f1 - 200F) * 0.04F, CockpitSu_11.k14BulletDrop) - CockpitSu_11.k14BulletDrop[0];
