...
// Source File Name:   CockpitSu_7.java
...
public class CockpitSu_7 extends CockpitPilot
{
    ...
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            if(fm != null)
            {
                ...
                setNew.k14w = (5F * CockpitSu_7.k14TargetWingspanScale[((Sukhoi)aircraft()).k14WingspanType]) / f1;
                setNew.k14w = 0.9F * setOld.k14w + 0.1F * setNew.k14w;
                setNew.k14wingspan = 0.9F * setOld.k14wingspan + 0.1F * CockpitSu_7.k14TargetMarkScale[((Sukhoi)aircraft()).k14WingspanType];
                ...
                float f4 = floatindex((f1 - 200F) * 0.04F, CockpitSu_7.k14BulletDrop) - CockpitSu_7.k14BulletDrop[0];
    ...
    public CockpitSu_7()
    {
        super("3DO/Cockpit/Su-7/Su_7.him", "bf109");
    ...
    {
        if(Sukhoi.bChangedPit)
            Sukhoi.bChangedPit = false;
        ...
        super.mesh.chunkSetAngles("Z_GasPrs1a", 0.0F, cvt(((FlightModelMain) (super.fm)).M.fuel > 1.0F ? cvt(((FlightModelMain) (super.fm)).EI.engines[0].getRPM(), 0.0F, 3050F, 0.0F, 4F) : 0.0F, 0.0F, 5F, -45F, 225F), 0.0F);
        super.mesh.chunkSetAngles("Z_GasPrs2a", 0.0F, cvt(((FlightModelMain) (super.fm)).M.fuel > 1.0F ? cvt(((FlightModelMain) (super.fm)).EI.engines[0].getRPM(), 0.0F, 3050F, 0.0F, 4F) : 0.0F, 0.0F, 5F, -180F, 0.0F), 0.0F);
        ...
        super.mesh.chunkSetAngles("Z_FuelPress1", cvt(((FlightModelMain) (super.fm)).M.fuel > 1.0F ? 0.55F : 0.0F, 0.0F, 1.0F, 0.0F, 284F), 0.0F, 0.0F);
