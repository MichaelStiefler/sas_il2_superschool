...
// Source File Name:   CockpitSu_7Bombardier.java
...
//            CockpitPilot, Sukhoi, AircraftLH

public class CockpitSu_7Bombardier extends CockpitPilot
{
    class Interpolater extends InterpolateRef
    {
        ...
        public boolean tick()
        {
            float f = ((Sukhoi)aircraft()).fSightCurForwardAngle;
            float f1 = ((Sukhoi)aircraft()).fSightCurSideslip;
    ...
    public void reflectWorldToInstruments(float f)
    {
        if(bBAiming)
        {
            super.mesh.chunkSetAngles("zAngleMark", -floatindex(cvt(((Sukhoi)aircraft()).fSightCurForwardAngle, 7F, 140F, 0.7F, 14F), angleScale), 0.0F, 0.0F);
            boolean flag = ((Sukhoi)aircraft()).fSightCurReadyness > 0.93F;
    ...
    static 
    {
        Property.set(com.maddox.il2.objects.air.CockpitSu_7Bombardier.class, "astatePilotIndx", 0);
    }
