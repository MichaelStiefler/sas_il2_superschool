...
// Source File Name:   MIG_21FL.java
    ...
    implements TypeGuidedMissileCarrier, TypeCountermeasure, TypeThreatDetector
{
    ...
    static 
    {
        ...
        String as1[] = new String[52];
        as1[0] = "MGunNull 1";
        as1[5] = "MiG21WingPylon 1";
        as1[6] = "MiG21WingPylon 1";
        as1[16] = "BombGunFAB100 1";
        as1[17] = "BombGunFAB100 1";
        Aircraft.weaponsRegister(class1, "2xFAB100", as1);
        String as2[] = new String[52];
        as2[0] = "MGunNull 1";
        as2[5] = "MiG21WingPylon 1";
        as2[6] = "MiG21WingPylon 1";
        as2[16] = "BombGunFAB250m46 1";
        as2[17] = "BombGunFAB250m46 1";
        Aircraft.weaponsRegister(class1, "2xFAB250", as2);
        String as3[] = new String[52];
        as3[0] = "MGunNull 1";
        as3[5] = "MiG21WingPylon 1";
        as3[6] = "MiG21WingPylon 1";
        as3[16] = "BombGunZB360 1";
        as3[17] = "BombGunZB360 1";
        Aircraft.weaponsRegister(class1, "2xZB360", as3);
        ...
        as4[11] = "RocketGunS24 1";
        as4[12] = "RocketGunNull 1";
        as4[13] = "RocketGunS24 1";
        as4[14] = "RocketGunNull 1";
        Aircraft.weaponsRegister(class1, "rocketS24", as4);
        String as5[] = new String[53];
        as5[3] = "MiG21Pylon 1";
        as5[4] = "FuelTankGun_PT490 1";
        Aircraft.weaponsRegister(class1, "droptank", as5);
        String as6[] = new String[53];
        as6[0] = "MGunNull 1";
        as6[3] = "MiG21Pylon 1";
        as6[4] = "FuelTankGun_PT490 1";
        as6[5] = "MiG21WingPylon 1";
        as6[6] = "MiG21WingPylon 1";
        as6[7] = "RocketGunK13A 1";
        as6[8] = "RocketGunNull 1";
        as6[9] = "RocketGunK13A 1";
        as6[10] = "RocketGunNull 1";
        Aircraft.weaponsRegister(class1, "dt_rocketK13", as6);
        String as7[] = new String[53];
        as7[0] = "MGunNull 1";
        as7[3] = "MiG21Pylon 1";
        as7[4] = "FuelTankGun_PT490 1";
        as7[5] = "MiG21WingPylon 1";
        as7[6] = "MiG21WingPylon 1";
        as7[17] = "BombGunFAB100 1";
        as7[18] = "BombGunFAB100 1";
        Aircraft.weaponsRegister(class1, "dt_2xFAB100", as7);
        String as8[] = new String[53];
        as8[0] = "MGunNull 1";
        as8[3] = "MiG21Pylon 1";
        as8[4] = "FuelTankGun_PT490 1";
        as8[5] = "MiG21WingPylon 1";
        as8[6] = "MiG21WingPylon 1";
        as8[17] = "BombGunFAB250m46 1";
        as8[18] = "BombGunFAB250m46 1";
        Aircraft.weaponsRegister(class1, "dt_2xFAB250", as8);
        ...
        as9[17] = "BombGunZB360 1";
        as9[18] = "BombGunZB360 1";
        Aircraft.weaponsRegister(class1, "dt_2xZB360", as9);
        ...
        as10[11] = "RocketGunS24 1";
        as10[12] = "RocketGunNull 1";
        as10[13] = "RocketGunS24 1";
        as10[14] = "RocketGunNull 1";
        Aircraft.weaponsRegister(class1, "dt_rocketS24", as10);
        String as11[] = new String[53];
        as11[0] = "MGunGSh23Ls 100";
        as11[1] = "MGunGSh23Ls 100";
        as11[2] = "PylonGP9 1";
        Aircraft.weaponsRegister(class1, "gunpod", as11);
        String as12[] = new String[53];
        as12[0] = "MGunGSh23Ls 100";
        as12[1] = "MGunGSh23Ls 100";
        as12[2] = "PylonGP9 1";
        as12[5] = "MiG21WingPylon 1";
        as12[6] = "MiG21WingPylon 1";
        as12[7] = "RocketGunK13A 1";
        as12[8] = "RocketGunNull 1";
        as12[9] = "RocketGunK13A 1";
        as12[10] = "RocketGunNull 1";
        Aircraft.weaponsRegister(class1, "gp_rocketK13", as12);
        String as13[] = new String[53];
        as13[0] = "MGunGSh23Ls 100";
        as13[1] = "MGunGSh23Ls 100";
        as13[2] = "PylonGP9 1";
        as13[5] = "MiG21WingPylon 1";
        as13[6] = "MiG21WingPylon 1";
        as13[17] = "BombGunFAB100 1";
        as13[18] = "BombGunFAB100 1";
        Aircraft.weaponsRegister(class1, "gp_2xFAB100", as13);
        String as14[] = new String[53];
        as14[0] = "MGunGSh23Ls 100";
        as14[1] = "MGunGSh23Ls 100";
        as14[2] = "PylonGP9 1";
        as14[5] = "MiG21WingPylon 1";
        as14[6] = "MiG21WingPylon 1";
        as14[17] = "BombGunFAB250m46 1";
        as14[18] = "BombGunFAB250m46 1";
        Aircraft.weaponsRegister(class1, "gp_2xFAB250", as14);
        String as15[] = new String[53];
        as15[0] = "MGunGSh23Ls 100";
        as15[1] = "MGunGSh23Ls 100";
        as15[2] = "PylonGP9 1";
        as15[5] = "MiG21WingPylon 1";
        as15[6] = "MiG21WingPylon 1";
        as15[17] = "BombGunZB360 1";
        as15[18] = "BombGunZB360 1";
        Aircraft.weaponsRegister(class1, "gp_2xZB360", as15);
        String as16[] = new String[53];
        as16[0] = "MGunGSh23Ls 100";
        as16[1] = "MGunGSh23Ls 100";
        as16[2] = "PylonGP9 1";
        as16[5] = "MiG21WingPylon 1";
        as16[6] = "MiG21WingPylon 1";
        as16[15] = "FuelTankGun_PT490 1";
        as16[16] = "FuelTankGun_PT490 1";
        Aircraft.weaponsRegister(class1, "gp_2xdroptank", as16);
        ...
        as17[0] = "MGunGSh23Ls 100";
        as17[1] = "MGunGSh23Ls 100";
        as17[2] = "PylonGP9 1";
        as17[5] = "MiG21WingPylon 1";
        as17[6] = "MiG21WingPylon 1";
        as17[11] = "RocketGunS24 1";
        as17[12] = "RocketGunNull 1";
        as17[13] = "RocketGunS24 1";
        as17[14] = "RocketGunNull 1";
        Aircraft.weaponsRegister(class1, "gp_rocketS24", as17);
        String as18[] = new String[53];
        as18[3] = "MiG21Pylon 1";
        as18[4] = "FuelTankGun_PT490 1";
        as18[5] = "MiG21WingPylon 1";
        as18[6] = "MiG21WingPylon 1";
        as18[15] = "FuelTankGun_PT490 1";
        as18[16] = "FuelTankGun_PT490 1";
        Aircraft.weaponsRegister(class1, "3xdroptank", as18);
